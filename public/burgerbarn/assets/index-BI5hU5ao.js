...
void main() {
	...
	`}function lg(i){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===Ka||c===$a,h=c===ks||c===Bs;if(l||h){let u=t.get(a);const d=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return e===null&&(e=new Jl(i)),u=l?e.fromEquirectangular(a,u):e.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),u.texture;if(u!==void 0)return u.texture;{const f=a.image;return l&&f&&f.height>0||h&&f&&s(f)?(e===null&&(e=new Jl(i)),u=l?e.fromEquirectangular(a):e.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),a.addEventListener("dispose",r),u.texture):null}}}return a}function s(a){let c=0;const l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function r(a){const c=a.target;c.removeEventListener("dispose",r);const l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function hg(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const s=e(n);return s===null&&po("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function ug(i,t,e,n){const s={},r=new WeakMap;function o(u){const d=u.target;d.index!==null&&t.remove(d.index);for(const m in d.attributes)t.remove(d.attributes[m]);for(const m in d.morphAttributes){const _=d.morphAttributes[m];for(let p=0,g=_.length;p<g;p++)t.remove(_[p])}d.removeEventListener("dispose",o),delete s[d.id];const f=r.get(d);f&&(t.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function a(u,d){return s[d.id]===!0||(d.addEventListener("dispose",o),s[d.id]=!0,e.memory.geometries++),d}function c(u){const d=u.attributes;for(const m in d)t.update(d[m],i.ARRAY_BUFFER);const f=u.morphAttributes;for(const m in f){const _=f[m];for(let p=0,g=_.length;p<g;p++)t.update(_[p],i.ARRAY_BUFFER)}}function l(u){const d=[],f=u.index,m=u.attributes.position;let _=0;if(f!==null){const y=f.array;_=f.version;for(let x=0,S=y.length;x<S;x+=3){const C=y[x+0],A=y[x+1],b=y[x+2];d.push(C,A,A,b,b,C)}}else if(m!==void 0){const y=m.array;_=m.version;for(let x=0,S=y.length/3-1;x<S;x+=3){const C=x+0,A=x+1,b=x+2;d.push(C,A,A,b,b,C)}}else return;const p=new(bu(d)?Lu:Pu)(d,1);p.version=_;const g=r.get(u);g&&t.remove(g),r.set(u,p)}function h(u){const d=r.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&l(u)}else l(u);return r.get(u)}return{get:a,update:c,getWireframeAttribute:h}}function dg(i,t,e){let n;function s(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function c(d,f){i.drawElements(n,f,r,d*o),e.update(f,n,1)}function l(d,f,m){m!==0&&(i.drawElementsInstanced(n,f,r,d*o,m),e.update(f,n,m))}function h(d,f,m){if(m===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,d,0,m);let p=0;for(let g=0;g<m;g++)p+=f[g];e.update(p,n,1)}function u(d,f,m,_){if(m===0)return;const p=t.get("WEBGL_multi_draw");if(p===null)for(let g=0;g<d.length;g++)l(d[g]/o,f[g],_[g]);else{p.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,_,0,m);let g=0;for(let y=0;y<m;y++)g+=f[y];for(let y=0;y<_.length;y++)e.update(g,n,_[y])}}this.setMode=s,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function fg(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(e.calls++,o){case i.TRIANGLES:e.triangles+=a*(r/3);break;case i.LINES:e.lines+=a*(r/2);break;case i.LINE_STRIP:e.lines+=a*(r-1);break;case i.LINE_LOOP:e.lines+=a*r;break;case i.POINTS:e.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function pg(i,t,e){const n=new WeakMap,s=new he;function r(o,a,c){const l=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(a);if(d===void 0||d.count!==u){let v=function(){P.dispose(),n.delete(a),a.removeEventListener("dispose",v)};var f=v;d!==void 0&&d.texture.dispose();const m=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,p=a.morphAttributes.color!==void 0,g=a.morphAttributes.position||[],y=a.morphAttributes.normal||[],x=a.morphAttributes.color||[];let S=0;m===!0&&(S=1),_===!0&&(S=2),p===!0&&(S=3);let C=a.attributes.position.count*S,A=1;C>t.maxTextureSize&&(A=Math.ceil(C/t.maxTextureSize),C=t.maxTextureSize);const b=new Float32Array(C*A*4*u),P=new Au(b,C,A,u);P.type=fi,P.needsUpdate=!0;const D=S*4;for(let w=0;w<u;w++){const U=g[w],N=y[w],X=x[w],q=C*A*4*w;for(let V=0;V<U.count;V++){const K=V*D;m===!0&&(s.fromBufferAttribute(U,V),b[q+K+0]=s.x,b[q+K+1]=s.y,b[q+K+2]=s.z,b[q+K+3]=0),_===!0&&(s.fromBufferAttribute(N,V),b[q+K+4]=s.x,b[q+K+5]=s.y,b[q+K+6]=s.z,b[q+K+7]=0),p===!0&&(s.fromBufferAttribute(X,V),b[q+K+8]=s.x,b[q+K+9]=s.y,b[q+K+10]=s.z,b[q+K+11]=X.itemSize===4?s.w:1)}}d={count:u,texture:P,size:new St(C,A)},n.set(a,d),a.addEventListener("dispose",v)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",o.morphTexture,e);else{let m=0;for(let p=0;p<l.length;p++)m+=l[p];const _=a.morphTargetsRelative?1:1-m;c.getUniforms().setValue(i,"morphTargetBaseInfluence",_),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",d.texture,e),c.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function mg(i,t,e,n){let s=new WeakMap;function r(c){const l=n.render.frame,h=c.geometry,u=t.get(c,h);if(s.get(u)!==l&&(t.update(u),s.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),s.get(c)!==l&&(e.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const d=c.skeleton;s.get(d)!==l&&(d.update(),s.set(d,l))}return u}function o(){s=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:r,dispose:o}}class Fu extends tn{constructor(t,e,n,s,r,o,a,c,l,h=Us){if(h!==Us&&h!==Gs)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===Us&&(n=ts),n===void 0&&h===Gs&&(n=Hs),super(null,s,r,o,a,c,h,n,l),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:An,this.minFilter=c!==void 0?c:An,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const zu=new tn,nh=new Fu(1,1),ku=new Au,Bu=new e0,Hu=new Uu,ih=[],sh=[],rh=new Float32Array(16),oh=new Float32Array(9),ah=new Float32Array(4);function js(i,t,e){const n=i[0];if(n<=0||n>0)return i;const s=t*e;let r=ih[s];if(r===void 0&&(r=new Float32Array(s),ih[s]=r),t!==0){n.toArray(r,0);for(let o=1,a=0;o!==t;++o)a+=e,i[o].toArray(r,a)}return r}function Ue(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function Ne(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function Lo(i,t){let e=sh[t];e===void 0&&(e=new Int32Array(t),sh[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function gg(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function _g(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ue(e,t))return;i.uniform2fv(this.addr,t),Ne(e,t)}}function xg(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(Ue(e,t))return;i.uniform3fv(this.addr,t),Ne(e,t)}}function vg(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ue(e,t))return;i.uniform4fv(this.addr,t),Ne(e,t)}}function yg(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ue(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),Ne(e,t)}else{if(Ue(e,n))return;ah.set(n),i.uniformMatrix2fv(this.addr,!1,ah),Ne(e,n)}}function Mg(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ue(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),Ne(e,t)}else{if(Ue(e,n))return;oh.set(n),i.uniformMatrix3fv(this.addr,!1,oh),Ne(e,n)}}function Sg(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ue(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),Ne(e,t)}else{if(Ue(e,n))return;rh.set(n),i.uniformMatrix4fv(this.addr,!1,rh),Ne(e,n)}}function wg(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function Eg(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ue(e,t))return;i.uniform2iv(this.addr,t),Ne(e,t)}}function bg(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ue(e,t))return;i.uniform3iv(this.addr,t),Ne(e,t)}}function Tg(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ue(e,t))return;i.uniform4iv(this.addr,t),Ne(e,t)}}function Ag(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function Rg(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ue(e,t))return;i.uniform2uiv(this.addr,t),Ne(e,t)}}function Cg(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ue(e,t))return;i.uniform3uiv(this.addr,t),Ne(e,t)}}function Pg(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ue(e,t))return;i.uniform4uiv(this.addr,t),Ne(e,t)}}function Lg(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(nh.compareFunction=Eu,r=nh):r=zu,e.setTexture2D(t||r,s)}function Ig(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||Bu,s)}function Dg(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||Hu,s)}function Ug(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||ku,s)}function Ng(i){switch(i){case 5126:return gg;case 35664:return _g;case 35665:return xg;case 35666:return vg;case 35674:return yg;case 35675:return Mg;case 35676:return Sg;case 5124:case 35670:return wg;case 35667:case 35671:return Eg;case 35668:case 35672:return bg;case 35669:case 35673:return Tg;case 5125:return Ag;case 36294:return Rg;case 36295:return Cg;case 36296:return Pg;case 35678:case 36198:case 36298:case 36306:case 35682:return Lg;case 35679:case 36299:case 36307:return Ig;case 35680:case 36300:case 36308:case 36293:return Dg;case 36289:case 36303:case 36311:case 36292:return Ug}}function Og(i,t){i.uniform1fv(this.addr,t)}function Fg(i,t){const e=js(t,this.size,2);i.uniform2fv(this.addr,e)}function zg(i,t){const e=js(t,this.size,3);i.uniform3fv(this.addr,e)}function kg(i,t){const e=js(t,this.size,4);i.uniform4fv(this.addr,e)}function Bg(i,t){const e=js(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function Hg(i,t){const e=js(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function Gg(i,t){const e=js(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function Vg(i,t){i.uniform1iv(this.addr,t)}function Wg(i,t){i.uniform2iv(this.addr,t)}function qg(i,t){i.uniform3iv(this.addr,t)}function Xg(i,t){i.uniform4iv(this.addr,t)}function Yg(i,t){i.uniform1uiv(this.addr,t)}function jg(i,t){i.uniform2uiv(this.addr,t)}function Kg(i,t){i.uniform3uiv(this.addr,t)}function $g(i,t){i.uniform4uiv(this.addr,t)}function Zg(i,t,e){const n=this.cache,s=t.length,r=Lo(e,s);Ue(n,r)||(i.uniform1iv(this.addr,r),Ne(n,r));for(let o=0;o!==s;++o)e.setTexture2D(t[o]||zu,r[o])}function Jg(i,t,e){const n=this.cache,s=t.length,r=Lo(e,s);Ue(n,r)||(i.uniform1iv(this.addr,r),Ne(n,r));for(let o=0;o!==s;++o)e.setTexture3D(t[o]||Bu,r[o])}function Qg(i,t,e){const n=this.cache,s=t.length,r=Lo(e,s);Ue(n,r)||(i.uniform1iv(this.addr,r),Ne(n,r));for(let o=0;o!==s;++o)e.setTextureCube(t[o]||Hu,r[o])}function t_(i,t,e){const n=this.cache,s=t.length,r=Lo(e,s);Ue(n,r)||(i.uniform1iv(this.addr,r),Ne(n,r));for(let o=0;o!==s;++o)e.setTexture2DArray(t[o]||ku,r[o])}function e_(i){switch(i){case 5126:return Og;case 35664:return Fg;case 35665:return zg;case 35666:return kg;case 35674:return Bg;case 35675:return Hg;case 35676:return Gg;case 5124:case 35670:return Vg;case 35667:case 35671:return Wg;case 35668:case 35672:return qg;case 35669:case 35673:return Xg;case 5125:return Yg;case 36294:return jg;case 36295:return Kg;case 36296:return $g;case 35678:case 36198:case 36298:case 36306:case 35682:return Zg;case 35679:case 36299:case 36307:return Jg;case 35680:case 36300:case 36308:case 36293:return Qg;case 36289:case 36303:case 36311:case 36292:return t_}}class n_{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Ng(e.type)}}class i_{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=e_(e.type)}}class s_{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(t,e[a.id],n)}}}const pa=/(\w+)(\])?(\[|\.)?/g;function ch(i,t){i.seq.push(t),i.map[t.id]=t}function r_(i,t,e){const n=i.name,s=n.length;for(pa.lastIndex=0;;){const r=pa.exec(n),o=pa.lastIndex;let a=r[1];const c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===s){ch(e,l===void 0?new n_(a,i,t):new i_(a,i,t));break}else{let u=e.map[a];u===void 0&&(u=new s_(a),ch(e,u)),e=u}}}class mo{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=t.getActiveUniform(e,s),o=t.getUniformLocation(e,r.name);r_(r,o,this)}}setValue(t,e,n,s){const r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){const s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,o=e.length;r!==o;++r){const a=e[r],c=n[a.id];c.needsUpdate!==!1&&a.setValue(t,c.value,s)}}static seqWithValue(t,e){const n=[];for(let s=0,r=t.length;s!==r;++s){const o=t[s];o.id in e&&n.push(o)}return n}}function lh(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const o_=37297;let a_=0;function c_(i,t){const e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let o=s;o<r;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}function l_(i){const t=ae.getPrimaries(ae.workingColorSpace),e=ae.getPrimaries(i);let n;switch(t===e?n="":t===Mo&&e===yo?n="LinearDisplayP3ToLinearSRGB":t===yo&&e===Mo&&(n="LinearSRGBToLinearDisplayP3"),i){case zi:case Co:return[n,"LinearTransferOETF"];case Le:case Zc:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function hh(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),s=i.getShaderInfoLog(t).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const o=parseInt(r[1]);return e.toUpperCase()+`

`+s+`

`+c_(i.getShaderSource(t),o)}else return s}function h_(i,t){const e=l_(t);return`vec4 ${i}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function u_(i,t){let e;switch(t){case ff:e="Linear";break;case pf:e="Reinhard";break;case mf:e="Cineon";break;case du:e="ACESFilmic";break;case _f:e="AgX";break;case xf:e="Neutral";break;case gf:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Vr=new I;function d_(){ae.getLuminanceCoefficients(Vr);const i=Vr.x.toFixed(4),t=Vr.y.toFixed(4),e=Vr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function f_(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(rr).join(`
`)}function p_(i){const t=[];for(const e in i){const n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function m_(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function rr(i){return i!==""}function uh(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function dh(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const g_=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ec(i){return i.replace(g_,x_)}const __=new Map;function x_(i,t){let e=Zt[t];if(e===void 0){const n=__.get(t);if(n!==void 0)e=Zt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Ec(e)}const v_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function fh(i){return i.replace(v_,y_)}function y_(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function ph(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function M_(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===hu?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===uu?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===ui&&(t="SHADOWMAP_TYPE_VSM"),t}function S_(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ks:case Bs:t="ENVMAP_TYPE_CUBE";break;case Ro:t="ENVMAP_TYPE_CUBE_UV";break}return t}function w_(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Bs:t="ENVMAP_MODE_REFRACTION";break}return t}function E_(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Vc:t="ENVMAP_BLENDING_MULTIPLY";break;case uf:t="ENVMAP_BLENDING_MIX";break;case df:t="ENVMAP_BLENDING_ADD";break}return t}function b_(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function T_(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=M_(e),l=S_(e),h=w_(e),u=E_(e),d=b_(e),f=f_(e),m=p_(r),_=s.createProgram();let p,g,y=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+g);const x=y+p+o,S=y+g+a,C=lh(s,s.VERTEX_SHADER,x),A=lh(s,s.FRAGMENT_SHADER,S);s.attachShader(_,C),s.attachShader(_,A),e.index0AttributeName!==void 0?s.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function b(w){if(i.debug.checkShaderErrors){const U=s.getProgramInfoLog(_).trim(),N=s.getShaderInfoLog(C).trim(),X=s.getShaderInfoLog(A).trim();let q=!0,V=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,C,A);else{const K=hh(s,C,"vertex"),k=hh(s,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
}`;class tx{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){const s=new tn,r=t.properties.get(s);r.__webglTexture=e.texture,(e.depthNear!=n.depthNear||e.depthFar!=n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new xi({vertexShader:J_,fragmentShader:Q_,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new ut(new Be(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class ex extends Xs{constructor(t,e){super();const n=this;let s=null,r=1,o=null,a="local-floor",c=1,l=null,h=null,u=null,d=null,f=null,m=null;const _=new tx,p=e.getContextAttributes();let g=null,y=null;const x=[],S=[],C=new St;let A=null;const b=new on;b.layers.enable(1),b.viewport=new he;const P=new on;P.layers.enable(2),P.viewport=new he;const D=[b,P],v=new $_;v.layers.enable(1),v.layers.enable(2);let w=null,U=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Q){let F=x[Q];return F===void 0&&(F=new ma,x[Q]=F),F.getTargetRaySpace()},this.getControllerGrip=function(Q){let F=x[Q];return F===void 0&&(F=new ma,x[Q]=F),F.getGripSpace()},this.getHand=function(Q){let F=x[Q];return F===void 0&&(F=new ma,x[Q]=F),F.getHandSpace()};function N(Q){const F=S.indexOf(Q.inputSource);if(F===-1)return;const dt=x[F];dt!==void 0&&(dt.update(Q.inputSource,Q.frame,l||o),dt.dispatchEvent({type:Q.type,data:Q.inputSource}))}function X(){s.removeEventListener("select",N),s.removeEventListener("selectstart",N),s.removeEventListener("selectend",N),s.removeEventListener("squeeze",N),s.removeEventListener("squeezestart",N),s.removeEventListener("squeezeend",N),s.removeEventListener("end",X),s.removeEventListener("inputsourceschange",q);for(let Q=0;Q<x.length;Q++){const F=S[Q];F!==null&&(S[Q]=null,x[Q].disconnect(F))}w=null,U=null,_.reset(),t.setRenderTarget(g),f=null,d=null,u=null,s=null,y=null,jt.stop(),n.isPresenting=!1,t.setPixelRatio(A),t.setSize(C.width,C.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Q){r=Q,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Q){a=Q,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||o},this.setReferenceSpace=function(Q){l=Q},this.getBaseLayer=function(){return d!==null?d:f},this.getBinding=function(){return u},this.getFrame=function(){return m},this.getSession=function(){return s},this.setSession=async function(Q){if(s=Q,s!==null){if(g=t.getRenderTarget(),s.addEventListener("select",N),s.addEventListener("selectstart",N),s.addEventListener("selectend",N),s.addEventListener("squeeze",N),s.addEventListener("squeezestart",N),s.addEventListener("squeezeend",N),s.addEventListener("end",X),s.addEventListener("inputsourceschange",q),p.xrCompatible!==!0&&await e.makeXRCompatible(),A=t.getPixelRatio(),t.getSize(C),s.renderState.layers===void 0){const F={antialias:p.antialias,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:r};f=new XRWebGLLayer(s,e,F),s.updateRenderState({baseLayer:f}),t.setPixelRatio(1),t.setSize(f.framebufferWidth,f.framebufferHeight,!1),y=new es(f.framebufferWidth,f.framebufferHeight,{format:Bn,type:gi,colorSpace:t.outputColorSpace,stencilBuffer:p.stencil})}else{let F=null,dt=null,nt=null;p.depth&&(nt=p.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,F=p.stencil?Gs:Us,dt=p.stencil?Hs:ts);const vt={colorFormat:e.RGBA8,depthFormat:nt,scaleFactor:r};u=new XRWebGLBinding(s,e),d=u.createProjectionLayer(vt),s.updateRenderState({layers:[d]}),t.setPixelRatio(1),t.setSize(d.textureWidth,d.textureHeight,!1),y=new es(d.textureWidth,d.textureHeight,{format:Bn,type:gi,depthTexture:new Fu(d.textureWidth,d.textureHeight,dt,void 0,void 0,void 0,void 0,void 0,void 0,F),stencilBuffer:p.stencil,colorSpace:t.outputColorSpace,samples:p.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(c),l=null,o=await s.requestReferenceSpace(a),jt.setContext(s),jt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function q(Q){for(let F=0;F<Q.removed.length;F++){const dt=Q.removed[F],nt=S.indexOf(dt);nt>=0&&(S[nt]=null,x[nt].disconnect(dt))}for(let F=0;F<Q.added.length;F++){const dt=Q.added[F];let nt=S.indexOf(dt);if(nt===-1){for(let _t=0;_t<x.length;_t++)if(_t>=S.length){S.push(dt),nt=_t;break}else if(S[_t]===null){S[_t]=dt,nt=_t;break}if(nt===-1)break}const vt=x[nt];vt&&vt.connect(dt)}}const V=new I,K=new I;function k(Q,F,dt){V.setFromMatrixPosition(F.matrixWorld),K.setFromMatrixPosition(dt.matrixWorld);const nt=V.distanceTo(K),vt=F.projectionMatrix.elements,_t=dt.projectionMatrix.elements,Et=vt[14]/(vt[10]-1),At=vt[14]/(vt[10]+1),Z=(vt[9]+1)/vt[5],E=(vt[9]-1)/vt[5],ft=(vt[8]-1)/vt[0],st=(_t[8]+1)/_t[0],it=Et*ft,ot=Et*st,Pt=nt/(-ft+st),rt=Pt*-ft;if(F.matrixWorld.decompose(Q.position,Q.quaternion,Q.scale),Q.translateX(rt),Q.translateZ(Pt),Q.matrixWorld.compose(Q.position,Q.quaternion,Q.scale),Q.matrixWorldInverse.copy(Q.matrixWorld).invert(),vt[10]===-1)Q.projectionMatrix.copy(F.projectionMatrix),Q.projectionMatrixInverse.copy(F.projectionMatrixInverse);else{const R=Et+Pt,M=At+Pt,B=it-rt,J=ot+(nt-rt),et=Z*At/M*R,tt=E*At/M*R;Q.projectionMatrix.makePerspective(B,J,et,tt,R,M),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert()}}function pt(Q,F){F===null?Q.matrixWorld.copy(Q.matrix):Q.matrixWorld.multiplyMatrices(F.matrixWorld,Q.matrix),Q.matrixWorldInverse.copy(Q.matrixWorld).invert()}this.updateCamera=function(Q){if(s===null)return;let F=Q.near,dt=Q.far;_.texture!==null&&(_.depthNear>0&&(F=_.depthNear),_.depthFar>0&&(dt=_.depthFar)),v.near=P.near=b.near=F,v.far=P.far=b.far=dt,(w!==v.near||U!==v.far)&&(s.updateRenderState({depthNear:v.near,depthFar:v.far}),w=v.near,U=v.far);const nt=Q.parent,vt=v.cameras;pt(v,nt);for(let _t=0;_t<vt.length;_t++)pt(vt[_t],nt);vt.length===2?k(v,b,P):v.projectionMatrix.copy(b.projectionMatrix),mt(Q,v,nt)};function mt(Q,F,dt){dt===null?Q.matrix.copy(F.matrixWorld):(Q.matrix.copy(dt.matrixWorld),Q.matrix.invert(),Q.matrix.multiply(F.matrixWorld)),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.updateMatrixWorld(!0),Q.projectionMatrix.copy(F.projectionMatrix),Q.projectionMatrixInverse.copy(F.projectionMatrixInverse),Q.isPerspectiveCamera&&(Q.fov=Vs*2*Math.atan(1/Q.projectionMatrix.elements[5]),Q.zoom=1)}this.getCamera=function(){return v},this.getFoveation=function(){if(!(d===null&&f===null))return c},this.setFoveation=function(Q){c=Q,d!==null&&(d.fixedFoveation=Q),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=Q)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(v)};let ct=null;function zt(Q,F){if(h=F.getViewerPose(l||o),m=F,h!==null){const dt=h.views;f!==null&&(t.setRenderTargetFramebuffer(y,f.framebuffer),t.setRenderTarget(y));let nt=!1;dt.length!==v.cameras.length&&(v.cameras.length=0,nt=!0);for(let _t=0;_t<dt.length;_t++){const Et=dt[_t];let At=null;if(f!==null)At=f.getViewport(Et);else{const E=u.getViewSubImage(d,Et);At=E.viewport,_t===0&&(t.setRenderTargetTextures(y,E.colorTexture,d.ignoreDepthValues?void 0:E.depthStencilTexture),t.setRenderTarget(y))}let Z=D[_t];Z===void 0&&(Z=new on,Z.layers.enable(_t),Z.viewport=new he,D[_t]=Z),Z.matrix.fromArray(Et.transform.matrix),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.projectionMatrix.fromArray(Et.projectionMatrix),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert(),Z.viewport.set(At.x,At.y,At.width,At.height),_t===0&&(v.matrix.copy(Z.matrix),v.matrix.decompose(v.position,v.quaternion,v.scale)),nt===!0&&v.cameras.push(Z)}const vt=s.enabledFeatures;if(vt&&vt.includes("depth-sensing")){const _t=u.getDepthInformation(dt[0]);_t&&_t.isValid&&_t.texture&&_.init(t,_t,s.renderState)}}for(let dt=0;dt<x.length;dt++){const nt=S[dt],vt=x[dt];nt!==null&&vt!==void 0&&vt.update(nt,F,l||o)}ct&&ct(Q,F),F.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:F}),m=null}const jt=new Nu;jt.setAnimationLoop(zt),this.setAnimationLoop=function(Q){ct=Q},this.dispose=function(){}}}const Xi=new Hn,nx=new xe;function ix(i,t){function e(p,g){p.matrixAutoUpdate===!0&&p.updateMatrix(),g.value.copy(p.matrix)}function n(p,g){g.color.getRGB(p.fogColor.value,Iu(i)),g.isFog?(p.fogNear.value=g.near,p.fogFar.value=g.far):g.isFogExp2&&(p.fogDensity.value=g.density)}function s(p,g,y,x,S){g.isMeshBasicMaterial||g.isMeshLambertMaterial?r(p,g):g.isMeshToonMaterial?(r(p,g),u(p,g)):g.isMeshPhongMaterial?(r(p,g),h(p,g)):g.isMeshStandardMaterial?(r(p,g),d(p,g),g.isMeshPhysicalMaterial&&f(p,g,S)):g.isMeshMatcapMaterial?(r(p,g),m(p,g)):g.isMeshDepthMaterial?r(p,g):g.isMeshDistanceMaterial?(r(p,g),_(p,g)):g.isMeshNormalMaterial?r(p,g):g.isLineBasicMaterial?(o(p,g),g.isLineDashedMaterial&&a(p,g)):g.isPointsMaterial?c(p,g,y,x):g.isSpriteMaterial?l(p,g):g.isShadowMaterial?(p.color.value.copy(g.color),p.opacity.value=g.opacity):g.isShaderMaterial&&(g.uniformsNeedUpdate=!1)}function r(p,g){p.opacity.value=g.opacity,g.color&&p.diffuse.value.copy(g.color),g.emissive&&p.emissive.value.copy(g.emissive).multiplyScalar(g.emissiveIntensity),g.map&&(p.map.value=g.map,e(g.map,p.mapTransform)),g.alphaMap&&(p.alphaMap.value=g.alphaMap,e(g.alphaMap,p.alphaMapTransform)),g.bumpMap&&(p.bumpMap.value=g.bumpMap,e(g.bumpMap,p.bumpMapTransform),p.bumpScale.value=g.bumpScale,g.side===Qe&&(p.bumpScale.value*=-1)),g.normalMap&&(p.normalMap.value=g.normalMap,e(g.normalMap,p.normalMapTransform),p.normalScale.value.copy(g.normalScale),g.side===Qe&&p.normalScale.value.negate()),g.displacementMap&&(p.displacementMap.value=g.displacementMap,e(g.displacementMap,p.displacementMapTransform),p.displacementScale.value=g.displacementScale,p.displacementBias.value=g.displacementBias),g.emissiveMap&&(p.emissiveMap.value=g.emissiveMap,e(g.emissiveMap,p.emissiveMapTransform)),g.specularMap&&(p.specularMap.value=g.specularMap,e(g.specularMap,p.specularMapTransform)),g.alphaTest>0&&(p.alphaTest.value=g.alphaTest);const y=t.get(g),x=y.envMap,S=y.envMapRotation;x&&(p.envMap.value=x,Xi.copy(S),Xi.x*=-1,Xi.y*=-1,Xi.z*=-1,x.isCubeTexture&&x.isRenderTargetTexture===!1&&(Xi.y*=-1,Xi.z*=-1),p.envMapRotation.value.setFromMatrix4(nx.makeRotationFromEuler(Xi)),p.flipEnvMap.value=x.isCubeTexture&&x.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=g.reflectivity,p.ior.value=g.ior,p.refractionRatio.value=g.refractionRatio),g.lightMap&&(p.lightMap.value=g.lightMap,p.lightMapIntensity.value=g.lightMapIntensity,e(g.lightMap,p.lightMapTransform)),g.aoMap&&(p.aoMap.value=g.aoMap,p.aoMapIntensity.value=g.aoMapIntensity,e(g.aoMap,p.aoMapTransform))}function o(p,g){p.diffuse.value.copy(g.color),p.opacity.value=g.opacity,g.map&&(p.map.value=g.map,e(g.map,p.mapTransform))}function a(p,g){p.dashSize.value=g.dashSize,p.totalSize.value=g.dashSize+g.gapSize,p.scale.value=g.scale}function c(p,g,y,x){p.diffuse.value.copy(g.color),p.opacity.value=g.opacity,p.size.value=g.size*y,p.scale.value=x*.5,g.map&&(p.map.value=g.map,e(g.map,p.uvTransform)),g.alphaMap&&(p.alphaMap.value=g.alphaMap,e(g.alphaMap,p.alphaMapTransform)),g.alphaTest>0&&(p.alphaTest.value=g.alphaTest)}function l(p,g){p.diffuse.value.copy(g.color),p.opacity.value=g.opacity,p.rotation.value=g.rotation,g.map&&(p.map.value=g.map,e(g.map,p.mapTransform)),g.alphaMap&&(p.alphaMap.value=g.alphaMap,e(g.alphaMap,p.alphaMapTransform)),g.alphaTest>0&&(p.alphaTest.value=g.alphaTest)}function h(p,g){p.specular.value.copy(g.specular),p.shininess.value=Math.max(g.shininess,1e-4)}function u(p,g){g.gradientMap&&(p.gradientMap.value=g.gradientMap)}function d(p,g){p.metalness.value=g.metalness,g.metalnessMap&&(p.metalnessMap.value=g.metalnessMap,e(g.metalnessMap,p.metalnessMapTransform)),p.roughness.value=g.roughness,g.roughnessMap&&(p.roughnessMap.value=g.roughnessMap,e(g.roughnessMap,p.roughnessMapTransform)),g.envMap&&(p.envMapIntensity.value=g.envMapIntensity)}function f(p,g,y){p.ior.value=g.ior,g.sheen>0&&(p.sheenColor.value.copy(g.sheenColor).multiplyScalar(g.sheen),p.sheenRoughness.value=g.sheenRoughness,g.sheenColorMap&&(p.sheenColorMap.value=g.sheenColorMap,e(g.sheenColorMap,p.sheenColorMapTransform)),g.sheenRoughnessMap&&(p.sheenRoughnessMap.value=g.sheenRoughnessMap,e(g.sheenRoughnessMap,p.sheenRoughnessMapTransform))),g.clearcoat>0&&(p.clearcoat.value=g.clearcoat,p.clearcoatRoughness.value=g.clearcoatRoughness,g.clearcoatMap&&(p.clearcoatMap.value=g.clearcoatMap,e(g.clearcoatMap,p.clearcoatMapTransform)),g.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=g.clearcoatRoughnessMap,e(g.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),g.clearcoatNormalMap&&(p.clearcoatNormalMap.value=g.clearcoatNormalMap,e(g.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(g.clearcoatNormalScale),g.side===Qe&&p.clearcoatNormalScale.value.negate())),g.dispersion>0&&(p.dispersion.value=g.dispersion),g.iridescence>0&&(p.iridescence.value=g.iridescence,p.iridescenceIOR.value=g.iridescenceIOR,p.iridescenceThicknessMinimum.value=g.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=g.iridescenceThicknessRange[1],g.iridescenceMap&&(p.iridescenceMap.value=g.iridescenceMap,e(g.iridescenceMap,p.iridescenceMapTransform)),g.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=g.iridescenceThicknessMap,e(g.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),g.transmission>0&&(p.transmission.value=g.transmission,p.transmissionSamplerMap.value=y.texture,p.transmissionSamplerSize.value.set(y.width,y.height),g.transmissionMap&&(p.transmissionMap.value=g.transmissionMap,e(g.transmissionMap,p.transmissionMapTransform)),p.thickness.value=g.thickness,g.thicknessMap&&(p.thicknessMap.value=g.thicknessMap,e(g.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=g.attenuationDistance,p.attenuationColor.value.copy(g.attenuationColor)),g.anisotropy>0&&(p.anisotropyVector.value.set(g.anisotropy*Math.cos(g.anisotropyRotation),g.anisotropy*Math.sin(g.anisotropyRotation)),g.anisotropyMap&&(p.anisotropyMap.value=g.anisotropyMap,e(g.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=g.specularIntensity,p.specularColor.value.copy(g.specularColor),g.specularColorMap&&(p.specularColorMap.value=g.specularColorMap,e(g.specularColorMap,p.specularColorMapTransform)),g.specularIntensityMap&&(p.specularIntensityMap.value=g.specularIntensityMap,e(g.specularIntensityMap,p.specularIntensityMapTransform))}function m(p,g){g.matcap&&(p.matcap.value=g.matcap)}function _(p,g){const y=t.get(g).light;p.referencePosition.value.setFromMatrixPosition(y.matrixWorld),p.nearDistance.value=y.shadow.camera.near,p.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function sx(i,t,e,n){let s={},r={},o=[];const a=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(y,x){const S=x.program;n.uniformBlockBinding(y,S)}function l(y,x){let S=s[y.id];S===void 0&&(m(y),S=h(y),s[y.id]=S,y.addEventListener("dispose",p));const C=x.program;n.updateUBOMapping(y,C);const A=t.render.frame;r[y.id]!==A&&(d(y),r[y.id]=A)}function h(y){const x=u();y.__bindingPointIndex=x;const S=i.createBuffer(),C=y.__size,A=y.usage;return i.bindBuffer(i.UNIFORM_BUFFER,S),i.bufferData(i.UNIFORM_BUFFER,C,A),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,x,S),S}function u(){for(let y=0;y<a;y++)if(o.indexOf(y)===-1)return o.push(y),y;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(y){const x=s[y.id],S=y.uniforms,C=y.__cache;i.bindBuffer(i.UNIFORM_BUFFER,x);for(let A=0,b=S.length;A<b;A++){const P=Array.isArray(S[A])?S[A]:[S[A]];for(let D=0,v=P.length;D<v;D++){const w=P[D];if(f(w,A,D,C)===!0){const U=w.__offset,N=Array.isArray(w.value)?w.value:[w.value];let X=0;for(let q=0;q<N.length;q++){const V=N[q],K=_(V);typeof V=="number"||typeof V=="boolean"?(w.__data[0]=V,i.bufferSubData(i.UNIFORM_BUFFER,U+X,w.__data)):V.isMatrix3?(w.__data[0]=V.elements[0],w.__data[1]=V.elements[1],w.__data[2]=V.elements[2],w.__data[3]=0,w.__data[4]=V.elements[3],w.__data[5]=V.elements[4],w.__data[6]=V.elements[5],w.__data[7]=0,w.__data[8]=V.elements[6],w.__data[9]=V.elements[7],w.__data[10]=V.elements[8],w.__data[11]=0):(V.toArray(w.__data,X),X+=K.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,U,w.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function f(y,x,S,C){const A=y.value,b=x+"_"+S;if(C[b]===void 0)return typeof A=="number"||typeof A=="boolean"?C[b]=A:C[b]=A.clone(),!0;{const P=C[b];if(typeof A=="number"||typeof A=="boolean"){if(P!==A)return C[b]=A,!0}else if(P.equals(A)===!1)return P.copy(A),!0}return!1}function m(y){const x=y.uniforms;let S=0;const C=16;for(let b=0,P=x.length;b<P;b++){const D=Array.isArray(x[b])?x[b]:[x[b]];for(let v=0,w=D.length;v<w;v++){const U=D[v],N=Array.isArray(U.value)?U.value:[U.value];for(let X=0,q=N.length;X<q;X++){const V=N[X],K=_(V),k=S%C,pt=k%K.boundary,mt=k+pt;S+=pt,mt!==0&&C-mt<K.storage&&(S+=C-mt),U.__data=new Float32Array(K.storage/Float32Array.BYTES_PER_ELEMENT),U.__offset=S,S+=K.storage}}}const A=S%C;return A>0&&(S+=C-A),y.__size=S,y.__cache={},this}function _(y){const x={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(x.boundary=4,x.storage=4):y.isVector2?(x.boundary=8,x.storage=8):y.isVector3||y.isColor?(x.boundary=16,x.storage=12):y.isVector4?(x.boundary=16,x.storage=16):y.isMatrix3?(x.boundary=48,x.storage=48):y.isMatrix4?(x.boundary=64,x.storage=64):y.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",y),x}function p(y){const x=y.target;x.removeEventListener("dispose",p);const S=o.indexOf(x.__bindingPointIndex);o.splice(S,1),i.deleteBuffer(s[x.id]),delete s[x.id],delete r[x.id]}function g(){for(const y in s)i.deleteBuffer(s[y]);o=[],s={},r={}}return{bind:c,update:l,dispose:g}}class rx{constructor(t={}){const{canvas:e=Xf(),context:n=null,depth:s=!0,stencil:r=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1}=t;this.isWebGLRenderer=!0;let d;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");d=n.getContextAttributes().alpha}else d=o;const f=new Uint32Array(4),m=new Int32Array(4);let _=null,p=null;const g=[],y=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Le,this.toneMapping=Oi,this.toneMappingExposure=1;const x=this;let S=!1,C=0,A=0,b=null,P=-1,D=null;const v=new he,w=new he;let U=null;const N=new Gt(0);let X=0,q=e.width,V=e.height,K=1,k=null,pt=null;const mt=new he(0,0,q,V),ct=new he(0,0,q,V);let zt=!1;const jt=new tl;let Q=!1,F=!1;const dt=new xe,nt=new xe,vt=new I,_t=new he,Et={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let At=!1;function Z(){return b===null?K:1}let E=n;function ft(T,H){return e.getContext(T,H)}try{const T={alpha:!0,depth:s,stencil:r,antialias:a,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Gc}`),e.addEventListener("webglcontextlost",Y,!1),e.addEventListener("webglcontextrestored",at,!1),e.addEventListener("webglcontextcreationerror",wt,!1),E===null){const H="webgl2";if(E=ft(H,T),E===null)throw ft(H)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(T){throw console.error("THREE.WebGLRenderer: "+T.message),T}let st,it,ot,Pt,rt,R,M,B,J,et,tt,Lt,lt,Mt,Kt,ht,Rt,kt,Bt,bt,te,qt,se,z;function L(){st=new hg(E),st.init(),qt=new K_(E,st),it=new sg(E,st,t,qt),ot=new X_(E),it.reverseDepthBuffer&&ot.buffers.depth.setReversed(!0),Pt=new fg(E),rt=new L_,R=new j_(E,st,ot,rt,it,qt,Pt),M=new og(x),B=new lg(x),J=new y0(E),se=new ng(E,J),et=new ug(E,J,Pt,se),tt=new mg(E,et,J,Pt),Bt=new pg(E,it,R),ht=new rg(rt),Lt=new P_(x,M,B,st,it,se,ht),lt=new ix(x,rt),Mt=new D_,Kt=new k_(st),kt=new eg(x,M,B,ot,tt,d,c),Rt=new W_(x,tt,it),z=new sx(E,Pt,it,ot),bt=new ig(E,st,Pt),te=new dg(E,st,Pt),Pt.programs=Lt.programs,x.capabilities=it,x.extensions=st,x.properties=rt,x.renderLists=Mt,x.shadowMap=Rt,x.state=ot,x.info=Pt}L();const O=new ex(x,E);this.xr=O,this.getContext=function(){return E},this.getContextAttributes=function(){return E.getContextAttributes()},this.forceContextLoss=function(){const T=st.get("WEBGL_lose_context");T&&T.loseContext()},this.forceContextRestore=function(){const T=st.get("WEBGL_lose_context");T&&T.restoreContext()},this.getPixelRatio=function(){return K},this.setPixelRatio=function(T){T!==void 0&&(K=T,this.setSize(q,V,!1))},this.getSize=function(T){return T.set(q,V)},this.setSize=function(T,H,j=!0){if(O.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}q=T,V=H,e.width=Math.floor(T*K),e.height=Math.floor(H*K),j===!0&&(e.style.width=T+"px",e.style.height=H+"px"),this.setViewport(0,0,T,H)},this.getDrawingBufferSize=function(T){return T.set(q*K,V*K).floor()},this.setDrawingBufferSize=function(T,H,j){q=T,V=H,K=j,e.width=Math.floor(T*j),e.height=Math.floor(H*j),this.setViewport(0,0,T,H)},this.getCurrentViewport=function(T){return T.copy(v)},this.getViewport=function(T){return T.copy(mt)},this.setViewport=function(T,H,j,$){T.isVector4?mt.set(T.x,T.y,T.z,T.w):mt.set(T,H,j,$),ot.viewport(v.copy(mt).multiplyScalar(K).round())},this.getScissor=function(T){return T.copy(ct)},this.setScissor=function(T,H,j,$){T.isVector4?ct.set(T.x,T.y,T.z,T.w):ct.set(T,H,j,$),ot.scissor(w.copy(ct).multiplyScalar(K).round())},this.getScissorTest=function(){return zt},this.setScissorTest=function(T){ot.setScissorTest(zt=T)},this.setOpaqueSort=function(T){k=T},this.setTransparentSort=function(T){pt=T},this.getClearColor=function(T){return T.copy(kt.getClearColor())},this.setClearColor=function(){kt.setClearColor.apply(kt,arguments)},this.getClearAlpha=function(){return kt.getClearAlpha()},this.setClearAlpha=function(){kt.setClearAlpha.apply(kt,arguments)},this.clear=function(T=!0,H=!0,j=!0){let $=0;if(T){let G=!1;if(b!==null){const xt=b.texture.format;G=xt===Kc||xt===jc||xt===Yc}if(G){const xt=b.texture.type,Ct=xt===gi||xt===ts||xt===dr||xt===Hs||xt===qc||xt===Xc,Dt=kt.getClearColor(),Nt=kt.getClearAlpha(),Wt=Dt.r,Xt=Dt.g,Ot=Dt.b;Ct?(f[0]=Wt,f[1]=Xt,f[2]=Ot,f[3]=Nt,E.clearBufferuiv(E.COLOR,0,f)):(m[0]=Wt,m[1]=Xt,m[2]=Ot,m[3]=Nt,E.clearBufferiv(E.COLOR,0,m))}else $|=E.COLOR_BUFFER_BIT}H&&($|=E.DEPTH_BUFFER_BIT,E.clearDepth(this.capabilities.reverseDepthBuffer?0:1)),j&&($|=E.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),E.clear($)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",Y,!1),e.removeEventListener("webglcontextrestored",at,!1),e.removeEventListener("webglcontextcreationerror",wt,!1),Mt.dispose(),Kt.dispose(),rt.dispose(),M.dispose(),B.dispose(),tt.dispose(),se.dispose(),z.dispose(),Lt.dispose(),O.dispose(),O.removeEventListener("sessionstart",Ks),O.removeEventListener("sessionend",$s),qn.stop()};function Y(T){T.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),S=!0}function at(){console.log("THREE.WebGLRenderer: Context Restored."),S=!1;const T=Pt.autoReset,H=Rt.enabled,j=Rt.autoUpdate,$=Rt.needsUpdate,G=Rt.type;L(),Pt.autoReset=T,Rt.enabled=H,Rt.autoUpdate=j,Rt.needsUpdate=$,Rt.type=G}function wt(T){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",T.statusMessage)}function $t(T){const H=T.target;H.removeEventListener("dispose",$t),Me(H)}function Me(T){ve(T),rt.remove(T)}function ve(T){const H=rt.get(T).programs;H!==void 0&&(H.forEach(function(j){Lt.releaseProgram(j)}),T.isShaderMaterial&&Lt.releaseShaderCache(T))}this.renderBufferDirect=function(T,H,j,$,G,xt){H===null&&(H=Et);const Ct=G.isMesh&&G.matrixWorld.determinant()<0,Dt=wd(T,H,j,$,G);ot.setMaterial($,Ct);let Nt=j.index,Wt=1;if($.wireframe===!0){if(Nt=et.getWireframeAttribute(j),Nt===void 0)return;Wt=2}const Xt=j.drawRange,Ot=j.attributes.position;let ce=Xt.start*Wt,ge=(Xt.start+Xt.count)*Wt;xt!==null&&(ce=Math.max(ce,xt.start*Wt),ge=Math.min(ge,(xt.start+xt.count)*Wt)),Nt!==null?(ce=Math.max(ce,0),ge=Math.min(ge,Nt.count)):Ot!=null&&(ce=Math.max(ce,0),ge=Math.min(ge,Ot.count));const Se=ge-ce;if(Se<0||Se===1/0)return;se.setup(G,$,Dt,j,Nt);let an,re=bt;if(Nt!==null&&(an=J.get(Nt),re=te,re.setIndex(an)),G.isMesh)$.wireframe===!0?(ot.setLineWidth($.wireframeLinewidth*Z()),re.setMode(E.LINES)):re.setMode(E.TRIANGLES);else if(G.isLine){let Ft=$.linewidth;Ft===void 0&&(Ft=1),ot.setLineWidth(Ft*Z()),G.isLineSegments?re.setMode(E.LINES):G.isLineLoop?re.setMode(E.LINE_LOOP):re.setMode(E.LINE_STRIP)}else G.isPoints?re.setMode(E.POINTS):G.isSprite&&re.setMode(E.TRIANGLES);if(G.isBatchedMesh)if(G._multiDrawInstances!==null)re.renderMultiDrawInstances(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount,G._multiDrawInstances);else if(st.get("WEBGL_multi_draw"))re.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else{const Ft=G._multiDrawStarts,Ge=G._multiDrawCounts,oe=G._multiDrawCount,Pn=Nt?J.get(Nt).bytesPerElement:1,os=rt.get($).currentProgram.getUniforms();for(let cn=0;cn<oe;cn++)os.setValue(E,"_gl_DrawID",cn),re.render(Ft[cn]/Pn,Ge[cn])}else if(G.isInstancedMesh)re.renderInstances(ce,Se,G.count);else if(j.isInstancedBufferGeometry){const Ft=j._maxInstanceCount!==void 0?j._maxInstanceCount:1/0,Ge=Math.min(j.instanceCount,Ft);re.renderInstances(ce,Se,Ge)}else re.render(ce,Se)};function ee(T,H,j){T.transparent===!0&&T.side===zn&&T.forceSinglePass===!1?(T.side=Qe,T.needsUpdate=!0,Sr(T,H,j),T.side=ti,T.needsUpdate=!0,Sr(T,H,j),T.side=zn):Sr(T,H,j)}this.compile=function(T,H,j=null){j===null&&(j=T),p=Kt.get(j),p.init(H),y.push(p),j.traverseVisible(function(G){G.isLight&&G.layers.test(H.layers)&&(p.pushLight(G),G.castShadow&&p.pushShadow(G))}),T!==j&&T.traverseVisible(function(G){G.isLight&&G.layers.test(H.layers)&&(p.pushLight(G),G.castShadow&&p.pushShadow(G))}),p.setupLights();const $=new Set;return T.traverse(function(G){if(!(G.isMesh||G.isPoints||G.isLine||G.isSprite))return;const xt=G.material;if(xt)if(Array.isArray(xt))for(let Ct=0;Ct<xt.length;Ct++){const Dt=xt[Ct];ee(Dt,j,G),$.add(Dt)}else ee(xt,j,G),$.add(xt)}),y.pop(),p=null,$},this.compileAsync=function(T,H,j=null){const $=this.compile(T,H,j);return new Promise(G=>{function xt(){if($.forEach(function(Ct){rt.get(Ct).currentProgram.isReady()&&$.delete(Ct)}),$.size===0){G(T);return}setTimeout(xt,10)}st.get("KHR_parallel_shader_compile")!==null?xt():setTimeout(xt,10)})};let He=null;function mn(T){He&&He(T)}function Ks(){qn.stop()}function $s(){qn.start()}const qn=new Nu;qn.setAnimationLoop(mn),typeof self<"u"&&qn.setContext(self),this.setAnimationLoop=function(T){He=T,O.setAnimationLoop(T),T===null?qn.stop():qn.start()},O.addEventListener("sessionstart",Ks),O.addEventListener("sessionend",$s),this.render=function(T,H){if(H!==void 0&&H.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(S===!0)return;if(T.matrixWorldAutoUpdate===!0&&T.updateMatrixWorld(),H.parent===null&&H.matrixWorldAutoUpdate===!0&&H.updateMatrixWorld(),O.enabled===!0&&O.isPresenting===!0&&(O.cameraAutoUpdate===!0&&O.updateCamera(H),H=O.getCamera()),T.isScene===!0&&T.onBeforeRender(x,T,H,b),p=Kt.get(T,y.length),p.init(H),y.push(p),nt.multiplyMatrices(H.projectionMatrix,H.matrixWorldInverse),jt.setFromProjectionMatrix(nt),F=this.localClippingEnabled,Q=ht.init(this.clippingPlanes,F),_=Mt.get(T,g.length),_.init(),g.push(_),O.enabled===!0&&O.isPresenting===!0){const xt=x.xr.getDepthSensingMesh();xt!==null&&Fo(xt,H,-1/0,x.sortObjects)}Fo(T,H,0,x.sortObjects),_.finish(),x.sortObjects===!0&&_.sort(k,pt),At=O.enabled===!1||O.isPresenting===!1||O.hasDepthSensing()===!1,At&&kt.addToRenderList(_,T),this.info.render.frame++,Q===!0&&ht.beginShadows();const j=p.state.shadowsArray;Rt.render(j,T,H),Q===!0&&ht.endShadows(),this.info.autoReset===!0&&this.info.reset();const $=_.opaque,G=_.transmissive;if(p.setupLights(),H.isArrayCamera){const xt=H.cameras;if(G.length>0)for(let Ct=0,Dt=xt.length;Ct<Dt;Ct++){const Nt=xt[Ct];gl($,G,T,Nt)}At&&kt.render(T);for(let Ct=0,Dt=xt.length;Ct<Dt;Ct++){const Nt=xt[Ct];ml(_,T,Nt,Nt.viewport)}}else G.length>0&&gl($,G,T,H),At&&kt.render(T),ml(_,T,H);b!==null&&(R.updateMultisampleRenderTarget(b),R.updateRenderTargetMipmap(b)),T.isScene===!0&&T.onAfterRender(x,T,H),se.resetDefaultState(),P=-1,D=null,y.pop(),y.length>0?(p=y[y.length-1],Q===!0&&ht.setGlobalState(x.clippingPlanes,p.state.camera)):p=null,g.pop(),g.length>0?_=g[g.length-1]:_=null};function Fo(T,H,j,$){if(T.visible===!1)return;if(T.layers.test(H.layers)){if(T.isGroup)j=T.renderOrder;else if(T.isLOD)T.autoUpdate===!0&&T.update(H);else if(T.isLight)p.pushLight(T),T.castShadow&&p.pushShadow(T);else if(T.isSprite){if(!T.frustumCulled||jt.intersectsSprite(T)){$&&_t.setFromMatrixPosition(T.matrixWorld).applyMatrix4(nt);const Ct=tt.update(T),Dt=T.material;Dt.visible&&_.push(T,Ct,Dt,j,_t.z,null)}}else if((T.isMesh||T.isLine||T.isPoints)&&(!T.frustumCulled||jt.intersectsObject(T))){const Ct=tt.update(T),Dt=T.material;if($&&(T.boundingSphere!==void 0?(T.boundingSphere===null&&T.computeBoundingSphere(),_t.copy(T.boundingSphere.center)):(Ct.boundingSphere===null&&Ct.computeBoundingSphere(),_t.copy(Ct.boundingSphere.center)),_t.applyMatrix4(T.matrixWorld).applyMatrix4(nt)),Array.isArray(Dt)){const Nt=Ct.groups;for(let Wt=0,Xt=Nt.length;Wt<Xt;Wt++){const Ot=Nt[Wt],ce=Dt[Ot.materialIndex];ce&&ce.visible&&_.push(T,Ct,ce,j,_t.z,Ot)}}else Dt.visible&&_.push(T,Ct,Dt,j,_t.z,null)}}const xt=T.children;for(let Ct=0,Dt=xt.length;Ct<Dt;Ct++)Fo(xt[Ct],H,j,$)}function ml(T,H,j,$){const G=T.opaque,xt=T.transmissive,Ct=T.transparent;p.setupLightsView(j),Q===!0&&ht.setGlobalState(x.clippingPlanes,j),$&&ot.viewport(v.copy($)),G.length>0&&Mr(G,H,j),xt.length>0&&Mr(xt,H,j),Ct.length>0&&Mr(Ct,H,j),ot.buffers.depth.setTest(!0),ot.buffers.depth.setMask(!0),ot.buffers.color.setMask(!0),ot.setPolygonOffset(!1)}function gl(T,H,j,$){if((j.isScene===!0?j.overrideMaterial:null)!==null)return;p.state.transmissionRenderTarget[$.id]===void 0&&(p.state.transmissionRenderTarget[$.id]=new es(1,1,{generateMipmaps:!0,type:st.has("EXT_color_buffer_half_float")||st.has("EXT_color_buffer_float")?gr:gi,minFilter:Pi,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ae.workingColorSpace}));const xt=p.state.transmissionRenderTarget[$.id],Ct=$.viewport||v;xt.setSize(Ct.z,Ct.w);const Dt=x.getRenderTarget();x.setRenderTarget(xt),x.getClearColor(N),X=x.getClearAlpha(),X<1&&x.setClearColor(16777215,.5),x.clear(),At&&kt.render(j);const Nt=x.toneMapping;x.toneMapping=Oi;const Wt=$.viewport;if($.viewport!==void 0&&($.viewport=void 0),p.setupLightsView($),Q===!0&&ht.setGlobalState(x.clippingPlanes,$),Mr(T,j,$),R.updateMultisampleRenderTarget(xt),R.updateRenderTargetMipmap(xt),st.has("WEBGL_multisampled_render_to_texture")===!1){let Xt=!1;for(let Ot=0,ce=H.length;Ot<ce;Ot++){const ge=H[Ot],Se=ge.object,an=ge.geometry,re=ge.material,Ft=ge.group;if(re.side===zn&&Se.layers.test($.layers)){const Ge=re.side;re.side=Qe,re.needsUpdate=!0,_l(Se,j,$,an,re,Ft),re.side=Ge,re.needsUpdate=!0,Xt=!0}}Xt===!0&&(R.updateMultisampleRenderTarget(xt),R.updateRenderTargetMipmap(xt))}x.setRenderTarget(Dt),x.setClearColor(N,X),Wt!==void 0&&($.viewport=Wt),x.toneMapping=Nt}function Mr(T,H,j){const $=H.isScene===!0?H.overrideMaterial:null;for(let G=0,xt=T.length;G<xt;G++){const Ct=T[G],Dt=Ct.object,Nt=Ct.geometry,Wt=$===null?Ct.material:$,Xt=Ct.group;Dt.layers.test(j.layers)&&_l(Dt,H,j,Nt,Wt,Xt)}}function _l(T,H,j,$,G,xt){T.onBeforeRender(x,H,j,$,G,xt),T.modelViewMatrix.multiplyMatrices(j.matrixWorldInverse,T.matrixWorld),T.normalMatrix.getNormalMatrix(T.modelViewMatrix),G.onBeforeRender(x,H,j,$,T,xt),G.transparent===!0&&G.side===zn&&G.forceSinglePass===!1?(G.side=Qe,G.needsUpdate=!0,x.renderBufferDirect(j,H,$,G,T,xt),G.side=ti,G.needsUpdate=!0,x.renderBufferDirect(j,H,$,G,T,xt),G.side=zn):x.renderBufferDirect(j,H,$,G,T,xt),T.onAfterRender(x,H,j,$,G,xt)}function Sr(T,H,j){H.isScene!==!0&&(H=Et);const $=rt.get(T),G=p.state.lights,xt=p.state.shadowsArray,Ct=G.state.version,Dt=Lt.getParameters(T,G.state,xt,H,j),Nt=Lt.getProgramCacheKey(Dt);let Wt=$.programs;$.environment=T.isMeshStandardMaterial?H.environment:null,$.fog=H.fog,$.envMap=(T.isMeshStandardMaterial?B:M).get(T.envMap||$.environment),$.envMapRotation=$.environment!==null&&T.envMap===null?H.environmentRotation:T.envMapRotation,Wt===void 0&&(T.addEventListener("dispose",$t),Wt=new Map,$.programs=Wt);let Xt=Wt.get(Nt);if(Xt!==void 0){if($.currentProgram===Xt&&$.lightsStateVersion===Ct)return vl(T,Dt),Xt}else Dt.uniforms=Lt.getUniforms(T),T.onBeforeCompile(Dt,x),Xt=Lt.acquireProgram(Dt,Nt),Wt.set(Nt,Xt),$.uniforms=Dt.uniforms;const Ot=$.uniforms;return(!T.isShaderMaterial&&!T.isRawShaderMaterial||T.clipping===!0)&&(Ot.clippingPlanes=ht.uniform),vl(T,Dt),$.needsLights=bd(T),$.lightsStateVersion=Ct,$.needsLights&&(Ot.ambientLightColor.value=G.state.ambient,Ot.lightProbe.value=G.state.probe,Ot.directionalLights.value=G.state.directional,Ot.directionalLightShadows.value=G.state.directionalShadow,Ot.spotLights.value=G.state.spot,Ot.spotLightShadows.value=G.state.spotShadow,Ot.rectAreaLights.value=G.state.rectArea,Ot.ltc_1.value=G.state.rectAreaLTC1,Ot.ltc_2.value=G.state.rectAreaLTC2,Ot.pointLights.value=G.state.point,Ot.pointLightShadows.value=G.state.pointShadow,Ot.hemisphereLights.value=G.state.hemi,Ot.directionalShadowMap.value=G.state.directionalShadowMap,Ot.directionalShadowMatrix.value=G.state.directionalShadowMatrix,Ot.spotShadowMap.value=G.state.spotShadowMap,Ot.spotLightMatrix.value=G.state.spotLightMatrix,Ot.spotLightMap.value=G.state.spotLightMap,Ot.pointShadowMap.value=G.state.pointShadowMap,Ot.pointShadowMatrix.value=G.state.pointShadowMatrix),$.currentProgram=Xt,$.uniformsList=null,Xt}function xl(T){if(T.uniformsList===null){const H=T.currentProgram.getUniforms();T.uniformsList=mo.seqWithValue(H.seq,T.uniforms)}return T.uniformsList}function vl(T,H){const j=rt.get(T);j.outputColorSpace=H.outputColorSpace,j.batching=H.batching,j.batchingColor=H.batchingColor,j.instancing=H.instancing,j.instancingColor=H.instancingColor,j.instancingMorph=H.instancingMorph,j.skinning=H.skinning,j.morphTargets=H.morphTargets,j.morphNormals=H.morphNormals,j.morphColors=H.morphColors,j.morphTargetsCount=H.morphTargetsCount,j.numClippingPlanes=H.numClippingPlanes,j.numIntersection=H.numClipIntersection,j.vertexAlphas=H.vertexAlphas,j.vertexTangents=H.vertexTangents,j.toneMapping=H.toneMapping}function wd(T,H,j,$,G){H.isScene!==!0&&(H=Et),R.resetTextureUnits();const xt=H.fog,Ct=$.isMeshStandardMaterial?H.environment:null,Dt=b===null?x.outputColorSpace:b.isXRRenderTarget===!0?b.texture.colorSpace:zi,Nt=($.isMeshStandardMaterial?B:M).get($.envMap||Ct),Wt=$.vertexColors===!0&&!!j.attributes.color&&j.attributes.color.itemSize===4,Xt=!!j.attributes.tangent&&(!!$.normalMap||$.anisotropy>0),Ot=!!j.morphAttributes.position,ce=!!j.morphAttributes.normal,ge=!!j.morphAttributes.color;let Se=Oi;$.toneMapped&&(b===null||b.isXRRenderTarget===!0)&&(Se=x.toneMapping);const an=j.morphAttributes.position||j.morphAttributes.normal||j.morphAttributes.color,re=an!==void 0?an.length:0,Ft=rt.get($),Ge=p.state.lights;if(Q===!0&&(F===!0||T!==D)){const gn=T===D&&$.id===P;ht.setState($,T,gn)}let oe=!1;$.version===Ft.__version?(Ft.needsLights&&Ft.lightsStateVersion!==Ge.state.version||Ft.outputColorSpace!==Dt||G.isBatchedMesh&&Ft.batching===!1||!G.isBatchedMesh&&Ft.batching===!0||G.isBatchedMesh&&Ft.batchingColor===!0&&G.colorTexture===null||G.isBatchedMesh&&Ft.batchingColor===!1&&G.colorTexture!==null||G.isInstancedMesh&&Ft.instancing===!1||!G.isInstancedMesh&&Ft.instancing===!0||G.isSkinnedMesh&&Ft.skinning===!1||!G.isSkinnedMesh&&Ft.skinning===!0||G.isInstancedMesh&&Ft.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&Ft.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&Ft.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&Ft.instancingMorph===!1&&G.morphTexture!==null||Ft.envMap!==Nt||$.fog===!0&&Ft.fog!==xt||Ft.numClippingPlanes!==void 0&&(Ft.numClippingPlanes!==ht.numPlanes||Ft.numIntersection!==ht.numIntersection)||Ft.vertexAlphas!==Wt||Ft.vertexTangents!==Xt||Ft.morphTargets!==Ot||Ft.morphNormals!==ce||Ft.morphColors!==ge||Ft.toneMapping!==Se||Ft.morphTargetsCount!==re)&&(oe=!0):(oe=!0,Ft.__version=$.version);let Pn=Ft.currentProgram;oe===!0&&(Pn=Sr($,H,G));let os=!1,cn=!1,zo=!1;const be=Pn.getUniforms(),vi=Ft.uniforms;if(ot.useProgram(Pn.program)&&(os=!0,cn=!0,zo=!0),$.id!==P&&(P=$.id,cn=!0),os||D!==T){it.reverseDepthBuffer?(dt.copy(T.projectionMatrix),jf(dt),Kf(dt),be.setValue(E,"projectionMatrix",dt)):be.setValue(E,"projectionMatrix",T.projectionMatrix),be.setValue(E,"viewMatrix",T.matrixWorldInverse);const gn=be.map.cameraPosition;gn!==void 0&&gn.setValue(E,vt.setFromMatrixPosition(T.matrixWorld)),it.logarithmicDepthBuffer&&be.setValue(E,"logDepthBufFC",2/(Math.log(T.far+1)/Math.LN2)),($.isMeshPhongMaterial||$.isMeshToonMaterial||$.isMeshLambertMaterial||$.isMeshBasicMaterial||$.isMeshStandardMaterial||$.isShaderMaterial)&&be.setValue(E,"isOrthographic",T.isOrthographicCamera===!0),D!==T&&(D=T,cn=!0,zo=!0)}if(G.isSkinnedMesh){be.setOptional(E,G,"bindMatrix"),be.setOptional(E,G,"bindMatrixInverse");const gn=G.skeleton;gn&&(gn.boneTexture===null&&gn.computeBoneTexture(),be.setValue(E,"boneTexture",gn.boneTexture,R))}G.isBatchedMesh&&(be.setOptional(E,G,"batchingTexture"),be.setValue(E,"batchingTexture",G._matricesTexture,R),be.setOptional(E,G,"batchingIdTexture"),be.setValue(E,"batchingIdTexture",G._indirectTexture,R),be.setOptional(E,G,"batchingColorTexture"),G._colorsTexture!==null&&be.setValue(E,"batchingColorTexture",G._colorsTexture,R));const ko=j.morphAttributes;if((ko.position!==void 0||ko.normal!==void 0||ko.color!==void 0)&&Bt.update(G,j,Pn),(cn||Ft.receiveShadow!==G.receiveShadow)&&(Ft.receiveShadow=G.receiveShadow,be.setValue(E,"receiveShadow",G.receiveShadow)),$.isMeshGouraudMaterial&&$.envMap!==null&&(vi.envMap.value=Nt,vi.flipEnvMap.value=Nt.isCubeTexture&&Nt.isRenderTargetTexture===!1?-1:1),$.isMeshStandardMaterial&&$.envMap===null&&H.environment!==null&&(vi.envMapIntensity.value=H.environmentIntensity),cn&&(be.setValue(E,"toneMappingExposure",x.toneMappingExposure),Ft.needsLights&&Ed(vi,zo),xt&&$.fog===!0&&lt.refreshFogUniforms(vi,xt),lt.refreshMaterialUniforms(vi,$,K,V,p.state.transmissionRenderTarget[T.id]),mo.upload(E,xl(Ft),vi,R)),$.isShaderMaterial&&$.uniformsNeedUpdate===!0&&(mo.upload(E,xl(Ft),vi,R),$.uniformsNeedUpdate=!1),$.isSpriteMaterial&&be.setValue(E,"center",G.center),be.setValue(E,"modelViewMatrix",G.modelViewMatrix),be.setValue(E,"normalMatrix",G.normalMatrix),be.setValue(E,"modelMatrix",G.matrixWorld),$.isShaderMaterial||$.isRawShaderMaterial){const gn=$.uniformsGroups;for(let Bo=0,Td=gn.length;Bo<Td;Bo++){const yl=gn[Bo];z.update(yl,Pn),z.bind(yl,Pn)}}return Pn}function Ed(T,H){T.ambientLightColor.needsUpdate=H,T.lightProbe.needsUpdate=H,T.directionalLights.needsUpdate=H,T.directionalLightShadows.needsUpdate=H,T.pointLights.needsUpdate=H,T.pointLightShadows.needsUpdate=H,T.spotLights.needsUpdate=H,T.spotLightShadows.needsUpdate=H,T.rectAreaLights.needsUpdate=H,T.hemisphereLights.needsUpdate=H}function bd(T){return T.isMeshLambertMaterial||T.isMeshToonMaterial||T.isMeshPhongMaterial||T.isMeshStandardMaterial||T.isShadowMaterial||T.isShaderMaterial&&T.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return A},this.getRenderTarget=function(){return b},this.setRenderTargetTextures=function(T,H,j){rt.get(T.texture).__webglTexture=H,rt.get(T.depthTexture).__webglTexture=j;const $=rt.get(T);$.__hasExternalTextures=!0,$.__autoAllocateDepthBuffer=j===void 0,$.__autoAllocateDepthBuffer||st.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),$.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(T,H){const j=rt.get(T);j.__webglFramebuffer=H,j.__useDefaultFramebuffer=H===void 0},this.setRenderTarget=function(T,H=0,j=0){b=T,C=H,A=j;let $=!0,G=null,xt=!1,Ct=!1;if(T){const Nt=rt.get(T);if(Nt.__useDefaultFramebuffer!==void 0)ot.bindFramebuffer(E.FRAMEBUFFER,null),$=!1;else if(Nt.__webglFramebuffer===void 0)R.setupRenderTarget(T);else if(Nt.__hasExternalTextures)R.rebindTextures(T,rt.get(T.texture).__webglTexture,rt.get(T.depthTexture).__webglTexture);else if(T.depthBuffer){const Ot=T.depthTexture;if(Nt.__boundDepthTexture!==Ot){if(Ot!==null&&rt.has(Ot)&&(T.width!==Ot.image.width||T.height!==Ot.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");R.setupDepthRenderbuffer(T)}}const Wt=T.texture;(Wt.isData3DTexture||Wt.isDataArrayTexture||Wt.isCompressedArrayTexture)&&(Ct=!0);const Xt=rt.get(T).__webglFramebuffer;T.isWebGLCubeRenderTarget?(Array.isArray(Xt[H])?G=Xt[H][j]:G=Xt[H],xt=!0):T.samples>0&&R.useMultisampledRTT(T)===!1?G=rt.get(T).__webglMultisampledFramebuffer:Array.isArray(Xt)?G=Xt[j]:G=Xt,v.copy(T.viewport),w.copy(T.scissor),U=T.scissorTest}else v.copy(mt).multiplyScalar(K).floor(),w.copy(ct).multiplyScalar(K).floor(),U=zt;if(ot.bindFramebuffer(E.FRAMEBUFFER,G)&&$&&ot.drawBuffers(T,G),ot.viewport(v),ot.scissor(w),ot.setScissorTest(U),xt){const Nt=rt.get(T.texture);E.framebufferTexture2D(E.FRAMEBUFFER,E.COLOR_ATTACHMENT0,E.TEXTURE_CUBE_MAP_POSITIVE_X+H,Nt.__webglTexture,j)}else if(Ct){const Nt=rt.get(T.texture),Wt=H||0;E.framebufferTextureLayer(E.FRAMEBUFFER,E.COLOR_ATTACHMENT0,Nt.__webglTexture,j||0,Wt)}P=-1},this.readRenderTargetPixels=function(T,H,j,$,G,xt,Ct){if(!(T&&T.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Dt=rt.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&Ct!==void 0&&(Dt=Dt[Ct]),Dt){ot.bindFramebuffer(E.FRAMEBUFFER,Dt);try{const Nt=T.texture,Wt=Nt.format,Xt=Nt.type;if(!it.textureFormatReadable(Wt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!it.textureTypeReadable(Xt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}H>=0&&H<=T.width-$&&j>=0&&j<=T.height-G&&E.readPixels(H,j,$,G,qt.convert(Wt),qt.convert(Xt),xt)}finally{const Nt=b!==null?rt.get(b).__webglFramebuffer:null;ot.bindFramebuffer(E.FRAMEBUFFER,Nt)}}},this.readRenderTargetPixelsAsync=async function(T,H,j,$,G,xt,Ct){if(!(T&&T.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Dt=rt.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&Ct!==void 0&&(Dt=Dt[Ct]),Dt){const Nt=T.texture,Wt=Nt.format,Xt=Nt.type;if(!it.textureFormatReadable(Wt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!it.textureTypeReadable(Xt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(H>=0&&H<=T.width-$&&j>=0&&j<=T.height-G){ot.bindFramebuffer(E.FRAMEBUFFER,Dt);const Ot=E.createBuffer();E.bindBuffer(E.PIXEL_PACK_BUFFER,Ot),E.bufferData(E.PIXEL_PACK_BUFFER,xt.byteLength,E.STREAM_READ),E.readPixels(H,j,$,G,qt.convert(Wt),qt.convert(Xt),0);const ce=b!==null?rt.get(b).__webglFramebuffer:null;ot.bindFramebuffer(E.FRAMEBUFFER,ce);const ge=E.fenceSync(E.SYNC_GPU_COMMANDS_COMPLETE,0);return E.flush(),await Yf(E,ge,4),E.bindBuffer(E.PIXEL_PACK_BUFFER,Ot),E.getBufferSubData(E.PIXEL_PACK_BUFFER,0,xt),E.deleteBuffer(Ot),E.deleteSync(ge),xt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(T,H=null,j=0){T.isTexture!==!0&&(po("WebGLRenderer: copyFramebufferToTexture function signature has changed."),H=arguments[0]||null,T=arguments[1]);const $=Math.pow(2,-j),G=Math.floor(T.image.width*$),xt=Math.floor(T.image.height*$),Ct=H!==null?H.x:0,Dt=H!==null?H.y:0;R.setTexture2D(T,0),E.copyTexSubImage2D(E.TEXTURE_2D,j,0,0,Ct,Dt,G,xt),ot.unbindTexture()},this.copyTextureToTexture=function(T,H,j=null,$=null,G=0){T.isTexture!==!0&&(po("WebGLRenderer: copyTextureToTexture function signature has changed."),$=arguments[0]||null,T=arguments[1],H=arguments[2],G=arguments[3]||0,j=null);let xt,Ct,Dt,Nt,Wt,Xt;j!==null?(xt=j.max.x-j.min.x,Ct=j.max.y-j.min.y,Dt=j.min.x,Nt=j.min.y):(xt=T.image.width,Ct=T.image.height,Dt=0,Nt=0),$!==null?(Wt=$.x,Xt=$.y):(Wt=0,Xt=0);const Ot=qt.convert(H.format),ce=qt.convert(H.type);R.setTexture2D(H,0),E.pixelStorei(E.UNPACK_FLIP_Y_WEBGL,H.flipY),E.pixelStorei(E.UNPACK_PREMULTIPLY_ALPHA_WEBGL,H.premultiplyAlpha),E.pixelStorei(E.UNPACK_ALIGNMENT,H.unpackAlignment);const ge=E.getParameter(E.UNPACK_ROW_LENGTH),Se=E.getParameter(E.UNPACK_IMAGE_HEIGHT),an=E.getParameter(E.UNPACK_SKIP_PIXELS),re=E.getParameter(E.UNPACK_SKIP_ROWS),Ft=E.getParameter(E.UNPACK_SKIP_IMAGES),Ge=T.isCompressedTexture?T.mipmaps[G]:T.image;E.pixelStorei(E.UNPACK_ROW_LENGTH,Ge.width),E.pixelStorei(E.UNPACK_IMAGE_HEIGHT,Ge.height),E.pixelStorei(E.UNPACK_SKIP_PIXELS,Dt),E.pixelStorei(E.UNPACK_SKIP_ROWS,Nt),T.isDataTexture?E.texSubImage2D(E.TEXTURE_2D,G,Wt,Xt,xt,Ct,Ot,ce,Ge.data):T.isCompressedTexture?E.compressedTexSubImage2D(E.TEXTURE_2D,G,Wt,Xt,Ge.width,Ge.height,Ot,Ge.data):E.texSubImage2D(E.TEXTURE_2D,G,Wt,Xt,xt,Ct,Ot,ce,Ge),E.pixelStorei(E.UNPACK_ROW_LENGTH,ge),E.pixelStorei(E.UNPACK_IMAGE_HEIGHT,Se),E.pixelStorei(E.UNPACK_SKIP_PIXELS,an),E.pixelStorei(E.UNPACK_SKIP_ROWS,re),E.pixelStorei(E.UNPACK_SKIP_IMAGES,Ft),G===0&&H.generateMipmaps&&E.generateMipmap(E.TEXTURE_2D),ot.unbindTexture()},this.copyTextureToTexture3D=function(T,H,j=null,$=null,G=0){T.isTexture!==!0&&(po("WebGLRenderer: copyTextureToTexture3D function signature has changed."),j=arguments[0]||null,$=arguments[1]||null,T=arguments[2],H=arguments[3],G=arguments[4]||0);let xt,Ct,Dt,Nt,Wt,Xt,Ot,ce,ge;const Se=T.isCompressedTexture?T.mipmaps[G]:T.image;j!==null?(xt=j.max.x-j.min.x,Ct=j.max.y-j.min.y,Dt=j.max.z-j.min.z,Nt=j.min.x,Wt=j.min.y,Xt=j.min.z):(xt=Se.width,Ct=Se.height,Dt=Se.depth,Nt=0,Wt=0,Xt=0),$!==null?(Ot=$.x,ce=$.y,ge=$.z):(Ot=0,ce=0,ge=0);const an=qt.convert(H.format),re=qt.convert(H.type);let Ft;if(H.isData3DTexture)R.setTexture3D(H,0),Ft=E.TEXTURE_3D;else if(H.isDataArrayTexture||H.isCompressedArrayTexture)R.setTexture2DArray(H,0),Ft=E.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}E.pixelStorei(E.UNPACK_FLIP_Y_WEBGL,H.flipY),E.pixelStorei(E.UNPACK_PREMULTIPLY_ALPHA_WEBGL,H.premultiplyAlpha),E.pixelStorei(E.UNPACK_ALIGNMENT,H.unpackAlignment);const Ge=E.getParameter(E.UNPACK_ROW_LENGTH),oe=E.getParameter(E.UNPACK_IMAGE_HEIGHT),Pn=E.getParameter(E.UNPACK_SKIP_PIXELS),os=E.getParameter(E.UNPACK_SKIP_ROWS),cn=E.getParameter(E.UNPACK_SKIP_IMAGES);E.pixelStorei(E.UNPACK_ROW_LENGTH,Se.width),E.pixelStorei(E.UNPACK_IMAGE_HEIGHT,Se.height),E.pixelStorei(E.UNPACK_SKIP_PIXELS,Nt),E.pixelStorei(E.UNPACK_SKIP_ROWS,Wt),E.pixelStorei(E.UNPACK_SKIP_IMAGES,Xt),T.isDataTexture||T.isData3DTexture?E.texSubImage3D(Ft,G,Ot,ce,ge,xt,Ct,Dt,an,re,Se.data):H.isCompressedArrayTexture?E.compressedTexSubImage3D(Ft,G,Ot,ce,ge,xt,Ct,Dt,an,Se.data):E.texSubImage3D(Ft,G,Ot,ce,ge,xt,Ct,Dt,an,re,Se),E.pixelStorei(E.UNPACK_ROW_LENGTH,Ge),E.pixelStorei(E.UNPACK_IMAGE_HEIGHT,oe),E.pixelStorei(E.UNPACK_SKIP_PIXELS,Pn),E.pixelStorei(E.UNPACK_SKIP_ROWS,os),E.pixelStorei(E.UNPACK_SKIP_IMAGES,cn),G===0&&H.generateMipmaps&&E.generateMipmap(Ft),ot.unbindTexture()},this.initRenderTarget=function(T){rt.get(T).__webglFramebuffer===void 0&&R.setupRenderTarget(T)},this.initTexture=function(T){T.isCubeTexture?R.setTextureCube(T,0):T.isData3DTexture?R.setTexture3D(T,0):T.isDataArrayTexture||T.isCompressedArrayTexture?R.setTexture2DArray(T,0):R.setTexture2D(T,0),ot.unbindTexture()},this.resetState=function(){C=0,A=0,b=null,ot.reset(),se.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return pi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=t===Zc?"display-p3":"srgb",e.unpackColorSpace=ae.workingColorSpace===Co?"display-p3":"srgb"}}class nl{constructor(t,e=1,n=1e3){this.isFog=!0,this.name="",this.color=new Gt(t),this.near=e,this.far=n}clone(){return new nl(this.color,this.near,this.far)}toJSON(){return{type:"Fog",name:this.name,color:this.color.getHex(),near:this.near,far:this.far}}}class ox extends Re{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Hn,this.environmentIntensity=1,this.environmentRotation=new Hn,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(t,e){return super.copy(t,e),t.background!==null&&(this.background=t.background.clone()),t.environment!==null&&(this.environment=t.environment.clone()),t.fog!==null&&(this.fog=t.fog.clone()),this.backgroundBlurriness=t.backgroundBlurriness,this.backgroundIntensity=t.backgroundIntensity,this.backgroundRotation.copy(t.backgroundRotation),this.environmentIntensity=t.environmentIntensity,this.environmentRotation.copy(t.environmentRotation),t.overrideMaterial!==null&&(this.overrideMaterial=t.overrideMaterial.clone()),this.matrixAutoUpdate=t.matrixAutoUpdate,this}toJSON(t){const e=super.toJSON(t);return this.fog!==null&&(e.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(e.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(e.object.backgroundIntensity=this.backgroundIntensity),e.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(e.object.environmentIntensity=this.environmentIntensity),e.object.environmentRotation=this.environmentRotation.toArray(),e}}class Gu extends ss{constructor(t){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new Gt(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.alphaMap=t.alphaMap,this.size=t.size,this.sizeAttenuation=t.sizeAttenuation,this.fog=t.fog,this}}const vh=new xe,bc=new Qc,Wr=new Po,qr=new I;class ax extends Re{constructor(t=new $e,e=new Gu){super(),this.isPoints=!0,this.type="Points",this.geometry=t,this.material=e,this.updateMorphTargets()}copy(t,e){return super.copy(t,e),this.material=Array.isArray(t.material)?t.material.slice():t.material,this.geometry=t.geometry,this}raycast(t,e){const n=this.geometry,s=this.matrixWorld,r=t.params.Points.threshold,o=n.drawRange;if(n.boundingSphere===null&&n.computeBoundingSphere(),Wr.copy(n.boundingSphere),Wr.applyMatrix4(s),Wr.radius+=r,t.ray.intersectsSphere(Wr)===!1)return;vh.copy(s).invert(),bc.copy(t.ray).applyMatrix4(vh);const a=r/((this.scale.x+this.scale.y+this.scale.z)/3),c=a*a,l=n.index,u=n.attributes.position;if(l!==null){const d=Math.max(0,o.start),f=Math.min(l.count,o.start+o.count);for(let m=d,_=f;m<_;m++){const p=l.getX(m);qr.fromBufferAttribute(u,p),yh(qr,p,c,s,t,e,this)}}else{const d=Math.max(0,o.start),f=Math.min(u.count,o.start+o.count);for(let m=d,_=f;m<_;m++)qr.fromBufferAttribute(u,m),yh(qr,m,c,s,t,e,this)}}updateMorphTargets(){const e=this.geometry.morphAttributes,n=Object.keys(e);if(n.length>0){const s=e[n[0]];if(s!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let r=0,o=s.length;r<o;r++){const a=s[r].name||String(r);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=r}}}}}function yh(i,t,e,n,s,r,o){const a=bc.distanceSqToPoint(i);if(a<e){const c=new I;bc.closestPointToPoint(i,c),c.applyMatrix4(n);const l=s.ray.origin.distanceTo(c);if(l<s.near||l>s.far)return;r.push({distance:l,distanceToRay:Math.sqrt(a),point:c,index:t,face:null,faceIndex:null,barycoord:null,object:o})}}class Vn extends tn{constructor(t,e,n,s,r,o,a,c,l){super(t,e,n,s,r,o,a,c,l),this.isCanvasTexture=!0,this.needsUpdate=!0}}class ni{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(t,e){const n=this.getUtoTmapping(t);return this.getPoint(n,e)}getPoints(t=5){const e=[];for(let n=0;n<=t;n++)e.push(this.getPoint(n/t));return e}getSpacedPoints(t=5){const e=[];for(let n=0;n<=t;n++)e.push(this.getPointAt(n/t));return e}getLength(){const t=this.getLengths();return t[t.length-1]}getLengths(t=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===t+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const e=[];let n,s=this.getPoint(0),r=0;e.push(0);for(let o=1;o<=t;o++)n=this.getPoint(o/t),r+=n.distanceTo(s),e.push(r),s=n;return this.cacheArcLengths=e,e}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(t,e){const n=this.getLengths();let s=0;const r=n.length;let o;e?o=e:o=t*n[r-1];let a=0,c=r-1,l;for(;a<=c;)if(s=Math.floor(a+(c-a)/2),l=n[s]-o,l<0)a=s+1;else if(l>0)c=s-1;else{c=s;break}if(s=c,n[s]===o)return s/(r-1);const h=n[s],d=n[s+1]-h,f=(o-h)/d;return(s+f)/(r-1)}getTangent(t,e){let s=t-1e-4,r=t+1e-4;s<0&&(s=0),r>1&&(r=1);const o=this.getPoint(s),a=this.getPoint(r),c=e||(o.isVector2?new St:new I);return c.copy(a).sub(o).normalize(),c}getTangentAt(t,e){const n=this.getUtoTmapping(t);return this.getTangent(n,e)}computeFrenetFrames(t,e){const n=new I,s=[],r=[],o=[],a=new I,c=new xe;for(let f=0;f<=t;f++){const m=f/t;s[f]=this.getTangentAt(m,new I)}r[0]=new I,o[0]=new I;let l=Number.MAX_VALUE;const h=Math.abs(s[0].x),u=Math.abs(s[0].y),d=Math.abs(s[0].z);h<=l&&(l=h,n.set(1,0,0)),u<=l&&(l=u,n.set(0,1,0)),d<=l&&n.set(0,0,1),a.crossVectors(s[0],n).normalize(),r[0].crossVectors(s[0],a),o[0].crossVectors(s[0],r[0]);for(let f=1;f<=t;f++){if(r[f]=r[f-1].clone(),o[f]=o[f-1].clone(),a.crossVectors(s[f-1],s[f]),a.length()>Number.EPSILON){a.normalize();const m=Math.acos(Ye(s[f-1].dot(s[f]),-1,1));r[f].applyMatrix4(c.makeRotationAxis(a,m))}o[f].crossVectors(s[f],r[f])}if(e===!0){let f=Math.acos(Ye(r[0].dot(r[t]),-1,1));f/=t,s[0].dot(a.crossVectors(r[0],r[t]))>0&&(f=-f);for(let m=1;m<=t;m++)r[m].applyMatrix4(c.makeRotationAxis(s[m],f*m)),o[m].crossVectors(s[m],r[m])}return{tangents:s,normals:r,binormals:o}}clone(){return new this.constructor().copy(this)}copy(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}toJSON(){const t={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return t.arcLengthDivisions=this.arcLengthDivisions,t.type=this.type,t}fromJSON(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}}class il extends ni{constructor(t=0,e=0,n=1,s=1,r=0,o=Math.PI*2,a=!1,c=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=t,this.aY=e,this.xRadius=n,this.yRadius=s,this.aStartAngle=r,this.aEndAngle=o,this.aClockwise=a,this.aRotation=c}getPoint(t,e=new St){const n=e,s=Math.PI*2;let r=this.aEndAngle-this.aStartAngle;const o=Math.abs(r)<Number.EPSILON;for(;r<0;)r+=s;for(;r>s;)r-=s;r<Number.EPSILON&&(o?r=0:r=s),this.aClockwise===!0&&!o&&(r===s?r=-s:r=r-s);const a=this.aStartAngle+t*r;let c=this.aX+this.xRadius*Math.cos(a),l=this.aY+this.yRadius*Math.sin(a);if(this.aRotation!==0){const h=Math.cos(this.aRotation),u=Math.sin(this.aRotation),d=c-this.aX,f=l-this.aY;c=d*h-f*u+this.aX,l=d*u+f*h+this.aY}return n.set(c,l)}copy(t){return super.copy(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}toJSON(){const t=super.toJSON();return t.aX=this.aX,t.aY=this.aY,t.xRadius=this.xRadius,t.yRadius=this.yRadius,t.aStartAngle=this.aStartAngle,t.aEndAngle=this.aEndAngle,t.aClockwise=this.aClockwise,t.aRotation=this.aRotation,t}fromJSON(t){return super.fromJSON(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}}class cx extends il{constructor(t,e,n,s,r,o){super(t,e,n,n,s,r,o),this.isArcCurve=!0,this.type="ArcCurve"}}function sl(){let i=0,t=0,e=0,n=0;function s(r,o,a,c){i=r,t=a,e=-3*r+3*o-2*a-c,n=2*r-2*o+a+c}return{initCatmullRom:function(r,o,a,c,l){s(o,a,l*(a-r),l*(c-o))},initNonuniformCatmullRom:function(r,o,a,c,l,h,u){let d=(o-r)/l-(a-r)/(l+h)+(a-o)/h,f=(a-o)/h-(c-o)/(h+u)+(c-a)/u;d*=h,f*=h,s(o,a,d,f)},calc:function(r){const o=r*r,a=o*r;return i+t*r+e*o+n*a}}}const Xr=new I,ga=new sl,_a=new sl,xa=new sl;class lx extends ni{constructor(t=[],e=!1,n="centripetal",s=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=t,this.closed=e,this.curveType=n,this.tension=s}getPoint(t,e=new I){const n=e,s=this.points,r=s.length,o=(r-(this.closed?0:1))*t;let a=Math.floor(o),c=o-a;this.closed?a+=a>0?0:(Math.floor(Math.abs(a)/r)+1)*r:c===0&&a===r-1&&(a=r-2,c=1);let l,h;this.closed||a>0?l=s[(a-1)%r]:(Xr.subVectors(s[0],s[1]).add(s[0]),l=Xr);const u=s[a%r],d=s[(a+1)%r];if(this.closed||a+2<r?h=s[(a+2)%r]:(Xr.subVectors(s[r-1],s[r-2]).add(s[r-1]),h=Xr),this.curveType==="centripetal"||this.curveType==="chordal"){const f=this.curveType==="chordal"?.5:.25;let m=Math.pow(l.distanceToSquared(u),f),_=Math.pow(u.distanceToSquared(d),f),p=Math.pow(d.distanceToSquared(h),f);_<1e-4&&(_=1),m<1e-4&&(m=_),p<1e-4&&(p=_),ga.initNonuniformCatmullRom(l.x,u.x,d.x,h.x,m,_,p),_a.initNonuniformCatmullRom(l.y,u.y,d.y,h.y,m,_,p),xa.initNonuniformCatmullRom(l.z,u.z,d.z,h.z,m,_,p)}else this.curveType==="catmullrom"&&(ga.initCatmullRom(l.x,u.x,d.x,h.x,this.tension),_a.initCatmullRom(l.y,u.y,d.y,h.y,this.tension),xa.initCatmullRom(l.z,u.z,d.z,h.z,this.tension));return n.set(ga.calc(c),_a.calc(c),xa.calc(c)),n}copy(t){super.copy(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const s=t.points[e];this.points.push(s.clone())}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}toJSON(){const t=super.toJSON();t.points=[];for(let e=0,n=this.points.length;e<n;e++){const s=this.points[e];t.points.push(s.toArray())}return t.closed=this.closed,t.curveType=this.curveType,t.tension=this.tension,t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const s=t.points[e];this.points.push(new I().fromArray(s))}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}}function Mh(i,t,e,n,s){const r=(n-t)*.5,o=(s-e)*.5,a=i*i,c=i*a;return(2*e-2*n+r+o)*c+(-3*e+3*n-2*r-o)*a+r*i+e}function hx(i,t){const e=1-i;return e*e*t}function ux(i,t){return 2*(1-i)*i*t}function dx(i,t){return i*i*t}function cr(i,t,e,n){return hx(i,t)+ux(i,e)+dx(i,n)}function fx(i,t){const e=1-i;return e*e*e*t}function px(i,t){const e=1-i;return 3*e*e*i*t}function mx(i,t){return 3*(1-i)*i*i*t}function gx(i,t){return i*i*i*t}function lr(i,t,e,n,s){return fx(i,t)+px(i,e)+mx(i,n)+gx(i,s)}class Vu extends ni{constructor(t=new St,e=new St,n=new St,s=new St){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=t,this.v1=e,this.v2=n,this.v3=s}getPoint(t,e=new St){const n=e,s=this.v0,r=this.v1,o=this.v2,a=this.v3;return n.set(lr(t,s.x,r.x,o.x,a.x),lr(t,s.y,r.y,o.y,a.y)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}}class _x extends ni{constructor(t=new I,e=new I,n=new I,s=new I){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=t,this.v1=e,this.v2=n,this.v3=s}getPoint(t,e=new I){const n=e,s=this.v0,r=this.v1,o=this.v2,a=this.v3;return n.set(lr(t,s.x,r.x,o.x,a.x),lr(t,s.y,r.y,o.y,a.y),lr(t,s.z,r.z,o.z,a.z)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}}class Wu extends ni{constructor(t=new St,e=new St){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=t,this.v2=e}getPoint(t,e=new St){const n=e;return t===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(t).add(this.v1)),n}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new St){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class xx extends ni{constructor(t=new I,e=new I){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=t,this.v2=e}getPoint(t,e=new I){const n=e;return t===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(t).add(this.v1)),n}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new I){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class qu extends ni{constructor(t=new St,e=new St,n=new St){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=t,this.v1=e,this.v2=n}getPoint(t,e=new St){const n=e,s=this.v0,r=this.v1,o=this.v2;return n.set(cr(t,s.x,r.x,o.x),cr(t,s.y,r.y,o.y)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class vx extends ni{constructor(t=new I,e=new I,n=new I){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=t,this.v1=e,this.v2=n}getPoint(t,e=new I){const n=e,s=this.v0,r=this.v1,o=this.v2;return n.set(cr(t,s.x,r.x,o.x),cr(t,s.y,r.y,o.y),cr(t,s.z,r.z,o.z)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Xu extends ni{constructor(t=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=t}getPoint(t,e=new St){const n=e,s=this.points,r=(s.length-1)*t,o=Math.floor(r),a=r-o,c=s[o===0?o:o-1],l=s[o],h=s[o>s.length-2?s.length-1:o+1],u=s[o>s.length-3?s.length-1:o+2];return n.set(Mh(a,c.x,l.x,h.x,u.x),Mh(a,c.y,l.y,h.y,u.y)),n}copy(t){super.copy(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const s=t.points[e];this.points.push(s.clone())}return this}toJSON(){const t=super.toJSON();t.points=[];for(let e=0,n=this.points.length;e<n;e++){const s=this.points[e];t.points.push(s.toArray())}return t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const s=t.points[e];this.points.push(new St().fromArray(s))}return this}}var Tc=Object.freeze({__proto__:null,ArcCurve:cx,CatmullRomCurve3:lx,CubicBezierCurve:Vu,CubicBezierCurve3:_x,EllipseCurve:il,LineCurve:Wu,LineCurve3:xx,QuadraticBezierCurve:qu,QuadraticBezierCurve3:vx,SplineCurve:Xu});class yx extends ni{constructor(){super(),this.type="CurvePath",this.curves=[],this.autoClose=!1}add(t){this.curves.push(t)}closePath(){const t=this.curves[0].getPoint(0),e=this.curves[this.curves.length-1].getPoint(1);if(!t.equals(e)){const n=t.isVector2===!0?"LineCurve":"LineCurve3";this.curves.push(new Tc[n](e,t))}return this}getPoint(t,e){const n=t*this.getLength(),s=this.getCurveLengths();let r=0;for(;r<s.length;){if(s[r]>=n){const o=s[r]-n,a=this.curves[r],c=a.getLength(),l=c===0?0:1-o/c;return a.getPointAt(l,e)}r++}return null}getLength(){const t=this.getCurveLengths();return t[t.length-1]}updateArcLengths(){this.needsUpdate=!0,this.cacheLengths=null,this.getCurveLengths()}getCurveLengths(){if(this.cacheLengths&&this.cacheLengths.length===this.curves.length)return this.cacheLengths;const t=[];let e=0;for(let n=0,s=this.curves.length;n<s;n++)e+=this.curves[n].getLength(),t.push(e);return this.cacheLengths=t,t}getSpacedPoints(t=40){const e=[];for(let n=0;n<=t;n++)e.push(this.getPoint(n/t));return this.autoClose&&e.push(e[0]),e}getPoints(t=12){const e=[];let n;for(let s=0,r=this.curves;s<r.length;s++){const o=r[s],a=o.isEllipseCurve?t*2:o.isLineCurve||o.isLineCurve3?1:o.isSplineCurve?t*o.points.length:t,c=o.getPoints(a);for(let l=0;l<c.length;l++){const h=c[l];n&&n.equals(h)||(e.push(h),n=h)}}return this.autoClose&&e.length>1&&!e[e.length-1].equals(e[0])&&e.push(e[0]),e}copy(t){super.copy(t),this.curves=[];for(let e=0,n=t.curves.length;e<n;e++){const s=t.curves[e];this.curves.push(s.clone())}return this.autoClose=t.autoClose,this}toJSON(){const t=super.toJSON();t.autoClose=this.autoClose,t.curves=[];for(let e=0,n=this.curves.length;e<n;e++){const s=this.curves[e];t.curves.push(s.toJSON())}return t}fromJSON(t){super.fromJSON(t),this.autoClose=t.autoClose,this.curves=[];for(let e=0,n=t.curves.length;e<n;e++){const s=t.curves[e];this.curves.push(new Tc[s.type]().fromJSON(s))}return this}}class Sh extends yx{constructor(t){super(),this.type="Path",this.currentPoint=new St,t&&this.setFromPoints(t)}setFromPoints(t){this.moveTo(t[0].x,t[0].y);for(let e=1,n=t.length;e<n;e++)this.lineTo(t[e].x,t[e].y);return this}moveTo(t,e){return this.currentPoint.set(t,e),this}lineTo(t,e){const n=new Wu(this.currentPoint.clone(),new St(t,e));return this.curves.push(n),this.currentPoint.set(t,e),this}quadraticCurveTo(t,e,n,s){const r=new qu(this.currentPoint.clone(),new St(t,e),new St(n,s));return this.curves.push(r),this.currentPoint.set(n,s),this}bezierCurveTo(t,e,n,s,r,o){const a=new Vu(this.currentPoint.clone(),new St(t,e),new St(n,s),new St(r,o));return this.curves.push(a),this.currentPoint.set(r,o),this}splineThru(t){const e=[this.currentPoint.clone()].concat(t),n=new Xu(e);return this.curves.push(n),this.currentPoint.copy(t[t.length-1]),this}arc(t,e,n,s,r,o){const a=this.currentPoint.x,c=this.currentPoint.y;return this.absarc(t+a,e+c,n,s,r,o),this}absarc(t,e,n,s,r,o){return this.absellipse(t,e,n,n,s,r,o),this}ellipse(t,e,n,s,r,o,a,c){const l=this.currentPoint.x,h=this.currentPoint.y;return this.absellipse(t+l,e+h,n,s,r,o,a,c),this}absellipse(t,e,n,s,r,o,a,c){const l=new il(t,e,n,s,r,o,a,c);if(this.curves.length>0){const u=l.getPoint(0);u.equals(this.currentPoint)||this.lineTo(u.x,u.y)}this.curves.push(l);const h=l.getPoint(1);return this.currentPoint.copy(h),this}copy(t){return super.copy(t),this.currentPoint.copy(t.currentPoint),this}toJSON(){const t=super.toJSON();return t.currentPoint=this.currentPoint.toArray(),t}fromJSON(t){return super.fromJSON(t),this.currentPoint.fromArray(t.currentPoint),this}}class De extends $e{constructor(t=1,e=1,n=1,s=32,r=1,o=!1,a=0,c=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:t,radiusBottom:e,height:n,radialSegments:s,heightSegments:r,openEnded:o,thetaStart:a,thetaLength:c};const l=this;s=Math.floor(s),r=Math.floor(r);const h=[],u=[],d=[],f=[];let m=0;const _=[],p=n/2;let g=0;y(),o===!1&&(t>0&&x(!0),e>0&&x(!1)),this.setIndex(h),this.setAttribute("position",new Ce(u,3)),this.setAttribute("normal",new Ce(d,3)),this.setAttribute("uv",new Ce(f,2));function y(){const S=new I,C=new I;let A=0;const b=(e-t)/n;for(let P=0;P<=r;P++){const D=[],v=P/r,w=v*(e-t)+t;for(let U=0;U<=s;U++){const N=U/s,X=N*c+a,q=Math.sin(X),V=Math.cos(X);C.x=w*q,C.y=-v*n+p,C.z=w*V,u.push(C.x,C.y,C.z),S.set(q,b,V).normalize(),d.push(S.x,S.y,S.z),f.push(N,1-v),D.push(m++)}_.push(D)}for(let P=0;P<s;P++)for(let D=0;D<r;D++){const v=_[D][P],w=_[D+1][P],U=_[D+1][P+1],N=_[D][P+1];t>0&&(h.push(v,w,N),A+=3),e>0&&(h.push(w,U,N),A+=3)}l.addGroup(g,A,0),g+=A}function x(S){const C=m,A=new St,b=new I;let P=0;const D=S===!0?t:e,v=S===!0?1:-1;for(let U=1;U<=s;U++)u.push(0,p*v,0),d.push(0,v,0),f.push(.5,.5),m++;const w=m;for(let U=0;U<=s;U++){const X=U/s*c+a,q=Math.cos(X),V=Math.sin(X);b.x=D*V,b.y=p*v,b.z=D*q,u.push(b.x,b.y,b.z),d.push(0,v,0),A.x=q*.5+.5,A.y=V*.5*v+.5,f.push(A.x,A.y),m++}for(let U=0;U<s;U++){const N=C+U,X=w+U;S===!0?h.push(X,X+1,N):h.push(X+1,X,N),P+=3}l.addGroup(g,P,S===!0?1:2),g+=P}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new De(t.radiusTop,t.radiusBottom,t.height,t.radialSegments,t.heightSegments,t.openEnded,t.thetaStart,t.thetaLength)}}class Io extends De{constructor(t=1,e=1,n=32,s=1,r=!1,o=0,a=Math.PI*2){super(0,t,e,n,s,r,o,a),this.type="ConeGeometry",this.parameters={radius:t,height:e,radialSegments:n,heightSegments:s,openEnded:r,thetaStart:o,thetaLength:a}}static fromJSON(t){return new Io(t.radius,t.height,t.radialSegments,t.heightSegments,t.openEnded,t.thetaStart,t.thetaLength)}}class rl extends $e{constructor(t=[],e=[],n=1,s=0){super(),this.type="PolyhedronGeometry",this.parameters={vertices:t,indices:e,radius:n,detail:s};const r=[],o=[];a(s),l(n),h(),this.setAttribute("position",new Ce(r,3)),this.setAttribute("normal",new Ce(r.slice(),3)),this.setAttribute("uv",new Ce(o,2)),s===0?this.computeVertexNormals():this.normalizeNormals();function a(y){const x=new I,S=new I,C=new I;for(let A=0;A<e.length;A+=3)f(e[A+0],x),f(e[A+1],S),f(e[A+2],C),c(x,S,C,y)}function c(y,x,S,C){const A=C+1,b=[];for(let P=0;P<=A;P++){b[P]=[];const D=y.clone().lerp(S,P/A),v=x.clone().lerp(S,P/A),w=A-P;for(let U=0;U<=w;U++)U===0&&P===A?b[P][U]=D:b[P][U]=D.clone().lerp(v,U/w)}for(let P=0;P<A;P++)for(let D=0;D<2*(A-P)-1;D++){const v=Math.floor(D/2);D%2===0?(d(b[P][v+1]),d(b[P+1][v]),d(b[P][v])):(d(b[P][v+1]),d(b[P+1][v+1]),d(b[P+1][v]))}}function l(y){const x=new I;for(let S=0;S<r.length;S+=3)x.x=r[S+0],x.y=r[S+1],x.z=r[S+2],x.normalize().multiplyScalar(y),r[S+0]=x.x,r[S+1]=x.y,r[S+2]=x.z}function h(){const y=new I;for(let x=0;x<r.length;x+=3){y.x=r[x+0],y.y=r[x+1],y.z=r[x+2];const S=p(y)/2/Math.PI+.5,C=g(y)/Math.PI+.5;o.push(S,1-C)}m(),u()}function u(){for(let y=0;y<o.length;y+=6){const x=o[y+0],S=o[y+2],C=o[y+4],A=Math.max(x,S,C),b=Math.min(x,S,C);A>.9&&b<.1&&(x<.2&&(o[y+0]+=1),S<.2&&(o[y+2]+=1),C<.2&&(o[y+4]+=1))}}function d(y){r.push(y.x,y.y,y.z)}function f(y,x){const S=y*3;x.x=t[S+0],x.y=t[S+1],x.z=t[S+2]}function m(){const y=new I,x=new I,S=new I,C=new I,A=new St,b=new St,P=new St;for(let D=0,v=0;D<r.length;D+=9,v+=6){y.set(r[D+0],r[D+1],r[D+2]),x.set(r[D+3],r[D+4],r[D+5]),S.set(r[D+6],r[D+7],r[D+8]),A.set(o[v+0],o[v+1]),b.set(o[v+2],o[v+3]),P.set(o[v+4],o[v+5]),C.copy(y).add(x).add(S).divideScalar(3);const w=p(C);_(A,v+0,y,w),_(b,v+2,x,w),_(P,v+4,S,w)}}function _(y,x,S,C){C<0&&y.x===1&&(o[x]=y.x-1),S.x===0&&S.z===0&&(o[x]=C/2/Math.PI+.5)}function p(y){return Math.atan2(y.z,-y.x)}function g(y){return Math.atan2(-y.y,Math.sqrt(y.x*y.x+y.z*y.z))}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new rl(t.vertices,t.indices,t.radius,t.details)}}class Yu extends Sh{constructor(t){super(t),this.uuid=is(),this.type="Shape",this.holes=[]}getPointsHoles(t){const e=[];for(let n=0,s=this.holes.length;n<s;n++)e[n]=this.holes[n].getPoints(t);return e}extractPoints(t){return{shape:this.getPoints(t),holes:this.getPointsHoles(t)}}copy(t){super.copy(t),this.holes=[];for(let e=0,n=t.holes.length;e<n;e++){const s=t.holes[e];this.holes.push(s.clone())}return this}toJSON(){const t=super.toJSON();t.uuid=this.uuid,t.holes=[];for(let e=0,n=this.holes.length;e<n;e++){const s=this.holes[e];t.holes.push(s.toJSON())}return t}fromJSON(t){super.fromJSON(t),this.uuid=t.uuid,this.holes=[];for(let e=0,n=t.holes.length;e<n;e++){const s=t.holes[e];this.holes.push(new Sh().fromJSON(s))}return this}}const Mx={triangulate:function(i,t,e=2){const n=t&&t.length,s=n?t[0]*e:i.length;let r=ju(i,0,s,e,!0);const o=[];if(!r||r.next===r.prev)return o;let a,c,l,h,u,d,f;if(n&&(r=Tx(i,t,r,e)),i.length>80*e){a=l=i[0],c=h=i[1];for(let m=e;m<s;m+=e)u=i[m],d=i[m+1],u<a&&(a=u),d<c&&(c=d),u>l&&(l=u),d>h&&(h=d);f=Math.max(l-a,h-c),f=f!==0?32767/f:0}return fr(r,o,e,a,c,f,0),o}};function ju(i,t,e,n,s){let r,o;if(s===Fx(i,t,e,n)>0)for(r=t;r<e;r+=n)o=wh(r,i[r],i[r+1],o);else for(r=e-n;r>=t;r-=n)o=wh(r,i[r],i[r+1],o);return o&&Do(o,o.next)&&(mr(o),o=o.next),o}function ns(i,t){if(!i)return i;t||(t=i);let e=i,n;do if(n=!1,!e.steiner&&(Do(e,e.next)||ye(e.prev,e,e.next)===0)){if(mr(e),e=t=e.prev,e===e.next)break;n=!0}else e=e.next;while(n||e!==t);return t}function fr(i,t,e,n,s,r,o){if(!i)return;!o&&r&&Lx(i,n,s,r);let a=i,c,l;for(;i.prev!==i.next;){if(c=i.prev,l=i.next,r?wx(i,n,s,r):Sx(i)){t.push(c.i/e|0),t.push(i.i/e|0),t.push(l.i/e|0),mr(i),i=l.next,a=l.next;continue}if(i=l,i===a){o?o===1?(i=Ex(ns(i),t,e),fr(i,t,e,n,s,r,2)):o===2&&bx(i,t,e,n,s,r):fr(ns(i),t,e,n,s,r,1);break}}}function Sx(i){const t=i.prev,e=i,n=i.next;if(ye(t,e,n)>=0)return!1;const s=t.x,r=e.x,o=n.x,a=t.y,c=e.y,l=n.y,h=s<r?s<o?s:o:r<o?r:o,u=a<c?a<l?a:l:c<l?c:l,d=s>r?s>o?s:o:r>o?r:o,f=a>c?a>l?a:l:c>l?c:l;let m=n.next;for(;m!==t;){if(m.x>=h&&m.x<=d&&m.y>=u&&m.y<=f&&Rs(s,a,r,c,o,l,m.x,m.y)&&ye(m.prev,m,m.next)>=0)return!1;m=m.next}return!0}function wx(i,t,e,n){const s=i.prev,r=i,o=i.next;if(ye(s,r,o)>=0)return!1;const a=s.x,c=r.x,l=o.x,h=s.y,u=r.y,d=o.y,f=a<c?a<l?a:l:c<l?c:l,m=h<u?h<d?h:d:u<d?u:d,_=a>c?a>l?a:l:c>l?c:l,p=h>u?h>d?h:d:u>d?u:d,g=Ac(f,m,t,e,n),y=Ac(_,p,t,e,n);let x=i.prevZ,S=i.nextZ;for(;x&&x.z>=g&&S&&S.z<=y;){if(x.x>=f&&x.x<=_&&x.y>=m&&x.y<=p&&x!==s&&x!==o&&Rs(a,h,c,u,l,d,x.x,x.y)&&ye(x.prev,x,x.next)>=0||(x=x.prevZ,S.x>=f&&S.x<=_&&S.y>=m&&S.y<=p&&S!==s&&S!==o&&Rs(a,h,c,u,l,d,S.x,S.y)&&ye(S.prev,S,S.next)>=0))return!1;S=S.nextZ}for(;x&&x.z>=g;){if(x.x>=f&&x.x<=_&&x.y>=m&&x.y<=p&&x!==s&&x!==o&&Rs(a,h,c,u,l,d,x.x,x.y)&&ye(x.prev,x,x.next)>=0)return!1;x=x.prevZ}for(;S&&S.z<=y;){if(S.x>=f&&S.x<=_&&S.y>=m&&S.y<=p&&S!==s&&S!==o&&Rs(a,h,c,u,l,d,S.x,S.y)&&ye(S.prev,S,S.next)>=0)return!1;S=S.nextZ}return!0}function Ex(i,t,e){let n=i;do{const s=n.prev,r=n.next.next;!Do(s,r)&&Ku(s,n,n.next,r)&&pr(s,r)&&pr(r,s)&&(t.push(s.i/e|0),t.push(n.i/e|0),t.push(r.i/e|0),mr(n),mr(n.next),n=i=r),n=n.next}while(n!==i);return ns(n)}function bx(i,t,e,n,s,r){let o=i;do{let a=o.next.next;for(;a!==o.prev;){if(o.i!==a.i&&Ux(o,a)){let c=$u(o,a);o=ns(o,o.next),c=ns(c,c.next),fr(o,t,e,n,s,r,0),fr(c,t,e,n,s,r,0);return}a=a.next}o=o.next}while(o!==i)}function Tx(i,t,e,n){const s=[];let r,o,a,c,l;for(r=0,o=t.length;r<o;r++)a=t[r]*n,c=r<o-1?t[r+1]*n:i.length,l=ju(i,a,c,n,!1),l===l.next&&(l.steiner=!0),s.push(Dx(l));for(s.sort(Ax),r=0;r<s.length;r++)e=Rx(s[r],e);return e}function Ax(i,t){return i.x-t.x}function Rx(i,t){const e=Cx(i,t);if(!e)return t;const n=$u(e,i);return ns(n,n.next),ns(e,e.next)}function Cx(i,t){let e=t,n=-1/0,s;const r=i.x,o=i.y;do{if(o<=e.y&&o>=e.next.y&&e.next.y!==e.y){const d=e.x+(o-e.y)*(e.next.x-e.x)/(e.next.y-e.y);if(d<=r&&d>n&&(n=d,s=e.x<e.next.x?e:e.next,d===r))return s}e=e.next}while(e!==t);if(!s)return null;const a=s,c=s.x,l=s.y;let h=1/0,u;e=s;do r>=e.x&&e.x>=c&&r!==e.x&&Rs(o<l?r:n,o,c,l,o<l?n:r,o,e.x,e.y)&&(u=Math.abs(o-e.y)/(r-e.x),pr(e,i)&&(u<h||u===h&&(e.x>s.x||e.x===s.x&&Px(s,e)))&&(s=e,h=u)),e=e.next;while(e!==a);return s}function Px(i,t){return ye(i.prev,i,t.prev)<0&&ye(t.next,i,i.next)<0}function Lx(i,t,e,n){let s=i;do s.z===0&&(s.z=Ac(s.x,s.y,t,e,n)),s.prevZ=s.prev,s.nextZ=s.next,s=s.next;while(s!==i);s.prevZ.nextZ=null,s.prevZ=null,Ix(s)}function Ix(i){let t,e,n,s,r,o,a,c,l=1;do{for(e=i,i=null,r=null,o=0;e;){for(o++,n=e,a=0,t=0;t<l&&(a++,n=n.nextZ,!!n);t++);for(c=l;a>0||c>0&&n;)a!==0&&(c===0||!n||e.z<=n.z)?(s=e,e=e.nextZ,a--):(s=n,n=n.nextZ,c--),r?r.nextZ=s:i=s,s.prevZ=r,r=s;e=n}r.nextZ=null,l*=2}while(o>1);return i}function Ac(i,t,e,n,s){return i=(i-e)*s|0,t=(t-n)*s|0,i=(i|i<<8)&16711935,i=(i|i<<4)&252645135,i=(i|i<<2)&858993459,i=(i|i<<1)&1431655765,t=(t|t<<8)&16711935,t=(t|t<<4)&252645135,t=(t|t<<2)&858993459,t=(t|t<<1)&1431655765,i|t<<1}function Dx(i){let t=i,e=i;do(t.x<e.x||t.x===e.x&&t.y<e.y)&&(e=t),t=t.next;while(t!==i);return e}function Rs(i,t,e,n,s,r,o,a){return(s-o)*(t-a)>=(i-o)*(r-a)&&(i-o)*(n-a)>=(e-o)*(t-a)&&(e-o)*(r-a)>=(s-o)*(n-a)}function Ux(i,t){return i.next.i!==t.i&&i.prev.i!==t.i&&!Nx(i,t)&&(pr(i,t)&&pr(t,i)&&Ox(i,t)&&(ye(i.prev,i,t.prev)||ye(i,t.prev,t))||Do(i,t)&&ye(i.prev,i,i.next)>0&&ye(t.prev,t,t.next)>0)}function ye(i,t,e){return(t.y-i.y)*(e.x-t.x)-(t.x-i.x)*(e.y-t.y)}function Do(i,t){return i.x===t.x&&i.y===t.y}function Ku(i,t,e,n){const s=jr(ye(i,t,e)),r=jr(ye(i,t,n)),o=jr(ye(e,n,i)),a=jr(ye(e,n,t));return!!(s!==r&&o!==a||s===0&&Yr(i,e,t)||r===0&&Yr(i,n,t)||o===0&&Yr(e,i,n)||a===0&&Yr(e,t,n))}function Yr(i,t,e){return t.x<=Math.max(i.x,e.x)&&t.x>=Math.min(i.x,e.x)&&t.y<=Math.max(i.y,e.y)&&t.y>=Math.min(i.y,e.y)}function jr(i){return i>0?1:i<0?-1:0}function Nx(i,t){let e=i;do{if(e.i!==i.i&&e.next.i!==i.i&&e.i!==t.i&&e.next.i!==t.i&&Ku(e,e.next,i,t))return!0;e=e.next}while(e!==i);return!1}function pr(i,t){return ye(i.prev,i,i.next)<0?ye(i,t,i.next)>=0&&ye(i,i.prev,t)>=0:ye(i,t,i.prev)<0||ye(i,i.next,t)<0}function Ox(i,t){let e=i,n=!1;const s=(i.x+t.x)/2,r=(i.y+t.y)/2;do e.y>r!=e.next.y>r&&e.next.y!==e.y&&s<(e.next.x-e.x)*(r-e.y)/(e.next.y-e.y)+e.x&&(n=!n),e=e.next;while(e!==i);return n}function $u(i,t){const e=new Rc(i.i,i.x,i.y),n=new Rc(t.i,t.x,t.y),s=i.next,r=t.prev;return i.next=t,t.prev=i,e.next=s,s.prev=e,n.next=e,e.prev=n,r.next=n,n.prev=r,n}function wh(i,t,e,n){const s=new Rc(i,t,e);return n?(s.next=n.next,s.prev=n,n.next.prev=s,n.next=s):(s.prev=s,s.next=s),s}function mr(i){i.next.prev=i.prev,i.prev.next=i.next,i.prevZ&&(i.prevZ.nextZ=i.nextZ),i.nextZ&&(i.nextZ.prevZ=i.prevZ)}function Rc(i,t,e){this.i=i,this.x=t,this.y=e,this.prev=null,this.next=null,this.z=0,this.prevZ=null,this.nextZ=null,this.steiner=!1}function Fx(i,t,e,n){let s=0;for(let r=t,o=e-n;r<e;r+=n)s+=(i[o]-i[r])*(i[r+1]+i[o+1]),o=r;return s}class hr{static area(t){const e=t.length;let n=0;for(let s=e-1,r=0;r<e;s=r++)n+=t[s].x*t[r].y-t[r].x*t[s].y;return n*.5}static isClockWise(t){return hr.area(t)<0}static triangulateShape(t,e){const n=[],s=[],r=[];Eh(t),bh(n,t);let o=t.length;e.forEach(Eh);for(let c=0;c<e.length;c++)s.push(o),o+=e[c].length,bh(n,e[c]);const a=Mx.triangulate(n,s);for(let c=0;c<a.length;c+=3)r.push(a.slice(c,c+3));return r}}function Eh(i){const t=i.length;t>2&&i[t-1].equals(i[0])&&i.pop()}function bh(i,t){for(let e=0;e<t.length;e++)i.push(t[e].x),i.push(t[e].y)}class ol extends $e{constructor(t=new Yu([new St(.5,.5),new St(-.5,.5),new St(-.5,-.5),new St(.5,-.5)]),e={}){super(),this.type="ExtrudeGeometry",this.parameters={shapes:t,options:e},t=Array.isArray(t)?t:[t];const n=this,s=[],r=[];for(let a=0,c=t.length;a<c;a++){const l=t[a];o(l)}this.setAttribute("position",new Ce(s,3)),this.setAttribute("uv",new Ce(r,2)),this.computeVertexNormals();function o(a){const c=[],l=e.curveSegments!==void 0?e.curveSegments:12,h=e.steps!==void 0?e.steps:1,u=e.depth!==void 0?e.depth:1;let d=e.bevelEnabled!==void 0?e.bevelEnabled:!0,f=e.bevelThickness!==void 0?e.bevelThickness:.2,m=e.bevelSize!==void 0?e.bevelSize:f-.1,_=e.bevelOffset!==void 0?e.bevelOffset:0,p=e.bevelSegments!==void 0?e.bevelSegments:3;const g=e.extrudePath,y=e.UVGenerator!==void 0?e.UVGenerator:zx;let x,S=!1,C,A,b,P;g&&(x=g.getSpacedPoints(h),S=!0,d=!1,C=g.computeFrenetFrames(h,!1),A=new I,b=new I,P=new I),d||(p=0,f=0,m=0,_=0);const D=a.extractPoints(l);let v=D.shape;const w=D.holes;if(!hr.isClockWise(v)){v=v.reverse();for(let Z=0,E=w.length;Z<E;Z++){const ft=w[Z];hr.isClockWise(ft)&&(w[Z]=ft.reverse())}}const N=hr.triangulateShape(v,w),X=v;for(let Z=0,E=w.length;Z<E;Z++){const ft=w[Z];v=v.concat(ft)}function q(Z,E,ft){return E||console.error("THREE.ExtrudeGeometry: vec does not exist"),Z.clone().addScaledVector(E,ft)}const V=v.length,K=N.length;function k(Z,E,ft){let st,it,ot;const Pt=Z.x-E.x,rt=Z.y-E.y,R=ft.x-Z.x,M=ft.y-Z.y,B=Pt*Pt+rt*rt,J=Pt*M-rt*R;if(Math.abs(J)>Number.EPSILON){const et=Math.sqrt(B),tt=Math.sqrt(R*R+M*M),Lt=E.x-rt/et,lt=E.y+Pt/et,Mt=ft.x-M/tt,Kt=ft.y+R/tt,ht=((Mt-Lt)*M-(Kt-lt)*R)/(Pt*M-rt*R);st=Lt+Pt*ht-Z.x,it=lt+rt*ht-Z.y;const Rt=st*st+it*it;if(Rt<=2)return new St(st,it);ot=Math.sqrt(Rt/2)}else{let et=!1;Pt>Number.EPSILON?R>Number.EPSILON&&(et=!0):Pt<-Number.EPSILON?R<-Number.EPSILON&&(et=!0):Math.sign(rt)===Math.sign(M)&&(et=!0),et?(st=-rt,it=Pt,ot=Math.sqrt(B)):(st=Pt,it=rt,ot=Math.sqrt(B/2))}return new St(st/ot,it/ot)}const pt=[];for(let Z=0,E=X.length,ft=E-1,st=Z+1;Z<E;Z++,ft++,st++)ft===E&&(ft=0),st===E&&(st=0),pt[Z]=k(X[Z],X[ft],X[st]);const mt=[];let ct,zt=pt.concat();for(let Z=0,E=w.length;Z<E;Z++){const ft=w[Z];ct=[];for(let st=0,it=ft.length,ot=it-1,Pt=st+1;st<it;st++,ot++,Pt++)ot===it&&(ot=0),Pt===it&&(Pt=0),ct[st]=k(ft[st],ft[ot],ft[Pt]);mt.push(ct),zt=zt.concat(ct)}for(let Z=0;Z<p;Z++){const E=Z/p,ft=f*Math.cos(E*Math.PI/2),st=m*Math.sin(E*Math.PI/2)+_;for(let it=0,ot=X.length;it<ot;it++){const Pt=q(X[it],pt[it],st);nt(Pt.x,Pt.y,-ft)}for(let it=0,ot=w.length;it<ot;it++){const Pt=w[it];ct=mt[it];for(let rt=0,R=Pt.length;rt<R;rt++){const M=q(Pt[rt],ct[rt],st);nt(M.x,M.y,-ft)}}}const jt=m+_;for(let Z=0;Z<V;Z++){const E=d?q(v[Z],zt[Z],jt):v[Z];S?(b.copy(C.normals[0]).multiplyScalar(E.x),A.copy(C.binormals[0]).multiplyScalar(E.y),P.copy(x[0]).add(b).add(A),nt(P.x,P.y,P.z)):nt(E.x,E.y,0)}for(let Z=1;Z<=h;Z++)for(let E=0;E<V;E++){const ft=d?q(v[E],zt[E],jt):v[E];S?(b.copy(C.normals[Z]).multiplyScalar(ft.x),A.copy(C.binormals[Z]).multiplyScalar(ft.y),P.copy(x[Z]).add(b).add(A),nt(P.x,P.y,P.z)):nt(ft.x,ft.y,u/h*Z)}for(let Z=p-1;Z>=0;Z--){const E=Z/p,ft=f*Math.cos(E*Math.PI/2),st=m*Math.sin(E*Math.PI/2)+_;for(let it=0,ot=X.length;it<ot;it++){const Pt=q(X[it],pt[it],st);nt(Pt.x,Pt.y,u+ft)}for(let it=0,ot=w.length;it<ot;it++){const Pt=w[it];ct=mt[it];for(let rt=0,R=Pt.length;rt<R;rt++){const M=q(Pt[rt],ct[rt],st);S?nt(M.x,M.y+x[h-1].y,x[h-1].x+ft):nt(M.x,M.y,u+ft)}}}Q(),F();function Q(){const Z=s.length/3;if(d){let E=0,ft=V*E;for(let st=0;st<K;st++){const it=N[st];vt(it[2]+ft,it[1]+ft,it[0]+ft)}E=h+p*2,ft=V*E;for(let st=0;st<K;st++){const it=N[st];vt(it[0]+ft,it[1]+ft,it[2]+ft)}}else{for(let E=0;E<K;E++){const ft=N[E];vt(ft[2],ft[1],ft[0])}for(let E=0;E<K;E++){const ft=N[E];vt(ft[0]+V*h,ft[1]+V*h,ft[2]+V*h)}}n.addGroup(Z,s.length/3-Z,0)}function F(){const Z=s.length/3;let E=0;dt(X,E),E+=X.length;for(let ft=0,st=w.length;ft<st;ft++){const it=w[ft];dt(it,E),E+=it.length}n.addGroup(Z,s.length/3-Z,1)}function dt(Z,E){let ft=Z.length;for(;--ft>=0;){const st=ft;let it=ft-1;it<0&&(it=Z.length-1);for(let ot=0,Pt=h+p*2;ot<Pt;ot++){const rt=V*ot,R=V*(ot+1),M=E+st+rt,B=E+it+rt,J=E+it+R,et=E+st+R;_t(M,B,J,et)}}}function nt(Z,E,ft){c.push(Z),c.push(E),c.push(ft)}function vt(Z,E,ft){Et(Z),Et(E),Et(ft);const st=s.length/3,it=y.generateTopUV(n,s,st-3,st-2,st-1);At(it[0]),At(it[1]),At(it[2])}function _t(Z,E,ft,st){Et(Z),Et(E),Et(st),Et(E),Et(ft),Et(st);const it=s.length/3,ot=y.generateSideWallUV(n,s,it-6,it-3,it-2,it-1);At(ot[0]),At(ot[1]),At(ot[3]),At(ot[1]),At(ot[2]),At(ot[3])}function Et(Z){s.push(c[Z*3+0]),s.push(c[Z*3+1]),s.push(c[Z*3+2])}function At(Z){r.push(Z.x),r.push(Z.y)}}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}toJSON(){const t=super.toJSON(),e=this.parameters.shapes,n=this.parameters.options;return kx(e,n,t)}static fromJSON(t,e){const n=[];for(let r=0,o=t.shapes.length;r<o;r++){const a=e[t.shapes[r]];n.push(a)}const s=t.options.extrudePath;return s!==void 0&&(t.options.extrudePath=new Tc[s.type]().fromJSON(s)),new ol(n,t.options)}}const zx={generateTopUV:function(i,t,e,n,s){const r=t[e*3],o=t[e*3+1],a=t[n*3],c=t[n*3+1],l=t[s*3],h=t[s*3+1];return[new St(r,o),new St(a,c),new St(l,h)]},generateSideWallUV:function(i,t,e,n,s,r){const o=t[e*3],a=t[e*3+1],c=t[e*3+2],l=t[n*3],h=t[n*3+1],u=t[n*3+2],d=t[s*3],f=t[s*3+1],m=t[s*3+2],_=t[r*3],p=t[r*3+1],g=t[r*3+2];return Math.abs(a-h)<Math.abs(o-l)?[new St(o,1-c),new St(l,1-u),new St(d,1-m),new St(_,1-g)]:[new St(a,1-c),new St(h,1-u),new St(f,1-m),new St(p,1-g)]}};function kx(i,t,e){if(e.shapes=[],Array.isArray(i))for(let n=0,s=i.length;n<s;n++){const r=i[n];e.shapes.push(r.uuid)}else e.shapes.push(i.uuid);return e.options=Object.assign({},t),t.extrudePath!==void 0&&(e.options.extrudePath=t.extrudePath.toJSON()),e}class Uo extends rl{constructor(t=1,e=0){const n=(1+Math.sqrt(5))/2,s=[-1,n,0,1,n,0,-1,-n,0,1,-n,0,0,-1,n,0,1,n,0,-1,-n,0,1,-n,n,0,-1,n,0,1,-n,0,-1,-n,0,1],r=[0,11,5,0,5,1,0,1,7,0,7,10,0,10,11,1,5,9,5,11,4,11,10,2,10,7,6,7,1,8,3,9,4,3,4,2,3,2,6,3,6,8,3,8,9,4,9,5,2,4,11,6,2,10,8,6,7,9,8,1];super(s,r,t,e),this.type="IcosahedronGeometry",this.parameters={radius:t,detail:e}}static fromJSON(t){return new Uo(t.radius,t.detail)}}class al extends $e{constructor(t=.5,e=1,n=32,s=1,r=0,o=Math.PI*2){super(),this.type="RingGeometry",this.parameters={innerRadius:t,outerRadius:e,thetaSegments:n,phiSegments:s,thetaStart:r,thetaLength:o},n=Math.max(3,n),s=Math.max(1,s);const a=[],c=[],l=[],h=[];let u=t;const d=(e-t)/s,f=new I,m=new St;for(let _=0;_<=s;_++){for(let p=0;p<=n;p++){const g=r+p/n*o;f.x=u*Math.cos(g),f.y=u*Math.sin(g),c.push(f.x,f.y,f.z),l.push(0,0,1),m.x=(f.x/e+1)/2,m.y=(f.y/e+1)/2,h.push(m.x,m.y)}u+=d}for(let _=0;_<s;_++){const p=_*(n+1);for(let g=0;g<n;g++){const y=g+p,x=y,S=y+n+1,C=y+n+2,A=y+1;a.push(x,S,A),a.push(S,C,A)}}this.setIndex(a),this.setAttribute("position",new Ce(c,3)),this.setAttribute("normal",new Ce(l,3)),this.setAttribute("uv",new Ce(h,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new al(t.innerRadius,t.outerRadius,t.thetaSegments,t.phiSegments,t.thetaStart,t.thetaLength)}}class Fi extends $e{constructor(t=1,e=32,n=16,s=0,r=Math.PI*2,o=0,a=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:t,widthSegments:e,heightSegments:n,phiStart:s,phiLength:r,thetaStart:o,thetaLength:a},e=Math.max(3,Math.floor(e)),n=Math.max(2,Math.floor(n));const c=Math.min(o+a,Math.PI);let l=0;const h=[],u=new I,d=new I,f=[],m=[],_=[],p=[];for(let g=0;g<=n;g++){const y=[],x=g/n;let S=0;g===0&&o===0?S=.5/e:g===n&&c===Math.PI&&(S=-.5/e);for(let C=0;C<=e;C++){const A=C/e;u.x=-t*Math.cos(s+A*r)*Math.sin(o+x*a),u.y=t*Math.cos(o+x*a),u.z=t*Math.sin(s+A*r)*Math.sin(o+x*a),m.push(u.x,u.y,u.z),d.copy(u).normalize(),_.push(d.x,d.y,d.z),p.push(A+S,1-x),y.push(l++)}h.push(y)}for(let g=0;g<n;g++)for(let y=0;y<e;y++){const x=h[g][y+1],S=h[g][y],C=h[g+1][y],A=h[g+1][y+1];(g!==0||o>0)&&f.push(x,S,A),(g!==n-1||c<Math.PI)&&f.push(S,C,A)}this.setIndex(f),this.setAttribute("position",new Ce(m,3)),this.setAttribute("normal",new Ce(_,3)),this.setAttribute("uv",new Ce(p,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new Fi(t.radius,t.widthSegments,t.heightSegments,t.phiStart,t.phiLength,t.thetaStart,t.thetaLength)}}class Rn extends ss{constructor(t){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new Gt(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Gt(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=$c,this.normalScale=new St(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new Hn,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.defines={STANDARD:""},this.color.copy(t.color),this.roughness=t.roughness,this.metalness=t.metalness,this.map=t.map,this.lightMap=t.lightMap,this.lightMapIntensity=t.lightMapIntensity,this.aoMap=t.aoMap,this.aoMapIntensity=t.aoMapIntensity,this.emissive.copy(t.emissive),this.emissiveMap=t.emissiveMap,this.emissiveIntensity=t.emissiveIntensity,this.bumpMap=t.bumpMap,this.bumpScale=t.bumpScale,this.normalMap=t.normalMap,this.normalMapType=t.normalMapType,this.normalScale.copy(t.normalScale),this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this.roughnessMap=t.roughnessMap,this.metalnessMap=t.metalnessMap,this.alphaMap=t.alphaMap,this.envMap=t.envMap,this.envMapRotation.copy(t.envMapRotation),this.envMapIntensity=t.envMapIntensity,this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this.wireframeLinecap=t.wireframeLinecap,this.wireframeLinejoin=t.wireframeLinejoin,this.flatShading=t.flatShading,this.fog=t.fog,this}}class Li extends ss{constructor(t){super(),this.isMeshLambertMaterial=!0,this.type="MeshLambertMaterial",this.color=new Gt(16777215),this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Gt(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=$c,this.normalScale=new St(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.specularMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new Hn,this.combine=Vc,this.reflectivity=1,this.refractionRatio=.98,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.lightMap=t.lightMap,this.lightMapIntensity=t.lightMapIntensity,this.aoMap=t.aoMap,this.aoMapIntensity=t.aoMapIntensity,this.emissive.copy(t.emissive),this.emissiveMap=t.emissiveMap,this.emissiveIntensity=t.emissiveIntensity,this.bumpMap=t.bumpMap,this.bumpScale=t.bumpScale,this.normalMap=t.normalMap,this.normalMapType=t.normalMapType,this.normalScale.copy(t.normalScale),this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this.specularMap=t.specularMap,this.alphaMap=t.alphaMap,this.envMap=t.envMap,this.envMapRotation.copy(t.envMapRotation),this.combine=t.combine,this.reflectivity=t.reflectivity,this.refractionRatio=t.refractionRatio,this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this.wireframeLinecap=t.wireframeLinecap,this.wireframeLinejoin=t.wireframeLinejoin,this.flatShading=t.flatShading,this.fog=t.fog,this}}class _r extends Re{constructor(t,e=1){super(),this.isLight=!0,this.type="Light",this.color=new Gt(t),this.intensity=e}dispose(){}copy(t,e){return super.copy(t,e),this.color.copy(t.color),this.intensity=t.intensity,this}toJSON(t){const e=super.toJSON(t);return e.object.color=this.color.getHex(),e.object.intensity=this.intensity,this.groundColor!==void 0&&(e.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(e.object.distance=this.distance),this.angle!==void 0&&(e.object.angle=this.angle),this.decay!==void 0&&(e.object.decay=this.decay),this.penumbra!==void 0&&(e.object.penumbra=this.penumbra),this.shadow!==void 0&&(e.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(e.object.target=this.target.uuid),e}}class Bx extends _r{constructor(t,e,n){super(t,n),this.isHemisphereLight=!0,this.type="HemisphereLight",this.position.copy(Re.DEFAULT_UP),this.updateMatrix(),this.groundColor=new Gt(e)}copy(t,e){return super.copy(t,e),this.groundColor.copy(t.groundColor),this}}const va=new xe,Th=new I,Ah=new I;class cl{constructor(t){this.camera=t,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new St(512,512),this.map=null,this.mapPass=null,this.matrix=new xe,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new tl,this._frameExtents=new St(1,1),this._viewportCount=1,this._viewports=[new he(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(t){const e=this.camera,n=this.matrix;Th.setFromMatrixPosition(t.matrixWorld),e.position.copy(Th),Ah.setFromMatrixPosition(t.target.matrixWorld),e.lookAt(Ah),e.updateMatrixWorld(),va.multiplyMatrices(e.projectionMatrix,e.matrixWorldInverse),this._frustum.setFromProjectionMatrix(va),n.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),n.multiply(va)}getViewport(t){return this._viewports[t]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(t){return this.camera=t.camera.clone(),this.intensity=t.intensity,this.bias=t.bias,this.radius=t.radius,this.mapSize.copy(t.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const t={};return this.intensity!==1&&(t.intensity=this.intensity),this.bias!==0&&(t.bias=this.bias),this.normalBias!==0&&(t.normalBias=this.normalBias),this.radius!==1&&(t.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(t.mapSize=this.mapSize.toArray()),t.camera=this.camera.toJSON(!1).object,delete t.camera.matrix,t}}class Hx extends cl{constructor(){super(new on(50,1,.5,500)),this.isSpotLightShadow=!0,this.focus=1}updateMatrices(t){const e=this.camera,n=Vs*2*t.angle*this.focus,s=this.mapSize.width/this.mapSize.height,r=t.distance||e.far;(n!==e.fov||s!==e.aspect||r!==e.far)&&(e.fov=n,e.aspect=s,e.far=r,e.updateProjectionMatrix()),super.updateMatrices(t)}copy(t){return super.copy(t),this.focus=t.focus,this}}class Gx extends _r{constructor(t,e,n=0,s=Math.PI/3,r=0,o=2){super(t,e),this.isSpotLight=!0,this.type="SpotLight",this.position.copy(Re.DEFAULT_UP),this.updateMatrix(),this.target=new Re,this.distance=n,this.angle=s,this.penumbra=r,this.decay=o,this.map=null,this.shadow=new Hx}get power(){return this.intensity*Math.PI}set power(t){this.intensity=t/Math.PI}dispose(){this.shadow.dispose()}copy(t,e){return super.copy(t,e),this.distance=t.distance,this.angle=t.angle,this.penumbra=t.penumbra,this.decay=t.decay,this.target=t.target.clone(),this.shadow=t.shadow.clone(),this}}const Rh=new xe,nr=new I,ya=new I;class Vx extends cl{constructor(){super(new on(90,1,.5,500)),this.isPointLightShadow=!0,this._frameExtents=new St(4,2),this._viewportCount=6,this._viewports=[new he(2,1,1,1),new he(0,1,1,1),new he(3,1,1,1),new he(1,1,1,1),new he(3,0,1,1),new he(1,0,1,1)],this._cubeDirections=[new I(1,0,0),new I(-1,0,0),new I(0,0,1),new I(0,0,-1),new I(0,1,0),new I(0,-1,0)],this._cubeUps=[new I(0,1,0),new I(0,1,0),new I(0,1,0),new I(0,1,0),new I(0,0,1),new I(0,0,-1)]}updateMatrices(t,e=0){const n=this.camera,s=this.matrix,r=t.distance||n.far;r!==n.far&&(n.far=r,n.updateProjectionMatrix()),nr.setFromMatrixPosition(t.matrixWorld),n.position.copy(nr),ya.copy(n.position),ya.add(this._cubeDirections[e]),n.up.copy(this._cubeUps[e]),n.lookAt(ya),n.updateMatrixWorld(),s.makeTranslation(-nr.x,-nr.y,-nr.z),Rh.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Rh)}}class Wx extends _r{constructor(t,e,n=0,s=2){super(t,e),this.isPointLight=!0,this.type="PointLight",this.distance=n,this.decay=s,this.shadow=new Vx}get power(){return this.intensity*4*Math.PI}set power(t){this.intensity=t/(4*Math.PI)}dispose(){this.shadow.dispose()}copy(t,e){return super.copy(t,e),this.distance=t.distance,this.decay=t.decay,this.shadow=t.shadow.clone(),this}}class qx extends cl{constructor(){super(new Ou(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class Ch extends _r{constructor(t,e){super(t,e),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(Re.DEFAULT_UP),this.updateMatrix(),this.target=new Re,this.shadow=new qx}dispose(){this.shadow.dispose()}copy(t){return super.copy(t),this.target=t.target.clone(),this.shadow=t.shadow.clone(),this}}class Xx extends _r{constructor(t,e){super(t,e),this.isAmbientLight=!0,this.type="AmbientLight"}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Gc}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Gc);const Yx={clear:0,overcast:.88,rain:1,storm:1},jx=i=>Yx[i==null?void 0:i.condition]??0,jn={hemi:.44,ambient:.48,bounce:.34,exposure:.15,fov:-6,shadowSpan:18,shadowBias:-25e-5,shadowNormalBias:.01,rate:2.6},Kr={shadowSpan:55,shadowBias:-4e-4,shadowNormalBias:.035},Ph=.45,Kx=6;class $x{constructor(t){this.spot=new Gx(16767392,0,9,1.15,.7,2),this.spot.castShadow=!0,this.spot.shadow.mapSize.set(1024,1024),this.spot.shadow.camera.near=.3,this.spot.shadow.camera.far=9,this.spot.shadow.bias=-8e-4,this.spot.shadow.normalBias=.012,this.spot.shadow.autoUpdate=!1,this.spot.target=new Re,t.add(this.spot,this.spot.target),this._base=new WeakMap,this._roomLights=new WeakMap,this._tmp=new I}base(t){let e=this._base.get(t);return e===void 0&&(e=t.intensity,this._base.set(t,e)),e}lightsFor(t,e){var o;const n=this._roomLights.get(e);if(n!==void 0)return n;let s=e.lights;if(!s){const a=(o=t.buildings)==null?void 0:o.find(c=>c.lights&&Math.abs(c.x-e.x)<.01&&Math.abs(c.z-e.z)<.01&&Math.abs(c.rotY-e.rotY)<.01);s=a==null?void 0:a.lights}if(!s||!s.length)return this._roomLights.set(e,null),null;const r=e.interiorBounds;if(r){const a=Math.cos(e.rotY),c=Math.sin(e.rotY),l=s.filter(h=>{h.updateWorldMatrix(!0,!1),h.getWorldPosition(this._tmp);const u=this._tmp.x-e.x,d=this._tmp.z-e.z,f=u*a-d*c,m=u*c+d*a;return f>r.minX&&f<r.maxX&&m>r.minZ&&m<r.maxZ});l.length&&(s=l)}return this._roomLights.set(e,s),s}update(t,e,n){const s=t.currentBuilding,r=s?this.lightsFor(t,s):null;let o=null,a=Kx;if(r&&e>.02&&n)for(const c of r){const l=c.getWorldPosition(this._tmp).distanceTo(n.position);l<a&&(o=c,a=l)}for(const c of t.enterable){const l=c===s?r:this.lightsFor(t,c);if(!l)continue;const h=c===s?e:0;for(const u of l){const d=h*this.base(u)*(u===o?1-Ph:1);u.intensity!==d&&(u.intensity=d)}}o?(o.getWorldPosition(this._tmp),this.spot.position.copy(this._tmp),this.spot.target.position.set(this._tmp.x,this._floorY(s,n),this._tmp.z),this.spot.target.updateMatrixWorld(),this.spot.color.copy(o.color),this.spot.intensity=e*this.base(o)*Ph,this.spot.shadow.autoUpdate=!0):(this.spot.intensity!==0||this.spot.shadow.autoUpdate)&&(this.spot.intensity=0,this.spot.shadow.autoUpdate=!1)}_floorY(t,e){const n=e.position.y,s=(t==null?void 0:t.padY)??n;return n-s>.5?n:s}}const Zx=`
  varying vec3 vWorld;
  void main() {
...
`,Ti=[{t:0,top:329487,mid:658970,bot:1317414,sun:2766160,amb:1712176,int:.05},{t:.22,top:1779520,mid:5329002,bot:10123890,sun:16751964,amb:4868704,int:.3},{t:.27,top:5208752,mid:10466511,bot:15778714,sun:16761479,amb:9082024,int:.75},{t:.4,top:4884168,mid:10339044,bot:14214898,sun:16774109,amb:11058384,int:1},{t:.52,top:4161476,mid:9682402,bot:13886450,sun:16777215,amb:11453142,int:1.05},{t:.72,top:4882360,mid:11058388,bot:14734013,sun:16771524,amb:10530496,int:.85},{t:.8,top:2902642,mid:9072512,bot:14256732,sun:16747082,amb:6969960,int:.42},{t:.86,top:1186350,mid:2962768,bot:5917272,sun:9067114,amb:2764872,int:.14},{t:1,top:329487,mid:658970,bot:1317414,sun:2766160,amb:1712176,int:.05}];function Qx(i){let t=Ti[0],e=Ti[Ti.length-1];for(let o=0;o<Ti.length-1;o++)if(i>=Ti[o].t&&i<=Ti[o+1].t){t=Ti[o],e=Ti[o+1];break}const n=e.t-t.t||1,s=(i-t.t)/n,r=(o,a)=>new Gt(o).lerp(new Gt(a),s);return{top:r(t.top,e.top),mid:r(t.mid,e.mid),bot:r(t.bot,e.bot),sun:r(t.sun,e.sun),amb:r(t.amb,e.amb),int:t.int+(e.int-t.int)*s}}class tv{constructor(t,e){this.game=e,this.canvas=t,this.renderer=new rx({canvas:t,antialias:!0,powerPreference:"high-performance"}),this.renderer.setPixelRatio(Math.min(devicePixelRatio,2)),this.renderer.setSize(innerWidth,innerHeight,!1),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=uu,this.renderer.outputColorSpace=Le,this.renderer.toneMapping=du,this.renderer.toneMappingExposure=1.05,this.scene=new ox,this.scene.fog=new nl(11059416,60,340),this._buildSky(),this._buildLights(),this.indoorFactor=0,this.interiorLights=new $x(this.scene),this.quality={shadows:!0,drawDistance:340},addEventListener("resize",()=>this.resize())}_buildSky(){this.skyUniforms={uTop:{value:new Gt(4884168)},uMid:{value:new Gt(10339044)},uBottom:{value:new Gt(14214898)},uSunY:{value:.6},uSunDir:{value:new I(0,1,0)},uSunColour:{value:new Gt(16777215)},uExposure:{value:1.05}};const t=new ut(new Fi(900,32,20),new xi({uniforms:this.skyUniforms,vertexShader:Zx,fragmentShader:Jx,side:Qe,depthWrite:!1,fog:!1}));t.frustumCulled=!1,this.scene.add(t),this.sky=t;const e=900,n=new Float32Array(e*3);for(let r=0;r<e;r++){const o=new I().randomDirection().multiplyScalar(850);o.y<40&&(o.y=Math.abs(o.y)+40),n.set([o.x,o.y,o.z],r*3)}const s=new $e;s.setAttribute("position",new Te(n,3)),this.stars=new ax(s,new Gu({color:16777215,size:3.2,sizeAttenuation:!1,transparent:!0,opacity:0,fog:!1,depthWrite:!1})),this.stars.frustumCulled=!1,this.scene.add(this.stars),this.moon=new ut(new Fi(18,16,12),new Gn({color:14673648,fog:!1})),this.scene.add(this.moon)}_buildLights(){this.hemi=new Bx(12374760,5918784,.9),this.scene.add(this.hemi),this.sun=new Ch(16774109,2.2),this.sun.castShadow=!0,this.sun.shadow.mapSize.set(4096,4096),this.sun.shadow.camera.near=1,this.sun.shadow.camera.far=420,this.shadowSpan=Kr.shadowSpan,this._applyShadowSpan(0),this.scene.add(this.sun),this.scene.add(this.sun.target),this.bounce=new Ch(10467020,.35),this.scene.add(this.bounce),this.scene.add(this.bounce.target),this.ambient=new Xx(11058384,.35),this.scene.add(this.ambient)}add(t){this.scene.add(t)}remove(t){this.scene.remove(t)}_applyShadowSpan(t){const e=pn.lerp(Kr.shadowSpan,jn.shadowSpan,t);if(Math.abs(e-this.shadowSpan)>1e-4||!this._spanApplied){this.shadowSpan=e;const n=this.sun.shadow.camera;n.left=-e,n.right=e,n.top=e,n.bottom=-e,n.updateProjectionMatrix(),this._spanApplied=!0}this.sun.shadow.bias=pn.lerp(Kr.shadowBias,jn.shadowBias,t),this.sun.shadow.normalBias=pn.lerp(Kr.shadowNormalBias,jn.shadowNormalBias,t)}_skyDelta(t){const e=performance.now(),n=(e-(this._lastSky??e))/1e3;return this._lastSky=e,t>0?Math.min(t,.25):n>.001?Math.min(n,.25):this.game.fixedStep||1/60}updateSky(t,e,n=0,s=0){var U,N;const r=this._skyDelta(s),o=(U=this.game.world)==null?void 0:U.weather,a=jx(o),c=(N=this.game.world)!=null&&N.isIndoors?1:0;this.indoorFactor+=(c-this.indoorFactor)*Math.min(1,r*jn.rate);const l=this.indoorFactor;this._applyShadowSpan(l);const h=Qx(t);this.skyUniforms.uTop.value.copy(h.top),this.skyUniforms.uMid.value.copy(h.mid),this.skyUniforms.uBottom.value.copy(h.bot),this.skyUniforms.uSunColour.value.copy(h.sun);const u=(t-.25)*Math.PI*2,d=Math.sin(n/364*Math.PI*2)*.3,f=new I(Math.cos(u),Math.sin(u)+d,-.35).normalize();this.skyUniforms.uSunDir.value.copy(f),this.skyUniforms.uSunY.value=f.y;const m=(e==null?void 0:e.x)||0,_=(e==null?void 0:e.z)||0,p=(e==null?void 0:e.y)||0,g=this.shadowSpan*2/this.sun.shadow.mapSize.x,y=Math.round(m/g)*g,x=Math.round(_/g)*g;this.sun.position.set(y+f.x*160,p+Math.max(f.y,.08)*160,x+f.z*160),this.sun.target.position.set(y,p,x),this.sun.target.updateMatrixWorld();const S=Math.max(0,f.y),C=pn.smoothstep(f.y,-.005,.03);this.sun.intensity=Math.pow(S,.65)*3*(1-a)*C,this.sun.color.copy(h.sun).lerp(new Gt(15265524),a),this.sun.shadow.autoUpdate=this.sun.intensity>.01,this.bounce.position.set(y-f.x*90,p+40,x-f.z*90),this.bounce.target.position.set(y,p,x),this.bounce.target.updateMatrixWorld(),this.bounce.intensity=.15+h.int*.4,this.bounce.color.copy(h.mid),this.moon.position.set(m-f.x*600,-f.y*600,_-f.z*600),this.moon.visible=f.y<.08;const A=pn.clamp((.06-f.y)*6,0,1),b=o!=null&&o.wetness?1:0;this.hemi.intensity=.25+h.int*.8+A*.5+a*.5*(1-b*.5),this.hemi.color.copy(h.mid).lerp(new Gt(5992332),A*.7).lerp(new Gt(13161180),a*.6),this.ambient.intensity=.12+h.int*.3+A*.38+a*.05,this.ambient.color.copy(h.amb).lerp(new Gt(6978201),A*.8),this.stars.material.opacity=A*.9,this.hemi.intensity*=Math.pow(jn.hemi,l),this.ambient.intensity*=Math.pow(jn.ambient,l),this.bounce.intensity*=Math.pow(jn.bounce,l),this.scene.fog.color.copy(h.mid).lerp(h.bot,.45);const P=o!=null&&o.wetness?.45:0,D=o&&["overcast","rain","storm"].includes(o.condition)?.25:0;this.scene.fog.near=60-(P+D)*40,this.scene.fog.far=this.quality.drawDistance*(1-P*.35-D*.15-A*.3);const v=1+A*.45+(1-Math.min(1,h.int))*.2+a*.12+b*.03+l*jn.exposure;this.renderer.toneMappingExposure+=(v-this.renderer.toneMappingExposure)*Math.min(1,r*jn.rate),this.skyUniforms.uExposure.value=this.renderer.toneMappingExposure,this.nightFactor=A;const w=this.game.world;if(w!=null&&w.enterable){const X=.34+a*.26;this.interiorLights.update(w,Math.max(X,A),this.game.player)}this.sky&&this.sky.position.set(m,0,_),this.stars.position.set(m,0,_)}resize(){var e;this.renderer.setSize(innerWidth,innerHeight,!1);const t=(e=this.game.camera)==null?void 0:e.active;t&&(t.aspect=innerWidth/innerHeight,t.updateProjectionMatrix())}render(t){this.renderer.render(this.scene,t)}}const Ms=[{id:"first",label:"First person",distance:0,height:0,fov:64},{id:"third",label:"Third person",distance:3.6,height:.35,shoulder:.55,fov:52},{id:"thirdFar",label:"Third person (wide)",distance:6.5,height:.9,shoulder:0,fov:50},{id:"ride",label:"Behind the van",distance:7,height:1.7,shoulder:0,fov:54,hidden:!0}],ev=jn.fov;class nv{constructor(t){this.game=t,this.modeIndex=1,this.active=new on(Ms[1].fov,innerWidth/innerHeight,.25,1e3),this.yaw=0,this.pitch=-.05,this.distance=Ms[1].distance,this._targetDistance=this.distance,this._pos=new I,this._look=new I,this._ray2=new Qc,this._box=new _i,this._hit=new I,this.shakeAmount=0,this.bob=0,this.fovBoost=0}get mode(){return Ms[this.modeIndex]}get isFirstPerson(){return this.mode.id==="first"}cycle(){do this.modeIndex=(this.modeIndex+1)%Ms.length;while(Ms[this.modeIndex].hidden);return this.game.bus.emit("camera:mode",{mode:this.mode}),this.mode}setMode(t){const e=Ms.findIndex(n=>n.id===t);e>=0&&(this.modeIndex=e)}addShake(t){this.shakeAmount=Math.min(1.2,this.shakeAmount+t)}update(t){const{input:e,player:n}=this.game;if(e.locked&&e.enabled){const c=e.consumeMouse();this.yaw-=c.dx*e.mouse.sensitivity,this.pitch-=(e.mouse.invertY?-c.dy:c.dy)*e.mouse.sensitivity;const l=Math.PI/2-.05;this.pitch=pn.clamp(this.pitch,-l,l)}else e.consumeMouse();const s=this.mode,r=n.position.clone();r.y+=n.eyeHeight;const o=n.horizontalSpeed;if(o>.3){this.bob+=t*o*1.9;const c=this.isFirstPerson?.035:.012;r.y+=Math.sin(this.bob*2)*c,r.x+=Math.cos(this.bob)*c*.4}else this.bob+=t*1.1,r.y+=Math.sin(this.bob)*.006;const a=new I(Math.sin(this.yaw)*Math.cos(this.pitch),Math.sin(this.pitch),Math.cos(this.yaw)*Math.cos(this.pitch));if(s.distance===0)this._pos.copy(r),this._look.copy(r).addScaledVector(a,10);else{const c=n.position.clone();c.y+=n.eyeHeight*.92+s.height;const l=new I(-Math.cos(this.yaw),0,Math.sin(this.yaw));c.addScaledVector(l,s.shoulder||0);const h=this.game.world,u=h.isIndoors,d=u?.35:.7;let f=u?Math.min(s.distance,2.2):s.distance;const m=a.clone().negate();this._ray2.set(c,m);const _=c.clone().addScaledVector(m,f*.5);let p=f+.45;for(const g of h.query(_,f+1.5)){this._box.set(g.min,g.max);const y=this._ray2.intersectBox(this._box,this._hit);if(!y)continue;const x=c.distanceTo(y);x<p&&(p=x)}if(f=Math.max(d,Math.min(f,p-.45)),f<.65){this._pos.copy(r),this._look.copy(r).addScaledVector(a,10),this.distance=0,this._targetDistance=f,this._applyShake(t),this._commit(t,s,n);return}if(this._targetDistance+=(f-this._targetDistance)*(f<this._targetDistance?1:Math.min(1,t*5)),this.distance=this._targetDistance,this._pos.copy(c).addScaledVector(m,this.distance),this._look.copy(c).addScaledVector(a,4),u){const g=h.currentBuilding,y=g.interiorBounds;this._pos.y=Math.min(this._pos.y,g.padY+y.maxY-.2),this._pos.y=Math.max(this._pos.y,g.padY+.3)}}this._applyShake(t),this._commit(t,s,n)}_applyShake(t){if(this.shakeAmount<=.001)return;const e=this.shakeAmount;this._pos.x+=(Math.random()-.5)*.06*e,this._pos.y+=(Math.random()-.5)*.06*e,this._look.x+=(Math.random()-.5)*.5*e,this._look.y+=(Math.random()-.5)*.5*e,this.shakeAmount*=Math.pow(.06,t)}_commit(t,e,n){var o;this.active.position.copy(this._pos),this.active.lookAt(this._look);const s=(o=this.game.world)!=null&&o.isIndoors?1:0,r=e.fov+this.fovBoost+s*ev;this.active.fov+=(r-this.active.fov)*Math.min(1,t*6),this.active.updateProjectionMatrix(),n.avatar&&n.avatar.setFirstPerson(this.isFirstPerson||this.distance===0)}basis(){const t=new I(Math.sin(this.yaw),0,Math.cos(this.yaw)).normalize(),e=new I(-t.z,0,t.x);return{forward:t,right:e}}}const ie={grass:7311194,glass:6453644,trunk:6047282,foliage:5208645,foliageLight:6984789,foliageDeep:4154168,metal:9146777,metalDark:4870231,concrete:12039083,skinTones:[15914685,15253915,13803636,11104575,8014374,5517852],hairTones:[2825494,4861726,8014374,12159818,14270346,9276813,2763310,8141370],carBodies:[11680571,3104140,14737632,2764083,5929546,14263361,9080726,7031418]},gt={ceiling:15525851,wall:13814974,trim:16249834,joineryDark:7034951,joineryLight:9073760,floorTimber:9072722,benchtop:12168342,tileFloor:12104358,metalDull:9146777,shadowDark:2764339},Os=new Map,iv=["roughness","metalness","flat","transparent","opacity","side","emissive","emissiveIntensity","vertexColors"];function ke(i,t={}){let e=String(i);for(const s of iv)t[s]!==void 0&&(e+="|"+s+"="+JSON.stringify(t[s]));if(Os.has(e))return Os.get(e);const n=new Rn({color:i,roughness:t.roughness??.85,metalness:t.metalness??0,flatShading:t.flat??!1,transparent:t.transparent??!1,opacity:t.opacity??1,side:t.side??ti,emissive:t.emissive??0,emissiveIntensity:t.emissiveIntensity??1,vertexColors:t.vertexColors??!1});return Os.set(e,n),n}function ki(i,t){if(Os.has(i))return Os.get(i);const e=t();return Os.set(i,e),e}const sv=i=>{i.fragmentShader=i.fragmentShader.replace("#include <opaque_fragment>",`#include <opaque_fragment>
    ...
    gl_FragColor.a = max( ghA, 0.80 * ghLit );`)};function ll(i){return i.onBeforeCompile=sv,i}function No(){return ki("window",()=>ll(new Rn({color:ie.glass,roughness:.1,metalness:0,transparent:!0,opacity:.28,depthWrite:!1,emissive:new Gt(16767392),emissiveIntensity:0})))}function rv(){return ki("windowinner",()=>ll(new Rn({color:ie.glass,roughness:.1,metalness:0,transparent:!0,opacity:.1,depthWrite:!1})))}function ov(){return ki("bulb",()=>new Rn({color:16774365,emissive:new Gt(16770744),emissiveIntensity:1.6}))}function Zu(){return ki("carglass",()=>new Rn({color:2831680,roughness:.2,metalness:.3}))}function Ju(){return ki("headlight",()=>new Rn({color:15787727,emissive:new Gt(16771512),emissiveIntensity:0}))}function Qu(){return ki("taillight",()=>new Rn({color:9186091,emissive:new Gt(16726843),emissiveIntensity:.2}))}function av(){return ki("troffer",()=>new Rn({color:16185074,roughness:.5,emissive:new Gt(14477567),emissiveIntensity:.9}))}function cv(){return ki("contactshadow",()=>{const t=document.createElement("canvas");t.width=t.height=128;const e=t.getContext("2d"),n=e.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);n.addColorStop(0,"rgb(140,140,140)"),n.addColorStop(.55,"rgb(196,196,196)"),n.addColorStop(1,"rgb(255,255,255)"),e.fillStyle=n,e.fillRect(0,0,128,128);const s=new Vn(t);s.colorSpace=Le;const r=new Gn({map:s,blending:ka,transparent:!0,depthWrite:!1,toneMapped:!1,polygonOffset:!0,polygonOffsetFactor:-1,polygonOffsetUnits:-1});return r.userData.decal=!0,r})}new Vt(1,1,1),new Be(1,1),new De(.5,.5,1,10),new Io(.5,1,8),new Fi(.5,12,10);const lv=new Set;function xr(i){lv.add(i)}function hv(i,t=!1){const e=i[0].index!==null,n=new Set(Object.keys(i[0].attributes)),s=new Set(Object.keys(i[0].morphAttributes)),r={},o={},a=i[0].morphTargetsRelative,c=new $e;let l=0;for(let h=0;h<i.length;++h){const u=i[h];let d=0;if(e!==(u.index!==null))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+". All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them."),null;for(const f in u.attributes){if(!n.has(f))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+'. All geometries must have compatible attributes; make sure "'+f+'" attribute exists among all geometries, or in none of them.'),null;r[f]===void 0&&(r[f]=[]),r[f].push(u.attributes[f]),d++}if(d!==n.size)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+". Make sure all geometries have the same number of attributes."),null;if(a!==u.morphTargetsRelative)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+". .morphTargetsRelative must be consistent throughout all geometries."),null;for(const f in u.morphAttributes){if(!s.has(f))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+".  .morphAttributes must be consistent throughout all geometries."),null;o[f]===void 0&&(o[f]=[]),o[f].push(u.morphAttributes[f])}if(t){let f;if(e)f=u.index.count;else if(u.attributes.position!==void 0)f=u.attributes.position.count;else return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+". The geometry must have either an index or a position attribute"),null;c.addGroup(l,f,h),l+=f}}if(e){let h=0;const u=[];for(let d=0;d<i.length;++d){const f=i[d].index;for(let m=0;m<f.count;++m)u.push(f.getX(m)+h);h+=i[d].attributes.position.count}c.setIndex(u)}for(const h in r){const u=Lh(r[h]);if(!u)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+h+" attribute."),null;c.setAttribute(h,u)}for(const h in o){const u=o[h][0].length;if(u===0)break;c.morphAttributes=c.morphAttributes||{},c.morphAttributes[h]=[];for(let d=0;d<u;++d){const f=[];for(let _=0;_<o[h].length;++_)f.push(o[h][_][d]);const m=Lh(f);if(!m)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+h+" morphAttribute."),null;c.morphAttributes[h].push(m)}}return c}function Lh(i){let t,e,n,s=-1,r=0;for(let l=0;l<i.length;++l){const h=i[l];if(t===void 0&&(t=h.array.constructor),t!==h.array.constructor)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes."),null;if(e===void 0&&(e=h.itemSize),e!==h.itemSize)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes."),null;if(n===void 0&&(n=h.normalized),n!==h.normalized)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes."),null;if(s===-1&&(s=h.gpuType),s!==h.gpuType)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes."),null;r+=h.count*e}const o=new t(r),a=new Te(o,e,n);let c=0;for(let l=0;l<i.length;++l){const h=i[l];if(h.isInterleavedBufferAttribute){const u=c/e;for(let d=0,f=h.count;d<f;d++)for(let m=0;m<e;m++){const _=h.getComponent(d,m);a.setComponent(d+u,m,_)}}else o.set(h.array,c);c+=h.count*e}return s!==void 0&&(a.gpuType=s),a}const uv=new Set(["position","normal","uv","color"]);function td(i,t={}){var o,a;i.updateMatrixWorld(!0);const e=new Map,n=[];i.traverse(c=>{var f,m;if(c===i)return;if(c.isInstancedMesh||c.userData.isSign||c.isLight){n.push(c);return}if(!c.isMesh||!((m=(f=c.geometry)==null?void 0:f.attributes)!=null&&m.position))return;const l=c.material.uuid;e.has(l)||e.set(l,{material:c.material,geos:[],cast:!1});const h=c.geometry.clone();h.applyMatrix4(c.matrixWorld);for(const _ of Object.keys(h.attributes))uv.has(_)||h.deleteAttribute(_);const u=h.attributes.position.count;h.attributes.uv||h.setAttribute("uv",new Te(new Float32Array(u*2),2)),h.attributes.color||h.setAttribute("color",new Te(new Float32Array(u*3).fill(1),3));const d=e.get(l);d.geos.push(h.index?h.toNonIndexed():h),d.cast=d.cast||c.castShadow});const s=t.colliders?new Cc(t.colliders,1):null,r=new Qt;for(const{material:c,geos:l,cast:h}of e.values()){if(!l.length)continue;const u=l.length===1?l[0]:hv(l,!1);if(!u){console.error("bakeGroup: merge returned null (mismatched attributes)",c);continue}const d=((o=c.userData)==null?void 0:o.decal)===!0,f=(a=c.userData)==null?void 0:a.uvScale;f&&!d&&dv(u,f[0],f[1]),s&&!d&&_v(u,s);const m=new ut(u,c);m.castShadow=d?!1:h,m.receiveShadow=!d,d&&(m.renderOrder=2),r.add(m)}for(const c of n)r.add(c);return r}function dv(i,t,e=t){const n=i.attributes.position.count,s=i.attributes.position.array,r=i.attributes.normal.array,o=new Float32Array(n*2);for(let a=0;a<n;a++){const c=a*3,l=Math.abs(r[c]),h=Math.abs(r[c+1]),u=Math.abs(r[c+2]);let d,f;h>=l&&h>=u?(d=s[c],f=s[c+2]):l>=u?(d=s[c+2],f=s[c+1]):(d=s[c],f=s[c+1]),o[a*2]=d/t,o[a*2+1]=f/e}i.setAttribute("uv",new Te(o,2))}const Ma=512,Ih=1024;function Dh(i,t,e){return((i+Ma)*Ih+(t+Ma))*Ih+(e+Ma)}class Cc{constructor(t,e=1){this.cell=e,this.boxes=t,this.bins=new Map;for(let n=0;n<t.length;n++){const s=t[n],r=Math.floor(s.min.x/e),o=Math.floor(s.max.x/e),a=Math.floor(s.min.y/e),c=Math.floor(s.max.y/e),l=Math.floor(s.min.z/e),h=Math.floor(s.max.z/e);for(let u=r;u<=o;u++)for(let d=a;d<=c;d++)for(let f=l;f<=h;f++){const m=Dh(u,d,f);let _=this.bins.get(m);_||(_=[],this.bins.set(m,_)),_.push(n)}}this._stamp=new Int32Array(t.length),this._epoch=0,this._out=[]}near(t,e,n,s){const r=this.cell,o=this._out;o.length=0;const a=++this._epoch,c=Math.floor((t-s)/r),l=Math.floor((t+s)/r),h=Math.floor((e-s)/r),u=Math.floor((e+s)/r),d=Math.floor((n-s)/r),f=Math.floor((n+s)/r);for(let m=c;m<=l;m++)for(let _=h;_<=u;_++)for(let p=d;p<=f;p++){const g=this.bins.get(Dh(m,_,p));if(g)for(let y=0;y<g.length;y++){const x=g[y];this._stamp[x]!==a&&(this._stamp[x]=a,o.push(this.boxes[x]))}}return o}}const fv=.18,pv=.55,Uh=.75,mv=.3,Nh=.55,gv=1.2;function _v(i,t){const e=t instanceof Cc?t:new Cc(t,1),n=Array.isArray(i)?i:[i];for(const s of n)xv(s,e)}function xv(i,t){const e=i.attributes.color;if(!e||e.itemSize!==3||e.normalized||!i.attributes.normal)return;const n=i.attributes.position.array,s=i.attributes.normal.array,r=e.array,o=i.attributes.position.count;for(let a=0;a<o;a++){const c=a*3,l=s[c],h=s[c+1],u=s[c+2],d=n[c]+l*.01,f=n[c+1]+h*.01,m=n[c+2]+u*.01;let _=0;const p=t.near(d,f,m,gv);for(let y=0;y<p.length;y++){const x=p[y],S=Math.max(x.min.x-d,0,d-x.max.x),C=Math.max(x.min.y-f,0,f-x.max.y),A=Math.max(x.min.z-m,0,m-x.max.z),b=Math.sqrt(S*S+C*C+A*A);if(b>Uh*3)continue;const P=(x.min.x+x.max.x)/2-d,D=(x.min.y+x.max.y)/2-f,v=(x.min.z+x.max.z)/2-m;l*P+h*D+u*v<=0||(_+=pv*Math.exp(-b/fv)+mv*Math.exp(-b/Uh))}const g=Math.max(Nh,1-Math.min(1-Nh,_));r[c]*=g,r[c+1]*=g,r[c+2]*=g}e.needsUpdate=!0}let vv=8,yv=i=>{const t=document.createElement("canvas");return t.width=t.height=i,t};const ed=(i,t=i)=>{const e=yv(i);return e.width=i,e.height=t,e};let nd=0;function hl(i,t){return t&&(i.colorSpace=Le),i.wrapS=i.wrapT=xo,i.anisotropy=vv,i.generateMipmaps=!0,i.minFilter=Pi,i.magFilter=Tn,nd+=i.image.width*i.image.height*4*4/3,i}function ii(i){return hl(new Vn(Mv(i)),!0)}function Pc(i){return i.wrapS=i.wrapT=Ci,i}function Mv(i){const t=ed(i.w,i.h),e=t.getContext("2d"),n=e.createImageData(i.w,i.h),s=n.data,r=i.d,o=i.w*i.h;for(let a=0,c=0,l=0;a<o;a++,c+=3,l+=4){const h=r[c],u=r[c+1],d=r[c+2];s[l]=(h<0?0:h>1?1:h)*255+.5,s[l+1]=(u<0?0:u>1?1:u)*255+.5,s[l+2]=(d<0?0:d>1?1:d)*255+.5,s[l+3]=255}return e.putImageData(n,0,0),t}const Ae=i=>i<0?0:i>1?1:i,ei=i=>[(i>>16&255)/255,(i>>8&255)/255,(i&255)/255];function Sv(i){const[t,e,n]=i,s=Math.max(t,e,n),r=Math.min(t,e,n),o=(s+r)/2;if(s===r)return[0,0,o];const a=s-r,c=o>.5?a/(2-s-r):a/(s+r);let l;return s===t?l=((e-n)/a+(e<n?6:0))/6:s===e?l=((n-t)/a+2)/6:l=((t-e)/a+4)/6,[l,c,o]}function wv(i,t,e){if(t===0)return[e,e,e];const n=e<.5?e*(1+t):e+t-e*t,s=2*e-n,r=o=>(o=(o%1+1)%1,o<1/6?s+(n-s)*6*o:o<1/2?n:o<2/3?s+(n-s)*(2/3-o)*6:s);return[r(i+1/3),r(i),r(i-1/3)]}function Qn(i,t=1,e=0,n=1){const[s,r,o]=Sv(Array.isArray(i)?i:ei(i));return wv(s+e/360,Ae(r*n),Ae(o*t))}function si(i,t){return{w:i,h:t,d:new Float32Array(i*t*3)}}function rs(i,t){const e=Array.isArray(t)?t:ei(t),n=i.d;for(let s=0;s<n.length;s+=3)n[s]=e[0],n[s+1]=e[1],n[s+2]=e[2]}function ul(i,t,e,n,s){if(s<=0)return;const r=i.w,o=i.h;let a=t,c=e;(a<0||a>=r)&&(a=(a%r+r)%r),(c<0||c>=o)&&(c=(c%o+o)%o);const l=(c*r+a)*3,h=i.d,u=1-s;h[l]=h[l]*u+n[0]*s,h[l+1]=h[l+1]*u+n[1]*s,h[l+2]=h[l+2]*u+n[2]*s}function wn(i,t,e,n,s,r,o=1){const a=Array.isArray(r)?r:ei(r),c=Math.round(t),l=Math.round(n),h=Math.round(e),u=Math.round(s);if(o<1){for(let _=h;_<u;_++)for(let p=c;p<l;p++)ul(i,p,_,a,o);return}const d=i.w,f=i.h,m=i.d;for(let _=h;_<u;_++){let p=_;(p<0||p>=f)&&(p=(p%f+f)%f);const g=p*d;for(let y=c;y<l;y++){let x=y;(x<0||x>=d)&&(x=(x%d+d)%d);const S=(g+x)*3;m[S]=a[0],m[S+1]=a[1],m[S+2]=a[2]}}}function vr(i,t,e,n,s,r=1){const o=n+1;for(let a=Math.floor(e-o);a<=Math.ceil(e+o);a++)for(let c=Math.floor(t-o);c<=Math.ceil(t+o);c++){const l=c+.5-t,h=a+.5-e,u=Ae(n-Math.sqrt(l*l+h*h)+.5);u>0&&ul(i,c,a,s,r*u)}}function Lc(i,t,e,n,s=1){const r=Math.max(1,e)/2;for(let o=1;o<t.length;o++){const[a,c]=t[o-1],[l,h]=t[o],u=Math.hypot(l-a,h-c),d=Math.max(1,Math.ceil(u));for(let f=0;f<=d;f++){const m=f/d;vr(i,a+(l-a)*m,c+(h-c)*m,r,n,s)}}}function id(i,t,e,n,s,r,o,a){const c=i.w,l=i.h,h=i.d,u=r/2,d=o[0],f=o[1],m=o[2],_=Math.PI*2/n;for(let p=0;p<l;p++){const g=p*c,y=t+e*Math.sin(p*_+s),x=y-u,S=y+u,C=Math.floor(x),A=Math.ceil(S);for(let b=C;b<=A;b++){const P=Ae(Math.min(b+1,S)-Math.max(b,x));if(P<=0)continue;const D=a*P,v=1-D;let w=b;(w<0||w>=c)&&(w=(w%c+c)%c);const U=(g+w)*3;h[U]=h[U]*v+d*D,h[U+1]=h[U+1]*v+f*D,h[U+2]=h[U+2]*v+m*D}}}const Oh=i=>i*i*(3-2*i);function Ev(i,t,e){const n=new Float32Array(t*e);for(let s=0;s<n.length;s++)n[s]=i.float();return n}const Fh=256;function Wn(i,t,e={}){const{p0:n=32,octaves:s=4,gain:r=.5,lacunarity:o=2,h:a=t}=e,c=e.p0x??n,l=e.p0y??n,h=new Float32Array(t*a),u=[];let d=1,f=0;for(let C=0;C<s;C++){const A=Math.min(Fh,Math.max(1,Math.round(c*o**C))),b=Math.min(Fh,Math.max(1,Math.round(l*o**C)));u.push({lat:Ev(i,A,b),px:A,py:b,amp:d}),f+=d,d*=r}const m=new Float64Array(t*a),_=new Int32Array(t),p=new Int32Array(t),g=new Float64Array(t);for(let C=0;C<u.length;C++){const A=u[C],b=A.lat,P=A.px,D=A.py,v=A.amp,w=P/t,U=D/a;for(let N=0;N<t;N++){const X=N*w,q=X|0,V=q>=P?q%P:q;_[N]=V,p[N]=V+1>=P?0:V+1,g[N]=Oh(X-q)}for(let N=0;N<a;N++){const X=N*U,q=X|0,V=Oh(X-q),K=1-V,k=q>=D?q%D:q,pt=k*P,mt=(k+1>=D?0:k+1)*P,ct=N*t;for(let zt=0;zt<t;zt++){const jt=_[zt],Q=p[zt],F=g[zt],dt=b[pt+jt],nt=b[pt+Q],vt=b[mt+jt],_t=b[mt+Q];m[ct+zt]+=v*((dt+(nt-dt)*F)*K+(vt+(_t-vt)*F)*V)}}}let y=1/0,x=-1/0;for(let C=0;C<h.length;C++){h[C]=m[C]/f;const A=h[C];A<y&&(y=A),A>x&&(x=A)}const S=x-y||1;for(let C=0;C<h.length;C++)h[C]=(h[C]-y)/S;return h}function sd(i,t,e,n){const s=new Float32Array(t*e),r=new Float32Array(t*e),o=2*n+1,a=new Int32Array(t),c=new Int32Array(t);for(let u=0;u<t;u++)a[u]=((u-n)%t+t)%t,c[u]=(u+n+1)%t;for(let u=0;u<e;u++){const d=u*t;let f=0;for(let m=-n;m<=n;m++)f+=i[d+(m%t+t)%t];for(let m=0;m<t;m++)s[d+m]=f/o,f-=i[d+a[m]],f+=i[d+c[m]]}const l=new Int32Array(e),h=new Int32Array(e);for(let u=0;u<e;u++)l[u]=((u-n)%e+e)%e*t,h[u]=(u+n+1)%e*t;for(let u=0;u<t;u++){let d=0;for(let f=-n;f<=n;f++)d+=s[(f%e+e)%e*t+u];for(let f=0;f<e;f++)r[f*t+u]=d/o,d-=s[l[f]+u],d+=s[h[f]+u]}return r}function bv(i,t,e=1.5,n=null){const s=n??i.length/t,r=new Uint8Array(t*s*4),o=e/8,a=new Int32Array(t),c=new Int32Array(t);for(let l=0;l<t;l++)a[l]=(l-1+t)%t,c[l]=(l+1)%t;for(let l=0;l<s;l++){const h=(l-1+s)%s*t,u=l*t,d=(l+1)%s*t;let f=u*4;for(let m=0;m<t;m++,f+=4){const _=a[m],p=c[m],g=i[h+_],y=i[h+m],x=i[h+p],S=i[u+_],C=i[u+p],A=i[d+_],b=i[d+m],P=i[d+p],D=x+2*C+P-(g+2*S+A),v=A+2*b+P-(g+2*y+x),w=-D*o,U=v*o,N=1/Math.sqrt(w*w+U*U+1);r[f]=(w*N*.5+.5)*255+.5,r[f+1]=(U*N*.5+.5)*255+.5,r[f+2]=(N*.5+.5)*255+.5,r[f+3]=255}}return r}function yr(i,t,e=1.5,n=null){const s=n??i.length/t;return hl(new Vn(rd(bv(i,t,e,s),t,s)),!1)}function rd(i,t,e){const n=ed(t,e),s=n.getContext("2d"),r=s.createImageData(t,e);return r.data.set(i),s.putImageData(r,0,0),n}function Tv(i,t,e,n,s=null){const o=i*(s??i),a=new Uint8Array(o*4);for(let c=0,l=0;c<o;c++,l+=4){const h=t?t[c]:1,u=e?e[c]:.85,d=n?n[c]:0;a[l]=(h<0?0:h>1?1:h)*255+.5,a[l+1]=(u<0?0:u>1?1:u)*255+.5,a[l+2]=(d<0?0:d>1?1:d)*255+.5,a[l+3]=255}return a}function Cn(i,t,e,n,s=null){const r=s??i;return hl(new Vn(rd(Tv(i,t,e,n,r),i,r)),!1)}const dl={},ur=new Map;let od=null;function en(i,t){dl[i]=t}const Av=i=>{const t=Object.keys(i).sort();return t.length?t.map(e=>e+"="+JSON.stringify(i[e])).join(","):""};function Rv(i,t=null,e={}){const n=dl[i];if(!n)throw new Error(`Textures: no recipe named '${i}'`);const s=Av(e),r=s?i+"#"+s:i;if(ur.has(r))return ur.get(r);const o=t||(od||new Ao("textures")).child("tex."+r),a=n(o,e);return a.name=i,ur.set(r,a),a}function Cv(){var i,t;for(const e of ur.values()){for(const n of["map","normalMap","ormMap"])(t=(i=e[n])==null?void 0:i.dispose)==null||t.call(i);if(e.maps)for(const n of e.maps)n.dispose()}ur.clear(),nd=0,od=null}xr(Cv);const Sa={blackbutt:{base:13214581,dark:10122054,rough:.4},spottedGum:{base:11040332,dark:8015662,rough:.38},jarrah:{base:9061685,dark:6040352,rough:.44},tasOak:{base:14072722,dark:11111779,rough:.42},pine:{base:14467213,dark:11571294,rough:.5}};en("timberFloor",(i,t={})=>{const o=1.9500000000000002,a=1024/o,c=1024/15,l=Math.max(2,Math.round(.004*a)),h=t.species||i.pick(Object.keys(Sa)),u=Sa[h]||Sa.blackbutt,d=si(1024,1024);rs(d,Qn(u.dark,.72));const f=ei(u.dark),m=Qn(u.base,1.25),_=[];for(let A=0;A<15;A++){const b=A*c+l/2,P=(A+1)*c-l/2,D=Qn(u.base,1+i.range(-.06,.06),i.range(-3,3));wn(d,b,0,P,1024,D);const v=Math.round(i.range(.15,.85)*1024);_.push(v),wn(d,b,v,P,v+2,Qn(u.dark,.8),.85),wn(d,b,v-2,P,v,m,.25);const w=i.int(28,60);for(let U=0;U<w;U++){const N=i.range(b+1,P-1),X=i.range(1.5,4),q=1024/i.int(2,5),V=i.range(0,Math.PI*2),K=i.range(2,3),k=i.range(.04,.12),pt=i.chance(.25)?m:f;id(d,N,X,q,V,K,pt,k)}if(i.chance(.2)){const U=i.range(204.8,819.2),N=i.range(60,160),X=i.range(b+4,P-4);for(let q=0;q<i.int(2,4);q++){const V=(q+1)*i.range(3,7),K=[];for(let k=0;k<=16;k++){const pt=k/16;K.push([X+(pt-.5)*2*V,U-N*(1-(pt-.5)**2*4)])}Lc(d,K,2,f,.06)}}}const p=Wn(i,512,{p0:64,octaves:3}),g=new Float32Array(512*512),y=new Float32Array(512*512),x=new Float32Array(512*512),S=512/15,C=l*512/1024;for(let A=0;A<512;A++)for(let b=0;b<512;b++){const P=A*512+b,D=Math.floor(b/S),v=b-D*S,w=v<C/2||v>S-C/2,U=A*1024/512,N=_[D],X=U>=N-1&&U<=N+2,q=w||X;y[P]=q?.15:.75,g[P]=Ae(u.rough+(q?.1:0)+(p[P]-.5)*.1),x[P]=q?.72:1}return{map:ii(d),normalMap:yr(sd(y,512,512,1),512,1.2),ormMap:Cn(512,x,g,null),uvScale:[o,o],normalScale:.5,species:h,tinted:!1}});en("plasterWall",(i,t={})=>{const s=t.rough??.88,r=Wn(i,256,{p0:64,octaves:3,gain:.45}),o=new Float32Array(256*256),a=.4*256/2;for(let c=0;c<256;c++)for(let l=0;l<256;l++){const h=c*256+l;let u=s+(r[h]**1.5-.5)*.1;t.ceiling||(u+=Math.cos(l/a*Math.PI*2)*.02),o[h]=Ae(u)}return{ormMap:Cn(256,null,o,null),uvScale:[2,2],normalScale:0,tinted:!0}});en("plasterCeiling",i=>dl.plasterWall(i,{rough:.93,ceiling:!0}));en("paintedJoinery",i=>{const n=Wn(i,256,{p0:64,octaves:3}),s=new Float32Array(256*256);for(let r=0;r<256;r++)for(let o=0;o<256;o++){const a=r*256+o;s[a]=Ae(.42+(n[a]-.5)*.06+Math.sin(o/256*Math.PI*2*12)*.015)}return{ormMap:Cn(256,null,s,null),uvScale:[1,1],normalScale:0,tinted:!0}});en("carpetPile",i=>{const n=si(512,512);rs(n,[1,1,1]);const s=Wn(i,512,{p0x:64,p0y:192,octaves:3,gain:.5}),r=n.d;for(let c=0;c<512;c++)for(let l=0;l<512;l++){const h=c*512+l,u=Math.cos(c/256*Math.PI*2)*.03,d=Ae(.9+(s[h]-.5)*.16+u);r[h*3]=d,r[h*3+1]=d,r[h*3+2]=d}for(let c=0;c<1200;c++){const l=i.pick([[1.1,0],[.78,8],[.92,-10]]),h=Qn(16777215,l[0],l[1],1);if(l[1]!==0){const u=i.range(0,1);h[0]=h[0]*(.94+u*.12),h[2]=h[2]*(1.06-u*.12)}vr(n,i.range(0,512),i.range(0,512),i.range(1,2),h,.25)}const o=Wn(i,512,{p0x:43,p0y:128,octaves:3}),a=new Float32Array(512*512);for(let c=0;c<a.length;c++)a[c]=Ae(.92+(o[c]-.5)*.06);return{map:ii(n),normalMap:yr(o,512,.6),ormMap:Cn(512,null,a,null),uvScale:[1,1],normalScale:.7,tinted:!0}});en("ceramicTile",(i,t={})=>{const n=t.tile??.3,s=2,r=n*s,o=Math.max(2,Math.round(.003*512/r)),a=3,c=512/s,l=ei(12104358),h=[];for(let p=0;p<s*s;p++)h.push({c:Qn(14473423,1+i.range(-.03,.03),i.range(-2,2)),g:i.range(-1,1)});const u=si(512,512),d=new Float32Array(512*512),f=new Float32Array(512*512),m=new Float32Array(512*512),_=o/2;for(let p=0;p<512;p++)for(let g=0;g<512;g++){const y=p*512+g,x=Math.floor(g/c),S=Math.floor(p/c),C=g-x*c,A=p-S*c,b=Math.min(C,c-C,A,c-A);if(b<_){u.d[y*3]=l[0],u.d[y*3+1]=l[1],u.d[y*3+2]=l[2],d[y]=.85,f[y]=.25,m[y]=.62;continue}const P=h[S*s+x],D=(C/c+A/c)/2,v=1.03-.06*(P.g>0?D:1-D);u.d[y*3]=Ae(P.c[0]*v),u.d[y*3+1]=Ae(P.c[1]*v),u.d[y*3+2]=Ae(P.c[2]*v),d[y]=.08;const w=Ae((b-_)/a);f[y]=.25+.75*w,m[y]=.62+.38*w}return{map:ii(u),normalMap:yr(f,512,2),ormMap:Cn(512,m,d,null),uvScale:[r,r],normalScale:.8,tinted:!1}});en("fabricWeave",i=>{const n=si(256,256),s=new Float32Array(256*256),r=new Float32Array(256*256),o=128,a=new Float32Array(o*8),c=new Float32Array(o*8);for(let h=0;h<a.length;h++)a[h]=i.range(-.035,.035);for(let h=0;h<c.length;h++)c[h]=i.range(-.035,.035);const l=Wn(i,256,{p0:64,octaves:2});for(let h=0;h<256;h++)for(let u=0;u<256;u++){const d=h*256+u,f=(u>>1&1^h>>1&1)===0,m=u>>1,_=h>>1,p=f?a[(m*8+(h>>5&7))%a.length]:c[(_*8+(u>>5&7))%c.length],g=Ae((f?1.06:.94)+p+(l[d]-.5)*.06);n.d[d*3]=g,n.d[d*3+1]=g,n.d[d*3+2]=g,s[d]=f?.66:.8,r[d]=f?1:.3}return{map:ii(n),normalMap:yr(sd(r,256,256,1),256,.8),ormMap:Cn(256,null,s,null),uvScale:[.25,.25],normalScale:.6,tinted:!0}});en("joineryTimber",i=>{const n=si(512,512);rs(n,[1,1,1]);const s=Wn(i,512,{p0x:48,p0y:8,octaves:4}),r=n.d;for(let c=0;c<512*512;c++){const l=Ae(.94+(s[c]-.5)*.22);r[c*3]=l,r[c*3+1]=l,r[c*3+2]=l}const o=Qn(16777215,.72);for(let c=0;c<220;c++){const l=i.range(0,512),h=i.range(2,6),u=512/i.int(1,2),d=i.range(0,Math.PI*2);id(n,l,h,u,d,i.range(2,3.5),o,i.range(.03,.09))}const a=new Float32Array(512*512);for(let c=0;c<a.length;c++)a[c]=Ae(.55+(s[c]-.5)*.08);return{map:ii(n),ormMap:Cn(512,null,a,null),uvScale:[1,1],normalScale:0,tinted:!0}});en("vinylSheet",i=>{const n=si(512,512);rs(n,14209732);const s=[13222578,15131093,11906460,14472902].map(ei);for(let c=0;c<3e3;c++)vr(n,i.range(0,512),i.range(0,512),i.range(1,3),i.pick(s),.35);const r=Wn(i,512,{p0:32,octaves:3}),o=new Float32Array(512*512);for(let c=0;c<o.length;c++)o[c]=Ae(.28+(r[c]-.5)*.12);const a={w:512,h:512,d:new Float32Array(512*512*3)};for(let c=0;c<12;c++){const l=i.range(0,512),h=i.range(0,512),u=i.range(40,120),d=i.range(0,Math.PI*2),f=i.range(.6,2.2),m=[];for(let _=0;_<=24;_++){const p=d+f*(_/24);m.push([l+Math.cos(p)*u,h+Math.sin(p)*u])}Lc(n,m,i.range(2,4),Qn(14209732,.88),.3),Lc(a,m,i.range(2,4),[1,1,1],1)}for(let c=0;c<o.length;c++)o[c]=Ae(o[c]+a.d[c*3]*.15);return{map:ii(n),ormMap:Cn(512,null,o,null),uvScale:[1,1],normalScale:0,tinted:!1}});en("laminateBench",i=>{const s=si(512,512);rs(s,gt.benchtop);const r=[9274743,14077886,7235417].map(ei);for(let l=0;l<2e3;l++)vr(s,i.range(0,512),i.range(0,512),i.range(1,2.5),i.pick(r),.3);const o=new Float32Array(512*512);for(let l=0;l<o.length;l++)o[l]=.28;const a=Math.max(2,Math.round(.006*512/.6)),c=Qn(gt.benchtop,.82);for(let l=0;l<512;l++)if(Math.min(l,512-l)<a)for(let u=0;u<512;u++)ul(s,u,l,c,.85),o[l*512+u]=.45;return{map:ii(s),ormMap:Cn(512,null,o,null),uvScale:[1.2,.6],normalScale:0,tinted:!1}});en("ceilingGrid",i=>{const s=si(512,512);rs(s,15526370);const r=Math.max(2,Math.round(.015*512/1.2)),o=Math.max(2,Math.round(.015*512/.6)),a=ei(14210509),c=ei(12434098),l=Wn(i,512,{p0:64,octaves:2}),h=new Float32Array(512*512);for(let u=0;u<512;u++)for(let d=0;d<512;d++){const f=u*512+d,m=Math.min(d,512-d),_=Math.min(u,512-u);if(m<r/2||_<o/2){const y=m>=r/2-2&&m<r/2||_>=o/2-2&&_<o/2?c:a;s.d[f*3]=y[0],s.d[f*3+1]=y[1],s.d[f*3+2]=y[2],h[f]=.55}else{const g=1+(l[f]-.5)*.04;s.d[f*3]*=g,s.d[f*3+1]*=g,s.d[f*3+2]*=g,h[f]=.9}}return{map:ii(s),ormMap:Cn(512,null,h,null),uvScale:[1.2,.6],normalScale:0,tinted:!1}});en("applianceEnamel",i=>{const n=Wn(i,256,{p0:64,octaves:3}),s=new Float32Array(256*256);for(let r=0;r<s.length;r++)s[r]=Ae(.3+(n[r]-.5)*.04);return{ormMap:Cn(256,null,s,null),uvScale:[1,1],normalScale:0,tinted:!0}});en("metalBrushed",i=>{const n=new Float32Array(65536),s=new Float32Array(256*256),r=Wn(i,256,{p0x:8,p0y:256,octaves:2});for(let o=0;o<256;o++){const a=i.range(-.1,.1);for(let c=0;c<256;c++){const l=o*256+c;n[l]=Ae(.35+a*.6+(r[l]-.5)*.1)}}return{ormMap:Cn(256,null,n,s),uvScale:[.4,.4],normalScale:0,tinted:!0}});en("quiltFolds",i=>{const n=[],s=i.int(5,9);for(let d=0;d<s;d++)n.push({a:i.range(.4,1),c:i.range(.05,.95),w:i.range(.06,.14)});const r=d=>{let f=0;for(const m of n)f+=m.a*Math.exp(-(((d-m.c)/m.w)**2));return f+=.5*Math.exp(-((d/.04)**2))+.5*Math.exp(-(((1-d)/.04)**2)),f};let o=1/0,a=-1/0;for(let d=0;d<=256;d++){const f=r(d/256);f<o&&(o=f),f>a&&(a=f)}const c=a-o||1,l=d=>(r(Ae(d))-o)/c,h=si(512,256),u=new Float32Array(512*256);for(let d=0;d<512;d++){const f=l(d/511),m=.9+.1*f;for(let _=0;_<256;_++){const p=_*512+d;h.d[p*3]=m,h.d[p*3+1]=m,h.d[p*3+2]=m,u[p]=f}}return{map:Pc(ii(h)),normalMap:Pc(yr(u,512,3,256)),uvScale:null,normalScale:1,field:l,folds:n,tinted:!0}});en("pictureArt",i=>{const n=[[14272936,10251087,4148050,15130057],[8361635,14213090,3095106,12820586],[11056266,15196880,6056775,9067068],[13609376,8015698,15722204,3814198],[9415096,15788760,4479587,12153919]],s=[];for(let r=0;r<5;r++){const o=n[r].map(ei),a=si(256,256);rs(a,o[i.int(0,3)]);const c=i.int(0,2);if(c===0){let h=0;for(;h<256;){const u=i.int(12,48);wn(a,0,h,256,Math.min(256,h+u),o[i.int(0,3)],i.range(.5,1)),h+=u}}else if(c===1)for(let h=0;h<i.int(5,11);h++){const u=i.range(0,179.2),d=i.range(0,256*.7);wn(a,u,d,u+i.range(30,110),d+i.range(30,110),o[i.int(0,3)],i.range(.55,.95))}else{const h=i.range(115.2,174.08);wn(a,0,0,256,h,o[0],1),wn(a,0,h,256,256,o[2],1);for(let u=0;u<i.int(3,7);u++){const d=i.range(h-40,h+40);wn(a,0,d,256,d+i.range(3,10),o[i.int(0,3)],i.range(.3,.7))}vr(a,i.range(256*.2,256*.8),i.range(20,h-20),i.range(12,26),o[3],.9)}const l=Qn(16777215,.97);wn(a,0,0,256,6,l),wn(a,0,250,256,256,l),wn(a,0,0,6,256,l),wn(a,250,0,256,256,l),s.push(Pc(ii(a)))}return{maps:s,map:s[0],uvScale:null,normalScale:0,prints:5,tinted:!1}});const Pv={wall:{recipe:"plasterWall",r:1,m:0,cast:!0,tint:!0},wallWet:{recipe:"ceramicTile",r:1,m:0,cast:!0,tint:!1},ceiling:{recipe:"plasterCeiling",r:1,m:0,cast:!1,tint:!0},trim:{recipe:"paintedJoinery",r:1,m:0,cast:!0,tint:!0},doorLeaf:{recipe:"paintedJoinery",r:1,m:0,cast:!0,tint:!0},floorTimber:{recipe:"timberFloor",r:1,m:0,cast:!1,tint:!1},carpet:{recipe:"carpetPile",r:1,m:0,cast:!1,tint:!0},vinyl:{recipe:"vinylSheet",r:1,m:0,cast:!1,tint:!1},tile:{recipe:"ceramicTile",r:1,m:0,cast:!1,tint:!1},joinery:{recipe:"joineryTimber",r:1,m:0,cast:!0,tint:!0},fabric:{recipe:"fabricWeave",r:1,m:0,cast:!0,tint:!0},bedding:{recipe:"fabricWeave",r:1,m:0,cast:!0,tint:!0},bench:{recipe:"laminateBench",r:1,m:0,cast:!0,tint:!1},appliance:{recipe:"applianceEnamel",r:1,m:0,cast:!0,tint:!0},metal:{recipe:"metalBrushed",r:1,m:1,cast:!0,tint:!0},chrome:{recipe:null,r:.18,m:0,cast:!0,tint:!1},ceramic:{recipe:null,r:.12,m:0,cast:!0,tint:!1},screen:{recipe:null,r:.08,m:0,cast:!1,tint:!1},glass:{recipe:null,r:.1,m:0,cast:!1,tint:!1,alpha:.28},ceilingGrid:{recipe:"ceilingGrid",r:1,m:0,cast:!1,tint:!1},quilt:{recipe:"quiltFolds",r:.8,m:0,cast:!0,tint:!0},artwork:{recipe:"pictureArt",r:.55,m:0,cast:!1,tint:!1}},Cs=new Map;function fl(i,t=16777215,e=null,n={}){const s=Pv[i];if(!s)throw new Error(`Surfaces: no surface named '${i}'`);const r=Object.keys(n).sort().map(h=>h+"="+JSON.stringify(n[h])).join(","),o=i+"|"+t+"|"+r;if(Cs.has(o))return Cs.get(o);const a={color:t,roughness:s.r,metalness:s.m,vertexColors:!0};s.alpha!==void 0&&(a.transparent=!0,a.opacity=s.alpha,a.depthWrite=!1);const c=h=>s.alpha!==void 0?ll(h):h;if(s.recipe){const{print:h,...u}=n,d=Object.keys(u).sort().map(g=>g+"="+JSON.stringify(u[g])).join(","),f=e?e.child("tex."+s.recipe+(d?"#"+d:"")):null,m=Rv(s.recipe,f,u),_=m.maps?m.maps[Math.min(m.maps.length-1,h??0)]:m.map;if(_&&(a.map=_),m.normalMap){a.normalMap=m.normalMap;const g=m.normalScale??1;a.normalScale=new St(g,g)}m.ormMap?(a.aoMap=m.ormMap,a.roughnessMap=m.ormMap,a.aoMapIntensity=1,a.roughness=1,s.m===1&&(a.metalnessMap=m.ormMap,a.metalness=1)):a.roughness=s.r===1?.85:s.r;const p=c(new Rn(a));return m.uvScale&&(p.userData.uvScale=m.uvScale),p.userData.cast=s.cast,p.userData.surface=i,Cs.set(o,p),p}const l=c(new Rn(a));return l.userData.cast=s.cast,l.userData.surface=i,Cs.set(o,l),l}function Lv(){for(const i of Cs.values())i.dispose();Cs.clear()}xr(Lv);const Ut={wallThick:.17,storey:2.65,cornice:.09,doorH:2.05,winSill:.95,winHead:2.15,intWall:.11,skirtProud:.018,archW:.09,archProud:.018,archQuirk:.006,corniceGirth:.075,reveal:.019,skirtCommercial:.1,leafT:.035,headDatum:2.1,benchH:.9,toeKickH:.15,toeKickD:.05,cabinetModules:[.3,.45,.6,.75,.9,1,1.2],handleH:1,switchH:1.05,gpoH:.3},Ee={thin:.002,furniture:.003,joinery:.005},zh=new Set;function Ic(i,t,e={}){if(e.material)return e.material;try{return fl(i,t,null,e.recipe||{})}catch(n){zh.has(i)||(zh.add(i),console.error(`RoomKit: surface '${i}' unavailable, falling back to flat colour`,n))}return ke(t,e)}function ne(i,t,e,n,s,r={}){var l;const o=Ic(i,s,r),a=r.chamfer?ld(t,e,n,r.chamfer):r.graded?Iv(t,e,n,r.gradeEdge):new Vt(Math.max(t,.001),Math.max(e,.001),Math.max(n,.001)),c=new ut(a,o);return c.castShadow=r.cast??((l=o.userData)==null?void 0:l.cast)??!1,c.receiveShadow=!0,c}const qs=new Map,Ii=i=>Math.round(i*1e3);function ad(i,t,e){const n=new Float32Array(e*2);for(let s=0;s<e;s++){const r=s*3,o=Math.abs(t[r]),a=Math.abs(t[r+1]),c=Math.abs(t[r+2]);a>=o&&a>=c?(n[s*2]=i[r],n[s*2+1]=i[r+2]):o>=c?(n[s*2]=i[r+2],n[s*2+1]=i[r+1]):(n[s*2]=i[r],n[s*2+1]=i[r+1])}return n}function cd(i){const t=i.length*3,e=new Float32Array(t*3),n=new Float32Array(t*3);let s=0;for(const o of i){const[a,c,l]=o;let h=c[0]-a[0],u=c[1]-a[1],d=c[2]-a[2],f=l[0]-a[0],m=l[1]-a[1],_=l[2]-a[2],p=u*_-d*m,g=d*f-h*_,y=h*m-u*f;const x=(a[0]+c[0]+l[0])/3,S=(a[1]+c[1]+l[1])/3,C=(a[2]+c[2]+l[2])/3;let A=c,b=l;p*x+g*S+y*C<0&&(A=l,b=c,p=-p,g=-g,y=-y);const P=Math.hypot(p,g,y)||1;p/=P,g/=P,y/=P;for(const D of[a,A,b])e[s*3]=D[0],e[s*3+1]=D[1],e[s*3+2]=D[2],n[s*3]=p,n[s*3+1]=g,n[s*3+2]=y,s++}const r=new $e;return r.setAttribute("position",new Te(e,3)),r.setAttribute("normal",new Te(n,3)),r.setAttribute("uv",new Te(ad(e,n,t),2)),r.setAttribute("color",new Te(new Float32Array(t*3).fill(1),3)),r}function ld(i,t,e,n=Ee.furniture){i=Math.max(i,.001),t=Math.max(t,.001),e=Math.max(e,.001);const s=Math.min(n,Math.min(i,t,e)/2-5e-4);if(!(s>2e-4))return new Vt(i,t,e);const r=`c${Ii(i)},${Ii(t)},${Ii(e)},${Ii(s)}`,o=qs.get(r);if(o)return o;const a=i/2,c=t/2,l=e/2,h=[a-s,c-s,l-s],u=[a,c,l],d=(g,y)=>[(y===0?u[0]:h[0])*g[0],(y===1?u[1]:h[1])*g[1],(y===2?u[2]:h[2])*g[2]],f=[];for(const g of[-1,1])for(const y of[-1,1])for(const x of[-1,1])f.push([g,y,x]);const m=[],_=(g,y,x,S)=>{m.push([g,y,x]),m.push([g,x,S])};for(let g=0;g<3;g++){const y=(g+1)%3,x=(g+2)%3;for(const S of[-1,1]){const C=(A,b)=>{const P=[0,0,0];return P[g]=S,P[y]=A,P[x]=b,d(P,g)};_(C(-1,-1),C(1,-1),C(1,1),C(-1,1))}}for(let g=0;g<3;g++)for(let y=g+1;y<3;y++){const x=3-g-y;for(const S of[-1,1])for(const C of[-1,1]){const A=[0,0,0];A[g]=S,A[y]=C,A[x]=-1;const b=[0,0,0];b[g]=S,b[y]=C,b[x]=1,_(d(A,g),d(A,y),d(b,y),d(b,g))}}for(const g of f)m.push([d(g,0),d(g,1),d(g,2)]);const p=cd(m);return qs.set(r,p),p}const $r=[0,.05,.18,.55];function kh(i,t=.12){const e=t/.12,n=[0];for(let s=1;s<$r.length;s++){const r=$r[s]*e;r<i/2-1e-4&&n.push(r)}n.push(i/2);for(let s=$r.length-1;s>=1;s--){const r=i-$r[s]*e;r>i/2+1e-4&&n.push(r)}return n.push(i),n}function Bh(i,t,e,n,s,r){const o=(a,c)=>[t[0]+e[0]*a+n[0]*c,t[1]+e[1]*a+n[1]*c,t[2]+e[2]*a+n[2]*c];for(let a=0;a<s.length-1;a++)for(let c=0;c<r.length-1;c++){const l=o(s[a],r[c]),h=o(s[a+1],r[c]),u=o(s[a+1],r[c+1]),d=o(s[a],r[c+1]);i.push([l,h,u]),i.push([l,u,d])}}function Iv(i,t,e,n=.12){const s=`g${Ii(i)},${Ii(t)},${Ii(e)},${Ii(n)}`,r=qs.get(s);if(r)return r;const o=e<=i&&e<=t?2:t<=i?1:0,[a,c,l]=o===2?[i,t,e]:o===1?[i,e,t]:[e,t,i],h=a/2,u=c/2,d=l/2,f=kh(a,n),m=kh(c,n),_=[];Bh(_,[-h,-u,d],[1,0,0],[0,1,0],f,m),Bh(_,[-h,-u,-d],[1,0,0],[0,1,0],f,m);const p=(y,x,S,C)=>{_.push([y,x,S]),_.push([y,S,C])};p([h,-u,-d],[h,u,-d],[h,u,d],[h,-u,d]),p([-h,-u,-d],[-h,u,-d],[-h,u,d],[-h,-u,d]),p([-h,u,-d],[h,u,-d],[h,u,d],[-h,u,d]),p([-h,-u,-d],[h,-u,-d],[h,-u,d],[-h,-u,d]);const g=cd(_);if(o===1?g.rotateX(-Math.PI/2):o===0&&g.rotateY(Math.PI/2),o!==2){const y=g.attributes.position.array,x=g.attributes.normal.array;g.setAttribute("uv",new Te(ad(y,x,g.attributes.position.count),2))}return qs.set(s,g),g}xr(()=>{for(const i of qs.values())i.dispose();qs.clear()});class Dv{constructor(){this.group=new Qt,this.colliders=[],this.doors=[],this.interactables=[],this.spots={},this.lights=[],this.faces={},this.decals=[]}add(t){return this.group.add(t),t}solid(t,e,n,s,r,o,a=!1){this.colliders.push({min:new I(t-s/2,e,n-o/2),max:new I(t+s/2,e+r,n+o/2),walkable:a})}spot(t,e,n,s){return this.spots[t]=new I(e,n,s),this.spots[t]}interact(t,e,n,s,r,o,a={},c=1.8){this.interactables.push({id:t,label:e,pos:new I(n,s,r),action:o,data:a,radius:c})}light(t,e,n,s=16770756,r=9,o=13){const a=new Wx(s,r,o,2);return a.position.set(t,e,n),this.group.add(a),this.lights.push(a),a}}function Uv(i,t,e,n,s,r,o=gt.floorTimber,a={}){const c=a.thickness??.16,l=ne(a.surface??"floorTimber",n,c,s,o,{graded:!0,gradeEdge:a.gradeEdge??.12,cast:!1});return l.position.set(t,r-c/2,e),i.add(l),i.solid(t,r-c,e,n,c,s,!0),l}function Hh(i,t,e,n,s,r,o=gt.ceiling,a={}){const c=a.thickness??Ut.cornice,l=ne(a.surface??"ceiling",n,c,s,o,{graded:!0,gradeEdge:a.gradeEdge??.12,cast:!1});return l.position.set(t,r+c/2,e),i.add(l),l}function Nv(i,t,e,n,s=0,r={}){const o=ne("trim",.075,.115,.01,r.colour??gt.trim,{});o.position.set(t,e,n),o.rotation.y=s,i.add(o);const a=ne("trim",.03,.055,.004,r.colour??gt.trim,{});return a.rotation.y=s,a.position.set(t,e,n),a.translateZ(.007),i.add(a),o}function Ov(i,t,e,n,s=0,r={}){const o=ne("trim",.115,.075,.01,r.colour??gt.trim,{});return o.position.set(t,e,n),o.rotation.y=s,i.add(o),o}function $n(i,t,e,n,s,r,o={}){const a=o.margin??Math.min(Math.max(Math.min(s,r)*.3,.05),.3);let c=t-s/2-a,l=t+s/2+a,h=e-r/2-a,u=e+r/2+a;const d=t-s/2,f=t+s/2,m=e-r/2,_=e+r/2;for(const x of i.decals){if(l<=x.x0||c>=x.x1||u<=x.z0||h>=x.z1)continue;const S=Math.min(l-x.x0,x.x1-c),C=Math.min(u-x.z0,x.z1-h);if(S<=C?t<(x.x0+x.x1)/2?l=Math.max(f,Math.min(l,x.x0)):c=Math.min(d,Math.max(c,x.x1)):e<(x.z0+x.z1)/2?u=Math.max(_,Math.min(u,x.z0)):h=Math.min(m,Math.max(h,x.z1)),l>x.x0+1e-4&&c<x.x1-1e-4&&u>x.z0+1e-4&&h<x.z1-1e-4)return null}const p=l-c,g=u-h;if(p<.05||g<.05)return null;const y=new ut(new Be(p,g),cv());return y.rotation.x=-Math.PI/2,y.position.set((c+l)/2,n+.006,(h+u)/2),i.add(y),i.decals.push({x0:c,x1:l,z0:h,z1:u}),y}const hi=new _i;function hd(i,t,e,n){hi.setFromObject(t);const s=hi.max.x-hi.min.x,r=hi.max.z-hi.min.z;return i.solid((hi.min.x+hi.max.x)/2,e,(hi.min.z+hi.max.z)/2,s,n,r),[s,r]}function Fv(i,t,e,n){if(i.door===!1||i.leaf===!1||i.door===void 0&&i.leaf===void 0&&t<=1.005)return null;const s=i.door||{},r=t>=1.25,o=s.style??(i.leaf?"panel":r?"glazed":"panel");return{label:s.label??"door",style:o,pair:s.pair??r,auto:s.auto??!1,startsShut:s.startsShut??!0,face:s.swing??n,colour:s.colour??i.leaf??(o==="glazed"?ie.metal:e),surfaceName:s.surface??i.leafSurface??"doorLeaf",triggerR:s.triggerR,dwell:s.dwell,leaves:[]}}function Qi(i,t,e,n,s,r={}){const{y0:o=0,height:a=Ut.storey,thickness:c=Ut.wallThick,colour:l=gt.wall,innerColour:h=null,outerColour:u=null,openings:d=[],skirting:f=!0,skirtStyle:m="timber",cornice:_=!0,corniceStyle:p="cove",autoServices:g=!0,inner:y=null,surface:x="wall",trimColour:S=gt.trim,graded:C=!0,name:A=null}=r,b=h??u,P=n-t,D=s-e,v=Math.hypot(P,D);if(v<.01)return;const w=P/v,U=D/v,N=Math.atan2(-U,w),X=-U,q=w,V=c/2,K=(F,dt,nt,vt=0,_t=0)=>(F.position.set(t+w*dt+X*vt,nt,e+U*dt+q*vt),F.rotation.y=N+_t,i.add(F),F),k=(F,dt,nt,vt={})=>ne("trim",F,dt,nt,vt.colour??S,vt),pt=y===null?[-1,1]:[y],mt=(F,dt,nt,vt)=>{const _t=dt-F,Et=vt-nt;if(_t<=.005||Et<=.005)return;const At=(F+dt)/2,Z=_&&p==="shadowline"&&Math.abs(vt-(o+a))<.02,E=Z?Et-.01:Et,ft=_t>=1.2&&E>=1.2,st=ne(x,_t,E,c,l,{graded:C&&ft,cast:!0});if(K(st,At,nt+E/2),Z){const R=ne(x,_t,.01,c-.02,l,{});K(R,At,vt-.005)}const it=Math.abs(w)*_t+Math.abs(U)*c,ot=Math.abs(U)*_t+Math.abs(w)*c,Pt=t+w*At,rt=e+U*At;if(i.solid(Pt,nt,rt,it,Et,ot),b)for(const R of pt){const M=ne(x,_t,E,.02,b,{graded:C&&ft});K(M,At,nt+E/2,R*(V+.01))}if(f&&m&&nt-o<.02)if(m==="commercial"){const R=k(_t,Ut.skirtCommercial,c+.04,{colour:gt.tileFloor,chamfer:Ee.thin});K(R,At,nt+Ut.skirtCommercial/2)}else{const R=[[.112,Ut.skirtProud,0,Ee.thin],[.018,.014,.112,0],[.008,.008,.13,0]];for(const[M,B,J,et]of R){const tt=k(_t,M,c+B*2,{chamfer:et});K(tt,At,nt+J+M/2)}}if(_&&p==="cove"&&Math.abs(vt-(o+a))<.02){const R=Ut.corniceGirth/Math.SQRT2;for(const M of pt){const B=k(_t,Ut.corniceGirth,.008,{chamfer:0});K(B,At,vt-R/2,M*(V+R/2)),B.rotation.order="YXZ",B.rotation.set(-M*Math.PI/4,N,0)}}},ct=(F,dt,nt,vt)=>{const _t=vt-nt;for(const At of[-1,1]){const Z=k(Ut.reveal,_t,c,{});K(Z,F+At*(dt/2-Ut.reveal/2),nt+_t/2)}const Et=k(dt,Ut.reveal,c,{});K(Et,F,vt-Ut.reveal/2)},zt=(F,dt,nt,vt)=>{const _t=dt-2*Ut.reveal,Et=_t/2+Ut.archQuirk,At=vt+Ut.archQuirk;for(const Z of[-1,1])for(const E of[-1,1]){const ft=k(Ut.archW,At-nt+.002,Ut.archProud,{chamfer:Ee.joinery});if(K(ft,F+Z*(Et+Ut.archW/2),nt+(At-nt)/2,E*(V+Ut.archProud/2)),nt-o<.02){const st=k(Ut.archW+.02,.15,.032,{});K(st,F+Z*(Et+Ut.archW/2),nt+.075,E*(V+.016))}}for(const Z of[-1,1]){const E=k(_t+2*(Ut.archW+Ut.archQuirk),Ut.archW,Ut.archProud,{chamfer:Ee.joinery});K(E,F,At+Ut.archW/2,Z*(V+Ut.archProud/2))}},jt=[...d].sort((F,dt)=>F.at-dt.at);let Q=0;for(const F of jt){const dt=F.width/2,nt=Math.max(0,F.at-dt),vt=Math.min(v,F.at+dt),_t=F.kind==="window"?F.sill??Ut.winSill:0,Et=F.kind==="window"?F.head??Ut.winHead:F.head??(F.kind==="arch"?2.25:Ut.doorH);if(mt(Q,nt,o,o+a),_t>0&&mt(nt,vt,o,o+_t),mt(nt,vt,o+Et,o+a),Q=vt,F.kind==="window"){const At=Et-_t,Z=o+(_t+Et)/2,E=y===null?1:-y,ft=new ut(new Vt(F.width-2*Ut.reveal-.002,At-.002,.006),No());ft.castShadow=!1,ft.receiveShadow=!0,K(ft,F.at,Z,E*.015);const st=new ut(new Vt(F.width-2*Ut.reveal-.002,At-.002,.006),rv());st.castShadow=!1,st.receiveShadow=!0,K(st,F.at,Z,-E*.015),ct(F.at,F.width,o+_t,o+Et),zt(F.at,F.width,o+_t,o+Et);const it=Math.max(1,Math.round((F.width-2*Ut.reveal)/.9)),ot=F.width-2*Ut.reveal;for(let rt=1;rt<it;rt++){const R=k(.04,At,.05,{chamfer:Ee.joinery});K(R,F.at-ot/2+ot/it*rt,Z)}const Pt=F.restrictor?Math.min(o+1.7,o+Et-.1):o+_t+At/3;if(At>.55){const rt=k(ot,.04,.05,{chamfer:Ee.joinery});K(rt,F.at,Pt)}if(F.restrictor){const rt=k(.06,.02,.03,{colour:gt.metalDull,chamfer:Ee.thin});K(rt,F.at+ot/4,o+_t+.02,0)}for(const rt of pt){const R=k(F.width+.09,.025,c/2+.03,{chamfer:Ee.joinery});K(R,F.at,o+_t-.0125,rt*(c/4+.015))}if(y!==null){const rt=k(F.width+.12,.04,.09,{chamfer:Ee.joinery});K(rt,F.at,o+_t-.02,-y*(V+.045)),rt.rotation.order="YXZ",rt.rotation.set(y*.1,N,0)}if(F.curtains){zv(i,t+w*F.at,o+Et+.15,e+U*F.at,N,F.width+.4,{offset:(y??1)*(V+.09)});const rt=[.3,.22],R=y??1;for(const B of[-1,1]){const J=rt[B<0?0:1],et=F.width*J,tt=6;for(let Lt=0;Lt<tt;Lt++){const lt=et/tt,Mt=ne("fabric",lt*1.35,At+.35,.045,F.curtains,{cast:!0}),Kt=F.at+B*(F.width/2-et+(Lt+.5)*lt);K(Mt,Kt,Z+.1,R*(V+.075),Lt%2?.175:-.175)}}const M=k(F.width+.44,.12,.09,{chamfer:Ee.joinery});K(M,F.at,o+Et+.21,R*(V+.055))}}else if((F.kind==="door"||F.kind==="arch")&&(ct(F.at,F.width,o,o+Et),zt(F.at,F.width,o,o+Et),F.kind==="door")){const At=F.swing??1,Z=F.width/2-Ut.reveal,E=V-.045;for(const it of[-1,1]){const ot=k(.013,Et-.02,.03,{});K(ot,F.at+it*(Z-.0055),o+(Et-.02)/2,At*E)}const ft=k(F.width-2*Ut.reveal,.014,.03,{});K(ft,F.at,o+Et-.025,At*E);const st=Fv(F,F.width,S,At);if(st){const it=E+.015+Ut.leafT,ot=Et-Ut.reveal-.02,Pt=st.pair?Z-.006:2*Z-.006,rt=st.face,R=st.pair?[1,-1]:[rt];for(const M of R){const B=F.at+M*(Z-.003),J=rt*it;st.leaves.push({hx:t+w*B+X*J,hz:e+U*B+q*J,y:o,baseRot:N,phiOpen:M*rt*Math.PI/2,leafRot:M>0?0:Math.PI,dx:-M*Pt/2,dz:-rt*Ut.leafT/2,lw:Pt,lh:ot});for(const et of[.15,1.02,1.89]){if(et>ot-.1)continue;const tt=ne("chrome",.016,.1,.016,ie.metal,{chamfer:.001,cast:!1});K(tt,B,o+.015+et,J)}}st.centre={x:t+w*F.at,z:e+U*F.at},st.y0=o,i.doors.push(st)}}if(g&&F.kind==="door"){const At=-(F.swing??1);for(const Z of[-1,1])Nv(i,t+w*(F.at+At*(F.width/2+Ut.archW+.15))+X*Z*(V+.006),o+Ut.switchH,e+U*(F.at+At*(F.width/2+Ut.archW+.15))+q*Z*(V+.006),N+(Z<0?Math.PI:0))}}if(mt(Q,v,o,o+a),g&&y!==null&&o+Ut.gpoH<o+a){const F=Math.max(1,Math.floor(v/3.5));for(let dt=0;dt<F;dt++){const nt=(dt+.5)*(v/F);jt.some(vt=>Math.abs(vt.at-nt)<vt.width/2+.25)||Ov(i,t+w*nt+X*y*(V+.006),o+Ut.gpoH,e+U*nt+q*y*(V+.006),N+(y<0?Math.PI:0))}}A&&(i.faces[A]={a:{x:t,z:e},b:{x:n,z:s},u:{x:w,z:U},n:{x:X,z:q},angle:N,thickness:c,y0:o,height:a,length:v,face:F=>({x:(t+n)/2+X*F*(c/2),z:(e+s)/2+q*F*(c/2),nx:X*F,nz:q*F,rotY:N+(F<0?Math.PI:0)})})}function zv(i,t,e,n,s=0,r=1.6,o={}){const a=new Qt,c=new ut(new De(.0125,.0125,r,8),Ic("chrome",o.colour??ie.metalDark));c.rotation.z=Math.PI/2,a.add(c);for(const l of[-1,1]){const h=new ut(new Fi(.0175,8,6),Ic("chrome",o.colour??ie.metalDark));h.position.x=l*r/2,a.add(h)}return a.rotation.y=s,a.position.set(t,e,n),a.translateZ(o.offset??0),i.add(a),a}function kv(i,t,e,n,s=!0){const r=ne("chrome",s?.128:.018,s?.018:.128,.018,ie.metal,{chamfer:.001,cast:!1});r.position.set(t,e,n+.032),i.add(r);for(const o of[-1,1]){const a=ne("chrome",.01,.01,.032,ie.metal,{cast:!1});a.position.set(t+(s?o*.064:0),e+(s?0:o*.064),n+.016),i.add(a)}return r}function Dc(i,t,e,n,s=0,r=gt.joineryLight){const o=typeof r=="object"&&r!==null?r:{colour:r},{colour:a=gt.joineryLight,frame:c=gt.joineryDark,collide:l=!0,seatH:h=.45}=o,u=new Qt,d=.44,f=ne("joinery",d,.018,d,a,{chamfer:.02,cast:!0});f.position.y=h-.009,u.add(f);const m=.42,_=ne("joinery",d,m,.018,a,{chamfer:Ee.furniture});_.position.set(0,h+.04+m/2,-d/2+.02),_.rotation.x=.14,u.add(_);for(const p of[-1,1]){const g=ne("joinery",.03,m+.07,.03,c,{chamfer:Ee.furniture});g.position.set(p*(d/2-.02),h+.02+(m+.07)/2,-d/2+.02),g.rotation.x=.14,u.add(g)}for(const p of[-1,1])for(const g of[-1,1]){const y=ne("joinery",.032,h-.018,.032,c,{chamfer:Ee.furniture});y.position.set(p*(d/2-.024),(h-.018)/2,g*(d/2-.024)),g<0&&(y.rotation.x=-.105),u.add(y)}for(const p of[-1,1]){const g=ne("joinery",d-.07,.045,.016,c,{chamfer:Ee.thin});g.position.set(0,h-.045,p*(d/2-.026)),u.add(g);const y=ne("joinery",d-.07,.02,.02,c,{chamfer:Ee.thin});y.position.set(0,.18,p*(d/2-.026)),u.add(y)}return u.position.set(t,n,e),u.rotation.y=s,i.add(u),l&&i.solid(t,n,e,.45,.45,.45),u}function Bv(i,t,e,n,s,r,o=0,a=gt.benchtop,c=gt.joineryLight,l={}){const{shadow:h=!0,handle:u=!0}=l,d=new Qt,f=Ut.toeKickH,m=Ut.toeKickD,_=.72,p=.038,g=ne("joinery",s-.1,f,r-m,gt.shadowDark,{});g.position.set(0,f/2,-m/2),d.add(g);const y=ne("joinery",s,_,r,c,{chamfer:Ee.furniture,cast:!0});y.position.set(0,f+_/2,0),d.add(y);const x=ne("bench",s+.04,p,r+.02,a,{chamfer:Ee.joinery,cast:!0});x.position.set(0,Ut.benchH-p/2,.01),d.add(x);const S=[];let C=s;for(;C>.02;){let D=Ut.cabinetModules[0];for(const v of Ut.cabinetModules)v<=C+.001&&(D=v);(C-D<.02||S.length>12)&&(D=C),S.push(D),C-=D}let A=-s/2;for(const D of S){const v=ne("joinery",D-.003,_-.006,.018,c,{chamfer:Ee.thin,cast:!1});v.position.set(A+D/2,f+_/2,r/2+.009),d.add(v),u&&kv(d,A+D/2,f+_-.05,r/2+.018),A+=D}d.position.set(t,n,e),d.rotation.y=o,i.add(d);const[b,P]=hd(i,d,n,Ut.benchH);return h&&$n(i,t,e,n,b,P),d}function ud(i,t,e,n,s,r,o=0,a=gt.joineryLight,c={}){const{frame:l=gt.joineryDark,height:h=.74,shadow:u=!0}=c,d=new Qt,f=.03,m=ne("joinery",s,f,r,a,{chamfer:Ee.joinery,cast:!0});m.position.y=h-f/2,d.add(m);for(const g of[-1,1])for(const y of[-1,1]){const x=ne("joinery",.06,h-f,.06,l,{chamfer:Ee.furniture});x.position.set(g*(s/2-.09),(h-f)/2,y*(r/2-.09)),d.add(x)}for(const[g,y,x,S]of[[s-.24,.02,0,r/2-.09],[s-.24,.02,0,-r/2+.09],[.02,r-.24,s/2-.09,0],[.02,r-.24,-s/2+.09,0]]){const C=ne("joinery",g,.07,y,l,{chamfer:Ee.furniture});C.position.set(x,h-f-.035,S),d.add(C)}d.position.set(t,n,e),d.rotation.y=o,i.add(d);const[_,p]=hd(i,d,n,h);return u&&$n(i,t,e,n,_,p),d}function Hv(i,t,e,n,s,r,o={}){const{tileW:a=1.2,tileD:c=.6,colour:l=gt.ceiling,tee:h=gt.metalDull}=o,u=new Qt,d=Math.max(1,Math.round(n/a)),f=Math.max(1,Math.round(s/c)),m=n/d,_=s/f;for(let p=0;p<d;p++)for(let g=0;g<f;g++){const y=ne("ceilingGrid",m-.02,.014,_-.02,l,{cast:!1});y.position.set(-n/2+(p+.5)*m,-.007,-s/2+(g+.5)*_),u.add(y)}for(let p=0;p<=d;p++){const g=ne("chrome",.024,.024,s,h,{chamfer:.001});g.position.set(-n/2+p*m,-.012,0),u.add(g)}for(let p=0;p<=f;p++){const g=ne("chrome",n,.024,.024,h,{chamfer:.001});g.position.set(0,-.012,-s/2+p*_),u.add(g)}return u.position.set(t,r,e),i.add(u),u}const Gv=.38,Vv=.44,Wv=2.4,qv=1.8,Xv=.95,Yv=2.4,Gh=70,Zr=.38,Vh=i=>i<0?0:i>1?1:i,jv=i=>i*i*(3-2*i);function Kv(i,t,e,n="doorLeaf"){const s=new Qt,r=Ut.leafT,o=.105,a=.175,c=.105,l=.14,h=Math.min(Ut.handleH+.01,t-c-l),u=(g,y,x,S,C=r,A=.005)=>{const b=ne(n,g,y,C,e,{chamfer:A,cast:!0});return b.position.set(x,S,0),s.add(b),b};u(o,t,i/2-o/2,0),u(o,t,-i/2+o/2,0);const d=i-2*o;u(d,a,0,-t/2+a/2),u(d,c,0,t/2-c/2),u(d,l,0,-t/2+h);const f=a,m=h-l/2,_=h+l/2,p=t-c;m-f>.05&&u(d-.004,m-f-.004,0,-t/2+(f+m)/2,r-.016,.002),p-_>.05&&u(d-.004,p-_-.004,0,-t/2+(_+p)/2,r-.016,.002);for(const g of[-1,1]){const y=ne("chrome",.052,.052,.01,ie.metal,{chamfer:.002,cast:!1});y.position.set(-i/2+.06,-t/2+Ut.handleH,g*(r/2+.005)),s.add(y);const x=ne("chrome",.02,.02,.045,ie.metal,{chamfer:.001,cast:!1});x.position.set(-i/2+.06,-t/2+Ut.handleH,g*(r/2+.0275)),s.add(x);const S=ne("chrome",.11,.02,.02,ie.metal,{chamfer:.001,cast:!1});S.position.set(-i/2+.115,-t/2+Ut.handleH,g*(r/2+.05)),s.add(S)}return s}function $v(i,t,e=ie.metal){const n=new Qt,s=.048,r=.085,o=.07,a=.21,c=.07,l=Math.min(1.02,t-o-c-.2),h=(f,m,_,p,g=s,y=.003)=>{const x=ne("chrome",f,m,g,e,{chamfer:y,cast:!0});return x.position.set(_,p,0),n.add(x),x};h(r,t,i/2-r/2,0),h(r,t,-i/2+r/2,0);const u=i-2*r;h(u,a,0,-t/2+a/2),h(u,o,0,t/2-o/2),h(u,c,0,-t/2+l);const d=[[-t/2+a,-t/2+l-c/2],[-t/2+l+c/2,t/2-o]];for(const[f,m]of d){const _=m-f;if(_<.08)continue;const p=new ut(new Vt(u-.004,_-.004,.008),No());p.castShadow=!1,p.receiveShadow=!0,p.position.set(0,(f+m)/2,0),n.add(p)}for(const f of[-1,1]){const m=ne("chrome",u,a-.03,.004,e,{chamfer:.001,cast:!1});m.position.set(0,-t/2+a/2,f*(s/2+.003)),n.add(m);const _=-t/2+1.05,p=ne("chrome",i-.17,.038,.038,e,{chamfer:.002,cast:!1});p.position.set(0,_,f*(s/2+.062)),n.add(p);for(const g of[-1,1]){const y=ne("chrome",.026,.026,.062,e,{chamfer:.001,cast:!1});y.position.set(g*(i/2-.115),_,f*(s/2+.031)),n.add(y)}}return n}class Zv{constructor(t,e,n,s){this.system=t,this.id=s,this.name=e.label||"door",this.auto=!!e.auto,this.triggerR=e.triggerR??(this.auto?Wv:Xv),this.dwell=e.dwell??(this.auto?qv:Yv),this.openTime=e.openTime??Gv,this.closeTime=e.closeTime??Vv,this.state=e.startsShut===!1?"open":"shut",this.phase=this.state==="open"?1:0,this._hold=0,this.isDoor=!0,this.action="door",this.data={door:this},this.radius=2,this.leaves=[];for(const c of e.leaves){const l=new Qt;l.position.set(c.hx,c.y,c.hz),l.rotation.y=c.baseRot;const h=e.style==="glazed"?$v(c.lw,c.lh,e.colour):Kv(c.lw,c.lh,e.colour,e.surfaceName),u=td(h);u.position.set(c.dx,c.lh/2+.015,c.dz),u.rotation.y=c.leafRot,l.add(u),n.add(l),this.leaves.push({pivot:l,baked:u,baseRot:c.baseRot,phiOpen:c.phiOpen})}for(const c of this.leaves)c.pivot.rotation.y=c.baseRot;n.updateMatrixWorld(!0);const r=new _i,o=new _i;for(const c of this.leaves)r.union(o.setFromObject(c.baked));r.min.y-=.05,this.collider={min:r.min.clone(),max:r.max.clone(),walkable:!1,door:this};const a=new I(e.centre.x,e.y0+1,e.centre.z);n.localToWorld(a),this.pos=a,this._trigger2=this.triggerR*this.triggerR,this._apply()}get open(){return this.state==="open"}get blocking(){return this.state==="shut"}get label(){return this.state==="shut"||this.state==="closing"?`Open the ${this.name}`:`Close the ${this.name}`}requestOpen(){if(this.state==="open"||this.state==="opening"){this._hold=this.dwell;return}this.state="opening",this.system._dirty=!0}requestClose(){return this.state==="shut"||this.state==="closing"?!0:this._occupied()?!1:(this.state="closing",!0)}toggle(){return this.state==="shut"||this.state==="closing"?(this.requestOpen(),!0):this.requestClose()}_occupied(t=null){var o;const e=this.collider,n=a=>a.x>e.min.x-Zr&&a.x<e.max.x+Zr&&a.z>e.min.z-Zr&&a.z<e.max.z+Zr,s=(o=this.system.game.player)==null?void 0:o.position;if(s&&n(s))return!0;const r=t||this.system._movers();for(const a of r)if(n(a))return!0;return!1}update(t,e,n){let s=!1;if(this.auto&&n){const r=n.x-this.pos.x,o=n.z-this.pos.z;s=r*r+o*o<this._trigger2}if(!s)for(const r of e){const o=r.x-this.pos.x,a=r.z-this.pos.z;if(o*o+a*a<this._trigger2){s=!0;break}}switch(s&&(this._hold=this.dwell,(this.state==="shut"||this.state==="closing")&&(this.state="opening",this.system._dirty=!0)),this.state){case"opening":this.phase=Vh(this.phase+t/this.openTime),this.phase>=1&&(this.phase=1,this.state="open");break;case"open":this._hold>0&&(this._hold-=t,this._hold<=0&&!this._occupied(e)&&(this.state="closing"));break;case"closing":if(this._occupied(e)){this.state="opening",this._hold=this.dwell;break}this.phase=Vh(this.phase-t/this.closeTime),this.phase<=0&&(this.phase=0,this.state="shut",this.system._dirty=!0);break}this._apply()}_apply(){const t=jv(this.phase);for(const e of this.leaves)e.pivot.rotation.y=e.baseRot+e.phiOpen*t}setVisible(t){for(const e of this.leaves)e.pivot.visible!==t&&(e.pivot.visible=t)}dispose(){var t;for(const e of this.leaves)(t=e.pivot.parent)==null||t.remove(e.pivot),e.baked.traverse(n=>{n.isMesh&&n.geometry.dispose()});this.leaves.length=0}}class Jv{constructor(t){this.game=t,this.list=[],this._blocking=[],this._dirty=!0,this._moverBuf=[],this._moverFrame=-1,this._frame=0,this.scanned=0}install(t,e){if(!t||!t.length)return[];const n=[];for(const s of t){const r=new Zv(this,s,e,this.list.length);this.list.push(r),n.push(r)}return this._dirty=!0,n}get count(){return this.list.length}_movers(){var r,o,a;if(this._moverFrame===this._frame)return this._moverBuf;this._moverFrame=this._frame;const t=this._moverBuf;t.length=0;const e=this.game,n=(o=(r=e.slice)==null?void 0:r.bodies)==null?void 0:o.call(r);if(n)for(const c of n)t.push(c.pos);const s=(a=e.npcs)==null?void 0:a.list;if(s)for(const c of s)c.visible&&t.push(c.position);return t}update(t){var r;if(!this.list.length)return;this._frame++;const e=this._movers(),n=(r=this.game.player)==null?void 0:r.position,s=Gh*Gh;for(const o of this.list)if(o.update(t,e,n),n){const a=n.x-o.pos.x,c=n.z-o.pos.z;o.setVisible(a*a+c*c<s)}}collect(t,e,n){if(this._dirty){this._blocking.length=0;for(const l of this.list)l.blocking&&this._blocking.push(l.collider);this._dirty=!1}const s=this._blocking.length;if(!s)return n;this.scanned+=s;const r=t.x-e,o=t.x+e,a=t.z-e,c=t.z+e;for(let l=0;l<s;l++){const h=this._blocking[l];h.max.x<r||h.min.x>o||h.max.z<a||h.min.z>c||n.push(h)}return n}nearest(t,e=2){let n=null,s=e;for(const r of this.list){if(r.auto)continue;const o=r.pos.distanceTo(t);o<s&&(s=o,n=r)}return n}clear(){for(const t of this.list)t.dispose();this.list.length=0,this._blocking.length=0,this._dirty=!0}}const ze=(i,t,e,n,s={})=>{const r=new ut(new Vt(i,t,e),s.material||ke(n,s));return r.castShadow=s.cast!==!1,r.receiveShadow=!0,r};function dd(i,t={}){var f;const{width:e=3,height:n=.8,bg:s="#1f2933",fg:r="#f4efe4",font:o="bold 64px Georgia, serif",pad:a=24}=t,c=document.createElement("canvas");c.width=512,c.height=Math.max(32,Math.round(512*(n/e)));const l=c.getContext("2d");l.fillStyle=s,l.fillRect(0,0,c.width,c.height),t.border&&(l.strokeStyle=t.border,l.lineWidth=8,l.strokeRect(6,6,c.width-12,c.height-12)),l.fillStyle=r,l.font=o,l.textAlign="center",l.textBaseline="middle";let h=parseInt(((f=o.match(/(\d+)px/))==null?void 0:f[1])||"64",10);for(;l.measureText(i).width>c.width-a*2&&h>12;)h-=2,l.font=o.replace(/\d+px/,h+"px");l.fillText(i,c.width/2,c.height/2);const u=new Vn(c);u.colorSpace=Le,u.anisotropy=4;const d=new ut(new Be(e,n),new Gn({map:u,transparent:!0,side:zn}));return d.userData.isSign=!0,d}function fd(i,t=1){const e=new Qt,n=i.range(2.6,4.4)*t,s=new ut(new De(.2*t,.3*t,n,6),ke(ie.trunk,{flat:!0}));s.position.y=n/2,s.castShadow=!0,e.add(s);const r=i.weighted([{value:ie.foliage,weight:4},{value:ie.foliageLight,weight:3},{value:ie.foliageDeep,weight:2}]).value,o=i.int(2,4);for(let a=0;a<o;a++){const c=i.range(1.3,2.2)*t,l=new ut(new Uo(c,0),ke(r,{flat:!0}));l.position.set(i.range(-.7,.7)*t,n+i.range(-.2,.9)*t,i.range(-.7,.7)*t),l.rotation.set(i.range(0,3),i.range(0,3),i.range(0,3)),l.castShadow=!0,l.receiveShadow=!0,e.add(l)}return e}function pd(i,t){const e=new Qt,n=i.pick(ie.carBodies),s=ze(1.9,.72,4.3,n);s.position.y=.78,e.add(s);const r=ze(1.72,.62,2.2,0,{material:Zu()});r.position.set(0,1.4,-.15),e.add(r);const o=ze(1.78,.09,2,n);o.position.set(0,1.75,-.15),e.add(o);for(const l of[-1,1]){const h=ze(.09,.12,.24,n);h.position.set(l,1.26,.88),e.add(h)}const a=ze(1.95,.34,4.35,ie.metalDark);a.position.y=.45,e.add(a);for(const l of[-.86,.86])for(const h of[1.42,-1.42]){const u=new ut(new De(.34,.34,.26,10),ke(1579292));u.rotation.z=Math.PI/2,u.position.set(l,.34,h),u.castShadow=!0,e.add(u)}const c=Ju();for(const l of[-.62,.62]){const h=new ut(new Vt(.34,.16,.08),c);h.position.set(l,.86,2.16),e.add(h);const u=new ut(new Vt(.3,.14,.08),Qu());u.position.set(l,.86,-2.16),e.add(u)}return e.userData.headlights=c,e}function Qv(){const i=new Qt;i.rotation.order="YXZ";const t=ze(1.9,.72,4.1,15262418);t.position.y=.78,i.add(t);const e=ze(1.86,1.15,2.3,15262418);e.position.set(0,1.62,-.85),i.add(e);const n=ze(1.92,.28,2.32,11026479);n.position.set(0,1.55,-.85),i.add(n);const s=ze(1.72,.62,1.3,0,{material:Zu()});s.position.set(0,1.4,.9),i.add(s);const r=ze(1.95,.34,4.15,ie.metalDark);r.position.y=.45,i.add(r);for(const a of[-.86,.86])for(const c of[1.3,-1.3]){const l=new ut(new De(.36,.36,.26,10),ke(1579292));l.rotation.z=Math.PI/2,l.position.set(a,.36,c),l.castShadow=!0,i.add(l)}const o=Ju();for(const a of[-.62,.62]){const c=new ut(new Vt(.34,.16,.08),o);c.position.set(a,.86,2.06),i.add(c);const l=new ut(new Vt(.3,.14,.08),Qu());l.position.set(a,.86,-2.06),i.add(l)}return i}function t1(i){const t=new Qt,e=i.pick([13616564,12109001,13220004,11187616]),n=i.pick([7035472,5266020,7626571]),s=7,r=5.6,o=2.9,a=ze(s,o,r,e);a.position.y=o/2,t.add(a);for(const m of[-1,1]){const _=ze(s+.7,.12,r*.62,n);_.position.set(0,o+.62,m*r*.235),_.rotation.x=m*.42,t.add(_)}const c=ze(s+.8,.14,.3,n);c.position.y=o+1.2,t.add(c);const l=new Yu;l.moveTo(-r/2,0),l.lineTo(r/2,0),l.lineTo(0,1.12),l.closePath();const h=new ol(l,{depth:.16,bevelEnabled:!1});for(const m of[-1,1]){const _=new ut(h,ke(e));_.rotation.y=Math.PI/2,_.position.set(m===1?s/2-.16:-s/2,o,0),_.castShadow=!0,t.add(_)}const u=ze(.5,1.3,.5,9072736);u.position.set(s*.28,o+.8,-.6),t.add(u);const d=ze(.95,2,.1,5916210);d.position.set(0,1,r/2+.04),t.add(d);const f=ze(1.4,.16,.7,ie.concrete);f.position.set(0,.08,r/2+.4),t.add(f);for(const m of[-2.1,2.1]){const _=ze(1.15,1.1,.08,0,{material:No(),cast:!1});_.position.set(m,1.5,r/2+.03),t.add(_);const p=ze(1.3,1.25,.05,16777215);p.position.set(m,1.5,r/2+.01),t.add(p)}return{group:t,size:{w:s,d:r,h:o}}}const e1=.42,n1=.34,mi=n1+.03,Uc=.7,Nc=.6,nn=.55,We=11026479,ir=3.2,Un=2.8,yt={x0:-5.4,x1:-1.8,z0:-3.65,z1:-2.35,cx:-3.6,cz:-3,w:3.6,d:1.3,benchH:.9},fe={x0:-1.72,z0:-2.45,x1:-.9,z1:-.55,w:.36},Ps={x:-1.93,z:-2.51},Jr={x:yt.cx,y:1.78,z:yt.z0+.176,tilt:-.16,w:.48,h:.28},Fs={x0:-1.7,y:.97,z:0},Nn={x0:yt.x0+.35,x1:-2.3,z:yt.z1+.55,facing:Math.PI},Wh={x:-8,screen:{y:1.22,z:1.721,w:.3,h:.22,rotY:Math.PI}},i1={x:-5.2,y:2.3,z:1.934,w:.62,h:.34,rotY:0},Yi={x:-8,z:.85,facing:0},s1=.04,r1=.004,o1=.012,a1=(i,t,e)=>{const n=Math.min(i,t,e);return n<s1?0:Math.min(o1,Math.max(r1,n/12))},c1=[["tile",16777215,"kitchen floor overlay, splashbacks, partition linings"],["metal",gt.metalDull,"all stainless: pod, benches, pass, hood, shelving"],["bench",gt.benchtop,"front counter top (RoomKit counter())"],["joinery",gt.joineryLight,"tables, chairs, booths, gate, door leaves"],["joinery",gt.joineryDark,"chair frames, bins, kiosk plinths"],["joinery",gt.shadowDark,"toe kicks, recesses, coved skirting, screens off"],["trim",We,"counter fascia, kiosk pedestals, menu board, signage"],["(basic)","signAtlas","ONE canvas atlas: every label in the shop"],["(shared)","troffer emissive","luminaire faces — one material town-wide"],["(shared)","contact shadow","fixture footprint decals — one town-wide"],["trim",5208634,"cold bin: lettuce (legibility is a design requirement)"],["trim",10236968,"cold bin: tomato"],["trim",13210159,"cold bin: cheese + UHC hold slots"],["trim",8030778,"cold bin: pickle"],["trim",15261904,"cold bin: onion + mayo gun band"]],qh=new Set;function md(i,t,e={}){if(e.material)return e.material;try{return fl(i,t,null,e.recipe||{})}catch(n){return qh.has(i)||(qh.add(i),console.error(`Fitout: surface '${i}' unavailable, flat colour instead`,n)),ke(t,e)}}function l1(i,t,e,n,s,r={}){var h;const o=md(i,s,r),a=r.chamfer??a1(t,e,n),c=a>0?ld(t,e,n,a):new Vt(Math.max(t,.001),Math.max(e,.001),Math.max(n,.001)),l=new ut(c,o);return l.castShadow=r.cast??((h=o.userData)==null?void 0:h.cast)??!1,l.receiveShadow=!0,l}function W(i,t,e,n,s,r,o,a,c,l={}){const h=l1(t,o,a,c,e,l);return h.position.set(n,s,r),l.rotY&&(h.rotation.y=l.rotY),i.add(h),h}const gd=i=>({x:Math.sin(i),z:Math.cos(i)});function sr(i,t,e,n,s){const r=(t+n)/2,o=(e+s)/2;W(i,"joinery",gt.shadowDark,r,.0375,o,Math.max(Math.abs(n-t),.024),.075,Math.max(Math.abs(s-e),.024))}function Qr(i,t,e,n,s,r,o,a){const c=n-t,l=s-e;for(let h=0;h<o;h++)for(let u=0;u<a;u++){const d=t+(h+.5)*(c/o),f=e+(u+.5)*(l/a);W(i,"metal",gt.metalDull,d,r+.035,f,1.2,.07,.6);const m=new ut(new Vt(1.16,.012,.56),av());m.position.set(d,r-.006,f),i.add(m)}}function h1(i,t,e,n=0,s=.62,r=.48){const a=gd(n);W(i,"joinery",gt.joineryDark,t,.9/2,e,s,.9,r,{rotY:n,cast:!0}),W(i,"joinery",gt.shadowDark,t,.075,e,s-.06,.15,r-.06,{rotY:n}),W(i,"joinery",gt.shadowDark,t+a.x*(r/2-.03),.6,e+a.z*(r/2-.03),s-.16,.34,.04,{rotY:n});const c=W(i,"joinery",gt.joineryLight,t+a.x*(r/2+.01),.64,e+a.z*(r/2+.01),s-.2,.26,.016,{rotY:n,cast:!0});c.rotation.x=-.22,W(i,"metal",gt.metalDull,t,.9+.02,e,s+.06,.04,r+.06,{rotY:n,cast:!0}),W(i,"trim",We,t,.9-.07,e,s+.005,.09,r+.005,{rotY:n}),i.solid(t,0,e,Math.abs(a.z)*s+Math.abs(a.x)*r,.9+.05,Math.abs(a.z)*r+Math.abs(a.x)*s)}function Xh(i,t,e,n,s=0){const r={rotY:s};W(i,"joinery",gt.joineryDark,t,n+.021,e,.17,.042,.115,r),W(i,"trim",We,t-.045,n+.1,e,.052,.15,.052,{...r,cast:!0}),W(i,"joinery",gt.shadowDark,t+.03,n+.075,e-.02,.038,.1,.038,{...r,cast:!0}),W(i,"joinery",gt.joineryLight,t+.038,n+.058,e+.028,.055,.065,.055,r)}function Yh(i,t,e,n,s=7,r=.4,o=.3,a=0){for(let c=0;c<s;c++)W(i,"trim",We,t,e+.01+c*.014,n,r,.012,o,{rotY:a,cast:c===s-1});W(i,"joinery",gt.shadowDark,t,e+.004,n,r+.03,.008,o+.03,{rotY:a})}const Oc=4,Fc=8;function Ss(){return"#"+We.toString(16).padStart(6,"0")}const _d={fries:[0,0,"FRIES","#20262e"],grill:[1,0,"GRILL","#20262e"],pod:[2,0,"BUILD","#20262e"],pack:[3,0,"PACK-OUT","#20262e"],drivethru:[0,1,"DRIVE-THRU",Ss()],staff:[1,1,"STAFF ONLY","#20262e"],collect:[2,1,"COLLECT",Ss()],order:[3,1,"ORDER HERE",Ss()],drinks:[0,2,"DRINKS","#20262e"],mccafe:[1,2,"McCAFE","#4b2e22"],barn:[2,2,"BURGER BARN",Ss()],uhc:[3,2,"UHC","#20262e"],lettuce:[0,3,"LETTUCE","#4f7a3a"],tomato:[1,3,"TOMATO","#9c3428"],cheese:[2,3,"CHEESE","#c9922f"],pickle:[3,3,"PICKLE","#7a8a3a"],onion:[0,4,"ONION","#8f9784","#20262e"],ketchup:[1,4,"KETCHUP","#9c2b1f"],mustard:[2,4,"MUSTARD","#c9922f"],mayo:[3,4,"MAYO","#e6dcc4","#20262e"],bbq:[0,5,"BBQ","#5a3a26"],buns:[1,5,"BUNS","#a8763f"],wrap:[2,5,"WRAP","#20262e"],dry:[3,5,"DRY STORE","#2f5d6b"],pay:[0,6,"PAY",Ss()],present:[1,6,"PRESENT",Ss()],toaster:[2,6,"TOASTER","#20262e"],sauce:[3,6,"SAUCE","#20262e"]};let Fn=null;function xd(){if(Fn!==null)return Fn||null;if(typeof document>"u"||!document.createElement)return Fn=!1,null;const i=document.createElement("canvas");i.width=1024,i.height=1024;const t=i.getContext("2d");if(!t)return Fn=!1,null;const e=i.width/Oc,n=i.height/Fc;t.clearRect(0,0,i.width,i.height);for(const[,r]of Object.entries(_d)){const[o,a,c,l,h="#f4efe4"]=r,u=o*e,d=a*n;t.fillStyle=l,t.fillRect(u+3,d+3,e-6,n-6),t.strokeStyle="rgba(0,0,0,0.35)",t.lineWidth=3,t.strokeRect(u+3,d+3,e-6,n-6),t.fillStyle=h,t.textAlign="center",t.textBaseline="middle";let f=44;for(t.font=`bold ${f}px Helvetica, Arial, sans-serif`;t.measureText(c).width>e-34&&f>12;)f-=2,t.font=`bold ${f}px Helvetica, Arial, sans-serif`;t.fillText(c,u+e/2,d+n/2)}const s=new Vn(i);return s.colorSpace=Le,s.anisotropy=4,Fn=new Rn({map:s,roughness:.9,metalness:0,emissive:2763306,emissiveMap:s,side:ti,transparent:!1}),Fn}xr(()=>{var i;Fn&&Fn.dispose&&((i=Fn.map)==null||i.dispose(),Fn.dispose()),Fn=null});let di=null;function to(){return di||(di=new Rn({color:856342,roughness:.3,metalness:0,emissive:1454666,emissiveIntensity:.55})),di}xr(()=>{var i;(i=di==null?void 0:di.dispose)==null||i.call(di),di=null});function me(i,t,e,n,s,r,o,a=0){const c=xd(),l=_d[t];if(!c||!l)return null;const[h,u]=l,d=new Be(r,o),f=h/Oc,m=(h+1)/Oc,_=1-(u+1)/Fc,p=1-u/Fc;d.setAttribute("uv",new Te(new Float32Array([f,p,m,p,f,_,m,_]),2));const g=new ut(d,c);return g.position.set(e,n,s),g.rotation.y=a,i.add(g),g}const Eo=i=>!i.walkable&&i.max.y>e1&&i.min.y<1.7;function u1(i,t,e){let n=t,s=e,r=0;for(let o=0;o<4;o++){let a=!1;for(const c of i){if(!Eo(c))continue;const l=c.min.x-mi,h=c.max.x+mi,u=c.min.z-mi,d=c.max.z+mi;if(n<=l||n>=h||s<=u||s>=d)continue;const f=[[n-l,-1,0],[h-n,1,0],[s-u,0,-1],[d-s,0,1]];f.sort((g,y)=>g[0]-y[0]);const[m,_,p]=f[0];n+=_*m,s+=p*m,r+=m,a=!0}if(!a)break}return{x:n,z:s,moved:r}}function d1(i,t,e){let n=1/0;for(const s of i){if(!Eo(s))continue;const r=Math.max(s.min.x-t,0,t-s.max.x),o=Math.max(s.min.z-e,0,e-s.max.z),a=r===0&&o===0?-Math.min(t-s.min.x,s.max.x-t,e-s.min.z,s.max.z-e):Math.hypot(r,o);a<n&&(n=a)}return n===1/0?99:n}function f1(i,t){const e=[],n=[];for(const s of t){const r=[];for(const m of i)Eo(m)&&s.x>m.min.x-mi&&s.x<m.max.x+mi&&s.z>m.min.z-mi&&s.z<m.max.z+mi&&r.push([+m.min.x.toFixed(2),+m.min.z.toFixed(2),+m.max.x.toFixed(2),+m.max.z.toFixed(2)]);if(r.length&&e.push({id:s.id,why:"point inside a blocking collider",boxes:r}),n.push({id:s.id,clear:+d1(i,s.x,s.z).toFixed(3)}),s.facing==null||s.standoff==null)continue;const o=gd(s.facing),a=[s.standoff-.01,s.standoff-Nc],c=[s.x+o.x*a[0],s.x+o.x*a[1]],l=[s.z+o.z*a[0],s.z+o.z*a[1]],h=Uc/2,u=[Math.min(...c)-Math.abs(o.z)*h,Math.max(...c)+Math.abs(o.z)*h],d=[Math.min(...l)-Math.abs(o.x)*h,Math.max(...l)+Math.abs(o.x)*h],f=[];for(const m of i)Eo(m)&&(m.max.x<=u[0]+1e-6||m.min.x>=u[1]-1e-6||m.max.z<=d[0]+1e-6||m.min.z>=d[1]-1e-6||f.push([+m.min.x.toFixed(2),+m.min.z.toFixed(2),+m.max.x.toFixed(2),+m.max.z.toFixed(2)]));f.length&&e.push({id:s.id,why:`clear floor ${Uc} x ${Nc} obstructed`,rect:[+u[0].toFixed(2),+d[0].toFixed(2),+u[1].toFixed(2),+d[1].toFixed(2)],boxes:f})}return n.sort((s,r)=>s.clear-r.clear),{failures:e,tightest:n.slice(0,8)}}function p1(i,t={}){const e=t.width??20,n=t.depth??14,s=e/2,r=n/2,o=s-Ut.wallThick/2,a=r-Ut.wallThick/2,c=gt.metalDull,l=gt.joineryLight,h=gt.joineryDark,u=gt.shadowDark,d=[],f=(L,O,Y,at=null,wt=null,$t={})=>{d.push({name:L,x:O,z:Y,facing:at,standoff:wt,noClamp:!!$t.noClamp})},m=1.4;W(i,"tile",16777215,(-o+7.9)/2,.003,(-a+m)/2,o+7.9,.006,m+a,{cast:!1,chamfer:0}),W(i,"tile",16777215,(7.9+o)/2,.003,(-5+m)/2,o-7.9,.006,m+5,{cast:!1,chamfer:0}),sr(i,-o+.02,-a+.04,-6.35,-a+.04),sr(i,-4.45,-a+.04,3.25,-a+.04),sr(i,-o+.04,-a,-o+.04,m),sr(i,o-.04,-5,o-.04,m);const _=-a+.375,p=-a+.75,g=-9.6,y=-6.7,x=(g+y)/2,S=y-g;W(i,"metal",c,x,.45,_,S,.9,.75,{cast:!0}),W(i,"joinery",u,x,.075,_+.02,S-.1,.15,.66),i.solid(x,0,_,S,.9,.75);const C=1.12;W(i,"tile",16777215,x,1.5,-a+.02,S+.4,1.2,.02,{cast:!1,chamfer:0}),W(i,"metal",c,x,1.01,_,2.1,.22,.62,{cast:!0});for(const L of[-.7,-.23,.24])W(i,"joinery",u,x+L,C,_,.32,.03,.42),W(i,"trim",13210159,x+L,C-.03,_,.28,.01,.38,{chamfer:0}),W(i,"metal",c,x+L,C+.16,_-.26,.03,.3,.03),W(i,"metal",c,x+L,C+.3,_-.2,.03,.03,.16);W(i,"metal",c,x+.95,1.06,_,.75,.1,.62,{cast:!0}),W(i,"metal",c,x+.95,1.24,_-.26,.7,.04,.04),W(i,"trim",We,x+.95,1.14,_+.1,.3,.06,.22),me(i,"fries",x,1.62,-a+.05,.9,.26,0),W(i,"metal",c,x,2.24,_+.15,S+.3,.42,1,{cast:!0});const A=1.06,b=-4.3,P=-.3,D=(b+P)/2,v=P-b;W(i,"metal",c,D,.45,_,v,.9,.75,{cast:!0}),W(i,"joinery",u,D,.075,_+.02,v-.1,.15,.66),i.solid(D,0,_,v,.9,.75),W(i,"tile",16777215,D,1.5,-a+.02,v+.4,1.2,.02,{cast:!1,chamfer:0}),W(i,"metal",c,D,.98,_,2.6,.16,.62,{cast:!0});for(const L of[-.65,.65])W(i,"joinery",u,D+L,A,_,1.1,.02,.5);W(i,"metal",c,D,A+.1,_-.3,2.6,.2,.03,{cast:!0}),W(i,"metal",c,D+1.35,A+.02,_+.16,.1,.02,.16),W(i,"joinery",u,D+1.35,A+.06,_+.24,.03,.07,.1),me(i,"grill",D,1.62,-a+.05,.9,.26,0),W(i,"metal",c,D,2.24,_+.15,v+.4,.42,1,{cast:!0}),W(i,"metal",c,D,2.62,_+.15,.34,.36,.34),W(i,"metal",c,1.35,1,_+.02,1.6,2,.7,{cast:!0}),i.solid(1.35,0,_+.02,1.6,2,.7);for(const L of[-.4,.4])W(i,"joinery",u,1.35+L,1,_+.38,.72,1.86,.02),W(i,"metal",c,1.35+L-.3,1.05,_+.4,.04,.6,.04);const w=Ut.intWall,U=3.3,N=-4.55,X={height:Un,surface:"tile",colour:16777215,thickness:w,skirting:!1,cornice:!1,trimColour:gt.trim};Qi(i,U,-a,U,N,{...X,inner:-1,autoServices:!1,name:"dryWest"}),Qi(i,U,N,o,N,{...X,inner:1,autoServices:!1,openings:[{at:.95,width:1,kind:"door",head:Ut.headDatum,door:{startsShut:!1,style:"panel",label:"dry store",swing:-1}}],name:"drySouth"}),me(i,"staff",U+.006+w/2,1.85,-5.7,.7,.22,Math.PI/2),me(i,"dry",U+1.85,2.3,N+w/2+.006,.9,.26,0);const q={x0:5.55,x1:7.85,z0:-a+.05,z1:-5.35},V=(q.x0+q.x1)/2,K=(q.z0+q.z1)/2;W(i,"metal",c,V,1.2,K,q.x1-q.x0,2.4,q.z1-q.z0,{cast:!0}),i.solid(V,0,K,q.x1-q.x0,2.4,q.z1-q.z0);for(const L of[-.5,.28])W(i,"joinery",u,q.x0-.008,1.2,K+L,.012,2.3,.014,{chamfer:0});for(const L of[-.75,0,.75])W(i,"joinery",u,V+L,1.2,q.z1+.008,.014,2.3,.012,{chamfer:0});W(i,"metal",c,q.x0-.03,1.02,K+.3,.04,1.84,.78,{cast:!0});for(const[L,O,Y,at]of[[.3,1.94,.8,.02],[.3,.1,.8,.02],[-.09,1.02,.02,1.86],[.69,1.02,.02,1.86]])W(i,"joinery",u,q.x0-.052,O,K+L,.008,at,Y,{chamfer:0});W(i,"metal",c,q.x0-.07,1.05,K+.62,.05,.34,.06,{cast:!0}),W(i,"joinery",u,q.x0-.045,.35,K-.25,.01,.26,.44,{chamfer:0});for(let L=0;L<4;L++)W(i,"metal",c,q.x0-.052,.26+L*.055,K-.25,.006,.018,.4,{chamfer:0});W(i,"metal",c,V,2.55,K,.9,.3,.7,{cast:!0});for(let L=0;L<4;L++)W(i,"metal",c,4.45,.15+L*.44,-a+.25,1.7,.03,.45),L>0&&(W(i,"joinery",l,4.1,.29+L*.44,-a+.25,.55,.24,.38,{cast:!0}),W(i,"joinery",h,4.9,.27+L*.44,-a+.25,.55,.21,.36));i.solid(4.45,0,-a+.25,1.7,1.6,.45),W(i,"joinery",l,6.95,.16,-4.95,.55,.32,.42,{cast:!0}),W(i,"joinery",h,6.85,.44,-4.98,.42,.24,.36,{cast:!0}),sr(i,U+w/2,-a,U+w/2,N),Qr(i,U,-a,o-1,N,Un,2,1);const k={cx:4.7,cz:-2.5,w:3,d:.75};W(i,"metal",c,k.cx,.45,k.cz,k.w,.9,k.d,{cast:!0}),W(i,"joinery",u,k.cx,.075,k.cz,k.w-.1,.15,k.d-.08),i.solid(k.cx,0,k.cz,k.w,.9,k.d),$n(i,k.cx,k.cz,0,k.w,k.d);for(let L=0;L<3;L++)W(i,"trim",We,k.cx-1.05,.98+L*.09,k.cz,.34,.08,.26);Yh(i,k.cx-.3,.9,k.cz,7);for(let L=0;L<4;L++)W(i,"joinery",l,k.cx+.6,.96+L*.11,k.cz,.42,.1,.42,{cast:L===3});W(i,"joinery",l,k.cx+1.2,.97,k.cz,.36,.14,.36,{cast:!0}),me(i,"pack",k.cx,1.6,k.cz-k.d/2-.02,.9,.26,Math.PI);const pt=o-.375;W(i,"metal",c,pt,.45,-2.7,.75,.9,4.5,{cast:!0}),W(i,"joinery",u,pt,.075,-2.7,.66,.15,4.4),i.solid(pt,0,-2.7,.75,.9,4.5),$n(i,pt,-2.7,0,.75,4.5),W(i,"joinery",u,pt-.05,1.02,-4.2,.3,.2,.36,{cast:!0}),W(i,"joinery",u,pt-.11,1.22,-4.2,.03,.24,.32,{cast:!0}),W(i,"metal",c,pt,.94,-1,.6,.04,.8),W(i,"metal",c,o-.06,1.55,-2.7,.05,.22,.05,{cast:!0}),W(i,"joinery",u,o-.1,1.62,-2.7,.14,.14,.1,{cast:!0}),W(i,"joinery",u,o-.05,1.75,-2.7,.05,.4,.6,{cast:!0});{const L=new ut(new Be(.52,.32),to());L.position.set(o-.07,1.75,-2.7),L.rotation.y=-Math.PI/2,i.add(L)}W(i,"metal",c,o-.25,1.25,-2.7,.45,.03,1.1),W(i,"trim",We,o-.25,1.32,-2.35,.3,.1,.22,{cast:!0}),W(i,"joinery",l,o-.25,1.34,-3,.28,.14,.3,{cast:!0}),me(i,"pay",o-.02,2.3,-4.2,.6,.2,-Math.PI/2),me(i,"present",o-.02,2.3,-1,.75,.2,-Math.PI/2),me(i,"drivethru",o-.02,2.58,-2.6,1.1,.26,-Math.PI/2),i.interact("dt_window_out","hand the bag out",o-.25,1.1,-1,"service",{op:"deliver",when:"window_handout"},1.8);const mt=-.5;W(i,"metal",c,-o+.35,.45,mt,.7,.9,1.7,{cast:!0}),W(i,"joinery",u,-o+.35,.075,mt,.62,.15,1.6),i.solid(-o+.35,0,mt,.7,.9,1.7),$n(i,-o+.35,mt,0,.7,1.7),W(i,"joinery",u,-o+.32,1.02,mt-.45,.3,.2,.36,{cast:!0}),W(i,"joinery",u,-o+.26,1.22,mt-.45,.03,.24,.32,{cast:!0}),W(i,"metal",c,-o+.06,1.55,mt+.55,.05,.22,.05,{cast:!0}),W(i,"joinery",u,-o+.1,1.62,mt+.55,.1,.14,.14,{cast:!0}),W(i,"joinery",u,-o+.03,1.45,mt,.03,.14,.14),me(i,"drivethru",-o+.02,2.35,mt,1.1,.26,Math.PI/2),me(i,"order",-o+.02,2.05,mt,.8,.22,Math.PI/2),i.interact("dt_window_take","take the drive-thru order",-o+.3,1.1,mt,"service",{op:"dt_take",when:"dt_order"},1.8);const ct=yt.benchH;W(i,"metal",c,yt.cx,.45,yt.cz,yt.w,.9,yt.d,{cast:!0}),W(i,"joinery",u,yt.cx,.075,yt.cz,yt.w-.1,.15,yt.d-.1),i.solid(yt.cx,0,yt.cz,yt.w,.9,yt.d),$n(i,yt.cx,yt.cz,0,yt.w,yt.d);for(const[L,O]of[[0,We],[1,13210159],[2,5208634],[3,l]]){const Y=yt.x0+.55+L*.85;for(let at=0;at<4;at++)W(i,"trim",O,Y,.24+at*.13,yt.z1-.16,.4,.11,.26,{chamfer:0})}const zt=-4.9;W(i,"metal",c,zt,ct+.31,yt.cz-.1,.85,.62,.62,{cast:!0}),W(i,"joinery",u,zt,ct+.63,yt.cz-.1,.6,.03,.3),W(i,"joinery",u,zt,ct+.18,yt.cz+.215,.52,.09,.02),W(i,"metal",c,zt,ct+.12,yt.cz+.26,.56,.025,.1,{cast:!0}),W(i,"trim",We,zt,ct+.5,yt.cz+.22,.6,.08,.02),me(i,"toaster",zt,ct+.36,yt.cz+.225,.44,.14,0),W(i,"metal",c,yt.x0-.55,.6,yt.cz,.7,1.2,.9,{cast:!0}),i.solid(yt.x0-.55,0,yt.cz,.7,1.2,.9);for(let L=0;L<3;L++)W(i,"joinery",l,yt.x0-.55,.35+L*.32,yt.cz,.62,.16,.8);me(i,"buns",yt.x0-.55,1.32,yt.cz+.46,.5,.16,0);const jt=-4;W(i,"metal",c,jt,ct+.1,yt.cz-.25,.7,.2,.45,{cast:!0});const Q=[["ketchup",10236968],["mustard",13210159],["mayo",15261904],["bbq",8030778]];Q.forEach(([L,O],Y)=>{const at=jt-.255+Y*.17;W(i,"metal",c,at,ct+.3,yt.cz-.25,.06,.22,.06,{cast:!0}),W(i,"trim",O,at,ct+.43,yt.cz-.25,.05,.05,.05,{chamfer:0}),me(i,L,at,ct+.135,yt.cz-.02,.15,.06,0)});const F=-3.58;W(i,"joinery",u,-3.1,ct+.015,yt.cz-.08,1,.05,.6);const dt=[["pickle",8030778],["onion",15261904],["lettuce",5208634],["tomato",10236968],["cheese",13210159]];dt.forEach(([L,O],Y)=>{const at=F+.1+Y*.19;W(i,"metal",c,at,ct+.045,yt.cz-.08,.165,.09,.54),W(i,"trim",O,at,ct+.075,yt.cz-.08,.13,.05,.48,{chamfer:0}),me(i,L,at,ct-.1,yt.z1+.006,.17,.075,0)});const nt=-2.2;W(i,"metal",c,nt,ct+.38,yt.cz,.78,.76,.68,{cast:!0});for(let L=0;L<3;L++)for(const O of[1,-1])W(i,"joinery",u,nt,ct+.14+L*.24,yt.cz+O*.345,.64,.16,.02),W(i,"trim",13210159,nt,ct+.11+L*.24,yt.cz+O*.3,.56,.03,.06,{chamfer:0});me(i,"uhc",nt,ct+.86,yt.cz+.01,.4,.16,0),W(i,"joinery",l,Ps.x,ct+.02,Ps.z,.3,.04,.34,{cast:!0}),me(i,"wrap",-1.95,ct-.1,yt.z1+.006,.3,.1,0);{const L=fe.x1-fe.x0,O=fe.z1-fe.z0,Y=Math.hypot(L,O),at=Math.atan2(-O,L)+Math.PI/2,wt=(fe.x0+fe.x1)/2,$t=(fe.z0+fe.z1)/2,Me=W(i,"metal",c,wt,.965,$t,fe.w,.03,Y,{rotY:at,cast:!0});Me.rotation.x=-.045;for(const ve of[-1,1]){const ee=W(i,"metal",c,wt,.995,$t,.03,.06,Y,{rotY:at});ee.translateX(ve*(fe.w/2-.015)),ee.rotation.x=-.045}for(const[ve,ee]of[[fe.x0+.1,fe.z0+.22],[fe.x1-.1,fe.z1-.25]])W(i,"metal",c,ve,.47,ee,.05,.94,.05);for(let ve=0;ve<3;ve++){const ee=ve/3,He=(ve+1)/3,mn=fe.x0+L*ee,Ks=fe.x0+L*He,$s=fe.z0+O*ee,qn=fe.z0+O*He;i.solid((mn+Ks)/2,.6,($s+qn)/2,Math.abs(Ks-mn)+fe.w,.5,Math.abs(qn-$s)+.06)}}W(i,"metal",c,yt.cx,1.28,yt.z0+.06,.05,.8,.05,{cast:!0}),W(i,"metal",c,yt.cx,1.66,yt.z0+.09,.06,.05,.1);{const L=W(i,"joinery",u,yt.cx,1.78,yt.z0+.14,.56,.36,.035,{cast:!0});L.rotation.x=-.16;const O=W(i,"joinery",u,yt.cx,1.78,yt.z0+.165,.5,.3,.008,{chamfer:0});O.rotation.x=-.16;const Y=new ut(new Be(.48,.28),to());Y.position.set(yt.cx,1.78,yt.z0+.172),Y.rotation.x=-.16,i.add(Y)}me(i,"pod",yt.cx,2.05,yt.z0+.1,.6,.2,0);const vt=.6,_t=2.45,Et=3.55,At=-2.65,Z=-1.95;for(const[L,O]of[[-o,At],[Z,_t],[Et,o]]){const Y=(L+O)/2,at=O-L;W(i,"metal",c,Y,.45,0,at,.9,vt,{cast:!0}),W(i,"joinery",u,Y,.075,0,at-.1,.15,vt-.08),i.solid(Y,0,0,at,.9,vt)}$n(i,(-o+At)/2,0,0,At+o,vt);{const L=W(i,"metal",c,At+.03,1.24,0,.05,Z-At,vt-.04,{cast:!0});L.rotation.z=.2}W(i,"metal",c,-.9,.945,0,1.6,.05,vt+.06,{cast:!0});for(const L of[-.7,.7])W(i,"metal",c,-.9+L,1.22,0,.04,.5,.04);W(i,"metal",c,-.9,1.44,0,1.56,.04,.05);for(const L of[-.4,.2]){W(i,"trim",We,-.9+L,1.38,0,.28,.1,.2,{cast:!0});const O=new ut(new Vt(.2,.02,.14),ov());O.position.set(-.9+L,1.325,0),i.add(O)}i.doors.push({label:"staff gate",style:"panel",pair:!1,auto:!0,startsShut:!0,face:-1,colour:l,surfaceName:"joinery",triggerR:1.2,dwell:1,leaves:[{hx:Et-.003,hz:0,y:0,baseRot:0,phiOpen:-Math.PI/2,leafRot:0,dx:-1.0939999999999996/2,dz:Ut.leafT/2,lw:Et-_t-.006,lh:1}],centre:{x:(_t+Et)/2,z:0},y0:0});const E={z:1.8,d:.8,x0:-o,x1:_t},ft=(E.x0+E.x1)/2,st=E.x1-E.x0;Bv(i,ft,E.z,0,st,E.d,0,gt.benchtop,l,{handle:!1}),W(i,"trim",We,ft,.52,E.z+E.d/2+.03,st,.6,.02),me(i,"barn",E.x0+1.6,.62,E.z+E.d/2+.05,1.4,.34,0);const it=-8;W(i,"joinery",u,it,1.02,E.z,.36,.2,.3,{cast:!0}),W(i,"joinery",u,it,1.22,E.z-.06,.32,.24,.03,{cast:!0}),W(i,"metal",c,it,.98,E.z+.3,.14,.16,.1),me(i,"order",it,1.42,E.z+E.d/2+.01,.8,.22,0);const ot=-5.2;W(i,"metal",c,ot,1.06,E.z,1.6,.04,E.d+.1);for(const L of[-.72,.72])W(i,"metal",c,ot+L,.98,E.z,.05,.16,.05);me(i,"collect",ot,1.28,E.z+.12,.9,.24,0),W(i,"metal",c,ot,2.62,E.z+.1,.05,.36,.05),W(i,"joinery",u,ot,2.3,E.z+.1,.72,.44,.05,{cast:!0});{const L=new ut(new Be(.64,.36),to());L.position.set(ot,2.3,E.z+.13),i.add(L)}me(i,"collect",ot,2.62,E.z+.135,.6,.2,0);const Pt=.2;W(i,"metal",c,Pt,1.12,E.z-.1,.72,.44,.5,{cast:!0}),W(i,"joinery",u,Pt,1.1,E.z+.16,.6,.24,.04);for(const L of[-.18,.1])W(i,"metal",c,Pt+L,.96,E.z+.12,.05,.12,.05);W(i,"joinery",l,Pt+.55,.99,E.z-.15,.28,.18,.28);const rt=1.55;W(i,"joinery",h,rt,.96,E.z,1.2,.1,.7,{cast:!0}),W(i,"metal",c,rt,1.46,E.z,1.2,.05,.7,{cast:!0});for(const L of[-1,1])W(i,"metal",c,rt+L*.575,1.21,E.z,.05,.45,.66);const R=new ut(new Vt(1.1,.42,.62),md("glass",13623528));R.position.set(rt,1.215,E.z),i.add(R),W(i,"joinery",l,rt,1.19,E.z,1.06,.02,.56);for(const[L,O,Y]of[[-.35,-.12,We],[0,.1,13210159],[.33,-.08,l]])W(i,"trim",Y,rt+L,1.06+.035,E.z+O,.16,.07,.16,{chamfer:0}),W(i,"trim",Y,rt+L*.7,1.23,E.z-O,.14,.06,.14,{chamfer:0});me(i,"mccafe",Pt+1.15,.62,E.z+E.d/2+.05,.9,.26,0),W(i,"trim",We,-3.6,2.44,E.z-.55,5.8,.58,.06,{cast:!0}),me(i,"barn",-5.6,2.44,E.z-.51,1.6,.4,0),me(i,"order",-1.8,2.44,E.z-.51,1.5,.36,0);const M={x:o-.35,z0:.9,z1:2.5},B=(M.z0+M.z1)/2;W(i,"metal",c,M.x,.45,B,.7,.9,M.z1-M.z0,{cast:!0}),i.solid(M.x,0,B,.7,.9,M.z1-M.z0),$n(i,M.x,B,0,.7,M.z1-M.z0),W(i,"metal",c,M.x+.1,1.24,B-.25,.3,.68,.86,{cast:!0}),W(i,"joinery",u,M.x-.075,1.34,B-.25,.02,.4,.74);for(let L=0;L<3;L++){const O=B-.51+L*.26;W(i,"trim",[10236968,8030778,13210159][L],M.x-.085,1.34,O,.01,.3,.19,{chamfer:0}),W(i,"metal",c,M.x-.1,1.02,O,.05,.14,.05,{cast:!0}),W(i,"metal",c,M.x-.15,1.11,O,.1,.03,.03)}W(i,"metal",c,M.x-.11,.925,B-.25,.24,.02,.8),W(i,"joinery",u,M.x-.11,.935,B-.25,.18,.01,.74);for(const[L,O]of[[B+.42,6],[B+.6,5]])for(let Y=0;Y<O;Y++)W(i,"joinery",13620957,M.x,.95+Y*.055,L,.115,.055,.115,{cast:Y===O-1,chamfer:0});me(i,"drinks",o-.02,1.85,B,.9,.26,-Math.PI/2),h1(i,o-.42,3.3,-Math.PI/2);const J=-9.55;for(const L of[4.3,5.45]){W(i,"metal",c,J,.05,L,.44,.1,.38),W(i,"trim",We,J,.62,L,.38,1.04,.3,{cast:!0}),W(i,"metal",c,J,1.16,L,.42,.05,.34);const O=W(i,"joinery",u,J+.13,1.42,L,.035,.56,.44,{cast:!0});O.rotation.z=.26;const Y=new ut(new Vt(.02,.48,.37),to());Y.position.set(J+.165,1.42,L),Y.rotation.z=.26,i.add(Y),W(i,"metal",c,J+.1,1.08,L+.22,.11,.13,.09),i.solid(J,0,L,.44,1.7,.42),$n(i,J,L,0,.48,.44)}me(i,"order",-o+.02,1.62,4.88,.6,.2,Math.PI/2);const tt=a-.03-.03,Lt=[{x:-6.9,z:3.8},{x:-4.3,z:3.8},{x:-6.9,z:5.55},{x:-4.3,z:5.55},{x:2.9,z:3.8},{x:5.7,z:3.8},{x:8.3,z:3.8}];Lt.forEach((L,O)=>{const Y=O+1;ud(i,L.x,L.z,0,.8,.8),Dc(i,L.x-.72,L.z,0,Math.PI/2),Dc(i,L.x+.72,L.z,0,-Math.PI/2),W(i,"metal",c,L.x,.86,L.z,.035,.24,.035),Xh(i,L.x+.22,L.z+.16,.74),f(`table_${Y}`,L.x,L.z,null,null,{noClamp:!0}),f(`seat_${Y}`,L.x+.72,L.z,null,null,{noClamp:!0}),i.interact(`table_serve_${Y}`,"set the tray down",L.x,.85,L.z,"service",{op:"deliver",table:Y,when:"carrying_for"},1.7)});const lt=tt,Mt=lt-1.7,Kt=2.6,ht=9.4,Rt=2,kt=(ht-Kt)/Rt;for(let L=0;L<Rt;L++){const O=Kt+(L+.5)*kt;for(const[Y,at,wt]of[[Mt+.265,Mt+.06,.95],[lt-.265,lt-.06,.55]])W(i,"joinery",l,O,.23,Y,kt-.1,.46,.53,{cast:!0}),W(i,"joinery",u,O,.075,Y,kt-.2,.15,.43),W(i,"joinery",l,O,wt/2,at,kt-.1,wt,.12,{cast:!0});W(i,"joinery",l,O,.725,(Mt+lt)/2,kt-.2,.03,.7,{cast:!0}),W(i,"joinery",h,O,.36,(Mt+lt)/2,.09,.71,.09),Xh(i,O+.28,(Mt+lt)/2,.74),i.solid(O,0,(Mt+lt)/2,kt,.95,lt-Mt)}for(const L of[0,kt,kt*Rt]){const O=Kt+L;W(i,"joinery",l,O,.675,(Mt+lt)/2,.07,1.35,lt-Mt-.06,{cast:!0}),W(i,"trim",We,O,1.32,(Mt+lt)/2,.086,.06,lt-Mt-.06)}$n(i,(Kt+ht)/2,(Mt+lt)/2,0,ht-Kt,lt-Mt,{margin:.028});const Bt=tt-.35;W(i,"joinery",l,-6.3,1.03,Bt,6.2,.05,.64,{cast:!0});for(const L of[-2.6,0,2.6])W(i,"metal",c,-6.3+L,.5,Bt+.2,.06,1,.06);i.solid(-6.3,0,Bt,6.2,1.05,.64);for(const L of[-8.5,-7.2,-5.9,-4.6])W(i,"joinery",l,L,.72,Bt-.75,.36,.04,.36,{cast:!0}),W(i,"metal",c,L,.36,Bt-.75,.07,.68,.07),W(i,"metal",c,L,.02,Bt-.75,.34,.04,.34),i.solid(L,0,Bt-.75,.4,.75,.4);const bt=16772056;i.light(-6.5,ir-.15,4.2,bt,10,13),i.light(-2,ir-.15,4.6,bt,10,13),i.light(2.5,ir-.15,4.2,bt,10,13),i.light(7,ir-.15,4.4,bt,10,13),i.light(-3.7,Un-.15,1,bt,10,12),i.light(-7.5,Un-.15,-4.8,bt,10,12),i.light(-.5,Un-.15,-5,bt,10,12),i.light(-3.6,Un-.15,-2.6,bt,12,12),i.light(4.9,Un-.3,-5.15,bt,8,9),i.light(8.8,Un-.15,-2.6,bt,9,10),i.light(5,Un-.15,-1.6,bt,8,10);for(const[L,O,Y,at,wt]of[[-1.5,1.9,-3.2,2.4,15],[-3,2.1,4.2,3.4,16],[5.5,2.1,4,2.8,13],[-7.6,2,4.9,2.2,11],[-4,1.9,1,1.6,12]]){const $t=i.light(L,O,Y,15260876,at,wt);$t.decay=1}Qr(i,-9.4,-6.6,3.1,.2,Un,4,3),Qr(i,3.6,-4.3,9.6,-.2,Un,2,2),Qr(i,-9,2.4,9.4,6.4,ir,4,2),f("spawn",-1,12.6,null,null,{noClamp:!0}),f("station_pod",yt.cx,yt.z1+nn,Math.PI,nn),f("station_fries",x,p+nn,Math.PI,nn),f("station_grill",D,p+nn,Math.PI,nn),f("station_counter",it,E.z-E.d/2-nn,0,nn),f("station_runner",ot,E.z-E.d/2-nn,0,nn),f("station_drivethru",pt-.375-nn,-2.7,Math.PI/2,nn),f("restock",4.45,-5.65,Math.PI,nn),f("gate",(_t+Et)/2,0,null,null,{noClamp:!0}),f("entry_out",-1,8.3,null,null,{noClamp:!0}),f("entry",-1,6),f("aisle",-2,2.9),f("queue_1",-8,2.8),f("queue_2",-7.25,2.95),f("queue_3",-6.5,3),f("queue_4",-5.9,3.15),f("collect_wait",-5.2,3.1),f("collect_pickup",-5.2,2.65),f("kiosk_gate",-8.9,2.9),f("kiosk_1",-8.78,4.3),f("kiosk_2",-8.85,5.15),i.interact("station_pod","work the pod",yt.cx,.95,yt.z1,"station",{station:"pod",zone:{minZ:yt.z1}},2),i.interact("pod_toaster","toast a bun",zt,1.25,yt.cz+.21,"pod",{op:"token",token:"bun",podOnly:!0},1.8),Q.forEach(([L],O)=>{const Y=jt-.255+O*.17;i.interact("pod_gun_"+L,L==="bbq"?"dose BBQ":"dose "+L,Y,1.25,yt.cz-.25,"pod",{op:"token",token:L,podOnly:!0},1.7)}),dt.forEach(([L],O)=>{const Y=F+.1+O*.19;i.interact("pod_bin_"+L,"add "+L,Y,.98,yt.cz-.08,"pod",{op:"token",token:L,podOnly:!0},1.7)}),i.interact("pod_uhc","pull from the cabinet",nt,1.28,yt.cz+.345,"pod",{op:"uhc",podOnly:!0},1.6),i.interact("pod_wrap","wrap the order",Ps.x,.95,Ps.z,"pod",{op:"wrap",podOnly:!0},1.4),i.interact("pod_chute","send it down",fe.x0+.05,1.05,fe.z0,"pod",{op:"send",podOnly:!0},1.4),Yh(i,.42,.94,0,6);for(let L=0;L<3;L++)W(i,"joinery",14272934,1.08+L*.13,.975,-.04+L%2*.08,.11,.15,.065,{cast:L===0,chamfer:0}),W(i,"joinery",14272934,1.08+L*.13,1.06,-.04+L%2*.08,.115,.022,.03,{chamfer:0});for(let L=0;L<3;L++)W(i,"joinery",14272934,1.62+L*.13,.975,-.02+L%2*.07,.11,.15,.065,{cast:!1,chamfer:0}),W(i,"trim",We,1.62+L*.13,.955,-.02+L%2*.07,.112,.03,.067,{chamfer:0});i.interact("counter_tray","take a tray for table service",.42,1.02,0,"service",{op:"tray",when:"tray_ready"},1.6),i.interact("counter_bag","bag the next takeaway",1.18,1.02,0,"service",{op:"bag",when:"bag_ready"},1.6),i.interact("dt_bag","bag the drive-thru order",1.68,1.02,0,"service",{op:"dt_bag",when:"dt_bag_ready"},1.6),i.interact("dlv_bag","bag the delivery",1.18,1.02,-.28,"service",{op:"dlv_bag",when:"dlv_bag_ready"},1.6),i.interact("station_counter","work the counter",it,.95,E.z-E.d/2,"station",{station:"counter",zone:{maxZ:E.z-E.d/2}},1.8),i.interact("till_order","take their order",it,1.3,E.z+.95,"counter",{op:"take_order",when:"queue_head"},2.4),i.interact("till_payment","take payment",it,1,E.z+.3,"counter",{op:"take_payment",when:"payment_due"},1.6);const te=[];for(const L of d){const O=L.noClamp?{x:L.x,z:L.z,moved:0}:u1(i.colliders,L.x,L.z);i.spot(L.name,O.x,0,O.z),O.moved>.005&&te.push({name:L.name,from:[L.x,L.z],to:[+O.x.toFixed(3),+O.z.toFixed(3)],moved:+O.moved.toFixed(3)})}const qt=f1(i.colliders,d.filter(L=>!L.noClamp).map(L=>({id:L.name,x:L.x,z:L.z,facing:L.facing,standoff:L.standoff}))),se={rule:`spot = fixture face + normal * standoff; clear floor ${Uc} x ${Nc}; hard floor ${mi}`,checked:d.length,failures:qt.failures,clamped:te,tightest:qt.tightest,ok:qt.failures.length===0&&te.length===0};se.ok||console.error("Fitout: CLEARANCE FAILURES — a published point is unreachable",se.failures,te);const z=[{where:"pod face to the pass",m:+(-vt/2-yt.z1).toFixed(2)},{where:"pod back to the grill front",m:+(yt.z0-p).toFixed(2)},{where:"pod east end to the pack-out",m:+(k.cx-k.w/2-yt.x1).toFixed(2)},{where:"crew aisle, pass to counter",m:+(E.z-E.d/2-vt/2).toFixed(2)},{where:"staff gate",m:+(Et-_t).toFixed(2)},{where:"pass flap by the landing",m:+(Z-At).toFixed(2)},{where:"counter face to dining tables",m:+(Lt[0].z-.4-(E.z+E.d/2)).toFixed(2)},{where:"restock straight line, pod spot to dry store door",m:+Math.hypot(4.15-yt.cx,-4.55-(yt.z1+nn)).toFixed(2)},{where:"front door opening",m:1.8}];return{workplace:"burger_barn",clearance:se,walkways:z,spots:i.spots,materials:c1.map(L=>typeof L[1]=="number"?`${L[0]}@${L[1].toString(16)}`:`${L[0]}:${L[1]}`),labels:xd()!==null}}const En={width:20,depth:14,height:4.2},Yt=En.width/2,Ht=En.depth/2,Xn=En.height,Oo=Ut.wallThick,Ai=Yt-Oo/2,ws=Ht-Oo/2,xn=2,wa=4.9,eo=.15,jh=6.4,Ea=3.2,no=2.8,m1=.45,g1=2.7,we=-1,ji=1.8,Kh=2.6,ba=.9,Ta=.85,Aa=2.05,$h=-4.2,Zh=-1,Ra=-5.4,_1=1.8,bn=11026479,Ls=13224902,Jh=new Set;function vd(i,t,e={}){if(e.material)return e.material;try{return fl(i,t,null,e.recipe||{})}catch(n){return Jh.has(i)||(Jh.add(i),console.error(`Shell: surface '${i}' unavailable, flat colour instead`,n)),ke(t,e)}}function It(i,t,e,n,s,r,o,a,c,l={}){var d;const h=vd(t,e,l),u=new ut(new Vt(Math.max(o,.001),Math.max(a,.001),Math.max(c,.001)),h);return u.castShadow=l.cast??((d=h.userData)==null?void 0:d.cast)??!1,u.receiveShadow=!0,u.position.set(n,s,r),l.rotY&&(u.rotation.y=l.rotY),i.add(u),u}const Jn=()=>ke(ie.concrete);function un(i,t,e,n,s,r=0){const o=(t+n)/2,a=(e+s)/2,c=Math.abs(n-t),l=Math.abs(s-e);It(i,"(concrete)",0,o,r-.06,a,c,.12,l,{material:Jn(),cast:!1}),i.solid(o,r-1.2,a,c,1.2,l,!0)}function Qh(i,t,e,n,s,r,o){const a=new al(n,s,28,2,r,Math.PI/2);a.rotateX(-Math.PI/2);const c=new ut(a,Jn());return c.receiveShadow=!0,c.position.set(t,o,e),i.add(c),c}function vn(i,t,e,n,s,r=0,o=.15){const a=(t+n)/2,c=(e+s)/2;It(i,"(concrete)",0,a,r+o/2,c,Math.max(Math.abs(n-t),.15),o,Math.max(Math.abs(s-e),.15),{material:Jn()})}function io(i,t,e,n,s,r,o=0,a=.15){for(let l=0;l<8;l++){const h=s+(r-s)*(l/8),u=s+(r-s)*((l+1)/8),d=t+Math.cos(h)*n,f=e+Math.sin(h)*n,m=t+Math.cos(u)*n,_=e+Math.sin(u)*n,p=Math.hypot(m-d,_-f)+.04;It(i,"(concrete)",0,(d+m)/2,o+a/2,(f+_)/2,p,a,.16,{material:Jn(),rotY:Math.atan2(-(_-f),m-d)})}}function Fe(i,t,e,n,s,r=0){const o=(t+n)/2,a=(e+s)/2;It(i,"trim",gt.trim,o,r+.008,a,Math.max(Math.abs(n-t),.1),.012,Math.max(Math.abs(s-e),.1))}function go(i,t,e,n=0,s=1){const r=new ut(new De(.07,.07,s,8),vd("metal",gt.metalDull));r.castShadow=!0,r.position.set(t,n+s/2,e),i.add(r)}function so(i,t,e,n,s,r,o=0){const a=n-t,c=s-e,l=Math.hypot(a,c);if(l<.5)return;const h=a/l,u=c/l,d=-u,f=h,m=Math.atan2(-u,h),_=Oo/2+.006;for(let p=1.2;p<r-.2;p+=1.2)It(i,"joinery",gt.shadowDark,t+h*(l/2)+d*_,o+p,e+u*(l/2)+f*_,l,.02,.012,{rotY:m});for(let p=1.2;p<l-.3;p+=1.2)It(i,"joinery",gt.shadowDark,t+h*p+d*_,o+r/2,e+u*p+f*_,.02,r,.012,{rotY:m})}const pl={lane:{width:3.5,surface:0,legs:[{name:"entry",from:{x:-15,z:15.9},to:{x:-15,z:-6.5},forward:{x:0,z:-1}},{name:"rear",from:{x:-9,z:-12.5},to:{x:6.15,z:-12.5},forward:{x:1,z:0}},{name:"service",from:{x:12.15,z:-6.5},to:{x:12.15,z:29.5},forward:{x:0,z:1}}]}},le=pl.lane.surface,Es=pl.lane.width/2;function x1(i,t){un(i,-Yt,Ht,Yt,10.5),un(i,-11,10.5,10.4,27.5),un(i,-17.75,15.9,-11,29.5),un(i,9.65,27.5,14.65,29.5),un(i,-13.25,-6.5,-10,Ht),un(i,-12.9,-Ht,-10,-6.5),un(i,-7,-10.75,1.5,-8.6),un(i,-6.9,-10,-3.9,-Ht),un(i,2,-10.2,5,-8.2),un(i,-15-Es,-6.5,-15+Es,15.9,le),un(i,-9,-12.5-Es,6.15,-12.5+Es,le),un(i,12.15-Es,-6.5,12.15+Es,29.5,le),Qh(i,-9,-6.5,4.25,7.75,Math.PI/2,le),Qh(i,6.15,-6.5,4.25,7.75,0,le),vn(i,-16.75,-6.5,-16.75,15.9,le),vn(i,-13.25,-6.5,-13.25,15.9,le),vn(i,-9,-14.25,6.15,-14.25,le),vn(i,-9,-10.75,.5,-10.75,le),vn(i,13.9,-6.5,13.9,29.5,le),vn(i,10.4,-6.5,10.4,-5.6,le),vn(i,10.4,.6,10.4,29.5,le),vn(i,10.4,-5.2,10.4,.2,le,.1),io(i,-9,-6.5,4.25,Math.PI,Math.PI*1.5,le),io(i,-9,-6.5,7.75,Math.PI,Math.PI*1.5,le),io(i,6.15,-6.5,4.25,Math.PI*1.5,Math.PI*2,le),io(i,6.15,-6.5,7.75,Math.PI*1.5,Math.PI*2,le);for(const r of[-16.6,-13.4])Fe(i,r,-6.5,r,15,le);for(const r of[-14.1,-10.9])Fe(i,-9,r,.4,r,le);Fe(i,13.75,-6.5,13.75,27.5,le),Fe(i,.5,-14.25,.5,-10.75,le);for(let r=1;r<6.4;r+=.8)Fe(i,r,-14.25,r+.4,-14.25,le);for(const[r,o]of[[-11.2,-8.6],[-10.2,-9.4],[8.6,-8.8],[9.4,-7.8]])go(i,r,o);for(let r=0;r<=2;r++)Fe(i,-11+r*2.6,10.5,-11+r*2.6,15.9);for(let r=0;r<=3;r++)Fe(i,1.4+r*2.6,10.5,1.4+r*2.6,15.9);for(let r=0;r<=8;r++)Fe(i,-11+r*2.6,22.1,-11+r*2.6,27.5);for(let r=0;r<2;r++)It(i,"(concrete)",0,-11+(r+.5)*2.6,.06,11.4,1.65,.12,.18,{material:Jn()});for(let r=0;r<3;r++)It(i,"(concrete)",0,1.4+(r+.5)*2.6,.06,11.4,1.65,.12,.18,{material:Jn()});for(let r=0;r<8;r++)It(i,"(concrete)",0,-11+(r+.5)*2.6,.06,26.6,1.65,.12,.18,{material:Jn()});for(const r of[we-2.4,we,we+2.4])Fe(i,r,10.5,r,15.9);for(let r=11;r<15.9;r+=.7)Fe(i,we-2.4,r,we,r+.24);go(i,we-1.2,13.2,0,1.3),Fe(i,we,13.2,we+2.4,13.44);for(let r=11;r<15.6;r+=.8)Fe(i,-5.6,r,-3.6,r+.3);vn(i,-Yt,10.5,Yt,10.5),vn(i,-11,10.5,-11,27.5),vn(i,-11,27.5,9.8,27.5);for(let r=16.1;r<22.1;r+=.8)Fe(i,-5.2,r,-3.2,r+.3);Fe(i,-11.25,15.9,-11.25,22.1);for(let r=10.6;r<13.9;r+=.8)Fe(i,r,18,r+.3,20,le);for(let r=-9.2;r<=9.2;r+=1.5)r>we-1.7&&r<we+1.7||go(i,r,Ht+.6);It(i,"metal",gt.metalDull,we,3.07,Ht+1.5,6,.14,3,{cast:!0});for(const r of[-2.7,2.7])It(i,"metal",gt.metalDull,we+r,1.5,Ht+2.8,.12,3,.12,{cast:!0});for(const r of[3.4,6.6]){ud(i,r,9.3,0,.9,.9);for(const[o,a,c]of[[-.78,0,Math.PI/2],[.78,0,-Math.PI/2],[0,-.78,0],[0,.78,Math.PI]])Dc(i,r+o,9.3+a,0,c)}Fe(i,-9.8,8.2,-9.8,10.4),Fe(i,-8.6,8.2,-8.6,10.4),Fe(i,-7.4,8.2,-7.4,10.4);for(const r of[-9.2,-8])It(i,"metal",gt.metalDull,r-.35,.38,10.1,.06,.76,.06,{cast:!0}),It(i,"metal",gt.metalDull,r+.35,.38,10.1,.06,.76,.06,{cast:!0}),It(i,"metal",gt.metalDull,r,.74,10.1,.76,.06,.06,{cast:!0});It(i,"metal",gt.metalDull,-6,.55,-10.1,.1,1.1,.1,{cast:!0}),It(i,"trim",bn,-6,1.6,-10.1,.9,1.4,.1,{cast:!0,rotY:-.6});const e=.209;It(i,"(concrete)",0,-1.5,.12,-10.15,2.1,.25,.6,{material:Jn(),rotY:e}),It(i,"trim",bn,-1.5,1.7,-10.15,1.96,1.66,.16,{cast:!0,rotY:e}),It(i,"trim",gt.trim,-1.5,1.7,-10.22,1.8,1.5,.06,{rotY:e});const n=(r,o,a,c,l,h,u=0)=>{It(i,r,o,-1.5+a*Math.cos(e),c,-10.26-u-a*Math.sin(e),l,h,.02,{rotY:e})};n("trim",bn,0,2.28,1.64,.22);for(let r=0;r<5;r++)for(const o of[-.42,.44])n("joinery",gt.shadowDark,o,2.02-r*.14,.68,.035);for(const r of[-.55,0,.55])n("trim",bn,r,1.18,.4,.3),n("joinery",gt.joineryLight,r,1.12,.28,.12,.01);It(i,"metal",gt.metalDull,.5,.9,-10.4,.25,1.8,.25,{cast:!0}),It(i,"joinery",gt.shadowDark,.5,1.35,-10.54,.2,.2,.04),It(i,"joinery",gt.shadowDark,.5,1.62,-10.54,.55,.35,.04),It(i,"metal",gt.metalDull,-1,2.92,-12,3,.14,3.2,{cast:!0});for(const r of[-2.3,.3])It(i,"metal",gt.metalDull,r,1.4,-10.45,.12,2.8,.12,{cast:!0});for(const r of[-17.05,-12.95])It(i,"metal",gt.metalDull,r,le+1.3,14,.09,2.6,.09,{cast:!0});It(i,"trim",bn,-15,le+2.5,14,4.3,.2,.12,{cast:!0}),It(i,"wall",Ls,1.7,1,-9.2,.14,2,2,{cast:!0}),i.solid(1.7,0,-9.2,.14,2,2);for(const r of[-9.6,-8.7])It(i,"metal",gt.metalDull,3.5,.45,r,1.2,.9,.7,{cast:!0}),i.solid(3.5,0,r,1.2,.9,.7);const s={x0:-12.8,x1:-10.2,z0:-Ht,z1:-5};for(const[r,o,a,c]of[[s.x0,s.z0,s.x1,s.z0+.2],[s.x0,s.z0,s.x0+.2,s.z1],[s.x1-.2,s.z0,s.x1,s.z1]]){const l=(r+a)/2,h=(o+c)/2;It(i,"wall",Ls,l,.9,h,a-r,1.8,c-o,{cast:!0}),i.solid(l,0,h,a-r,1.8,c-o)}It(i,"metal",gt.metalDull,(s.x0+s.x1)/2,1.2,s.z1,2.4,2.4,.08,{cast:!0}),It(i,"metal",gt.metalDull,(s.x0+s.x1)/2,1.94,(s.z0+s.z1)/2,s.x1-s.x0+.2,.1,s.z1-s.z0+.1,{cast:!0});for(const[r,o,a]of[[-12.1,-6.2,1.2],[-10.85,-6.2,1.2],[-12.1,-5.55,1.2],[-10.9,-5.55,.6]])It(i,"joinery",gt.joineryDark,r,.55,o,a,1.1,.55,{cast:!0}),It(i,"joinery",gt.shadowDark,r,1.13,o,a+.04,.06,.59),i.solid(r,0,o,a,1.16,.55);un(i,-13,-4.8,-11.5,-3.3);for(const[r,o,a,c]of[[-13,-4.8,-11.5,-4.68],[-13,-3.42,-11.5,-3.3],[-13,-4.8,-12.88,-3.3],[-11.62,-4.8,-11.5,-3.3]])vn(i,r,o,a,c,0,.2);for(const[r,o]of[[-12.55,-4.1],[-11.95,-4.1]])It(i,"metal",gt.metalDull,r,.42,o,.5,.84,.5,{cast:!0});if(It(i,"(concrete)",0,-10.6,.1,28.3,1.1,.2,1.1,{material:Jn()}),It(i,"trim",bn,-10.6,3,28.3,.55,6,.55,{cast:!0}),i.solid(-10.6,0,28.3,.7,6,.7),t){const r=t.clone();r.scale.set(.62,1.9,1),r.position.set(-10.6,4.3,28.62),i.add(r);const o=t.clone();o.scale.set(.62,1.9,1),o.position.set(-10.6,4.3,27.98),o.rotation.y=Math.PI,i.add(o)}}function v1(i,t={}){const e=new Dv;Uv(e,0,0,En.width,En.depth,0,gt.tileFloor,{surface:"vinyl"});const n={height:Xn,colour:Ls,surface:"wall",skirting:!1,cornice:!1,autoServices:!1,inner:-1},s=[],r=(_,p)=>{const g=p-_,y=Math.max(1,Math.round(g/1.565)),x=g/y;for(let S=0;S<y;S++)s.push({at:_+(S+.5)*x+Yt,width:Math.min(1.375,x-.19),kind:"window",sill:m1,head:g1})};r(-Ai,we-ji/2-.15),r(we+ji/2+.15,9.6),s.push({at:we+Yt,width:ji,kind:"door",head:Kh,door:{pair:!0,style:"glazed",auto:!0,startsShut:!0,swing:1,label:"entrance"}}),Qi(e,-Yt,Ht,Yt,Ht,{...n,openings:s,name:"front"}),Qi(e,Yt,Ht,Yt,-Ht+xn,{...n,openings:[{at:Ht-4,width:1.2,kind:"window",sill:1.8,head:2.7},{at:Ht-Zh,width:ba,kind:"window",sill:Ta,head:Aa},{at:Ht-$h,width:ba,kind:"window",sill:Ta,head:Aa}],name:"east"}),Qi(e,Yt,-Ht+xn,Yt-xn,-Ht,{...n,name:"splay"}),Qi(e,Yt-xn,-Ht,-Yt,-Ht,{...n,openings:[{at:Ht-Ra,width:_1,kind:"door",head:Kh,door:{style:"panel",pair:!1,startsShut:!1,swing:1,colour:gt.metalDull,label:"goods door"}}],name:"rear"}),Qi(e,-Yt,-Ht,-Yt,Ht,{...n,openings:[{at:Ht-.5,width:ba,kind:"window",sill:Ta,head:Aa}],name:"west"});const o=1.4;Hv(e,0,(o+ws)/2,Ai*2,ws-o,Ea),Hh(e,0,(o-5)/2,Ai*2,o+5,no),Hh(e,(-Ai+7.9)/2,(-ws-5)/2,Ai+7.9,ws-5,no),It(e,"wall",Ls,0,(no+Ea+.12)/2,o,Ai*2,Ea-no+.16,.12,{cast:!0}),It(e,"wall",Ls,0,Xn+.1,0,En.width,.2,En.depth,{cast:!0});const a=[[-Yt,Ht,Yt,Ht],[Yt,Ht,Yt,-Ht+xn],[Yt,-Ht+xn,Yt-xn,-Ht],[Yt-xn,-Ht,-Yt,-Ht],[-Yt,-Ht,-Yt,Ht]];for(const[_,p,g,y]of a){const x=Math.hypot(g-_,y-p)+.36,S=Math.atan2(-(y-p),g-_),C=(_+g)/2,A=(p+y)/2;It(e,"wall",Ls,C,(Xn+wa-eo)/2,A,x,wa-eo-Xn,.35,{rotY:S,cast:!0}),It(e,"trim",gt.trim,C,wa-eo/2,A,x+.06,eo,.47,{rotY:S,cast:!0})}const c=Ht+Oo/2;It(e,"trim",bn,0,3.475,c+.05,En.width,.85,.1,{cast:!0});const l=3.2,h=we-1.2,u=h+l;for(const[_,p]of[[(-Yt+h)/2,h+Yt],[(u+Yt)/2,Yt-u]])It(e,"metal",gt.metalDull,_,2.93,c+.6,p,.16,1.2,{cast:!0}),It(e,"trim",bn,_,2.79,c+1.18,p,.14,.06);const d=(h+u)/2;It(e,"trim",bn,d,(2.4+jh)/2,c+.2,l,jh-2.4,.4,{cast:!0});for(const[_,p]of[[(h+we-ji/2)/2,we-ji/2-h],[(we+ji/2+u)/2,u-we-ji/2]])It(e,"trim",bn,_,1.2,c+.2,p,2.4,.4,{cast:!0});It(e,"joinery",gt.shadowDark,d,4.3,c+.41,l,3.4,.02);for(let _=0;_<18;_++)It(e,"joinery",gt.joineryLight,h+.0875+_*.175,4.3,c+.44,.15,3.4,.04,{cast:!0});let f=null;typeof document<"u"&&document.createElement&&(f=dd(t.name||"BURGER BARN",{width:7.2,height:.62,bg:"rgba(0,0,0,0)",fg:t.signFg??"#f6efe0",font:"bold 84px Georgia, serif"}),f.position.set(4.9,3.46,c+.12),e.add(f));for(const _ of[$h,Zh]){It(e,"metal",gt.metalDull,Yt+.53,le+2.66,_,.9,.12,1.6,{cast:!0});for(const p of[-.75,.75])go(e,Yt+.6,_+p,le)}It(e,"metal",gt.metalDull,-Yt-.53,le+2.66,-.5,.9,.12,1.6,{cast:!0}),It(e,"trim",bn,-Yt-.1,2.35,-.5,.1,.45,1.7,{cast:!0}),It(e,"(concrete)",0,-12.85,.12,-1.9,1.3,.25,.45,{material:Jn()}),It(e,"trim",bn,-12.85,1.55,-1.9,1.24,1.3,.14,{cast:!0}),It(e,"trim",gt.trim,-12.85,1.55,-1.97,1.1,1.16,.05);for(let _=0;_<4;_++)It(e,"joinery",gt.shadowDark,-12.85,1.86-_*.17,-2,.88,.032,.02);It(e,"metal",gt.metalDull,-12.85,.85,-.95,.2,1.7,.2,{cast:!0}),It(e,"joinery",gt.shadowDark,-12.85,1.3,-1.06,.16,.16,.04),It(e,"metal",gt.metalDull,6.2,2.3,-Ht-.4,.8,4.2,.6,{cast:!0}),It(e,"metal",gt.metalDull,6.2,4.55,-Ht-.4,1,.35,.8,{cast:!0});for(const _ of[-1,.5]){It(e,"metal",gt.metalDull,_,2.6,-Ht-.06,.6,.6,.06);for(let p=0;p<5;p++)It(e,"joinery",gt.shadowDark,_,2.36+p*.12,-Ht-.1,.54,.05,.04)}It(e,"metal",gt.metalDull,Ra,2.86,-Ht-1,3,.14,2,{cast:!0});for(const _ of[-1.3,1.3])It(e,"metal",gt.metalDull,Ra+_,1.43,-Ht-1.85,.12,2.86,.12,{cast:!0});so(e,Yt,Ht,Yt,-Ht+xn,Xn),so(e,Yt,-Ht+xn,Yt-xn,-Ht,Xn),so(e,Yt-xn,-Ht,-Yt,-Ht,Xn),so(e,-Yt,-Ht,-Yt,Ht,Xn),x1(e,f);const m=p1(e,{width:En.width,depth:En.depth});return{group:td(e.group),colliders:e.colliders,doorSpecs:e.doors,interactables:e.interactables,spots:e.spots,lights:e.lights,report:m,width:En.width,depth:En.depth,height:Xn,door:{x:we,z:Ht+1.6},doors:[{x:we,z:Ht+1.6}],interiorBounds:{minX:-Ai,maxX:Ai,minZ:-ws,maxZ:ws,maxY:Xn}}}const Ie=6,Ve=34.5,On=-34,yn=-46,Mn=44,bo=[];function y1(i){const t=i.root,e=i.rng.child("town"),n=i.colliders,s=()=>ke(ie.concrete),r=(u,d,f,m)=>{const _=(u+f)/2,p=(d+m)/2,g=new ut(new Vt(Math.abs(f-u),.1,Math.abs(m-d)),s());g.position.set(_,-.045,p),g.receiveShadow=!0,t.add(g)},o=(u,d,f,m)=>{const _=Math.abs(f-u)>Math.abs(m-d)?"x":"z",p=Math.abs(_==="x"?f-u:m-d);for(let g=0;g<p;g+=4){const y=g/p,x=new ut(new Vt(_==="x"?1.6:.12,.02,_==="x"?.12:1.6),ke(gt.trim));x.position.set(u+(f-u)*y,.012,d+(m-d)*y),t.add(x)}};r(yn-Ie/2,Ve-Ie/2,Mn+Ie/2,Ve+Ie/2),r(yn-Ie/2,On-Ie/2,Mn+Ie/2,On+Ie/2),r(yn-Ie/2,On-Ie/2,yn+Ie/2,Ve+Ie/2),r(Mn-Ie/2,On-Ie/2,Mn+Ie/2,Ve+Ie/2),o(yn+4,Ve,Mn-4,Ve),o(yn+4,On,Mn-4,On),o(yn,On+4,yn,Ve-4),o(Mn,On+4,Mn,Ve-4),r(-17.75,29.5,-11,Ve-Ie/2),r(9.65,29.5,14.65,Ve-Ie/2),r(-10,-16,-1,-22.5),r(-8,-22.5,-3,On+Ie/2);const a=(u,d,f,m)=>{const _=new ut(new Vt(Math.max(.12,Math.abs(f-u)),.02,Math.max(.12,Math.abs(m-d))),ke(gt.trim));_.position.set((u+f)/2,.012,(d+m)/2),t.add(_)};a(-9.4,-16.4,-9.4,-21.2),a(-6.4,-16.4,-6.4,-21.2),a(-1.6,-16.4,-1.6,-21.2),a(-9.4,-16.4,-1.6,-16.4);const c=dd("DELIVERIES",{width:2.4,height:.55,bg:"#a8402f"});c.position.set(-5.5,2.15,-15.95),c.rotation.y=Math.PI,t.add(c);for(const u of[-6.5,-4.5]){const d=new ut(new Vt(.12,2.1,.12),ke(ie.metalDark));d.position.set(u,1.05,-15.95),d.castShadow=!0,t.add(d)}const l=(u,d,f,m)=>{const{group:_,size:p}=t1(e);_.position.set(d,0,f),_.rotation.y=m,t.add(_);const g=Math.abs(Math.sin(m))>.5,y=(g?p.d:p.w)/2+.1,x=(g?p.w:p.d)/2+.1;n.push({min:new I(d-y,0,f-x),max:new I(d+y,p.h+1.2,f+x),walkable:!1});const S=new Ys().setFromAxisAngle(new I(0,1,0),m),C=new I(0,0,p.d/2+1).applyQuaternion(S),A={x:d+C.x,z:f+C.z},b=new ut(new Vt(1.1,.06,2.6),s()),P=new I(0,0,p.d/2+1.6).applyQuaternion(S);b.position.set(d+P.x,-.02,f+P.z),b.rotation.y=m,b.receiveShadow=!0,t.add(b),bo.push({name:u,x:d,z:f,rotY:m,door:A})};l("1 Barn Road",-34,Ve+8.5,Math.PI),l("2 Barn Road",-8,Ve+8.5,Math.PI),l("3 Barn Road",18,Ve+8.5,Math.PI),l("4 Barn Road",38,Ve+8.5,Math.PI),l("1 Millet Street",yn-8.5,8,Math.PI/2),l("2 Millet Street",yn-8.5,-18,Math.PI/2),l("1 Sunset Avenue",Mn+8.5,4,-Math.PI/2),l("2 Sunset Avenue",Mn+8.5,-22,-Math.PI/2);const h=[[-30,Ve-8],[8,Ve-8.5],[30,Ve-8],[yn+8,20],[yn+8,-8],[Mn-8,16],[Mn-8,-14],[-24,On+8],[12,On+8]];for(const[u,d]of h){const f=fd(e,e.range(.9,1.4));f.position.set(u,0,d),t.add(f)}}class M1{constructor(t){this.game=t,this.rng=t.rng.child("world"),this.scene=t.renderer.scene,this.root=new Qt,this.scene.add(this.root),this.colliders=[],this.interactables=[],this.buildings=[],this.enterable=[],this.currentBuilding=null,this.spots={},this.doors=new Jv(t),this._grid=new Map,this.cellSize=5,this.weather={condition:"clear",wetness:0,temp:24,wind:.3},this._nightState=!1}generate(){this._ground(),this._shop(),this._dressing(),y1(this),bo.forEach((t,e)=>{this.addInteractable({id:`house_${e}`,label:"hand over the delivery",pos:new I(t.door.x,1,t.door.z),action:"service",data:{op:"deliver",house:e,when:"at_house"},radius:2.2})}),this._rebuildSpatialHash(),this.game.bus.emit("world:generated",{world:this})}_ground(){const t=new ut(new Be(400,400,1,1),ke(ie.grass));t.rotation.x=-Math.PI/2,t.position.y=-.06,t.receiveShadow=!0,this.root.add(t)}_shop(){var n;const t=v1(this.rng.child("shop"));this.report=t.report,t.group.position.set(0,0,0),this.root.add(t.group);for(const s of t.interactables||[])this.interactables.push(s);this.spots=t.spots||{};for(const s of t.colliders)this.colliders.push(s);(n=t.doorSpecs)!=null&&n.length&&(t.group.updateMatrixWorld(!0),this.doors.install(t.doorSpecs,t.group));const e={x:0,z:0,rotY:0,padY:0,shopId:"fastfood",built:t,lights:t.lights,interiorBounds:t.interiorBounds};this.buildings.push(e),this.enterable.push(e)}_dressing(){const t=this.rng.child("dressing"),e=[[-16.5,25],[-16.8,8],[-16.2,-2],[16.5,12],[16.8,-4],[15.8,24],[-6,32.5],[4,32.8],[12,32]];for(const[s,r]of e){const o=fd(t,t.range(.9,1.3));o.position.set(s,0,r),this.root.add(o)}const n=[{x:-9.7,z:24.8,rotY:0},{x:-2,z:24.8,rotY:0},{x:5.8,z:24.8,rotY:0},{x:5.3,z:13.2,rotY:Math.PI}];for(const s of n){const r=pd(t);r.position.set(s.x,0,s.z),r.rotation.y=s.rotY,this.root.add(r),this.colliders.push({min:new I(s.x-1,0,s.z-2.2),max:new I(s.x+1,1.5,s.z+2.2),walkable:!1})}}_rebuildSpatialHash(){this._grid.clear(),this.colliders.forEach((t,e)=>{const n=Math.floor(t.min.x/this.cellSize),s=Math.floor(t.max.x/this.cellSize),r=Math.floor(t.min.z/this.cellSize),o=Math.floor(t.max.z/this.cellSize);for(let a=n;a<=s;a++)for(let c=r;c<=o;c++){const l=a+","+c;this._grid.has(l)||this._grid.set(l,[]),this._grid.get(l).push(e)}})}query(t,e){const n=[],s=Math.floor((t.x-e)/this.cellSize),r=Math.floor((t.x+e)/this.cellSize),o=Math.floor((t.z-e)/this.cellSize),a=Math.floor((t.z+e)/this.cellSize),c=new Set;for(let l=s;l<=r;l++)for(let h=o;h<=a;h++){const u=this._grid.get(l+","+h);if(u)for(const d of u)c.has(d)||(c.add(d),n.push(this.colliders[d]))}return this.doors.collect(t,e,n),n}sightBlocked(t,e,{eye:n=1.15,backOff:s=.45}={}){const r=t.x,o=t.z,a=(t.y??0)+n;let c=e.x-r,l=e.z-o;const h=Math.hypot(c,l);if(h<.05)return!1;const u=Math.max(0,h-s);if(u<.05)return!1;c/=h,l/=h;const d=r+c*u/2,f=o+l*u/2;for(const m of this.query({x:d,z:f},u/2+1)){if(m.walkable||a<m.min.y||a>m.max.y||r>=m.min.x&&r<=m.max.x&&o>=m.min.z&&o<=m.max.z)continue;let _=0,p=u,g=!0;for(const[y,x,S,C]of[[r,c,m.min.x,m.max.x],[o,l,m.min.z,m.max.z]]){if(Math.abs(x)<1e-9){if(y<S||y>C){g=!1;break}continue}let A=(S-y)/x,b=(C-y)/x;if(A>b){const P=A;A=b,b=P}if(A>_&&(_=A),b<p&&(p=b),_>p){g=!1;break}}if(g)return!0}return!1}groundHeight(){return 0}addInteractable(t){return this.interactables.push(t),t}activeInteractables(){return this.interactables}get isIndoors(){return this.currentBuilding!==null}_updateOccupancy(){var n;const t=(n=this.game.player)==null?void 0:n.position;if(!t)return;let e=null;for(const s of this.enterable){const r=s.interiorBounds;if(r&&t.x>r.minX&&t.x<r.maxX&&t.z>r.minZ&&t.z<r.maxZ&&t.y>s.padY-1.5&&t.y<s.padY+r.maxY){e=s;break}}e!==this.currentBuilding&&(this.currentBuilding=e,this.game.bus.emit("world:occupancy",{building:e}))}update(t){var s;this._updateOccupancy(),this.doors.update(t);const e=this.game.clock;this.game.renderer.updateSky(e.dayFraction,(s=this.game.player)==null?void 0:s.position,e.dayOfYear,t);const n=this.game.renderer.nightFactor>.25;n!==this._nightState&&(this._nightState=n,No().emissiveIntensity=n?.45:0,this.game.bus.emit("world:daynight",{night:n}))}}const S1=.72;class w1{constructor(t){this.game=t,this.target=null,this._label=null,this._fwd=new I(0,0,-1)}update(){var h,u,d,f,m,_;const t=this.game;if(t.mode!==Xe.PLAY){this._setTarget(null);return}if(t.player.vehicle){this._setTarget({label:"get out",action:"vehicle_exit",pos:t.player.position}),t.input.wasPressed("interact")&&t.player.vehicle.dismount();return}const e=t.player.position,n=t.camera.active,s=n.position;n.getWorldDirection(this._fwd);const r=((h=t.shift)==null?void 0:h.station)||null;let o=null,a=1/0;const c=(p,g)=>{var U,N;const y=p.pos.x-e.x,x=p.pos.z-e.z,S=Math.hypot(y,x);if(S>=(p.radius||1.8))return;const C=p.pos.x-s.x,A=p.pos.y-s.y,b=p.pos.z-s.z,P=Math.hypot(C,A,b)||1,D=(C*this._fwd.x+A*this._fwd.y+b*this._fwd.z)/P,v=Math.acos(Math.min(1,Math.max(-1,D)));if(v>S1)return;const w=v+S*.1;w>=a||(N=(U=t.world).sightBlocked)!=null&&N.call(U,e,p.pos,g)||(a=w,o=p)};for(const p of t.world.activeInteractables()){const g=(u=p.data)==null?void 0:u.zone;g&&(g.minZ!==void 0&&e.z<g.minZ||g.maxZ!==void 0&&e.z>g.maxZ||g.minX!==void 0&&e.x<g.minX||g.maxX!==void 0&&e.x>g.maxX)||p.action==="station"&&r||(d=p.data)!=null&&d.podOnly&&r!=="pod"||(f=p.data)!=null&&f.when&&!((m=t.shift)!=null&&m.available(p.data.when,p.data))||c(p,void 0)}const l=(_=t.world.doors)==null?void 0:_.nearest(e,2);l&&!r&&c(l,{backOff:.7}),this._setTarget(o),t.input.wasPressed("interact")&&this.activate()}_setTarget(t){const e=t?t.label:null;this.target===t&&this._label===e||(this.target=t,this._label=e,this.game.bus.emit("interaction:target",{label:e,interactable:t}))}activate(){this.target&&this.run(this.target.action,this.target.data||{})}run(t,e){var s;const n=this.game;switch(t){case"door":{e.door.toggle()||n.ui.toast("You are standing in the doorway.");return}case"station":return void n.shift.lockIn(e.station);case"pod":return void n.shift.podPress(e);case"counter":return void n.shift.counterPress(e);case"service":return void n.shift.servicePress(e);case"vehicle":return void((s=n.deliveryCar)==null?void 0:s.mount());case"note":return void n.ui.toast(e.text);default:console.warn("[interaction] no handler for action:",t,e),n.ui.toast("Nothing happens.")}}}const pe={ORDER_OFFERED:"order:offered",ORDER_STARTED:"order:started",ORDER_STEP:"order:step",ORDER_BUILT:"order:built",ORDER_WRAPPED:"order:wrapped",ORDER_READY:"order:ready",ORDER_BAGGED:"order:bagged",ORDER_TRAY:"order:tray",ORDER_SERVED:"order:served",COUNTER_TAKEN:"counter:order_taken",COUNTER_PAID:"counter:paid",DT_TAKEN:"dt:order_taken",DT_BAGGED:"dt:bagged",DLV_BAGGED:"dlv:bagged",POD_REFUSED:"pod:refused"},Di={bun:{label:"toasted bun",station:"toaster",colour:13210159,shape:"heel"},ketchup:{label:"ketchup",station:"guns",colour:10236968,shape:"smear"},mustard:{label:"mustard",station:"guns",colour:13210159,shape:"smear"},mayo:{label:"mayo",station:"guns",colour:15261904,shape:"smear"},bbq:{label:"BBQ sauce",station:"guns",colour:5913126,shape:"smear"},pickle:{label:"pickles",station:"bins",colour:8030778,shape:"chips"},onion:{label:"onion",station:"bins",colour:15261904,shape:"chips"},lettuce:{label:"lettuce",station:"bins",colour:5208634,shape:"leaf"},tomato:{label:"tomato",station:"bins",colour:10236968,shape:"slice"},cheese:{label:"cheese",station:"bins",colour:13210159,shape:"flat"},patty:{label:"beef patty",station:"uhc",colour:7031349,shape:"disc"},fillet:{label:"chicken fillet",station:"uhc",colour:13216097,shape:"disc"}},Ui={classic:{label:"Barn Classic",value:7.5,sequence:["bun","ketchup","mustard","pickle","onion","patty"]},cheese:{label:"Cheese Barn",value:8,sequence:["bun","ketchup","pickle","cheese","patty"]},smokehouse:{label:"Smokehouse",value:9,sequence:["bun","bbq","onion","cheese","patty"]},garden_chook:{label:"Garden Chook",value:8.5,sequence:["bun","mayo","lettuce","tomato","fillet"]}},tu=Object.keys(Ui),zc={double_patty:{label:"double beef",dupe:"patty",value:2.5},double_fillet:{label:"double chook",dupe:"fillet",value:2.5},extra_cheese:{label:"extra cheese",dupe:"cheese",value:1},extra_pickles:{label:"extra pickles",dupe:"pickle",value:.5},extra_onion:{label:"extra onion",dupe:"onion",value:.5},extra_sauce_bbq:{label:"extra BBQ",dupe:"bbq",value:.5}},E1=Object.keys(zc),Yn={intervalMin:7,intervalJitter:.35,maxLive:4,queueCapacity:3,secondItemChance:.25,sourceMix:{kiosk:.34,counter:.3,drivethru:.21},deliveryHouses:8,laneCapacity:3,modifierChance:.3,dineInChance:.45},eu=[{skin:0,hair:0,height:1,build:1,hairStyle:"short",top:4877194,bottom:3884626},{skin:1,hair:2,height:.94,build:.92,hairStyle:"long",top:9067115,bottom:3027256},{skin:2,hair:4,height:1.05,build:1.12,hairStyle:"short",top:5929554,bottom:4866619},{skin:3,hair:1,height:.98,build:1,hairStyle:"bun",top:11569738,bottom:3884626},{skin:4,hair:6,height:1.02,build:.95,hairStyle:"short",top:7035530,bottom:3027256},{skin:5,hair:3,height:.9,build:.9,hairStyle:"long",top:9071434,bottom:5392702},{skin:1,hair:5,height:1.07,build:1.05,hairStyle:"short",top:4885123,bottom:3884626},{skin:3,hair:7,height:.96,build:1.08,hairStyle:"bun",top:10242626,bottom:3027256}];class b1{constructor({emit:t,rng:e,now:n=0}){this.emit=t,this.rng=e,this.now=n,this.orders=new Map,this._nextId=11,this._nextOfferAt=null,this.stats={offered:0,served:0,balked:0,bySource:{}}}live(){return[...this.orders.values()].filter(t=>t.state!=="served"&&t.state!=="queued"&&t.state!=="ordering"&&t.state!=="driveup").sort((t,e)=>t.id-e.id)}carQueue(){return[...this.orders.values()].filter(t=>t.state==="driveup").sort((t,e)=>t.id-e.id)}all(){return[...this.orders.values()].sort((t,e)=>t.id-e.id)}counterQueue(){return[...this.orders.values()].filter(t=>t.state==="queued").sort((t,e)=>t.id-e.id)}ordering(){return[...this.orders.values()].find(t=>t.state==="ordering")||null}active(){return this.live().find(t=>t.state==="active"||t.state==="building"||t.state==="built"||t.state==="wrapped")||null}ready(){return this.live().filter(t=>t.state==="ready")}readyFor(t){return this.ready().filter(e=>e.service===t&&e.source!=="drivethru")}bagged(){return this.live().filter(t=>t.state==="bagged")}carriedBy(t){return this.live().find(e=>e.state==="carried"&&e.carrier===t)||null}get(t){return this.orders.get(t)||null}offer(t){const e=this.rng.float(),n=Yn.sourceMix,s=e<n.kiosk?"kiosk":e<n.kiosk+n.counter?"counter":e<n.kiosk+n.counter+n.drivethru?"drivethru":"delivery";if(s==="counter"&&this.counterQueue().length>=Yn.queueCapacity)return this.stats.balked+=1,null;if(s==="drivethru"&&this.carQueue().length>=Yn.laneCapacity)return this.stats.balked+=1,null;if((s==="kiosk"||s==="delivery")&&this.live().length>=Yn.maxLive)return this.stats.balked+=1,null;const r=[this.rng.pick(tu)];this.rng.chance(Yn.secondItemChance)&&r.push(this.rng.pick(tu));const o=r.map(u=>{if(!this.rng.chance(Yn.modifierChance))return null;const d=E1.filter(f=>Ui[u].sequence.includes(zc[f].dupe));return d.length?this.rng.pick(d):null}),a=[],c=[];let l=0;r.forEach((u,d)=>{const f=[...Ui[u].sequence],m=o[d]?zc[o[d]]:null;if(m){const _=f.indexOf(m.dupe);f.splice(_+1,0,m.dupe)}a.push(...f),c.push(Ui[u].label+(m?` +${m.label}`:"")),l+=Ui[u].value+((m==null?void 0:m.value)??0)});const h={id:this._nextId++,source:s,items:r,mods:o,itemLabels:c,value:l,sequence:a,step:0,state:s==="counter"?"queued":s==="drivethru"?"driveup":"active",house:s==="delivery"?this.rng.int(0,Yn.deliveryHouses-1):null,look:this.rng.int(0,7),service:s==="drivethru"?"takeaway":this.rng.chance(Yn.dineInChance)?"dinein":"takeaway",carrier:null,offeredAt:t,takenAt:null,takenBy:null,servedBy:null,builtAt:null,wrappedAt:null,readyAt:null,baggedAt:null,carriedAt:null,servedAt:null};return this.orders.set(h.id,h),this.stats.offered+=1,this.stats.bySource[s]=(this.stats.bySource[s]||0)+1,this.emit(pe.ORDER_OFFERED,{id:h.id,source:s,items:[...r],sequence:[...a]}),h}takeOrder(t,e="player"){if(this.ordering())return{ok:!1,reason:"already_taking"};const n=this.counterQueue()[0];return n?(n.state="ordering",n.takenBy=e,this.emit(pe.COUNTER_TAKEN,{id:n.id,items:[...n.items],total:n.value,by:e}),{ok:!0,id:n.id}):{ok:!1,reason:"nothing_queued"}}takePayment(t,e="player"){const n=this.ordering();return n?(n.state="active",n.takenAt=t,this.emit(pe.COUNTER_PAID,{id:n.id,total:n.value,by:e}),{ok:!0,id:n.id}):{ok:!1,reason:"nothing_to_pay"}}serve(t,e,n="player",s=["ready"]){return!t||!s.includes(t.state)?!1:(t.state="served",t.servedAt=e,t.servedBy=n,this.stats.served+=1,this.emit(pe.ORDER_SERVED,{id:t.id,ageMin:+(e-(t.takenAt??t.offeredAt)).toFixed(2)}),!0)}bagOrder(t,e="player"){const n=this.readyFor("takeaway")[0];return n?(n.state="bagged",n.baggedAt=t,this.emit(pe.ORDER_BAGGED,{id:n.id,by:e}),{ok:!0,id:n.id}):{ok:!1,reason:"nothing_to_bag"}}collect(t,e,n="customer"){const s=this.orders.get(t);return!s||s.state!=="bagged"?{ok:!1,reason:"not_bagged"}:(this.serve(s,e,n,["bagged"]),{ok:!0,id:s.id})}trayUp(t,e="player"){if(this.carriedBy(e))return{ok:!1,reason:"already_carrying"};const n=this.readyFor("dinein")[0];return n?(n.state="carried",n.carrier=e,n.carriedAt=t,this.emit(pe.ORDER_TRAY,{id:n.id,by:e}),{ok:!0,id:n.id}):{ok:!1,reason:"nothing_to_tray"}}deliver(t,e="player"){const n=this.carriedBy(e);return n?(this.serve(n,t,e,["carried"]),{ok:!0,id:n.id}):{ok:!1,reason:"not_carrying"}}dtTakeOrder(t,e="player"){const n=this.carQueue()[0];return n?(n.state="active",n.takenAt=t,n.takenBy=e,this.emit(pe.DT_TAKEN,{id:n.id,items:[...n.items],total:n.value,by:e}),{ok:!0,id:n.id}):{ok:!1,reason:"no_car_waiting"}}dtBagUp(t,e="player"){if(this.carriedBy(e))return{ok:!1,reason:"already_carrying"};const n=this.ready().find(s=>s.source==="drivethru");return n?(n.state="carried",n.carrier=e,n.carriedAt=t,this.emit(pe.DT_BAGGED,{id:n.id,by:e}),{ok:!0,id:n.id}):{ok:!1,reason:"nothing_for_the_window"}}dlvBagUp(t,e="player"){if(this.carriedBy(e))return{ok:!1,reason:"already_carrying"};const n=this.ready().find(s=>s.source==="delivery");return n?(n.state="carried",n.carrier=e,n.carriedAt=t,this.emit(pe.DLV_BAGGED,{id:n.id,house:n.house,by:e}),{ok:!0,id:n.id}):{ok:!1,reason:"nothing_to_run"}}_interval(){const t=1+this.rng.range(-.35,Yn.intervalJitter);return Yn.intervalMin*t}tick(t){this.now=t,this._nextOfferAt===null&&(this._nextOfferAt=t+this._interval());let e=0;for(;t>=this._nextOfferAt&&e++<16;)this.offer(this._nextOfferAt),this._nextOfferAt+=this._interval();for(const n of this.orders.values())n.state==="served"&&t-n.servedAt>10&&this.orders.delete(n.id)}serialize(){return{nextId:this._nextId,nextOfferAt:this._nextOfferAt,stats:{...this.stats,bySource:{...this.stats.bySource}},orders:[...this.orders.values()]}}load(t){var e;t&&(this._nextId=t.nextId,this._nextOfferAt=t.nextOfferAt??null,this.stats={...t.stats,bySource:{...((e=t.stats)==null?void 0:e.bySource)||{}}},this.orders=new Map(t.orders.map(n=>[n.id,{...n}])))}}const qe={NO_ORDER:"no_order",NOT_NEXT:"not_next",NOT_AT_UHC:"not_at_uhc",ALREADY_BUILT:"already_built",NOT_BUILT:"not_built",NOT_WRAPPED:"not_wrapped"};class T1{constructor({queue:t,emit:e}){this.queue=t,this.emit=e}nextToken(){const t=this.queue.active();return!t||t.step>=t.sequence.length?null:t.sequence[t.step]}_refuse(t,e=null){return this.emit(pe.POD_REFUSED,{reason:t,token:e,next:this.nextToken()}),{ok:!1,reason:t}}addToken(t,e,n="player"){const s=this.queue.active();if(!s)return this._refuse(qe.NO_ORDER,t);if(s.state==="built"||s.state==="wrapped")return this._refuse(qe.ALREADY_BUILT,t);const r=s.sequence[s.step];return t!==r?this._refuse(qe.NOT_NEXT,t):(s.step+=1,s.state==="active"&&(s.state="building",this.emit(pe.ORDER_STARTED,{id:s.id})),this.emit(pe.ORDER_STEP,{id:s.id,added:t,next:s.sequence[s.step]??null,step:s.step}),s.step>=s.sequence.length&&(s.state="built",s.builtAt=e,this.emit(pe.ORDER_BUILT,{id:s.id})),{ok:!0,added:t})}pullFromUHC(t,e="player"){var s;const n=this.nextToken();if(n===null){const r=this.queue.active();return this._refuse(r?qe.ALREADY_BUILT:qe.NO_ORDER)}return((s=Di[n])==null?void 0:s.station)!=="uhc"?this._refuse(qe.NOT_AT_UHC):this.addToken(n,t,e)}wrap(t,e="player"){const n=this.queue.active();return n?n.state!=="built"?this._refuse(n.state==="wrapped"?qe.ALREADY_BUILT:qe.NOT_BUILT):(n.state="wrapped",n.wrappedAt=t,this.emit(pe.ORDER_WRAPPED,{id:n.id}),{ok:!0}):this._refuse(qe.NO_ORDER)}send(t,e="player"){const n=this.queue.active();return n?n.state!=="wrapped"?this._refuse(qe.NOT_WRAPPED):(n.state="ready",n.readyAt=t,this.emit(pe.ORDER_READY,{id:n.id}),{ok:!0}):this._refuse(qe.NO_ORDER)}}const Is=class Is{constructor({rng:t,bus:e=null}){this.bus=e,this.minute=0,this.log=[],this.logSeq=0,this.rev=0,this.netRole="solo";const n=(s,r)=>this._emit(s,r);this.orders=new b1({emit:n,rng:t.child("orders")}),this.pod=new T1({queue:this.orders,emit:n})}_emit(t,e={}){this.logSeq+=1,this.rev+=1,this.log.push({type:t,payload:e,minute:+this.minute.toFixed(3),seq:this.logSeq}),this.log.length>600&&this.log.shift(),this.bus&&this.bus.emit(t,e)}tick(t){this.netRole!=="guest"&&(t<=0||(this.minute+=t,this.orders.tick(this.minute)))}addToken(t,e="player"){return this.pod.addToken(t,this.minute,e)}pullFromUHC(t="player"){return this.pod.pullFromUHC(this.minute,t)}wrap(t="player"){return this.pod.wrap(this.minute,t)}send(t="player"){return this.pod.send(this.minute,t)}takeOrder(t="player"){return this.orders.takeOrder(this.minute,t)}takePayment(t="player"){return this.orders.takePayment(this.minute,t)}bagOrder(t="player"){return this.orders.bagOrder(this.minute,t)}trayUp(t="player"){return this.orders.trayUp(this.minute,t)}deliver(t="player"){return this.orders.deliver(this.minute,t)}collect(t,e="customer"){return this.orders.collect(t,this.minute,e)}dtTakeOrder(t="player"){return this.orders.dtTakeOrder(this.minute,t)}dtBagUp(t="player"){return this.orders.dtBagUp(this.minute,t)}dlvBagUp(t="player"){return this.orders.dlvBagUp(this.minute,t)}applyNet(t,e=[],n="guest"){if(!Object.hasOwn(Is.NET_COMMANDS,t))return{ok:!1,reason:"unknown_command"};const s=Is.NET_COMMANDS[t];return!Array.isArray(e)||e.length<s.n?{ok:!1,reason:"bad_args"}:Is.prototype[s.m].apply(this,[...e.slice(0,s.n),n])}snapshot(){var t;return{minute:this.minute,board:this.orders.live(),queue:this.orders.counterQueue(),ordering:this.orders.ordering(),activeId:((t=this.orders.active())==null?void 0:t.id)??null,nextToken:this.pod.nextToken(),readyCount:this.orders.ready().length,stats:{...this.orders.stats}}}serialize(){return{minute:this.minute,orders:this.orders.serialize()}}load(t){t&&(this.minute=t.minute||0,this.orders.load(t.orders))}};Ml(Is,"NET_COMMANDS",{token:{m:"addToken",n:1},uhc:{m:"pullFromUHC",n:0},wrap:{m:"wrap",n:0},send:{m:"send",n:0},take_order:{m:"takeOrder",n:0},take_payment:{m:"takePayment",n:0},bag:{m:"bagOrder",n:0},tray:{m:"trayUp",n:0},deliver:{m:"deliver",n:0},collect:{m:"collect",n:1},dt_take:{m:"dtTakeOrder",n:0},dt_bag:{m:"dtBagUp",n:0},dlv_bag:{m:"dlvBagUp",n:0}});let kc=Is;const bs=560,nu=340,Ca=68,Pa=4,iu="#f1ece1",ro="#9aa3ad",oo="#c9a961",ao="#0d1116",A1="#141a21",R1="#1d2733",La="#7fb069",C1="#cf5b45";class P1{constructor(t,e,n,s){this.scene=t,this.canvas=typeof document<"u"?document.createElement("canvas"):null,this.canvas&&(this.canvas.width=bs,this.canvas.height=nu,this.ctx=this.canvas.getContext("2d"),this.tex=new Vn(this.canvas),this.tex.colorSpace=Le,this.tex.anisotropy=4,this.mesh=new ut(new Be(s.w,s.h),new Gn({map:this.tex})),this.mesh.position.set(e.x,e.y,e.z),this.mesh.rotation.x=n,t.add(this.mesh),this._sig=null,this.paint([],null,null,{},{},0))}paint(t,e,n,s,r,o){if(!this.ctx)return;const a=t.slice(0,Pa),c=u=>u.takenAt??u.offeredAt,l=`${e}|${n}|`+a.map(u=>`${u.id}:${u.state}:${u.step}:${u.source}:${Math.floor(o-c(u))}`).join(",");if(l===this._sig)return;this._sig=l;const h=this.ctx;if(h.fillStyle=ao,h.fillRect(0,0,bs,nu),h.fillStyle=oo,h.font="bold 32px Segoe UI, system-ui, sans-serif",h.fillText("ORDERS",16,36),t.length>Pa&&(h.fillStyle=ro,h.font="22px Segoe UI, system-ui, sans-serif",h.textAlign="right",h.fillText(`+${t.length-Pa} more`,bs-16,34),h.textAlign="left"),!a.length){h.fillStyle=ro,h.font="28px Segoe UI, system-ui, sans-serif",h.fillText("Nothing on.",16,100),this.tex.needsUpdate=!0;return}a.forEach((u,d)=>{var S;const f=48+d*Ca,m=u.id===e;h.fillStyle=m?R1:A1,h.fillRect(10,f,bs-20,Ca-8),m&&(h.fillStyle=oo,h.fillRect(10,f,6,Ca-8)),h.fillStyle=m?iu:ro,h.font="bold 31px Segoe UI, system-ui, sans-serif",h.fillText(`#${u.id}`,22,f+30);let _=92;u.source==="drivethru"?(h.fillStyle=C1,h.fillRect(_,f+8,50,26),h.fillStyle=ao,h.font="bold 20px Segoe UI, system-ui, sans-serif",h.fillText("DT",_+12,f+28),_+=60):u.source==="delivery"?(h.fillStyle="#4a7dc9",h.fillRect(_,f+8,52,26),h.fillStyle=ao,h.font="bold 20px Segoe UI, system-ui, sans-serif",h.fillText("DLV",_+8,f+28),_+=62):u.service==="dinein"&&(h.fillStyle=La,h.fillRect(_,f+8,62,26),h.fillStyle=ao,h.font="bold 20px Segoe UI, system-ui, sans-serif",h.fillText("DINE",_+8,f+28),_+=72),h.fillStyle=m?iu:ro,h.font="25px Segoe UI, system-ui, sans-serif";const p=(u.itemLabels||(u.items||[]).map(C=>{var A;return((A=r[C])==null?void 0:A.label)||C})).join(", ");if(h.fillText(p.slice(0,u.source==="drivethru"?24:28),_,f+30),h.font="23px Segoe UI, system-ui, sans-serif",m){h.fillStyle=La;const C=u.state==="built"?"wrap it":u.state==="wrapped"?"send it down":n?`next: ${((S=s[n])==null?void 0:S.label)||n}`:"…";h.fillText(C,92,f+57)}else{h.fillStyle=u.state==="ready"||u.state==="bagged"||u.state==="carried"?oo:"#5d6570";const C=Math.floor(o-c(u));h.fillText(u.state==="ready"?"at the landing":u.state==="bagged"?"on the counter":u.state==="carried"?u.source==="drivethru"?"going to the window":u.source==="delivery"?"out for delivery":"going to the table":C<1?"just in":`waiting ${C}m`,92,f+57)}const g=(u.sequence||[]).length||1,y=u.state==="ready"||u.state==="wrapped"||u.state==="built"||u.state==="bagged"||u.state==="carried",x=y?1:Math.min(1,(u.step||0)/g);h.fillStyle="#2a333d",h.fillRect(bs-104,f+20,84,10),h.fillStyle=y&&u.state!=="built"?oo:La,h.fillRect(bs-104,f+20,84*x,10)}),this.tex.needsUpdate=!0}dispose(){this.mesh&&(this.scene.remove(this.mesh),this.mesh.geometry.dispose(),this.mesh.material.map.dispose(),this.mesh.material.dispose(),this.mesh=null)}}const Bc="#f1ece1",To="#9aa3ad",Hc="#c9a961",yd="#0d1116",su="#7fb069";function Md(i,t,e,n,s){const r=document.createElement("canvas");r.width=n,r.height=s;const o=new Vn(r);o.colorSpace=Le,o.anisotropy=4;const a=new ut(new Be(e.w,e.h),new Gn({map:o}));return a.position.set(t.x,t.y,t.z),a.rotation.y=t.rotY||0,i.add(a),{canvas:r,tex:o,mesh:a,ctx:r.getContext("2d")}}class L1{constructor(t,e){typeof document>"u"||(this.face=Md(t,e,{w:e.w,h:e.h},320,235),this._sig=null)}paint(t,e,n,s,r){if(!this.face)return;const o=n&&s-n.atMin<2,a=t?`t${t.id}:${(t.itemLabels||t.items).join("+")}`:o?`p${n.id}`:`q${e}`;if(a===this._sig)return;this._sig=a;const c=this.face.ctx,l=320,h=235;if(c.fillStyle=yd,c.fillRect(0,0,l,h),c.fillStyle=Hc,c.font="bold 26px Segoe UI, system-ui, sans-serif",c.fillText("TILL",14,32),t){c.fillStyle=Bc,c.font="bold 28px Segoe UI, system-ui, sans-serif",c.fillText(`#${t.id}`,240,32),c.font="24px Segoe UI, system-ui, sans-serif";let u=70;t.items.forEach((d,f)=>{var _;const m=r[d];c.fillStyle=Bc,c.fillText((((_=t.itemLabels)==null?void 0:_[f])||(m==null?void 0:m.label)||d).slice(0,24),14,u),u+=34}),c.strokeStyle="#2a333d",c.beginPath(),c.moveTo(14,u-12),c.lineTo(l-14,u-12),c.stroke(),c.fillStyle=Hc,c.font="bold 28px Segoe UI, system-ui, sans-serif",c.fillText("TOTAL",14,u+18),c.textAlign="right",c.fillText(`$${t.value.toFixed(2)}`,l-14,u+18),c.textAlign="left",c.fillStyle=su,c.font="24px Segoe UI, system-ui, sans-serif",c.fillText("take payment",14,h-14)}else o?(c.fillStyle=su,c.font="bold 42px Segoe UI, system-ui, sans-serif",c.fillText("PAID",14,104),c.fillText(`$${n.total.toFixed(2)}`,14,140),c.fillStyle=To,c.font="24px Segoe UI, system-ui, sans-serif",c.fillText(`#${n.id} to the kitchen`,14,184)):(c.fillStyle=To,c.font="28px Segoe UI, system-ui, sans-serif",c.fillText(e===0?"No one waiting.":e===1?"1 in line.":`${e} in line.`,14,100));this.face.tex.needsUpdate=!0}}class I1{constructor(t,e){typeof document>"u"||(this.face=Md(t,e,{w:e.w,h:e.h},500,275),this._sig=null)}paint(t){if(!this.face)return;const e=t.filter(h=>h.source!=="drivethru"&&h.source!=="delivery"),n=e.filter(h=>h.state!=="bagged"&&h.state!=="carried").map(h=>h.id),s=e.filter(h=>h.state==="bagged").map(h=>h.id),r=n.join(",")+"|"+s.join(",");if(r===this._sig)return;this._sig=r;const o=this.face.ctx,a=500,c=275;o.fillStyle=yd,o.fillRect(0,0,a,c),o.strokeStyle="#2a333d",o.beginPath(),o.moveTo(a/2,12),o.lineTo(a/2,c-12),o.stroke(),o.font="bold 30px Segoe UI, system-ui, sans-serif",o.fillStyle=To,o.fillText("PREPARING",24,38),o.fillStyle=Hc,o.fillText("READY",a/2+24,38),o.font="bold 58px Segoe UI, system-ui, sans-serif";const l=(h,u,d)=>{o.fillStyle=d,h.slice(0,6).forEach((f,m)=>{o.fillText(`${f}`,u+m%2*118,104+Math.floor(m/2)*72)})};l(n,34,To),l(s,a/2+34,Bc),this.face.tex.needsUpdate=!0}}const D1=2.6,U1=4;class N1{constructor(t){var n;this.game=t,this.rules=new kc({rng:t.rng.child("shift"),bus:t.bus}),this.station=null;const e=t.renderer.scene;this.screen=new P1(e,Jr,Jr.tilt,{w:Jr.w,h:Jr.h}),this.till=new L1(e,{x:Wh.x,...Wh.screen}),this.readyBoard=new I1(e,i1),this._lastPaid=null,t.bus.on(pe.COUNTER_PAID,({id:s,total:r})=>{this._lastPaid={id:s,total:r,atMin:this.rules.minute}}),this._buildLandingPool(e),this._buildBagPool(e),this._wireToasts();for(const s of t.world.activeInteractables()){const r=(n=s.data)==null?void 0:n.token;r&&!Di[r]&&console.error("ShiftSystem: interactable",s.id,"dispenses a token the menu does not know:",r)}}available(t,e={}){var s,r,o,a,c;const n=this.rules.orders;switch(t){case"dt_order":{const l=n.carQueue()[0];return!!l&&(((s=this.game.cars)==null?void 0:s.atOrderWindow(l.id))??!1)}case"dt_bag_ready":return!this.game.player.isBusy&&!n.carriedBy("player")&&n.ready().some(l=>l.source==="drivethru");case"window_handout":{const l=n.carriedBy("player");return!!l&&l.source==="drivethru"&&(((r=this.game.cars)==null?void 0:r.atPickup(l.id))??!1)}case"dlv_bag_ready":return!this.game.player.isBusy&&!n.carriedBy("player")&&n.ready().some(l=>l.source==="delivery");case"at_house":{const l=n.carriedBy("player");return!!l&&l.source==="delivery"&&l.house===e.house}case"queue_head":{if(this.station!=="counter"||n.ordering())return!1;const l=n.counterQueue()[0];return!!l&&(((o=this.game.customers)==null?void 0:o.atTill(l.id))??!0)}case"payment_due":return this.station==="counter"&&!!n.ordering();case"bag_ready":return n.readyFor("takeaway").length>0;case"tray_ready":{if(this.game.player.isBusy||n.carriedBy("player"))return!1;const l=n.readyFor("dinein")[0];return!!l&&((a=this.game.customers)==null?void 0:a.seatedTable(l.id))!=null}case"carrying_for":{const l=n.carriedBy("player");return!!l&&((c=this.game.customers)==null?void 0:c.tableOf(l.id))===e.table}default:return!1}}servicePress(t){var n,s,r;const e=this.game.ui;if(t.op==="tray"){const o=this.rules.trayUp();if(o.ok){const a=(n=this.game.customers)==null?void 0:n.tableOf(o.id);e.toast(`#${o.id} on the tray — table ${a??"?"}.`,4200)}else e.toast("Nothing ready for a tray.")}else if(t.op==="bag"){const o=this.rules.bagOrder();o.ok?e.toast(`#${o.id} bagged — their number is up.`):e.toast("Nothing ready to bag.")}else if(t.op==="dt_take"){const o=this.rules.dtTakeOrder();o.ok?e.toast(`#${o.id} — drive-thru order on the board.`):e.toast("No car at the window.")}else if(t.op==="dt_bag"){const o=this.rules.dtBagUp();o.ok?e.toast(`#${o.id} in the bag — pickup window.`,4200):e.toast("Nothing for the window.")}else if(t.op==="dlv_bag"){const o=this.rules.dlvBagUp();if(o.ok){const a=((r=bo[(s=this.rules.orders.get(o.id))==null?void 0:s.house])==null?void 0:r.name)??"the address";e.toast(`#${o.id} for ${a} — the van's at the goods door.`,5200)}else e.toast("No deliveries waiting.")}else t.op==="deliver"&&(this.rules.deliver().ok||e.toast("You are not carrying anything."))}lockIn(t){if(t==="pod")return this._lockPod();if(t==="counter")return this._lockCounter();this.game.ui.toast("Nothing to work there yet.")}_lockPod(){const t=this.game.player;t.position.z<Nn.z-.75||(this.station="pod",t.setState("busy"),t.position.x=pn.clamp(t.position.x,Nn.x0,Nn.x1),t.position.z=Nn.z,t.position.y=0,t.velocity.set(0,0,0),t.facing=Nn.facing,this.game.camera.yaw=Nn.facing,this.game.ui.toast("On the pod. A/D to slide along, S to step off.",5200),this.game.bus.emit("shift:station",{station:"pod"}))}_lockCounter(){const t=this.game.player;t.position.z>Yi.z+.75||(this.station="counter",t.setState("busy"),t.position.x=Yi.x,t.position.z=Yi.z,t.position.y=0,t.velocity.set(0,0,0),t.facing=Yi.facing,this.game.camera.yaw=Yi.facing,this.game.ui.toast("On the till. S to step off.",5200),this.game.bus.emit("shift:station",{station:"counter"}))}release(){this.station&&(this.station=null,this.game.player.setState("normal"),this.game.bus.emit("shift:station",{station:null}))}podPress(t){this.station==="pod"&&(t.op==="uhc"?this.rules.pullFromUHC():t.op==="wrap"?this.rules.wrap():t.op==="send"?this.rules.send():this.rules.addToken(t.token))}counterPress(t){if(this.station!=="counter")return;(t.op==="take_payment"?this.rules.takePayment():this.rules.takeOrder()).ok||this.game.ui.toast("Not right now.")}update(t){var c,l,h,u;const e=this.game;e.mode===Xe.PLAY&&(this.rules.tick(t*e.clock.scale),this.station==="pod"?this._slide(t):this.station==="counter"&&this._pin(t));const n=this.rules.orders,s=n.live();(l=this.screen)==null||l.paint(s,((c=n.active())==null?void 0:c.id)??null,this.rules.pod.nextToken(),Di,Ui,this.rules.minute),(h=this.till)==null||h.paint(n.ordering(),n.counterQueue().length,this._lastPaid,this.rules.minute,Ui),(u=this.readyBoard)==null||u.paint(s),this._syncLanding(),this._syncBags();const r=n.carriedBy("player"),o=r&&r.source!=="kiosk"&&r.source!=="counter"?r.source:null,a=!!this.game.player.vehicle;this.game.player.avatar.setHeld(r&&!a?[{id:(o?"bag":"tray")+r.id,shape:o?"bag":"tray",colour:o?14272934:11026479}]:[]),this._syncReceipt(r&&!a?r:null)}_syncReceipt(t){var r,o,a,c;if(!t){(r=this._receipt)!=null&&r.mesh.parent&&this._receipt.mesh.parent.remove(this._receipt.mesh);return}if(!this._receipt){const l=document.createElement("canvas");l.width=80,l.height=64;const h=new Vn(l);h.colorSpace=Le;const u=new ut(new Be(.085,.068),new Gn({map:h,transparent:!0,side:zn}));u.position.set(-.1,.05,-.06),u.rotation.y=Math.PI,u.rotation.x=.28,this._receipt={canvas:l,tex:h,mesh:u,sig:null}}const e=(o=this.game.customers)==null?void 0:o.tableOf(t.id),n=`${t.id}:${e}`;if(n!==this._receipt.sig){this._receipt.sig=n;const l=this._receipt.canvas.getContext("2d");l.clearRect(0,0,80,64),l.fillStyle="#f4efe4",l.fillRect(2,2,76,60),l.fillStyle="#20262e",l.textAlign="center",l.font="bold 26px Segoe UI, system-ui, sans-serif",l.fillText("#"+t.id,40,28),l.font="bold 20px Segoe UI, system-ui, sans-serif";const h=t.source==="drivethru"?"WINDOW":t.source==="delivery"?(((a=bo[t.house])==null?void 0:a.name)??"DELIVERY").toUpperCase().slice(0,14):e!=null?"TABLE "+e:"";l.font=t.source==="delivery"?"bold 13px Segoe UI, system-ui, sans-serif":"bold 20px Segoe UI, system-ui, sans-serif",l.fillText(h,40,52),this._receipt.tex.needsUpdate=!0}const s=(c=this.game.player.avatar._held)==null?void 0:c[0];s&&this._receipt.mesh.parent!==s&&s.add(this._receipt.mesh)}_buildBagPool(t){this._bags=[];const e=new Li({color:14272934}),n=new Li({color:11026479});for(let s=0;s<3;s++){const r=new Qt,o=new ut(new Vt(.16,.21,.1),e);o.castShadow=!0;const a=new ut(new Vt(.165,.035,.05),e);a.position.y=.12;const c=new ut(new Vt(.162,.03,.102),n);c.position.y=.02,r.add(o,a,c),r.position.set(-5.85+s*.65,1.075+.105,1.95),r.rotation.y=(s%2?-1:1)*.18,r.visible=!1,t.add(r),this._bags.push(r)}}_syncBags(){const t=this.rules.orders.bagged();for(let e=0;e<this._bags.length;e++)this._bags[e].visible=e<t.length}_pin(){const t=this.game.player;t.position.x=Yi.x,t.position.z=Yi.z,t.position.y=0,this.game.input.axis().y<-.5&&this.release()}_slide(t){const e=this.game.player;e.position.x=pn.clamp(e.position.x,Nn.x0,Nn.x1),e.position.z=Nn.z,e.position.y=0;const s=this.game.input.axis();if(s.y<-.5){this.release();return}if(s.x!==0){const r=this.game.camera.basis().right,o=Math.sign(r.x)||1;e.position.x=pn.clamp(e.position.x+s.x*o*D1*t,Nn.x0,Nn.x1)}}_buildLandingPool(t){this._landing=[];const e=new Li({color:15262418}),n=new Li({color:11026479}),s=new Vt(.115,.055,.115),r=new Vt(.118,.016,.05);for(let o=0;o<U1;o++){const a=new Qt,c=new ut(s,e);c.castShadow=!0;const l=new ut(r,n);l.position.y=.02,a.add(c,l);const h=document.createElement("canvas");h.width=64,h.height=32;const u=new Vn(h);u.colorSpace=Le;const d=new ut(new Be(.075,.0375),new Gn({map:u,transparent:!0}));d.rotation.x=-Math.PI/2+.35,d.position.set(0,.032,.035),a.add(d);const f=Fs.x0+.22+o*.42;a.position.set(f,Fs.y+.03,Fs.z),a.rotation.y=(o%2?-1:1)*.22,a.visible=!1,t.add(a),this._landing.push({g:a,canvas:h,tex:u,shownId:null})}}_stencil(t,e){if(t.shownId===e)return;t.shownId=e;const n=t.canvas.getContext("2d");n.clearRect(0,0,64,32),n.fillStyle="#3a3126",n.font="bold 24px Segoe UI, system-ui, sans-serif",n.textAlign="center",n.textBaseline="middle",n.fillText("#"+e,32,17),t.tex.needsUpdate=!0}_syncLanding(){var n;const t=this.rules.orders.ready(),e=((n=this.game.buildBoard)==null?void 0:n.slidingId)??null;for(let s=0;s<this._landing.length;s++){const r=this._landing[s],o=t[s];r.g.visible=!!o&&o.id!==e,o&&this._stencil(r,o.id)}}_wireToasts(){const t=this.game.bus,e={toast:s=>{var r;return(r=this.game.ui)==null?void 0:r.toast(s)}},n=s=>{const r=Di[s];return r?r.station==="toaster"||r.station==="uhc"?"a "+r.label:r.label:s};t.on(pe.POD_REFUSED,({reason:s,next:r})=>{switch(s){case qe.NO_ORDER:return e.toast("Nothing on the board.");case qe.NOT_NEXT:case qe.NOT_AT_UHC:return e.toast(`It wants ${n(r)} next.`);case qe.ALREADY_BUILT:return e.toast("It has everything it needs.");case qe.NOT_BUILT:return e.toast("It is not built yet.");case qe.NOT_WRAPPED:return e.toast("Wrap it before it goes down.");default:return e.toast("Not now.")}}),t.on(pe.ORDER_SERVED,({id:s})=>e.toast(`#${s} away.`))}}const Ia={};function ue(i,t){return Ia[i]||(Ia[i]=t())}const de=(i,t={})=>new Li({color:i,...t});function O1(i){const t=new Qt,e=new ut(ue("cup",()=>new De(.043,.032,.135,10)),de(i));e.castShadow=!0;const n=new ut(ue("cupLid",()=>new De(.047,.047,.016,10)),de(14173231));n.position.y=.075;const s=new ut(ue("straw",()=>new De(.005,.005,.1,5)),de(15790836));return s.position.set(.012,.13,0),s.rotation.z=.18,t.add(e,n,s),t}function F1(i){const t=new ut(ue("bun",()=>new Fi(.056,10,6,0,Math.PI*2,0,Math.PI/2)),de(i));return t.scale.y=.62,t.castShadow=!0,t}function z1(i){const t=new ut(ue("heel",()=>new De(.054,.05,.02,12)),de(i));return t.castShadow=!0,t}function k1(i){const t=new ut(ue("chip",()=>new De(.021,.021,.008,8)),de(i));return t.castShadow=!0,t}function B1(i){const t=new ut(ue("disc",()=>new De(.052,.052,.018,12)),de(i));return t.castShadow=!0,t}function H1(i){const t=new ut(ue("flat",()=>new Vt(.082,.006,.082)),de(i));return t.castShadow=!0,t}function G1(i){const t=new ut(ue("blob",()=>new Uo(.036,0)),de(i));return t.castShadow=!0,t}function V1(i){const t=new Qt,e=new ut(ue("bottle",()=>new De(.024,.028,.105,8)),de(i));e.castShadow=!0;const n=new ut(ue("bottleCap",()=>new Io(.017,.036,8)),de(2896184));return n.position.y=.068,t.add(e,n),t}function W1(i){const t=new Qt,e=new ut(ue("carton",()=>new De(.04,.026,.09,4)),de(14173231));e.rotation.y=Math.PI/4,e.castShadow=!0;const n=new ut(ue("chipTop",()=>new De(.03,.03,.05,6)),de(i));return n.position.y=.055,t.add(e,n),t}function q1(i){const t=new Qt,e=new ut(ue("bag",()=>new Vt(.1,.135,.062)),de(i));e.castShadow=!0;const n=new ut(ue("bagFold",()=>new Vt(.104,.022,.03)),de(i));return n.position.y=.076,t.add(e,n),t}function X1(i){const t=new Qt,e=new ut(ue("box",()=>new Vt(.125,.075,.105)),de(i));e.castShadow=!0;const n=new ut(ue("boxTape",()=>new Vt(.128,.004,.022)),de(15262418));return n.position.y=.039,t.add(e,n),t}function Y1(i){const t=new Qt,e=new ut(ue("trayBase",()=>new Vt(.34,.014,.25)),de(i));e.castShadow=!0;const n=new ut(ue("trayRim",()=>new Vt(.36,.022,.27)),de(i));n.position.y=.004;const s=new ut(ue("trayParcel",()=>new Vt(.115,.055,.115)),de(15262418));s.position.set(.04,.045,.01),s.rotation.y=.3,s.castShadow=!0;const r=new ut(ue("trayBand",()=>new Vt(.118,.016,.05)),de(11026479));return r.position.set(.04,.062,.01),r.rotation.y=.3,t.add(e,n,s,r),t}function j1(i){const t=new Qt,e=new ut(ue("shaft",()=>new De(.016,.016,1.15,6)),de(i));e.castShadow=!0;const n=new ut(ue("mopHead",()=>new Vt(.115,.1,.055)),de(14341056));return n.position.y=-.6,t.add(e,n),t}function K1(i){const t=new Qt,e=new ut(ue("sprayBody",()=>new Vt(.055,.115,.045)),de(i));e.castShadow=!0;const n=new ut(ue("sprayNeck",()=>new Vt(.028,.05,.028)),de(2896184));n.position.y=.082;const s=new ut(ue("sprayTrigger",()=>new Vt(.05,.022,.022)),de(2896184));s.position.set(.032,.068,0);const r=new ut(ue("cloth",()=>new Vt(.075,.018,.06)),de(7317704));return r.position.y=-.075,t.add(e,n,s,r),t}const $1={cup:O1,bun:F1,heel:z1,chip:k1,disc:B1,flat:H1,blob:G1,bottle:V1,carton:W1,bag:q1,box:X1,tray:Y1,mop:j1,spray:K1};function Z1(i){const t=new ut(ue("fallback",()=>new Vt(.075,.055,.075)),de(i));return t.castShadow=!0,t}function Kn(i,t=13421772){return($1[i]||Z1)(t)}function J1(i){return i==="mop"}const dn=(i,t,e,n)=>{const s=new ut(new Vt(i,t,e),ke(n));return s.castShadow=!0,s.receiveShadow=!0,s};class Sd{constructor(t={}){const{skin:e=ie.skinTones[0],hair:n=ie.hairTones[0],height:s=1,build:r=1,hairStyle:o="short"}=t;this.group=new Qt,this.scale=s,this.opts={skin:e,hair:n,height:s,build:r,hairStyle:o};const a=s,c=.44*r,l=.24*r;this.hips=new Qt,this.hips.position.y=.84*a,this.group.add(this.hips),this.torso=dn(c,.58*a,l,14209734),this.torso.position.y=.29*a,this.hips.add(this.torso),this.neck=dn(.14*a,.08*a,.14*a,e),this.neck.position.y=.62*a,this.hips.add(this.neck),this.head=new Qt,this.head.position.y=.66*a,this.hips.add(this.head);const h=dn(.26*a,.3*a,.25*a,e);h.position.y=.15*a,this.head.add(h),this.skull=h,this.hair=new Qt;const u=o==="long"?.2:.1,d=dn(.28*a,u*a,.27*a,n);if(d.position.y=(.3-u/2+.005)*a,this.hair.add(d),o==="long"){const f=dn(.26*a,.26*a,.1*a,n);f.position.set(0,.12*a,-.14*a),this.hair.add(f)}if(o==="bun"){const f=new ut(new Fi(.08*a,8,6),ke(n));f.position.set(0,.3*a,-.14*a),f.castShadow=!0,this.hair.add(f)}this.head.add(this.hair);for(const f of[-.06,.06]){const m=dn(.045*a,.045*a,.02*a,1973016);m.position.set(f*a,.17*a,.13*a),this.head.add(m)}this.arms={};for(const f of["left","right"]){const m=new Qt;m.position.set((f==="left"?-1:1)*(c/2+.055*a),.54*a,0);const _=dn(.11*a,.5*a,.12*a,14209734);_.position.y=-.25*a,m.add(_);const p=dn(.1*a,.1*a,.11*a,e);p.position.y=-.54*a,m.add(p);const g=new Qt;g.position.y=-.6*a,m.add(g),this.hips.add(m),this.arms[f]={pivot:m,upper:_,hand:p,grip:g}}this.legs={};for(const f of["left","right"]){const m=new Qt;m.position.set((f==="left"?-1:1)*.11*a,0,0);const _=dn(.15*a,.78*a,.16*a,3884626);_.position.y=-.39*a,m.add(_);const p=dn(.17*a,.1*a,.24*a,2764083);p.position.set(0,-.82*a,.03*a),m.add(p),this.hips.add(m),this.legs[f]={pivot:m,leg:_,shoe:p}}this.bag=null,this.hat=null,this.phase=0,this.leaning=0,this.firstPerson=!1,this._held=[],this._heldSig=""}applyOutfit(t={}){var o,a,c;const e=(l,h)=>{l.material=ke(h)},n=((o=t.top)==null?void 0:o.colour)??14209734;e(this.torso,n),e(this.arms.left.upper,n),e(this.arms.right.upper,n);const s=((a=t.bottom)==null?void 0:a.colour)??3884626;e(this.legs.left.leg,s),e(this.legs.right.leg,s);const r=((c=t.shoes)==null?void 0:c.colour)??2764083;if(e(this.legs.left.shoe,r),e(this.legs.right.shoe,r),this.hat&&(this.head.remove(this.hat),this.hat=null),t.head){const l=this.scale;if(this.hat=dn(.3*l,.08*l,.3*l,t.head.colour),this.hat.position.y=.33*l,t.head.id==="cap"){const h=dn(.28*l,.03*l,.14*l,t.head.colour);h.position.set(0,-.03*l,.2*l),this.hat.add(h)}this.head.add(this.hat)}if(this.bag&&(this.hips.remove(this.bag),this.bag=null),t.bag){const l=this.scale;this.bag=dn(.32*l,.4*l,.16*l,t.bag.colour),this.bag.position.set(0,.3*l,-.2*l),this.hips.add(this.bag)}}setFirstPerson(t){this.firstPerson=t,this.head.visible=!t,this.neck.visible=!t,this.torso.visible=!t,this.arms.left.pivot.visible=!t,this.arms.right.pivot.visible=!t,this.legs.left.pivot.visible=!t,this.legs.right.pivot.visible=!t,this.bag&&(this.bag.visible=!t),this._applyHeldVisibility()}setHeld(t=[]){var r;const e=Array.isArray(t)?t.slice(0,4):[],n=e.map(o=>`${o.id}:${o.colour}:${o.shape||""}`).join("|");if(n===this._heldSig)return;this._heldSig=n;for(const o of this._held)(r=o.parent)==null||r.remove(o);this._held=[];const s=this.scale;e.forEach((o,a)=>{const c=a===1?"left":"right",l=this.arms[c].grip,h=J1(o.shape)||!!o.big,u=Kn(o.shape,o.colour??13421772);u.scale.setScalar(s),u.position.set(0,h?-.16*s:-.02*s-(a>>1)*.11*s,h?.05*s:.075*s),h&&(u.rotation.x=.24),l.add(u),this._held.push(u)}),this._applyHeldVisibility()}_applyHeldVisibility(){for(const t of["left","right"]){const e=this.arms[t].grip;e.visible=!0,this.firstPerson?(e.parent!==this.hips&&this.hips.add(e),e.position.set((t==="left"?-1:1)*.22*this.scale,.34*this.scale,.34*this.scale)):e.parent!==this.arms[t].pivot&&(this.arms[t].pivot.add(e),e.position.set(0,-.6*this.scale,0))}}update(t,e=0,n={}){const s=e>.2;if(this.phase+=t*(s?4.2+e*1.1:2.2),n.sitting){this.legs.left.pivot.rotation.x=-1.4,this.legs.right.pivot.rotation.x=-1.4,this.arms.left.pivot.rotation.x=-.5,this.arms.right.pivot.rotation.x=-.5,this.hips.position.y=.5*this.scale;return}if(n.sleeping){this.group.rotation.z=Math.PI/2*.98,this.hips.position.y=.3*this.scale;return}this.group.rotation.z=0,this.hips.position.y=.84*this.scale+(s?Math.abs(Math.sin(this.phase))*.02:0);const r=s?Math.sin(this.phase)*Math.min(.85,.28+e*.14):Math.sin(this.phase)*.03;this.legs.left.pivot.rotation.x=r,this.legs.right.pivot.rotation.x=-r,this.arms.left.pivot.rotation.x=-r*.75,this.arms.right.pivot.rotation.x=r*.75,this.arms.left.pivot.rotation.z=.06,this.arms.right.pivot.rotation.z=-.06;const o=n.tired?.16:0;this.torso.rotation.x=o,this.head.rotation.x=o*.6}fidget(t){this.arms.left.pivot.rotation.x+=(Math.random()-.5)*t*.3,this.arms.right.pivot.rotation.x+=(Math.random()-.5)*t*.3,this.head.rotation.y=(Math.random()-.5)*t*.4}dispose(){this.group.traverse(t=>{t.isMesh&&t.geometry.dispose()})}}const ru=1.5,Q1=.3,ou=.3,ty=.34,ey=4.5,ny={queue_1:Math.PI,queue_2:Math.PI,queue_3:Math.PI,queue_4:Math.PI,collect_wait:Math.PI,collect_pickup:Math.PI,kiosk_1:-Math.PI/2,kiosk_2:-Math.PI/2,seat_1:-Math.PI/2,seat_2:-Math.PI/2,seat_3:-Math.PI/2,seat_4:-Math.PI/2,seat_5:-Math.PI/2,seat_6:-Math.PI/2,seat_7:-Math.PI/2},Da=7,iy=14;class sy{constructor(t){this.game=t,this.scene=t.renderer.scene,this._bodies=new Map,this._doorList=[],this._tables=new Map,this._buildLocators(),t.slice=this}tableOf(t){for(const[e,n]of this._tables)if(n===t)return e;return null}seatedTable(t){const e=this.tableOf(t);if(e==null)return null;const n=this._bodies.get(t);return n&&n.sitting?e:null}_freeTable(){for(let t=1;t<=Da;t++)if(!this._tables.has(t))return t;return null}_buildLocators(){this._locators=[];for(let t=1;t<=Da;t++){const e=new Qt,n=new ut(new Vt(.035,.115,.022),new Li({color:11026479}));n.position.y=.058,n.castShadow=!0,e.add(n);const s=document.createElement("canvas");s.width=64,s.height=40;const r=new Vn(s);r.colorSpace=Le;const o=new Gn({map:r,transparent:!0});for(const a of[0,Math.PI]){const c=new ut(new Be(.07,.044),o);c.position.set(0,.075,a===0?.013:-.013),c.rotation.y=a,e.add(c)}e.visible=!1,this.scene.add(e),this._locators.push({g:e,canvas:s,tex:r,shownId:null})}}_syncLocators(){const t=this.game.shift.rules.orders;for(let e=1;e<=Da;e++){const n=this._locators[e-1],s=this._tables.get(e),r=s!=null?t.get(s):null,o=!!r&&r.state!=="served";if(n.g.visible=o,!o)continue;const a=this.spot(`table_${e}`);if(n.g.position.set(a.x-.24,.745,a.z-.2),n.shownId!==s){n.shownId=s;const c=n.canvas.getContext("2d");c.clearRect(0,0,64,40),c.fillStyle="#f4efe4",c.font="bold 26px Segoe UI, system-ui, sans-serif",c.textAlign="center",c.textBaseline="middle",c.fillText("#"+s,32,21),n.tex.needsUpdate=!0}}}bodies(){return this._doorList}atTill(t){const e=this._bodies.get(t);return!!e&&e.goalName==="queue_1"&&e.path.length===0}spot(t){return this.game.world.spots[t]}update(t){if(t>0&&this.game.mode===Xe.PLAY){this._sync(t);for(const e of this._bodies.values())this._move(e,t);this._separate(),this._syncLocators(),this._doorList.length=0;for(const e of this._bodies.values())this._doorList.push(e),e.avatar.update(t,e.speed,{sitting:!!e.sitting})}}_sync(t){const e=this.game.shift.rules.orders;for(const n of e.all()){if(n.source==="drivethru"||n.source==="delivery")continue;let s=this._bodies.get(n.id);if(n.state==="served"){if(!s||s.table!=null&&!s.leaving&&(s.sitting=!0,s.eat??(s.eat=iy+n.id%7*4),s.eat-=t,s.eat>0))continue;this._leave(s);continue}s||(s=this._spawn(n)),!s.leaving&&(n.source==="counter"?this._counterChoreo(s,n,e):this._kioskChoreo(s,n,t))}for(const n of this._bodies.values())e.get(n.id)||this._leave(n)}_counterChoreo(t,e,n){if(e.state==="queued"){const s=n.counterQueue().indexOf(e),r=Math.min(s+1+(n.ordering()?1:0),4);this._stand(t,`queue_${r}`)}else e.state==="ordering"?this._stand(t,"queue_1"):this._waitChoreo(t,e)}_kioskChoreo(t,e,n){t.phase==="arrive"?(this._stand(t,t.kioskSpot),!t.path.length&&t.goalName===t.kioskSpot&&(t.phase="ordering",t.dwell=ey)):t.phase==="ordering"?(t.dwell-=n,t.dwell<=0&&(t.phase="waiting")):this._waitChoreo(t,e)}_waitChoreo(t,e){if(e.state==="bagged"){t.sitting=!1,this._stand(t,"collect_pickup"),!t.path.length&&t.goalName==="collect_pickup"&&!t.collected&&(t.collected=!0,this.game.shift.rules.collect(e.id,"customer"),t.avatar.setHeld([{id:"bag",shape:"bag",colour:14272934}]));return}if(e.service==="dinein"){if(t.table==null){const n=this._freeTable();if(n==null){this._stand(t,"collect_wait");return}t.table=n,this._tables.set(n,e.id)}this._stand(t,`seat_${t.table}`),t.sitting=!t.path.length&&t.goalName===`seat_${t.table}`;return}this._stand(t,"collect_wait")}_spawn(t){const e=eu[t.look%eu.length],n=new Sd({skin:ie.skinTones[e.skin%ie.skinTones.length],hair:ie.hairTones[e.hair%ie.hairTones.length],hairStyle:e.hairStyle,height:e.height,build:e.build});n.applyOutfit({top:{colour:e.top},bottom:{colour:e.bottom},shoes:{colour:2764083}});const s=this.spot("entry_out");n.group.position.set(s.x,0,s.z),this.scene.add(n.group);const r={id:t.id,avatar:n,pos:n.group.position,facing:Math.PI,speed:0,path:[],goalName:null,leaving:!1,phase:"arrive",dwell:0,kioskSpot:t.id%2?"kiosk_1":"kiosk_2"};return this._bodies.set(t.id,r),r}_despawn(t){this._freeUp(t),this.scene.remove(t.avatar.group),t.avatar.dispose(),this._bodies.delete(t.id)}_freeUp(t){t.table!=null&&(this._tables.delete(t.table),t.table=null),t.sitting=!1}_stand(t,e){t.goalName!==e&&(t.goalName=e,t.path=this._route(t,e))}_leave(t){t.leaving||(this._freeUp(t),t.leaving=!0,t.goalName="entry_out",t.path=this._route(t,"entry_out"))}_route(t,e){const n=this.spot(e),s=[],r=t.pos,o=r.x<-8.3&&r.z>3.5,a=r.z<3.5;return e==="entry_out"?(o&&s.push(this.spot("kiosk_gate")),(o||a)&&s.push(this.spot("aisle")),s.push(this.spot("entry"))):e.startsWith("kiosk")?(!a&&!o&&s.push(this.spot("aisle")),s.push(this.spot("kiosk_gate"))):n.z<3.5&&o?s.push(this.spot("kiosk_gate")):n.z<3.5&&!a&&s.push(this.spot("aisle")),s.push(n),s}_move(t,e){const n=t.path[0];if(!n){const c=t.goalName&&this.spot(t.goalName);if(c){const h=Math.hypot(c.x-t.pos.x,c.z-t.pos.z),u=this.game.player.position,d=Math.hypot(c.x-u.x,c.z-u.z)<.6;if(h>.55&&!d){t.path=[c];return}}t.speed=0;const l=ny[t.goalName];l!==void 0&&(t.facing=l),t.avatar.group.rotation.y=t.facing;return}const s=n.x-t.pos.x,r=n.z-t.pos.z,o=Math.hypot(s,r);if(o<Q1){t.path.shift(),!t.path.length&&t.leaving&&this._despawn(t);return}const a=Math.min(o,ru*e);t.pos.x+=s/o*a,t.pos.z+=r/o*a,t.facing=Math.atan2(s,r),t.avatar.group.rotation.y=t.facing,t.speed=ru}_separate(){const t=[...this._bodies.values()];for(let e=0;e<t.length;e++){if(t[e].sitting)continue;for(let l=e+1;l<t.length;l++){const h=t[e],u=t[l];if(u.sitting)continue;let d=u.pos.x-h.pos.x,f=u.pos.z-h.pos.z,m=Math.hypot(d,f);const _=ou*2;if(m>=_)continue;m<1e-4&&(d=1,f=0,m=1);const p=(_-m)/2;h.pos.x-=d/m*p,h.pos.z-=f/m*p,u.pos.x+=d/m*p,u.pos.z+=f/m*p}const n=this.game.player.position,s=t[e];let r=s.pos.x-n.x,o=s.pos.z-n.z,a=Math.hypot(r,o);const c=ou+ty;a<c&&(a<1e-4&&(r=1,o=0,a=1),s.pos.x+=r/a*(c-a),s.pos.z+=o/a*(c-a))}}}const ry=5.5,oy=4.5,Ua=.35,au=-.5,ay=-1,Na=20;class cy{constructor(t){this.game=t,this.scene=t.renderer.scene,this._cars=new Map,this._path=this._buildPath(),this._sOrder=15.9-au,this._sPickup=this._sAtServiceZ(ay),this._sExit=this._sAtServiceZ(Na)}_buildPath(){const t=[],e=(h,u)=>t.push({x:h,z:u}),n=pl.lane.legs,s=n[0],r=n[1],o=n[2];e(s.from.x,s.from.z),e(s.to.x,s.to.z);const a=(h,u,d,f)=>{for(let _=1;_<=7;_++){const p=d+(f-d)*(_/7);e(h+Math.cos(p)*6,u+Math.sin(p)*6)}};a(-9,-6.5,Math.PI,Math.PI*1.5),e(r.to.x,r.to.z),a(6.15,-6.5,Math.PI*1.5,Math.PI*2),e(o.to.x,Na);let c=0;const l=t.map((h,u)=>(u>0&&(c+=Math.hypot(h.x-t[u-1].x,h.z-t[u-1].z)),{...h,s:c}));return this._length=c,l}_sAtServiceZ(t){return this._path[this._path.length-1].s-(Na-t)}_at(t){const e=this._path;let n=1;for(;n<e.length-1&&e[n].s<t;)n++;const s=e[n-1],r=e[n],o=r.s-s.s||1,a=Math.min(1,Math.max(0,(t-s.s)/o));return{x:s.x+(r.x-s.x)*a,z:s.z+(r.z-s.z)*a,yaw:Math.atan2(r.x-s.x,r.z-s.z)}}atOrderWindow(t){const e=this._cars.get(t);return!!e&&Math.abs(e.s-this._sOrder)<Ua}atPickup(t){const e=this._cars.get(t);return!!e&&Math.abs(e.s-this._sPickup)<Ua}update(t){if(!(t>0)||this.game.mode!==Xe.PLAY)return;const e=this.game.shift.rules.orders;for(const r of e.all()){if(r.source!=="drivethru")continue;let o=this._cars.get(r.id);!o&&r.state!=="served"&&(o=this._spawn(r)),o&&(o.order=r)}for(const[r,o]of this._cars)e.get(r)||(o.order={state:"served"});const n=[...this._cars.values()].sort((r,o)=>o.s-r.s);let s=1/0;for(const r of n){const o=r.order,a=o.state==="driveup"?this._sOrder:o.state==="served"?this._sExit:this._sPickup,l=Math.min(a,s-ry)-r.s;if(l>.001){const u=Math.min(oy,.8+l*1.4);r.s+=Math.min(l,u*t)}s=r.s;const h=this._at(r.s);r.mesh.position.set(h.x,0,h.z),r.mesh.rotation.y=h.yaw,!r.chimed&&o.state==="driveup"&&Math.abs(r.s-this._sOrder)<Ua&&(r.chimed=!0,this.game.audio.play("kiosk_order",{at:{x:-10,y:1.3,z:au},rate:.8})),o.state==="served"&&r.s>=this._sExit-.1&&this._despawn(r)}}_spawn(t){const e=this.game.rng.child("car"+t.id),n=pd(e);this.scene.add(n);const s={id:t.id,order:t,mesh:n,s:0,chimed:!1};return this._cars.set(t.id,s),s}_despawn(t){this.scene.remove(t.mesh),t.mesh.traverse(e=>{var n,s,r,o,a;(s=(n=e.geometry)==null?void 0:n.dispose)==null||s.call(n),e.material&&!((r=e.userData)!=null&&r.shared)&&((a=(o=e.material).dispose)==null||a.call(o))}),this._cars.delete(t.id)}}const Sn={topSpeed:12,accel:4.5,brake:7,coastDrag:1.2,turnRateAtSpeed:1,turnRateAtCrawl:2.2,mountRange:2.2},ly=1.2,Oa={x:-7.9,z:-18.7,heading:Math.PI};class hy{constructor(t){this.game=t,this.mesh=Qv(),t.renderer.scene.add(this.mesh),this.parked=new I(Oa.x,0,Oa.z),this.heading=Oa.heading,this.lean=0,this.speed=0,this.rider=null,this._syncMesh(),this.point=t.world.addInteractable({id:"delivery_van",label:"take the delivery van",pos:this.parked,action:"vehicle",data:{},radius:Sn.mountRange}),this._collider=null,this._addParkedCollider()}get isRidden(){return this.rider!==null}_addParkedCollider(){const t=Math.abs(Math.sin(this.heading))>.5,e=(t?4.2:2)/2,n=(t?2:4.2)/2;this._collider={min:new I(this.parked.x-e,0,this.parked.z-n),max:new I(this.parked.x+e,2.2,this.parked.z+n),walkable:!1},this.game.world.colliders.push(this._collider),this.game.world._rebuildSpatialHash()}_removeParkedCollider(){const t=this.game.world.colliders,e=t.indexOf(this._collider);e>=0&&t.splice(e,1),this._collider=null,this.game.world._rebuildSpatialHash()}_syncMesh(){const t=this.rider?this.rider.position:this.parked;this.mesh.position.set(t.x,0,t.z),this.mesh.rotation.y=this.heading,this.mesh.rotation.z=this.lean*.4}mount(){const t=this.game.player;if(this.isRidden||!t||t.isBusy)return!1;this.rider=t,t.vehicle=this,this._removeParkedCollider(),t.position.set(this.parked.x,0,this.parked.z),t.velocity.set(0,0,0),t.facing=this.heading,this.speed=0;const e=this.game.camera;return e.setMode("ride"),e.yaw=this.heading,e.pitch=-.14,this.game.ui.toast("W/S drive, A/D steer, Space brakes. E to get out.",5200),this.game.bus.emit("van:mounted",{}),!0}dismount(){if(!this.isRidden)return!1;const t=this.rider;this.parked.set(t.position.x,0,t.position.z);const e={x:Math.cos(this.heading),z:-Math.sin(this.heading)},n=t.position.clone();return t.position.x+=e.x*1.35,t.position.z+=e.z*1.35,t.position.y=t._floorUnder(),t._insideSolid()&&t.position.copy(n),t.velocity.set(0,0,0),t.vehicle=null,this.rider=null,this.speed=0,this.game.camera.fovBoost=0,this.game.camera.setMode("first"),this._addParkedCollider(),this._syncMesh(),this.game.bus.emit("van:dismounted",{}),!0}ride(t){const e=this.rider;if(!e)return;const n=this.game.input,s=n.axis(),r=s.y,o=s.x;if(r>.01)this.speed+=Sn.accel*r*t;else if(r<-.01)this.speed>.15?this.speed-=Sn.brake*t:this.speed-=Sn.accel*.6*t;else{const g=Sn.coastDrag*t;this.speed-=Math.sign(this.speed)*Math.min(Math.abs(this.speed),g)}if(n.isDown("jump")){const g=Sn.brake*1.3*t;this.speed-=Math.sign(this.speed)*Math.min(Math.abs(this.speed),g)}this.speed=pn.clamp(this.speed,-2.5,Sn.topSpeed);const a=Math.min(1,Math.abs(this.speed)/Sn.topSpeed),c=Sn.turnRateAtCrawl+(Sn.turnRateAtSpeed-Sn.turnRateAtCrawl)*a,l=Math.min(1,Math.abs(this.speed)/ly),h=-o*c*l*Math.sign(this.speed||1)*t;this.heading+=h;const u=pn.clamp(-h/Math.max(t,1e-4)*.22*a,-.42,.42);this.lean+=(u-this.lean)*Math.min(1,t*6);const d=Math.sin(this.heading),f=Math.cos(this.heading);e.velocity.x=d*this.speed,e.velocity.z=f*this.speed,e._applyGravity(t),e._collide(t);const m=e._floorUnder();e.position.y<m&&(e.position.y=m,e.velocity.y=0,e.onGround=!0),this.speed=e.velocity.x*d+e.velocity.z*f,e.facing=this.heading,e.horizontalSpeed=0;const _=this.game.camera,p=this.heading-_.yaw;_.yaw+=Math.atan2(Math.sin(p),Math.cos(p))*Math.min(1,t*2.2*a),this.game.camera.fovBoost=7*Math.max(0,this.speed)/Sn.topSpeed,this._syncMesh()}}const sn={x:Ps.x,y:yt.benchH+.045,z:Ps.z},cu={z:yt.z1-.15,y:yt.benchH+.002},uy=1.1,dy={heel:.02,smear:.005,chips:.01,leaf:.014,slice:.011,flat:.006,disc:.018,crown:.036},fy=.72;class py{constructor(t){this.game=t;const e=t.renderer.scene;this.group=new Qt,this.group.name="build-board",e.add(this.group),this._sig=null,this._mats=[],this._piles=[],this._pilePos=[],this._pileOrderId=null,this._parcel=new Qt;const n=new ut(new Vt(.115,.055,.115),new Li({color:15262418}));n.castShadow=!0;const s=new ut(new Vt(.118,.016,.05),new Li({color:11026479}));s.position.y=.02,this._parcel.add(n,s),this._parcel.visible=!1,e.add(this._parcel),this.slidingId=null,this._slide=null,this._fixturePos={};for(const r of t.world.activeInteractables())r.id==="pod_toaster"?this._fixturePos.bun=r.pos:r.id==="pod_uhc"?(this._fixturePos.patty=r.pos,this._fixturePos.fillet=r.pos):r.id.startsWith("pod_gun_")?this._fixturePos[r.id.slice(8)]=r.pos:r.id.startsWith("pod_bin_")?this._fixturePos[r.id.slice(8)]=r.pos:r.id==="landing_handover"?this._landingPos=r.pos:r.id==="till_order"&&(this._tillPos=r.pos);this._pulses=[];for(let r=0;r<6;r++){const o=new ut(new Be(.16,.16),new Gn({color:16777215,transparent:!0,opacity:0,blending:za,depthWrite:!1}));o.visible=!1,o.rotation.x=-.4,e.add(o),this._pulses.push({mesh:o,life:0})}this._bunHalf=Kn("bun",Di.bun.colour),this._bunHalf.visible=!1,e.add(this._bunHalf),this._eject=null,this._wire()}_wire(){const t=this.game.bus,e=this.game.audio,n=s=>s?{at:{x:s.x,y:s.y,z:s.z}}:{};t.on(pe.ORDER_STEP,({added:s})=>{const r=this._fixturePos[s],o=Di[s];r&&o&&this._pulse(r,o.colour),s==="bun"&&(this._eject={t:0}),e.play("item_place",{...n(r),rate:.94+Math.random()*.12})}),t.on(pe.POD_REFUSED,()=>{e.play("wrong_item",n({x:yt.cx,y:1.2,z:yt.cz}))}),t.on(pe.ORDER_BUILT,()=>{e.play("item_pickup",n({x:sn.x,y:1,z:sn.z}))}),t.on(pe.ORDER_WRAPPED,()=>{e.play("item_place",{...n({x:sn.x,y:1,z:sn.z}),rate:.8})}),t.on(pe.ORDER_READY,({id:s})=>{this.slidingId=s,this._slide={t:0},e.play("item_drop",{...n({x:fe.x0,y:1,z:fe.z0}),rate:1.15})}),t.on(pe.ORDER_SERVED,({id:s})=>{const r=this.game.shift.rules.orders.get(s),o=(r==null?void 0:r.source)==="drivethru"?{x:9.9,y:1.2,z:-1}:this._landingPos;e.play("order_complete",n(o))}),t.on(pe.COUNTER_TAKEN,()=>e.play("order_taken",n(this._tillPos))),t.on(pe.COUNTER_PAID,()=>e.play("purchase",n(this._tillPos))),t.on(pe.ORDER_OFFERED,({source:s})=>{var r;if(s==="kiosk"){const o=(r=this.game.world.spots)==null?void 0:r.kiosk_1;e.play("kiosk_order",n(o&&{x:o.x,y:1.4,z:o.z}))}})}_pulse(t,e){const n=this._pulses.find(s=>s.life<=0)||this._pulses[0];n.life=.35,n.mesh.material.color.set(e),n.mesh.position.set(t.x,t.y+.06,t.z+.02),n.mesh.visible=!0}update(t){this._syncStack(),this._animate(t)}_syncStack(){var o;const t=this.game.shift.rules.orders.active(),e=t?`${t.id}:${t.step}:${t.state}`:null;if(e===this._sig)return;this._sig=e;for(const a of[...this.group.children])this.group.remove(a);for(const a of this._mats)a.dispose();if(this._mats=[],this._piles=[],this._parcel.visible=this._slide!==null,(!t||this._pileOrderId!==t.id)&&(this._pilePos=[],this._pileOrderId=(t==null?void 0:t.id)??null),!t||t.state==="ready")return;if(t.state==="wrapped"){this._parcel.visible=!0,this._parcel.position.set(sn.x,sn.y+.028,sn.z),this._parcel.rotation.set(0,.12,0);return}const n=t.items.map((a,c)=>{var l;return Ui[a].sequence.length+((l=t.mods)!=null&&l[c]?1:0)});let s=0,r=0;for(let a=0;a<n.length&&s<t.step;a++){const c=s,l=Math.min(t.step-c,n[a]);if(s+=n[a],l<=0)break;const h=l===n[a],u=new Qt,d=(p,g)=>((t.id*7+(c+p)*13)%5-2)*.003*g;let f=0;for(let p=0;p<l;p++){const g=Di[t.sequence[c+p]];if(!g)continue;const y=dy[g.shape]??.012;this._layer(u,g,f+y/2,d(p,1),d(p,-1)),f+=y}if(h){const p=Kn("bun",Di.bun.colour);this._own(p),p.position.y=f,u.add(p)}let m;if(h)m=new I(sn.x+(r%2?.075:-.075)*(n.length>1?1:0),sn.y,sn.z),r++;else{const p=t.sequence[c+l-1],g=((o=this._fixturePos[p])==null?void 0:o.x)??sn.x;m=new I(g,cu.y,cu.z)}const _=this._pilePos[a];u.position.copy(_||m),this.group.add(u),this._piles.push({group:u,target:m,item:a})}}_layer(t,e,n,s,r){const o=(a,c=1,l=1,h=1,u=0,d=0)=>{this._own(a),a.scale.multiply(new I(c,l,h)),a.position.set(s+u,n,r+d),t.add(a)};switch(e.shape){case"smear":o(Kn("flat",e.colour),.62,.5,.62);break;case"chips":o(Kn("chip",e.colour),1,1,1,-.018,-.008),o(Kn("chip",e.colour),1,1,1,.016,-.014),o(Kn("chip",e.colour),1,1,1,.004,.019);break;case"leaf":o(Kn("blob",e.colour),1.5,.38,1.5);break;case"slice":o(Kn("disc",e.colour),.92,.6,.92);break;default:o(Kn(e.shape,e.colour))}}_own(t){t.traverse(e=>{e.material&&this._mats.push(e.material)})}_animate(t){var e,n;for(const s of this._piles){const r=s.group,o=s.target,a=o.x-r.position.x,c=o.y-r.position.y,l=o.z-r.position.z,h=Math.hypot(a,c,l);if(h>5e-4){const u=Math.min(h,uy*t);r.position.x+=a/h*u,r.position.y+=c/h*u,r.position.z+=l/h*u}((e=this._pilePos)[n=s.item]||(e[n]=new I)).copy(r.position)}for(const s of this._pulses)s.life<=0||(s.life-=t,s.mesh.material.opacity=Math.max(0,s.life/.35)*.9,s.life<=0&&(s.mesh.visible=!1));if(this._eject){const s=this._fixturePos.bun;this._eject.t+=t/.35;const r=Math.min(1,this._eject.t);s&&(this._bunHalf.visible=!0,this._bunHalf.position.set(s.x,yt.benchH+.3-.27*r*r,yt.cz+.24+.16*r),this._bunHalf.rotation.x=.3*(1-r)),r>=1&&(this._eject=null,this._bunHalf.visible=!1)}if(this._slide){this._slide.t+=t/fy;const s=Math.min(1,this._slide.t),r=this.game.shift.rules.orders.ready(),o=Math.max(0,Math.min(r.findIndex(_=>_.id===this.slidingId),3)),a={x:Fs.x0+.22+o*.42,y:Fs.y+.03,z:Fs.z},c=[{x:sn.x,y:sn.y+.03,z:sn.z},{x:fe.x0,y:1,z:fe.z0},{x:fe.x1,y:.93,z:fe.z1},a],l=[.18,.62,1];let h=0;for(;h<2&&s>l[h];)h++;const u=h===0?0:l[h-1],d=(s-u)/(l[h]-u),f=c[h],m=c[h+1];this._parcel.visible=!0,this._parcel.scale.setScalar(1.25-.25*s),this._parcel.position.set(f.x+(m.x-f.x)*d,f.y+(m.y-f.y)*d,f.z+(m.z-f.z)*d),this._parcel.rotation.y+=t*2.2,s>=1&&(this._slide=null,this.slidingId=null,this._parcel.visible=!1,this._parcel.rotation.set(0,0,0),this._parcel.scale.setScalar(1))}}}const fn=.34,lu=1.75,my=1.62,gy=22,Fa=.42,_y={top:{colour:3817286},bottom:{colour:2303531},shoes:{colour:2764083},head:{id:"cap",colour:11026479}};class xy{constructor(t){var n,s,r;this.game=t,this.position=new I(0,0,0),this.velocity=new I,this.facing=0,this.onGround=!0,this.state="normal",this.eyeHeight=my,this.horizontalSpeed=0,this.avatar=new Sd({skin:(n=ie.skinTones)==null?void 0:n[1],hair:(s=ie.hairTones)==null?void 0:s[1],hairStyle:"short",height:1,build:1}),this.avatar.applyOutfit(_y),t.renderer.scene.add(this.avatar.group);const e=(r=t.world.spots)==null?void 0:r.spawn;this.teleport(e?e.clone():new I(0,0,14)),this.walkSpeed=4.6,this.runSpeed=9}teleport(t){this.position.copy(t),this.velocity.set(0,0,0),this.avatar.group.position.copy(t)}get isBusy(){return this.state!=="normal"}update(t){if(this.vehicle){this.game.mode===Xe.PLAY&&this.vehicle.ride(t),this.avatar.group.position.copy(this.position),this.avatar.group.rotation.y=this.facing,this.avatar.update(t,0,{sitting:!0});return}this.state==="normal"&&this.game.mode===Xe.PLAY?this._move(t):(this.velocity.x=0,this.velocity.z=0,this.horizontalSpeed=0,this.state==="normal"&&this._applyGravity(t)),this.avatar.group.position.copy(this.position),this.avatar.group.rotation.y=this.facing,this.avatar.update(t,this.horizontalSpeed,{sitting:!1,sleeping:!1,tired:!1})}_move(t){const e=this.game.input,n=e.axis(),{forward:s,right:r}=this.game.camera.basis(),o=e.isDown("sprint"),a=o?this.runSpeed:this.walkSpeed,c=new I().addScaledVector(s,n.y).addScaledVector(r,n.x);c.lengthSq()>0?(c.normalize(),this.facing=Math.atan2(c.x,c.z),this.game.camera.fovBoost=o?5:0):this.game.camera.fovBoost=0;const l=c.multiplyScalar(a),h=this.onGround?14:3;this.velocity.x+=(l.x-this.velocity.x)*Math.min(1,h*t),this.velocity.z+=(l.z-this.velocity.z)*Math.min(1,h*t),e.wasPressed("jump")&&this.onGround&&(this.velocity.y=6.2,this.onGround=!1),this._applyGravity(t),this._collide(t);const u=this._floorUnder();this.position.y<u&&(this.position.y=u,this.velocity.y=0,this.onGround=!0),this.horizontalSpeed=Math.hypot(this.velocity.x,this.velocity.z)}_floorUnder(){const t=this.game.world,{x:e,z:n,y:s}=this.position;let r=t.groundHeight(e,n);for(const o of t.query(this.position,fn+.5))o.walkable&&(e<o.min.x-fn||e>o.max.x+fn||n<o.min.z-fn||n>o.max.z+fn||o.max.y<=s+Fa&&o.max.y>r&&(r=o.max.y));return r}_insideSolid(){const t=this.game.world,e=fn-.06;for(const n of t.query(this.position,fn+.3)){if(this.position.y+lu<n.min.y||this.position.y>n.max.y||n.max.y<=this.position.y+Fa)continue;const s=Math.max(n.min.x,Math.min(this.position.x,n.max.x)),r=Math.max(n.min.z,Math.min(this.position.z,n.max.z)),o=this.position.x-s,a=this.position.z-r;if(o*o+a*a<e*e)return!0}return!1}_applyGravity(t){this.velocity.y-=gy*t,this.position.y+=this.velocity.y*t;const e=this._floorUnder();this.position.y<=e&&(this.position.y=e,this.velocity.y=0,this.onGround=!0)}_collide(t){const e=this.game.world;this.position.x+=this.velocity.x*t,this.position.z+=this.velocity.z*t;for(let s=0;s<4;s++){let r=!1;for(const o of e.query(this.position,fn+.6)){if(this.position.y+lu<o.min.y||this.position.y>o.max.y||o.max.y<=this.position.y+Fa)continue;const a=Math.max(o.min.x,Math.min(this.position.x,o.max.x)),c=Math.max(o.min.z,Math.min(this.position.z,o.max.z));let l=this.position.x-a,h=this.position.z-c;const u=l*l+h*h;if(u>=fn*fn)continue;if(u>1e-8){const f=Math.sqrt(u),m=fn-f;l/=f,h/=f,this.position.x+=l*m,this.position.z+=h*m}else{const f=[[this.position.x-o.min.x,-1,0],[o.max.x-this.position.x,1,0],[this.position.z-o.min.z,0,-1],[o.max.z-this.position.z,0,1]].sort((m,_)=>m[0]-_[0])[0];l=f[1],h=f[2],this.position.x+=l*(f[0]+fn),this.position.z+=h*(f[0]+fn)}const d=this.velocity.x*l+this.velocity.z*h;d<0&&(this.velocity.x-=l*d,this.velocity.z-=h*d),r=!0}if(!r)break}this._insideSolid()?(this._lastSafe&&this.position.copy(this._lastSafe),this.velocity.x=0,this.velocity.z=0):(this._lastSafe||(this._lastSafe=new I)).copy(this.position);const n=180;this.position.x=pn.clamp(this.position.x,-n,n),this.position.z=pn.clamp(this.position.z,-n,n)}setState(t){this.state=t,this.game.bus.emit("player:state",{state:t})}serialize(){return{position:this.position.toArray(),facing:this.facing}}load(t){t&&(this.teleport(new I().fromArray(t.position)),this.position.y=Math.max(this.position.y,this._floorUnder()),this.avatar.group.position.copy(this.position),this.facing=t.facing||0)}}class vy{constructor(t){this.game=t;const e=document.getElementById("ui");e.innerHTML=`
      ...
      </div>`,this.prompt=document.getElementById("prompt"),this.promptLabel=document.getElementById("prompt-label"),this.toastEl=document.getElementById("toast"),this.pauseEl=document.getElementById("pause"),this._toastTimer=null,this.pauseEl.addEventListener("click",()=>t.setMode(Xe.PLAY,"resume")),t.bus.on("game:mode",({mode:n})=>{this.pauseEl.classList.toggle("hidden",n===Xe.PLAY)}),t.bus.on("interaction:target",({label:n})=>this.showPrompt(n))}showPrompt(t){if(!t){this.prompt.style.display="none";return}this.promptLabel.textContent=t,this.prompt.style.display="block"}toast(t,e=2600){this.toastEl.textContent=t,this.toastEl.style.opacity="1",clearTimeout(this._toastTimer),this._toastTimer=setTimeout(()=>{this.toastEl.style.opacity="0"},e)}update(){}}const Xe={PLAY:"play",MENU:"menu"};class yy{constructor(t,e={}){this.canvas=t,this.seed=e.seed||"burgerbarn",this.bus=new Ld,this.rng=new Ao(this.seed),this.clock=new Id(this.bus),this.input=new Nd(this.bus,t),this.audio=new Vd(this),this.mode=Xe.MENU,this.running=!1,this._accum=0,this._last=0,this.fixedStep=1/60}build(){return this.renderer=new tv(this.canvas,this),this.world=new M1(this),this.world.generate(),this.player=new xy(this),this.camera=new nv(this),this.interaction=new w1(this),this.shift=new N1(this),this.customers=new sy(this),this.cars=new cy(this),this.deliveryCar=new hy(this),this.buildBoard=new py(this),this.ui=new vy(this),this.camera.setMode("first"),this.camera.yaw=Math.PI,this._wireGlobalInput(),this.input.enabled=!1,this.bus.emit("game:ready",{game:this}),this}_wireGlobalInput(){this.bus.on("action:camera",()=>{this.mode===Xe.PLAY&&this.camera.cycle()}),this.bus.on("input:pointerlock",({locked:t})=>{!t&&this.mode===Xe.PLAY&&this.setMode(Xe.MENU,"pause")})}setMode(t,e=""){if(this.mode===t)return;const n=this.mode;this.mode=t,this.clock.paused=t===Xe.MENU,this.input.enabled=t===Xe.PLAY,t===Xe.PLAY?this.input.requestLock():n===Xe.PLAY&&this.input.locked&&this.input.releaseLock(),this.bus.emit("game:mode",{mode:t,prev:n,reason:e})}start(){this.running=!0,this._last=performance.now();const t=e=>{if(!this.running)return;requestAnimationFrame(t);let n=(e-this._last)/1e3;this._last=e,n>.25&&(n=.25),this.update(n),this.render(n)};requestAnimationFrame(t)}update(t){this.mode===Xe.PLAY&&this.clock.update(t),this._accum+=t;let e=0;for(;this._accum>=this.fixedStep&&e++<5;)this._accum-=this.fixedStep,this.player.update(this.fixedStep);this.camera.update(t),this.world.update(t),this.interaction.update(t),this.shift.update(t),this.buildBoard.update(t),this.customers.update(t),this.cars.update(t),this.ui.update(t),this.audio.update(t),this.input.endFrame()}render(t){this.renderer.render(this.camera.active,t)}}const _o=document.getElementById("scene"),rn=new yy(_o,{seed:new URLSearchParams(location.search).get("seed")||"burgerbarn"});rn.build();rn.start();window.game=rn;window.shot=async function(t="shot",e=null){if(e){if(e.pos){const c=rn.player.position.clone();c.set(e.pos[0],e.pos[1]??0,e.pos[2]),rn.player.teleport(c)}e.mode&&rn.camera.setMode(e.mode),e.yaw!==void 0&&(rn.camera.yaw=e.yaw),e.pitch!==void 0&&(rn.camera.pitch=e.pitch)}const n=1280,s=720;(_o.width!==n||_o.height!==s)&&(rn.renderer.renderer.setSize(n,s,!1),rn.camera.active.aspect=n/s,rn.camera.active.updateProjectionMatrix());const r=Math.max(1,(e==null?void 0:e.settle)??90);for(let c=0;c<r;c++)rn.update(1/60);if(e!=null&&e.free){const c=rn.camera.active;c.position.set(...e.free.pos),c.lookAt(...e.free.look)}rn.render(0);const o=_o.toDataURL("image/png");return(await fetch("http://localhost:5199/shot",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({name:t,dataURL:o})})).json()};
