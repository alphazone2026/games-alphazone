...
#endif`,jf="gl_FragColor = linearToOutputTexel( gl_FragColor );",Kf=`
...
void main() {
	...
	`}function om(i){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===ma||c===ga,h=c===ws||c===Ts;if(l||h){let u=t.get(a);const d=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return e===null&&(e=new ul(i)),u=l?e.fromEquirectangular(a,u):e.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),u.texture;if(u!==void 0)return u.texture;{const f=a.image;return l&&f&&f.height>0||h&&f&&s(f)?(e===null&&(e=new ul(i)),u=l?e.fromEquirectangular(a):e.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),a.addEventListener("dispose",r),u.texture):null}}}return a}function s(a){let c=0;const l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function r(a){const c=a.target;c.removeEventListener("dispose",r);const l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function am(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const s=e(n);return s===null&&Xr("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function cm(i,t,e,n){const s={},r=new WeakMap;function o(u){const d=u.target;d.index!==null&&t.remove(d.index);for(const g in d.attributes)t.remove(d.attributes[g]);for(const g in d.morphAttributes){const _=d.morphAttributes[g];for(let p=0,m=_.length;p<m;p++)t.remove(_[p])}d.removeEventListener("dispose",o),delete s[d.id];const f=r.get(d);f&&(t.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function a(u,d){return s[d.id]===!0||(d.addEventListener("dispose",o),s[d.id]=!0,e.memory.geometries++),d}function c(u){const d=u.attributes;for(const g in d)t.update(d[g],i.ARRAY_BUFFER);const f=u.morphAttributes;for(const g in f){const _=f[g];for(let p=0,m=_.length;p<m;p++)t.update(_[p],i.ARRAY_BUFFER)}}function l(u){const d=[],f=u.index,g=u.attributes.position;let _=0;if(f!==null){const M=f.array;_=f.version;for(let v=0,S=M.length;v<S;v+=3){const C=M[v+0],b=M[v+1],T=M[v+2];d.push(C,b,b,T,T,C)}}else if(g!==void 0){const M=g.array;_=g.version;for(let v=0,S=M.length/3-1;v<S;v+=3){const C=v+0,b=v+1,T=v+2;d.push(C,b,b,T,T,C)}}else return;const p=new(Nh(d)?Hh:Bh)(d,1);p.version=_;const m=r.get(u);m&&t.remove(m),r.set(u,p)}function h(u){const d=r.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&l(u)}else l(u);return r.get(u)}return{get:a,update:c,getWireframeAttribute:h}}function lm(i,t,e){let n;function s(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function c(d,f){i.drawElements(n,f,r,d*o),e.update(f,n,1)}function l(d,f,g){g!==0&&(i.drawElementsInstanced(n,f,r,d*o,g),e.update(f,n,g))}function h(d,f,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,d,0,g);let p=0;for(let m=0;m<g;m++)p+=f[m];e.update(p,n,1)}function u(d,f,g,_){if(g===0)return;const p=t.get("WEBGL_multi_draw");if(p===null)for(let m=0;m<d.length;m++)l(d[m]/o,f[m],_[m]);else{p.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,_,0,g);let m=0;for(let M=0;M<g;M++)m+=f[M];for(let M=0;M<_.length;M++)e.update(m,n,_[M])}}this.setMode=s,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function hm(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(e.calls++,o){case i.TRIANGLES:e.triangles+=a*(r/3);break;case i.LINES:e.lines+=a*(r/2);break;case i.LINE_STRIP:e.lines+=a*(r-1);break;case i.LINE_LOOP:e.lines+=a*r;break;case i.POINTS:e.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function um(i,t,e){const n=new WeakMap,s=new ae;function r(o,a,c){const l=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(a);if(d===void 0||d.count!==u){let x=function(){P.dispose(),n.delete(a),a.removeEventListener("dispose",x)};var f=x;d!==void 0&&d.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,p=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],M=a.morphAttributes.normal||[],v=a.morphAttributes.color||[];let S=0;g===!0&&(S=1),_===!0&&(S=2),p===!0&&(S=3);let C=a.attributes.position.count*S,b=1;C>t.maxTextureSize&&(b=Math.ceil(C/t.maxTextureSize),C=t.maxTextureSize);const T=new Float32Array(C*b*4*u),P=new Fh(T,C,b,u);P.type=ei,P.needsUpdate=!0;const D=S*4;for(let E=0;E<u;E++){const U=m[E],O=M[E],K=v[E],X=C*b*4*E;for(let V=0;V<U.count;V++){const $=V*D;g===!0&&(s.fromBufferAttribute(U,V),T[X+$+0]=s.x,T[X+$+1]=s.y,T[X+$+2]=s.z,T[X+$+3]=0),_===!0&&(s.fromBufferAttribute(O,V),T[X+$+4]=s.x,T[X+$+5]=s.y,T[X+$+6]=s.z,T[X+$+7]=0),p===!0&&(s.fromBufferAttribute(K,V),T[X+$+8]=s.x,T[X+$+9]=s.y,T[X+$+10]=s.z,T[X+$+11]=K.itemSize===4?s.w:1)}}d={count:u,texture:P,size:new Jt(C,b)},n.set(a,d),a.addEventListener("dispose",x)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",o.morphTexture,e);else{let g=0;for(let p=0;p<l.length;p++)g+=l[p];const _=a.morphTargetsRelative?1:1-g;c.getUniforms().setValue(i,"morphTargetBaseInfluence",_),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",d.texture,e),c.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function dm(i,t,e,n){let s=new WeakMap;function r(c){const l=n.render.frame,h=c.geometry,u=t.get(c,h);if(s.get(u)!==l&&(t.update(u),s.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),s.get(c)!==l&&(e.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const d=c.skeleton;s.get(d)!==l&&(d.update(),s.set(d,l))}return u}function o(){s=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:r,dispose:o}}class Yh extends Ke{constructor(t,e,n,s,r,o,a,c,l,h=vs){if(h!==vs&&h!==As)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===vs&&(n=Vi),n===void 0&&h===As&&(n=bs),super(null,s,r,o,a,c,h,n,l),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:_n,this.minFilter=c!==void 0?c:_n,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const jh=new Ke,ml=new Yh(1,1),Kh=new Fh,$h=new Zd,Zh=new Wh,gl=[],_l=[],xl=new Float32Array(16),vl=new Float32Array(9),Ml=new Float32Array(4);function Is(i,t,e){const n=i[0];if(n<=0||n>0)return i;const s=t*e;let r=gl[s];if(r===void 0&&(r=new Float32Array(s),gl[s]=r),t!==0){n.toArray(r,0);for(let o=1,a=0;o!==t;++o)a+=e,i[o].toArray(r,a)}return r}function Pe(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function Le(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function co(i,t){let e=_l[t];e===void 0&&(e=new Int32Array(t),_l[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function fm(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function pm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Pe(e,t))return;i.uniform2fv(this.addr,t),Le(e,t)}}function mm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(Pe(e,t))return;i.uniform3fv(this.addr,t),Le(e,t)}}function gm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Pe(e,t))return;i.uniform4fv(this.addr,t),Le(e,t)}}function _m(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Pe(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),Le(e,t)}else{if(Pe(e,n))return;Ml.set(n),i.uniformMatrix2fv(this.addr,!1,Ml),Le(e,n)}}function xm(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Pe(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),Le(e,t)}else{if(Pe(e,n))return;vl.set(n),i.uniformMatrix3fv(this.addr,!1,vl),Le(e,n)}}function vm(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(Pe(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),Le(e,t)}else{if(Pe(e,n))return;xl.set(n),i.uniformMatrix4fv(this.addr,!1,xl),Le(e,n)}}function Mm(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function ym(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Pe(e,t))return;i.uniform2iv(this.addr,t),Le(e,t)}}function Sm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Pe(e,t))return;i.uniform3iv(this.addr,t),Le(e,t)}}function Em(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Pe(e,t))return;i.uniform4iv(this.addr,t),Le(e,t)}}function wm(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function Tm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Pe(e,t))return;i.uniform2uiv(this.addr,t),Le(e,t)}}function bm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Pe(e,t))return;i.uniform3uiv(this.addr,t),Le(e,t)}}function Am(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Pe(e,t))return;i.uniform4uiv(this.addr,t),Le(e,t)}}function Rm(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(ml.compareFunction=Uh,r=ml):r=jh,e.setTexture2D(t||r,s)}function Cm(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||$h,s)}function Pm(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||Zh,s)}function Lm(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||Kh,s)}function Dm(i){switch(i){case 5126:return fm;case 35664:return pm;case 35665:return mm;case 35666:return gm;case 35674:return _m;case 35675:return xm;case 35676:return vm;case 5124:case 35670:return Mm;case 35667:case 35671:return ym;case 35668:case 35672:return Sm;case 35669:case 35673:return Em;case 5125:return wm;case 36294:return Tm;case 36295:return bm;case 36296:return Am;case 35678:case 36198:case 36298:case 36306:case 35682:return Rm;case 35679:case 36299:case 36307:return Cm;case 35680:case 36300:case 36308:case 36293:return Pm;case 36289:case 36303:case 36311:case 36292:return Lm}}function Im(i,t){i.uniform1fv(this.addr,t)}function Um(i,t){const e=Is(t,this.size,2);i.uniform2fv(this.addr,e)}function Nm(i,t){const e=Is(t,this.size,3);i.uniform3fv(this.addr,e)}function Om(i,t){const e=Is(t,this.size,4);i.uniform4fv(this.addr,e)}function Fm(i,t){const e=Is(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function zm(i,t){const e=Is(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function km(i,t){const e=Is(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function Bm(i,t){i.uniform1iv(this.addr,t)}function Hm(i,t){i.uniform2iv(this.addr,t)}function Gm(i,t){i.uniform3iv(this.addr,t)}function Vm(i,t){i.uniform4iv(this.addr,t)}function Wm(i,t){i.uniform1uiv(this.addr,t)}function qm(i,t){i.uniform2uiv(this.addr,t)}function Xm(i,t){i.uniform3uiv(this.addr,t)}function Ym(i,t){i.uniform4uiv(this.addr,t)}function jm(i,t,e){const n=this.cache,s=t.length,r=co(e,s);Pe(n,r)||(i.uniform1iv(this.addr,r),Le(n,r));for(let o=0;o!==s;++o)e.setTexture2D(t[o]||jh,r[o])}function Km(i,t,e){const n=this.cache,s=t.length,r=co(e,s);Pe(n,r)||(i.uniform1iv(this.addr,r),Le(n,r));for(let o=0;o!==s;++o)e.setTexture3D(t[o]||$h,r[o])}function $m(i,t,e){const n=this.cache,s=t.length,r=co(e,s);Pe(n,r)||(i.uniform1iv(this.addr,r),Le(n,r));for(let o=0;o!==s;++o)e.setTextureCube(t[o]||Zh,r[o])}function Zm(i,t,e){const n=this.cache,s=t.length,r=co(e,s);Pe(n,r)||(i.uniform1iv(this.addr,r),Le(n,r));for(let o=0;o!==s;++o)e.setTexture2DArray(t[o]||Kh,r[o])}function Jm(i){switch(i){case 5126:return Im;case 35664:return Um;case 35665:return Nm;case 35666:return Om;case 35674:return Fm;case 35675:return zm;case 35676:return km;case 5124:case 35670:return Bm;case 35667:case 35671:return Hm;case 35668:case 35672:return Gm;case 35669:case 35673:return Vm;case 5125:return Wm;case 36294:return qm;case 36295:return Xm;case 36296:return Ym;case 35678:case 36198:case 36298:case 36306:case 35682:return jm;case 35679:case 36299:case 36307:return Km;case 35680:case 36300:case 36308:case 36293:return $m;case 36289:case 36303:case 36311:case 36292:return Zm}}class Qm{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Dm(e.type)}}class tg{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=Jm(e.type)}}class eg{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(t,e[a.id],n)}}}const Wo=/(\w+)(\])?(\[|\.)?/g;function yl(i,t){i.seq.push(t),i.map[t.id]=t}function ng(i,t,e){const n=i.name,s=n.length;for(Wo.lastIndex=0;;){const r=Wo.exec(n),o=Wo.lastIndex;let a=r[1];const c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===s){yl(e,l===void 0?new Qm(a,i,t):new tg(a,i,t));break}else{let u=e.map[a];u===void 0&&(u=new eg(a),yl(e,u)),e=u}}}class Yr{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=t.getActiveUniform(e,s),o=t.getUniformLocation(e,r.name);ng(r,o,this)}}setValue(t,e,n,s){const r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){const s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,o=e.length;r!==o;++r){const a=e[r],c=n[a.id];c.needsUpdate!==!1&&a.setValue(t,c.value,s)}}static seqWithValue(t,e){const n=[];for(let s=0,r=t.length;s!==r;++s){const o=t[s];o.id in e&&n.push(o)}return n}}function Sl(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const ig=37297;let sg=0;function rg(i,t){const e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let o=s;o<r;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}function og(i){const t=re.getPrimaries(re.workingColorSpace),e=re.getPrimaries(i);let n;switch(t===e?n="":t===Qr&&e===Jr?n="LinearDisplayP3ToLinearSRGB":t===Jr&&e===Qr&&(n="LinearSRGBToLinearDisplayP3"),i){case bi:case oo:return[n,"LinearTransferOETF"];case Ue:case fc:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function El(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),s=i.getShaderInfoLog(t).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const o=parseInt(r[1]);return e.toUpperCase()+`

`+s+`

`+rg(i.getShaderSource(t),o)}else return s}function ag(i,t){const e=og(t);return`vec4 ${i}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function cg(i,t){let e;switch(t){case ld:e="Linear";break;case hd:e="Reinhard";break;case ud:e="Cineon";break;case Sh:e="ACESFilmic";break;case fd:e="AgX";break;case pd:e="Neutral";break;case dd:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Tr=new I;function lg(){re.getLuminanceCoefficients(Tr);const i=Tr.x.toFixed(4),t=Tr.y.toFixed(4),e=Tr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function hg(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ws).join(`
`)}function ug(i){const t=[];for(const e in i){const n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function dg(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function Ws(i){return i!==""}function wl(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Tl(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const fg=/^[ \t]*#include +<([\w\d./]+)>/gm;function Wa(i){return i.replace(fg,mg)}const pg=new Map;function mg(i,t){let e=Xt[t];if(e===void 0){const n=pg.get(t);if(n!==void 0)e=Xt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Wa(e)}const gg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function bl(i){return i.replace(gg,_g)}function _g(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Al(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function xg(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Mh?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===yh?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Zn&&(t="SHADOWMAP_TYPE_VSM"),t}function vg(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ws:case Ts:t="ENVMAP_TYPE_CUBE";break;case ro:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Mg(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ts:t="ENVMAP_MODE_REFRACTION";break}return t}function yg(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case rc:t="ENVMAP_BLENDING_MULTIPLY";break;case ad:t="ENVMAP_BLENDING_MIX";break;case cd:t="ENVMAP_BLENDING_ADD";break}return t}function Sg(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Eg(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=xg(e),l=vg(e),h=Mg(e),u=yg(e),d=Sg(e),f=hg(e),g=ug(r),_=s.createProgram();let p,m,M=e.glslVersion?"#version "+e.glslVersion+`
...
`,gi=[{t:0,top:329487,mid:658970,bot:1317414,sun:2766160,amb:1712176,int:.05},{t:.22,top:1779520,mid:5329002,bot:10123890,sun:16751964,amb:4868704,int:.3},{t:.27,top:5208752,mid:10466511,bot:15778714,sun:16761479,amb:9082024,int:.75},{t:.4,top:4884168,mid:10339044,bot:14214898,sun:16774109,amb:11058384,int:1},{t:.52,top:4161476,mid:9682402,bot:13886450,sun:16777215,amb:11453142,int:1.05},{t:.72,top:4882360,mid:11058388,bot:14734013,sun:16771524,amb:10530496,int:.85},{t:.8,top:2902642,mid:9072512,bot:14256732,sun:16747082,amb:6969960,int:.42},{t:.86,top:1186350,mid:2962768,bot:5917272,sun:9067114,amb:2764872,int:.14},{t:1,top:329487,mid:658970,bot:1317414,sun:2766160,amb:1712176,int:.05}];function x_(i){let t=gi[0],e=gi[gi.length-1];for(let o=0;o<gi.length-1;o++)if(i>=gi[o].t&&i<=gi[o+1].t){t=gi[o],e=gi[o+1];break}const n=e.t-t.t||1,s=(i-t.t)/n,r=(o,a)=>new Ot(o).lerp(new Ot(a),s);return{top:r(t.top,e.top),mid:r(t.mid,e.mid),bot:r(t.bot,e.bot),sun:r(t.sun,e.sun),amb:r(t.amb,e.amb),int:t.int+(e.int-t.int)*s}}class v_{constructor(t,e){this.game=e,this.canvas=t,this.renderer=new n_({canvas:t,antialias:!0,powerPreference:"high-performance"}),this.renderer.setPixelRatio(Math.min(devicePixelRatio,2)),this.renderer.setSize(innerWidth,innerHeight,!1),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=yh,this.renderer.outputColorSpace=Ue,this.renderer.toneMapping=Sh,this.renderer.toneMappingExposure=1.05,this.scene=new i_,this.scene.fog=new xc(11059416,60,340),this._buildSky(),this._buildLights(),this.indoorFactor=0,this.interiorLights=new m_(this.scene),this.quality={shadows:!0,drawDistance:340},addEventListener("resize",()=>this.resize())}_buildSky(){this.skyUniforms={uTop:{value:new Ot(4884168)},uMid:{value:new Ot(10339044)},uBottom:{value:new Ot(14214898)},uSunY:{value:.6},uSunDir:{value:new I(0,1,0)},uSunColour:{value:new Ot(16777215)},uExposure:{value:1.05}};const t=new xt(new Ti(900,32,20),new oi({uniforms:this.skyUniforms,vertexShader:g_,fragmentShader:__,side:je,depthWrite:!1,fog:!1}));t.frustumCulled=!1,this.scene.add(t),this.sky=t;const e=900,n=new Float32Array(e*3);for(let r=0;r<e;r++){const o=new I().randomDirection().multiplyScalar(850);o.y<40&&(o.y=Math.abs(o.y)+40),n.set([o.x,o.y,o.z],r*3)}const s=new $e;s.setAttribute("position",new Te(n,3)),this.stars=new s_(s,new Jh({color:16777215,size:3.2,sizeAttenuation:!1,transparent:!0,opacity:0,fog:!1,depthWrite:!1})),this.stars.frustumCulled=!1,this.scene.add(this.stars),this.moon=new xt(new Ti(18,16,12),new ai({color:14673648,fog:!1})),this.scene.add(this.moon)}_buildLights(){this.hemi=new r_(12374760,5918784,.9),this.scene.add(this.hemi),this.sun=new Fl(16774109,2.2),this.sun.castShadow=!0,this.sun.shadow.mapSize.set(4096,4096),this.sun.shadow.camera.near=1,this.sun.shadow.camera.far=420,this.shadowSpan=Rr.shadowSpan,this._applyShadowSpan(0),this.scene.add(this.sun),this.scene.add(this.sun.target),this.bounce=new Fl(10467020,.35),this.scene.add(this.bounce),this.scene.add(this.bounce.target),this.ambient=new u_(11058384,.35),this.scene.add(this.ambient)}add(t){this.scene.add(t)}remove(t){this.scene.remove(t)}_applyShadowSpan(t){const e=Rn.lerp(Rr.shadowSpan,Nn.shadowSpan,t);if(Math.abs(e-this.shadowSpan)>1e-4||!this._spanApplied){this.shadowSpan=e;const n=this.sun.shadow.camera;n.left=-e,n.right=e,n.top=e,n.bottom=-e,n.updateProjectionMatrix(),this._spanApplied=!0}this.sun.shadow.bias=Rn.lerp(Rr.shadowBias,Nn.shadowBias,t),this.sun.shadow.normalBias=Rn.lerp(Rr.shadowNormalBias,Nn.shadowNormalBias,t)}_skyDelta(t){const e=performance.now(),n=(e-(this._lastSky??e))/1e3;return this._lastSky=e,t>0?Math.min(t,.25):n>.001?Math.min(n,.25):this.game.fixedStep||1/60}updateSky(t,e,n=0,s=0){var U,O;const r=this._skyDelta(s),o=(U=this.game.world)==null?void 0:U.weather,a=f_(o),c=(O=this.game.world)!=null&&O.isIndoors?1:0;this.indoorFactor+=(c-this.indoorFactor)*Math.min(1,r*Nn.rate);const l=this.indoorFactor;this._applyShadowSpan(l);const h=x_(t);this.skyUniforms.uTop.value.copy(h.top),this.skyUniforms.uMid.value.copy(h.mid),this.skyUniforms.uBottom.value.copy(h.bot),this.skyUniforms.uSunColour.value.copy(h.sun);const u=(t-.25)*Math.PI*2,d=Math.sin(n/364*Math.PI*2)*.3,f=new I(Math.cos(u),Math.sin(u)+d,-.35).normalize();this.skyUniforms.uSunDir.value.copy(f),this.skyUniforms.uSunY.value=f.y;const g=(e==null?void 0:e.x)||0,_=(e==null?void 0:e.z)||0,p=(e==null?void 0:e.y)||0,m=this.shadowSpan*2/this.sun.shadow.mapSize.x,M=Math.round(g/m)*m,v=Math.round(_/m)*m;this.sun.position.set(M+f.x*160,p+Math.max(f.y,.08)*160,v+f.z*160),this.sun.target.position.set(M,p,v),this.sun.target.updateMatrixWorld();const S=Math.max(0,f.y),C=Rn.smoothstep(f.y,-.005,.03);this.sun.intensity=Math.pow(S,.65)*3*(1-a)*C,this.sun.color.copy(h.sun).lerp(new Ot(15265524),a),this.sun.shadow.autoUpdate=this.sun.intensity>.01,this.bounce.position.set(M-f.x*90,p+40,v-f.z*90),this.bounce.target.position.set(M,p,v),this.bounce.target.updateMatrixWorld(),this.bounce.intensity=.15+h.int*.4,this.bounce.color.copy(h.mid),this.moon.position.set(g-f.x*600,-f.y*600,_-f.z*600),this.moon.visible=f.y<.08;const b=Rn.clamp((.06-f.y)*6,0,1),T=o!=null&&o.wetness?1:0;this.hemi.intensity=.25+h.int*.8+b*.5+a*.5*(1-T*.5),this.hemi.color.copy(h.mid).lerp(new Ot(5992332),b*.7).lerp(new Ot(13161180),a*.6),this.ambient.intensity=.12+h.int*.3+b*.38+a*.05,this.ambient.color.copy(h.amb).lerp(new Ot(6978201),b*.8),this.stars.material.opacity=b*.9,this.hemi.intensity*=Math.pow(Nn.hemi,l),this.ambient.intensity*=Math.pow(Nn.ambient,l),this.bounce.intensity*=Math.pow(Nn.bounce,l),this.scene.fog.color.copy(h.mid).lerp(h.bot,.45);const P=o!=null&&o.wetness?.45:0,D=o&&["overcast","rain","storm"].includes(o.condition)?.25:0;this.scene.fog.near=60-(P+D)*40,this.scene.fog.far=this.quality.drawDistance*(1-P*.35-D*.15-b*.3);const x=1+b*.45+(1-Math.min(1,h.int))*.2+a*.12+T*.03+l*Nn.exposure;this.renderer.toneMappingExposure+=(x-this.renderer.toneMappingExposure)*Math.min(1,r*Nn.rate),this.skyUniforms.uExposure.value=this.renderer.toneMappingExposure,this.nightFactor=b;const E=this.game.world;if(E!=null&&E.enterable){const K=.34+a*.26;this.interiorLights.update(E,Math.max(K,b),this.game.player)}this.sky&&this.sky.position.set(g,0,_),this.stars.position.set(g,0,_)}resize(){var e;this.renderer.setSize(innerWidth,innerHeight,!1);const t=(e=this.game.camera)==null?void 0:e.active;t&&(t.aspect=innerWidth/innerHeight,t.updateProjectionMatrix())}render(t){this.renderer.render(this.scene,t)}}const Gs=[{id:"first",label:"First person",distance:0,height:0,fov:64},{id:"third",label:"Third person",distance:3.6,height:.35,shoulder:.55,fov:52},{id:"thirdFar",label:"Third person (wide)",distance:6.5,height:.9,shoulder:0,fov:50}],M_=Nn.fov;class y_{constructor(t){this.game=t,this.modeIndex=1,this.active=new tn(Gs[1].fov,innerWidth/innerHeight,.25,1e3),this.yaw=0,this.pitch=-.05,this.distance=Gs[1].distance,this._targetDistance=this.distance,this._pos=new I,this._look=new I,this._ray2=new mc,this._box=new ri,this._hit=new I,this.shakeAmount=0,this.bob=0,this.fovBoost=0}get mode(){return Gs[this.modeIndex]}get isFirstPerson(){return this.mode.id==="first"}cycle(){return this.modeIndex=(this.modeIndex+1)%Gs.length,this.game.bus.emit("camera:mode",{mode:this.mode}),this.mode}setMode(t){const e=Gs.findIndex(n=>n.id===t);e>=0&&(this.modeIndex=e)}addShake(t){this.shakeAmount=Math.min(1.2,this.shakeAmount+t)}update(t){const{input:e,player:n}=this.game;if(e.locked&&e.enabled){const c=e.consumeMouse();this.yaw-=c.dx*e.mouse.sensitivity,this.pitch-=(e.mouse.invertY?-c.dy:c.dy)*e.mouse.sensitivity;const l=Math.PI/2-.05;this.pitch=Rn.clamp(this.pitch,-l,l)}else e.consumeMouse();const s=this.mode,r=n.position.clone();r.y+=n.eyeHeight;const o=n.horizontalSpeed;if(o>.3){this.bob+=t*o*1.9;const c=this.isFirstPerson?.035:.012;r.y+=Math.sin(this.bob*2)*c,r.x+=Math.cos(this.bob)*c*.4}else this.bob+=t*1.1,r.y+=Math.sin(this.bob)*.006;const a=new I(Math.sin(this.yaw)*Math.cos(this.pitch),Math.sin(this.pitch),Math.cos(this.yaw)*Math.cos(this.pitch));if(s.distance===0)this._pos.copy(r),this._look.copy(r).addScaledVector(a,10);else{const c=n.position.clone();c.y+=n.eyeHeight*.92+s.height;const l=new I(-Math.cos(this.yaw),0,Math.sin(this.yaw));c.addScaledVector(l,s.shoulder||0);const h=this.game.world,u=h.isIndoors,d=u?.35:.7;let f=u?Math.min(s.distance,2.2):s.distance;const g=a.clone().negate();this._ray2.set(c,g);const _=c.clone().addScaledVector(g,f*.5);let p=f+.45;for(const m of h.query(_,f+1.5)){this._box.set(m.min,m.max);const M=this._ray2.intersectBox(this._box,this._hit);if(!M)continue;const v=c.distanceTo(M);v<p&&(p=v)}if(f=Math.max(d,Math.min(f,p-.45)),f<.65){this._pos.copy(r),this._look.copy(r).addScaledVector(a,10),this.distance=0,this._targetDistance=f,this._applyShake(t),this._commit(t,s,n);return}if(this._targetDistance+=(f-this._targetDistance)*(f<this._targetDistance?1:Math.min(1,t*5)),this.distance=this._targetDistance,this._pos.copy(c).addScaledVector(g,this.distance),this._look.copy(c).addScaledVector(a,4),u){const m=h.currentBuilding,M=m.interiorBounds;this._pos.y=Math.min(this._pos.y,m.padY+M.maxY-.2),this._pos.y=Math.max(this._pos.y,m.padY+.3)}}this._applyShake(t),this._commit(t,s,n)}_applyShake(t){if(this.shakeAmount<=.001)return;const e=this.shakeAmount;this._pos.x+=(Math.random()-.5)*.06*e,this._pos.y+=(Math.random()-.5)*.06*e,this._look.x+=(Math.random()-.5)*.5*e,this._look.y+=(Math.random()-.5)*.5*e,this.shakeAmount*=Math.pow(.06,t)}_commit(t,e,n){var o;this.active.position.copy(this._pos),this.active.lookAt(this._look);const s=(o=this.game.world)!=null&&o.isIndoors?1:0,r=e.fov+this.fovBoost+s*M_;this.active.fov+=(r-this.active.fov)*Math.min(1,t*6),this.active.updateProjectionMatrix(),n.avatar&&n.avatar.setFirstPerson(this.isFirstPerson||this.distance===0)}basis(){const t=new I(Math.sin(this.yaw),0,Math.cos(this.yaw)).normalize(),e=new I(-t.z,0,t.x);return{forward:t,right:e}}}const ce={grass:7311194,glass:6453644,trunk:6047282,foliage:5208645,foliageLight:6984789,foliageDeep:4154168,metal:9146777,metalDark:4870231,concrete:12039083,skinTones:[15914685,15253915,13803636,11104575,8014374,5517852],hairTones:[2825494,4861726,8014374,12159818,14270346,9276813,2763310,8141370],carBodies:[11680571,3104140,14737632,2764083,5929546,14263361,9080726,7031418]},ht={ceiling:15525851,wall:13814974,trim:16249834,joineryDark:7034951,joineryLight:9073760,floorTimber:9072722,benchtop:12168342,tileFloor:12104358,metalDull:9146777,shadowDark:2764339},ys=new Map,S_=["roughness","metalness","flat","transparent","opacity","side","emissive","emissiveIntensity","vertexColors"];function vn(i,t={}){let e=String(i);for(const s of S_)t[s]!==void 0&&(e+="|"+s+"="+JSON.stringify(t[s]));if(ys.has(e))return ys.get(e);const n=new xn({color:i,roughness:t.roughness??.85,metalness:t.metalness??0,flatShading:t.flat??!1,transparent:t.transparent??!1,opacity:t.opacity??1,side:t.side??Hn,emissive:t.emissive??0,emissiveIntensity:t.emissiveIntensity??1,vertexColors:t.vertexColors??!1});return ys.set(e,n),n}function Ai(i,t){if(ys.has(i))return ys.get(i);const e=t();return ys.set(i,e),e}const E_=i=>{i.fragmentShader=i.fragmentShader.replace("#include <opaque_fragment>",`#include <opaque_fragment>
    ...
    gl_FragColor.a = max( ghA, 0.80 * ghLit );`)};function Sc(i){return i.onBeforeCompile=E_,i}function Ec(){return Ai("window",()=>Sc(new xn({color:ce.glass,roughness:.1,metalness:0,transparent:!0,opacity:.28,depthWrite:!1,emissive:new Ot(16767392),emissiveIntensity:0})))}function w_(){return Ai("windowinner",()=>Sc(new xn({color:ce.glass,roughness:.1,metalness:0,transparent:!0,opacity:.1,depthWrite:!1})))}function T_(){return Ai("bulb",()=>new xn({color:16774365,emissive:new Ot(16770744),emissiveIntensity:1.6}))}function b_(){return Ai("carglass",()=>new xn({color:2831680,roughness:.2,metalness:.3}))}function A_(){return Ai("headlight",()=>new xn({color:15787727,emissive:new Ot(16771512),emissiveIntensity:0}))}function R_(){return Ai("taillight",()=>new xn({color:9186091,emissive:new Ot(16726843),emissiveIntensity:.2}))}function C_(){return Ai("troffer",()=>new xn({color:16185074,roughness:.5,emissive:new Ot(14477567),emissiveIntensity:.9}))}function P_(){return Ai("contactshadow",()=>{const t=document.createElement("canvas");t.width=t.height=128;const e=t.getContext("2d"),n=e.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);n.addColorStop(0,"rgb(140,140,140)"),n.addColorStop(.55,"rgb(196,196,196)"),n.addColorStop(1,"rgb(255,255,255)"),e.fillStyle=n,e.fillRect(0,0,128,128);const s=new ci(t);s.colorSpace=Ue;const r=new ai({map:s,blending:ra,transparent:!0,depthWrite:!1,toneMapped:!1,polygonOffset:!0,polygonOffsetFactor:-1,polygonOffsetUnits:-1});return r.userData.decal=!0,r})}new te(1,1,1),new Ge(1,1),new Ne(.5,.5,1,10),new lo(.5,1,8),new Ti(.5,12,10);const L_=new Set;function tr(i){L_.add(i)}function D_(i,t=!1){const e=i[0].index!==null,n=new Set(Object.keys(i[0].attributes)),s=new Set(Object.keys(i[0].morphAttributes)),r={},o={},a=i[0].morphTargetsRelative,c=new $e;let l=0;for(let h=0;h<i.length;++h){const u=i[h];let d=0;if(e!==(u.index!==null))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+". All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them."),null;for(const f in u.attributes){if(!n.has(f))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+'. All geometries must have compatible attributes; make sure "'+f+'" attribute exists among all geometries, or in none of them.'),null;r[f]===void 0&&(r[f]=[]),r[f].push(u.attributes[f]),d++}if(d!==n.size)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+". Make sure all geometries have the same number of attributes."),null;if(a!==u.morphTargetsRelative)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+". .morphTargetsRelative must be consistent throughout all geometries."),null;for(const f in u.morphAttributes){if(!s.has(f))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+".  .morphAttributes must be consistent throughout all geometries."),null;o[f]===void 0&&(o[f]=[]),o[f].push(u.morphAttributes[f])}if(t){let f;if(e)f=u.index.count;else if(u.attributes.position!==void 0)f=u.attributes.position.count;else return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+". The geometry must have either an index or a position attribute"),null;c.addGroup(l,f,h),l+=f}}if(e){let h=0;const u=[];for(let d=0;d<i.length;++d){const f=i[d].index;for(let g=0;g<f.count;++g)u.push(f.getX(g)+h);h+=i[d].attributes.position.count}c.setIndex(u)}for(const h in r){const u=kl(r[h]);if(!u)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+h+" attribute."),null;c.setAttribute(h,u)}for(const h in o){const u=o[h][0].length;if(u===0)break;c.morphAttributes=c.morphAttributes||{},c.morphAttributes[h]=[];for(let d=0;d<u;++d){const f=[];for(let _=0;_<o[h].length;++_)f.push(o[h][_][d]);const g=kl(f);if(!g)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+h+" morphAttribute."),null;c.morphAttributes[h].push(g)}}return c}function kl(i){let t,e,n,s=-1,r=0;for(let l=0;l<i.length;++l){const h=i[l];if(t===void 0&&(t=h.array.constructor),t!==h.array.constructor)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes."),null;if(e===void 0&&(e=h.itemSize),e!==h.itemSize)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes."),null;if(n===void 0&&(n=h.normalized),n!==h.normalized)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes."),null;if(s===-1&&(s=h.gpuType),s!==h.gpuType)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes."),null;r+=h.count*e}const o=new t(r),a=new Te(o,e,n);let c=0;for(let l=0;l<i.length;++l){const h=i[l];if(h.isInterleavedBufferAttribute){const u=c/e;for(let d=0,f=h.count;d<f;d++)for(let g=0;g<e;g++){const _=h.getComponent(d,g);a.setComponent(d+u,g,_)}}else o.set(h.array,c);c+=h.count*e}return s!==void 0&&(a.gpuType=s),a}const I_=new Set(["position","normal","uv","color"]);function Qh(i,t={}){var o,a;i.updateMatrixWorld(!0);const e=new Map,n=[];i.traverse(c=>{var f,g;if(c===i)return;if(c.isInstancedMesh||c.userData.isSign||c.isLight){n.push(c);return}if(!c.isMesh||!((g=(f=c.geometry)==null?void 0:f.attributes)!=null&&g.position))return;const l=c.material.uuid;e.has(l)||e.set(l,{material:c.material,geos:[],cast:!1});const h=c.geometry.clone();h.applyMatrix4(c.matrixWorld);for(const _ of Object.keys(h.attributes))I_.has(_)||h.deleteAttribute(_);const u=h.attributes.position.count;h.attributes.uv||h.setAttribute("uv",new Te(new Float32Array(u*2),2)),h.attributes.color||h.setAttribute("color",new Te(new Float32Array(u*3).fill(1),3));const d=e.get(l);d.geos.push(h.index?h.toNonIndexed():h),d.cast=d.cast||c.castShadow});const s=t.colliders?new Xa(t.colliders,1):null,r=new ee;for(const{material:c,geos:l,cast:h}of e.values()){if(!l.length)continue;const u=l.length===1?l[0]:D_(l,!1);if(!u){console.error("bakeGroup: merge returned null (mismatched attributes)",c);continue}const d=((o=c.userData)==null?void 0:o.decal)===!0,f=(a=c.userData)==null?void 0:a.uvScale;f&&!d&&U_(u,f[0],f[1]),s&&!d&&k_(u,s);const g=new xt(u,c);g.castShadow=d?!1:h,g.receiveShadow=!d,d&&(g.renderOrder=2),r.add(g)}for(const c of n)r.add(c);return r}function U_(i,t,e=t){const n=i.attributes.position.count,s=i.attributes.position.array,r=i.attributes.normal.array,o=new Float32Array(n*2);for(let a=0;a<n;a++){const c=a*3,l=Math.abs(r[c]),h=Math.abs(r[c+1]),u=Math.abs(r[c+2]);let d,f;h>=l&&h>=u?(d=s[c],f=s[c+2]):l>=u?(d=s[c+2],f=s[c+1]):(d=s[c],f=s[c+1]),o[a*2]=d/t,o[a*2+1]=f/e}i.setAttribute("uv",new Te(o,2))}const jo=512,Bl=1024;function Hl(i,t,e){return((i+jo)*Bl+(t+jo))*Bl+(e+jo)}class Xa{constructor(t,e=1){this.cell=e,this.boxes=t,this.bins=new Map;for(let n=0;n<t.length;n++){const s=t[n],r=Math.floor(s.min.x/e),o=Math.floor(s.max.x/e),a=Math.floor(s.min.y/e),c=Math.floor(s.max.y/e),l=Math.floor(s.min.z/e),h=Math.floor(s.max.z/e);for(let u=r;u<=o;u++)for(let d=a;d<=c;d++)for(let f=l;f<=h;f++){const g=Hl(u,d,f);let _=this.bins.get(g);_||(_=[],this.bins.set(g,_)),_.push(n)}}this._stamp=new Int32Array(t.length),this._epoch=0,this._out=[]}near(t,e,n,s){const r=this.cell,o=this._out;o.length=0;const a=++this._epoch,c=Math.floor((t-s)/r),l=Math.floor((t+s)/r),h=Math.floor((e-s)/r),u=Math.floor((e+s)/r),d=Math.floor((n-s)/r),f=Math.floor((n+s)/r);for(let g=c;g<=l;g++)for(let _=h;_<=u;_++)for(let p=d;p<=f;p++){const m=this.bins.get(Hl(g,_,p));if(m)for(let M=0;M<m.length;M++){const v=m[M];this._stamp[v]!==a&&(this._stamp[v]=a,o.push(this.boxes[v]))}}return o}}const N_=.18,O_=.55,Gl=.75,F_=.3,Vl=.55,z_=1.2;function k_(i,t){const e=t instanceof Xa?t:new Xa(t,1),n=Array.isArray(i)?i:[i];for(const s of n)B_(s,e)}function B_(i,t){const e=i.attributes.color;if(!e||e.itemSize!==3||e.normalized||!i.attributes.normal)return;const n=i.attributes.position.array,s=i.attributes.normal.array,r=e.array,o=i.attributes.position.count;for(let a=0;a<o;a++){const c=a*3,l=s[c],h=s[c+1],u=s[c+2],d=n[c]+l*.01,f=n[c+1]+h*.01,g=n[c+2]+u*.01;let _=0;const p=t.near(d,f,g,z_);for(let M=0;M<p.length;M++){const v=p[M],S=Math.max(v.min.x-d,0,d-v.max.x),C=Math.max(v.min.y-f,0,f-v.max.y),b=Math.max(v.min.z-g,0,g-v.max.z),T=Math.sqrt(S*S+C*C+b*b);if(T>Gl*3)continue;const P=(v.min.x+v.max.x)/2-d,D=(v.min.y+v.max.y)/2-f,x=(v.min.z+v.max.z)/2-g;l*P+h*D+u*x<=0||(_+=O_*Math.exp(-T/N_)+F_*Math.exp(-T/Gl))}const m=Math.max(Vl,1-Math.min(1-Vl,_));r[c]*=m,r[c+1]*=m,r[c+2]*=m}e.needsUpdate=!0}let H_=8,G_=i=>{const t=document.createElement("canvas");return t.width=t.height=i,t};const tu=(i,t=i)=>{const e=G_(i);return e.width=i,e.height=t,e};let eu=0;function wc(i,t){return t&&(i.colorSpace=Ue),i.wrapS=i.wrapT=$r,i.anisotropy=H_,i.generateMipmaps=!0,i.minFilter=Mi,i.magFilter=gn,eu+=i.image.width*i.image.height*4*4/3,i}function Vn(i){return wc(new ci(V_(i)),!0)}function Ya(i){return i.wrapS=i.wrapT=vi,i}function V_(i){const t=tu(i.w,i.h),e=t.getContext("2d"),n=e.createImageData(i.w,i.h),s=n.data,r=i.d,o=i.w*i.h;for(let a=0,c=0,l=0;a<o;a++,c+=3,l+=4){const h=r[c],u=r[c+1],d=r[c+2];s[l]=(h<0?0:h>1?1:h)*255+.5,s[l+1]=(u<0?0:u>1?1:u)*255+.5,s[l+2]=(d<0?0:d>1?1:d)*255+.5,s[l+3]=255}return e.putImageData(n,0,0),t}const be=i=>i<0?0:i>1?1:i,Gn=i=>[(i>>16&255)/255,(i>>8&255)/255,(i&255)/255];function W_(i){const[t,e,n]=i,s=Math.max(t,e,n),r=Math.min(t,e,n),o=(s+r)/2;if(s===r)return[0,0,o];const a=s-r,c=o>.5?a/(2-s-r):a/(s+r);let l;return s===t?l=((e-n)/a+(e<n?6:0))/6:s===e?l=((n-t)/a+2)/6:l=((t-e)/a+4)/6,[l,c,o]}function q_(i,t,e){if(t===0)return[e,e,e];const n=e<.5?e*(1+t):e+t-e*t,s=2*e-n,r=o=>(o=(o%1+1)%1,o<1/6?s+(n-s)*6*o:o<1/2?n:o<2/3?s+(n-s)*(2/3-o)*6:s);return[r(i+1/3),r(i),r(i-1/3)]}function Bn(i,t=1,e=0,n=1){const[s,r,o]=W_(Array.isArray(i)?i:Gn(i));return q_(s+e/360,be(r*n),be(o*t))}function Wn(i,t){return{w:i,h:t,d:new Float32Array(i*t*3)}}function Xi(i,t){const e=Array.isArray(t)?t:Gn(t),n=i.d;for(let s=0;s<n.length;s+=3)n[s]=e[0],n[s+1]=e[1],n[s+2]=e[2]}function Tc(i,t,e,n,s){if(s<=0)return;const r=i.w,o=i.h;let a=t,c=e;(a<0||a>=r)&&(a=(a%r+r)%r),(c<0||c>=o)&&(c=(c%o+o)%o);const l=(c*r+a)*3,h=i.d,u=1-s;h[l]=h[l]*u+n[0]*s,h[l+1]=h[l+1]*u+n[1]*s,h[l+2]=h[l+2]*u+n[2]*s}function pn(i,t,e,n,s,r,o=1){const a=Array.isArray(r)?r:Gn(r),c=Math.round(t),l=Math.round(n),h=Math.round(e),u=Math.round(s);if(o<1){for(let _=h;_<u;_++)for(let p=c;p<l;p++)Tc(i,p,_,a,o);return}const d=i.w,f=i.h,g=i.d;for(let _=h;_<u;_++){let p=_;(p<0||p>=f)&&(p=(p%f+f)%f);const m=p*d;for(let M=c;M<l;M++){let v=M;(v<0||v>=d)&&(v=(v%d+d)%d);const S=(m+v)*3;g[S]=a[0],g[S+1]=a[1],g[S+2]=a[2]}}}function er(i,t,e,n,s,r=1){const o=n+1;for(let a=Math.floor(e-o);a<=Math.ceil(e+o);a++)for(let c=Math.floor(t-o);c<=Math.ceil(t+o);c++){const l=c+.5-t,h=a+.5-e,u=be(n-Math.sqrt(l*l+h*h)+.5);u>0&&Tc(i,c,a,s,r*u)}}function ja(i,t,e,n,s=1){const r=Math.max(1,e)/2;for(let o=1;o<t.length;o++){const[a,c]=t[o-1],[l,h]=t[o],u=Math.hypot(l-a,h-c),d=Math.max(1,Math.ceil(u));for(let f=0;f<=d;f++){const g=f/d;er(i,a+(l-a)*g,c+(h-c)*g,r,n,s)}}}function nu(i,t,e,n,s,r,o,a){const c=i.w,l=i.h,h=i.d,u=r/2,d=o[0],f=o[1],g=o[2],_=Math.PI*2/n;for(let p=0;p<l;p++){const m=p*c,M=t+e*Math.sin(p*_+s),v=M-u,S=M+u,C=Math.floor(v),b=Math.ceil(S);for(let T=C;T<=b;T++){const P=be(Math.min(T+1,S)-Math.max(T,v));if(P<=0)continue;const D=a*P,x=1-D;let E=T;(E<0||E>=c)&&(E=(E%c+c)%c);const U=(m+E)*3;h[U]=h[U]*x+d*D,h[U+1]=h[U+1]*x+f*D,h[U+2]=h[U+2]*x+g*D}}}const Wl=i=>i*i*(3-2*i);function X_(i,t,e){const n=new Float32Array(t*e);for(let s=0;s<n.length;s++)n[s]=i.float();return n}const ql=256;function Dn(i,t,e={}){const{p0:n=32,octaves:s=4,gain:r=.5,lacunarity:o=2,h:a=t}=e,c=e.p0x??n,l=e.p0y??n,h=new Float32Array(t*a),u=[];let d=1,f=0;for(let C=0;C<s;C++){const b=Math.min(ql,Math.max(1,Math.round(c*o**C))),T=Math.min(ql,Math.max(1,Math.round(l*o**C)));u.push({lat:X_(i,b,T),px:b,py:T,amp:d}),f+=d,d*=r}const g=new Float64Array(t*a),_=new Int32Array(t),p=new Int32Array(t),m=new Float64Array(t);for(let C=0;C<u.length;C++){const b=u[C],T=b.lat,P=b.px,D=b.py,x=b.amp,E=P/t,U=D/a;for(let O=0;O<t;O++){const K=O*E,X=K|0,V=X>=P?X%P:X;_[O]=V,p[O]=V+1>=P?0:V+1,m[O]=Wl(K-X)}for(let O=0;O<a;O++){const K=O*U,X=K|0,V=Wl(K-X),$=1-V,k=X>=D?X%D:X,at=k*P,it=(k+1>=D?0:k+1)*P,vt=O*t;for(let Gt=0;Gt<t;Gt++){const jt=_[Gt],J=p[Gt],F=m[Gt],ot=T[at+jt],et=T[at+J],ft=T[it+jt],ct=T[it+J];g[vt+Gt]+=x*((ot+(et-ot)*F)*$+(ft+(ct-ft)*F)*V)}}}let M=1/0,v=-1/0;for(let C=0;C<h.length;C++){h[C]=g[C]/f;const b=h[C];b<M&&(M=b),b>v&&(v=b)}const S=v-M||1;for(let C=0;C<h.length;C++)h[C]=(h[C]-M)/S;return h}function iu(i,t,e,n){const s=new Float32Array(t*e),r=new Float32Array(t*e),o=2*n+1,a=new Int32Array(t),c=new Int32Array(t);for(let u=0;u<t;u++)a[u]=((u-n)%t+t)%t,c[u]=(u+n+1)%t;for(let u=0;u<e;u++){const d=u*t;let f=0;for(let g=-n;g<=n;g++)f+=i[d+(g%t+t)%t];for(let g=0;g<t;g++)s[d+g]=f/o,f-=i[d+a[g]],f+=i[d+c[g]]}const l=new Int32Array(e),h=new Int32Array(e);for(let u=0;u<e;u++)l[u]=((u-n)%e+e)%e*t,h[u]=(u+n+1)%e*t;for(let u=0;u<t;u++){let d=0;for(let f=-n;f<=n;f++)d+=s[(f%e+e)%e*t+u];for(let f=0;f<e;f++)r[f*t+u]=d/o,d-=s[l[f]+u],d+=s[h[f]+u]}return r}function Y_(i,t,e=1.5,n=null){const s=n??i.length/t,r=new Uint8Array(t*s*4),o=e/8,a=new Int32Array(t),c=new Int32Array(t);for(let l=0;l<t;l++)a[l]=(l-1+t)%t,c[l]=(l+1)%t;for(let l=0;l<s;l++){const h=(l-1+s)%s*t,u=l*t,d=(l+1)%s*t;let f=u*4;for(let g=0;g<t;g++,f+=4){const _=a[g],p=c[g],m=i[h+_],M=i[h+g],v=i[h+p],S=i[u+_],C=i[u+p],b=i[d+_],T=i[d+g],P=i[d+p],D=v+2*C+P-(m+2*S+b),x=b+2*T+P-(m+2*M+v),E=-D*o,U=x*o,O=1/Math.sqrt(E*E+U*U+1);r[f]=(E*O*.5+.5)*255+.5,r[f+1]=(U*O*.5+.5)*255+.5,r[f+2]=(O*.5+.5)*255+.5,r[f+3]=255}}return r}function nr(i,t,e=1.5,n=null){const s=n??i.length/t;return wc(new ci(su(Y_(i,t,e,s),t,s)),!1)}function su(i,t,e){const n=tu(t,e),s=n.getContext("2d"),r=s.createImageData(t,e);return r.data.set(i),s.putImageData(r,0,0),n}function j_(i,t,e,n,s=null){const o=i*(s??i),a=new Uint8Array(o*4);for(let c=0,l=0;c<o;c++,l+=4){const h=t?t[c]:1,u=e?e[c]:.85,d=n?n[c]:0;a[l]=(h<0?0:h>1?1:h)*255+.5,a[l+1]=(u<0?0:u>1?1:u)*255+.5,a[l+2]=(d<0?0:d>1?1:d)*255+.5,a[l+3]=255}return a}function Mn(i,t,e,n,s=null){const r=s??i;return wc(new ci(su(j_(i,t,e,n,r),i,r)),!1)}const bc={},Ys=new Map;let ru=null;function Ze(i,t){bc[i]=t}const K_=i=>{const t=Object.keys(i).sort();return t.length?t.map(e=>e+"="+JSON.stringify(i[e])).join(","):""};function $_(i,t=null,e={}){const n=bc[i];if(!n)throw new Error(`Textures: no recipe named '${i}'`);const s=K_(e),r=s?i+"#"+s:i;if(Ys.has(r))return Ys.get(r);const o=t||(ru||new so("textures")).child("tex."+r),a=n(o,e);return a.name=i,Ys.set(r,a),a}function Z_(){var i,t;for(const e of Ys.values()){for(const n of["map","normalMap","ormMap"])(t=(i=e[n])==null?void 0:i.dispose)==null||t.call(i);if(e.maps)for(const n of e.maps)n.dispose()}Ys.clear(),eu=0,ru=null}tr(Z_);const Ko={blackbutt:{base:13214581,dark:10122054,rough:.4},spottedGum:{base:11040332,dark:8015662,rough:.38},jarrah:{base:9061685,dark:6040352,rough:.44},tasOak:{base:14072722,dark:11111779,rough:.42},pine:{base:14467213,dark:11571294,rough:.5}};Ze("timberFloor",(i,t={})=>{const o=1.9500000000000002,a=1024/o,c=1024/15,l=Math.max(2,Math.round(.004*a)),h=t.species||i.pick(Object.keys(Ko)),u=Ko[h]||Ko.blackbutt,d=Wn(1024,1024);Xi(d,Bn(u.dark,.72));const f=Gn(u.dark),g=Bn(u.base,1.25),_=[];for(let b=0;b<15;b++){const T=b*c+l/2,P=(b+1)*c-l/2,D=Bn(u.base,1+i.range(-.06,.06),i.range(-3,3));pn(d,T,0,P,1024,D);const x=Math.round(i.range(.15,.85)*1024);_.push(x),pn(d,T,x,P,x+2,Bn(u.dark,.8),.85),pn(d,T,x-2,P,x,g,.25);const E=i.int(28,60);for(let U=0;U<E;U++){const O=i.range(T+1,P-1),K=i.range(1.5,4),X=1024/i.int(2,5),V=i.range(0,Math.PI*2),$=i.range(2,3),k=i.range(.04,.12),at=i.chance(.25)?g:f;nu(d,O,K,X,V,$,at,k)}if(i.chance(.2)){const U=i.range(204.8,819.2),O=i.range(60,160),K=i.range(T+4,P-4);for(let X=0;X<i.int(2,4);X++){const V=(X+1)*i.range(3,7),$=[];for(let k=0;k<=16;k++){const at=k/16;$.push([K+(at-.5)*2*V,U-O*(1-(at-.5)**2*4)])}ja(d,$,2,f,.06)}}}const p=Dn(i,512,{p0:64,octaves:3}),m=new Float32Array(512*512),M=new Float32Array(512*512),v=new Float32Array(512*512),S=512/15,C=l*512/1024;for(let b=0;b<512;b++)for(let T=0;T<512;T++){const P=b*512+T,D=Math.floor(T/S),x=T-D*S,E=x<C/2||x>S-C/2,U=b*1024/512,O=_[D],K=U>=O-1&&U<=O+2,X=E||K;M[P]=X?.15:.75,m[P]=be(u.rough+(X?.1:0)+(p[P]-.5)*.1),v[P]=X?.72:1}return{map:Vn(d),normalMap:nr(iu(M,512,512,1),512,1.2),ormMap:Mn(512,v,m,null),uvScale:[o,o],normalScale:.5,species:h,tinted:!1}});Ze("plasterWall",(i,t={})=>{const s=t.rough??.88,r=Dn(i,256,{p0:64,octaves:3,gain:.45}),o=new Float32Array(256*256),a=.4*256/2;for(let c=0;c<256;c++)for(let l=0;l<256;l++){const h=c*256+l;let u=s+(r[h]**1.5-.5)*.1;t.ceiling||(u+=Math.cos(l/a*Math.PI*2)*.02),o[h]=be(u)}return{ormMap:Mn(256,null,o,null),uvScale:[2,2],normalScale:0,tinted:!0}});Ze("plasterCeiling",i=>bc.plasterWall(i,{rough:.93,ceiling:!0}));Ze("paintedJoinery",i=>{const n=Dn(i,256,{p0:64,octaves:3}),s=new Float32Array(256*256);for(let r=0;r<256;r++)for(let o=0;o<256;o++){const a=r*256+o;s[a]=be(.42+(n[a]-.5)*.06+Math.sin(o/256*Math.PI*2*12)*.015)}return{ormMap:Mn(256,null,s,null),uvScale:[1,1],normalScale:0,tinted:!0}});Ze("carpetPile",i=>{const n=Wn(512,512);Xi(n,[1,1,1]);const s=Dn(i,512,{p0x:64,p0y:192,octaves:3,gain:.5}),r=n.d;for(let c=0;c<512;c++)for(let l=0;l<512;l++){const h=c*512+l,u=Math.cos(c/256*Math.PI*2)*.03,d=be(.9+(s[h]-.5)*.16+u);r[h*3]=d,r[h*3+1]=d,r[h*3+2]=d}for(let c=0;c<1200;c++){const l=i.pick([[1.1,0],[.78,8],[.92,-10]]),h=Bn(16777215,l[0],l[1],1);if(l[1]!==0){const u=i.range(0,1);h[0]=h[0]*(.94+u*.12),h[2]=h[2]*(1.06-u*.12)}er(n,i.range(0,512),i.range(0,512),i.range(1,2),h,.25)}const o=Dn(i,512,{p0x:43,p0y:128,octaves:3}),a=new Float32Array(512*512);for(let c=0;c<a.length;c++)a[c]=be(.92+(o[c]-.5)*.06);return{map:Vn(n),normalMap:nr(o,512,.6),ormMap:Mn(512,null,a,null),uvScale:[1,1],normalScale:.7,tinted:!0}});Ze("ceramicTile",(i,t={})=>{const n=t.tile??.3,s=2,r=n*s,o=Math.max(2,Math.round(.003*512/r)),a=3,c=512/s,l=Gn(12104358),h=[];for(let p=0;p<s*s;p++)h.push({c:Bn(14473423,1+i.range(-.03,.03),i.range(-2,2)),g:i.range(-1,1)});const u=Wn(512,512),d=new Float32Array(512*512),f=new Float32Array(512*512),g=new Float32Array(512*512),_=o/2;for(let p=0;p<512;p++)for(let m=0;m<512;m++){const M=p*512+m,v=Math.floor(m/c),S=Math.floor(p/c),C=m-v*c,b=p-S*c,T=Math.min(C,c-C,b,c-b);if(T<_){u.d[M*3]=l[0],u.d[M*3+1]=l[1],u.d[M*3+2]=l[2],d[M]=.85,f[M]=.25,g[M]=.62;continue}const P=h[S*s+v],D=(C/c+b/c)/2,x=1.03-.06*(P.g>0?D:1-D);u.d[M*3]=be(P.c[0]*x),u.d[M*3+1]=be(P.c[1]*x),u.d[M*3+2]=be(P.c[2]*x),d[M]=.08;const E=be((T-_)/a);f[M]=.25+.75*E,g[M]=.62+.38*E}return{map:Vn(u),normalMap:nr(f,512,2),ormMap:Mn(512,g,d,null),uvScale:[r,r],normalScale:.8,tinted:!1}});Ze("fabricWeave",i=>{const n=Wn(256,256),s=new Float32Array(256*256),r=new Float32Array(256*256),o=128,a=new Float32Array(o*8),c=new Float32Array(o*8);for(let h=0;h<a.length;h++)a[h]=i.range(-.035,.035);for(let h=0;h<c.length;h++)c[h]=i.range(-.035,.035);const l=Dn(i,256,{p0:64,octaves:2});for(let h=0;h<256;h++)for(let u=0;u<256;u++){const d=h*256+u,f=(u>>1&1^h>>1&1)===0,g=u>>1,_=h>>1,p=f?a[(g*8+(h>>5&7))%a.length]:c[(_*8+(u>>5&7))%c.length],m=be((f?1.06:.94)+p+(l[d]-.5)*.06);n.d[d*3]=m,n.d[d*3+1]=m,n.d[d*3+2]=m,s[d]=f?.66:.8,r[d]=f?1:.3}return{map:Vn(n),normalMap:nr(iu(r,256,256,1),256,.8),ormMap:Mn(256,null,s,null),uvScale:[.25,.25],normalScale:.6,tinted:!0}});Ze("joineryTimber",i=>{const n=Wn(512,512);Xi(n,[1,1,1]);const s=Dn(i,512,{p0x:48,p0y:8,octaves:4}),r=n.d;for(let c=0;c<512*512;c++){const l=be(.94+(s[c]-.5)*.22);r[c*3]=l,r[c*3+1]=l,r[c*3+2]=l}const o=Bn(16777215,.72);for(let c=0;c<220;c++){const l=i.range(0,512),h=i.range(2,6),u=512/i.int(1,2),d=i.range(0,Math.PI*2);nu(n,l,h,u,d,i.range(2,3.5),o,i.range(.03,.09))}const a=new Float32Array(512*512);for(let c=0;c<a.length;c++)a[c]=be(.55+(s[c]-.5)*.08);return{map:Vn(n),ormMap:Mn(512,null,a,null),uvScale:[1,1],normalScale:0,tinted:!0}});Ze("vinylSheet",i=>{const n=Wn(512,512);Xi(n,14209732);const s=[13222578,15131093,11906460,14472902].map(Gn);for(let c=0;c<3e3;c++)er(n,i.range(0,512),i.range(0,512),i.range(1,3),i.pick(s),.35);const r=Dn(i,512,{p0:32,octaves:3}),o=new Float32Array(512*512);for(let c=0;c<o.length;c++)o[c]=be(.28+(r[c]-.5)*.12);const a={w:512,h:512,d:new Float32Array(512*512*3)};for(let c=0;c<12;c++){const l=i.range(0,512),h=i.range(0,512),u=i.range(40,120),d=i.range(0,Math.PI*2),f=i.range(.6,2.2),g=[];for(let _=0;_<=24;_++){const p=d+f*(_/24);g.push([l+Math.cos(p)*u,h+Math.sin(p)*u])}ja(n,g,i.range(2,4),Bn(14209732,.88),.3),ja(a,g,i.range(2,4),[1,1,1],1)}for(let c=0;c<o.length;c++)o[c]=be(o[c]+a.d[c*3]*.15);return{map:Vn(n),ormMap:Mn(512,null,o,null),uvScale:[1,1],normalScale:0,tinted:!1}});Ze("laminateBench",i=>{const s=Wn(512,512);Xi(s,ht.benchtop);const r=[9274743,14077886,7235417].map(Gn);for(let l=0;l<2e3;l++)er(s,i.range(0,512),i.range(0,512),i.range(1,2.5),i.pick(r),.3);const o=new Float32Array(512*512);for(let l=0;l<o.length;l++)o[l]=.28;const a=Math.max(2,Math.round(.006*512/.6)),c=Bn(ht.benchtop,.82);for(let l=0;l<512;l++)if(Math.min(l,512-l)<a)for(let u=0;u<512;u++)Tc(s,u,l,c,.85),o[l*512+u]=.45;return{map:Vn(s),ormMap:Mn(512,null,o,null),uvScale:[1.2,.6],normalScale:0,tinted:!1}});Ze("ceilingGrid",i=>{const s=Wn(512,512);Xi(s,15526370);const r=Math.max(2,Math.round(.015*512/1.2)),o=Math.max(2,Math.round(.015*512/.6)),a=Gn(14210509),c=Gn(12434098),l=Dn(i,512,{p0:64,octaves:2}),h=new Float32Array(512*512);for(let u=0;u<512;u++)for(let d=0;d<512;d++){const f=u*512+d,g=Math.min(d,512-d),_=Math.min(u,512-u);if(g<r/2||_<o/2){const M=g>=r/2-2&&g<r/2||_>=o/2-2&&_<o/2?c:a;s.d[f*3]=M[0],s.d[f*3+1]=M[1],s.d[f*3+2]=M[2],h[f]=.55}else{const m=1+(l[f]-.5)*.04;s.d[f*3]*=m,s.d[f*3+1]*=m,s.d[f*3+2]*=m,h[f]=.9}}return{map:Vn(s),ormMap:Mn(512,null,h,null),uvScale:[1.2,.6],normalScale:0,tinted:!1}});Ze("applianceEnamel",i=>{const n=Dn(i,256,{p0:64,octaves:3}),s=new Float32Array(256*256);for(let r=0;r<s.length;r++)s[r]=be(.3+(n[r]-.5)*.04);return{ormMap:Mn(256,null,s,null),uvScale:[1,1],normalScale:0,tinted:!0}});Ze("metalBrushed",i=>{const n=new Float32Array(65536),s=new Float32Array(256*256),r=Dn(i,256,{p0x:8,p0y:256,octaves:2});for(let o=0;o<256;o++){const a=i.range(-.1,.1);for(let c=0;c<256;c++){const l=o*256+c;n[l]=be(.35+a*.6+(r[l]-.5)*.1)}}return{ormMap:Mn(256,null,n,s),uvScale:[.4,.4],normalScale:0,tinted:!0}});Ze("quiltFolds",i=>{const n=[],s=i.int(5,9);for(let d=0;d<s;d++)n.push({a:i.range(.4,1),c:i.range(.05,.95),w:i.range(.06,.14)});const r=d=>{let f=0;for(const g of n)f+=g.a*Math.exp(-(((d-g.c)/g.w)**2));return f+=.5*Math.exp(-((d/.04)**2))+.5*Math.exp(-(((1-d)/.04)**2)),f};let o=1/0,a=-1/0;for(let d=0;d<=256;d++){const f=r(d/256);f<o&&(o=f),f>a&&(a=f)}const c=a-o||1,l=d=>(r(be(d))-o)/c,h=Wn(512,256),u=new Float32Array(512*256);for(let d=0;d<512;d++){const f=l(d/511),g=.9+.1*f;for(let _=0;_<256;_++){const p=_*512+d;h.d[p*3]=g,h.d[p*3+1]=g,h.d[p*3+2]=g,u[p]=f}}return{map:Ya(Vn(h)),normalMap:Ya(nr(u,512,3,256)),uvScale:null,normalScale:1,field:l,folds:n,tinted:!0}});Ze("pictureArt",i=>{const n=[[14272936,10251087,4148050,15130057],[8361635,14213090,3095106,12820586],[11056266,15196880,6056775,9067068],[13609376,8015698,15722204,3814198],[9415096,15788760,4479587,12153919]],s=[];for(let r=0;r<5;r++){const o=n[r].map(Gn),a=Wn(256,256);Xi(a,o[i.int(0,3)]);const c=i.int(0,2);if(c===0){let h=0;for(;h<256;){const u=i.int(12,48);pn(a,0,h,256,Math.min(256,h+u),o[i.int(0,3)],i.range(.5,1)),h+=u}}else if(c===1)for(let h=0;h<i.int(5,11);h++){const u=i.range(0,179.2),d=i.range(0,256*.7);pn(a,u,d,u+i.range(30,110),d+i.range(30,110),o[i.int(0,3)],i.range(.55,.95))}else{const h=i.range(115.2,174.08);pn(a,0,0,256,h,o[0],1),pn(a,0,h,256,256,o[2],1);for(let u=0;u<i.int(3,7);u++){const d=i.range(h-40,h+40);pn(a,0,d,256,d+i.range(3,10),o[i.int(0,3)],i.range(.3,.7))}er(a,i.range(256*.2,256*.8),i.range(20,h-20),i.range(12,26),o[3],.9)}const l=Bn(16777215,.97);pn(a,0,0,256,6,l),pn(a,0,250,256,256,l),pn(a,0,0,6,256,l),pn(a,250,0,256,256,l),s.push(Ya(Vn(a)))}return{maps:s,map:s[0],uvScale:null,normalScale:0,prints:5,tinted:!1}});const J_={wall:{recipe:"plasterWall",r:1,m:0,cast:!0,tint:!0},wallWet:{recipe:"ceramicTile",r:1,m:0,cast:!0,tint:!1},ceiling:{recipe:"plasterCeiling",r:1,m:0,cast:!1,tint:!0},trim:{recipe:"paintedJoinery",r:1,m:0,cast:!0,tint:!0},doorLeaf:{recipe:"paintedJoinery",r:1,m:0,cast:!0,tint:!0},floorTimber:{recipe:"timberFloor",r:1,m:0,cast:!1,tint:!1},carpet:{recipe:"carpetPile",r:1,m:0,cast:!1,tint:!0},vinyl:{recipe:"vinylSheet",r:1,m:0,cast:!1,tint:!1},tile:{recipe:"ceramicTile",r:1,m:0,cast:!1,tint:!1},joinery:{recipe:"joineryTimber",r:1,m:0,cast:!0,tint:!0},fabric:{recipe:"fabricWeave",r:1,m:0,cast:!0,tint:!0},bedding:{recipe:"fabricWeave",r:1,m:0,cast:!0,tint:!0},bench:{recipe:"laminateBench",r:1,m:0,cast:!0,tint:!1},appliance:{recipe:"applianceEnamel",r:1,m:0,cast:!0,tint:!0},metal:{recipe:"metalBrushed",r:1,m:1,cast:!0,tint:!0},chrome:{recipe:null,r:.18,m:0,cast:!0,tint:!1},ceramic:{recipe:null,r:.12,m:0,cast:!0,tint:!1},screen:{recipe:null,r:.08,m:0,cast:!1,tint:!1},glass:{recipe:null,r:.1,m:0,cast:!1,tint:!1,alpha:.28},ceilingGrid:{recipe:"ceilingGrid",r:1,m:0,cast:!1,tint:!1},quilt:{recipe:"quiltFolds",r:.8,m:0,cast:!0,tint:!0},artwork:{recipe:"pictureArt",r:.55,m:0,cast:!1,tint:!1}},ps=new Map;function Ac(i,t=16777215,e=null,n={}){const s=J_[i];if(!s)throw new Error(`Surfaces: no surface named '${i}'`);const r=Object.keys(n).sort().map(h=>h+"="+JSON.stringify(n[h])).join(","),o=i+"|"+t+"|"+r;if(ps.has(o))return ps.get(o);const a={color:t,roughness:s.r,metalness:s.m,vertexColors:!0};s.alpha!==void 0&&(a.transparent=!0,a.opacity=s.alpha,a.depthWrite=!1);const c=h=>s.alpha!==void 0?Sc(h):h;if(s.recipe){const{print:h,...u}=n,d=Object.keys(u).sort().map(m=>m+"="+JSON.stringify(u[m])).join(","),f=e?e.child("tex."+s.recipe+(d?"#"+d:"")):null,g=$_(s.recipe,f,u),_=g.maps?g.maps[Math.min(g.maps.length-1,h??0)]:g.map;if(_&&(a.map=_),g.normalMap){a.normalMap=g.normalMap;const m=g.normalScale??1;a.normalScale=new Jt(m,m)}g.ormMap?(a.aoMap=g.ormMap,a.roughnessMap=g.ormMap,a.aoMapIntensity=1,a.roughness=1,s.m===1&&(a.metalnessMap=g.ormMap,a.metalness=1)):a.roughness=s.r===1?.85:s.r;const p=c(new xn(a));return g.uvScale&&(p.userData.uvScale=g.uvScale),p.userData.cast=s.cast,p.userData.surface=i,ps.set(o,p),p}const l=c(new xn(a));return l.userData.cast=s.cast,l.userData.surface=i,ps.set(o,l),l}function Q_(){for(const i of ps.values())i.dispose();ps.clear()}tr(Q_);const Rt={wallThick:.17,storey:2.65,cornice:.09,doorH:2.05,winSill:.95,winHead:2.15,intWall:.11,skirtProud:.018,archW:.09,archProud:.018,archQuirk:.006,corniceGirth:.075,reveal:.019,skirtCommercial:.1,leafT:.035,headDatum:2.1,benchH:.9,toeKickH:.15,toeKickD:.05,cabinetModules:[.3,.45,.6,.75,.9,1,1.2],handleH:1,switchH:1.05,gpoH:.3},Se={thin:.002,furniture:.003,joinery:.005},Xl=new Set;function Ka(i,t,e={}){if(e.material)return e.material;try{return Ac(i,t,null,e.recipe||{})}catch(n){Xl.has(i)||(Xl.add(i),console.error(`RoomKit: surface '${i}' unavailable, falling back to flat colour`,n))}return vn(t,e)}function Qt(i,t,e,n,s,r={}){var l;const o=Ka(i,s,r),a=r.chamfer?cu(t,e,n,r.chamfer):r.graded?tx(t,e,n,r.gradeEdge):new te(Math.max(t,.001),Math.max(e,.001),Math.max(n,.001)),c=new xt(a,o);return c.castShadow=r.cast??((l=o.userData)==null?void 0:l.cast)??!1,c.receiveShadow=!0,c}const Ps=new Map,yi=i=>Math.round(i*1e3);function ou(i,t,e){const n=new Float32Array(e*2);for(let s=0;s<e;s++){const r=s*3,o=Math.abs(t[r]),a=Math.abs(t[r+1]),c=Math.abs(t[r+2]);a>=o&&a>=c?(n[s*2]=i[r],n[s*2+1]=i[r+2]):o>=c?(n[s*2]=i[r+2],n[s*2+1]=i[r+1]):(n[s*2]=i[r],n[s*2+1]=i[r+1])}return n}function au(i){const t=i.length*3,e=new Float32Array(t*3),n=new Float32Array(t*3);let s=0;for(const o of i){const[a,c,l]=o;let h=c[0]-a[0],u=c[1]-a[1],d=c[2]-a[2],f=l[0]-a[0],g=l[1]-a[1],_=l[2]-a[2],p=u*_-d*g,m=d*f-h*_,M=h*g-u*f;const v=(a[0]+c[0]+l[0])/3,S=(a[1]+c[1]+l[1])/3,C=(a[2]+c[2]+l[2])/3;let b=c,T=l;p*v+m*S+M*C<0&&(b=l,T=c,p=-p,m=-m,M=-M);const P=Math.hypot(p,m,M)||1;p/=P,m/=P,M/=P;for(const D of[a,b,T])e[s*3]=D[0],e[s*3+1]=D[1],e[s*3+2]=D[2],n[s*3]=p,n[s*3+1]=m,n[s*3+2]=M,s++}const r=new $e;return r.setAttribute("position",new Te(e,3)),r.setAttribute("normal",new Te(n,3)),r.setAttribute("uv",new Te(ou(e,n,t),2)),r.setAttribute("color",new Te(new Float32Array(t*3).fill(1),3)),r}function cu(i,t,e,n=Se.furniture){i=Math.max(i,.001),t=Math.max(t,.001),e=Math.max(e,.001);const s=Math.min(n,Math.min(i,t,e)/2-5e-4);if(!(s>2e-4))return new te(i,t,e);const r=`c${yi(i)},${yi(t)},${yi(e)},${yi(s)}`,o=Ps.get(r);if(o)return o;const a=i/2,c=t/2,l=e/2,h=[a-s,c-s,l-s],u=[a,c,l],d=(m,M)=>[(M===0?u[0]:h[0])*m[0],(M===1?u[1]:h[1])*m[1],(M===2?u[2]:h[2])*m[2]],f=[];for(const m of[-1,1])for(const M of[-1,1])for(const v of[-1,1])f.push([m,M,v]);const g=[],_=(m,M,v,S)=>{g.push([m,M,v]),g.push([m,v,S])};for(let m=0;m<3;m++){const M=(m+1)%3,v=(m+2)%3;for(const S of[-1,1]){const C=(b,T)=>{const P=[0,0,0];return P[m]=S,P[M]=b,P[v]=T,d(P,m)};_(C(-1,-1),C(1,-1),C(1,1),C(-1,1))}}for(let m=0;m<3;m++)for(let M=m+1;M<3;M++){const v=3-m-M;for(const S of[-1,1])for(const C of[-1,1]){const b=[0,0,0];b[m]=S,b[M]=C,b[v]=-1;const T=[0,0,0];T[m]=S,T[M]=C,T[v]=1,_(d(b,m),d(b,M),d(T,M),d(T,m))}}for(const m of f)g.push([d(m,0),d(m,1),d(m,2)]);const p=au(g);return Ps.set(r,p),p}const Cr=[0,.05,.18,.55];function Yl(i,t=.12){const e=t/.12,n=[0];for(let s=1;s<Cr.length;s++){const r=Cr[s]*e;r<i/2-1e-4&&n.push(r)}n.push(i/2);for(let s=Cr.length-1;s>=1;s--){const r=i-Cr[s]*e;r>i/2+1e-4&&n.push(r)}return n.push(i),n}function jl(i,t,e,n,s,r){const o=(a,c)=>[t[0]+e[0]*a+n[0]*c,t[1]+e[1]*a+n[1]*c,t[2]+e[2]*a+n[2]*c];for(let a=0;a<s.length-1;a++)for(let c=0;c<r.length-1;c++){const l=o(s[a],r[c]),h=o(s[a+1],r[c]),u=o(s[a+1],r[c+1]),d=o(s[a],r[c+1]);i.push([l,h,u]),i.push([l,u,d])}}function tx(i,t,e,n=.12){const s=`g${yi(i)},${yi(t)},${yi(e)},${yi(n)}`,r=Ps.get(s);if(r)return r;const o=e<=i&&e<=t?2:t<=i?1:0,[a,c,l]=o===2?[i,t,e]:o===1?[i,e,t]:[e,t,i],h=a/2,u=c/2,d=l/2,f=Yl(a,n),g=Yl(c,n),_=[];jl(_,[-h,-u,d],[1,0,0],[0,1,0],f,g),jl(_,[-h,-u,-d],[1,0,0],[0,1,0],f,g);const p=(M,v,S,C)=>{_.push([M,v,S]),_.push([M,S,C])};p([h,-u,-d],[h,u,-d],[h,u,d],[h,-u,d]),p([-h,-u,-d],[-h,u,-d],[-h,u,d],[-h,-u,d]),p([-h,u,-d],[h,u,-d],[h,u,d],[-h,u,d]),p([-h,-u,-d],[h,-u,-d],[h,-u,d],[-h,-u,d]);const m=au(_);if(o===1?m.rotateX(-Math.PI/2):o===0&&m.rotateY(Math.PI/2),o!==2){const M=m.attributes.position.array,v=m.attributes.normal.array;m.setAttribute("uv",new Te(ou(M,v,m.attributes.position.count),2))}return Ps.set(s,m),m}tr(()=>{for(const i of Ps.values())i.dispose();Ps.clear()});class ex{constructor(){this.group=new ee,this.colliders=[],this.doors=[],this.interactables=[],this.spots={},this.lights=[],this.faces={},this.decals=[]}add(t){return this.group.add(t),t}solid(t,e,n,s,r,o,a=!1){this.colliders.push({min:new I(t-s/2,e,n-o/2),max:new I(t+s/2,e+r,n+o/2),walkable:a})}spot(t,e,n,s){return this.spots[t]=new I(e,n,s),this.spots[t]}interact(t,e,n,s,r,o,a={},c=1.8){this.interactables.push({id:t,label:e,pos:new I(n,s,r),action:o,data:a,radius:c})}light(t,e,n,s=16770756,r=9,o=13){const a=new l_(s,r,o,2);return a.position.set(t,e,n),this.group.add(a),this.lights.push(a),a}}function nx(i,t,e,n,s,r,o=ht.floorTimber,a={}){const c=a.thickness??.16,l=Qt(a.surface??"floorTimber",n,c,s,o,{graded:!0,gradeEdge:a.gradeEdge??.12,cast:!1});return l.position.set(t,r-c/2,e),i.add(l),i.solid(t,r-c,e,n,c,s,!0),l}function Kl(i,t,e,n,s,r,o=ht.ceiling,a={}){const c=a.thickness??Rt.cornice,l=Qt(a.surface??"ceiling",n,c,s,o,{graded:!0,gradeEdge:a.gradeEdge??.12,cast:!1});return l.position.set(t,r+c/2,e),i.add(l),l}function ix(i,t,e,n,s=0,r={}){const o=Qt("trim",.075,.115,.01,r.colour??ht.trim,{});o.position.set(t,e,n),o.rotation.y=s,i.add(o);const a=Qt("trim",.03,.055,.004,r.colour??ht.trim,{});return a.rotation.y=s,a.position.set(t,e,n),a.translateZ(.007),i.add(a),o}function sx(i,t,e,n,s=0,r={}){const o=Qt("trim",.115,.075,.01,r.colour??ht.trim,{});return o.position.set(t,e,n),o.rotation.y=s,i.add(o),o}function Jn(i,t,e,n,s,r,o={}){const a=o.margin??Math.min(Math.max(Math.min(s,r)*.3,.05),.3);let c=t-s/2-a,l=t+s/2+a,h=e-r/2-a,u=e+r/2+a;const d=t-s/2,f=t+s/2,g=e-r/2,_=e+r/2;for(const v of i.decals){if(l<=v.x0||c>=v.x1||u<=v.z0||h>=v.z1)continue;const S=Math.min(l-v.x0,v.x1-c),C=Math.min(u-v.z0,v.z1-h);if(S<=C?t<(v.x0+v.x1)/2?l=Math.max(f,Math.min(l,v.x0)):c=Math.min(d,Math.max(c,v.x1)):e<(v.z0+v.z1)/2?u=Math.max(_,Math.min(u,v.z0)):h=Math.min(g,Math.max(h,v.z1)),l>v.x0+1e-4&&c<v.x1-1e-4&&u>v.z0+1e-4&&h<v.z1-1e-4)return null}const p=l-c,m=u-h;if(p<.05||m<.05)return null;const M=new xt(new Ge(p,m),P_());return M.rotation.x=-Math.PI/2,M.position.set((c+l)/2,n+.006,(h+u)/2),i.add(M),i.decals.push({x0:c,x1:l,z0:h,z1:u}),M}const $n=new ri;function lu(i,t,e,n){$n.setFromObject(t);const s=$n.max.x-$n.min.x,r=$n.max.z-$n.min.z;return i.solid(($n.min.x+$n.max.x)/2,e,($n.min.z+$n.max.z)/2,s,n,r),[s,r]}function rx(i,t,e,n){if(i.door===!1||i.leaf===!1||i.door===void 0&&i.leaf===void 0&&t<=1.005)return null;const s=i.door||{},r=t>=1.25,o=s.style??(i.leaf?"panel":r?"glazed":"panel");return{label:s.label??"door",style:o,pair:s.pair??r,auto:s.auto??!1,startsShut:s.startsShut??!0,face:s.swing??n,colour:s.colour??i.leaf??(o==="glazed"?ce.metal:e),surfaceName:s.surface??i.leafSurface??"doorLeaf",triggerR:s.triggerR,dwell:s.dwell,leaves:[]}}function Gi(i,t,e,n,s,r={}){const{y0:o=0,height:a=Rt.storey,thickness:c=Rt.wallThick,colour:l=ht.wall,innerColour:h=null,outerColour:u=null,openings:d=[],skirting:f=!0,skirtStyle:g="timber",cornice:_=!0,corniceStyle:p="cove",autoServices:m=!0,inner:M=null,surface:v="wall",trimColour:S=ht.trim,graded:C=!0,name:b=null}=r,T=h??u,P=n-t,D=s-e,x=Math.hypot(P,D);if(x<.01)return;const E=P/x,U=D/x,O=Math.atan2(-U,E),K=-U,X=E,V=c/2,$=(F,ot,et,ft=0,ct=0)=>(F.position.set(t+E*ot+K*ft,et,e+U*ot+X*ft),F.rotation.y=O+ct,i.add(F),F),k=(F,ot,et,ft={})=>Qt("trim",F,ot,et,ft.colour??S,ft),at=M===null?[-1,1]:[M],it=(F,ot,et,ft)=>{const ct=ot-F,Et=ft-et;if(ct<=.005||Et<=.005)return;const wt=(F+ot)/2,bt=_&&p==="shadowline"&&Math.abs(ft-(o+a))<.02,R=bt?Et-.01:Et,le=ct>=1.2&&R>=1.2,It=Qt(v,ct,R,c,l,{graded:C&&le,cast:!0});if($(It,wt,et+R/2),bt){const A=Qt(v,ct,.01,c-.02,l,{});$(A,wt,ft-.005)}const Ft=Math.abs(E)*ct+Math.abs(U)*c,St=Math.abs(U)*ct+Math.abs(E)*c,Zt=t+E*wt,mt=e+U*wt;if(i.solid(Zt,et,mt,Ft,Et,St),T)for(const A of at){const y=Qt(v,ct,R,.02,T,{graded:C&&le});$(y,wt,et+R/2,A*(V+.01))}if(f&&g&&et-o<.02)if(g==="commercial"){const A=k(ct,Rt.skirtCommercial,c+.04,{colour:ht.tileFloor,chamfer:Se.thin});$(A,wt,et+Rt.skirtCommercial/2)}else{const A=[[.112,Rt.skirtProud,0,Se.thin],[.018,.014,.112,0],[.008,.008,.13,0]];for(const[y,H,Z,tt]of A){const Q=k(ct,y,c+H*2,{chamfer:tt});$(Q,wt,et+Z+y/2)}}if(_&&p==="cove"&&Math.abs(ft-(o+a))<.02){const A=Rt.corniceGirth/Math.SQRT2;for(const y of at){const H=k(ct,Rt.corniceGirth,.008,{chamfer:0});$(H,wt,ft-A/2,y*(V+A/2)),H.rotation.order="YXZ",H.rotation.set(-y*Math.PI/4,O,0)}}},vt=(F,ot,et,ft)=>{const ct=ft-et;for(const wt of[-1,1]){const bt=k(Rt.reveal,ct,c,{});$(bt,F+wt*(ot/2-Rt.reveal/2),et+ct/2)}const Et=k(ot,Rt.reveal,c,{});$(Et,F,ft-Rt.reveal/2)},Gt=(F,ot,et,ft)=>{const ct=ot-2*Rt.reveal,Et=ct/2+Rt.archQuirk,wt=ft+Rt.archQuirk;for(const bt of[-1,1])for(const R of[-1,1]){const le=k(Rt.archW,wt-et+.002,Rt.archProud,{chamfer:Se.joinery});if($(le,F+bt*(Et+Rt.archW/2),et+(wt-et)/2,R*(V+Rt.archProud/2)),et-o<.02){const It=k(Rt.archW+.02,.15,.032,{});$(It,F+bt*(Et+Rt.archW/2),et+.075,R*(V+.016))}}for(const bt of[-1,1]){const R=k(ct+2*(Rt.archW+Rt.archQuirk),Rt.archW,Rt.archProud,{chamfer:Se.joinery});$(R,F,wt+Rt.archW/2,bt*(V+Rt.archProud/2))}},jt=[...d].sort((F,ot)=>F.at-ot.at);let J=0;for(const F of jt){const ot=F.width/2,et=Math.max(0,F.at-ot),ft=Math.min(x,F.at+ot),ct=F.kind==="window"?F.sill??Rt.winSill:0,Et=F.kind==="window"?F.head??Rt.winHead:F.head??(F.kind==="arch"?2.25:Rt.doorH);if(it(J,et,o,o+a),ct>0&&it(et,ft,o,o+ct),it(et,ft,o+Et,o+a),J=ft,F.kind==="window"){const wt=Et-ct,bt=o+(ct+Et)/2,R=M===null?1:-M,le=new xt(new te(F.width-2*Rt.reveal-.002,wt-.002,.006),Ec());le.castShadow=!1,le.receiveShadow=!0,$(le,F.at,bt,R*.015);const It=new xt(new te(F.width-2*Rt.reveal-.002,wt-.002,.006),w_());It.castShadow=!1,It.receiveShadow=!0,$(It,F.at,bt,-R*.015),vt(F.at,F.width,o+ct,o+Et),Gt(F.at,F.width,o+ct,o+Et);const Ft=Math.max(1,Math.round((F.width-2*Rt.reveal)/.9)),St=F.width-2*Rt.reveal;for(let mt=1;mt<Ft;mt++){const A=k(.04,wt,.05,{chamfer:Se.joinery});$(A,F.at-St/2+St/Ft*mt,bt)}const Zt=F.restrictor?Math.min(o+1.7,o+Et-.1):o+ct+wt/3;if(wt>.55){const mt=k(St,.04,.05,{chamfer:Se.joinery});$(mt,F.at,Zt)}if(F.restrictor){const mt=k(.06,.02,.03,{colour:ht.metalDull,chamfer:Se.thin});$(mt,F.at+St/4,o+ct+.02,0)}for(const mt of at){const A=k(F.width+.09,.025,c/2+.03,{chamfer:Se.joinery});$(A,F.at,o+ct-.0125,mt*(c/4+.015))}if(M!==null){const mt=k(F.width+.12,.04,.09,{chamfer:Se.joinery});$(mt,F.at,o+ct-.02,-M*(V+.045)),mt.rotation.order="YXZ",mt.rotation.set(M*.1,O,0)}if(F.curtains){ox(i,t+E*F.at,o+Et+.15,e+U*F.at,O,F.width+.4,{offset:(M??1)*(V+.09)});const mt=[.3,.22],A=M??1;for(const H of[-1,1]){const Z=mt[H<0?0:1],tt=F.width*Z,Q=6;for(let Tt=0;Tt<Q;Tt++){const st=tt/Q,ut=Qt("fabric",st*1.35,wt+.35,.045,F.curtains,{cast:!0}),Wt=F.at+H*(F.width/2-tt+(Tt+.5)*st);$(ut,Wt,bt+.1,A*(V+.075),Tt%2?.175:-.175)}}const y=k(F.width+.44,.12,.09,{chamfer:Se.joinery});$(y,F.at,o+Et+.21,A*(V+.055))}}else if((F.kind==="door"||F.kind==="arch")&&(vt(F.at,F.width,o,o+Et),Gt(F.at,F.width,o,o+Et),F.kind==="door")){const wt=F.swing??1,bt=F.width/2-Rt.reveal,R=V-.045;for(const Ft of[-1,1]){const St=k(.013,Et-.02,.03,{});$(St,F.at+Ft*(bt-.0055),o+(Et-.02)/2,wt*R)}const le=k(F.width-2*Rt.reveal,.014,.03,{});$(le,F.at,o+Et-.025,wt*R);const It=rx(F,F.width,S,wt);if(It){const Ft=R+.015+Rt.leafT,St=Et-Rt.reveal-.02,Zt=It.pair?bt-.006:2*bt-.006,mt=It.face,A=It.pair?[1,-1]:[mt];for(const y of A){const H=F.at+y*(bt-.003),Z=mt*Ft;It.leaves.push({hx:t+E*H+K*Z,hz:e+U*H+X*Z,y:o,baseRot:O,phiOpen:y*mt*Math.PI/2,leafRot:y>0?0:Math.PI,dx:-y*Zt/2,dz:-mt*Rt.leafT/2,lw:Zt,lh:St});for(const tt of[.15,1.02,1.89]){if(tt>St-.1)continue;const Q=Qt("chrome",.016,.1,.016,ce.metal,{chamfer:.001,cast:!1});$(Q,H,o+.015+tt,Z)}}It.centre={x:t+E*F.at,z:e+U*F.at},It.y0=o,i.doors.push(It)}}if(m&&F.kind==="door"){const wt=-(F.swing??1);for(const bt of[-1,1])ix(i,t+E*(F.at+wt*(F.width/2+Rt.archW+.15))+K*bt*(V+.006),o+Rt.switchH,e+U*(F.at+wt*(F.width/2+Rt.archW+.15))+X*bt*(V+.006),O+(bt<0?Math.PI:0))}}if(it(J,x,o,o+a),m&&M!==null&&o+Rt.gpoH<o+a){const F=Math.max(1,Math.floor(x/3.5));for(let ot=0;ot<F;ot++){const et=(ot+.5)*(x/F);jt.some(ft=>Math.abs(ft.at-et)<ft.width/2+.25)||sx(i,t+E*et+K*M*(V+.006),o+Rt.gpoH,e+U*et+X*M*(V+.006),O+(M<0?Math.PI:0))}}b&&(i.faces[b]={a:{x:t,z:e},b:{x:n,z:s},u:{x:E,z:U},n:{x:K,z:X},angle:O,thickness:c,y0:o,height:a,length:x,face:F=>({x:(t+n)/2+K*F*(c/2),z:(e+s)/2+X*F*(c/2),nx:K*F,nz:X*F,rotY:O+(F<0?Math.PI:0)})})}function ox(i,t,e,n,s=0,r=1.6,o={}){const a=new ee,c=new xt(new Ne(.0125,.0125,r,8),Ka("chrome",o.colour??ce.metalDark));c.rotation.z=Math.PI/2,a.add(c);for(const l of[-1,1]){const h=new xt(new Ti(.0175,8,6),Ka("chrome",o.colour??ce.metalDark));h.position.x=l*r/2,a.add(h)}return a.rotation.y=s,a.position.set(t,e,n),a.translateZ(o.offset??0),i.add(a),a}function ax(i,t,e,n,s=!0){const r=Qt("chrome",s?.128:.018,s?.018:.128,.018,ce.metal,{chamfer:.001,cast:!1});r.position.set(t,e,n+.032),i.add(r);for(const o of[-1,1]){const a=Qt("chrome",.01,.01,.032,ce.metal,{cast:!1});a.position.set(t+(s?o*.064:0),e+(s?0:o*.064),n+.016),i.add(a)}return r}function $a(i,t,e,n,s=0,r=ht.joineryLight){const o=typeof r=="object"&&r!==null?r:{colour:r},{colour:a=ht.joineryLight,frame:c=ht.joineryDark,collide:l=!0,seatH:h=.45}=o,u=new ee,d=.44,f=Qt("joinery",d,.018,d,a,{chamfer:.02,cast:!0});f.position.y=h-.009,u.add(f);const g=.42,_=Qt("joinery",d,g,.018,a,{chamfer:Se.furniture});_.position.set(0,h+.04+g/2,-d/2+.02),_.rotation.x=.14,u.add(_);for(const p of[-1,1]){const m=Qt("joinery",.03,g+.07,.03,c,{chamfer:Se.furniture});m.position.set(p*(d/2-.02),h+.02+(g+.07)/2,-d/2+.02),m.rotation.x=.14,u.add(m)}for(const p of[-1,1])for(const m of[-1,1]){const M=Qt("joinery",.032,h-.018,.032,c,{chamfer:Se.furniture});M.position.set(p*(d/2-.024),(h-.018)/2,m*(d/2-.024)),m<0&&(M.rotation.x=-.105),u.add(M)}for(const p of[-1,1]){const m=Qt("joinery",d-.07,.045,.016,c,{chamfer:Se.thin});m.position.set(0,h-.045,p*(d/2-.026)),u.add(m);const M=Qt("joinery",d-.07,.02,.02,c,{chamfer:Se.thin});M.position.set(0,.18,p*(d/2-.026)),u.add(M)}return u.position.set(t,n,e),u.rotation.y=s,i.add(u),l&&i.solid(t,n,e,.45,.45,.45),u}function cx(i,t,e,n,s,r,o=0,a=ht.benchtop,c=ht.joineryLight,l={}){const{shadow:h=!0,handle:u=!0}=l,d=new ee,f=Rt.toeKickH,g=Rt.toeKickD,_=.72,p=.038,m=Qt("joinery",s-.1,f,r-g,ht.shadowDark,{});m.position.set(0,f/2,-g/2),d.add(m);const M=Qt("joinery",s,_,r,c,{chamfer:Se.furniture,cast:!0});M.position.set(0,f+_/2,0),d.add(M);const v=Qt("bench",s+.04,p,r+.02,a,{chamfer:Se.joinery,cast:!0});v.position.set(0,Rt.benchH-p/2,.01),d.add(v);const S=[];let C=s;for(;C>.02;){let D=Rt.cabinetModules[0];for(const x of Rt.cabinetModules)x<=C+.001&&(D=x);(C-D<.02||S.length>12)&&(D=C),S.push(D),C-=D}let b=-s/2;for(const D of S){const x=Qt("joinery",D-.003,_-.006,.018,c,{chamfer:Se.thin,cast:!1});x.position.set(b+D/2,f+_/2,r/2+.009),d.add(x),u&&ax(d,b+D/2,f+_-.05,r/2+.018),b+=D}d.position.set(t,n,e),d.rotation.y=o,i.add(d);const[T,P]=lu(i,d,n,Rt.benchH);return h&&Jn(i,t,e,n,T,P),d}function hu(i,t,e,n,s,r,o=0,a=ht.joineryLight,c={}){const{frame:l=ht.joineryDark,height:h=.74,shadow:u=!0}=c,d=new ee,f=.03,g=Qt("joinery",s,f,r,a,{chamfer:Se.joinery,cast:!0});g.position.y=h-f/2,d.add(g);for(const m of[-1,1])for(const M of[-1,1]){const v=Qt("joinery",.06,h-f,.06,l,{chamfer:Se.furniture});v.position.set(m*(s/2-.09),(h-f)/2,M*(r/2-.09)),d.add(v)}for(const[m,M,v,S]of[[s-.24,.02,0,r/2-.09],[s-.24,.02,0,-r/2+.09],[.02,r-.24,s/2-.09,0],[.02,r-.24,-s/2+.09,0]]){const C=Qt("joinery",m,.07,M,l,{chamfer:Se.furniture});C.position.set(v,h-f-.035,S),d.add(C)}d.position.set(t,n,e),d.rotation.y=o,i.add(d);const[_,p]=lu(i,d,n,h);return u&&Jn(i,t,e,n,_,p),d}function lx(i,t,e,n,s,r,o={}){const{tileW:a=1.2,tileD:c=.6,colour:l=ht.ceiling,tee:h=ht.metalDull}=o,u=new ee,d=Math.max(1,Math.round(n/a)),f=Math.max(1,Math.round(s/c)),g=n/d,_=s/f;for(let p=0;p<d;p++)for(let m=0;m<f;m++){const M=Qt("ceilingGrid",g-.02,.014,_-.02,l,{cast:!1});M.position.set(-n/2+(p+.5)*g,-.007,-s/2+(m+.5)*_),u.add(M)}for(let p=0;p<=d;p++){const m=Qt("chrome",.024,.024,s,h,{chamfer:.001});m.position.set(-n/2+p*g,-.012,0),u.add(m)}for(let p=0;p<=f;p++){const m=Qt("chrome",n,.024,.024,h,{chamfer:.001});m.position.set(0,-.012,-s/2+p*_),u.add(m)}return u.position.set(t,r,e),i.add(u),u}const hx=.38,ux=.44,dx=2.4,fx=1.8,px=.95,mx=2.4,$l=70,Pr=.38,Zl=i=>i<0?0:i>1?1:i,gx=i=>i*i*(3-2*i);function _x(i,t,e,n="doorLeaf"){const s=new ee,r=Rt.leafT,o=.105,a=.175,c=.105,l=.14,h=Math.min(Rt.handleH+.01,t-c-l),u=(m,M,v,S,C=r,b=.005)=>{const T=Qt(n,m,M,C,e,{chamfer:b,cast:!0});return T.position.set(v,S,0),s.add(T),T};u(o,t,i/2-o/2,0),u(o,t,-i/2+o/2,0);const d=i-2*o;u(d,a,0,-t/2+a/2),u(d,c,0,t/2-c/2),u(d,l,0,-t/2+h);const f=a,g=h-l/2,_=h+l/2,p=t-c;g-f>.05&&u(d-.004,g-f-.004,0,-t/2+(f+g)/2,r-.016,.002),p-_>.05&&u(d-.004,p-_-.004,0,-t/2+(_+p)/2,r-.016,.002);for(const m of[-1,1]){const M=Qt("chrome",.052,.052,.01,ce.metal,{chamfer:.002,cast:!1});M.position.set(-i/2+.06,-t/2+Rt.handleH,m*(r/2+.005)),s.add(M);const v=Qt("chrome",.02,.02,.045,ce.metal,{chamfer:.001,cast:!1});v.position.set(-i/2+.06,-t/2+Rt.handleH,m*(r/2+.0275)),s.add(v);const S=Qt("chrome",.11,.02,.02,ce.metal,{chamfer:.001,cast:!1});S.position.set(-i/2+.115,-t/2+Rt.handleH,m*(r/2+.05)),s.add(S)}return s}function xx(i,t,e=ce.metal){const n=new ee,s=.048,r=.085,o=.07,a=.21,c=.07,l=Math.min(1.02,t-o-c-.2),h=(f,g,_,p,m=s,M=.003)=>{const v=Qt("chrome",f,g,m,e,{chamfer:M,cast:!0});return v.position.set(_,p,0),n.add(v),v};h(r,t,i/2-r/2,0),h(r,t,-i/2+r/2,0);const u=i-2*r;h(u,a,0,-t/2+a/2),h(u,o,0,t/2-o/2),h(u,c,0,-t/2+l);const d=[[-t/2+a,-t/2+l-c/2],[-t/2+l+c/2,t/2-o]];for(const[f,g]of d){const _=g-f;if(_<.08)continue;const p=new xt(new te(u-.004,_-.004,.008),Ec());p.castShadow=!1,p.receiveShadow=!0,p.position.set(0,(f+g)/2,0),n.add(p)}for(const f of[-1,1]){const g=Qt("chrome",u,a-.03,.004,e,{chamfer:.001,cast:!1});g.position.set(0,-t/2+a/2,f*(s/2+.003)),n.add(g);const _=-t/2+1.05,p=Qt("chrome",i-.17,.038,.038,e,{chamfer:.002,cast:!1});p.position.set(0,_,f*(s/2+.062)),n.add(p);for(const m of[-1,1]){const M=Qt("chrome",.026,.026,.062,e,{chamfer:.001,cast:!1});M.position.set(m*(i/2-.115),_,f*(s/2+.031)),n.add(M)}}return n}class vx{constructor(t,e,n,s){this.system=t,this.id=s,this.name=e.label||"door",this.auto=!!e.auto,this.triggerR=e.triggerR??(this.auto?dx:px),this.dwell=e.dwell??(this.auto?fx:mx),this.openTime=e.openTime??hx,this.closeTime=e.closeTime??ux,this.state=e.startsShut===!1?"open":"shut",this.phase=this.state==="open"?1:0,this._hold=0,this.isDoor=!0,this.action="door",this.data={door:this},this.radius=2,this.leaves=[];for(const c of e.leaves){const l=new ee;l.position.set(c.hx,c.y,c.hz),l.rotation.y=c.baseRot;const h=e.style==="glazed"?xx(c.lw,c.lh,e.colour):_x(c.lw,c.lh,e.colour,e.surfaceName),u=Qh(h);u.position.set(c.dx,c.lh/2+.015,c.dz),u.rotation.y=c.leafRot,l.add(u),n.add(l),this.leaves.push({pivot:l,baked:u,baseRot:c.baseRot,phiOpen:c.phiOpen})}for(const c of this.leaves)c.pivot.rotation.y=c.baseRot;n.updateMatrixWorld(!0);const r=new ri,o=new ri;for(const c of this.leaves)r.union(o.setFromObject(c.baked));r.min.y-=.05,this.collider={min:r.min.clone(),max:r.max.clone(),walkable:!1,door:this};const a=new I(e.centre.x,e.y0+1,e.centre.z);n.localToWorld(a),this.pos=a,this._trigger2=this.triggerR*this.triggerR,this._apply()}get open(){return this.state==="open"}get blocking(){return this.state==="shut"}get label(){return this.state==="shut"||this.state==="closing"?`Open the ${this.name}`:`Close the ${this.name}`}requestOpen(){if(this.state==="open"||this.state==="opening"){this._hold=this.dwell;return}this.state="opening",this.system._dirty=!0}requestClose(){return this.state==="shut"||this.state==="closing"?!0:this._occupied()?!1:(this.state="closing",!0)}toggle(){return this.state==="shut"||this.state==="closing"?(this.requestOpen(),!0):this.requestClose()}_occupied(t=null){var o;const e=this.collider,n=a=>a.x>e.min.x-Pr&&a.x<e.max.x+Pr&&a.z>e.min.z-Pr&&a.z<e.max.z+Pr,s=(o=this.system.game.player)==null?void 0:o.position;if(s&&n(s))return!0;const r=t||this.system._movers();for(const a of r)if(n(a))return!0;return!1}update(t,e,n){let s=!1;if(this.auto&&n){const r=n.x-this.pos.x,o=n.z-this.pos.z;s=r*r+o*o<this._trigger2}if(!s)for(const r of e){const o=r.x-this.pos.x,a=r.z-this.pos.z;if(o*o+a*a<this._trigger2){s=!0;break}}switch(s&&(this._hold=this.dwell,(this.state==="shut"||this.state==="closing")&&(this.state="opening",this.system._dirty=!0)),this.state){case"opening":this.phase=Zl(this.phase+t/this.openTime),this.phase>=1&&(this.phase=1,this.state="open");break;case"open":this._hold>0&&(this._hold-=t,this._hold<=0&&!this._occupied(e)&&(this.state="closing"));break;case"closing":if(this._occupied(e)){this.state="opening",this._hold=this.dwell;break}this.phase=Zl(this.phase-t/this.closeTime),this.phase<=0&&(this.phase=0,this.state="shut",this.system._dirty=!0);break}this._apply()}_apply(){const t=gx(this.phase);for(const e of this.leaves)e.pivot.rotation.y=e.baseRot+e.phiOpen*t}setVisible(t){for(const e of this.leaves)e.pivot.visible!==t&&(e.pivot.visible=t)}dispose(){var t;for(const e of this.leaves)(t=e.pivot.parent)==null||t.remove(e.pivot),e.baked.traverse(n=>{n.isMesh&&n.geometry.dispose()});this.leaves.length=0}}class Mx{constructor(t){this.game=t,this.list=[],this._blocking=[],this._dirty=!0,this._moverBuf=[],this._moverFrame=-1,this._frame=0,this.scanned=0}install(t,e){if(!t||!t.length)return[];const n=[];for(const s of t){const r=new vx(this,s,e,this.list.length);this.list.push(r),n.push(r)}return this._dirty=!0,n}get count(){return this.list.length}_movers(){var r,o,a;if(this._moverFrame===this._frame)return this._moverBuf;this._moverFrame=this._frame;const t=this._moverBuf;t.length=0;const e=this.game,n=(o=(r=e.slice)==null?void 0:r.bodies)==null?void 0:o.call(r);if(n)for(const c of n)t.push(c.pos);const s=(a=e.npcs)==null?void 0:a.list;if(s)for(const c of s)c.visible&&t.push(c.position);return t}update(t){var r;if(!this.list.length)return;this._frame++;const e=this._movers(),n=(r=this.game.player)==null?void 0:r.position,s=$l*$l;for(const o of this.list)if(o.update(t,e,n),n){const a=n.x-o.pos.x,c=n.z-o.pos.z;o.setVisible(a*a+c*c<s)}}collect(t,e,n){if(this._dirty){this._blocking.length=0;for(const l of this.list)l.blocking&&this._blocking.push(l.collider);this._dirty=!1}const s=this._blocking.length;if(!s)return n;this.scanned+=s;const r=t.x-e,o=t.x+e,a=t.z-e,c=t.z+e;for(let l=0;l<s;l++){const h=this._blocking[l];h.max.x<r||h.min.x>o||h.max.z<a||h.min.z>c||n.push(h)}return n}nearest(t,e=2){let n=null,s=e;for(const r of this.list){if(r.auto)continue;const o=r.pos.distanceTo(t);o<s&&(s=o,n=r)}return n}clear(){for(const t of this.list)t.dispose();this.list.length=0,this._blocking.length=0,this._dirty=!0}}const $o=(i,t,e,n,s={})=>{const r=new xt(new te(i,t,e),s.material||vn(n,s));return r.castShadow=s.cast!==!1,r.receiveShadow=!0,r};function yx(i,t={}){var f;const{width:e=3,height:n=.8,bg:s="#1f2933",fg:r="#f4efe4",font:o="bold 64px Georgia, serif",pad:a=24}=t,c=document.createElement("canvas");c.width=512,c.height=Math.max(32,Math.round(512*(n/e)));const l=c.getContext("2d");l.fillStyle=s,l.fillRect(0,0,c.width,c.height),t.border&&(l.strokeStyle=t.border,l.lineWidth=8,l.strokeRect(6,6,c.width-12,c.height-12)),l.fillStyle=r,l.font=o,l.textAlign="center",l.textBaseline="middle";let h=parseInt(((f=o.match(/(\d+)px/))==null?void 0:f[1])||"64",10);for(;l.measureText(i).width>c.width-a*2&&h>12;)h-=2,l.font=o.replace(/\d+px/,h+"px");l.fillText(i,c.width/2,c.height/2);const u=new ci(c);u.colorSpace=Ue,u.anisotropy=4;const d=new xt(new Ge(e,n),new ai({map:u,transparent:!0,side:kn}));return d.userData.isSign=!0,d}function Sx(i,t=1){const e=new ee,n=i.range(2.6,4.4)*t,s=new xt(new Ne(.2*t,.3*t,n,6),vn(ce.trunk,{flat:!0}));s.position.y=n/2,s.castShadow=!0,e.add(s);const r=i.weighted([{value:ce.foliage,weight:4},{value:ce.foliageLight,weight:3},{value:ce.foliageDeep,weight:2}]).value,o=i.int(2,4);for(let a=0;a<o;a++){const c=i.range(1.3,2.2)*t,l=new xt(new ho(c,0),vn(r,{flat:!0}));l.position.set(i.range(-.7,.7)*t,n+i.range(-.2,.9)*t,i.range(-.7,.7)*t),l.rotation.set(i.range(0,3),i.range(0,3),i.range(0,3)),l.castShadow=!0,l.receiveShadow=!0,e.add(l)}return e}function Ex(i,t){const e=new ee,n=$o(1.9,.72,4.3,i.pick(ce.carBodies));n.position.y=.78,e.add(n);const s=$o(1.72,.62,2.2,0,{material:b_()});s.position.set(0,1.4,-.15),e.add(s);const r=$o(1.95,.34,4.35,ce.metalDark);r.position.y=.45,e.add(r);for(const a of[-.86,.86])for(const c of[1.42,-1.42]){const l=new xt(new Ne(.34,.34,.26,10),vn(1579292));l.rotation.z=Math.PI/2,l.position.set(a,.34,c),l.castShadow=!0,e.add(l)}const o=A_();for(const a of[-.62,.62]){const c=new xt(new te(.34,.16,.08),o);c.position.set(a,.86,2.16),e.add(c);const l=new xt(new te(.3,.14,.08),R_());l.position.set(a,.86,-2.16),e.add(l)}return e.userData.headlights=o,e}const wx=.42,Tx=.34,ii=Tx+.03,Za=.7,Ja=.6,Je=.55,He=11026479,Vs=3.2,Tn=2.8,dt={x0:-5.4,x1:-1.8,z0:-3.65,z1:-2.35,cx:-3.6,cz:-3,w:3.6,d:1.3,benchH:.9},ue={x0:-1.72,z0:-2.45,x1:-.9,z1:-.55,w:.36},ms={x:-1.93,z:-2.51},Lr={x:dt.cx,y:1.78,z:dt.z0+.176,tilt:-.16,w:.48,h:.28},Ss={x0:-1.7,y:.97,z:0},bn={x0:dt.x0+.35,x1:-2.3,z:dt.z1+.55,facing:Math.PI},Jl={x:-8,screen:{y:1.22,z:1.721,w:.3,h:.22,rotY:Math.PI}},bx={x:-5.2,y:2.3,z:1.934,w:.62,h:.34,rotY:0},Ni={x:-8,z:.85,facing:0},Ax=.04,Rx=.004,Cx=.012,Px=(i,t,e)=>{const n=Math.min(i,t,e);return n<Ax?0:Math.min(Cx,Math.max(Rx,n/12))},Lx=[["tile",16777215,"kitchen floor overlay, splashbacks, partition linings"],["metal",ht.metalDull,"all stainless: pod, benches, pass, hood, shelving"],["bench",ht.benchtop,"front counter top (RoomKit counter())"],["joinery",ht.joineryLight,"tables, chairs, booths, gate, door leaves"],["joinery",ht.joineryDark,"chair frames, bins, kiosk plinths"],["joinery",ht.shadowDark,"toe kicks, recesses, coved skirting, screens off"],["trim",He,"counter fascia, kiosk pedestals, menu board, signage"],["(basic)","signAtlas","ONE canvas atlas: every label in the shop"],["(shared)","troffer emissive","luminaire faces — one material town-wide"],["(shared)","contact shadow","fixture footprint decals — one town-wide"],["trim",5208634,"cold bin: lettuce (legibility is a design requirement)"],["trim",10236968,"cold bin: tomato"],["trim",13210159,"cold bin: cheese + UHC hold slots"],["trim",8030778,"cold bin: pickle"],["trim",15261904,"cold bin: onion + mayo gun band"]],Ql=new Set;function uu(i,t,e={}){if(e.material)return e.material;try{return Ac(i,t,null,e.recipe||{})}catch(n){return Ql.has(i)||(Ql.add(i),console.error(`Fitout: surface '${i}' unavailable, flat colour instead`,n)),vn(t,e)}}function Dx(i,t,e,n,s,r={}){var h;const o=uu(i,s,r),a=r.chamfer??Px(t,e,n),c=a>0?cu(t,e,n,a):new te(Math.max(t,.001),Math.max(e,.001),Math.max(n,.001)),l=new xt(c,o);return l.castShadow=r.cast??((h=o.userData)==null?void 0:h.cast)??!1,l.receiveShadow=!0,l}function Y(i,t,e,n,s,r,o,a,c,l={}){const h=Dx(t,o,a,c,e,l);return h.position.set(n,s,r),l.rotY&&(h.rotation.y=l.rotY),i.add(h),h}const du=i=>({x:Math.sin(i),z:Math.cos(i)});function Dr(i,t,e,n,s){const r=(t+n)/2,o=(e+s)/2;Y(i,"joinery",ht.shadowDark,r,.0375,o,Math.max(Math.abs(n-t),.024),.075,Math.max(Math.abs(s-e),.024))}function Ir(i,t,e,n,s,r,o,a){const c=n-t,l=s-e;for(let h=0;h<o;h++)for(let u=0;u<a;u++){const d=t+(h+.5)*(c/o),f=e+(u+.5)*(l/a);Y(i,"metal",ht.metalDull,d,r+.035,f,1.2,.07,.6);const g=new xt(new te(1.16,.012,.56),C_());g.position.set(d,r-.006,f),i.add(g)}}function Ix(i,t,e,n=0,s=.62,r=.48){const a=du(n);Y(i,"joinery",ht.joineryDark,t,.9/2,e,s,.9,r,{rotY:n,cast:!0}),Y(i,"joinery",ht.shadowDark,t,.075,e,s-.06,.15,r-.06,{rotY:n}),Y(i,"joinery",ht.shadowDark,t+a.x*(r/2-.03),.6,e+a.z*(r/2-.03),s-.16,.34,.04,{rotY:n});const c=Y(i,"joinery",ht.joineryLight,t+a.x*(r/2+.01),.64,e+a.z*(r/2+.01),s-.2,.26,.016,{rotY:n,cast:!0});c.rotation.x=-.22,Y(i,"metal",ht.metalDull,t,.9+.02,e,s+.06,.04,r+.06,{rotY:n,cast:!0}),Y(i,"trim",He,t,.9-.07,e,s+.005,.09,r+.005,{rotY:n}),i.solid(t,0,e,Math.abs(a.z)*s+Math.abs(a.x)*r,.9+.05,Math.abs(a.z)*r+Math.abs(a.x)*s)}function th(i,t,e,n,s=0){const r={rotY:s};Y(i,"joinery",ht.joineryDark,t,n+.021,e,.17,.042,.115,r),Y(i,"trim",He,t-.045,n+.1,e,.052,.15,.052,{...r,cast:!0}),Y(i,"joinery",ht.shadowDark,t+.03,n+.075,e-.02,.038,.1,.038,{...r,cast:!0}),Y(i,"joinery",ht.joineryLight,t+.038,n+.058,e+.028,.055,.065,.055,r)}function Ux(i,t,e,n,s=7,r=.4,o=.3,a=0){for(let c=0;c<s;c++)Y(i,"trim",He,t,e+.01+c*.014,n,r,.012,o,{rotY:a,cast:c===s-1});Y(i,"joinery",ht.shadowDark,t,e+.004,n,r+.03,.008,o+.03,{rotY:a})}const Qa=4,tc=8;function cs(){return"#"+He.toString(16).padStart(6,"0")}const fu={fries:[0,0,"FRIES","#20262e"],grill:[1,0,"GRILL","#20262e"],pod:[2,0,"BUILD","#20262e"],pack:[3,0,"PACK-OUT","#20262e"],drivethru:[0,1,"DRIVE-THRU",cs()],staff:[1,1,"STAFF ONLY","#20262e"],collect:[2,1,"COLLECT",cs()],order:[3,1,"ORDER HERE",cs()],drinks:[0,2,"DRINKS","#20262e"],mccafe:[1,2,"McCAFE","#4b2e22"],barn:[2,2,"BURGER BARN",cs()],uhc:[3,2,"UHC","#20262e"],lettuce:[0,3,"LETTUCE","#4f7a3a"],tomato:[1,3,"TOMATO","#9c3428"],cheese:[2,3,"CHEESE","#c9922f"],pickle:[3,3,"PICKLE","#7a8a3a"],onion:[0,4,"ONION","#8f9784","#20262e"],ketchup:[1,4,"KETCHUP","#9c2b1f"],mustard:[2,4,"MUSTARD","#c9922f"],mayo:[3,4,"MAYO","#e6dcc4","#20262e"],bbq:[0,5,"BBQ","#5a3a26"],buns:[1,5,"BUNS","#a8763f"],wrap:[2,5,"WRAP","#20262e"],dry:[3,5,"DRY STORE","#2f5d6b"],pay:[0,6,"PAY",cs()],present:[1,6,"PRESENT",cs()],toaster:[2,6,"TOASTER","#20262e"],sauce:[3,6,"SAUCE","#20262e"]};let An=null;function pu(){if(An!==null)return An||null;if(typeof document>"u"||!document.createElement)return An=!1,null;const i=document.createElement("canvas");i.width=1024,i.height=1024;const t=i.getContext("2d");if(!t)return An=!1,null;const e=i.width/Qa,n=i.height/tc;t.clearRect(0,0,i.width,i.height);for(const[,r]of Object.entries(fu)){const[o,a,c,l,h="#f4efe4"]=r,u=o*e,d=a*n;t.fillStyle=l,t.fillRect(u+3,d+3,e-6,n-6),t.strokeStyle="rgba(0,0,0,0.35)",t.lineWidth=3,t.strokeRect(u+3,d+3,e-6,n-6),t.fillStyle=h,t.textAlign="center",t.textBaseline="middle";let f=44;for(t.font=`bold ${f}px Helvetica, Arial, sans-serif`;t.measureText(c).width>e-34&&f>12;)f-=2,t.font=`bold ${f}px Helvetica, Arial, sans-serif`;t.fillText(c,u+e/2,d+n/2)}const s=new ci(i);return s.colorSpace=Ue,s.anisotropy=4,An=new xn({map:s,roughness:.9,metalness:0,emissive:2763306,emissiveMap:s,side:Hn,transparent:!1}),An}tr(()=>{var i;An&&An.dispose&&((i=An.map)==null||i.dispose(),An.dispose()),An=null});let Qn=null;function Ur(){return Qn||(Qn=new xn({color:856342,roughness:.3,metalness:0,emissive:1454666,emissiveIntensity:.55})),Qn}tr(()=>{var i;(i=Qn==null?void 0:Qn.dispose)==null||i.call(Qn),Qn=null});function pe(i,t,e,n,s,r,o,a=0){const c=pu(),l=fu[t];if(!c||!l)return null;const[h,u]=l,d=new Ge(r,o),f=h/Qa,g=(h+1)/Qa,_=1-(u+1)/tc,p=1-u/tc;d.setAttribute("uv",new Te(new Float32Array([f,p,g,p,f,_,g,_]),2));const m=new xt(d,c);return m.position.set(e,n,s),m.rotation.y=a,i.add(m),m}const no=i=>!i.walkable&&i.max.y>wx&&i.min.y<1.7;function Nx(i,t,e){let n=t,s=e,r=0;for(let o=0;o<4;o++){let a=!1;for(const c of i){if(!no(c))continue;const l=c.min.x-ii,h=c.max.x+ii,u=c.min.z-ii,d=c.max.z+ii;if(n<=l||n>=h||s<=u||s>=d)continue;const f=[[n-l,-1,0],[h-n,1,0],[s-u,0,-1],[d-s,0,1]];f.sort((m,M)=>m[0]-M[0]);const[g,_,p]=f[0];n+=_*g,s+=p*g,r+=g,a=!0}if(!a)break}return{x:n,z:s,moved:r}}function Ox(i,t,e){let n=1/0;for(const s of i){if(!no(s))continue;const r=Math.max(s.min.x-t,0,t-s.max.x),o=Math.max(s.min.z-e,0,e-s.max.z),a=r===0&&o===0?-Math.min(t-s.min.x,s.max.x-t,e-s.min.z,s.max.z-e):Math.hypot(r,o);a<n&&(n=a)}return n===1/0?99:n}function Fx(i,t){const e=[],n=[];for(const s of t){const r=[];for(const g of i)no(g)&&s.x>g.min.x-ii&&s.x<g.max.x+ii&&s.z>g.min.z-ii&&s.z<g.max.z+ii&&r.push([+g.min.x.toFixed(2),+g.min.z.toFixed(2),+g.max.x.toFixed(2),+g.max.z.toFixed(2)]);if(r.length&&e.push({id:s.id,why:"point inside a blocking collider",boxes:r}),n.push({id:s.id,clear:+Ox(i,s.x,s.z).toFixed(3)}),s.facing==null||s.standoff==null)continue;const o=du(s.facing),a=[s.standoff-.01,s.standoff-Ja],c=[s.x+o.x*a[0],s.x+o.x*a[1]],l=[s.z+o.z*a[0],s.z+o.z*a[1]],h=Za/2,u=[Math.min(...c)-Math.abs(o.z)*h,Math.max(...c)+Math.abs(o.z)*h],d=[Math.min(...l)-Math.abs(o.x)*h,Math.max(...l)+Math.abs(o.x)*h],f=[];for(const g of i)no(g)&&(g.max.x<=u[0]+1e-6||g.min.x>=u[1]-1e-6||g.max.z<=d[0]+1e-6||g.min.z>=d[1]-1e-6||f.push([+g.min.x.toFixed(2),+g.min.z.toFixed(2),+g.max.x.toFixed(2),+g.max.z.toFixed(2)]));f.length&&e.push({id:s.id,why:`clear floor ${Za} x ${Ja} obstructed`,rect:[+u[0].toFixed(2),+d[0].toFixed(2),+u[1].toFixed(2),+d[1].toFixed(2)],boxes:f})}return n.sort((s,r)=>s.clear-r.clear),{failures:e,tightest:n.slice(0,8)}}function zx(i,t={}){const e=t.width??20,n=t.depth??14,s=e/2,r=n/2,o=s-Rt.wallThick/2,a=r-Rt.wallThick/2,c=ht.metalDull,l=ht.joineryLight,h=ht.joineryDark,u=ht.shadowDark,d=[],f=(L,N,W,nt=null,pt=null,qt={})=>{d.push({name:L,x:N,z:W,facing:nt,standoff:pt,noClamp:!!qt.noClamp})},g=1.4;Y(i,"tile",16777215,(-o+7.9)/2,.003,(-a+g)/2,o+7.9,.006,g+a,{cast:!1,chamfer:0}),Y(i,"tile",16777215,(7.9+o)/2,.003,(-5+g)/2,o-7.9,.006,g+5,{cast:!1,chamfer:0}),Dr(i,-o+.02,-a+.04,3.25,-a+.04),Dr(i,-o+.04,-a,-o+.04,g),Dr(i,o-.04,-5,o-.04,g);const _=-a+.375,p=-a+.75,m=-9.6,M=-6.7,v=(m+M)/2,S=M-m;Y(i,"metal",c,v,.45,_,S,.9,.75,{cast:!0}),Y(i,"joinery",u,v,.075,_+.02,S-.1,.15,.66),i.solid(v,0,_,S,.9,.75);const C=1.12;Y(i,"tile",16777215,v,1.5,-a+.02,S+.4,1.2,.02,{cast:!1,chamfer:0}),Y(i,"metal",c,v,1.01,_,2.1,.22,.62,{cast:!0});for(const L of[-.7,-.23,.24])Y(i,"joinery",u,v+L,C,_,.32,.03,.42),Y(i,"trim",13210159,v+L,C-.03,_,.28,.01,.38,{chamfer:0}),Y(i,"metal",c,v+L,C+.16,_-.26,.03,.3,.03),Y(i,"metal",c,v+L,C+.3,_-.2,.03,.03,.16);Y(i,"metal",c,v+.95,1.06,_,.75,.1,.62,{cast:!0}),Y(i,"metal",c,v+.95,1.24,_-.26,.7,.04,.04),Y(i,"trim",He,v+.95,1.14,_+.1,.3,.06,.22),pe(i,"fries",v,1.62,-a+.05,.9,.26,0),Y(i,"metal",c,v,2.24,_+.15,S+.3,.42,1,{cast:!0});const b=1.06,T=-4.3,P=-.3,D=(T+P)/2,x=P-T;Y(i,"metal",c,D,.45,_,x,.9,.75,{cast:!0}),Y(i,"joinery",u,D,.075,_+.02,x-.1,.15,.66),i.solid(D,0,_,x,.9,.75),Y(i,"tile",16777215,D,1.5,-a+.02,x+.4,1.2,.02,{cast:!1,chamfer:0}),Y(i,"metal",c,D,.98,_,2.6,.16,.62,{cast:!0});for(const L of[-.65,.65])Y(i,"joinery",u,D+L,b,_,1.1,.02,.5);Y(i,"metal",c,D,b+.1,_-.3,2.6,.2,.03,{cast:!0}),Y(i,"metal",c,D+1.35,b+.02,_+.16,.1,.02,.16),Y(i,"joinery",u,D+1.35,b+.06,_+.24,.03,.07,.1),pe(i,"grill",D,1.62,-a+.05,.9,.26,0),Y(i,"metal",c,D,2.24,_+.15,x+.4,.42,1,{cast:!0}),Y(i,"metal",c,D,2.62,_+.15,.34,.36,.34),Y(i,"metal",c,1.35,1,_+.02,1.6,2,.7,{cast:!0}),i.solid(1.35,0,_+.02,1.6,2,.7);for(const L of[-.4,.4])Y(i,"joinery",u,1.35+L,1,_+.38,.72,1.86,.02),Y(i,"metal",c,1.35+L-.3,1.05,_+.4,.04,.6,.04);const E=Rt.intWall,U=3.3,O=-4.55,K={height:Tn,surface:"tile",colour:16777215,thickness:E,skirting:!1,cornice:!1,trimColour:ht.trim};Gi(i,U,-a,U,O,{...K,inner:-1,autoServices:!1,name:"dryWest"}),Gi(i,U,O,o,O,{...K,inner:1,autoServices:!1,openings:[{at:.95,width:1,kind:"door",head:Rt.headDatum,door:{startsShut:!1,style:"panel",label:"dry store"}}],name:"drySouth"}),pe(i,"staff",U+.006+E/2,1.85,-5.7,.7,.22,Math.PI/2),pe(i,"dry",U+1.85,2.3,O+E/2+.006,.9,.26,0);const X={x0:3.75,x1:6.05,z0:-a+.05,z1:-5.35},V=(X.x0+X.x1)/2,$=(X.z0+X.z1)/2;Y(i,"metal",c,V,1.2,$,X.x1-X.x0,2.4,X.z1-X.z0,{cast:!0}),i.solid(V,0,$,X.x1-X.x0,2.4,X.z1-X.z0),Y(i,"joinery",u,V+.4,1.05,X.z1+.012,.8,1.9,.03),Y(i,"metal",c,V+.72,1.05,X.z1+.03,.05,.3,.05),Y(i,"metal",c,V,2.55,$,.9,.3,.7,{cast:!0});for(let L=0;L<4;L++)Y(i,"metal",c,7.15,.15+L*.44,-a+.25,1.7,.03,.45),L>0&&(Y(i,"joinery",l,6.8,.29+L*.44,-a+.25,.55,.24,.38,{cast:!0}),Y(i,"joinery",h,7.6,.27+L*.44,-a+.25,.55,.21,.36));i.solid(7.15,0,-a+.25,1.7,1.6,.45),Y(i,"joinery",l,7.9,.16,-6.1,.55,.32,.45,{cast:!0}),Y(i,"joinery",h,7.8,.44,-6.05,.42,.24,.38,{cast:!0}),Dr(i,U+E/2,-a,U+E/2,O),Ir(i,U,-a,o-1,O,Tn,2,1);const k={cx:4.7,cz:-2.5,w:3,d:.75};Y(i,"metal",c,k.cx,.45,k.cz,k.w,.9,k.d,{cast:!0}),Y(i,"joinery",u,k.cx,.075,k.cz,k.w-.1,.15,k.d-.08),i.solid(k.cx,0,k.cz,k.w,.9,k.d),Jn(i,k.cx,k.cz,0,k.w,k.d);for(let L=0;L<3;L++)Y(i,"trim",He,k.cx-1.05,.98+L*.09,k.cz,.34,.08,.26);Ux(i,k.cx-.3,.9,k.cz,7);for(let L=0;L<4;L++)Y(i,"joinery",l,k.cx+.6,.96+L*.11,k.cz,.42,.1,.42,{cast:L===3});Y(i,"joinery",l,k.cx+1.2,.97,k.cz,.36,.14,.36,{cast:!0}),pe(i,"pack",k.cx,1.6,k.cz-k.d/2-.02,.9,.26,Math.PI);const at=o-.375;Y(i,"metal",c,at,.45,-2.7,.75,.9,4.5,{cast:!0}),Y(i,"joinery",u,at,.075,-2.7,.66,.15,4.4),i.solid(at,0,-2.7,.75,.9,4.5),Jn(i,at,-2.7,0,.75,4.5),Y(i,"joinery",u,at-.05,1.02,-4.2,.3,.2,.36,{cast:!0}),Y(i,"joinery",u,at-.11,1.22,-4.2,.03,.24,.32,{cast:!0}),Y(i,"metal",c,at,.94,-1,.6,.04,.8),Y(i,"metal",c,o-.06,1.55,-2.7,.05,.22,.05,{cast:!0}),Y(i,"joinery",u,o-.1,1.62,-2.7,.14,.14,.1,{cast:!0}),Y(i,"joinery",u,o-.05,1.75,-2.7,.05,.4,.6,{cast:!0});{const L=new xt(new Ge(.52,.32),Ur());L.position.set(o-.07,1.75,-2.7),L.rotation.y=-Math.PI/2,i.add(L)}Y(i,"metal",c,o-.25,1.25,-2.7,.45,.03,1.1),Y(i,"trim",He,o-.25,1.32,-2.35,.3,.1,.22,{cast:!0}),Y(i,"joinery",l,o-.25,1.34,-3,.28,.14,.3,{cast:!0}),pe(i,"pay",o-.02,2.3,-4.2,.6,.2,-Math.PI/2),pe(i,"present",o-.02,2.3,-1,.75,.2,-Math.PI/2),pe(i,"drivethru",o-.02,2.58,-2.6,1.1,.26,-Math.PI/2);const it=dt.benchH;Y(i,"metal",c,dt.cx,.45,dt.cz,dt.w,.9,dt.d,{cast:!0}),Y(i,"joinery",u,dt.cx,.075,dt.cz,dt.w-.1,.15,dt.d-.1),i.solid(dt.cx,0,dt.cz,dt.w,.9,dt.d),Jn(i,dt.cx,dt.cz,0,dt.w,dt.d);for(const[L,N]of[[0,He],[1,13210159],[2,5208634],[3,l]]){const W=dt.x0+.55+L*.85;for(let nt=0;nt<4;nt++)Y(i,"trim",N,W,.24+nt*.13,dt.z1-.16,.4,.11,.26,{chamfer:0})}const vt=-4.9;Y(i,"metal",c,vt,it+.31,dt.cz-.1,.85,.62,.62,{cast:!0}),Y(i,"joinery",u,vt,it+.63,dt.cz-.1,.6,.03,.3);const Gt=Y(i,"metal",c,vt,it+.16,dt.cz+.38,.6,.02,.42,{cast:!0});Gt.rotation.x=.42,Y(i,"trim",He,vt,it+.5,dt.cz+.22,.6,.08,.02),pe(i,"toaster",vt,it+.36,dt.cz+.225,.44,.14,0),Y(i,"metal",c,dt.x0-.55,.6,dt.cz,.7,1.2,.9,{cast:!0}),i.solid(dt.x0-.55,0,dt.cz,.7,1.2,.9);for(let L=0;L<3;L++)Y(i,"joinery",l,dt.x0-.55,.35+L*.32,dt.cz,.62,.16,.8);pe(i,"buns",dt.x0-.55,1.32,dt.cz+.46,.5,.16,0);const jt=-4;Y(i,"metal",c,jt,it+.1,dt.cz-.25,.7,.2,.45,{cast:!0});const J=[["ketchup",10236968],["mustard",13210159],["mayo",15261904],["bbq",8030778]];J.forEach(([L,N],W)=>{const nt=jt-.255+W*.17;Y(i,"metal",c,nt,it+.3,dt.cz-.25,.06,.22,.06,{cast:!0}),Y(i,"trim",N,nt,it+.43,dt.cz-.25,.05,.05,.05,{chamfer:0}),pe(i,L,nt,it+.135,dt.cz-.02,.15,.06,0)});const F=-3.58;Y(i,"joinery",u,-3.1,it+.015,dt.cz-.08,1,.05,.6);const ot=[["pickle",8030778],["onion",15261904],["lettuce",5208634],["tomato",10236968],["cheese",13210159]];ot.forEach(([L,N],W)=>{const nt=F+.1+W*.19;Y(i,"metal",c,nt,it+.045,dt.cz-.08,.165,.09,.54),Y(i,"trim",N,nt,it+.075,dt.cz-.08,.13,.05,.48,{chamfer:0}),pe(i,L,nt,it-.1,dt.z1+.006,.17,.075,0)});const et=-2.2;Y(i,"metal",c,et,it+.38,dt.cz,.78,.76,.68,{cast:!0});for(let L=0;L<3;L++)for(const N of[1,-1])Y(i,"joinery",u,et,it+.14+L*.24,dt.cz+N*.345,.64,.16,.02),Y(i,"trim",13210159,et,it+.11+L*.24,dt.cz+N*.3,.56,.03,.06,{chamfer:0});pe(i,"uhc",et,it+.86,dt.cz+.01,.4,.16,0),Y(i,"joinery",l,ms.x,it+.02,ms.z,.3,.04,.34,{cast:!0}),pe(i,"wrap",-1.95,it-.1,dt.z1+.006,.3,.1,0);{const L=ue.x1-ue.x0,N=ue.z1-ue.z0,W=Math.hypot(L,N),nt=Math.atan2(-N,L)+Math.PI/2,pt=(ue.x0+ue.x1)/2,qt=(ue.z0+ue.z1)/2,ve=Y(i,"metal",c,pt,.965,qt,ue.w,.03,W,{rotY:nt,cast:!0});ve.rotation.x=-.045;for(const xe of[-1,1]){const $t=Y(i,"metal",c,pt,.995,qt,.03,.06,W,{rotY:nt});$t.translateX(xe*(ue.w/2-.015)),$t.rotation.x=-.045}for(const[xe,$t]of[[ue.x0+.1,ue.z0+.22],[ue.x1-.1,ue.z1-.25]])Y(i,"metal",c,xe,.47,$t,.05,.94,.05);for(let xe=0;xe<3;xe++){const $t=xe/3,Oe=(xe+1)/3,ln=ue.x0+L*$t,Us=ue.x0+L*Oe,Ns=ue.z0+N*$t,In=ue.z0+N*Oe;i.solid((ln+Us)/2,.6,(Ns+In)/2,Math.abs(Us-ln)+ue.w,.5,Math.abs(In-Ns)+.06)}}Y(i,"metal",c,dt.cx,1.28,dt.z0+.06,.05,.8,.05,{cast:!0}),Y(i,"metal",c,dt.cx,1.66,dt.z0+.09,.06,.05,.1);{const L=Y(i,"joinery",u,dt.cx,1.78,dt.z0+.14,.56,.36,.035,{cast:!0});L.rotation.x=-.16;const N=Y(i,"joinery",u,dt.cx,1.78,dt.z0+.165,.5,.3,.008,{chamfer:0});N.rotation.x=-.16;const W=new xt(new Ge(.48,.28),Ur());W.position.set(dt.cx,1.78,dt.z0+.172),W.rotation.x=-.16,i.add(W)}pe(i,"pod",dt.cx,2.05,dt.z0+.1,.6,.2,0);const ft=.6,ct=2.45,Et=3.55,wt=-2.65,bt=-1.95;for(const[L,N]of[[-o,wt],[bt,ct],[Et,o]]){const W=(L+N)/2,nt=N-L;Y(i,"metal",c,W,.45,0,nt,.9,ft,{cast:!0}),Y(i,"joinery",u,W,.075,0,nt-.1,.15,ft-.08),i.solid(W,0,0,nt,.9,ft)}Jn(i,(-o+wt)/2,0,0,wt+o,ft);{const L=Y(i,"metal",c,wt+.03,1.24,0,.05,bt-wt,ft-.04,{cast:!0});L.rotation.z=.2}Y(i,"metal",c,-.9,.945,0,1.6,.05,ft+.06,{cast:!0});for(const L of[-.7,.7])Y(i,"metal",c,-.9+L,1.22,0,.04,.5,.04);Y(i,"metal",c,-.9,1.44,0,1.56,.04,.05);for(const L of[-.4,.2]){Y(i,"trim",He,-.9+L,1.38,0,.28,.1,.2,{cast:!0});const N=new xt(new te(.2,.02,.14),T_());N.position.set(-.9+L,1.325,0),i.add(N)}i.doors.push({label:"staff gate",style:"panel",pair:!1,auto:!0,startsShut:!0,face:-1,colour:l,surfaceName:"joinery",triggerR:1.2,dwell:1,leaves:[{hx:Et-.003,hz:0,y:0,baseRot:0,phiOpen:-Math.PI/2,leafRot:0,dx:-1.0939999999999996/2,dz:Rt.leafT/2,lw:Et-ct-.006,lh:1}],centre:{x:(ct+Et)/2,z:0},y0:0});const R={z:1.8,d:.8,x0:-o,x1:ct},le=(R.x0+R.x1)/2,It=R.x1-R.x0;cx(i,le,R.z,0,It,R.d,0,ht.benchtop,l,{handle:!1}),Y(i,"trim",He,le,.52,R.z+R.d/2+.03,It,.6,.02),pe(i,"barn",R.x0+1.6,.62,R.z+R.d/2+.05,1.4,.34,0);const Ft=-8;Y(i,"joinery",u,Ft,1.02,R.z,.36,.2,.3,{cast:!0}),Y(i,"joinery",u,Ft,1.22,R.z-.06,.32,.24,.03,{cast:!0}),Y(i,"metal",c,Ft,.98,R.z+.3,.14,.16,.1),pe(i,"order",Ft,1.42,R.z+R.d/2+.01,.8,.22,0);const St=-5.2;Y(i,"metal",c,St,1.06,R.z,1.6,.04,R.d+.1);for(const L of[-.72,.72])Y(i,"metal",c,St+L,.98,R.z,.05,.16,.05);pe(i,"collect",St,1.28,R.z+.12,.9,.24,0),Y(i,"metal",c,St,2.62,R.z+.1,.05,.36,.05),Y(i,"joinery",u,St,2.3,R.z+.1,.72,.44,.05,{cast:!0});{const L=new xt(new Ge(.64,.36),Ur());L.position.set(St,2.3,R.z+.13),i.add(L)}pe(i,"collect",St,2.62,R.z+.135,.6,.2,0);const Zt=.2;Y(i,"metal",c,Zt,1.12,R.z-.1,.72,.44,.5,{cast:!0}),Y(i,"joinery",u,Zt,1.1,R.z+.16,.6,.24,.04);for(const L of[-.18,.1])Y(i,"metal",c,Zt+L,.96,R.z+.12,.05,.12,.05);Y(i,"joinery",l,Zt+.55,.99,R.z-.15,.28,.18,.28);const mt=1.55;Y(i,"joinery",h,mt,.96,R.z,1.2,.1,.7,{cast:!0}),Y(i,"metal",c,mt,1.46,R.z,1.2,.05,.7,{cast:!0});for(const L of[-1,1])Y(i,"metal",c,mt+L*.575,1.21,R.z,.05,.45,.66);const A=new xt(new te(1.1,.42,.62),uu("glass",13623528));A.position.set(mt,1.215,R.z),i.add(A),Y(i,"joinery",l,mt,1.19,R.z,1.06,.02,.56);for(const[L,N,W]of[[-.35,-.12,He],[0,.1,13210159],[.33,-.08,l]])Y(i,"trim",W,mt+L,1.06+.035,R.z+N,.16,.07,.16,{chamfer:0}),Y(i,"trim",W,mt+L*.7,1.23,R.z-N,.14,.06,.14,{chamfer:0});pe(i,"mccafe",Zt+1.15,.62,R.z+R.d/2+.05,.9,.26,0),Y(i,"trim",He,-3.6,2.44,R.z-.55,5.8,.58,.06,{cast:!0}),pe(i,"barn",-5.6,2.44,R.z-.51,1.6,.4,0),pe(i,"order",-1.8,2.44,R.z-.51,1.5,.36,0);const y={x:o-.35,z0:.9,z1:2.5},H=(y.z0+y.z1)/2;Y(i,"metal",c,y.x,.45,H,.7,.9,y.z1-y.z0,{cast:!0}),i.solid(y.x,0,H,.7,.9,y.z1-y.z0),Jn(i,y.x,H,0,.7,y.z1-y.z0),Y(i,"metal",c,y.x+.1,1.24,H-.25,.3,.68,.86,{cast:!0}),Y(i,"joinery",u,y.x-.075,1.34,H-.25,.02,.4,.74);for(let L=0;L<3;L++){const N=H-.51+L*.26;Y(i,"trim",[10236968,8030778,13210159][L],y.x-.085,1.34,N,.01,.3,.19,{chamfer:0}),Y(i,"metal",c,y.x-.1,1.02,N,.05,.14,.05,{cast:!0}),Y(i,"metal",c,y.x-.15,1.11,N,.1,.03,.03)}Y(i,"metal",c,y.x-.11,.925,H-.25,.24,.02,.8),Y(i,"joinery",u,y.x-.11,.935,H-.25,.18,.01,.74);for(const[L,N]of[[H+.42,6],[H+.6,5]])for(let W=0;W<N;W++)Y(i,"joinery",13620957,y.x,.95+W*.055,L,.115,.055,.115,{cast:W===N-1,chamfer:0});pe(i,"drinks",o-.02,1.85,H,.9,.26,-Math.PI/2),Ix(i,o-.42,3.3,-Math.PI/2);const Z=-9.55;for(const L of[4.3,5.45]){Y(i,"metal",c,Z,.05,L,.44,.1,.38),Y(i,"trim",He,Z,.62,L,.38,1.04,.3,{cast:!0}),Y(i,"metal",c,Z,1.16,L,.42,.05,.34);const N=Y(i,"joinery",u,Z+.13,1.42,L,.035,.56,.44,{cast:!0});N.rotation.z=.26;const W=new xt(new te(.02,.48,.37),Ur());W.position.set(Z+.165,1.42,L),W.rotation.z=.26,i.add(W),Y(i,"metal",c,Z+.1,1.08,L+.22,.11,.13,.09),i.solid(Z,0,L,.44,1.7,.42),Jn(i,Z,L,0,.48,.44)}pe(i,"order",-o+.02,1.62,4.88,.6,.2,Math.PI/2);const Q=a-.03-.03,Tt=[{x:-6.9,z:3.8},{x:-4.3,z:3.8},{x:-6.9,z:5.55},{x:-4.3,z:5.55},{x:2.9,z:3.8},{x:5.7,z:3.8},{x:8.3,z:3.8}];Tt.forEach((L,N)=>{const W=N+1;hu(i,L.x,L.z,0,.8,.8),$a(i,L.x-.72,L.z,0,Math.PI/2),$a(i,L.x+.72,L.z,0,-Math.PI/2),Y(i,"metal",c,L.x,.86,L.z,.035,.24,.035),th(i,L.x+.22,L.z+.16,.74),f(`table_${W}`,L.x,L.z,null,null,{noClamp:!0})});const st=Q,ut=st-1.7,Wt=2.6,rt=9.4,yt=2,Ut=(rt-Wt)/yt;for(let L=0;L<yt;L++){const N=Wt+(L+.5)*Ut;for(const[W,nt,pt]of[[ut+.265,ut+.06,.95],[st-.265,st-.06,.55]])Y(i,"joinery",l,N,.23,W,Ut-.1,.46,.53,{cast:!0}),Y(i,"joinery",u,N,.075,W,Ut-.2,.15,.43),Y(i,"joinery",l,N,pt/2,nt,Ut-.1,pt,.12,{cast:!0});Y(i,"joinery",l,N,.725,(ut+st)/2,Ut-.2,.03,.7,{cast:!0}),Y(i,"joinery",h,N,.36,(ut+st)/2,.09,.71,.09),th(i,N+.28,(ut+st)/2,.74),i.solid(N,0,(ut+st)/2,Ut,.95,st-ut)}for(const L of[0,Ut,Ut*yt]){const N=Wt+L;Y(i,"joinery",l,N,.675,(ut+st)/2,.07,1.35,st-ut-.06,{cast:!0}),Y(i,"trim",He,N,1.32,(ut+st)/2,.086,.06,st-ut-.06)}Jn(i,(Wt+rt)/2,(ut+st)/2,0,rt-Wt,st-ut,{margin:.028});const Nt=Q-.35;Y(i,"joinery",l,-6.3,1.03,Nt,6.2,.05,.64,{cast:!0});for(const L of[-2.6,0,2.6])Y(i,"metal",c,-6.3+L,.5,Nt+.2,.06,1,.06);i.solid(-6.3,0,Nt,6.2,1.05,.64);for(const L of[-8.5,-7.2,-5.9,-4.6])Y(i,"joinery",l,L,.72,Nt-.75,.36,.04,.36,{cast:!0}),Y(i,"metal",c,L,.36,Nt-.75,.07,.68,.07),Y(i,"metal",c,L,.02,Nt-.75,.34,.04,.34),i.solid(L,0,Nt-.75,.4,.75,.4);const gt=16772056;i.light(-6.5,Vs-.15,4.2,gt,10,13),i.light(-2,Vs-.15,4.6,gt,10,13),i.light(2.5,Vs-.15,4.2,gt,10,13),i.light(7,Vs-.15,4.4,gt,10,13),i.light(-3.7,Tn-.15,1,gt,10,12),i.light(-7.5,Tn-.15,-4.8,gt,10,12),i.light(-.5,Tn-.15,-5,gt,10,12),i.light(-3.6,Tn-.15,-2.6,gt,12,12),i.light(6.8,Tn-.3,-5.5,gt,8,9),i.light(8.8,Tn-.15,-2.6,gt,9,10),i.light(5,Tn-.15,-1.6,gt,8,10);for(const[L,N,W,nt,pt]of[[-1.5,1.9,-3.2,2.4,15],[-3,2.1,4.2,3.4,16],[5.5,2.1,4,2.8,13],[-7.6,2,4.9,2.2,11],[-4,1.9,1,1.6,12]]){const qt=i.light(L,N,W,15260876,nt,pt);qt.decay=1}Ir(i,-9.4,-6.6,3.1,.2,Tn,4,3),Ir(i,3.6,-4.3,9.6,-.2,Tn,2,2),Ir(i,-9,2.4,9.4,6.4,Vs,4,2),f("spawn",-1,12.6,null,null,{noClamp:!0}),f("station_pod",dt.cx,dt.z1+Je,Math.PI,Je),f("station_fries",v,p+Je,Math.PI,Je),f("station_grill",D,p+Je,Math.PI,Je),f("station_counter",Ft,R.z-R.d/2-Je,0,Je),f("station_runner",St,R.z-R.d/2-Je,0,Je),f("station_drivethru",at-.375-Je,-2.7,Math.PI/2,Je),f("restock",7,-5.7,Math.PI,Je),f("gate",(ct+Et)/2,0,null,null,{noClamp:!0}),f("entry_out",-1,8.3,null,null,{noClamp:!0}),f("entry",-1,6),f("aisle",-2,2.9),f("queue_1",-8,2.8),f("queue_2",-7.25,2.95),f("queue_3",-6.5,3),f("queue_4",-5.9,3.15),f("collect_wait",-5.2,3.1),f("kiosk_gate",-8.9,2.9),f("kiosk_1",-8.78,4.3),f("kiosk_2",-8.85,5.15),i.interact("station_pod","work the pod",dt.cx,.95,dt.z1,"station",{station:"pod",zone:{minZ:dt.z1}},2),i.interact("pod_toaster","toast a bun",vt,1.25,dt.cz+.21,"pod",{op:"token",token:"bun",podOnly:!0},1.8),J.forEach(([L],N)=>{const W=jt-.255+N*.17;i.interact("pod_gun_"+L,L==="bbq"?"dose BBQ":"dose "+L,W,1.25,dt.cz-.25,"pod",{op:"token",token:L,podOnly:!0},1.7)}),ot.forEach(([L],N)=>{const W=F+.1+N*.19;i.interact("pod_bin_"+L,"add "+L,W,.98,dt.cz-.08,"pod",{op:"token",token:L,podOnly:!0},1.7)}),i.interact("pod_uhc","pull from the cabinet",et,1.28,dt.cz+.345,"pod",{op:"uhc",podOnly:!0},1.6),i.interact("pod_wrap","wrap the order",ms.x,.95,ms.z,"pod",{op:"wrap",podOnly:!0},1.4),i.interact("pod_chute","send it down",ue.x0+.05,1.05,ue.z0,"pod",{op:"send",podOnly:!0},1.4),i.interact("landing_handover","hand the order over",-.9,1,0,"landing",{when:"landing_ready"},1.25),i.interact("station_counter","work the counter",Ft,.95,R.z-R.d/2,"station",{station:"counter",zone:{maxZ:R.z-R.d/2}},1.8),i.interact("till_order","take their order",Ft,1.3,R.z+.95,"counter",{op:"take_order",when:"queue_head"},2.4),i.interact("till_payment","take payment",Ft,1,R.z+.3,"counter",{op:"take_payment",when:"payment_due"},1.6);const Kt=[];for(const L of d){const N=L.noClamp?{x:L.x,z:L.z,moved:0}:Nx(i.colliders,L.x,L.z);i.spot(L.name,N.x,0,N.z),N.moved>.005&&Kt.push({name:L.name,from:[L.x,L.z],to:[+N.x.toFixed(3),+N.z.toFixed(3)],moved:+N.moved.toFixed(3)})}const Bt=Fx(i.colliders,d.filter(L=>!L.noClamp).map(L=>({id:L.name,x:L.x,z:L.z,facing:L.facing,standoff:L.standoff}))),ne={rule:`spot = fixture face + normal * standoff; clear floor ${Za} x ${Ja}; hard floor ${ii}`,checked:d.length,failures:Bt.failures,clamped:Kt,tightest:Bt.tightest,ok:Bt.failures.length===0&&Kt.length===0};ne.ok||console.error("Fitout: CLEARANCE FAILURES — a published point is unreachable",ne.failures,Kt);const z=[{where:"pod face to the pass",m:+(-ft/2-dt.z1).toFixed(2)},{where:"pod back to the grill front",m:+(dt.z0-p).toFixed(2)},{where:"pod east end to the pack-out",m:+(k.cx-k.w/2-dt.x1).toFixed(2)},{where:"crew aisle, pass to counter",m:+(R.z-R.d/2-ft/2).toFixed(2)},{where:"staff gate",m:+(Et-ct).toFixed(2)},{where:"pass flap by the landing",m:+(bt-wt).toFixed(2)},{where:"counter face to dining tables",m:+(Tt[0].z-.4-(R.z+R.d/2)).toFixed(2)},{where:"restock straight line, pod spot to dry store door",m:+Math.hypot(4.15-dt.cx,-4.55-(dt.z1+Je)).toFixed(2)},{where:"front door opening",m:1.8}];return{workplace:"burger_barn",clearance:ne,walkways:z,spots:i.spots,materials:Lx.map(L=>typeof L[1]=="number"?`${L[0]}@${L[1].toString(16)}`:`${L[0]}:${L[1]}`),labels:pu()!==null}}const mn={width:20,depth:14,height:4.2},Vt=mn.width/2,zt=mn.depth/2,Un=mn.height,uo=Rt.wallThick,_i=Vt-uo/2,ls=zt-uo/2,dn=2,Zo=4.9,Nr=.15,eh=6.4,Jo=3.2,Or=2.8,kx=.45,Bx=2.7,ye=-1,Oi=1.8,nh=2.6,ih=.9,sh=.85,rh=2.05,oh=-4.2,ah=-1,Qo=-5.4,Hx=1.8,zn=11026479,gs=13224902,ch=new Set;function mu(i,t,e={}){if(e.material)return e.material;try{return Ac(i,t,null,e.recipe||{})}catch(n){return ch.has(i)||(ch.add(i),console.error(`Shell: surface '${i}' unavailable, flat colour instead`,n)),vn(t,e)}}function Dt(i,t,e,n,s,r,o,a,c,l={}){var d;const h=mu(t,e,l),u=new xt(new te(Math.max(o,.001),Math.max(a,.001),Math.max(c,.001)),h);return u.castShadow=l.cast??((d=h.userData)==null?void 0:d.cast)??!1,u.receiveShadow=!0,u.position.set(n,s,r),l.rotY&&(u.rotation.y=l.rotY),i.add(u),u}const ti=()=>vn(ce.concrete);function on(i,t,e,n,s,r=0){const o=(t+n)/2,a=(e+s)/2,c=Math.abs(n-t),l=Math.abs(s-e);Dt(i,"(concrete)",0,o,r-.06,a,c,.12,l,{material:ti(),cast:!1}),i.solid(o,r-1.2,a,c,1.2,l,!0)}function lh(i,t,e,n,s,r,o){const a=new Mc(n,s,28,2,r,Math.PI/2);a.rotateX(-Math.PI/2);const c=new xt(a,ti());return c.receiveShadow=!0,c.position.set(t,o,e),i.add(c),c}function fn(i,t,e,n,s,r=0,o=.15){const a=(t+n)/2,c=(e+s)/2;Dt(i,"(concrete)",0,a,r+o/2,c,Math.max(Math.abs(n-t),.15),o,Math.max(Math.abs(s-e),.15),{material:ti()})}function Fr(i,t,e,n,s,r,o=0,a=.15){for(let l=0;l<8;l++){const h=s+(r-s)*(l/8),u=s+(r-s)*((l+1)/8),d=t+Math.cos(h)*n,f=e+Math.sin(h)*n,g=t+Math.cos(u)*n,_=e+Math.sin(u)*n,p=Math.hypot(g-d,_-f)+.04;Dt(i,"(concrete)",0,(d+g)/2,o+a/2,(f+_)/2,p,a,.16,{material:ti(),rotY:Math.atan2(-(_-f),g-d)})}}function Ie(i,t,e,n,s,r=0){const o=(t+n)/2,a=(e+s)/2;Dt(i,"trim",ht.trim,o,r+.008,a,Math.max(Math.abs(n-t),.1),.012,Math.max(Math.abs(s-e),.1))}function jr(i,t,e,n=0,s=1){const r=new xt(new Ne(.07,.07,s,8),mu("metal",ht.metalDull));r.castShadow=!0,r.position.set(t,n+s/2,e),i.add(r)}function zr(i,t,e,n,s,r,o=0){const a=n-t,c=s-e,l=Math.hypot(a,c);if(l<.5)return;const h=a/l,u=c/l,d=-u,f=h,g=Math.atan2(-u,h),_=uo/2+.006;for(let p=1.2;p<r-.2;p+=1.2)Dt(i,"joinery",ht.shadowDark,t+h*(l/2)+d*_,o+p,e+u*(l/2)+f*_,l,.02,.012,{rotY:g});for(let p=1.2;p<l-.3;p+=1.2)Dt(i,"joinery",ht.shadowDark,t+h*p+d*_,o+r/2,e+u*p+f*_,.02,r,.012,{rotY:g})}const gu={lane:{width:3.5,surface:0}},he=gu.lane.surface,hs=gu.lane.width/2;function Gx(i,t){on(i,-Vt,zt,Vt,10.5),on(i,-11,10.5,10.4,27.5),on(i,-17.75,15.9,-11,29.5),on(i,9.65,27.5,14.65,29.5),on(i,-13.25,-6.5,-10,zt),on(i,-12.9,-zt,-10,-6.5),on(i,-7,-10.75,1.5,-8.6),on(i,-6.9,-10,-3.9,-zt),on(i,2,-10.2,5,-8.2),on(i,-15-hs,-6.5,-15+hs,15.9,he),on(i,-9,-12.5-hs,6.15,-12.5+hs,he),on(i,12.15-hs,-6.5,12.15+hs,29.5,he),lh(i,-9,-6.5,4.25,7.75,Math.PI/2,he),lh(i,6.15,-6.5,4.25,7.75,0,he),fn(i,-16.75,-6.5,-16.75,15.9,he),fn(i,-13.25,-6.5,-13.25,15.9,he),fn(i,-9,-14.25,6.15,-14.25,he),fn(i,-9,-10.75,.5,-10.75,he),fn(i,13.9,-6.5,13.9,29.5,he),fn(i,10.4,-6.5,10.4,-5.6,he),fn(i,10.4,.6,10.4,29.5,he),fn(i,10.4,-5.2,10.4,.2,he,.1),Fr(i,-9,-6.5,4.25,Math.PI,Math.PI*1.5,he),Fr(i,-9,-6.5,7.75,Math.PI,Math.PI*1.5,he),Fr(i,6.15,-6.5,4.25,Math.PI*1.5,Math.PI*2,he),Fr(i,6.15,-6.5,7.75,Math.PI*1.5,Math.PI*2,he);for(const r of[-16.6,-13.4])Ie(i,r,-6.5,r,15,he);for(const r of[-14.1,-10.9])Ie(i,-9,r,.4,r,he);Ie(i,13.75,-6.5,13.75,27.5,he),Ie(i,.5,-14.25,.5,-10.75,he);for(let r=1;r<6.4;r+=.8)Ie(i,r,-14.25,r+.4,-14.25,he);for(const[r,o]of[[-11.2,-8.6],[-10.2,-9.4],[8.6,-8.8],[9.4,-7.8]])jr(i,r,o);for(let r=0;r<=2;r++)Ie(i,-11+r*2.6,10.5,-11+r*2.6,15.9);for(let r=0;r<=3;r++)Ie(i,1.4+r*2.6,10.5,1.4+r*2.6,15.9);for(let r=0;r<=8;r++)Ie(i,-11+r*2.6,22.1,-11+r*2.6,27.5);for(let r=0;r<2;r++)Dt(i,"(concrete)",0,-11+(r+.5)*2.6,.06,11.4,1.65,.12,.18,{material:ti()});for(let r=0;r<3;r++)Dt(i,"(concrete)",0,1.4+(r+.5)*2.6,.06,11.4,1.65,.12,.18,{material:ti()});for(let r=0;r<8;r++)Dt(i,"(concrete)",0,-11+(r+.5)*2.6,.06,26.6,1.65,.12,.18,{material:ti()});for(const r of[ye-2.4,ye,ye+2.4])Ie(i,r,10.5,r,15.9);for(let r=11;r<15.9;r+=.7)Ie(i,ye-2.4,r,ye,r+.24);jr(i,ye-1.2,13.2,0,1.3),Ie(i,ye,13.2,ye+2.4,13.44);for(let r=11;r<15.6;r+=.8)Ie(i,-5.6,r,-3.6,r+.3);fn(i,-Vt,10.5,Vt,10.5),fn(i,-11,10.5,-11,27.5),fn(i,-11,27.5,9.8,27.5);for(let r=16.1;r<22.1;r+=.8)Ie(i,-5.2,r,-3.2,r+.3);Ie(i,-11.25,15.9,-11.25,22.1);for(let r=10.6;r<13.9;r+=.8)Ie(i,r,18,r+.3,20,he);for(let r=-9.2;r<=9.2;r+=1.5)r>ye-1.7&&r<ye+1.7||jr(i,r,zt+.6);Dt(i,"metal",ht.metalDull,ye,3.07,zt+1.5,6,.14,3,{cast:!0});for(const r of[-2.7,2.7])Dt(i,"metal",ht.metalDull,ye+r,1.5,zt+2.8,.12,3,.12,{cast:!0});for(const r of[3.4,6.6]){hu(i,r,9.3,0,.9,.9);for(const[o,a,c]of[[-.78,0,Math.PI/2],[.78,0,-Math.PI/2],[0,-.78,0],[0,.78,Math.PI]])$a(i,r+o,9.3+a,0,c)}Ie(i,-9.8,8.2,-9.8,10.4),Ie(i,-8.6,8.2,-8.6,10.4),Ie(i,-7.4,8.2,-7.4,10.4);for(const r of[-9.2,-8])Dt(i,"metal",ht.metalDull,r-.35,.38,10.1,.06,.76,.06,{cast:!0}),Dt(i,"metal",ht.metalDull,r+.35,.38,10.1,.06,.76,.06,{cast:!0}),Dt(i,"metal",ht.metalDull,r,.74,10.1,.76,.06,.06,{cast:!0});Dt(i,"metal",ht.metalDull,-6,.55,-10.1,.1,1.1,.1,{cast:!0}),Dt(i,"trim",zn,-6,1.6,-10.1,.9,1.4,.1,{cast:!0,rotY:-.6});const e=.209;Dt(i,"(concrete)",0,-1.5,.12,-10.15,2.1,.25,.6,{material:ti(),rotY:e}),Dt(i,"trim",zn,-1.5,1.7,-10.15,1.96,1.66,.16,{cast:!0,rotY:e}),Dt(i,"trim",ht.trim,-1.5,1.7,-10.22,1.8,1.5,.06,{rotY:e});const n=(r,o,a,c,l,h,u=0)=>{Dt(i,r,o,-1.5+a*Math.cos(e),c,-10.26-u-a*Math.sin(e),l,h,.02,{rotY:e})};n("trim",zn,0,2.28,1.64,.22);for(let r=0;r<5;r++)for(const o of[-.42,.44])n("joinery",ht.shadowDark,o,2.02-r*.14,.68,.035);for(const r of[-.55,0,.55])n("trim",zn,r,1.18,.4,.3),n("joinery",ht.joineryLight,r,1.12,.28,.12,.01);Dt(i,"metal",ht.metalDull,.5,.9,-10.4,.25,1.8,.25,{cast:!0}),Dt(i,"joinery",ht.shadowDark,.5,1.35,-10.54,.2,.2,.04),Dt(i,"joinery",ht.shadowDark,.5,1.62,-10.54,.55,.35,.04),Dt(i,"metal",ht.metalDull,-1,2.92,-12,3,.14,3.2,{cast:!0});for(const r of[-2.3,.3])Dt(i,"metal",ht.metalDull,r,1.4,-10.45,.12,2.8,.12,{cast:!0});for(const r of[-17.05,-12.95])Dt(i,"metal",ht.metalDull,r,he+1.3,14,.09,2.6,.09,{cast:!0});Dt(i,"trim",zn,-15,he+2.5,14,4.3,.2,.12,{cast:!0}),Dt(i,"wall",gs,1.7,1,-9.2,.14,2,2,{cast:!0}),i.solid(1.7,0,-9.2,.14,2,2);for(const r of[-9.6,-8.7])Dt(i,"metal",ht.metalDull,3.5,.45,r,1.2,.9,.7,{cast:!0}),i.solid(3.5,0,r,1.2,.9,.7);const s={x0:-12.8,x1:-10.2,z0:-zt,z1:-5};for(const[r,o,a,c]of[[s.x0,s.z0,s.x1,s.z0+.2],[s.x0,s.z0,s.x0+.2,s.z1],[s.x1-.2,s.z0,s.x1,s.z1]]){const l=(r+a)/2,h=(o+c)/2;Dt(i,"wall",gs,l,.9,h,a-r,1.8,c-o,{cast:!0}),i.solid(l,0,h,a-r,1.8,c-o)}Dt(i,"metal",ht.metalDull,(s.x0+s.x1)/2,1.2,s.z1,2.4,2.4,.08,{cast:!0}),Dt(i,"metal",ht.metalDull,(s.x0+s.x1)/2,1.94,(s.z0+s.z1)/2,s.x1-s.x0+.2,.1,s.z1-s.z0+.1,{cast:!0});for(const[r,o,a]of[[-12.1,-6.2,1.2],[-10.85,-6.2,1.2],[-12.1,-5.55,1.2],[-10.9,-5.55,.6]])Dt(i,"joinery",ht.joineryDark,r,.55,o,a,1.1,.55,{cast:!0}),Dt(i,"joinery",ht.shadowDark,r,1.13,o,a+.04,.06,.59),i.solid(r,0,o,a,1.16,.55);on(i,-13,-4.8,-11.5,-3.3);for(const[r,o,a,c]of[[-13,-4.8,-11.5,-4.68],[-13,-3.42,-11.5,-3.3],[-13,-4.8,-12.88,-3.3],[-11.62,-4.8,-11.5,-3.3]])fn(i,r,o,a,c,0,.2);for(const[r,o]of[[-12.55,-4.1],[-11.95,-4.1]])Dt(i,"metal",ht.metalDull,r,.42,o,.5,.84,.5,{cast:!0});if(Dt(i,"(concrete)",0,-10.6,.1,28.3,1.1,.2,1.1,{material:ti()}),Dt(i,"trim",zn,-10.6,3,28.3,.55,6,.55,{cast:!0}),i.solid(-10.6,0,28.3,.7,6,.7),t){const r=t.clone();r.scale.set(.62,1.9,1),r.position.set(-10.6,4.3,28.62),i.add(r);const o=t.clone();o.scale.set(.62,1.9,1),o.position.set(-10.6,4.3,27.98),o.rotation.y=Math.PI,i.add(o)}}function Vx(i,t={}){const e=new ex;nx(e,0,0,mn.width,mn.depth,0,ht.tileFloor,{surface:"vinyl"});const n={height:Un,colour:gs,surface:"wall",skirting:!1,cornice:!1,autoServices:!1,inner:-1},s=[],r=(_,p)=>{const m=p-_,M=Math.max(1,Math.round(m/1.565)),v=m/M;for(let S=0;S<M;S++)s.push({at:_+(S+.5)*v+Vt,width:Math.min(1.375,v-.19),kind:"window",sill:kx,head:Bx})};r(-_i,ye-Oi/2-.15),r(ye+Oi/2+.15,9.6),s.push({at:ye+Vt,width:Oi,kind:"door",head:nh,door:{pair:!0,style:"glazed",auto:!0,startsShut:!0,swing:1,label:"entrance"}}),Gi(e,-Vt,zt,Vt,zt,{...n,openings:s,name:"front"}),Gi(e,Vt,zt,Vt,-zt+dn,{...n,openings:[{at:zt-4,width:1.2,kind:"window",sill:1.8,head:2.7},{at:zt-ah,width:ih,kind:"window",sill:sh,head:rh},{at:zt-oh,width:ih,kind:"window",sill:sh,head:rh}],name:"east"}),Gi(e,Vt,-zt+dn,Vt-dn,-zt,{...n,name:"splay"}),Gi(e,Vt-dn,-zt,-Vt,-zt,{...n,openings:[{at:zt-Qo,width:Hx,kind:"door",head:nh,door:{style:"panel",pair:!1,startsShut:!1,swing:1,colour:ht.metalDull,label:"goods door"}}],name:"rear"}),Gi(e,-Vt,-zt,-Vt,zt,{...n,name:"west"});const o=1.4;lx(e,0,(o+ls)/2,_i*2,ls-o,Jo),Kl(e,0,(o-5)/2,_i*2,o+5,Or),Kl(e,(-_i+7.9)/2,(-ls-5)/2,_i+7.9,ls-5,Or),Dt(e,"wall",gs,0,(Or+Jo+.12)/2,o,_i*2,Jo-Or+.16,.12,{cast:!0}),Dt(e,"wall",gs,0,Un+.1,0,mn.width,.2,mn.depth,{cast:!0});const a=[[-Vt,zt,Vt,zt],[Vt,zt,Vt,-zt+dn],[Vt,-zt+dn,Vt-dn,-zt],[Vt-dn,-zt,-Vt,-zt],[-Vt,-zt,-Vt,zt]];for(const[_,p,m,M]of a){const v=Math.hypot(m-_,M-p)+.36,S=Math.atan2(-(M-p),m-_),C=(_+m)/2,b=(p+M)/2;Dt(e,"wall",gs,C,(Un+Zo-Nr)/2,b,v,Zo-Nr-Un,.35,{rotY:S,cast:!0}),Dt(e,"trim",ht.trim,C,Zo-Nr/2,b,v+.06,Nr,.47,{rotY:S,cast:!0})}const c=zt+uo/2;Dt(e,"trim",zn,0,3.475,c+.05,mn.width,.85,.1,{cast:!0});const l=3.2,h=ye-1.2,u=h+l;for(const[_,p]of[[(-Vt+h)/2,h+Vt],[(u+Vt)/2,Vt-u]])Dt(e,"metal",ht.metalDull,_,2.93,c+.6,p,.16,1.2,{cast:!0}),Dt(e,"trim",zn,_,2.79,c+1.18,p,.14,.06);const d=(h+u)/2;Dt(e,"trim",zn,d,(2.4+eh)/2,c+.2,l,eh-2.4,.4,{cast:!0});for(const[_,p]of[[(h+ye-Oi/2)/2,ye-Oi/2-h],[(ye+Oi/2+u)/2,u-ye-Oi/2]])Dt(e,"trim",zn,_,1.2,c+.2,p,2.4,.4,{cast:!0});Dt(e,"joinery",ht.shadowDark,d,4.3,c+.41,l,3.4,.02);for(let _=0;_<18;_++)Dt(e,"joinery",ht.joineryLight,h+.0875+_*.175,4.3,c+.44,.15,3.4,.04,{cast:!0});let f=null;typeof document<"u"&&document.createElement&&(f=yx(t.name||"BURGER BARN",{width:7.2,height:.62,bg:"rgba(0,0,0,0)",fg:t.signFg??"#f6efe0",font:"bold 84px Georgia, serif"}),f.position.set(4.9,3.46,c+.12),e.add(f));for(const _ of[oh,ah]){Dt(e,"metal",ht.metalDull,Vt+.53,he+2.66,_,.9,.12,1.6,{cast:!0});for(const p of[-.75,.75])jr(e,Vt+.6,_+p,he)}Dt(e,"metal",ht.metalDull,6.2,2.3,-zt-.4,.8,4.2,.6,{cast:!0}),Dt(e,"metal",ht.metalDull,6.2,4.55,-zt-.4,1,.35,.8,{cast:!0});for(const _ of[-1,.5]){Dt(e,"metal",ht.metalDull,_,2.6,-zt-.06,.6,.6,.06);for(let p=0;p<5;p++)Dt(e,"joinery",ht.shadowDark,_,2.36+p*.12,-zt-.1,.54,.05,.04)}Dt(e,"metal",ht.metalDull,Qo,2.86,-zt-1,3,.14,2,{cast:!0});for(const _ of[-1.3,1.3])Dt(e,"metal",ht.metalDull,Qo+_,1.43,-zt-1.85,.12,2.86,.12,{cast:!0});zr(e,Vt,zt,Vt,-zt+dn,Un),zr(e,Vt,-zt+dn,Vt-dn,-zt,Un),zr(e,Vt-dn,-zt,-Vt,-zt,Un),zr(e,-Vt,-zt,-Vt,zt,Un),Gx(e,f);const g=zx(e,{width:mn.width,depth:mn.depth});return{group:Qh(e.group),colliders:e.colliders,doorSpecs:e.doors,interactables:e.interactables,spots:e.spots,lights:e.lights,report:g,width:mn.width,depth:mn.depth,height:Un,door:{x:ye,z:zt+1.6},doors:[{x:ye,z:zt+1.6}],interiorBounds:{minX:-_i,maxX:_i,minZ:-ls,maxZ:ls,maxY:Un}}}class Wx{constructor(t){this.game=t,this.rng=t.rng.child("world"),this.scene=t.renderer.scene,this.root=new ee,this.scene.add(this.root),this.colliders=[],this.interactables=[],this.buildings=[],this.enterable=[],this.currentBuilding=null,this.spots={},this.doors=new Mx(t),this._grid=new Map,this.cellSize=5,this.weather={condition:"clear",wetness:0,temp:24,wind:.3},this._nightState=!1}generate(){this._ground(),this._shop(),this._dressing(),this._rebuildSpatialHash(),this.game.bus.emit("world:generated",{world:this})}_ground(){const t=new xt(new Ge(400,400,1,1),vn(ce.grass));t.rotation.x=-Math.PI/2,t.position.y=-.06,t.receiveShadow=!0,this.root.add(t)}_shop(){var n;const t=Vx(this.rng.child("shop"));this.report=t.report,t.group.position.set(0,0,0),this.root.add(t.group);for(const s of t.interactables||[])this.interactables.push(s);this.spots=t.spots||{};for(const s of t.colliders)this.colliders.push(s);(n=t.doorSpecs)!=null&&n.length&&(t.group.updateMatrixWorld(!0),this.doors.install(t.doorSpecs,t.group));const e={x:0,z:0,rotY:0,padY:0,shopId:"fastfood",built:t,lights:t.lights,interiorBounds:t.interiorBounds};this.buildings.push(e),this.enterable.push(e)}_dressing(){const t=this.rng.child("dressing"),e=[[-16.5,25],[-16.8,8],[-16.2,-2],[16.5,12],[16.8,-4],[15.8,24],[-6,32.5],[4,32.8],[12,32]];for(const[s,r]of e){const o=Sx(t,t.range(.9,1.3));o.position.set(s,0,r),this.root.add(o)}const n=[{x:-9.7,z:24.8,rotY:0},{x:-2,z:24.8,rotY:0},{x:5.8,z:24.8,rotY:0},{x:5.3,z:13.2,rotY:Math.PI}];for(const s of n){const r=Ex(t);r.position.set(s.x,0,s.z),r.rotation.y=s.rotY,this.root.add(r),this.colliders.push({min:new I(s.x-1,0,s.z-2.2),max:new I(s.x+1,1.5,s.z+2.2),walkable:!1})}}_rebuildSpatialHash(){this._grid.clear(),this.colliders.forEach((t,e)=>{const n=Math.floor(t.min.x/this.cellSize),s=Math.floor(t.max.x/this.cellSize),r=Math.floor(t.min.z/this.cellSize),o=Math.floor(t.max.z/this.cellSize);for(let a=n;a<=s;a++)for(let c=r;c<=o;c++){const l=a+","+c;this._grid.has(l)||this._grid.set(l,[]),this._grid.get(l).push(e)}})}query(t,e){const n=[],s=Math.floor((t.x-e)/this.cellSize),r=Math.floor((t.x+e)/this.cellSize),o=Math.floor((t.z-e)/this.cellSize),a=Math.floor((t.z+e)/this.cellSize),c=new Set;for(let l=s;l<=r;l++)for(let h=o;h<=a;h++){const u=this._grid.get(l+","+h);if(u)for(const d of u)c.has(d)||(c.add(d),n.push(this.colliders[d]))}return this.doors.collect(t,e,n),n}sightBlocked(t,e,{eye:n=1.15,backOff:s=.45}={}){const r=t.x,o=t.z,a=(t.y??0)+n;let c=e.x-r,l=e.z-o;const h=Math.hypot(c,l);if(h<.05)return!1;const u=Math.max(0,h-s);if(u<.05)return!1;c/=h,l/=h;const d=r+c*u/2,f=o+l*u/2;for(const g of this.query({x:d,z:f},u/2+1)){if(g.walkable||a<g.min.y||a>g.max.y||r>=g.min.x&&r<=g.max.x&&o>=g.min.z&&o<=g.max.z)continue;let _=0,p=u,m=!0;for(const[M,v,S,C]of[[r,c,g.min.x,g.max.x],[o,l,g.min.z,g.max.z]]){if(Math.abs(v)<1e-9){if(M<S||M>C){m=!1;break}continue}let b=(S-M)/v,T=(C-M)/v;if(b>T){const P=b;b=T,T=P}if(b>_&&(_=b),T<p&&(p=T),_>p){m=!1;break}}if(m)return!0}return!1}groundHeight(){return 0}addInteractable(t){return this.interactables.push(t),t}activeInteractables(){return this.interactables}get isIndoors(){return this.currentBuilding!==null}_updateOccupancy(){var n;const t=(n=this.game.player)==null?void 0:n.position;if(!t)return;let e=null;for(const s of this.enterable){const r=s.interiorBounds;if(r&&t.x>r.minX&&t.x<r.maxX&&t.z>r.minZ&&t.z<r.maxZ&&t.y>s.padY-1.5&&t.y<s.padY+r.maxY){e=s;break}}e!==this.currentBuilding&&(this.currentBuilding=e,this.game.bus.emit("world:occupancy",{building:e}))}update(t){var s;this._updateOccupancy(),this.doors.update(t);const e=this.game.clock;this.game.renderer.updateSky(e.dayFraction,(s=this.game.player)==null?void 0:s.position,e.dayOfYear,t);const n=this.game.renderer.nightFactor>.25;n!==this._nightState&&(this._nightState=n,Ec().emissiveIntensity=n?.45:0,this.game.bus.emit("world:daynight",{night:n}))}}const qx=.72;class Xx{constructor(t){this.game=t,this.target=null,this._label=null,this._fwd=new I(0,0,-1)}update(){var h,u,d,f,g,_;const t=this.game;if(t.mode!==Xe.PLAY){this._setTarget(null);return}const e=t.player.position,n=t.camera.active,s=n.position;n.getWorldDirection(this._fwd);const r=((h=t.shift)==null?void 0:h.station)||null;let o=null,a=1/0;const c=(p,m)=>{var U,O;const M=p.pos.x-e.x,v=p.pos.z-e.z,S=Math.hypot(M,v);if(S>=(p.radius||1.8))return;const C=p.pos.x-s.x,b=p.pos.y-s.y,T=p.pos.z-s.z,P=Math.hypot(C,b,T)||1,D=(C*this._fwd.x+b*this._fwd.y+T*this._fwd.z)/P,x=Math.acos(Math.min(1,Math.max(-1,D)));if(x>qx)return;const E=x+S*.1;E>=a||(O=(U=t.world).sightBlocked)!=null&&O.call(U,e,p.pos,m)||(a=E,o=p)};for(const p of t.world.activeInteractables()){const m=(u=p.data)==null?void 0:u.zone;m&&(m.minZ!==void 0&&e.z<m.minZ||m.maxZ!==void 0&&e.z>m.maxZ||m.minX!==void 0&&e.x<m.minX||m.maxX!==void 0&&e.x>m.maxX)||p.action==="station"&&r||(d=p.data)!=null&&d.podOnly&&r!=="pod"||(f=p.data)!=null&&f.when&&!((g=t.shift)!=null&&g.available(p.data.when))||c(p,void 0)}const l=(_=t.world.doors)==null?void 0:_.nearest(e,2);l&&!r&&c(l,{backOff:.7}),this._setTarget(o),t.input.wasPressed("interact")&&this.activate()}_setTarget(t){const e=t?t.label:null;this.target===t&&this._label===e||(this.target=t,this._label=e,this.game.bus.emit("interaction:target",{label:e,interactable:t}))}activate(){this.target&&this.run(this.target.action,this.target.data||{})}run(t,e){const n=this.game;switch(t){case"door":{e.door.toggle()||n.ui.toast("You are standing in the doorway.");return}case"station":return void n.shift.lockIn(e.station);case"pod":return void n.shift.podPress(e);case"counter":return void n.shift.counterPress(e);case"landing":return void n.shift.handOver();case"note":return void n.ui.toast(e.text);default:console.warn("[interaction] no handler for action:",t,e),n.ui.toast("Nothing happens.")}}}const Ee={ORDER_OFFERED:"order:offered",ORDER_STARTED:"order:started",ORDER_STEP:"order:step",ORDER_BUILT:"order:built",ORDER_WRAPPED:"order:wrapped",ORDER_READY:"order:ready",ORDER_SERVED:"order:served",COUNTER_TAKEN:"counter:order_taken",COUNTER_PAID:"counter:paid",POD_REFUSED:"pod:refused"},Si={bun:{label:"toasted bun",station:"toaster",colour:13210159,shape:"heel"},ketchup:{label:"ketchup",station:"guns",colour:10236968,shape:"smear"},mustard:{label:"mustard",station:"guns",colour:13210159,shape:"smear"},mayo:{label:"mayo",station:"guns",colour:15261904,shape:"smear"},bbq:{label:"BBQ sauce",station:"guns",colour:5913126,shape:"smear"},pickle:{label:"pickles",station:"bins",colour:8030778,shape:"chips"},onion:{label:"onion",station:"bins",colour:15261904,shape:"chips"},lettuce:{label:"lettuce",station:"bins",colour:5208634,shape:"leaf"},tomato:{label:"tomato",station:"bins",colour:10236968,shape:"slice"},cheese:{label:"cheese",station:"bins",colour:13210159,shape:"flat"},patty:{label:"beef patty",station:"uhc",colour:7031349,shape:"disc"},fillet:{label:"chicken fillet",station:"uhc",colour:13216097,shape:"disc"}},$s={classic:{label:"Barn Classic",value:7.5,sequence:["bun","ketchup","mustard","pickle","onion","patty"]},cheese:{label:"Cheese Barn",value:8,sequence:["bun","ketchup","pickle","cheese","patty"]},smokehouse:{label:"Smokehouse",value:9,sequence:["bun","bbq","onion","cheese","patty"]},garden_chook:{label:"Garden Chook",value:8.5,sequence:["bun","mayo","lettuce","tomato","fillet"]}},hh=Object.keys($s),Fi={intervalMin:7,intervalJitter:.35,maxLive:4,queueCapacity:3,secondItemChance:.25,sourceMix:{kiosk:.4,counter:.35}},uh=[{skin:0,hair:0,height:1,build:1,hairStyle:"short",top:4877194,bottom:3884626},{skin:1,hair:2,height:.94,build:.92,hairStyle:"long",top:9067115,bottom:3027256},{skin:2,hair:4,height:1.05,build:1.12,hairStyle:"short",top:5929554,bottom:4866619},{skin:3,hair:1,height:.98,build:1,hairStyle:"bun",top:11569738,bottom:3884626},{skin:4,hair:6,height:1.02,build:.95,hairStyle:"short",top:7035530,bottom:3027256},{skin:5,hair:3,height:.9,build:.9,hairStyle:"long",top:9071434,bottom:5392702},{skin:1,hair:5,height:1.07,build:1.05,hairStyle:"short",top:4885123,bottom:3884626},{skin:3,hair:7,height:.96,build:1.08,hairStyle:"bun",top:10242626,bottom:3027256}];class Yx{constructor({emit:t,rng:e,now:n=0}){this.emit=t,this.rng=e,this.now=n,this.orders=new Map,this._nextId=11,this._nextOfferAt=null,this.stats={offered:0,served:0,balked:0,bySource:{}}}live(){return[...this.orders.values()].filter(t=>t.state!=="served"&&t.state!=="queued"&&t.state!=="ordering").sort((t,e)=>t.id-e.id)}all(){return[...this.orders.values()].sort((t,e)=>t.id-e.id)}counterQueue(){return[...this.orders.values()].filter(t=>t.state==="queued").sort((t,e)=>t.id-e.id)}ordering(){return[...this.orders.values()].find(t=>t.state==="ordering")||null}active(){return this.live().find(t=>t.state==="active"||t.state==="building"||t.state==="built"||t.state==="wrapped")||null}ready(){return this.live().filter(t=>t.state==="ready")}get(t){return this.orders.get(t)||null}offer(t){const e=this.rng.float(),n=Fi.sourceMix,s=e<n.kiosk?"kiosk":e<n.kiosk+n.counter?"counter":"drivethru";if(s==="counter"&&this.counterQueue().length>=Fi.queueCapacity)return this.stats.balked+=1,null;const r=[this.rng.pick(hh)];this.rng.chance(Fi.secondItemChance)&&r.push(this.rng.pick(hh));const o=[];for(const c of r)o.push(...$s[c].sequence);const a={id:this._nextId++,source:s,items:r,value:r.reduce((c,l)=>c+$s[l].value,0),sequence:o,step:0,state:s==="counter"?"queued":"active",look:this.rng.int(0,7),offeredAt:t,takenAt:null,takenBy:null,servedBy:null,builtAt:null,wrappedAt:null,readyAt:null,servedAt:null};return this.orders.set(a.id,a),this.stats.offered+=1,this.stats.bySource[s]=(this.stats.bySource[s]||0)+1,this.emit(Ee.ORDER_OFFERED,{id:a.id,source:s,items:[...r],sequence:[...o]}),a}takeOrder(t,e="player"){if(this.ordering())return{ok:!1,reason:"already_taking"};const n=this.counterQueue()[0];return n?(n.state="ordering",n.takenBy=e,this.emit(Ee.COUNTER_TAKEN,{id:n.id,items:[...n.items],total:n.value,by:e}),{ok:!0,id:n.id}):{ok:!1,reason:"nothing_queued"}}takePayment(t,e="player"){const n=this.ordering();return n?(n.state="active",n.takenAt=t,this.emit(Ee.COUNTER_PAID,{id:n.id,total:n.value,by:e}),{ok:!0,id:n.id}):{ok:!1,reason:"nothing_to_pay"}}serve(t,e,n="player"){return!t||t.state!=="ready"?!1:(t.state="served",t.servedAt=e,t.servedBy=n,this.stats.served+=1,this.emit(Ee.ORDER_SERVED,{id:t.id,ageMin:+(e-(t.takenAt??t.offeredAt)).toFixed(2)}),!0)}_interval(){const t=1+this.rng.range(-.35,Fi.intervalJitter);return Fi.intervalMin*t}tick(t){if(this.now=t,this.live().length>=Fi.maxLive){this._nextOfferAt=null;return}this._nextOfferAt===null&&(this._nextOfferAt=t+this._interval());let e=0;for(;t>=this._nextOfferAt&&e++<16;){if(this.offer(this._nextOfferAt),this.live().length>=Fi.maxLive){this._nextOfferAt=null;break}this._nextOfferAt+=this._interval()}for(const n of this.orders.values())n.state==="served"&&t-n.servedAt>10&&this.orders.delete(n.id)}serialize(){return{nextId:this._nextId,nextOfferAt:this._nextOfferAt,stats:{...this.stats,bySource:{...this.stats.bySource}},orders:[...this.orders.values()]}}load(t){var e;t&&(this._nextId=t.nextId,this._nextOfferAt=t.nextOfferAt??null,this.stats={...t.stats,bySource:{...((e=t.stats)==null?void 0:e.bySource)||{}}},this.orders=new Map(t.orders.map(n=>[n.id,{...n}])))}}const ze={NO_ORDER:"no_order",NOT_NEXT:"not_next",NOT_AT_UHC:"not_at_uhc",ALREADY_BUILT:"already_built",NOT_BUILT:"not_built",NOT_WRAPPED:"not_wrapped"};class jx{constructor({queue:t,emit:e}){this.queue=t,this.emit=e}nextToken(){const t=this.queue.active();return!t||t.step>=t.sequence.length?null:t.sequence[t.step]}_refuse(t,e=null){return this.emit(Ee.POD_REFUSED,{reason:t,token:e,next:this.nextToken()}),{ok:!1,reason:t}}addToken(t,e,n="player"){const s=this.queue.active();if(!s)return this._refuse(ze.NO_ORDER,t);if(s.state==="built"||s.state==="wrapped")return this._refuse(ze.ALREADY_BUILT,t);const r=s.sequence[s.step];return t!==r?this._refuse(ze.NOT_NEXT,t):(s.step+=1,s.state==="active"&&(s.state="building",this.emit(Ee.ORDER_STARTED,{id:s.id})),this.emit(Ee.ORDER_STEP,{id:s.id,added:t,next:s.sequence[s.step]??null,step:s.step}),s.step>=s.sequence.length&&(s.state="built",s.builtAt=e,this.emit(Ee.ORDER_BUILT,{id:s.id})),{ok:!0,added:t})}pullFromUHC(t,e="player"){var s;const n=this.nextToken();if(n===null){const r=this.queue.active();return this._refuse(r?ze.ALREADY_BUILT:ze.NO_ORDER)}return((s=Si[n])==null?void 0:s.station)!=="uhc"?this._refuse(ze.NOT_AT_UHC):this.addToken(n,t,e)}wrap(t,e="player"){const n=this.queue.active();return n?n.state!=="built"?this._refuse(n.state==="wrapped"?ze.ALREADY_BUILT:ze.NOT_BUILT):(n.state="wrapped",n.wrappedAt=t,this.emit(Ee.ORDER_WRAPPED,{id:n.id}),{ok:!0}):this._refuse(ze.NO_ORDER)}send(t,e="player"){const n=this.queue.active();return n?n.state!=="wrapped"?this._refuse(ze.NOT_WRAPPED):(n.state="ready",n.readyAt=t,this.emit(Ee.ORDER_READY,{id:n.id}),{ok:!0}):this._refuse(ze.NO_ORDER)}}const _s=class _s{constructor({rng:t,bus:e=null}){this.bus=e,this.minute=0,this.log=[],this.logSeq=0,this.rev=0,this.netRole="solo";const n=(s,r)=>this._emit(s,r);this.orders=new Yx({emit:n,rng:t.child("orders")}),this.pod=new jx({queue:this.orders,emit:n})}_emit(t,e={}){this.logSeq+=1,this.rev+=1,this.log.push({type:t,payload:e,minute:+this.minute.toFixed(3),seq:this.logSeq}),this.log.length>600&&this.log.shift(),this.bus&&this.bus.emit(t,e)}tick(t){this.netRole!=="guest"&&(t<=0||(this.minute+=t,this.orders.tick(this.minute)))}addToken(t,e="player"){return this.pod.addToken(t,this.minute,e)}pullFromUHC(t="player"){return this.pod.pullFromUHC(this.minute,t)}wrap(t="player"){return this.pod.wrap(this.minute,t)}send(t="player"){return this.pod.send(this.minute,t)}takeOrder(t="player"){return this.orders.takeOrder(this.minute,t)}takePayment(t="player"){return this.orders.takePayment(this.minute,t)}handOver(t="player"){const e=this.orders.ready()[0]||null;return e?(this.orders.serve(e,this.minute,t),{ok:!0,id:e.id}):{ok:!1,reason:"nothing_ready"}}applyNet(t,e=[],n="guest"){if(!Object.hasOwn(_s.NET_COMMANDS,t))return{ok:!1,reason:"unknown_command"};const s=_s.NET_COMMANDS[t];return!Array.isArray(e)||e.length<s.n?{ok:!1,reason:"bad_args"}:_s.prototype[s.m].apply(this,[...e.slice(0,s.n),n])}snapshot(){var t;return{minute:this.minute,board:this.orders.live(),queue:this.orders.counterQueue(),ordering:this.orders.ordering(),activeId:((t=this.orders.active())==null?void 0:t.id)??null,nextToken:this.pod.nextToken(),readyCount:this.orders.ready().length,stats:{...this.orders.stats}}}serialize(){return{minute:this.minute,orders:this.orders.serialize()}}load(t){t&&(this.minute=t.minute||0,this.orders.load(t.orders))}};Uc(_s,"NET_COMMANDS",{token:{m:"addToken",n:1},uhc:{m:"pullFromUHC",n:0},wrap:{m:"wrap",n:0},send:{m:"send",n:0},handover:{m:"handOver",n:0},take_order:{m:"takeOrder",n:0},take_payment:{m:"takePayment",n:0}});let ec=_s;const us=560,dh=340,ta=68,ea=4,fh="#f1ece1",kr="#9aa3ad",Br="#c9a961",ph="#0d1116",Kx="#141a21",$x="#1d2733",mh="#7fb069",Zx="#cf5b45";class Jx{constructor(t,e,n,s){this.scene=t,this.canvas=typeof document<"u"?document.createElement("canvas"):null,this.canvas&&(this.canvas.width=us,this.canvas.height=dh,this.ctx=this.canvas.getContext("2d"),this.tex=new ci(this.canvas),this.tex.colorSpace=Ue,this.tex.anisotropy=4,this.mesh=new xt(new Ge(s.w,s.h),new ai({map:this.tex})),this.mesh.position.set(e.x,e.y,e.z),this.mesh.rotation.x=n,t.add(this.mesh),this._sig=null,this.paint([],null,null,{},{},0))}paint(t,e,n,s,r,o){if(!this.ctx)return;const a=t.slice(0,ea),c=u=>u.takenAt??u.offeredAt,l=`${e}|${n}|`+a.map(u=>`${u.id}:${u.state}:${u.step}:${u.source}:${Math.floor(o-c(u))}`).join(",");if(l===this._sig)return;this._sig=l;const h=this.ctx;if(h.fillStyle=ph,h.fillRect(0,0,us,dh),h.fillStyle=Br,h.font="bold 28px Segoe UI, system-ui, sans-serif",h.fillText("ORDERS",16,34),t.length>ea&&(h.fillStyle=kr,h.font="22px Segoe UI, system-ui, sans-serif",h.textAlign="right",h.fillText(`+${t.length-ea} more`,us-16,34),h.textAlign="left"),!a.length){h.fillStyle=kr,h.font="28px Segoe UI, system-ui, sans-serif",h.fillText("Nothing on.",16,100),this.tex.needsUpdate=!0;return}a.forEach((u,d)=>{var v;const f=48+d*ta,g=u.id===e;h.fillStyle=g?$x:Kx,h.fillRect(10,f,us-20,ta-8),g&&(h.fillStyle=Br,h.fillRect(10,f,6,ta-8)),h.fillStyle=g?fh:kr,h.font="bold 26px Segoe UI, system-ui, sans-serif",h.fillText(`#${u.id}`,24,f+28);let _=86;u.source==="drivethru"&&(h.fillStyle=Zx,h.fillRect(_,f+10,44,22),h.fillStyle=ph,h.font="bold 17px Segoe UI, system-ui, sans-serif",h.fillText("DT",_+11,f+27),_+=54),h.fillStyle=g?fh:kr,h.font="22px Segoe UI, system-ui, sans-serif";const p=(u.items||[]).map(S=>{var C;return((C=r[S])==null?void 0:C.label)||S}).join(", ");if(h.fillText(p.slice(0,u.source==="drivethru"?26:30),_,f+28),h.font="20px Segoe UI, system-ui, sans-serif",g){h.fillStyle=mh;const S=u.state==="built"?"wrap it":u.state==="wrapped"?"send it down":n?`next: ${((v=s[n])==null?void 0:v.label)||n}`:"…";h.fillText(S,86,f+52)}else{h.fillStyle=u.state==="ready"?Br:"#5d6570";const S=Math.floor(o-c(u));h.fillText(u.state==="ready"?"at the landing":S<1?"just in":`waiting ${S}m`,86,f+52)}const m=(u.sequence||[]).length||1,M=u.state==="ready"||u.state==="wrapped"||u.state==="built"?1:Math.min(1,(u.step||0)/m);h.fillStyle="#2a333d",h.fillRect(us-104,f+20,84,10),h.fillStyle=u.state==="ready"?Br:mh,h.fillRect(us-104,f+20,84*M,10)}),this.tex.needsUpdate=!0}dispose(){this.mesh&&(this.scene.remove(this.mesh),this.mesh.geometry.dispose(),this.mesh.material.map.dispose(),this.mesh.material.dispose(),this.mesh=null)}}const nc="#f1ece1",io="#9aa3ad",ic="#c9a961",_u="#0d1116",gh="#7fb069";function xu(i,t,e,n,s){const r=document.createElement("canvas");r.width=n,r.height=s;const o=new ci(r);o.colorSpace=Ue,o.anisotropy=4;const a=new xt(new Ge(e.w,e.h),new ai({map:o}));return a.position.set(t.x,t.y,t.z),a.rotation.y=t.rotY||0,i.add(a),{canvas:r,tex:o,mesh:a,ctx:r.getContext("2d")}}class Qx{constructor(t,e){typeof document>"u"||(this.face=xu(t,e,{w:e.w,h:e.h},320,235),this._sig=null)}paint(t,e,n,s,r){if(!this.face)return;const o=n&&s-n.atMin<2,a=t?`t${t.id}:${t.items.join("+")}`:o?`p${n.id}`:`q${e}`;if(a===this._sig)return;this._sig=a;const c=this.face.ctx,l=320,h=235;if(c.fillStyle=_u,c.fillRect(0,0,l,h),c.fillStyle=ic,c.font="bold 22px Segoe UI, system-ui, sans-serif",c.fillText("TILL",14,30),t){c.fillStyle=nc,c.font="bold 24px Segoe UI, system-ui, sans-serif",c.fillText(`#${t.id}`,250,30),c.font="22px Segoe UI, system-ui, sans-serif";let u=66;for(const d of t.items){const f=r[d];c.fillStyle=nc,c.fillText((f==null?void 0:f.label)||d,14,u),c.textAlign="right",c.fillText(`$${((f==null?void 0:f.value)??0).toFixed(2)}`,l-14,u),c.textAlign="left",u+=30}c.strokeStyle="#2a333d",c.beginPath(),c.moveTo(14,u-12),c.lineTo(l-14,u-12),c.stroke(),c.fillStyle=ic,c.font="bold 24px Segoe UI, system-ui, sans-serif",c.fillText("TOTAL",14,u+18),c.textAlign="right",c.fillText(`$${t.value.toFixed(2)}`,l-14,u+18),c.textAlign="left",c.fillStyle=gh,c.font="20px Segoe UI, system-ui, sans-serif",c.fillText("take payment",14,h-16)}else o?(c.fillStyle=gh,c.font="bold 34px Segoe UI, system-ui, sans-serif",c.fillText("PAID",14,100),c.fillText(`$${n.total.toFixed(2)}`,14,140),c.fillStyle=io,c.font="20px Segoe UI, system-ui, sans-serif",c.fillText(`#${n.id} to the kitchen`,14,180)):(c.fillStyle=io,c.font="24px Segoe UI, system-ui, sans-serif",c.fillText(e===0?"No one waiting.":e===1?"1 in line.":`${e} in line.`,14,100));this.face.tex.needsUpdate=!0}}class tv{constructor(t,e){typeof document>"u"||(this.face=xu(t,e,{w:e.w,h:e.h},500,275),this._sig=null)}paint(t){if(!this.face)return;const e=t.filter(l=>l.state!=="ready").map(l=>l.id),n=t.filter(l=>l.state==="ready").map(l=>l.id),s=e.join(",")+"|"+n.join(",");if(s===this._sig)return;this._sig=s;const r=this.face.ctx,o=500,a=275;r.fillStyle=_u,r.fillRect(0,0,o,a),r.strokeStyle="#2a333d",r.beginPath(),r.moveTo(o/2,12),r.lineTo(o/2,a-12),r.stroke(),r.font="bold 24px Segoe UI, system-ui, sans-serif",r.fillStyle=io,r.fillText("PREPARING",24,38),r.fillStyle=ic,r.fillText("READY",o/2+24,38),r.font="bold 44px Segoe UI, system-ui, sans-serif";const c=(l,h,u)=>{r.fillStyle=u,l.slice(0,6).forEach((d,f)=>{r.fillText(`${d}`,h+f%2*110,96+Math.floor(f/2)*62)})};c(e,34,io),c(n,o/2+34,nc),this.face.tex.needsUpdate=!0}}const ev=2.6,nv=4;class iv{constructor(t){var n;this.game=t,this.rules=new ec({rng:t.rng.child("shift"),bus:t.bus}),this.station=null;const e=t.renderer.scene;this.screen=new Jx(e,Lr,Lr.tilt,{w:Lr.w,h:Lr.h}),this.till=new Qx(e,{x:Jl.x,...Jl.screen}),this.readyBoard=new tv(e,bx),this._lastPaid=null,t.bus.on(Ee.COUNTER_PAID,({id:s,total:r})=>{this._lastPaid={id:s,total:r,atMin:this.rules.minute}}),this._buildLandingPool(e),this._wireToasts();for(const s of t.world.activeInteractables()){const r=(n=s.data)==null?void 0:n.token;r&&!Si[r]&&console.error("ShiftSystem: interactable",s.id,"dispenses a token the menu does not know:",r)}}available(t){var n;const e=this.rules.orders;switch(t){case"landing_ready":return e.ready().length>0;case"queue_head":{if(this.station!=="counter"||e.ordering())return!1;const s=e.counterQueue()[0];return!!s&&(((n=this.game.customers)==null?void 0:n.atTill(s.id))??!0)}case"payment_due":return this.station==="counter"&&!!e.ordering();default:return!1}}lockIn(t){if(t==="pod")return this._lockPod();if(t==="counter")return this._lockCounter();this.game.ui.toast("Nothing to work there yet.")}_lockPod(){const t=this.game.player;t.position.z<bn.z-.75||(this.station="pod",t.setState("busy"),t.position.x=Rn.clamp(t.position.x,bn.x0,bn.x1),t.position.z=bn.z,t.position.y=0,t.velocity.set(0,0,0),t.facing=bn.facing,this.game.camera.yaw=bn.facing,this.game.ui.toast("On the pod. A/D to slide along, S to step off.",5200),this.game.bus.emit("shift:station",{station:"pod"}))}_lockCounter(){const t=this.game.player;t.position.z>Ni.z+.75||(this.station="counter",t.setState("busy"),t.position.x=Ni.x,t.position.z=Ni.z,t.position.y=0,t.velocity.set(0,0,0),t.facing=Ni.facing,this.game.camera.yaw=Ni.facing,this.game.ui.toast("On the till. S to step off.",5200),this.game.bus.emit("shift:station",{station:"counter"}))}release(){this.station&&(this.station=null,this.game.player.setState("normal"),this.game.bus.emit("shift:station",{station:null}))}podPress(t){this.station==="pod"&&(t.op==="uhc"?this.rules.pullFromUHC():t.op==="wrap"?this.rules.wrap():t.op==="send"?this.rules.send():this.rules.addToken(t.token))}counterPress(t){if(this.station!=="counter")return;(t.op==="take_payment"?this.rules.takePayment():this.rules.takeOrder()).ok||this.game.ui.toast("Not right now.")}handOver(){this.rules.handOver().ok||this.game.ui.toast("Nothing waiting on the landing.")}update(t){var r,o,a,c;const e=this.game;e.mode===Xe.PLAY&&(this.rules.tick(t*e.clock.scale),this.station==="pod"?this._slide(t):this.station==="counter"&&this._pin(t));const n=this.rules.orders,s=n.live();(o=this.screen)==null||o.paint(s,((r=n.active())==null?void 0:r.id)??null,this.rules.pod.nextToken(),Si,$s,this.rules.minute),(a=this.till)==null||a.paint(n.ordering(),n.counterQueue().length,this._lastPaid,this.rules.minute,$s),(c=this.readyBoard)==null||c.paint(s),this._syncLanding()}_pin(){const t=this.game.player;t.position.x=Ni.x,t.position.z=Ni.z,t.position.y=0,this.game.input.axis().y<-.5&&this.release()}_slide(t){const e=this.game.player;e.position.x=Rn.clamp(e.position.x,bn.x0,bn.x1),e.position.z=bn.z,e.position.y=0;const s=this.game.input.axis();if(s.y<-.5){this.release();return}if(s.x!==0){const r=this.game.camera.basis().right,o=Math.sign(r.x)||1;e.position.x=Rn.clamp(e.position.x+s.x*o*ev*t,bn.x0,bn.x1)}}_buildLandingPool(t){this._landing=[];const e=new Ks({color:15262418}),n=new Ks({color:11026479}),s=new te(.115,.055,.115),r=new te(.118,.016,.05);for(let o=0;o<nv;o++){const a=new ee,c=new xt(s,e);c.castShadow=!0;const l=new xt(r,n);l.position.y=.02,a.add(c,l);const h=document.createElement("canvas");h.width=64,h.height=32;const u=new ci(h);u.colorSpace=Ue;const d=new xt(new Ge(.075,.0375),new ai({map:u,transparent:!0}));d.rotation.x=-Math.PI/2+.35,d.position.set(0,.032,.035),a.add(d);const f=Ss.x0+.22+o*.42;a.position.set(f,Ss.y+.03,Ss.z),a.rotation.y=(o%2?-1:1)*.22,a.visible=!1,t.add(a),this._landing.push({g:a,canvas:h,tex:u,shownId:null})}}_stencil(t,e){if(t.shownId===e)return;t.shownId=e;const n=t.canvas.getContext("2d");n.clearRect(0,0,64,32),n.fillStyle="#3a3126",n.font="bold 24px Segoe UI, system-ui, sans-serif",n.textAlign="center",n.textBaseline="middle",n.fillText("#"+e,32,17),t.tex.needsUpdate=!0}_syncLanding(){var n;const t=this.rules.orders.ready(),e=((n=this.game.buildBoard)==null?void 0:n.slidingId)??null;for(let s=0;s<this._landing.length;s++){const r=this._landing[s],o=t[s];r.g.visible=!!o&&o.id!==e,o&&this._stencil(r,o.id)}}_wireToasts(){const t=this.game.bus,e={toast:s=>{var r;return(r=this.game.ui)==null?void 0:r.toast(s)}},n=s=>{const r=Si[s];return r?r.station==="toaster"||r.station==="uhc"?"a "+r.label:r.label:s};t.on(Ee.POD_REFUSED,({reason:s,next:r})=>{switch(s){case ze.NO_ORDER:return e.toast("Nothing on the board.");case ze.NOT_NEXT:case ze.NOT_AT_UHC:return e.toast(`It wants ${n(r)} next.`);case ze.ALREADY_BUILT:return e.toast("It has everything it needs.");case ze.NOT_BUILT:return e.toast("It is not built yet.");case ze.NOT_WRAPPED:return e.toast("Wrap it before it goes down.");default:return e.toast("Not now.")}}),t.on(Ee.ORDER_SERVED,({id:s})=>e.toast(`#${s} away.`))}}const na={};function me(i,t){return na[i]||(na[i]=t())}const ge=(i,t={})=>new Ks({color:i,...t});function sv(i){const t=new ee,e=new xt(me("cup",()=>new Ne(.043,.032,.135,10)),ge(i));e.castShadow=!0;const n=new xt(me("cupLid",()=>new Ne(.047,.047,.016,10)),ge(14173231));n.position.y=.075;const s=new xt(me("straw",()=>new Ne(.005,.005,.1,5)),ge(15790836));return s.position.set(.012,.13,0),s.rotation.z=.18,t.add(e,n,s),t}function rv(i){const t=new xt(me("bun",()=>new Ti(.056,10,6,0,Math.PI*2,0,Math.PI/2)),ge(i));return t.scale.y=.62,t.castShadow=!0,t}function ov(i){const t=new xt(me("heel",()=>new Ne(.054,.05,.02,12)),ge(i));return t.castShadow=!0,t}function av(i){const t=new xt(me("chip",()=>new Ne(.021,.021,.008,8)),ge(i));return t.castShadow=!0,t}function cv(i){const t=new xt(me("disc",()=>new Ne(.052,.052,.018,12)),ge(i));return t.castShadow=!0,t}function lv(i){const t=new xt(me("flat",()=>new te(.082,.006,.082)),ge(i));return t.castShadow=!0,t}function hv(i){const t=new xt(me("blob",()=>new ho(.036,0)),ge(i));return t.castShadow=!0,t}function uv(i){const t=new ee,e=new xt(me("bottle",()=>new Ne(.024,.028,.105,8)),ge(i));e.castShadow=!0;const n=new xt(me("bottleCap",()=>new lo(.017,.036,8)),ge(2896184));return n.position.y=.068,t.add(e,n),t}function dv(i){const t=new ee,e=new xt(me("carton",()=>new Ne(.04,.026,.09,4)),ge(14173231));e.rotation.y=Math.PI/4,e.castShadow=!0;const n=new xt(me("chipTop",()=>new Ne(.03,.03,.05,6)),ge(i));return n.position.y=.055,t.add(e,n),t}function fv(i){const t=new ee,e=new xt(me("bag",()=>new te(.1,.135,.062)),ge(i));e.castShadow=!0;const n=new xt(me("bagFold",()=>new te(.104,.022,.03)),ge(i));return n.position.y=.076,t.add(e,n),t}function pv(i){const t=new ee,e=new xt(me("box",()=>new te(.125,.075,.105)),ge(i));e.castShadow=!0;const n=new xt(me("boxTape",()=>new te(.128,.004,.022)),ge(15262418));return n.position.y=.039,t.add(e,n),t}function mv(i){const t=new ee,e=new xt(me("shaft",()=>new Ne(.016,.016,1.15,6)),ge(i));e.castShadow=!0;const n=new xt(me("mopHead",()=>new te(.115,.1,.055)),ge(14341056));return n.position.y=-.6,t.add(e,n),t}function gv(i){const t=new ee,e=new xt(me("sprayBody",()=>new te(.055,.115,.045)),ge(i));e.castShadow=!0;const n=new xt(me("sprayNeck",()=>new te(.028,.05,.028)),ge(2896184));n.position.y=.082;const s=new xt(me("sprayTrigger",()=>new te(.05,.022,.022)),ge(2896184));s.position.set(.032,.068,0);const r=new xt(me("cloth",()=>new te(.075,.018,.06)),ge(7317704));return r.position.y=-.075,t.add(e,n,s,r),t}const _v={cup:sv,bun:rv,heel:ov,chip:av,disc:cv,flat:lv,blob:hv,bottle:uv,carton:dv,bag:fv,box:pv,mop:mv,spray:gv};function xv(i){const t=new xt(me("fallback",()=>new te(.075,.055,.075)),ge(i));return t.castShadow=!0,t}function On(i,t=13421772){return(_v[i]||xv)(t)}function vv(i){return i==="mop"}const an=(i,t,e,n)=>{const s=new xt(new te(i,t,e),vn(n));return s.castShadow=!0,s.receiveShadow=!0,s};class vu{constructor(t={}){const{skin:e=ce.skinTones[0],hair:n=ce.hairTones[0],height:s=1,build:r=1,hairStyle:o="short"}=t;this.group=new ee,this.scale=s,this.opts={skin:e,hair:n,height:s,build:r,hairStyle:o};const a=s,c=.44*r,l=.24*r;this.hips=new ee,this.hips.position.y=.84*a,this.group.add(this.hips),this.torso=an(c,.58*a,l,14209734),this.torso.position.y=.29*a,this.hips.add(this.torso),this.neck=an(.14*a,.08*a,.14*a,e),this.neck.position.y=.62*a,this.hips.add(this.neck),this.head=new ee,this.head.position.y=.66*a,this.hips.add(this.head);const h=an(.26*a,.3*a,.25*a,e);h.position.y=.15*a,this.head.add(h),this.skull=h,this.hair=new ee;const u=o==="long"?.2:.1,d=an(.28*a,u*a,.27*a,n);if(d.position.y=(.3-u/2+.005)*a,this.hair.add(d),o==="long"){const f=an(.26*a,.26*a,.1*a,n);f.position.set(0,.12*a,-.14*a),this.hair.add(f)}if(o==="bun"){const f=new xt(new Ti(.08*a,8,6),vn(n));f.position.set(0,.3*a,-.14*a),f.castShadow=!0,this.hair.add(f)}this.head.add(this.hair);for(const f of[-.06,.06]){const g=an(.045*a,.045*a,.02*a,1973016);g.position.set(f*a,.17*a,.13*a),this.head.add(g)}this.arms={};for(const f of["left","right"]){const g=new ee;g.position.set((f==="left"?-1:1)*(c/2+.055*a),.54*a,0);const _=an(.11*a,.5*a,.12*a,14209734);_.position.y=-.25*a,g.add(_);const p=an(.1*a,.1*a,.11*a,e);p.position.y=-.54*a,g.add(p);const m=new ee;m.position.y=-.6*a,g.add(m),this.hips.add(g),this.arms[f]={pivot:g,upper:_,hand:p,grip:m}}this.legs={};for(const f of["left","right"]){const g=new ee;g.position.set((f==="left"?-1:1)*.11*a,0,0);const _=an(.15*a,.78*a,.16*a,3884626);_.position.y=-.39*a,g.add(_);const p=an(.17*a,.1*a,.24*a,2764083);p.position.set(0,-.82*a,.03*a),g.add(p),this.hips.add(g),this.legs[f]={pivot:g,leg:_,shoe:p}}this.bag=null,this.hat=null,this.phase=0,this.leaning=0,this.firstPerson=!1,this._held=[],this._heldSig=""}applyOutfit(t={}){var o,a,c;const e=(l,h)=>{l.material=vn(h)},n=((o=t.top)==null?void 0:o.colour)??14209734;e(this.torso,n),e(this.arms.left.upper,n),e(this.arms.right.upper,n);const s=((a=t.bottom)==null?void 0:a.colour)??3884626;e(this.legs.left.leg,s),e(this.legs.right.leg,s);const r=((c=t.shoes)==null?void 0:c.colour)??2764083;if(e(this.legs.left.shoe,r),e(this.legs.right.shoe,r),this.hat&&(this.head.remove(this.hat),this.hat=null),t.head){const l=this.scale;if(this.hat=an(.3*l,.08*l,.3*l,t.head.colour),this.hat.position.y=.33*l,t.head.id==="cap"){const h=an(.28*l,.03*l,.14*l,t.head.colour);h.position.set(0,-.03*l,.2*l),this.hat.add(h)}this.head.add(this.hat)}if(this.bag&&(this.hips.remove(this.bag),this.bag=null),t.bag){const l=this.scale;this.bag=an(.32*l,.4*l,.16*l,t.bag.colour),this.bag.position.set(0,.3*l,-.2*l),this.hips.add(this.bag)}}setFirstPerson(t){this.firstPerson=t,this.head.visible=!t,this.neck.visible=!t,this.torso.visible=!t,this.arms.left.pivot.visible=!t,this.arms.right.pivot.visible=!t,this.legs.left.pivot.visible=!t,this.legs.right.pivot.visible=!t,this.bag&&(this.bag.visible=!t),this._applyHeldVisibility()}setHeld(t=[]){var r;const e=Array.isArray(t)?t.slice(0,4):[],n=e.map(o=>`${o.id}:${o.colour}:${o.shape||""}`).join("|");if(n===this._heldSig)return;this._heldSig=n;for(const o of this._held)(r=o.parent)==null||r.remove(o);this._held=[];const s=this.scale;e.forEach((o,a)=>{const c=a===1?"left":"right",l=this.arms[c].grip,h=vv(o.shape)||!!o.big,u=On(o.shape,o.colour??13421772);u.scale.setScalar(s),u.position.set(0,h?-.16*s:-.02*s-(a>>1)*.11*s,h?.05*s:.075*s),h&&(u.rotation.x=.24),l.add(u),this._held.push(u)}),this._applyHeldVisibility()}_applyHeldVisibility(){for(const t of["left","right"]){const e=this.arms[t].grip;e.visible=!0,this.firstPerson?(e.parent!==this.hips&&this.hips.add(e),e.position.set((t==="left"?-1:1)*.22*this.scale,.34*this.scale,.34*this.scale)):e.parent!==this.arms[t].pivot&&(this.arms[t].pivot.add(e),e.position.set(0,-.6*this.scale,0))}}update(t,e=0,n={}){const s=e>.2;if(this.phase+=t*(s?4.2+e*1.1:2.2),n.sitting){this.legs.left.pivot.rotation.x=-1.4,this.legs.right.pivot.rotation.x=-1.4,this.arms.left.pivot.rotation.x=-.5,this.arms.right.pivot.rotation.x=-.5,this.hips.position.y=.5*this.scale;return}if(n.sleeping){this.group.rotation.z=Math.PI/2*.98,this.hips.position.y=.3*this.scale;return}this.group.rotation.z=0,this.hips.position.y=.84*this.scale+(s?Math.abs(Math.sin(this.phase))*.02:0);const r=s?Math.sin(this.phase)*Math.min(.85,.28+e*.14):Math.sin(this.phase)*.03;this.legs.left.pivot.rotation.x=r,this.legs.right.pivot.rotation.x=-r,this.arms.left.pivot.rotation.x=-r*.75,this.arms.right.pivot.rotation.x=r*.75,this.arms.left.pivot.rotation.z=.06,this.arms.right.pivot.rotation.z=-.06;const o=n.tired?.16:0;this.torso.rotation.x=o,this.head.rotation.x=o*.6}fidget(t){this.arms.left.pivot.rotation.x+=(Math.random()-.5)*t*.3,this.arms.right.pivot.rotation.x+=(Math.random()-.5)*t*.3,this.head.rotation.y=(Math.random()-.5)*t*.4}dispose(){this.group.traverse(t=>{t.isMesh&&t.geometry.dispose()})}}const _h=1.5,Mv=.3,xh=.3,yv=.34,Sv=4.5,Ev={queue_1:Math.PI,queue_2:Math.PI,queue_3:Math.PI,queue_4:Math.PI,collect_wait:Math.PI,kiosk_1:-Math.PI/2,kiosk_2:-Math.PI/2};class wv{constructor(t){this.game=t,this.scene=t.renderer.scene,this._bodies=new Map,this._doorList=[],t.slice=this}bodies(){return this._doorList}atTill(t){const e=this._bodies.get(t);return!!e&&e.goalName==="queue_1"&&e.path.length===0}spot(t){return this.game.world.spots[t]}update(t){if(t>0&&this.game.mode===Xe.PLAY){this._sync(t);for(const e of this._bodies.values())this._move(e,t);this._separate(),this._doorList.length=0;for(const e of this._bodies.values())this._doorList.push(e),e.avatar.update(t,e.speed,{})}}_sync(t){const e=this.game.shift.rules.orders;for(const n of e.all()){if(n.source==="drivethru")continue;let s=this._bodies.get(n.id);if(n.state==="served"){s&&this._leave(s);continue}s||(s=this._spawn(n)),!s.leaving&&(n.source==="counter"?this._counterChoreo(s,n,e):this._kioskChoreo(s,n,t))}for(const n of this._bodies.values())e.get(n.id)||this._leave(n)}_counterChoreo(t,e,n){if(e.state==="queued"){const s=n.counterQueue().indexOf(e),r=Math.min(s+1+(n.ordering()?1:0),4);this._stand(t,`queue_${r}`)}else e.state==="ordering"?this._stand(t,"queue_1"):this._stand(t,"collect_wait")}_kioskChoreo(t,e,n){t.phase==="arrive"?(this._stand(t,t.kioskSpot),!t.path.length&&t.goalName===t.kioskSpot&&(t.phase="ordering",t.dwell=Sv)):t.phase==="ordering"?(t.dwell-=n,t.dwell<=0&&(t.phase="waiting")):this._stand(t,"collect_wait")}_spawn(t){const e=uh[t.look%uh.length],n=new vu({skin:ce.skinTones[e.skin%ce.skinTones.length],hair:ce.hairTones[e.hair%ce.hairTones.length],hairStyle:e.hairStyle,height:e.height,build:e.build});n.applyOutfit({top:{colour:e.top},bottom:{colour:e.bottom},shoes:{colour:2764083}});const s=this.spot("entry_out");n.group.position.set(s.x,0,s.z),this.scene.add(n.group);const r={id:t.id,avatar:n,pos:n.group.position,facing:Math.PI,speed:0,path:[],goalName:null,leaving:!1,phase:"arrive",dwell:0,kioskSpot:t.id%2?"kiosk_1":"kiosk_2"};return this._bodies.set(t.id,r),r}_despawn(t){this.scene.remove(t.avatar.group),t.avatar.dispose(),this._bodies.delete(t.id)}_stand(t,e){t.goalName!==e&&(t.goalName=e,t.path=this._route(t,e))}_leave(t){t.leaving||(t.leaving=!0,t.goalName="entry_out",t.path=this._route(t,"entry_out"))}_route(t,e){const n=this.spot(e),s=[],r=t.pos,o=r.x<-8.3&&r.z>3.5,a=r.z<3.5;return e==="entry_out"?(o&&s.push(this.spot("kiosk_gate")),(o||a)&&s.push(this.spot("aisle")),s.push(this.spot("entry"))):e.startsWith("kiosk")?(!a&&!o&&s.push(this.spot("aisle")),s.push(this.spot("kiosk_gate"))):n.z<3.5&&o?s.push(this.spot("kiosk_gate")):n.z<3.5&&!a&&s.push(this.spot("aisle")),s.push(n),s}_move(t,e){const n=t.path[0];if(!n){const c=t.goalName&&this.spot(t.goalName);if(c){const h=Math.hypot(c.x-t.pos.x,c.z-t.pos.z),u=this.game.player.position,d=Math.hypot(c.x-u.x,c.z-u.z)<.6;if(h>.55&&!d){t.path=[c];return}}t.speed=0;const l=Ev[t.goalName];l!==void 0&&(t.facing=l),t.avatar.group.rotation.y=t.facing;return}const s=n.x-t.pos.x,r=n.z-t.pos.z,o=Math.hypot(s,r);if(o<Mv){t.path.shift(),!t.path.length&&t.leaving&&this._despawn(t);return}const a=Math.min(o,_h*e);t.pos.x+=s/o*a,t.pos.z+=r/o*a,t.facing=Math.atan2(s,r),t.avatar.group.rotation.y=t.facing,t.speed=_h}_separate(){const t=[...this._bodies.values()];for(let e=0;e<t.length;e++){for(let l=e+1;l<t.length;l++){const h=t[e],u=t[l];let d=u.pos.x-h.pos.x,f=u.pos.z-h.pos.z,g=Math.hypot(d,f);const _=xh*2;if(g>=_)continue;g<1e-4&&(d=1,f=0,g=1);const p=(_-g)/2;h.pos.x-=d/g*p,h.pos.z-=f/g*p,u.pos.x+=d/g*p,u.pos.z+=f/g*p}const n=this.game.player.position,s=t[e];let r=s.pos.x-n.x,o=s.pos.z-n.z,a=Math.hypot(r,o);const c=xh+yv;a<c&&(a<1e-4&&(r=1,o=0,a=1),s.pos.x+=r/a*(c-a),s.pos.z+=o/a*(c-a))}}}const Ve={x:ms.x,y:dt.benchH+.045,z:ms.z},Tv={heel:.02,smear:.005,chips:.01,leaf:.014,slice:.011,flat:.006,disc:.018,crown:.036},bv=.72;class Av{constructor(t){this.game=t;const e=t.renderer.scene;this.group=new ee,this.group.name="build-board",e.add(this.group),this._sig=null,this._mats=[],this._parcel=new ee;const n=new xt(new te(.115,.055,.115),new Ks({color:15262418}));n.castShadow=!0;const s=new xt(new te(.118,.016,.05),new Ks({color:11026479}));s.position.y=.02,this._parcel.add(n,s),this._parcel.visible=!1,e.add(this._parcel),this.slidingId=null,this._slide=null,this._fixturePos={};for(const r of t.world.activeInteractables())r.id==="pod_toaster"?this._fixturePos.bun=r.pos:r.id==="pod_uhc"?(this._fixturePos.patty=r.pos,this._fixturePos.fillet=r.pos):r.id.startsWith("pod_gun_")?this._fixturePos[r.id.slice(8)]=r.pos:r.id.startsWith("pod_bin_")?this._fixturePos[r.id.slice(8)]=r.pos:r.id==="landing_handover"?this._landingPos=r.pos:r.id==="till_order"&&(this._tillPos=r.pos);this._pulses=[];for(let r=0;r<6;r++){const o=new xt(new Ge(.16,.16),new ai({color:16777215,transparent:!0,opacity:0,blending:sa,depthWrite:!1}));o.visible=!1,o.rotation.x=-.4,e.add(o),this._pulses.push({mesh:o,life:0})}this._bunHalf=On("bun",Si.bun.colour),this._bunHalf.visible=!1,e.add(this._bunHalf),this._eject=null,this._wire()}_wire(){const t=this.game.bus,e=this.game.audio,n=s=>s?{at:{x:s.x,y:s.y,z:s.z}}:{};t.on(Ee.ORDER_STEP,({added:s})=>{const r=this._fixturePos[s],o=Si[s];r&&o&&this._pulse(r,o.colour),s==="bun"&&(this._eject={t:0}),e.play("item_place",{...n(r),rate:.94+Math.random()*.12})}),t.on(Ee.POD_REFUSED,()=>{e.play("wrong_item",n({x:dt.cx,y:1.2,z:dt.cz}))}),t.on(Ee.ORDER_BUILT,()=>{e.play("item_pickup",n({x:Ve.x,y:1,z:Ve.z}))}),t.on(Ee.ORDER_WRAPPED,()=>{e.play("item_place",{...n({x:Ve.x,y:1,z:Ve.z}),rate:.8})}),t.on(Ee.ORDER_READY,({id:s})=>{this.slidingId=s,this._slide={t:0},e.play("item_drop",{...n({x:ue.x0,y:1,z:ue.z0}),rate:1.15})}),t.on(Ee.ORDER_SERVED,()=>{e.play("order_complete",n(this._landingPos))}),t.on(Ee.COUNTER_TAKEN,()=>e.play("order_taken",n(this._tillPos))),t.on(Ee.COUNTER_PAID,()=>e.play("purchase",n(this._tillPos))),t.on(Ee.ORDER_OFFERED,({source:s})=>{var r;if(s==="kiosk"){const o=(r=this.game.world.spots)==null?void 0:r.kiosk_1;e.play("kiosk_order",n(o&&{x:o.x,y:1.4,z:o.z}))}})}_pulse(t,e){const n=this._pulses.find(s=>s.life<=0)||this._pulses[0];n.life=.35,n.mesh.material.color.set(e),n.mesh.position.set(t.x,t.y+.06,t.z+.02),n.mesh.visible=!0}update(t){this._syncStack(),this._animate(t)}_syncStack(){const t=this.game.shift.rules.orders.active(),e=t?`${t.id}:${t.step}:${t.state}`:null;if(e===this._sig)return;this._sig=e;for(const r of[...this.group.children])this.group.remove(r);for(const r of this._mats)r.dispose();if(this._mats=[],this._parcel.visible=this._slide!==null,!t||t.state==="ready")return;if(t.state==="wrapped"){this._parcel.visible=!0,this._parcel.position.set(Ve.x,Ve.y+.028,Ve.z),this._parcel.rotation.set(0,.12,0);return}let n=Ve.y;const s=(r,o)=>((t.id*7+r*13)%5-2)*.003*o;for(let r=0;r<t.step;r++){const o=t.sequence[r],a=Si[o];if(!a)continue;const c=Tv[a.shape]??.012;this._layer(a,n+c/2,s(r,1),s(r,-1)),n+=c}if(t.state==="built"){const r=On("bun",Si.bun.colour);this._own(r),r.position.set(Ve.x,n,Ve.z),this.group.add(r)}}_layer(t,e,n,s){const r=(o,a=1,c=1,l=1,h=0,u=0)=>{this._own(o),o.scale.multiply(new I(a,c,l)),o.position.set(Ve.x+n+h,e,Ve.z+s+u),this.group.add(o)};switch(t.shape){case"smear":r(On("flat",t.colour),.62,.5,.62);break;case"chips":r(On("chip",t.colour),1,1,1,-.018,-.008),r(On("chip",t.colour),1,1,1,.016,-.014),r(On("chip",t.colour),1,1,1,.004,.019);break;case"leaf":r(On("blob",t.colour),1.5,.38,1.5);break;case"slice":r(On("disc",t.colour),.92,.6,.92);break;default:r(On(t.shape,t.colour))}}_own(t){t.traverse(e=>{e.material&&this._mats.push(e.material)})}_animate(t){for(const e of this._pulses)e.life<=0||(e.life-=t,e.mesh.material.opacity=Math.max(0,e.life/.35)*.9,e.life<=0&&(e.mesh.visible=!1));if(this._eject){const e=this._fixturePos.bun;this._eject.t+=t/.45;const n=Math.min(1,this._eject.t);e&&(this._bunHalf.visible=!0,this._bunHalf.position.set(e.x,1.46-.5*n*n,dt.cz-.05+.48*n),this._bunHalf.rotation.x=.42*(1-n)),n>=1&&(this._eject=null,this._bunHalf.visible=!1)}if(this._slide){this._slide.t+=t/bv;const e=Math.min(1,this._slide.t),n=this.game.shift.rules.orders.ready(),s=Math.max(0,Math.min(n.findIndex(f=>f.id===this.slidingId),3)),r={x:Ss.x0+.22+s*.42,y:Ss.y+.03,z:Ss.z},o=[{x:Ve.x,y:Ve.y+.03,z:Ve.z},{x:ue.x0,y:1,z:ue.z0},{x:ue.x1,y:.93,z:ue.z1},r],a=[.18,.62,1];let c=0;for(;c<2&&e>a[c];)c++;const l=c===0?0:a[c-1],h=(e-l)/(a[c]-l),u=o[c],d=o[c+1];this._parcel.visible=!0,this._parcel.scale.setScalar(1.25-.25*e),this._parcel.position.set(u.x+(d.x-u.x)*h,u.y+(d.y-u.y)*h,u.z+(d.z-u.z)*h),this._parcel.rotation.y+=t*2.2,e>=1&&(this._slide=null,this.slidingId=null,this._parcel.visible=!1,this._parcel.rotation.set(0,0,0),this._parcel.scale.setScalar(1))}}}const cn=.34,vh=1.75,Rv=1.62,Cv=22,ia=.42,Pv={top:{colour:3817286},bottom:{colour:2303531},shoes:{colour:2764083},head:{id:"cap",colour:11026479}};class Lv{constructor(t){var n,s,r;this.game=t,this.position=new I(0,0,0),this.velocity=new I,this.facing=0,this.onGround=!0,this.state="normal",this.eyeHeight=Rv,this.horizontalSpeed=0,this.avatar=new vu({skin:(n=ce.skinTones)==null?void 0:n[1],hair:(s=ce.hairTones)==null?void 0:s[1],hairStyle:"short",height:1,build:1}),this.avatar.applyOutfit(Pv),t.renderer.scene.add(this.avatar.group);const e=(r=t.world.spots)==null?void 0:r.spawn;this.teleport(e?e.clone():new I(0,0,14)),this.walkSpeed=4.6,this.runSpeed=9}teleport(t){this.position.copy(t),this.velocity.set(0,0,0),this.avatar.group.position.copy(t)}get isBusy(){return this.state!=="normal"}update(t){this.state==="normal"&&this.game.mode===Xe.PLAY?this._move(t):(this.velocity.x=0,this.velocity.z=0,this.horizontalSpeed=0,this.state==="normal"&&this._applyGravity(t)),this.avatar.group.position.copy(this.position),this.avatar.group.rotation.y=this.facing,this.avatar.update(t,this.horizontalSpeed,{sitting:!1,sleeping:!1,tired:!1})}_move(t){const e=this.game.input,n=e.axis(),{forward:s,right:r}=this.game.camera.basis(),o=e.isDown("sprint"),a=o?this.runSpeed:this.walkSpeed,c=new I().addScaledVector(s,n.y).addScaledVector(r,n.x);c.lengthSq()>0?(c.normalize(),this.facing=Math.atan2(c.x,c.z),this.game.camera.fovBoost=o?5:0):this.game.camera.fovBoost=0;const l=c.multiplyScalar(a),h=this.onGround?14:3;this.velocity.x+=(l.x-this.velocity.x)*Math.min(1,h*t),this.velocity.z+=(l.z-this.velocity.z)*Math.min(1,h*t),e.wasPressed("jump")&&this.onGround&&(this.velocity.y=6.2,this.onGround=!1),this._applyGravity(t),this._collide(t);const u=this._floorUnder();this.position.y<u&&(this.position.y=u,this.velocity.y=0,this.onGround=!0),this.horizontalSpeed=Math.hypot(this.velocity.x,this.velocity.z)}_floorUnder(){const t=this.game.world,{x:e,z:n,y:s}=this.position;let r=t.groundHeight(e,n);for(const o of t.query(this.position,cn+.5))o.walkable&&(e<o.min.x-cn||e>o.max.x+cn||n<o.min.z-cn||n>o.max.z+cn||o.max.y<=s+ia&&o.max.y>r&&(r=o.max.y));return r}_insideSolid(){const t=this.game.world,e=cn-.06;for(const n of t.query(this.position,cn+.3)){if(this.position.y+vh<n.min.y||this.position.y>n.max.y||n.max.y<=this.position.y+ia)continue;const s=Math.max(n.min.x,Math.min(this.position.x,n.max.x)),r=Math.max(n.min.z,Math.min(this.position.z,n.max.z)),o=this.position.x-s,a=this.position.z-r;if(o*o+a*a<e*e)return!0}return!1}_applyGravity(t){this.velocity.y-=Cv*t,this.position.y+=this.velocity.y*t;const e=this._floorUnder();this.position.y<=e&&(this.position.y=e,this.velocity.y=0,this.onGround=!0)}_collide(t){const e=this.game.world;this.position.x+=this.velocity.x*t,this.position.z+=this.velocity.z*t;for(let s=0;s<4;s++){let r=!1;for(const o of e.query(this.position,cn+.6)){if(this.position.y+vh<o.min.y||this.position.y>o.max.y||o.max.y<=this.position.y+ia)continue;const a=Math.max(o.min.x,Math.min(this.position.x,o.max.x)),c=Math.max(o.min.z,Math.min(this.position.z,o.max.z));let l=this.position.x-a,h=this.position.z-c;const u=l*l+h*h;if(u>=cn*cn)continue;if(u>1e-8){const f=Math.sqrt(u),g=cn-f;l/=f,h/=f,this.position.x+=l*g,this.position.z+=h*g}else{const f=[[this.position.x-o.min.x,-1,0],[o.max.x-this.position.x,1,0],[this.position.z-o.min.z,0,-1],[o.max.z-this.position.z,0,1]].sort((g,_)=>g[0]-_[0])[0];l=f[1],h=f[2],this.position.x+=l*(f[0]+cn),this.position.z+=h*(f[0]+cn)}const d=this.velocity.x*l+this.velocity.z*h;d<0&&(this.velocity.x-=l*d,this.velocity.z-=h*d),r=!0}if(!r)break}this._insideSolid()?(this._lastSafe&&this.position.copy(this._lastSafe),this.velocity.x=0,this.velocity.z=0):(this._lastSafe||(this._lastSafe=new I)).copy(this.position);const n=180;this.position.x=Rn.clamp(this.position.x,-n,n),this.position.z=Rn.clamp(this.position.z,-n,n)}setState(t){this.state=t,this.game.bus.emit("player:state",{state:t})}serialize(){return{position:this.position.toArray(),facing:this.facing}}load(t){t&&(this.teleport(new I().fromArray(t.position)),this.position.y=Math.max(this.position.y,this._floorUnder()),this.avatar.group.position.copy(this.position),this.facing=t.facing||0)}}class Dv{constructor(t){this.game=t;const e=document.getElementById("ui");e.innerHTML=`
