...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Hi,depthTest:!1,depthWrite:!1})}function Rh(){return new bi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Rl(),fragmentShader:`
		...
		`,blending:Hi,depthTest:!1,depthWrite:!1})}function Ch(){return new bi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Rl(),fragmentShader:`
...
`)}function ix(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function _r(i){return i!==""}function kh(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Bh(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const sx=/^[ \t]*#include +<([\w\d./]+)>/gm;function Zc(i){return i.replace(sx,ox)}const rx=new Map;function ox(i,t){let e=Qt[t];if(e===void 0){const n=rx.get(t);if(n!==void 0)e=Qt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Zc(e)}const ax=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Hh(i){return i.replace(ax,cx)}function cx(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Gh(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function lx(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===$u?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Zu?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===gi&&(t="SHADOWMAP_TYPE_VSM"),t}function hx(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Zs:case Ks:t="ENVMAP_TYPE_CUBE";break;case Ko:t="ENVMAP_TYPE_CUBE_UV";break}return t}function ux(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ks:t="ENVMAP_MODE_REFRACTION";break}return t}function dx(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case gl:t="ENVMAP_BLENDING_MULTIPLY";break;case Qf:t="ENVMAP_BLENDING_MIX";break;case t0:t="ENVMAP_BLENDING_ADD";break}return t}function fx(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function px(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=lx(e),l=hx(e),h=ux(e),u=dx(e),d=fx(e),f=ex(e),m=nx(r),_=s.createProgram();let p,g,v=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
    ...
    gl_FragColor.a = max( ghA, 0.80 * ghLit );`)};function Nl(i){return i.onBeforeCompile=Bv,i}function ds(){return $n("window",()=>Nl(new gn({color:qt.glass,roughness:.1,metalness:0,transparent:!0,opacity:.28,depthWrite:!1,emissive:new Gt(16767392),emissiveIntensity:0})))}function Hv(){return $n("windowinner",()=>Nl(new gn({color:qt.glass,roughness:.1,metalness:0,transparent:!0,opacity:.1,depthWrite:!1})))}function Gv(){return $n("bulb",()=>new gn({color:16774365,emissive:new Gt(16770744),emissiveIntensity:1.6}))}function Od(){return $n("carglass",()=>new gn({color:2831680,roughness:.2,metalness:.3}))}function Ol(){return $n("headlight",()=>new gn({color:15787727,emissive:new Gt(16771512),emissiveIntensity:0}))}function zd(){return $n("taillight",()=>new gn({color:9186091,emissive:new Gt(16726843),emissiveIntensity:.2}))}function Fd(){return $n("headlight-driving",()=>new gn({color:15787727,emissive:new Gt(16771512),emissiveIntensity:0}))}function kd(){return $n("streetlamp",()=>new gn({color:15262932,emissive:new Gt(16769702),emissiveIntensity:0}))}function Bd(){return $n("lamppool",()=>new en({color:16768926,transparent:!0,opacity:0,blending:ko,depthWrite:!1}))}function Vv(){return $n("troffer",()=>new gn({color:16185074,roughness:.5,emissive:new Gt(14477567),emissiveIntensity:.9}))}function Wv(){return $n("contactshadow",()=>{const t=document.createElement("canvas");t.width=t.height=128;const e=t.getContext("2d"),n=e.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);n.addColorStop(0,"rgb(140,140,140)"),n.addColorStop(.55,"rgb(196,196,196)"),n.addColorStop(1,"rgb(255,255,255)"),e.fillStyle=n,e.fillRect(0,0,128,128);const s=new Yn(t);s.colorSpace=He;const r=new en({map:s,blending:uc,transparent:!0,depthWrite:!1,toneMapped:!1,polygonOffset:!0,polygonOffsetFactor:-1,polygonOffsetUnits:-1});return r.userData.decal=!0,r})}new Ut(1,1,1),new Ie(1,1),new Ve(.5,.5,1,10),new na(.5,1,8),new Vi(.5,12,10);const Xv=new Set;function Lr(i){Xv.add(i)}const qv=`
  varying vec3 vWorld;
  void main() {
...
`,Di=[{t:0,top:329487,mid:658970,bot:1317414,sun:2766160,amb:1712176,int:.05},{t:.22,top:1779520,mid:5329002,bot:10123890,sun:16751964,amb:4868704,int:.3},{t:.27,top:5208752,mid:10466511,bot:15778714,sun:16761479,amb:9082024,int:.75},{t:.4,top:4884168,mid:10339044,bot:14214898,sun:16774109,amb:11058384,int:1},{t:.52,top:4161476,mid:9682402,bot:13886450,sun:16777215,amb:11453142,int:1.05},{t:.72,top:4882360,mid:11058388,bot:14734013,sun:16771524,amb:10530496,int:.85},{t:.8,top:2902642,mid:9072512,bot:14256732,sun:16747082,amb:6969960,int:.42},{t:.86,top:1186350,mid:2962768,bot:5917272,sun:9067114,amb:2764872,int:.14},{t:1,top:329487,mid:658970,bot:1317414,sun:2766160,amb:1712176,int:.05}];function jv(i){let t=Di[0],e=Di[Di.length-1];for(let o=0;o<Di.length-1;o++)if(i>=Di[o].t&&i<=Di[o+1].t){t=Di[o],e=Di[o+1];break}const n=e.t-t.t||1,s=(i-t.t)/n,r=(o,a)=>new Gt(o).lerp(new Gt(a),s);return{top:r(t.top,e.top),mid:r(t.mid,e.mid),bot:r(t.bot,e.bot),sun:r(t.sun,e.sun),amb:r(t.amb,e.amb),int:t.int+(e.int-t.int)*s}}class $v{constructor(t,e){this.game=e,this.canvas=t,this.renderer=new Yx({canvas:t,antialias:!0,powerPreference:"high-performance"}),this.renderer.setPixelRatio(Math.min(devicePixelRatio,2)),this.renderer.setSize(innerWidth,innerHeight,!1),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=Zu,this.renderer.outputColorSpace=He,this.renderer.toneMapping=Ku,this.renderer.toneMappingExposure=1.05,this.scene=new jx,this.scene.fog=new Cl(11059416,60,340),this._buildSky(),this._buildLights(),this.indoorFactor=0,this.interiorLights=new Fv(this.scene),this.quality={shadows:!0,drawDistance:340},addEventListener("resize",()=>this.resize())}_buildSky(){this.skyUniforms={uTop:{value:new Gt(4884168)},uMid:{value:new Gt(10339044)},uBottom:{value:new Gt(14214898)},uSunY:{value:.6},uSunDir:{value:new I(0,1,0)},uSunColour:{value:new Gt(16777215)},uExposure:{value:1.05}};const t=new st(new Vi(900,32,20),new bi({uniforms:this.skyUniforms,vertexShader:qv,fragmentShader:Yv,side:cn,depthWrite:!1,fog:!1}));t.frustumCulled=!1,this.scene.add(t),this.sky=t;const e=900,n=new Float32Array(e*3);for(let r=0;r<e;r++){const o=new I().randomDirection().multiplyScalar(850);o.y<40&&(o.y=Math.abs(o.y)+40),n.set([o.x,o.y,o.z],r*3)}const s=new nn;s.setAttribute("position",new ze(n,3)),this.stars=new $x(s,new Ad({color:16777215,size:3.2,sizeAttenuation:!1,transparent:!0,opacity:0,fog:!1,depthWrite:!1})),this.stars.frustumCulled=!1,this.scene.add(this.stars),this.moon=new st(new Vi(18,16,12),new en({color:14673648,fog:!1})),this.scene.add(this.moon)}_buildLights(){this.hemi=new Rv(12374760,5918784,.9),this.scene.add(this.hemi),this.sun=new iu(16774109,2.2),this.sun.castShadow=!0,this.sun.shadow.mapSize.set(4096,4096),this.sun.shadow.camera.near=1,this.sun.shadow.camera.far=420,this.shadowSpan=lo.shadowSpan,this._applyShadowSpan(0),this.scene.add(this.sun),this.scene.add(this.sun.target),this.bounce=new iu(10467020,.35),this.scene.add(this.bounce),this.scene.add(this.bounce.target),this.ambient=new Uv(11058384,.35),this.scene.add(this.ambient)}add(t){this.scene.add(t)}remove(t){this.scene.remove(t)}_applyShadowSpan(t){const e=mn.lerp(lo.shadowSpan,Jn.shadowSpan,t);if(Math.abs(e-this.shadowSpan)>1e-4||!this._spanApplied){this.shadowSpan=e;const n=this.sun.shadow.camera;n.left=-e,n.right=e,n.top=e,n.bottom=-e,n.updateProjectionMatrix(),this._spanApplied=!0}this.sun.shadow.bias=mn.lerp(lo.shadowBias,Jn.shadowBias,t),this.sun.shadow.normalBias=mn.lerp(lo.shadowNormalBias,Jn.shadowNormalBias,t)}_skyDelta(t){const e=performance.now(),n=(e-(this._lastSky??e))/1e3;return this._lastSky=e,t>0?Math.min(t,.25):n>.001?Math.min(n,.25):this.game.fixedStep||1/60}updateSky(t,e,n=0,s=0){var U,N;const r=this._skyDelta(s),o=(U=this.game.world)==null?void 0:U.weather,a=Ov(o),c=(N=this.game.world)!=null&&N.isIndoors?1:0;this.indoorFactor+=(c-this.indoorFactor)*Math.min(1,r*Jn.rate);const l=this.indoorFactor;this._applyShadowSpan(l);const h=jv(t);this.skyUniforms.uTop.value.copy(h.top),this.skyUniforms.uMid.value.copy(h.mid),this.skyUniforms.uBottom.value.copy(h.bot),this.skyUniforms.uSunColour.value.copy(h.sun);const u=(t-.25)*Math.PI*2,d=Math.sin(n/364*Math.PI*2)*.3,f=new I(Math.cos(u),Math.sin(u)+d,-.35).normalize();this.skyUniforms.uSunDir.value.copy(f),this.skyUniforms.uSunY.value=f.y;const m=(e==null?void 0:e.x)||0,_=(e==null?void 0:e.z)||0,p=(e==null?void 0:e.y)||0,g=this.shadowSpan*2/this.sun.shadow.mapSize.x,v=Math.round(m/g)*g,x=Math.round(_/g)*g;this.sun.position.set(v+f.x*160,p+Math.max(f.y,.08)*160,x+f.z*160),this.sun.target.position.set(v,p,x),this.sun.target.updateMatrixWorld();const M=Math.max(0,f.y),A=mn.smoothstep(f.y,-.005,.03);this.sun.intensity=Math.pow(M,.65)*3*(1-a)*A,this.sun.color.copy(h.sun).lerp(new Gt(15265524),a),this.sun.shadow.autoUpdate=this.sun.intensity>.01,this.bounce.position.set(v-f.x*90,p+40,x-f.z*90),this.bounce.target.position.set(v,p,x),this.bounce.target.updateMatrixWorld(),this.bounce.intensity=.15+h.int*.4,this.bounce.color.copy(h.mid),this.moon.position.set(m-f.x*600,-f.y*600,_-f.z*600),this.moon.visible=f.y<.08;const E=mn.clamp((.06-f.y)*6,0,1),b=o!=null&&o.wetness?1:0;this.hemi.intensity=.25+h.int*.8+E*.5+a*.5*(1-b*.5),this.hemi.color.copy(h.mid).lerp(new Gt(5992332),E*.7).lerp(new Gt(13161180),a*.6),this.ambient.intensity=.12+h.int*.3+E*.38+a*.05,this.ambient.color.copy(h.amb).lerp(new Gt(6978201),E*.8),this.stars.material.opacity=E*.9,this.hemi.intensity*=Math.pow(Jn.hemi,l),this.ambient.intensity*=Math.pow(Jn.ambient,l),this.bounce.intensity*=Math.pow(Jn.bounce,l),this.scene.fog.color.copy(h.mid).lerp(h.bot,.45);const P=o!=null&&o.wetness?.45:0,D=o&&["overcast","rain","storm"].includes(o.condition)?.25:0;this.scene.fog.near=60-(P+D)*40,this.scene.fog.far=this.quality.drawDistance*(1-P*.35-D*.15-E*.3);const y=1+E*.45+(1-Math.min(1,h.int))*.2+a*.12+b*.03+l*Jn.exposure;this.renderer.toneMappingExposure+=(y-this.renderer.toneMappingExposure)*Math.min(1,r*Jn.rate),this.skyUniforms.uExposure.value=this.renderer.toneMappingExposure,this.nightFactor=E,kd().emissiveIntensity=E*2.6,Bd().opacity=E*.32,Fd().emissiveIntensity=E*2.2;const w=this.game.world;if(w!=null&&w.enterable){const W=.34+a*.26;this.interiorLights.update(w,Math.max(W,E),this.game.player)}this.sky&&this.sky.position.set(m,0,_),this.stars.position.set(m,0,_)}resize(){var e;this.renderer.setSize(innerWidth,innerHeight,!1);const t=(e=this.game.camera)==null?void 0:e.active;t&&(t.aspect=innerWidth/innerHeight,t.updateProjectionMatrix())}render(t){this.sky.position.copy(t.position),this.renderer.render(this.scene,t)}}const Cs=[{id:"first",label:"First person",distance:0,height:0,fov:64},{id:"third",label:"Third person",distance:3.6,height:.35,shoulder:.55,fov:52},{id:"thirdFar",label:"Third person (wide)",distance:6.5,height:.9,shoulder:0,fov:50},{id:"ride",label:"Behind the van",distance:7,height:1.7,shoulder:0,fov:54,hidden:!0}],Zv=Jn.fov;class Kv{constructor(t){this.game=t,this.modeIndex=1,this.active=new pn(Cs[1].fov,innerWidth/innerHeight,.25,1e3),this.yaw=0,this.pitch=-.05,this.distance=Cs[1].distance,this._targetDistance=this.distance,this._pos=new I,this._look=new I,this._ray2=new Tl,this._box=new Ei,this._hit=new I,this.shakeAmount=0,this.bob=0,this.fovBoost=0}get mode(){return Cs[this.modeIndex]}get isFirstPerson(){return this.mode.id==="first"}cycle(){do this.modeIndex=(this.modeIndex+1)%Cs.length;while(Cs[this.modeIndex].hidden);return this.game.bus.emit("camera:mode",{mode:this.mode}),this.mode}setMode(t){const e=Cs.findIndex(n=>n.id===t);e>=0&&(this.modeIndex=e)}addShake(t){this.shakeAmount=Math.min(1.2,this.shakeAmount+t)}update(t){const{input:e,player:n}=this.game;if(e.locked&&e.enabled){const c=e.consumeMouse();this.yaw-=c.dx*e.mouse.sensitivity,this.pitch-=(e.mouse.invertY?-c.dy:c.dy)*e.mouse.sensitivity;const l=Math.PI/2-.05;this.pitch=mn.clamp(this.pitch,-l,l)}else e.consumeMouse();const s=this.mode,r=n.position.clone();r.y+=n.eyeHeight;const o=n.horizontalSpeed;if(o>.3){this.bob+=t*o*1.9;const c=this.isFirstPerson?.035:.012;r.y+=Math.sin(this.bob*2)*c,r.x+=Math.cos(this.bob)*c*.4}else this.bob+=t*1.1,r.y+=Math.sin(this.bob)*.006;const a=new I(Math.sin(this.yaw)*Math.cos(this.pitch),Math.sin(this.pitch),Math.cos(this.yaw)*Math.cos(this.pitch));if(s.distance===0)this._pos.copy(r),this._look.copy(r).addScaledVector(a,10);else{const c=n.position.clone();c.y+=n.eyeHeight*.92+s.height;const l=new I(-Math.cos(this.yaw),0,Math.sin(this.yaw));c.addScaledVector(l,s.shoulder||0);const h=this.game.world,u=h.isIndoors,d=u?.35:.7;let f=u?Math.min(s.distance,2.2):s.distance;const m=a.clone().negate();this._ray2.set(c,m);const _=c.clone().addScaledVector(m,f*.5);let p=f+.45;for(const g of h.query(_,f+1.5)){this._box.set(g.min,g.max);const v=this._ray2.intersectBox(this._box,this._hit);if(!v)continue;const x=c.distanceTo(v);x<p&&(p=x)}if(f=Math.max(d,Math.min(f,p-.45)),f<.65){this._pos.copy(r),this._look.copy(r).addScaledVector(a,10),this.distance=0,this._targetDistance=f,this._applyShake(t),this._commit(t,s,n);return}if(this._targetDistance+=(f-this._targetDistance)*(f<this._targetDistance?1:Math.min(1,t*5)),this.distance=this._targetDistance,this._pos.copy(c).addScaledVector(m,this.distance),this._look.copy(c).addScaledVector(a,4),u){const g=h.currentBuilding,v=g.interiorBounds;this._pos.y=Math.min(this._pos.y,g.padY+v.maxY-.2),this._pos.y=Math.max(this._pos.y,g.padY+.3)}}this._applyShake(t),this._commit(t,s,n)}_applyShake(t){if(this.shakeAmount<=.001)return;const e=this.shakeAmount;this._pos.x+=(Math.random()-.5)*.06*e,this._pos.y+=(Math.random()-.5)*.06*e,this._look.x+=(Math.random()-.5)*.5*e,this._look.y+=(Math.random()-.5)*.5*e,this.shakeAmount*=Math.pow(.06,t)}_commit(t,e,n){var o;this.active.position.copy(this._pos),this.active.lookAt(this._look);const s=(o=this.game.world)!=null&&o.isIndoors?1:0,r=e.fov+this.fovBoost+s*Zv;this.active.fov+=(r-this.active.fov)*Math.min(1,t*6),this.active.updateProjectionMatrix(),n.avatar&&n.avatar.setFirstPerson(this.isFirstPerson||this.distance===0)}basis(){const t=new I(Math.sin(this.yaw),0,Math.cos(this.yaw)).normalize(),e=new I(-t.z,0,t.x);return{forward:t,right:e}}}function Jv(i,t=!1){const e=i[0].index!==null,n=new Set(Object.keys(i[0].attributes)),s=new Set(Object.keys(i[0].morphAttributes)),r={},o={},a=i[0].morphTargetsRelative,c=new nn;let l=0;for(let h=0;h<i.length;++h){const u=i[h];let d=0;if(e!==(u.index!==null))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+". All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them."),null;for(const f in u.attributes){if(!n.has(f))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+'. All geometries must have compatible attributes; make sure "'+f+'" attribute exists among all geometries, or in none of them.'),null;r[f]===void 0&&(r[f]=[]),r[f].push(u.attributes[f]),d++}if(d!==n.size)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+". Make sure all geometries have the same number of attributes."),null;if(a!==u.morphTargetsRelative)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+". .morphTargetsRelative must be consistent throughout all geometries."),null;for(const f in u.morphAttributes){if(!s.has(f))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+".  .morphAttributes must be consistent throughout all geometries."),null;o[f]===void 0&&(o[f]=[]),o[f].push(u.morphAttributes[f])}if(t){let f;if(e)f=u.index.count;else if(u.attributes.position!==void 0)f=u.attributes.position.count;else return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+". The geometry must have either an index or a position attribute"),null;c.addGroup(l,f,h),l+=f}}if(e){let h=0;const u=[];for(let d=0;d<i.length;++d){const f=i[d].index;for(let m=0;m<f.count;++m)u.push(f.getX(m)+h);h+=i[d].attributes.position.count}c.setIndex(u)}for(const h in r){const u=ru(r[h]);if(!u)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+h+" attribute."),null;c.setAttribute(h,u)}for(const h in o){const u=o[h][0].length;if(u===0)break;c.morphAttributes=c.morphAttributes||{},c.morphAttributes[h]=[];for(let d=0;d<u;++d){const f=[];for(let _=0;_<o[h].length;++_)f.push(o[h][_][d]);const m=ru(f);if(!m)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+h+" morphAttribute."),null;c.morphAttributes[h].push(m)}}return c}function ru(i){let t,e,n,s=-1,r=0;for(let l=0;l<i.length;++l){const h=i[l];if(t===void 0&&(t=h.array.constructor),t!==h.array.constructor)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes."),null;if(e===void 0&&(e=h.itemSize),e!==h.itemSize)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes."),null;if(n===void 0&&(n=h.normalized),n!==h.normalized)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes."),null;if(s===-1&&(s=h.gpuType),s!==h.gpuType)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes."),null;r+=h.count*e}const o=new t(r),a=new ze(o,e,n);let c=0;for(let l=0;l<i.length;++l){const h=i[l];if(h.isInterleavedBufferAttribute){const u=c/e;for(let d=0,f=h.count;d<f;d++)for(let m=0;m<e;m++){const _=h.getComponent(d,m);a.setComponent(d+u,m,_)}}else o.set(h.array,c);c+=h.count*e}return s!==void 0&&(a.gpuType=s),a}const Qv=new Set(["position","normal","uv","color"]);function Hd(i,t={}){var o,a;i.updateMatrixWorld(!0);const e=new Map,n=[];i.traverse(c=>{var f,m;if(c===i)return;if(c.isInstancedMesh||c.userData.isSign||c.isLight){n.push(c);return}if(!c.isMesh||!((m=(f=c.geometry)==null?void 0:f.attributes)!=null&&m.position))return;const l=c.material.uuid;e.has(l)||e.set(l,{material:c.material,geos:[],cast:!1});const h=c.geometry.clone();h.applyMatrix4(c.matrixWorld);for(const _ of Object.keys(h.attributes))Qv.has(_)||h.deleteAttribute(_);const u=h.attributes.position.count;h.attributes.uv||h.setAttribute("uv",new ze(new Float32Array(u*2),2)),h.attributes.color||h.setAttribute("color",new ze(new Float32Array(u*3).fill(1),3));const d=e.get(l);d.geos.push(h.index?h.toNonIndexed():h),d.cast=d.cast||c.castShadow});const s=t.colliders?new el(t.colliders,1):null,r=new Xt;for(const{material:c,geos:l,cast:h}of e.values()){if(!l.length)continue;const u=l.length===1?l[0]:Jv(l,!1);if(!u){console.error("bakeGroup: merge returned null (mismatched attributes)",c);continue}const d=((o=c.userData)==null?void 0:o.decal)===!0,f=(a=c.userData)==null?void 0:a.uvScale;f&&!d&&t1(u,f[0],f[1]),s&&!d&&r1(u,s);const m=new st(u,c);m.castShadow=d?!1:h,m.receiveShadow=!d,d&&(m.renderOrder=2),r.add(m)}for(const c of n)r.add(c);return r}function t1(i,t,e=t){const n=i.attributes.position.count,s=i.attributes.position.array,r=i.attributes.normal.array,o=new Float32Array(n*2);for(let a=0;a<n;a++){const c=a*3,l=Math.abs(r[c]),h=Math.abs(r[c+1]),u=Math.abs(r[c+2]);let d,f;h>=l&&h>=u?(d=s[c],f=s[c+2]):l>=u?(d=s[c+2],f=s[c+1]):(d=s[c],f=s[c+1]),o[a*2]=d/t,o[a*2+1]=f/e}i.setAttribute("uv",new ze(o,2))}const qa=512,ou=1024;function au(i,t,e){return((i+qa)*ou+(t+qa))*ou+(e+qa)}class el{constructor(t,e=1){this.cell=e,this.boxes=t,this.bins=new Map;for(let n=0;n<t.length;n++){const s=t[n],r=Math.floor(s.min.x/e),o=Math.floor(s.max.x/e),a=Math.floor(s.min.y/e),c=Math.floor(s.max.y/e),l=Math.floor(s.min.z/e),h=Math.floor(s.max.z/e);for(let u=r;u<=o;u++)for(let d=a;d<=c;d++)for(let f=l;f<=h;f++){const m=au(u,d,f);let _=this.bins.get(m);_||(_=[],this.bins.set(m,_)),_.push(n)}}this._stamp=new Int32Array(t.length),this._epoch=0,this._out=[]}near(t,e,n,s){const r=this.cell,o=this._out;o.length=0;const a=++this._epoch,c=Math.floor((t-s)/r),l=Math.floor((t+s)/r),h=Math.floor((e-s)/r),u=Math.floor((e+s)/r),d=Math.floor((n-s)/r),f=Math.floor((n+s)/r);for(let m=c;m<=l;m++)for(let _=h;_<=u;_++)for(let p=d;p<=f;p++){const g=this.bins.get(au(m,_,p));if(g)for(let v=0;v<g.length;v++){const x=g[v];this._stamp[x]!==a&&(this._stamp[x]=a,o.push(this.boxes[x]))}}return o}}const e1=.18,n1=.55,cu=.75,i1=.3,lu=.55,s1=1.2;function r1(i,t){const e=t instanceof el?t:new el(t,1),n=Array.isArray(i)?i:[i];for(const s of n)o1(s,e)}function o1(i,t){const e=i.attributes.color;if(!e||e.itemSize!==3||e.normalized||!i.attributes.normal)return;const n=i.attributes.position.array,s=i.attributes.normal.array,r=e.array,o=i.attributes.position.count;for(let a=0;a<o;a++){const c=a*3,l=s[c],h=s[c+1],u=s[c+2],d=n[c]+l*.01,f=n[c+1]+h*.01,m=n[c+2]+u*.01;let _=0;const p=t.near(d,f,m,s1);for(let v=0;v<p.length;v++){const x=p[v],M=Math.max(x.min.x-d,0,d-x.max.x),A=Math.max(x.min.y-f,0,f-x.max.y),E=Math.max(x.min.z-m,0,m-x.max.z),b=Math.sqrt(M*M+A*A+E*E);if(b>cu*3)continue;const P=(x.min.x+x.max.x)/2-d,D=(x.min.y+x.max.y)/2-f,y=(x.min.z+x.max.z)/2-m;l*P+h*D+u*y<=0||(_+=n1*Math.exp(-b/e1)+i1*Math.exp(-b/cu))}const g=Math.max(lu,1-Math.min(1-lu,_));r[c]*=g,r[c+1]*=g,r[c+2]*=g}e.needsUpdate=!0}let a1=8,c1=i=>{const t=document.createElement("canvas");return t.width=t.height=i,t};const Gd=(i,t=i)=>{const e=c1(i);return e.width=i,e.height=t,e};let Vd=0;function zl(i,t){return t&&(i.colorSpace=He),i.wrapS=i.wrapT=Bo,i.anisotropy=a1,i.generateMipmaps=!0,i.minFilter=zi,i.magFilter=Dn,Vd+=i.image.width*i.image.height*4*4/3,i}function ci(i){return zl(new Yn(l1(i)),!0)}function nl(i){return i.wrapS=i.wrapT=Oi,i}function l1(i){const t=Gd(i.w,i.h),e=t.getContext("2d"),n=e.createImageData(i.w,i.h),s=n.data,r=i.d,o=i.w*i.h;for(let a=0,c=0,l=0;a<o;a++,c+=3,l+=4){const h=r[c],u=r[c+1],d=r[c+2];s[l]=(h<0?0:h>1?1:h)*255+.5,s[l+1]=(u<0?0:u>1?1:u)*255+.5,s[l+2]=(d<0?0:d>1?1:d)*255+.5,s[l+3]=255}return e.putImageData(n,0,0),t}const Fe=i=>i<0?0:i>1?1:i,oi=i=>[(i>>16&255)/255,(i>>8&255)/255,(i&255)/255];function h1(i){const[t,e,n]=i,s=Math.max(t,e,n),r=Math.min(t,e,n),o=(s+r)/2;if(s===r)return[0,0,o];const a=s-r,c=o>.5?a/(2-s-r):a/(s+r);let l;return s===t?l=((e-n)/a+(e<n?6:0))/6:s===e?l=((n-t)/a+2)/6:l=((t-e)/a+4)/6,[l,c,o]}function u1(i,t,e){if(t===0)return[e,e,e];const n=e<.5?e*(1+t):e+t-e*t,s=2*e-n,r=o=>(o=(o%1+1)%1,o<1/6?s+(n-s)*6*o:o<1/2?n:o<2/3?s+(n-s)*(2/3-o)*6:s);return[r(i+1/3),r(i),r(i-1/3)]}function ii(i,t=1,e=0,n=1){const[s,r,o]=h1(Array.isArray(i)?i:oi(i));return u1(s+e/360,Fe(r*n),Fe(o*t))}function li(i,t){return{w:i,h:t,d:new Float32Array(i*t*3)}}function fs(i,t){const e=Array.isArray(t)?t:oi(t),n=i.d;for(let s=0;s<n.length;s+=3)n[s]=e[0],n[s+1]=e[1],n[s+2]=e[2]}function Fl(i,t,e,n,s){if(s<=0)return;const r=i.w,o=i.h;let a=t,c=e;(a<0||a>=r)&&(a=(a%r+r)%r),(c<0||c>=o)&&(c=(c%o+o)%o);const l=(c*r+a)*3,h=i.d,u=1-s;h[l]=h[l]*u+n[0]*s,h[l+1]=h[l+1]*u+n[1]*s,h[l+2]=h[l+2]*u+n[2]*s}function Pn(i,t,e,n,s,r,o=1){const a=Array.isArray(r)?r:oi(r),c=Math.round(t),l=Math.round(n),h=Math.round(e),u=Math.round(s);if(o<1){for(let _=h;_<u;_++)for(let p=c;p<l;p++)Fl(i,p,_,a,o);return}const d=i.w,f=i.h,m=i.d;for(let _=h;_<u;_++){let p=_;(p<0||p>=f)&&(p=(p%f+f)%f);const g=p*d;for(let v=c;v<l;v++){let x=v;(x<0||x>=d)&&(x=(x%d+d)%d);const M=(g+x)*3;m[M]=a[0],m[M+1]=a[1],m[M+2]=a[2]}}}function Ir(i,t,e,n,s,r=1){const o=n+1;for(let a=Math.floor(e-o);a<=Math.ceil(e+o);a++)for(let c=Math.floor(t-o);c<=Math.ceil(t+o);c++){const l=c+.5-t,h=a+.5-e,u=Fe(n-Math.sqrt(l*l+h*h)+.5);u>0&&Fl(i,c,a,s,r*u)}}function il(i,t,e,n,s=1){const r=Math.max(1,e)/2;for(let o=1;o<t.length;o++){const[a,c]=t[o-1],[l,h]=t[o],u=Math.hypot(l-a,h-c),d=Math.max(1,Math.ceil(u));for(let f=0;f<=d;f++){const m=f/d;Ir(i,a+(l-a)*m,c+(h-c)*m,r,n,s)}}}function Wd(i,t,e,n,s,r,o,a){const c=i.w,l=i.h,h=i.d,u=r/2,d=o[0],f=o[1],m=o[2],_=Math.PI*2/n;for(let p=0;p<l;p++){const g=p*c,v=t+e*Math.sin(p*_+s),x=v-u,M=v+u,A=Math.floor(x),E=Math.ceil(M);for(let b=A;b<=E;b++){const P=Fe(Math.min(b+1,M)-Math.max(b,x));if(P<=0)continue;const D=a*P,y=1-D;let w=b;(w<0||w>=c)&&(w=(w%c+c)%c);const U=(g+w)*3;h[U]=h[U]*y+d*D,h[U+1]=h[U+1]*y+f*D,h[U+2]=h[U+2]*y+m*D}}}const hu=i=>i*i*(3-2*i);function d1(i,t,e){const n=new Float32Array(t*e);for(let s=0;s<n.length;s++)n[s]=i.float();return n}const uu=256;function jn(i,t,e={}){const{p0:n=32,octaves:s=4,gain:r=.5,lacunarity:o=2,h:a=t}=e,c=e.p0x??n,l=e.p0y??n,h=new Float32Array(t*a),u=[];let d=1,f=0;for(let A=0;A<s;A++){const E=Math.min(uu,Math.max(1,Math.round(c*o**A))),b=Math.min(uu,Math.max(1,Math.round(l*o**A)));u.push({lat:d1(i,E,b),px:E,py:b,amp:d}),f+=d,d*=r}const m=new Float64Array(t*a),_=new Int32Array(t),p=new Int32Array(t),g=new Float64Array(t);for(let A=0;A<u.length;A++){const E=u[A],b=E.lat,P=E.px,D=E.py,y=E.amp,w=P/t,U=D/a;for(let N=0;N<t;N++){const W=N*w,q=W|0,H=q>=P?q%P:q;_[N]=H,p[N]=H+1>=P?0:H+1,g[N]=hu(W-q)}for(let N=0;N<a;N++){const W=N*U,q=W|0,H=hu(W-q),Z=1-H,F=q>=D?q%D:q,ut=F*P,dt=(F+1>=D?0:F+1)*P,at=N*t;for(let Ot=0;Ot<t;Ot++){const Yt=_[Ot],Q=p[Ot],z=g[Ot],ct=b[ut+Yt],et=b[ut+Q],_t=b[dt+Yt],ft=b[dt+Q];m[at+Ot]+=y*((ct+(et-ct)*z)*Z+(_t+(ft-_t)*z)*H)}}}let v=1/0,x=-1/0;for(let A=0;A<h.length;A++){h[A]=m[A]/f;const E=h[A];E<v&&(v=E),E>x&&(x=E)}const M=x-v||1;for(let A=0;A<h.length;A++)h[A]=(h[A]-v)/M;return h}function Xd(i,t,e,n){const s=new Float32Array(t*e),r=new Float32Array(t*e),o=2*n+1,a=new Int32Array(t),c=new Int32Array(t);for(let u=0;u<t;u++)a[u]=((u-n)%t+t)%t,c[u]=(u+n+1)%t;for(let u=0;u<e;u++){const d=u*t;let f=0;for(let m=-n;m<=n;m++)f+=i[d+(m%t+t)%t];for(let m=0;m<t;m++)s[d+m]=f/o,f-=i[d+a[m]],f+=i[d+c[m]]}const l=new Int32Array(e),h=new Int32Array(e);for(let u=0;u<e;u++)l[u]=((u-n)%e+e)%e*t,h[u]=(u+n+1)%e*t;for(let u=0;u<t;u++){let d=0;for(let f=-n;f<=n;f++)d+=s[(f%e+e)%e*t+u];for(let f=0;f<e;f++)r[f*t+u]=d/o,d-=s[l[f]+u],d+=s[h[f]+u]}return r}function f1(i,t,e=1.5,n=null){const s=n??i.length/t,r=new Uint8Array(t*s*4),o=e/8,a=new Int32Array(t),c=new Int32Array(t);for(let l=0;l<t;l++)a[l]=(l-1+t)%t,c[l]=(l+1)%t;for(let l=0;l<s;l++){const h=(l-1+s)%s*t,u=l*t,d=(l+1)%s*t;let f=u*4;for(let m=0;m<t;m++,f+=4){const _=a[m],p=c[m],g=i[h+_],v=i[h+m],x=i[h+p],M=i[u+_],A=i[u+p],E=i[d+_],b=i[d+m],P=i[d+p],D=x+2*A+P-(g+2*M+E),y=E+2*b+P-(g+2*v+x),w=-D*o,U=y*o,N=1/Math.sqrt(w*w+U*U+1);r[f]=(w*N*.5+.5)*255+.5,r[f+1]=(U*N*.5+.5)*255+.5,r[f+2]=(N*.5+.5)*255+.5,r[f+3]=255}}return r}function Dr(i,t,e=1.5,n=null){const s=n??i.length/t;return zl(new Yn(qd(f1(i,t,e,s),t,s)),!1)}function qd(i,t,e){const n=Gd(t,e),s=n.getContext("2d"),r=s.createImageData(t,e);return r.data.set(i),s.putImageData(r,0,0),n}function p1(i,t,e,n,s=null){const o=i*(s??i),a=new Uint8Array(o*4);for(let c=0,l=0;c<o;c++,l+=4){const h=t?t[c]:1,u=e?e[c]:.85,d=n?n[c]:0;a[l]=(h<0?0:h>1?1:h)*255+.5,a[l+1]=(u<0?0:u>1?1:u)*255+.5,a[l+2]=(d<0?0:d>1?1:d)*255+.5,a[l+3]=255}return a}function Nn(i,t,e,n,s=null){const r=s??i;return zl(new Yn(qd(p1(i,t,e,n,r),i,r)),!1)}const kl={},Er=new Map;let Yd=null;function hn(i,t){kl[i]=t}const m1=i=>{const t=Object.keys(i).sort();return t.length?t.map(e=>e+"="+JSON.stringify(i[e])).join(","):""};function g1(i,t=null,e={}){const n=kl[i];if(!n)throw new Error(`Textures: no recipe named '${i}'`);const s=m1(e),r=s?i+"#"+s:i;if(Er.has(r))return Er.get(r);const o=t||(Yd||new Zo("textures")).child("tex."+r),a=n(o,e);return a.name=i,Er.set(r,a),a}function _1(){var i,t;for(const e of Er.values()){for(const n of["map","normalMap","ormMap"])(t=(i=e[n])==null?void 0:i.dispose)==null||t.call(i);if(e.maps)for(const n of e.maps)n.dispose()}Er.clear(),Vd=0,Yd=null}Lr(_1);const Ya={blackbutt:{base:13214581,dark:10122054,rough:.4},spottedGum:{base:11040332,dark:8015662,rough:.38},jarrah:{base:9061685,dark:6040352,rough:.44},tasOak:{base:14072722,dark:11111779,rough:.42},pine:{base:14467213,dark:11571294,rough:.5}};hn("timberFloor",(i,t={})=>{const o=1.9500000000000002,a=1024/o,c=1024/15,l=Math.max(2,Math.round(.004*a)),h=t.species||i.pick(Object.keys(Ya)),u=Ya[h]||Ya.blackbutt,d=li(1024,1024);fs(d,ii(u.dark,.72));const f=oi(u.dark),m=ii(u.base,1.25),_=[];for(let E=0;E<15;E++){const b=E*c+l/2,P=(E+1)*c-l/2,D=ii(u.base,1+i.range(-.06,.06),i.range(-3,3));Pn(d,b,0,P,1024,D);const y=Math.round(i.range(.15,.85)*1024);_.push(y),Pn(d,b,y,P,y+2,ii(u.dark,.8),.85),Pn(d,b,y-2,P,y,m,.25);const w=i.int(28,60);for(let U=0;U<w;U++){const N=i.range(b+1,P-1),W=i.range(1.5,4),q=1024/i.int(2,5),H=i.range(0,Math.PI*2),Z=i.range(2,3),F=i.range(.04,.12),ut=i.chance(.25)?m:f;Wd(d,N,W,q,H,Z,ut,F)}if(i.chance(.2)){const U=i.range(204.8,819.2),N=i.range(60,160),W=i.range(b+4,P-4);for(let q=0;q<i.int(2,4);q++){const H=(q+1)*i.range(3,7),Z=[];for(let F=0;F<=16;F++){const ut=F/16;Z.push([W+(ut-.5)*2*H,U-N*(1-(ut-.5)**2*4)])}il(d,Z,2,f,.06)}}}const p=jn(i,512,{p0:64,octaves:3}),g=new Float32Array(512*512),v=new Float32Array(512*512),x=new Float32Array(512*512),M=512/15,A=l*512/1024;for(let E=0;E<512;E++)for(let b=0;b<512;b++){const P=E*512+b,D=Math.floor(b/M),y=b-D*M,w=y<A/2||y>M-A/2,U=E*1024/512,N=_[D],W=U>=N-1&&U<=N+2,q=w||W;v[P]=q?.15:.75,g[P]=Fe(u.rough+(q?.1:0)+(p[P]-.5)*.1),x[P]=q?.72:1}return{map:ci(d),normalMap:Dr(Xd(v,512,512,1),512,1.2),ormMap:Nn(512,x,g,null),uvScale:[o,o],normalScale:.5,species:h,tinted:!1}});hn("plasterWall",(i,t={})=>{const s=t.rough??.88,r=jn(i,256,{p0:64,octaves:3,gain:.45}),o=new Float32Array(256*256),a=.4*256/2;for(let c=0;c<256;c++)for(let l=0;l<256;l++){const h=c*256+l;let u=s+(r[h]**1.5-.5)*.1;t.ceiling||(u+=Math.cos(l/a*Math.PI*2)*.02),o[h]=Fe(u)}return{ormMap:Nn(256,null,o,null),uvScale:[2,2],normalScale:0,tinted:!0}});hn("plasterCeiling",i=>kl.plasterWall(i,{rough:.93,ceiling:!0}));hn("paintedJoinery",i=>{const n=jn(i,256,{p0:64,octaves:3}),s=new Float32Array(256*256);for(let r=0;r<256;r++)for(let o=0;o<256;o++){const a=r*256+o;s[a]=Fe(.42+(n[a]-.5)*.06+Math.sin(o/256*Math.PI*2*12)*.015)}return{ormMap:Nn(256,null,s,null),uvScale:[1,1],normalScale:0,tinted:!0}});hn("carpetPile",i=>{const n=li(512,512);fs(n,[1,1,1]);const s=jn(i,512,{p0x:64,p0y:192,octaves:3,gain:.5}),r=n.d;for(let c=0;c<512;c++)for(let l=0;l<512;l++){const h=c*512+l,u=Math.cos(c/256*Math.PI*2)*.03,d=Fe(.9+(s[h]-.5)*.16+u);r[h*3]=d,r[h*3+1]=d,r[h*3+2]=d}for(let c=0;c<1200;c++){const l=i.pick([[1.1,0],[.78,8],[.92,-10]]),h=ii(16777215,l[0],l[1],1);if(l[1]!==0){const u=i.range(0,1);h[0]=h[0]*(.94+u*.12),h[2]=h[2]*(1.06-u*.12)}Ir(n,i.range(0,512),i.range(0,512),i.range(1,2),h,.25)}const o=jn(i,512,{p0x:43,p0y:128,octaves:3}),a=new Float32Array(512*512);for(let c=0;c<a.length;c++)a[c]=Fe(.92+(o[c]-.5)*.06);return{map:ci(n),normalMap:Dr(o,512,.6),ormMap:Nn(512,null,a,null),uvScale:[1,1],normalScale:.7,tinted:!0}});hn("ceramicTile",(i,t={})=>{const n=t.tile??.3,s=2,r=n*s,o=Math.max(2,Math.round(.003*512/r)),a=3,c=512/s,l=oi(12104358),h=[];for(let p=0;p<s*s;p++)h.push({c:ii(14473423,1+i.range(-.03,.03),i.range(-2,2)),g:i.range(-1,1)});const u=li(512,512),d=new Float32Array(512*512),f=new Float32Array(512*512),m=new Float32Array(512*512),_=o/2;for(let p=0;p<512;p++)for(let g=0;g<512;g++){const v=p*512+g,x=Math.floor(g/c),M=Math.floor(p/c),A=g-x*c,E=p-M*c,b=Math.min(A,c-A,E,c-E);if(b<_){u.d[v*3]=l[0],u.d[v*3+1]=l[1],u.d[v*3+2]=l[2],d[v]=.85,f[v]=.25,m[v]=.62;continue}const P=h[M*s+x],D=(A/c+E/c)/2,y=1.03-.06*(P.g>0?D:1-D);u.d[v*3]=Fe(P.c[0]*y),u.d[v*3+1]=Fe(P.c[1]*y),u.d[v*3+2]=Fe(P.c[2]*y),d[v]=.08;const w=Fe((b-_)/a);f[v]=.25+.75*w,m[v]=.62+.38*w}return{map:ci(u),normalMap:Dr(f,512,2),ormMap:Nn(512,m,d,null),uvScale:[r,r],normalScale:.8,tinted:!1}});hn("fabricWeave",i=>{const n=li(256,256),s=new Float32Array(256*256),r=new Float32Array(256*256),o=128,a=new Float32Array(o*8),c=new Float32Array(o*8);for(let h=0;h<a.length;h++)a[h]=i.range(-.035,.035);for(let h=0;h<c.length;h++)c[h]=i.range(-.035,.035);const l=jn(i,256,{p0:64,octaves:2});for(let h=0;h<256;h++)for(let u=0;u<256;u++){const d=h*256+u,f=(u>>1&1^h>>1&1)===0,m=u>>1,_=h>>1,p=f?a[(m*8+(h>>5&7))%a.length]:c[(_*8+(u>>5&7))%c.length],g=Fe((f?1.06:.94)+p+(l[d]-.5)*.06);n.d[d*3]=g,n.d[d*3+1]=g,n.d[d*3+2]=g,s[d]=f?.66:.8,r[d]=f?1:.3}return{map:ci(n),normalMap:Dr(Xd(r,256,256,1),256,.8),ormMap:Nn(256,null,s,null),uvScale:[.25,.25],normalScale:.6,tinted:!0}});hn("joineryTimber",i=>{const n=li(512,512);fs(n,[1,1,1]);const s=jn(i,512,{p0x:48,p0y:8,octaves:4}),r=n.d;for(let c=0;c<512*512;c++){const l=Fe(.94+(s[c]-.5)*.22);r[c*3]=l,r[c*3+1]=l,r[c*3+2]=l}const o=ii(16777215,.72);for(let c=0;c<220;c++){const l=i.range(0,512),h=i.range(2,6),u=512/i.int(1,2),d=i.range(0,Math.PI*2);Wd(n,l,h,u,d,i.range(2,3.5),o,i.range(.03,.09))}const a=new Float32Array(512*512);for(let c=0;c<a.length;c++)a[c]=Fe(.55+(s[c]-.5)*.08);return{map:ci(n),ormMap:Nn(512,null,a,null),uvScale:[1,1],normalScale:0,tinted:!0}});hn("vinylSheet",i=>{const n=li(512,512);fs(n,14209732);const s=[13222578,15131093,11906460,14472902].map(oi);for(let c=0;c<3e3;c++)Ir(n,i.range(0,512),i.range(0,512),i.range(1,3),i.pick(s),.35);const r=jn(i,512,{p0:32,octaves:3}),o=new Float32Array(512*512);for(let c=0;c<o.length;c++)o[c]=Fe(.28+(r[c]-.5)*.12);const a={w:512,h:512,d:new Float32Array(512*512*3)};for(let c=0;c<12;c++){const l=i.range(0,512),h=i.range(0,512),u=i.range(40,120),d=i.range(0,Math.PI*2),f=i.range(.6,2.2),m=[];for(let _=0;_<=24;_++){const p=d+f*(_/24);m.push([l+Math.cos(p)*u,h+Math.sin(p)*u])}il(n,m,i.range(2,4),ii(14209732,.88),.3),il(a,m,i.range(2,4),[1,1,1],1)}for(let c=0;c<o.length;c++)o[c]=Fe(o[c]+a.d[c*3]*.15);return{map:ci(n),ormMap:Nn(512,null,o,null),uvScale:[1,1],normalScale:0,tinted:!1}});hn("laminateBench",i=>{const s=li(512,512);fs(s,xt.benchtop);const r=[9274743,14077886,7235417].map(oi);for(let l=0;l<2e3;l++)Ir(s,i.range(0,512),i.range(0,512),i.range(1,2.5),i.pick(r),.3);const o=new Float32Array(512*512);for(let l=0;l<o.length;l++)o[l]=.28;const a=Math.max(2,Math.round(.006*512/.6)),c=ii(xt.benchtop,.82);for(let l=0;l<512;l++)if(Math.min(l,512-l)<a)for(let u=0;u<512;u++)Fl(s,u,l,c,.85),o[l*512+u]=.45;return{map:ci(s),ormMap:Nn(512,null,o,null),uvScale:[1.2,.6],normalScale:0,tinted:!1}});hn("ceilingGrid",i=>{const s=li(512,512);fs(s,15526370);const r=Math.max(2,Math.round(.015*512/1.2)),o=Math.max(2,Math.round(.015*512/.6)),a=oi(14210509),c=oi(12434098),l=jn(i,512,{p0:64,octaves:2}),h=new Float32Array(512*512);for(let u=0;u<512;u++)for(let d=0;d<512;d++){const f=u*512+d,m=Math.min(d,512-d),_=Math.min(u,512-u);if(m<r/2||_<o/2){const v=m>=r/2-2&&m<r/2||_>=o/2-2&&_<o/2?c:a;s.d[f*3]=v[0],s.d[f*3+1]=v[1],s.d[f*3+2]=v[2],h[f]=.55}else{const g=1+(l[f]-.5)*.04;s.d[f*3]*=g,s.d[f*3+1]*=g,s.d[f*3+2]*=g,h[f]=.9}}return{map:ci(s),ormMap:Nn(512,null,h,null),uvScale:[1.2,.6],normalScale:0,tinted:!1}});hn("applianceEnamel",i=>{const n=jn(i,256,{p0:64,octaves:3}),s=new Float32Array(256*256);for(let r=0;r<s.length;r++)s[r]=Fe(.3+(n[r]-.5)*.04);return{ormMap:Nn(256,null,s,null),uvScale:[1,1],normalScale:0,tinted:!0}});hn("metalBrushed",i=>{const n=new Float32Array(65536),s=new Float32Array(256*256),r=jn(i,256,{p0x:8,p0y:256,octaves:2});for(let o=0;o<256;o++){const a=i.range(-.1,.1);for(let c=0;c<256;c++){const l=o*256+c;n[l]=Fe(.35+a*.6+(r[l]-.5)*.1)}}return{ormMap:Nn(256,null,n,s),uvScale:[.4,.4],normalScale:0,tinted:!0}});hn("quiltFolds",i=>{const n=[],s=i.int(5,9);for(let d=0;d<s;d++)n.push({a:i.range(.4,1),c:i.range(.05,.95),w:i.range(.06,.14)});const r=d=>{let f=0;for(const m of n)f+=m.a*Math.exp(-(((d-m.c)/m.w)**2));return f+=.5*Math.exp(-((d/.04)**2))+.5*Math.exp(-(((1-d)/.04)**2)),f};let o=1/0,a=-1/0;for(let d=0;d<=256;d++){const f=r(d/256);f<o&&(o=f),f>a&&(a=f)}const c=a-o||1,l=d=>(r(Fe(d))-o)/c,h=li(512,256),u=new Float32Array(512*256);for(let d=0;d<512;d++){const f=l(d/511),m=.9+.1*f;for(let _=0;_<256;_++){const p=_*512+d;h.d[p*3]=m,h.d[p*3+1]=m,h.d[p*3+2]=m,u[p]=f}}return{map:nl(ci(h)),normalMap:nl(Dr(u,512,3,256)),uvScale:null,normalScale:1,field:l,folds:n,tinted:!0}});hn("pictureArt",i=>{const n=[[14272936,10251087,4148050,15130057],[8361635,14213090,3095106,12820586],[11056266,15196880,6056775,9067068],[13609376,8015698,15722204,3814198],[9415096,15788760,4479587,12153919]],s=[];for(let r=0;r<5;r++){const o=n[r].map(oi),a=li(256,256);fs(a,o[i.int(0,3)]);const c=i.int(0,2);if(c===0){let h=0;for(;h<256;){const u=i.int(12,48);Pn(a,0,h,256,Math.min(256,h+u),o[i.int(0,3)],i.range(.5,1)),h+=u}}else if(c===1)for(let h=0;h<i.int(5,11);h++){const u=i.range(0,179.2),d=i.range(0,256*.7);Pn(a,u,d,u+i.range(30,110),d+i.range(30,110),o[i.int(0,3)],i.range(.55,.95))}else{const h=i.range(115.2,174.08);Pn(a,0,0,256,h,o[0],1),Pn(a,0,h,256,256,o[2],1);for(let u=0;u<i.int(3,7);u++){const d=i.range(h-40,h+40);Pn(a,0,d,256,d+i.range(3,10),o[i.int(0,3)],i.range(.3,.7))}Ir(a,i.range(256*.2,256*.8),i.range(20,h-20),i.range(12,26),o[3],.9)}const l=ii(16777215,.97);Pn(a,0,0,256,6,l),Pn(a,0,250,256,256,l),Pn(a,0,0,6,256,l),Pn(a,250,0,256,256,l),s.push(nl(ci(a)))}return{maps:s,map:s[0],uvScale:null,normalScale:0,prints:5,tinted:!1}});const x1={wall:{recipe:"plasterWall",r:1,m:0,cast:!0,tint:!0},wallWet:{recipe:"ceramicTile",r:1,m:0,cast:!0,tint:!1},ceiling:{recipe:"plasterCeiling",r:1,m:0,cast:!1,tint:!0},trim:{recipe:"paintedJoinery",r:1,m:0,cast:!0,tint:!0},doorLeaf:{recipe:"paintedJoinery",r:1,m:0,cast:!0,tint:!0},floorTimber:{recipe:"timberFloor",r:1,m:0,cast:!1,tint:!1},carpet:{recipe:"carpetPile",r:1,m:0,cast:!1,tint:!0},vinyl:{recipe:"vinylSheet",r:1,m:0,cast:!1,tint:!1},tile:{recipe:"ceramicTile",r:1,m:0,cast:!1,tint:!1},joinery:{recipe:"joineryTimber",r:1,m:0,cast:!0,tint:!0},fabric:{recipe:"fabricWeave",r:1,m:0,cast:!0,tint:!0},bedding:{recipe:"fabricWeave",r:1,m:0,cast:!0,tint:!0},bench:{recipe:"laminateBench",r:1,m:0,cast:!0,tint:!1},appliance:{recipe:"applianceEnamel",r:1,m:0,cast:!0,tint:!0},metal:{recipe:"metalBrushed",r:1,m:1,cast:!0,tint:!0},chrome:{recipe:null,r:.18,m:0,cast:!0,tint:!1},ceramic:{recipe:null,r:.12,m:0,cast:!0,tint:!1},screen:{recipe:null,r:.08,m:0,cast:!1,tint:!1},glass:{recipe:null,r:.1,m:0,cast:!1,tint:!1,alpha:.28},ceilingGrid:{recipe:"ceilingGrid",r:1,m:0,cast:!1,tint:!1},quilt:{recipe:"quiltFolds",r:.8,m:0,cast:!0,tint:!0},artwork:{recipe:"pictureArt",r:.55,m:0,cast:!1,tint:!1}},Fs=new Map;function Bl(i,t=16777215,e=null,n={}){const s=x1[i];if(!s)throw new Error(`Surfaces: no surface named '${i}'`);const r=Object.keys(n).sort().map(h=>h+"="+JSON.stringify(n[h])).join(","),o=i+"|"+t+"|"+r;if(Fs.has(o))return Fs.get(o);const a={color:t,roughness:s.r,metalness:s.m,vertexColors:!0};s.alpha!==void 0&&(a.transparent=!0,a.opacity=s.alpha,a.depthWrite=!1);const c=h=>s.alpha!==void 0?Nl(h):h;if(s.recipe){const{print:h,...u}=n,d=Object.keys(u).sort().map(g=>g+"="+JSON.stringify(u[g])).join(","),f=e?e.child("tex."+s.recipe+(d?"#"+d:"")):null,m=g1(s.recipe,f,u),_=m.maps?m.maps[Math.min(m.maps.length-1,h??0)]:m.map;if(_&&(a.map=_),m.normalMap){a.normalMap=m.normalMap;const g=m.normalScale??1;a.normalScale=new wt(g,g)}m.ormMap?(a.aoMap=m.ormMap,a.roughnessMap=m.ormMap,a.aoMapIntensity=1,a.roughness=1,s.m===1&&(a.metalnessMap=m.ormMap,a.metalness=1)):a.roughness=s.r===1?.85:s.r;const p=c(new gn(a));return m.uvScale&&(p.userData.uvScale=m.uvScale),p.userData.cast=s.cast,p.userData.surface=i,Fs.set(o,p),p}const l=c(new gn(a));return l.userData.cast=s.cast,l.userData.surface=i,Fs.set(o,l),l}function v1(){for(const i of Fs.values())i.dispose();Fs.clear()}Lr(v1);const Dt={wallThick:.17,storey:2.65,cornice:.09,doorH:2.05,winSill:.95,winHead:2.15,intWall:.11,skirtProud:.018,archW:.09,archProud:.018,archQuirk:.006,corniceGirth:.075,reveal:.019,skirtCommercial:.1,leafT:.035,headDatum:2.1,benchH:.9,toeKickH:.15,toeKickD:.05,cabinetModules:[.3,.45,.6,.75,.9,1,1.2],handleH:1,switchH:1.05,gpoH:.3},Le={thin:.002,furniture:.003,joinery:.005},du=new Set;function sl(i,t,e={}){if(e.material)return e.material;try{return Bl(i,t,null,e.recipe||{})}catch(n){du.has(i)||(du.add(i),console.error(`RoomKit: surface '${i}' unavailable, falling back to flat colour`,n))}return Se(t,e)}function se(i,t,e,n,s,r={}){var l;const o=sl(i,s,r),a=r.chamfer?Zd(t,e,n,r.chamfer):r.graded?y1(t,e,n,r.gradeEdge):new Ut(Math.max(t,.001),Math.max(e,.001),Math.max(n,.001)),c=new st(a,o);return c.castShadow=r.cast??((l=o.userData)==null?void 0:l.cast)??!1,c.receiveShadow=!0,c}const nr=new Map,Fi=i=>Math.round(i*1e3);function jd(i,t,e){const n=new Float32Array(e*2);for(let s=0;s<e;s++){const r=s*3,o=Math.abs(t[r]),a=Math.abs(t[r+1]),c=Math.abs(t[r+2]);a>=o&&a>=c?(n[s*2]=i[r],n[s*2+1]=i[r+2]):o>=c?(n[s*2]=i[r+2],n[s*2+1]=i[r+1]):(n[s*2]=i[r],n[s*2+1]=i[r+1])}return n}function $d(i){const t=i.length*3,e=new Float32Array(t*3),n=new Float32Array(t*3);let s=0;for(const o of i){const[a,c,l]=o;let h=c[0]-a[0],u=c[1]-a[1],d=c[2]-a[2],f=l[0]-a[0],m=l[1]-a[1],_=l[2]-a[2],p=u*_-d*m,g=d*f-h*_,v=h*m-u*f;const x=(a[0]+c[0]+l[0])/3,M=(a[1]+c[1]+l[1])/3,A=(a[2]+c[2]+l[2])/3;let E=c,b=l;p*x+g*M+v*A<0&&(E=l,b=c,p=-p,g=-g,v=-v);const P=Math.hypot(p,g,v)||1;p/=P,g/=P,v/=P;for(const D of[a,E,b])e[s*3]=D[0],e[s*3+1]=D[1],e[s*3+2]=D[2],n[s*3]=p,n[s*3+1]=g,n[s*3+2]=v,s++}const r=new nn;return r.setAttribute("position",new ze(e,3)),r.setAttribute("normal",new ze(n,3)),r.setAttribute("uv",new ze(jd(e,n,t),2)),r.setAttribute("color",new ze(new Float32Array(t*3).fill(1),3)),r}function Zd(i,t,e,n=Le.furniture){i=Math.max(i,.001),t=Math.max(t,.001),e=Math.max(e,.001);const s=Math.min(n,Math.min(i,t,e)/2-5e-4);if(!(s>2e-4))return new Ut(i,t,e);const r=`c${Fi(i)},${Fi(t)},${Fi(e)},${Fi(s)}`,o=nr.get(r);if(o)return o;const a=i/2,c=t/2,l=e/2,h=[a-s,c-s,l-s],u=[a,c,l],d=(g,v)=>[(v===0?u[0]:h[0])*g[0],(v===1?u[1]:h[1])*g[1],(v===2?u[2]:h[2])*g[2]],f=[];for(const g of[-1,1])for(const v of[-1,1])for(const x of[-1,1])f.push([g,v,x]);const m=[],_=(g,v,x,M)=>{m.push([g,v,x]),m.push([g,x,M])};for(let g=0;g<3;g++){const v=(g+1)%3,x=(g+2)%3;for(const M of[-1,1]){const A=(E,b)=>{const P=[0,0,0];return P[g]=M,P[v]=E,P[x]=b,d(P,g)};_(A(-1,-1),A(1,-1),A(1,1),A(-1,1))}}for(let g=0;g<3;g++)for(let v=g+1;v<3;v++){const x=3-g-v;for(const M of[-1,1])for(const A of[-1,1]){const E=[0,0,0];E[g]=M,E[v]=A,E[x]=-1;const b=[0,0,0];b[g]=M,b[v]=A,b[x]=1,_(d(E,g),d(E,v),d(b,v),d(b,g))}}for(const g of f)m.push([d(g,0),d(g,1),d(g,2)]);const p=$d(m);return nr.set(r,p),p}const ho=[0,.05,.18,.55];function fu(i,t=.12){const e=t/.12,n=[0];for(let s=1;s<ho.length;s++){const r=ho[s]*e;r<i/2-1e-4&&n.push(r)}n.push(i/2);for(let s=ho.length-1;s>=1;s--){const r=i-ho[s]*e;r>i/2+1e-4&&n.push(r)}return n.push(i),n}function pu(i,t,e,n,s,r){const o=(a,c)=>[t[0]+e[0]*a+n[0]*c,t[1]+e[1]*a+n[1]*c,t[2]+e[2]*a+n[2]*c];for(let a=0;a<s.length-1;a++)for(let c=0;c<r.length-1;c++){const l=o(s[a],r[c]),h=o(s[a+1],r[c]),u=o(s[a+1],r[c+1]),d=o(s[a],r[c+1]);i.push([l,h,u]),i.push([l,u,d])}}function y1(i,t,e,n=.12){const s=`g${Fi(i)},${Fi(t)},${Fi(e)},${Fi(n)}`,r=nr.get(s);if(r)return r;const o=e<=i&&e<=t?2:t<=i?1:0,[a,c,l]=o===2?[i,t,e]:o===1?[i,e,t]:[e,t,i],h=a/2,u=c/2,d=l/2,f=fu(a,n),m=fu(c,n),_=[];pu(_,[-h,-u,d],[1,0,0],[0,1,0],f,m),pu(_,[-h,-u,-d],[1,0,0],[0,1,0],f,m);const p=(v,x,M,A)=>{_.push([v,x,M]),_.push([v,M,A])};p([h,-u,-d],[h,u,-d],[h,u,d],[h,-u,d]),p([-h,-u,-d],[-h,u,-d],[-h,u,d],[-h,-u,d]),p([-h,u,-d],[h,u,-d],[h,u,d],[-h,u,d]),p([-h,-u,-d],[h,-u,-d],[h,-u,d],[-h,-u,d]);const g=$d(_);if(o===1?g.rotateX(-Math.PI/2):o===0&&g.rotateY(Math.PI/2),o!==2){const v=g.attributes.position.array,x=g.attributes.normal.array;g.setAttribute("uv",new ze(jd(v,x,g.attributes.position.count),2))}return nr.set(s,g),g}Lr(()=>{for(const i of nr.values())i.dispose();nr.clear()});class M1{constructor(){this.group=new Xt,this.colliders=[],this.doors=[],this.interactables=[],this.spots={},this.lights=[],this.faces={},this.decals=[]}add(t){return this.group.add(t),t}solid(t,e,n,s,r,o,a=!1){this.colliders.push({min:new I(t-s/2,e,n-o/2),max:new I(t+s/2,e+r,n+o/2),walkable:a})}spot(t,e,n,s){return this.spots[t]=new I(e,n,s),this.spots[t]}interact(t,e,n,s,r,o,a={},c=1.8){this.interactables.push({id:t,label:e,pos:new I(n,s,r),action:o,data:a,radius:c})}light(t,e,n,s=16770756,r=9,o=13){const a=new Iv(s,r,o,2);return a.position.set(t,e,n),this.group.add(a),this.lights.push(a),a}}function S1(i,t,e,n,s,r,o=xt.floorTimber,a={}){const c=a.thickness??.16,l=se(a.surface??"floorTimber",n,c,s,o,{graded:!0,gradeEdge:a.gradeEdge??.12,cast:!1});return l.position.set(t,r-c/2,e),i.add(l),i.solid(t,r-c,e,n,c,s,!0),l}function mu(i,t,e,n,s,r,o=xt.ceiling,a={}){const c=a.thickness??Dt.cornice,l=se(a.surface??"ceiling",n,c,s,o,{graded:!0,gradeEdge:a.gradeEdge??.12,cast:!1});return l.position.set(t,r+c/2,e),i.add(l),l}function w1(i,t,e,n,s=0,r={}){const o=se("trim",.075,.115,.01,r.colour??xt.trim,{});o.position.set(t,e,n),o.rotation.y=s,i.add(o);const a=se("trim",.03,.055,.004,r.colour??xt.trim,{});return a.rotation.y=s,a.position.set(t,e,n),a.translateZ(.007),i.add(a),o}function E1(i,t,e,n,s=0,r={}){const o=se("trim",.115,.075,.01,r.colour??xt.trim,{});return o.position.set(t,e,n),o.rotation.y=s,i.add(o),o}function ti(i,t,e,n,s,r,o={}){const a=o.margin??Math.min(Math.max(Math.min(s,r)*.3,.05),.3);let c=t-s/2-a,l=t+s/2+a,h=e-r/2-a,u=e+r/2+a;const d=t-s/2,f=t+s/2,m=e-r/2,_=e+r/2;for(const x of i.decals){if(l<=x.x0||c>=x.x1||u<=x.z0||h>=x.z1)continue;const M=Math.min(l-x.x0,x.x1-c),A=Math.min(u-x.z0,x.z1-h);if(M<=A?t<(x.x0+x.x1)/2?l=Math.max(f,Math.min(l,x.x0)):c=Math.min(d,Math.max(c,x.x1)):e<(x.z0+x.z1)/2?u=Math.max(_,Math.min(u,x.z0)):h=Math.min(m,Math.max(h,x.z1)),l>x.x0+1e-4&&c<x.x1-1e-4&&u>x.z0+1e-4&&h<x.z1-1e-4)return null}const p=l-c,g=u-h;if(p<.05||g<.05)return null;const v=new st(new Ie(p,g),Wv());return v.rotation.x=-Math.PI/2,v.position.set((c+l)/2,n+.006,(h+u)/2),i.add(v),i.decals.push({x0:c,x1:l,z0:h,z1:u}),v}const mi=new Ei;function Kd(i,t,e,n){mi.setFromObject(t);const s=mi.max.x-mi.min.x,r=mi.max.z-mi.min.z;return i.solid((mi.min.x+mi.max.x)/2,e,(mi.min.z+mi.max.z)/2,s,n,r),[s,r]}function b1(i,t,e,n){if(i.door===!1||i.leaf===!1||i.door===void 0&&i.leaf===void 0&&t<=1.005)return null;const s=i.door||{},r=t>=1.25,o=s.style??(i.leaf?"panel":r?"glazed":"panel");return{label:s.label??"door",style:o,pair:s.pair??r,auto:s.auto??!1,startsShut:s.startsShut??!0,face:s.swing??n,colour:s.colour??i.leaf??(o==="glazed"?qt.metal:e),surfaceName:s.surface??i.leafSurface??"doorLeaf",triggerR:s.triggerR,dwell:s.dwell,leaves:[]}}function rs(i,t,e,n,s,r={}){const{y0:o=0,height:a=Dt.storey,thickness:c=Dt.wallThick,colour:l=xt.wall,innerColour:h=null,outerColour:u=null,openings:d=[],skirting:f=!0,skirtStyle:m="timber",cornice:_=!0,corniceStyle:p="cove",autoServices:g=!0,inner:v=null,surface:x="wall",trimColour:M=xt.trim,graded:A=!0,name:E=null}=r,b=h??u,P=n-t,D=s-e,y=Math.hypot(P,D);if(y<.01)return;const w=P/y,U=D/y,N=Math.atan2(-U,w),W=-U,q=w,H=c/2,Z=(z,ct,et,_t=0,ft=0)=>(z.position.set(t+w*ct+W*_t,et,e+U*ct+q*_t),z.rotation.y=N+ft,i.add(z),z),F=(z,ct,et,_t={})=>se("trim",z,ct,et,_t.colour??M,_t),ut=v===null?[-1,1]:[v],dt=(z,ct,et,_t)=>{const ft=ct-z,St=_t-et;if(ft<=.005||St<=.005)return;const At=(z+ct)/2,K=_&&p==="shadowline"&&Math.abs(_t-(o+a))<.02,T=K?St-.01:St,gt=ft>=1.2&&T>=1.2,rt=se(x,ft,T,c,l,{graded:A&&gt,cast:!0});if(Z(rt,At,et+T/2),K){const C=se(x,ft,.01,c-.02,l,{});Z(C,At,_t-.005)}const it=Math.abs(w)*ft+Math.abs(U)*c,lt=Math.abs(U)*ft+Math.abs(w)*c,Pt=t+w*At,ot=e+U*At;if(i.solid(Pt,et,ot,it,St,lt),b)for(const C of ut){const S=se(x,ft,T,.02,b,{graded:A&&gt});Z(S,At,et+T/2,C*(H+.01))}if(f&&m&&et-o<.02)if(m==="commercial"){const C=F(ft,Dt.skirtCommercial,c+.04,{colour:xt.tileFloor,chamfer:Le.thin});Z(C,At,et+Dt.skirtCommercial/2)}else{const C=[[.112,Dt.skirtProud,0,Le.thin],[.018,.014,.112,0],[.008,.008,.13,0]];for(const[S,B,J,nt]of C){const tt=F(ft,S,c+B*2,{chamfer:nt});Z(tt,At,et+J+S/2)}}if(_&&p==="cove"&&Math.abs(_t-(o+a))<.02){const C=Dt.corniceGirth/Math.SQRT2;for(const S of ut){const B=F(ft,Dt.corniceGirth,.008,{chamfer:0});Z(B,At,_t-C/2,S*(H+C/2)),B.rotation.order="YXZ",B.rotation.set(-S*Math.PI/4,N,0)}}},at=(z,ct,et,_t)=>{const ft=_t-et;for(const At of[-1,1]){const K=F(Dt.reveal,ft,c,{});Z(K,z+At*(ct/2-Dt.reveal/2),et+ft/2)}const St=F(ct,Dt.reveal,c,{});Z(St,z,_t-Dt.reveal/2)},Ot=(z,ct,et,_t)=>{const ft=ct-2*Dt.reveal,St=ft/2+Dt.archQuirk,At=_t+Dt.archQuirk;for(const K of[-1,1])for(const T of[-1,1]){const gt=F(Dt.archW,At-et+.002,Dt.archProud,{chamfer:Le.joinery});if(Z(gt,z+K*(St+Dt.archW/2),et+(At-et)/2,T*(H+Dt.archProud/2)),et-o<.02){const rt=F(Dt.archW+.02,.15,.032,{});Z(rt,z+K*(St+Dt.archW/2),et+.075,T*(H+.016))}}for(const K of[-1,1]){const T=F(ft+2*(Dt.archW+Dt.archQuirk),Dt.archW,Dt.archProud,{chamfer:Le.joinery});Z(T,z,At+Dt.archW/2,K*(H+Dt.archProud/2))}},Yt=[...d].sort((z,ct)=>z.at-ct.at);let Q=0;for(const z of Yt){const ct=z.width/2,et=Math.max(0,z.at-ct),_t=Math.min(y,z.at+ct),ft=z.kind==="window"?z.sill??Dt.winSill:0,St=z.kind==="window"?z.head??Dt.winHead:z.head??(z.kind==="arch"?2.25:Dt.doorH);if(dt(Q,et,o,o+a),ft>0&&dt(et,_t,o,o+ft),dt(et,_t,o+St,o+a),Q=_t,z.kind==="window"){const At=St-ft,K=o+(ft+St)/2,T=v===null?1:-v,gt=new st(new Ut(z.width-2*Dt.reveal-.002,At-.002,.006),ds());gt.castShadow=!1,gt.receiveShadow=!0,Z(gt,z.at,K,T*.015);const rt=new st(new Ut(z.width-2*Dt.reveal-.002,At-.002,.006),Hv());rt.castShadow=!1,rt.receiveShadow=!0,Z(rt,z.at,K,-T*.015),at(z.at,z.width,o+ft,o+St),Ot(z.at,z.width,o+ft,o+St);const it=Math.max(1,Math.round((z.width-2*Dt.reveal)/.9)),lt=z.width-2*Dt.reveal;for(let ot=1;ot<it;ot++){const C=F(.04,At,.05,{chamfer:Le.joinery});Z(C,z.at-lt/2+lt/it*ot,K)}const Pt=z.restrictor?Math.min(o+1.7,o+St-.1):o+ft+At/3;if(At>.55){const ot=F(lt,.04,.05,{chamfer:Le.joinery});Z(ot,z.at,Pt)}if(z.restrictor){const ot=F(.06,.02,.03,{colour:xt.metalDull,chamfer:Le.thin});Z(ot,z.at+lt/4,o+ft+.02,0)}for(const ot of ut){const C=F(z.width+.09,.025,c/2+.03,{chamfer:Le.joinery});Z(C,z.at,o+ft-.0125,ot*(c/4+.015))}if(v!==null){const ot=F(z.width+.12,.04,.09,{chamfer:Le.joinery});Z(ot,z.at,o+ft-.02,-v*(H+.045)),ot.rotation.order="YXZ",ot.rotation.set(v*.1,N,0)}if(z.curtains){T1(i,t+w*z.at,o+St+.15,e+U*z.at,N,z.width+.4,{offset:(v??1)*(H+.09)});const ot=[.3,.22],C=v??1;for(const B of[-1,1]){const J=ot[B<0?0:1],nt=z.width*J,tt=6;for(let Lt=0;Lt<tt;Lt++){const mt=nt/tt,yt=se("fabric",mt*1.35,At+.35,.045,z.curtains,{cast:!0}),Zt=z.at+B*(z.width/2-nt+(Lt+.5)*mt);Z(yt,Zt,K+.1,C*(H+.075),Lt%2?.175:-.175)}}const S=F(z.width+.44,.12,.09,{chamfer:Le.joinery});Z(S,z.at,o+St+.21,C*(H+.055))}}else if((z.kind==="door"||z.kind==="arch")&&(at(z.at,z.width,o,o+St),Ot(z.at,z.width,o,o+St),z.kind==="door")){const At=z.swing??1,K=z.width/2-Dt.reveal,T=H-.045;for(const it of[-1,1]){const lt=F(.013,St-.02,.03,{});Z(lt,z.at+it*(K-.0055),o+(St-.02)/2,At*T)}const gt=F(z.width-2*Dt.reveal,.014,.03,{});Z(gt,z.at,o+St-.025,At*T);const rt=b1(z,z.width,M,At);if(rt){const it=T+.015+Dt.leafT,lt=St-Dt.reveal-.02,Pt=rt.pair?K-.006:2*K-.006,ot=rt.face,C=rt.pair?[1,-1]:[ot];for(const S of C){const B=z.at+S*(K-.003),J=ot*it;rt.leaves.push({hx:t+w*B+W*J,hz:e+U*B+q*J,y:o,baseRot:N,phiOpen:S*ot*Math.PI/2,leafRot:S>0?0:Math.PI,dx:-S*Pt/2,dz:-ot*Dt.leafT/2,lw:Pt,lh:lt});for(const nt of[.15,1.02,1.89]){if(nt>lt-.1)continue;const tt=se("chrome",.016,.1,.016,qt.metal,{chamfer:.001,cast:!1});Z(tt,B,o+.015+nt,J)}}rt.centre={x:t+w*z.at,z:e+U*z.at},rt.y0=o,i.doors.push(rt)}}if(g&&z.kind==="door"){const At=-(z.swing??1);for(const K of[-1,1])w1(i,t+w*(z.at+At*(z.width/2+Dt.archW+.15))+W*K*(H+.006),o+Dt.switchH,e+U*(z.at+At*(z.width/2+Dt.archW+.15))+q*K*(H+.006),N+(K<0?Math.PI:0))}}if(dt(Q,y,o,o+a),g&&v!==null&&o+Dt.gpoH<o+a){const z=Math.max(1,Math.floor(y/3.5));for(let ct=0;ct<z;ct++){const et=(ct+.5)*(y/z);Yt.some(_t=>Math.abs(_t.at-et)<_t.width/2+.25)||E1(i,t+w*et+W*v*(H+.006),o+Dt.gpoH,e+U*et+q*v*(H+.006),N+(v<0?Math.PI:0))}}E&&(i.faces[E]={a:{x:t,z:e},b:{x:n,z:s},u:{x:w,z:U},n:{x:W,z:q},angle:N,thickness:c,y0:o,height:a,length:y,face:z=>({x:(t+n)/2+W*z*(c/2),z:(e+s)/2+q*z*(c/2),nx:W*z,nz:q*z,rotY:N+(z<0?Math.PI:0)})})}function T1(i,t,e,n,s=0,r=1.6,o={}){const a=new Xt,c=new st(new Ve(.0125,.0125,r,8),sl("chrome",o.colour??qt.metalDark));c.rotation.z=Math.PI/2,a.add(c);for(const l of[-1,1]){const h=new st(new Vi(.0175,8,6),sl("chrome",o.colour??qt.metalDark));h.position.x=l*r/2,a.add(h)}return a.rotation.y=s,a.position.set(t,e,n),a.translateZ(o.offset??0),i.add(a),a}function A1(i,t,e,n,s=!0){const r=se("chrome",s?.128:.018,s?.018:.128,.018,qt.metal,{chamfer:.001,cast:!1});r.position.set(t,e,n+.032),i.add(r);for(const o of[-1,1]){const a=se("chrome",.01,.01,.032,qt.metal,{cast:!1});a.position.set(t+(s?o*.064:0),e+(s?0:o*.064),n+.016),i.add(a)}return r}function rl(i,t,e,n,s=0,r=xt.joineryLight){const o=typeof r=="object"&&r!==null?r:{colour:r},{colour:a=xt.joineryLight,frame:c=xt.joineryDark,collide:l=!0,seatH:h=.45}=o,u=new Xt,d=.44,f=se("joinery",d,.018,d,a,{chamfer:.02,cast:!0});f.position.y=h-.009,u.add(f);const m=.42,_=se("joinery",d,m,.018,a,{chamfer:Le.furniture});_.position.set(0,h+.04+m/2,-d/2+.02),_.rotation.x=.14,u.add(_);for(const p of[-1,1]){const g=se("joinery",.03,m+.07,.03,c,{chamfer:Le.furniture});g.position.set(p*(d/2-.02),h+.02+(m+.07)/2,-d/2+.02),g.rotation.x=.14,u.add(g)}for(const p of[-1,1])for(const g of[-1,1]){const v=se("joinery",.032,h-.018,.032,c,{chamfer:Le.furniture});v.position.set(p*(d/2-.024),(h-.018)/2,g*(d/2-.024)),g<0&&(v.rotation.x=-.105),u.add(v)}for(const p of[-1,1]){const g=se("joinery",d-.07,.045,.016,c,{chamfer:Le.thin});g.position.set(0,h-.045,p*(d/2-.026)),u.add(g);const v=se("joinery",d-.07,.02,.02,c,{chamfer:Le.thin});v.position.set(0,.18,p*(d/2-.026)),u.add(v)}return u.position.set(t,n,e),u.rotation.y=s,i.add(u),l&&i.solid(t,n,e,.45,.45,.45),u}function R1(i,t,e,n,s,r,o=0,a=xt.benchtop,c=xt.joineryLight,l={}){const{shadow:h=!0,handle:u=!0}=l,d=new Xt,f=Dt.toeKickH,m=Dt.toeKickD,_=.72,p=.038,g=se("joinery",s-.1,f,r-m,xt.shadowDark,{});g.position.set(0,f/2,-m/2),d.add(g);const v=se("joinery",s,_,r,c,{chamfer:Le.furniture,cast:!0});v.position.set(0,f+_/2,0),d.add(v);const x=se("bench",s+.04,p,r+.02,a,{chamfer:Le.joinery,cast:!0});x.position.set(0,Dt.benchH-p/2,.01),d.add(x);const M=[];let A=s;for(;A>.02;){let D=Dt.cabinetModules[0];for(const y of Dt.cabinetModules)y<=A+.001&&(D=y);(A-D<.02||M.length>12)&&(D=A),M.push(D),A-=D}let E=-s/2;for(const D of M){const y=se("joinery",D-.003,_-.006,.018,c,{chamfer:Le.thin,cast:!1});y.position.set(E+D/2,f+_/2,r/2+.009),d.add(y),u&&A1(d,E+D/2,f+_-.05,r/2+.018),E+=D}d.position.set(t,n,e),d.rotation.y=o,i.add(d);const[b,P]=Kd(i,d,n,Dt.benchH);return h&&ti(i,t,e,n,b,P),d}function Jd(i,t,e,n,s,r,o=0,a=xt.joineryLight,c={}){const{frame:l=xt.joineryDark,height:h=.74,shadow:u=!0}=c,d=new Xt,f=.03,m=se("joinery",s,f,r,a,{chamfer:Le.joinery,cast:!0});m.position.y=h-f/2,d.add(m);for(const g of[-1,1])for(const v of[-1,1]){const x=se("joinery",.06,h-f,.06,l,{chamfer:Le.furniture});x.position.set(g*(s/2-.09),(h-f)/2,v*(r/2-.09)),d.add(x)}for(const[g,v,x,M]of[[s-.24,.02,0,r/2-.09],[s-.24,.02,0,-r/2+.09],[.02,r-.24,s/2-.09,0],[.02,r-.24,-s/2+.09,0]]){const A=se("joinery",g,.07,v,l,{chamfer:Le.furniture});A.position.set(x,h-f-.035,M),d.add(A)}d.position.set(t,n,e),d.rotation.y=o,i.add(d);const[_,p]=Kd(i,d,n,h);return u&&ti(i,t,e,n,_,p),d}function C1(i,t,e,n,s,r,o={}){const{tileW:a=1.2,tileD:c=.6,colour:l=xt.ceiling,tee:h=xt.metalDull}=o,u=new Xt,d=Math.max(1,Math.round(n/a)),f=Math.max(1,Math.round(s/c)),m=n/d,_=s/f;for(let p=0;p<d;p++)for(let g=0;g<f;g++){const v=se("ceilingGrid",m-.02,.014,_-.02,l,{cast:!1});v.position.set(-n/2+(p+.5)*m,-.007,-s/2+(g+.5)*_),u.add(v)}for(let p=0;p<=d;p++){const g=se("chrome",.024,.024,s,h,{chamfer:.001});g.position.set(-n/2+p*m,-.012,0),u.add(g)}for(let p=0;p<=f;p++){const g=se("chrome",n,.024,.024,h,{chamfer:.001});g.position.set(0,-.012,-s/2+p*_),u.add(g)}return u.position.set(t,r,e),i.add(u),u}const P1=.38,L1=.44,I1=2.4,D1=1.8,U1=.95,N1=2.4,gu=70,uo=.38,_u=i=>i<0?0:i>1?1:i,O1=i=>i*i*(3-2*i);function z1(i,t,e,n="doorLeaf"){const s=new Xt,r=Dt.leafT,o=.105,a=.175,c=.105,l=.14,h=Math.min(Dt.handleH+.01,t-c-l),u=(g,v,x,M,A=r,E=.005)=>{const b=se(n,g,v,A,e,{chamfer:E,cast:!0});return b.position.set(x,M,0),s.add(b),b};u(o,t,i/2-o/2,0),u(o,t,-i/2+o/2,0);const d=i-2*o;u(d,a,0,-t/2+a/2),u(d,c,0,t/2-c/2),u(d,l,0,-t/2+h);const f=a,m=h-l/2,_=h+l/2,p=t-c;m-f>.05&&u(d-.004,m-f-.004,0,-t/2+(f+m)/2,r-.016,.002),p-_>.05&&u(d-.004,p-_-.004,0,-t/2+(_+p)/2,r-.016,.002);for(const g of[-1,1]){const v=se("chrome",.052,.052,.01,qt.metal,{chamfer:.002,cast:!1});v.position.set(-i/2+.06,-t/2+Dt.handleH,g*(r/2+.005)),s.add(v);const x=se("chrome",.02,.02,.045,qt.metal,{chamfer:.001,cast:!1});x.position.set(-i/2+.06,-t/2+Dt.handleH,g*(r/2+.0275)),s.add(x);const M=se("chrome",.11,.02,.02,qt.metal,{chamfer:.001,cast:!1});M.position.set(-i/2+.115,-t/2+Dt.handleH,g*(r/2+.05)),s.add(M)}return s}function F1(i,t,e=qt.metal){const n=new Xt,s=.048,r=.085,o=.07,a=.21,c=.07,l=Math.min(1.02,t-o-c-.2),h=(f,m,_,p,g=s,v=.003)=>{const x=se("chrome",f,m,g,e,{chamfer:v,cast:!0});return x.position.set(_,p,0),n.add(x),x};h(r,t,i/2-r/2,0),h(r,t,-i/2+r/2,0);const u=i-2*r;h(u,a,0,-t/2+a/2),h(u,o,0,t/2-o/2),h(u,c,0,-t/2+l);const d=[[-t/2+a,-t/2+l-c/2],[-t/2+l+c/2,t/2-o]];for(const[f,m]of d){const _=m-f;if(_<.08)continue;const p=new st(new Ut(u-.004,_-.004,.008),ds());p.castShadow=!1,p.receiveShadow=!0,p.position.set(0,(f+m)/2,0),n.add(p)}for(const f of[-1,1]){const m=se("chrome",u,a-.03,.004,e,{chamfer:.001,cast:!1});m.position.set(0,-t/2+a/2,f*(s/2+.003)),n.add(m);const _=-t/2+1.05,p=se("chrome",i-.17,.038,.038,e,{chamfer:.002,cast:!1});p.position.set(0,_,f*(s/2+.062)),n.add(p);for(const g of[-1,1]){const v=se("chrome",.026,.026,.062,e,{chamfer:.001,cast:!1});v.position.set(g*(i/2-.115),_,f*(s/2+.031)),n.add(v)}}return n}class k1{constructor(t,e,n,s){this.system=t,this.id=s,this.name=e.label||"door",this.auto=!!e.auto,this.triggerR=e.triggerR??(this.auto?I1:U1),this.dwell=e.dwell??(this.auto?D1:N1),this.openTime=e.openTime??P1,this.closeTime=e.closeTime??L1,this.state=e.startsShut===!1?"open":"shut",this.phase=this.state==="open"?1:0,this._hold=0,this.isDoor=!0,this.action="door",this.data={door:this},this.radius=2,this.leaves=[];for(const c of e.leaves){const l=new Xt;l.position.set(c.hx,c.y,c.hz),l.rotation.y=c.baseRot;const h=e.style==="glazed"?F1(c.lw,c.lh,e.colour):z1(c.lw,c.lh,e.colour,e.surfaceName),u=Hd(h);u.position.set(c.dx,c.lh/2+.015,c.dz),u.rotation.y=c.leafRot,l.add(u),n.add(l),this.leaves.push({pivot:l,baked:u,baseRot:c.baseRot,phiOpen:c.phiOpen})}for(const c of this.leaves)c.pivot.rotation.y=c.baseRot;n.updateMatrixWorld(!0);const r=new Ei,o=new Ei;for(const c of this.leaves)r.union(o.setFromObject(c.baked));r.min.y-=.05,this.collider={min:r.min.clone(),max:r.max.clone(),walkable:!1,door:this};const a=new I(e.centre.x,e.y0+1,e.centre.z);n.localToWorld(a),this.pos=a,this._trigger2=this.triggerR*this.triggerR,this._apply()}get open(){return this.state==="open"}get blocking(){return this.state==="shut"}get label(){return this.state==="shut"||this.state==="closing"?`Open the ${this.name}`:`Close the ${this.name}`}requestOpen(){if(this.state==="open"||this.state==="opening"){this._hold=this.dwell;return}this.state="opening",this.system._dirty=!0}requestClose(){return this.state==="shut"||this.state==="closing"?!0:this._occupied()?!1:(this.state="closing",!0)}toggle(){return this.state==="shut"||this.state==="closing"?(this.requestOpen(),!0):this.requestClose()}_occupied(t=null){var o;const e=this.collider,n=a=>a.x>e.min.x-uo&&a.x<e.max.x+uo&&a.z>e.min.z-uo&&a.z<e.max.z+uo,s=(o=this.system.game.player)==null?void 0:o.position;if(s&&n(s))return!0;const r=t||this.system._movers();for(const a of r)if(n(a))return!0;return!1}update(t,e,n){let s=!1;if(this.auto&&n){const r=n.x-this.pos.x,o=n.z-this.pos.z;s=r*r+o*o<this._trigger2}if(!s)for(const r of e){const o=r.x-this.pos.x,a=r.z-this.pos.z;if(o*o+a*a<this._trigger2){s=!0;break}}switch(s&&(this._hold=this.dwell,(this.state==="shut"||this.state==="closing")&&(this.state="opening",this.system._dirty=!0)),this.state){case"opening":this.phase=_u(this.phase+t/this.openTime),this.phase>=1&&(this.phase=1,this.state="open");break;case"open":this._hold>0&&(this._hold-=t,this._hold<=0&&!this._occupied(e)&&(this.state="closing"));break;case"closing":if(this._occupied(e)){this.state="opening",this._hold=this.dwell;break}this.phase=_u(this.phase-t/this.closeTime),this.phase<=0&&(this.phase=0,this.state="shut",this.system._dirty=!0);break}this._apply()}_apply(){const t=O1(this.phase);for(const e of this.leaves)e.pivot.rotation.y=e.baseRot+e.phiOpen*t}setVisible(t){for(const e of this.leaves)e.pivot.visible!==t&&(e.pivot.visible=t)}dispose(){var t;for(const e of this.leaves)(t=e.pivot.parent)==null||t.remove(e.pivot),e.baked.traverse(n=>{n.isMesh&&n.geometry.dispose()});this.leaves.length=0}}class B1{constructor(t){this.game=t,this.list=[],this._blocking=[],this._dirty=!0,this._moverBuf=[],this._moverFrame=-1,this._frame=0,this.scanned=0}install(t,e){if(!t||!t.length)return[];const n=[];for(const s of t){const r=new k1(this,s,e,this.list.length);this.list.push(r),n.push(r)}return this._dirty=!0,n}get count(){return this.list.length}_movers(){var r,o,a;if(this._moverFrame===this._frame)return this._moverBuf;this._moverFrame=this._frame;const t=this._moverBuf;t.length=0;const e=this.game,n=(o=(r=e.slice)==null?void 0:r.bodies)==null?void 0:o.call(r);if(n)for(const c of n)t.push(c.pos);const s=(a=e.npcs)==null?void 0:a.list;if(s)for(const c of s)c.visible&&t.push(c.position);return t}update(t){var r;if(!this.list.length)return;this._frame++;const e=this._movers(),n=(r=this.game.player)==null?void 0:r.position,s=gu*gu;for(const o of this.list)if(o.update(t,e,n),n){const a=n.x-o.pos.x,c=n.z-o.pos.z;o.setVisible(a*a+c*c<s)}}collect(t,e,n){if(this._dirty){this._blocking.length=0;for(const l of this.list)l.blocking&&this._blocking.push(l.collider);this._dirty=!1}const s=this._blocking.length;if(!s)return n;this.scanned+=s;const r=t.x-e,o=t.x+e,a=t.z-e,c=t.z+e;for(let l=0;l<s;l++){const h=this._blocking[l];h.max.x<r||h.min.x>o||h.max.z<a||h.min.z>c||n.push(h)}return n}nearest(t,e=2){let n=null,s=e;for(const r of this.list){if(r.auto)continue;const o=r.pos.distanceTo(t);o<s&&(s=o,n=r)}return n}clear(){for(const t of this.list)t.dispose();this.list.length=0,this._blocking.length=0,this._dirty=!0}}const he=(i,t,e,n,s={})=>{const r=new st(new Ut(i,t,e),s.material||Se(n,s));return r.castShadow=s.cast!==!1,r.receiveShadow=!0,r};function Si(i,t={}){var f;const{width:e=3,height:n=.8,bg:s="#1f2933",fg:r="#f4efe4",font:o="bold 64px Georgia, serif",pad:a=24}=t,c=document.createElement("canvas");c.width=512,c.height=Math.max(32,Math.round(512*(n/e)));const l=c.getContext("2d");l.fillStyle=s,l.fillRect(0,0,c.width,c.height),t.border&&(l.strokeStyle=t.border,l.lineWidth=8,l.strokeRect(6,6,c.width-12,c.height-12)),l.fillStyle=r,l.font=o,l.textAlign="center",l.textBaseline="middle";let h=parseInt(((f=o.match(/(\d+)px/))==null?void 0:f[1])||"64",10);for(;l.measureText(i).width>c.width-a*2&&h>12;)h-=2,l.font=o.replace(/\d+px/,h+"px");l.fillText(i,c.width/2,c.height/2);const u=new Yn(c);u.colorSpace=He,u.anisotropy=4;const d=new st(new Ie(e,n),new en({map:u,transparent:!0,side:Vn}));return d.userData.isSign=!0,d}function qo(i,t=1){const e=new Xt,n=i.range(2.6,4.4)*t,s=new st(new Ve(.2*t,.3*t,n,6),Se(qt.trunk,{flat:!0}));s.position.y=n/2,s.castShadow=!0,e.add(s);const r=i.weighted([{value:qt.foliage,weight:4},{value:qt.foliageLight,weight:3},{value:qt.foliageDeep,weight:2}]).value,o=i.int(2,4);for(let a=0;a<o;a++){const c=i.range(1.3,2.2)*t,l=new st(new sa(c,0),Se(r,{flat:!0}));l.position.set(i.range(-.7,.7)*t,n+i.range(-.2,.9)*t,i.range(-.7,.7)*t),l.rotation.set(i.range(0,3),i.range(0,3),i.range(0,3)),l.castShadow=!0,l.receiveShadow=!0,e.add(l)}return e}function oa(i,t){const e=new Xt,n=i.pick(qt.carBodies),s=he(1.9,.72,4.3,n);s.position.y=.78,e.add(s);const r=he(1.72,.62,2.2,0,{material:Od()});r.position.set(0,1.4,-.15),e.add(r);const o=he(1.78,.09,2,n);o.position.set(0,1.75,-.15),e.add(o);for(const l of[-1,1]){const h=he(.09,.12,.24,n);h.position.set(l,1.26,.88),e.add(h)}const a=he(1.95,.34,4.35,qt.metalDark);a.position.y=.45,e.add(a);for(const l of[-.86,.86])for(const h of[1.42,-1.42]){const u=new st(new Ve(.34,.34,.26,10),Se(1579292));u.rotation.z=Math.PI/2,u.position.set(l,.34,h),u.castShadow=!0,e.add(u)}const c=Ol();for(const l of[-.62,.62]){const h=new st(new Ut(.34,.16,.08),c);h.position.set(l,.86,2.16),e.add(h);const u=new st(new Ut(.3,.14,.08),zd());u.position.set(l,.86,-2.16),e.add(u)}return e.userData.headlights=c,e}function H1(){const i=new Xt;i.rotation.order="YXZ";const t=he(1.9,.72,4.1,15262418);t.position.y=.78,i.add(t);const e=he(1.86,1.15,2.3,15262418);e.position.set(0,1.62,-.85),i.add(e);const n=he(1.92,.28,2.32,11026479);n.position.set(0,1.55,-.85),i.add(n);const s=he(1.72,.62,1.3,0,{material:Od()});s.position.set(0,1.4,.9),i.add(s);const r=he(1.95,.34,4.15,qt.metalDark);r.position.y=.45,i.add(r);for(const a of[-.86,.86])for(const c of[1.3,-1.3]){const l=new st(new Ve(.36,.36,.26,10),Se(1579292));l.rotation.z=Math.PI/2,l.position.set(a,.36,c),l.castShadow=!0,i.add(l)}const o=Ol();for(const a of[-.62,.62]){const c=new st(new Ut(.34,.16,.08),o);c.position.set(a,.86,2.06),i.add(c);const l=new st(new Ut(.3,.14,.08),zd());l.position.set(a,.86,-2.06),i.add(l)}return i}function G1(i){const t=new Xt,e=i.pick([13616564,12109001,13220004,11187616,14209732,10321770,11577792,9413544]),n=i.pick([7035472,5266020,7626571,9063482,4147024]),s=i.chance(.35)?2:1,r=i.pick(["gable","gable","skillion","parapet"]),o=i.chance(.4),a=i.range(6.4,8.4),c=i.range(5,6.4),l=s===2?5.3:2.9,h=o?3.1:0,u=a+h,d=-h/2,f=he(a,l,c,e);if(f.position.set(d,l/2,0),t.add(f),s===2){const v=he(a+.06,.18,c+.06,Yo(n));v.position.set(d,2.95,0),t.add(v)}if(r==="gable"){for(const A of[-1,1]){const E=he(a+.7,.12,c*.62,n);E.position.set(d,l+.62,A*c*.235),E.rotation.x=A*.42,t.add(E)}const v=he(a+.8,.14,.3,n);v.position.set(d,l+1.2,0),t.add(v);const x=new Id;x.moveTo(-c/2,0),x.lineTo(c/2,0),x.lineTo(0,1.12),x.closePath();const M=new Dl(x,{depth:.16,bevelEnabled:!1});for(const A of[-1,1]){const E=new st(M,Se(e));E.rotation.y=Math.PI/2,E.position.set(d+(A===1?a/2-.16:-a/2),l,0),E.castShadow=!0,t.add(E)}}else if(r==="skillion"){const v=he(a+.8,.14,c+.9,n);v.position.set(d,l+.42,0),v.rotation.x=.16,v.castShadow=!0,t.add(v);const x=he(a+.8,.3,.12,Yo(e));x.position.set(d,l+.3,c/2+.3),t.add(x)}else{const v=he(a+.3,.14,c+.3,n);v.position.set(d,l+.06,0),t.add(v);const x=he(a+.3,.42,.14,e);x.position.set(d,l+.24,c/2+.08),t.add(x)}if(r!=="parapet"&&i.chance(.5)){const v=he(.5,1.3,.5,9072736);v.position.set(d+a*.28,l+.8,-.6),t.add(v)}if(o){const v=a/2,x=Math.min(c,5.2),M=c/2-x/2,A=he(h,2.5,x,e);A.position.set(v,1.25,M),t.add(A);const E=he(h+.24,.12,x+.24,n);E.position.set(v,2.56,M),t.add(E);const b=he(h-.5,2,.08,14276043);b.position.set(v,1.05,c/2+.02),t.add(b);for(let P=0;P<4;P++){const D=he(h-.5,.03,.09,12170667);D.position.set(v,.45+P*.44,c/2+.03),t.add(D)}}const m=new Xt;m.position.set(-.475,0,c/2+.04);const _=he(.95,2,.1,i.pick([5916210,8007458,3099222]));_.position.set(.475,1,0),m.add(_),t.add(m);const p=he(1.4,.16,.7,qt.concrete);p.position.set(0,.08,c/2+.4),t.add(p);const g=(v,x)=>{const M=he(1.15,1.1,.08,0,{material:ds(),cast:!1});M.position.set(v,x,c/2+.03),t.add(M);const A=he(1.3,1.25,.05,16777215);A.position.set(v,x,c/2+.01),t.add(A)};return g(d-a*.28,1.5),o||g(d+a*.28,1.5),s===2&&(g(d-a*.28,4.15),g(d+a*.28,4.15),g(d,4.15)),{group:t,size:{w:u,d:c,h:l},door:m}}function Yo(i){const t=new Gt(i);return t.multiplyScalar(.72),t.getHex()}function V1(i,t=10129274){const e=new Xt,n=he(i,1.05,.05,t);n.position.y=.58,n.castShadow=!0,e.add(n);const s=he(i,.08,.08,Yo(t));s.position.y=1.12,e.add(s);const r=Math.max(2,Math.round(i/2.2));for(let o=0;o<=r;o++){const a=he(.1,1.25,.1,Yo(t));a.position.set(-i/2+i/r*o,.62,0),e.add(a)}return{group:e}}function Qd(i){const t=Ol(),e=Fd();i.traverse(n=>{n.material===t&&(n.material=e)})}const W1=.42,X1=.34,Mi=X1+.03,ol=.7,al=.6,un=.55,Ge=11026479,pr=3.2,Bn=2.8,Mt={x0:-5.4,x1:-1.8,z0:-3.65,z1:-2.35,cx:-3.6,cz:-3,w:3.6,d:1.3,benchH:.9},xe={x0:-1.72,z0:-2.45,x1:-.9,z1:-.55,w:.36},ks={x:-1.93,z:-2.51},fo={x:Mt.cx,y:1.78,z:Mt.z0+.176,tilt:-.16,w:.48,h:.28},Ys={x0:-1.7,y:.97,z:0},Hn={x0:Mt.x0+.35,x1:-2.3,z:Mt.z1+.55,facing:Math.PI},xu={x:-8,screen:{y:1.22,z:1.721,w:.3,h:.22,rotY:Math.PI}},q1={x:-5.2,y:2.3,z:1.934,w:.62,h:.34,rotY:0},Qi={x:-8,z:.85,facing:0},Y1=.04,j1=.004,$1=.012,Z1=(i,t,e)=>{const n=Math.min(i,t,e);return n<Y1?0:Math.min($1,Math.max(j1,n/12))},K1=[["tile",16777215,"kitchen floor overlay, splashbacks, partition linings"],["metal",xt.metalDull,"all stainless: pod, benches, pass, hood, shelving"],["bench",xt.benchtop,"front counter top (RoomKit counter())"],["joinery",xt.joineryLight,"tables, chairs, booths, gate, door leaves"],["joinery",xt.joineryDark,"chair frames, bins, kiosk plinths"],["joinery",xt.shadowDark,"toe kicks, recesses, coved skirting, screens off"],["trim",Ge,"counter fascia, kiosk pedestals, menu board, signage"],["(basic)","signAtlas","ONE canvas atlas: every label in the shop"],["(shared)","troffer emissive","luminaire faces — one material town-wide"],["(shared)","contact shadow","fixture footprint decals — one town-wide"],["trim",5208634,"cold bin: lettuce (legibility is a design requirement)"],["trim",10236968,"cold bin: tomato"],["trim",13210159,"cold bin: cheese + UHC hold slots"],["trim",8030778,"cold bin: pickle"],["trim",15261904,"cold bin: onion + mayo gun band"]],vu=new Set;function tf(i,t,e={}){if(e.material)return e.material;try{return Bl(i,t,null,e.recipe||{})}catch(n){return vu.has(i)||(vu.add(i),console.error(`Fitout: surface '${i}' unavailable, flat colour instead`,n)),Se(t,e)}}function J1(i,t,e,n,s,r={}){var h;const o=tf(i,s,r),a=r.chamfer??Z1(t,e,n),c=a>0?Zd(t,e,n,a):new Ut(Math.max(t,.001),Math.max(e,.001),Math.max(n,.001)),l=new st(c,o);return l.castShadow=r.cast??((h=o.userData)==null?void 0:h.cast)??!1,l.receiveShadow=!0,l}function X(i,t,e,n,s,r,o,a,c,l={}){const h=J1(t,o,a,c,e,l);return h.position.set(n,s,r),l.rotY&&(h.rotation.y=l.rotY),i.add(h),h}const ef=i=>({x:Math.sin(i),z:Math.cos(i)});function mr(i,t,e,n,s){const r=(t+n)/2,o=(e+s)/2;X(i,"joinery",xt.shadowDark,r,.0375,o,Math.max(Math.abs(n-t),.024),.075,Math.max(Math.abs(s-e),.024))}function po(i,t,e,n,s,r,o,a){const c=n-t,l=s-e;for(let h=0;h<o;h++)for(let u=0;u<a;u++){const d=t+(h+.5)*(c/o),f=e+(u+.5)*(l/a);X(i,"metal",xt.metalDull,d,r+.035,f,1.2,.07,.6);const m=new st(new Ut(1.16,.012,.56),Vv());m.position.set(d,r-.006,f),i.add(m)}}function Q1(i,t,e,n=0,s=.62,r=.48){const a=ef(n);X(i,"joinery",xt.joineryDark,t,.9/2,e,s,.9,r,{rotY:n,cast:!0}),X(i,"joinery",xt.shadowDark,t,.075,e,s-.06,.15,r-.06,{rotY:n}),X(i,"joinery",xt.shadowDark,t+a.x*(r/2-.03),.6,e+a.z*(r/2-.03),s-.16,.34,.04,{rotY:n});const c=X(i,"joinery",xt.joineryLight,t+a.x*(r/2+.01),.64,e+a.z*(r/2+.01),s-.2,.26,.016,{rotY:n,cast:!0});c.rotation.x=-.22,X(i,"metal",xt.metalDull,t,.9+.02,e,s+.06,.04,r+.06,{rotY:n,cast:!0}),X(i,"trim",Ge,t,.9-.07,e,s+.005,.09,r+.005,{rotY:n}),i.solid(t,0,e,Math.abs(a.z)*s+Math.abs(a.x)*r,.9+.05,Math.abs(a.z)*r+Math.abs(a.x)*s)}function yu(i,t,e,n,s=0){const r={rotY:s};X(i,"joinery",xt.joineryDark,t,n+.021,e,.17,.042,.115,r),X(i,"trim",Ge,t-.045,n+.1,e,.052,.15,.052,{...r,cast:!0}),X(i,"joinery",xt.shadowDark,t+.03,n+.075,e-.02,.038,.1,.038,{...r,cast:!0}),X(i,"joinery",xt.joineryLight,t+.038,n+.058,e+.028,.055,.065,.055,r)}function Mu(i,t,e,n,s=7,r=.4,o=.3,a=0){for(let c=0;c<s;c++)X(i,"trim",Ge,t,e+.01+c*.014,n,r,.012,o,{rotY:a,cast:c===s-1});X(i,"joinery",xt.shadowDark,t,e+.004,n,r+.03,.008,o+.03,{rotY:a})}const cl=4,ll=8;function Ps(){return"#"+Ge.toString(16).padStart(6,"0")}const nf={fries:[0,0,"FRIES","#20262e"],grill:[1,0,"GRILL","#20262e"],pod:[2,0,"BUILD","#20262e"],pack:[3,0,"PACK-OUT","#20262e"],drivethru:[0,1,"DRIVE-THRU",Ps()],staff:[1,1,"STAFF ONLY","#20262e"],collect:[2,1,"COLLECT",Ps()],order:[3,1,"ORDER HERE",Ps()],drinks:[0,2,"DRINKS","#20262e"],mccafe:[1,2,"BARN CAFE","#4b2e22"],barn:[2,2,"BURGER BARN",Ps()],uhc:[3,2,"UHC","#20262e"],lettuce:[0,3,"LETTUCE","#4f7a3a"],tomato:[1,3,"TOMATO","#9c3428"],cheese:[2,3,"CHEESE","#c9922f"],pickle:[3,3,"PICKLE","#7a8a3a"],onion:[0,4,"ONION","#8f9784","#20262e"],ketchup:[1,4,"KETCHUP","#9c2b1f"],mustard:[2,4,"MUSTARD","#c9922f"],mayo:[3,4,"MAYO","#e6dcc4","#20262e"],bbq:[0,5,"BBQ","#5a3a26"],buns:[1,5,"BUNS","#a8763f"],wrap:[2,5,"WRAP","#20262e"],dry:[3,5,"DRY STORE","#2f5d6b"],pay:[0,6,"PAY",Ps()],present:[1,6,"PRESENT",Ps()],toaster:[2,6,"TOASTER","#20262e"],sauce:[3,6,"SAUCE","#20262e"]};let Gn=null;function sf(){if(Gn!==null)return Gn||null;if(typeof document>"u"||!document.createElement)return Gn=!1,null;const i=document.createElement("canvas");i.width=1024,i.height=1024;const t=i.getContext("2d");if(!t)return Gn=!1,null;const e=i.width/cl,n=i.height/ll;t.clearRect(0,0,i.width,i.height);for(const[,r]of Object.entries(nf)){const[o,a,c,l,h="#f4efe4"]=r,u=o*e,d=a*n;t.fillStyle=l,t.fillRect(u+3,d+3,e-6,n-6),t.strokeStyle="rgba(0,0,0,0.35)",t.lineWidth=3,t.strokeRect(u+3,d+3,e-6,n-6),t.fillStyle=h,t.textAlign="center",t.textBaseline="middle";let f=44;for(t.font=`bold ${f}px Helvetica, Arial, sans-serif`;t.measureText(c).width>e-34&&f>12;)f-=2,t.font=`bold ${f}px Helvetica, Arial, sans-serif`;t.fillText(c,u+e/2,d+n/2)}const s=new Yn(i);return s.colorSpace=He,s.anisotropy=4,Gn=new gn({map:s,roughness:.9,metalness:0,emissive:2763306,emissiveMap:s,side:ri,transparent:!1}),Gn}Lr(()=>{var i;Gn&&Gn.dispose&&((i=Gn.map)==null||i.dispose(),Gn.dispose()),Gn=null});let _i=null;function mo(){return _i||(_i=new gn({color:856342,roughness:.3,metalness:0,emissive:1454666,emissiveIntensity:.55})),_i}Lr(()=>{var i;(i=_i==null?void 0:_i.dispose)==null||i.call(_i),_i=null});function ve(i,t,e,n,s,r,o,a=0){const c=sf(),l=nf[t];if(!c||!l)return null;const[h,u]=l,d=new Ie(r,o),f=h/cl,m=(h+1)/cl,_=1-(u+1)/ll,p=1-u/ll;d.setAttribute("uv",new ze(new Float32Array([f,p,m,p,f,_,m,_]),2));const g=new st(d,c);return g.position.set(e,n,s),g.rotation.y=a,i.add(g),g}const jo=i=>!i.walkable&&i.max.y>W1&&i.min.y<1.7;function ty(i,t,e){let n=t,s=e,r=0;for(let o=0;o<4;o++){let a=!1;for(const c of i){if(!jo(c))continue;const l=c.min.x-Mi,h=c.max.x+Mi,u=c.min.z-Mi,d=c.max.z+Mi;if(n<=l||n>=h||s<=u||s>=d)continue;const f=[[n-l,-1,0],[h-n,1,0],[s-u,0,-1],[d-s,0,1]];f.sort((g,v)=>g[0]-v[0]);const[m,_,p]=f[0];n+=_*m,s+=p*m,r+=m,a=!0}if(!a)break}return{x:n,z:s,moved:r}}function ey(i,t,e){let n=1/0;for(const s of i){if(!jo(s))continue;const r=Math.max(s.min.x-t,0,t-s.max.x),o=Math.max(s.min.z-e,0,e-s.max.z),a=r===0&&o===0?-Math.min(t-s.min.x,s.max.x-t,e-s.min.z,s.max.z-e):Math.hypot(r,o);a<n&&(n=a)}return n===1/0?99:n}function ny(i,t){const e=[],n=[];for(const s of t){const r=[];for(const m of i)jo(m)&&s.x>m.min.x-Mi&&s.x<m.max.x+Mi&&s.z>m.min.z-Mi&&s.z<m.max.z+Mi&&r.push([+m.min.x.toFixed(2),+m.min.z.toFixed(2),+m.max.x.toFixed(2),+m.max.z.toFixed(2)]);if(r.length&&e.push({id:s.id,why:"point inside a blocking collider",boxes:r}),n.push({id:s.id,clear:+ey(i,s.x,s.z).toFixed(3)}),s.facing==null||s.standoff==null)continue;const o=ef(s.facing),a=[s.standoff-.01,s.standoff-al],c=[s.x+o.x*a[0],s.x+o.x*a[1]],l=[s.z+o.z*a[0],s.z+o.z*a[1]],h=ol/2,u=[Math.min(...c)-Math.abs(o.z)*h,Math.max(...c)+Math.abs(o.z)*h],d=[Math.min(...l)-Math.abs(o.x)*h,Math.max(...l)+Math.abs(o.x)*h],f=[];for(const m of i)jo(m)&&(m.max.x<=u[0]+1e-6||m.min.x>=u[1]-1e-6||m.max.z<=d[0]+1e-6||m.min.z>=d[1]-1e-6||f.push([+m.min.x.toFixed(2),+m.min.z.toFixed(2),+m.max.x.toFixed(2),+m.max.z.toFixed(2)]));f.length&&e.push({id:s.id,why:`clear floor ${ol} x ${al} obstructed`,rect:[+u[0].toFixed(2),+d[0].toFixed(2),+u[1].toFixed(2),+d[1].toFixed(2)],boxes:f})}return n.sort((s,r)=>s.clear-r.clear),{failures:e,tightest:n.slice(0,8)}}function iy(i,t={}){const e=t.width??20,n=t.depth??14,s=e/2,r=n/2,o=s-Dt.wallThick/2,a=r-Dt.wallThick/2,c=xt.metalDull,l=xt.joineryLight,h=xt.joineryDark,u=xt.shadowDark,d=[],f=(L,O,Y,ht=null,Et=null,Jt={})=>{d.push({name:L,x:O,z:Y,facing:ht,standoff:Et,noClamp:!!Jt.noClamp})},m=1.4;X(i,"tile",16777215,(-o+7.9)/2,.003,(-a+m)/2,o+7.9,.006,m+a,{cast:!1,chamfer:0}),X(i,"tile",16777215,(7.9+o)/2,.003,(-5+m)/2,o-7.9,.006,m+5,{cast:!1,chamfer:0}),mr(i,-o+.02,-a+.04,-6.35,-a+.04),mr(i,-4.45,-a+.04,3.25,-a+.04),mr(i,-o+.04,-a,-o+.04,m),mr(i,o-.04,-5,o-.04,m);const _=-a+.375,p=-a+.75,g=-9.6,v=-6.7,x=(g+v)/2,M=v-g;X(i,"metal",c,x,.45,_,M,.9,.75,{cast:!0}),X(i,"joinery",u,x,.075,_+.02,M-.1,.15,.66),i.solid(x,0,_,M,.9,.75);const A=1.12;X(i,"tile",16777215,x,1.5,-a+.02,M+.4,1.2,.02,{cast:!1,chamfer:0}),X(i,"metal",c,x,1.01,_,2.1,.22,.62,{cast:!0});for(const L of[-.7,-.23,.24])X(i,"joinery",u,x+L,A,_,.32,.03,.42),X(i,"trim",13210159,x+L,A-.03,_,.28,.01,.38,{chamfer:0}),X(i,"metal",c,x+L,A+.16,_-.26,.03,.3,.03),X(i,"metal",c,x+L,A+.3,_-.2,.03,.03,.16);X(i,"metal",c,x+.95,1.06,_,.75,.1,.62,{cast:!0}),X(i,"metal",c,x+.95,1.24,_-.26,.7,.04,.04),X(i,"trim",Ge,x+.95,1.14,_+.1,.3,.06,.22),ve(i,"fries",x,1.62,-a+.05,.9,.26,0),X(i,"metal",c,x,2.24,_+.15,M+.3,.42,1,{cast:!0});const E=1.06,b=-4.3,P=-.3,D=(b+P)/2,y=P-b;X(i,"metal",c,D,.45,_,y,.9,.75,{cast:!0}),X(i,"joinery",u,D,.075,_+.02,y-.1,.15,.66),i.solid(D,0,_,y,.9,.75),X(i,"tile",16777215,D,1.5,-a+.02,y+.4,1.2,.02,{cast:!1,chamfer:0}),X(i,"metal",c,D,.98,_,2.6,.16,.62,{cast:!0});for(const L of[-.65,.65])X(i,"joinery",u,D+L,E,_,1.1,.02,.5);X(i,"metal",c,D,E+.1,_-.3,2.6,.2,.03,{cast:!0}),X(i,"metal",c,D+1.35,E+.02,_+.16,.1,.02,.16),X(i,"joinery",u,D+1.35,E+.06,_+.24,.03,.07,.1),ve(i,"grill",D,1.62,-a+.05,.9,.26,0),X(i,"metal",c,D,2.24,_+.15,y+.4,.42,1,{cast:!0}),X(i,"metal",c,D,2.62,_+.15,.34,.36,.34),X(i,"metal",c,1.35,1,_+.02,1.6,2,.7,{cast:!0}),i.solid(1.35,0,_+.02,1.6,2,.7);for(const L of[-.4,.4])X(i,"joinery",u,1.35+L,1,_+.38,.72,1.86,.02),X(i,"metal",c,1.35+L-.3,1.05,_+.4,.04,.6,.04);const w=Dt.intWall,U=3.3,N=-4.55,W={height:Bn,surface:"tile",colour:16777215,thickness:w,skirting:!1,cornice:!1,trimColour:xt.trim};rs(i,U,-a,U,N,{...W,inner:-1,autoServices:!1,name:"dryWest"}),rs(i,U,N,o,N,{...W,inner:1,autoServices:!1,openings:[{at:.95,width:1,kind:"door",head:Dt.headDatum,door:{startsShut:!1,style:"panel",label:"dry store",swing:-1}}],name:"drySouth"}),ve(i,"staff",U+.006+w/2,1.85,-5.7,.7,.22,Math.PI/2),ve(i,"dry",U+1.85,2.3,N+w/2+.006,.9,.26,0);const q={x0:5.55,x1:7.85,z0:-a+.05,z1:-5.35},H=(q.x0+q.x1)/2,Z=(q.z0+q.z1)/2;X(i,"metal",c,H,1.2,Z,q.x1-q.x0,2.4,q.z1-q.z0,{cast:!0}),i.solid(H,0,Z,q.x1-q.x0,2.4,q.z1-q.z0);for(const L of[-.5,.28])X(i,"joinery",u,q.x0-.008,1.2,Z+L,.012,2.3,.014,{chamfer:0});for(const L of[-.75,0,.75])X(i,"joinery",u,H+L,1.2,q.z1+.008,.014,2.3,.012,{chamfer:0});X(i,"metal",c,q.x0-.03,1.02,Z+.3,.04,1.84,.78,{cast:!0});for(const[L,O,Y,ht]of[[.3,1.94,.8,.02],[.3,.1,.8,.02],[-.09,1.02,.02,1.86],[.69,1.02,.02,1.86]])X(i,"joinery",u,q.x0-.052,O,Z+L,.008,ht,Y,{chamfer:0});X(i,"metal",c,q.x0-.07,1.05,Z+.62,.05,.34,.06,{cast:!0}),X(i,"joinery",u,q.x0-.045,.35,Z-.25,.01,.26,.44,{chamfer:0});for(let L=0;L<4;L++)X(i,"metal",c,q.x0-.052,.26+L*.055,Z-.25,.006,.018,.4,{chamfer:0});X(i,"metal",c,H,2.55,Z,.9,.3,.7,{cast:!0});for(let L=0;L<4;L++)X(i,"metal",c,4.45,.15+L*.44,-a+.25,1.7,.03,.45),L>0&&(X(i,"joinery",l,4.1,.29+L*.44,-a+.25,.55,.24,.38,{cast:!0}),X(i,"joinery",h,4.9,.27+L*.44,-a+.25,.55,.21,.36));i.solid(4.45,0,-a+.25,1.7,1.6,.45),X(i,"joinery",l,6.95,.16,-4.95,.55,.32,.42,{cast:!0}),X(i,"joinery",h,6.85,.44,-4.98,.42,.24,.36,{cast:!0}),mr(i,U+w/2,-a,U+w/2,N),po(i,U,-a,o-1,N,Bn,2,1);const F={cx:4.7,cz:-2.5,w:3,d:.75};X(i,"metal",c,F.cx,.45,F.cz,F.w,.9,F.d,{cast:!0}),X(i,"joinery",u,F.cx,.075,F.cz,F.w-.1,.15,F.d-.08),i.solid(F.cx,0,F.cz,F.w,.9,F.d),ti(i,F.cx,F.cz,0,F.w,F.d);for(let L=0;L<3;L++)X(i,"trim",Ge,F.cx-1.05,.98+L*.09,F.cz,.34,.08,.26);Mu(i,F.cx-.3,.9,F.cz,7);for(let L=0;L<4;L++)X(i,"joinery",l,F.cx+.6,.96+L*.11,F.cz,.42,.1,.42,{cast:L===3});X(i,"joinery",l,F.cx+1.2,.97,F.cz,.36,.14,.36,{cast:!0}),ve(i,"pack",F.cx,1.6,F.cz-F.d/2-.02,.9,.26,Math.PI);const ut=o-.375;X(i,"metal",c,ut,.45,-2.7,.75,.9,4.5,{cast:!0}),X(i,"joinery",u,ut,.075,-2.7,.66,.15,4.4),i.solid(ut,0,-2.7,.75,.9,4.5),ti(i,ut,-2.7,0,.75,4.5),X(i,"joinery",u,ut-.05,1.02,-4.2,.3,.2,.36,{cast:!0}),X(i,"joinery",u,ut-.11,1.22,-4.2,.03,.24,.32,{cast:!0}),X(i,"metal",c,ut,.94,-1,.6,.04,.8),X(i,"metal",c,o-.06,1.55,-2.7,.05,.22,.05,{cast:!0}),X(i,"joinery",u,o-.1,1.62,-2.7,.14,.14,.1,{cast:!0}),X(i,"joinery",u,o-.05,1.75,-2.7,.05,.4,.6,{cast:!0});{const L=new st(new Ie(.52,.32),mo());L.position.set(o-.07,1.75,-2.7),L.rotation.y=-Math.PI/2,i.add(L)}X(i,"metal",c,o-.25,1.25,-2.7,.45,.03,1.1),X(i,"trim",Ge,o-.25,1.32,-2.35,.3,.1,.22,{cast:!0}),X(i,"joinery",l,o-.25,1.34,-3,.28,.14,.3,{cast:!0}),ve(i,"pay",o-.02,2.3,-4.2,.6,.2,-Math.PI/2),ve(i,"present",o-.02,2.3,-1,.75,.2,-Math.PI/2),ve(i,"drivethru",o-.02,2.58,-2.6,1.1,.26,-Math.PI/2),i.interact("dt_window_out","hand the bag out",o-.25,1.1,-1,"service",{op:"deliver",when:"window_handout"},1.8);const dt=-.5;X(i,"metal",c,-o+.35,.45,dt,.7,.9,1.7,{cast:!0}),X(i,"joinery",u,-o+.35,.075,dt,.62,.15,1.6),i.solid(-o+.35,0,dt,.7,.9,1.7),ti(i,-o+.35,dt,0,.7,1.7),X(i,"joinery",u,-o+.32,1.02,dt-.45,.3,.2,.36,{cast:!0}),X(i,"joinery",u,-o+.26,1.22,dt-.45,.03,.24,.32,{cast:!0}),X(i,"metal",c,-o+.06,1.55,dt+.55,.05,.22,.05,{cast:!0}),X(i,"joinery",u,-o+.1,1.62,dt+.55,.1,.14,.14,{cast:!0}),X(i,"joinery",u,-o+.03,1.45,dt,.03,.14,.14),ve(i,"drivethru",-o+.02,2.35,dt,1.1,.26,Math.PI/2),ve(i,"order",-o+.02,2.05,dt,.8,.22,Math.PI/2),i.interact("dt_window_take","take the drive-thru order",-o+.3,1.1,dt,"service",{op:"dt_take",when:"dt_order"},1.8);const at=Mt.benchH;X(i,"metal",c,Mt.cx,.45,Mt.cz,Mt.w,.9,Mt.d,{cast:!0}),X(i,"joinery",u,Mt.cx,.075,Mt.cz,Mt.w-.1,.15,Mt.d-.1),i.solid(Mt.cx,0,Mt.cz,Mt.w,.9,Mt.d),ti(i,Mt.cx,Mt.cz,0,Mt.w,Mt.d);for(const[L,O]of[[0,Ge],[1,13210159],[2,5208634],[3,l]]){const Y=Mt.x0+.55+L*.85;for(let ht=0;ht<4;ht++)X(i,"trim",O,Y,.24+ht*.13,Mt.z1-.16,.4,.11,.26,{chamfer:0})}const Ot=-4.9;X(i,"metal",c,Ot,at+.31,Mt.cz-.1,.85,.62,.62,{cast:!0}),X(i,"joinery",u,Ot,at+.63,Mt.cz-.1,.6,.03,.3),X(i,"joinery",u,Ot,at+.18,Mt.cz+.215,.52,.09,.02),X(i,"metal",c,Ot,at+.12,Mt.cz+.26,.56,.025,.1,{cast:!0}),X(i,"trim",Ge,Ot,at+.5,Mt.cz+.22,.6,.08,.02),ve(i,"toaster",Ot,at+.36,Mt.cz+.225,.44,.14,0),X(i,"metal",c,Mt.x0-.55,.6,Mt.cz,.7,1.2,.9,{cast:!0}),i.solid(Mt.x0-.55,0,Mt.cz,.7,1.2,.9);for(let L=0;L<3;L++)X(i,"joinery",l,Mt.x0-.55,.35+L*.32,Mt.cz,.62,.16,.8);ve(i,"buns",Mt.x0-.55,1.32,Mt.cz+.46,.5,.16,0);const Yt=-4;X(i,"metal",c,Yt,at+.1,Mt.cz-.25,.7,.2,.45,{cast:!0});const Q=[["ketchup",10236968],["mustard",13210159],["mayo",15261904],["bbq",8030778]];Q.forEach(([L,O],Y)=>{const ht=Yt-.255+Y*.17;X(i,"metal",c,ht,at+.3,Mt.cz-.25,.06,.22,.06,{cast:!0}),X(i,"trim",O,ht,at+.43,Mt.cz-.25,.05,.05,.05,{chamfer:0}),ve(i,L,ht,at+.135,Mt.cz-.02,.15,.06,0)});const z=-3.58;X(i,"joinery",u,-3.1,at+.015,Mt.cz-.08,1,.05,.6);const ct=[["pickle",8030778],["onion",15261904],["lettuce",5208634],["tomato",10236968],["cheese",13210159]];ct.forEach(([L,O],Y)=>{const ht=z+.1+Y*.19;X(i,"metal",c,ht,at+.045,Mt.cz-.08,.165,.09,.54),X(i,"trim",O,ht,at+.075,Mt.cz-.08,.13,.05,.48,{chamfer:0}),ve(i,L,ht,at-.1,Mt.z1+.006,.17,.075,0)});const et=-2.2;X(i,"metal",c,et,at+.38,Mt.cz,.78,.76,.68,{cast:!0});for(let L=0;L<3;L++)for(const O of[1,-1])X(i,"joinery",u,et,at+.14+L*.24,Mt.cz+O*.345,.64,.16,.02),X(i,"trim",13210159,et,at+.11+L*.24,Mt.cz+O*.3,.56,.03,.06,{chamfer:0});ve(i,"uhc",et,at+.86,Mt.cz+.01,.4,.16,0),X(i,"joinery",l,ks.x,at+.02,ks.z,.3,.04,.34,{cast:!0}),ve(i,"wrap",-1.95,at-.1,Mt.z1+.006,.3,.1,0);{const L=xe.x1-xe.x0,O=xe.z1-xe.z0,Y=Math.hypot(L,O),ht=Math.atan2(-O,L)+Math.PI/2,Et=(xe.x0+xe.x1)/2,Jt=(xe.z0+xe.z1)/2,Re=X(i,"metal",c,Et,.965,Jt,xe.w,.03,Y,{rotY:ht,cast:!0});Re.rotation.x=-.045;for(const Te of[-1,1]){const ne=X(i,"metal",c,Et,.995,Jt,.03,.06,Y,{rotY:ht});ne.translateX(Te*(xe.w/2-.015)),ne.rotation.x=-.045}for(const[Te,ne]of[[xe.x0+.1,xe.z0+.22],[xe.x1-.1,xe.z1-.25]])X(i,"metal",c,Te,.47,ne,.05,.94,.05);for(let Te=0;Te<3;Te++){const ne=Te/3,Ze=(Te+1)/3,En=xe.x0+L*ne,or=xe.x0+L*Ze,ar=xe.z0+O*ne,Zn=xe.z0+O*Ze;i.solid((En+or)/2,.6,(ar+Zn)/2,Math.abs(or-En)+xe.w,.5,Math.abs(Zn-ar)+.06)}}X(i,"metal",c,Mt.cx,1.28,Mt.z0+.06,.05,.8,.05,{cast:!0}),X(i,"metal",c,Mt.cx,1.66,Mt.z0+.09,.06,.05,.1);{const L=X(i,"joinery",u,Mt.cx,1.78,Mt.z0+.14,.56,.36,.035,{cast:!0});L.rotation.x=-.16;const O=X(i,"joinery",u,Mt.cx,1.78,Mt.z0+.165,.5,.3,.008,{chamfer:0});O.rotation.x=-.16;const Y=new st(new Ie(.48,.28),mo());Y.position.set(Mt.cx,1.78,Mt.z0+.172),Y.rotation.x=-.16,i.add(Y)}ve(i,"pod",Mt.cx,2.05,Mt.z0+.1,.6,.2,0);const _t=.6,ft=2.45,St=3.55,At=-2.65,K=-1.95;for(const[L,O]of[[-o,At],[K,ft],[St,o]]){const Y=(L+O)/2,ht=O-L;X(i,"metal",c,Y,.45,0,ht,.9,_t,{cast:!0}),X(i,"joinery",u,Y,.075,0,ht-.1,.15,_t-.08),i.solid(Y,0,0,ht,.9,_t)}ti(i,(-o+At)/2,0,0,At+o,_t);{const L=X(i,"metal",c,At+.03,1.24,0,.05,K-At,_t-.04,{cast:!0});L.rotation.z=.2}X(i,"metal",c,-.9,.945,0,1.6,.05,_t+.06,{cast:!0});for(const L of[-.7,.7])X(i,"metal",c,-.9+L,1.22,0,.04,.5,.04);X(i,"metal",c,-.9,1.44,0,1.56,.04,.05);for(const L of[-.4,.2]){X(i,"trim",Ge,-.9+L,1.38,0,.28,.1,.2,{cast:!0});const O=new st(new Ut(.2,.02,.14),Gv());O.position.set(-.9+L,1.325,0),i.add(O)}i.doors.push({label:"staff gate",style:"panel",pair:!1,auto:!0,startsShut:!0,face:-1,colour:l,surfaceName:"joinery",triggerR:1.2,dwell:1,leaves:[{hx:St-.003,hz:0,y:0,baseRot:0,phiOpen:-Math.PI/2,leafRot:0,dx:-1.0939999999999996/2,dz:Dt.leafT/2,lw:St-ft-.006,lh:1}],centre:{x:(ft+St)/2,z:0},y0:0});const T={z:1.8,d:.8,x0:-o,x1:ft},gt=(T.x0+T.x1)/2,rt=T.x1-T.x0;R1(i,gt,T.z,0,rt,T.d,0,xt.benchtop,l,{handle:!1}),X(i,"trim",Ge,gt,.52,T.z+T.d/2+.03,rt,.6,.02),ve(i,"barn",T.x0+1.6,.62,T.z+T.d/2+.05,1.4,.34,0);const it=-8;X(i,"joinery",u,it,1.02,T.z,.36,.2,.3,{cast:!0}),X(i,"joinery",u,it,1.22,T.z-.06,.32,.24,.03,{cast:!0}),X(i,"metal",c,it,.98,T.z+.3,.14,.16,.1),ve(i,"order",it,1.42,T.z+T.d/2+.01,.8,.22,0);const lt=-5.2;X(i,"metal",c,lt,1.06,T.z,1.6,.04,T.d+.1);for(const L of[-.72,.72])X(i,"metal",c,lt+L,.98,T.z,.05,.16,.05);ve(i,"collect",lt,1.28,T.z+.12,.9,.24,0),X(i,"metal",c,lt,2.62,T.z+.1,.05,.36,.05),X(i,"joinery",u,lt,2.3,T.z+.1,.72,.44,.05,{cast:!0});{const L=new st(new Ie(.64,.36),mo());L.position.set(lt,2.3,T.z+.13),i.add(L)}ve(i,"collect",lt,2.62,T.z+.135,.6,.2,0);const Pt=.2;X(i,"metal",c,Pt,1.12,T.z-.1,.72,.44,.5,{cast:!0}),X(i,"joinery",u,Pt,1.1,T.z+.16,.6,.24,.04);for(const L of[-.18,.1])X(i,"metal",c,Pt+L,.96,T.z+.12,.05,.12,.05);X(i,"joinery",l,Pt+.55,.99,T.z-.15,.28,.18,.28);const ot=1.55;X(i,"joinery",h,ot,.96,T.z,1.2,.1,.7,{cast:!0}),X(i,"metal",c,ot,1.46,T.z,1.2,.05,.7,{cast:!0});for(const L of[-1,1])X(i,"metal",c,ot+L*.575,1.21,T.z,.05,.45,.66);const C=new st(new Ut(1.1,.42,.62),tf("glass",13623528));C.position.set(ot,1.215,T.z),i.add(C),X(i,"joinery",l,ot,1.19,T.z,1.06,.02,.56);for(const[L,O,Y]of[[-.35,-.12,Ge],[0,.1,13210159],[.33,-.08,l]])X(i,"trim",Y,ot+L,1.06+.035,T.z+O,.16,.07,.16,{chamfer:0}),X(i,"trim",Y,ot+L*.7,1.23,T.z-O,.14,.06,.14,{chamfer:0});ve(i,"mccafe",Pt+1.15,.62,T.z+T.d/2+.05,.9,.26,0),X(i,"trim",Ge,-3.6,2.44,T.z-.55,5.8,.58,.06,{cast:!0}),ve(i,"barn",-5.6,2.44,T.z-.51,1.6,.4,0),ve(i,"order",-1.8,2.44,T.z-.51,1.5,.36,0);const S={x:o-.35,z0:.9,z1:2.5},B=(S.z0+S.z1)/2;X(i,"metal",c,S.x,.45,B,.7,.9,S.z1-S.z0,{cast:!0}),i.solid(S.x,0,B,.7,.9,S.z1-S.z0),ti(i,S.x,B,0,.7,S.z1-S.z0),X(i,"metal",c,S.x+.1,1.24,B-.25,.3,.68,.86,{cast:!0}),X(i,"joinery",u,S.x-.075,1.34,B-.25,.02,.4,.74);for(let L=0;L<3;L++){const O=B-.51+L*.26;X(i,"trim",[10236968,8030778,13210159][L],S.x-.085,1.34,O,.01,.3,.19,{chamfer:0}),X(i,"metal",c,S.x-.1,1.02,O,.05,.14,.05,{cast:!0}),X(i,"metal",c,S.x-.15,1.11,O,.1,.03,.03)}X(i,"metal",c,S.x-.11,.925,B-.25,.24,.02,.8),X(i,"joinery",u,S.x-.11,.935,B-.25,.18,.01,.74);for(const[L,O]of[[B+.42,6],[B+.6,5]])for(let Y=0;Y<O;Y++)X(i,"joinery",13620957,S.x,.95+Y*.055,L,.115,.055,.115,{cast:Y===O-1,chamfer:0});ve(i,"drinks",o-.02,1.85,B,.9,.26,-Math.PI/2),Q1(i,o-.42,3.3,-Math.PI/2);const J=-9.55;for(const L of[4.3,5.45]){X(i,"metal",c,J,.05,L,.44,.1,.38),X(i,"trim",Ge,J,.62,L,.38,1.04,.3,{cast:!0}),X(i,"metal",c,J,1.16,L,.42,.05,.34);const O=X(i,"joinery",u,J+.13,1.42,L,.035,.56,.44,{cast:!0});O.rotation.z=.26;const Y=new st(new Ut(.02,.48,.37),mo());Y.position.set(J+.165,1.42,L),Y.rotation.z=.26,i.add(Y),X(i,"metal",c,J+.1,1.08,L+.22,.11,.13,.09),i.solid(J,0,L,.44,1.7,.42),ti(i,J,L,0,.48,.44)}ve(i,"order",-o+.02,1.62,4.88,.6,.2,Math.PI/2);const tt=a-.03-.03,Lt=[{x:-6.9,z:3.8},{x:-4.3,z:3.8},{x:-6.9,z:5.55},{x:-4.3,z:5.55},{x:2.9,z:3.8},{x:5.7,z:3.8},{x:8.3,z:3.8}];Lt.forEach((L,O)=>{const Y=O+1;Jd(i,L.x,L.z,0,.8,.8),rl(i,L.x-.72,L.z,0,Math.PI/2),rl(i,L.x+.72,L.z,0,-Math.PI/2),X(i,"metal",c,L.x,.86,L.z,.035,.24,.035),yu(i,L.x+.22,L.z+.16,.74),f(`table_${Y}`,L.x,L.z,null,null,{noClamp:!0}),f(`seat_${Y}`,L.x+.72,L.z,null,null,{noClamp:!0}),i.interact(`table_serve_${Y}`,"set the tray down",L.x,.85,L.z,"service",{op:"deliver",table:Y,when:"carrying_for"},1.7)});const mt=tt,yt=mt-1.7,Zt=2.6,pt=9.4,Rt=2,Bt=(pt-Zt)/Rt;for(let L=0;L<Rt;L++){const O=Zt+(L+.5)*Bt;for(const[Y,ht,Et]of[[yt+.265,yt+.06,.95],[mt-.265,mt-.06,.55]])X(i,"joinery",l,O,.23,Y,Bt-.1,.46,.53,{cast:!0}),X(i,"joinery",u,O,.075,Y,Bt-.2,.15,.43),X(i,"joinery",l,O,Et/2,ht,Bt-.1,Et,.12,{cast:!0});X(i,"joinery",l,O,.725,(yt+mt)/2,Bt-.2,.03,.7,{cast:!0}),X(i,"joinery",h,O,.36,(yt+mt)/2,.09,.71,.09),yu(i,O+.28,(yt+mt)/2,.74),i.solid(O,0,(yt+mt)/2,Bt,.95,mt-yt)}for(const L of[0,Bt,Bt*Rt]){const O=Zt+L;X(i,"joinery",l,O,.675,(yt+mt)/2,.07,1.35,mt-yt-.06,{cast:!0}),X(i,"trim",Ge,O,1.32,(yt+mt)/2,.086,.06,mt-yt-.06)}ti(i,(Zt+pt)/2,(yt+mt)/2,0,pt-Zt,mt-yt,{margin:.028}),X(i,"trim",Ge,(Zt+pt)/2,.985,yt+.06,pt-Zt,.06,.13);const Ht=tt-.35;X(i,"joinery",l,-6.3,1.03,Ht,6.2,.05,.64,{cast:!0}),X(i,"joinery",u,-6.3,.505,Ht+.1,6,1,.4,{cast:!0}),X(i,"trim",Ge,-6.3,.955,Ht-.285,6.2,.09,.045),i.solid(-6.3,0,Ht,6.2,1.05,.64);for(const L of[-8.5,-7.2,-5.9,-4.6])X(i,"joinery",l,L,.72,Ht-.68,.36,.04,.36,{cast:!0}),X(i,"metal",c,L,.36,Ht-.68,.07,.68,.07),X(i,"metal",c,L,.02,Ht-.68,.34,.04,.34),i.solid(L,0,Ht-.68,.4,.75,.4);const bt=16772056;i.light(-6.5,pr-.15,4.2,bt,10,13),i.light(-2,pr-.15,4.6,bt,10,13),i.light(2.5,pr-.15,4.2,bt,10,13),i.light(7,pr-.15,4.4,bt,10,13),i.light(-3.7,Bn-.15,1,bt,10,12),i.light(-7.5,Bn-.15,-4.8,bt,10,12),i.light(-.5,Bn-.15,-5,bt,10,12),i.light(-3.6,Bn-.15,-2.6,bt,12,12),i.light(4.9,Bn-.3,-5.15,bt,8,9),i.light(8.8,Bn-.15,-2.6,bt,9,10),i.light(5,Bn-.15,-1.6,bt,8,10);for(const[L,O,Y,ht,Et]of[[-1.5,1.9,-3.2,2.4,15],[-3,2.1,4.2,3.4,16],[5.5,2.1,4,2.8,13],[-7.6,2,4.9,2.2,11],[-4,1.9,1,1.6,12]]){const Jt=i.light(L,O,Y,15260876,ht,Et);Jt.decay=1}po(i,-9.4,-6.6,3.1,.2,Bn,4,3),po(i,3.6,-4.3,9.6,-.2,Bn,2,2),po(i,-9,2.4,9.4,6.4,pr,4,2),f("spawn",-1,12.6,null,null,{noClamp:!0}),f("station_pod",Mt.cx,Mt.z1+un,Math.PI,un),f("station_fries",x,p+un,Math.PI,un),f("station_grill",D,p+un,Math.PI,un),f("station_counter",it,T.z-T.d/2-un,0,un),f("station_runner",lt,T.z-T.d/2-un,0,un),f("station_drivethru",ut-.375-un,-2.7,Math.PI/2,un),f("restock",4.45,-5.65,Math.PI,un),f("gate",(ft+St)/2,0,null,null,{noClamp:!0}),f("entry_out",-1,8.3,null,null,{noClamp:!0}),f("entry",-1,6),f("aisle",-2,2.9),f("queue_1",-8,2.8),f("queue_2",-7.25,2.95),f("queue_3",-6.5,3),f("queue_4",-5.9,3.15),f("collect_wait",-5.2,3.1),f("collect_pickup",-5.2,2.65),f("kiosk_gate",-8.9,2.9),f("kiosk_1",-8.78,4.3),f("kiosk_2",-8.85,5.15),i.interact("station_pod","work the pod",Mt.cx,.95,Mt.z1,"station",{station:"pod",zone:{minZ:Mt.z1}},2),i.interact("pod_toaster","toast a bun",Ot,1.25,Mt.cz+.21,"pod",{op:"token",token:"bun",podOnly:!0},1.8),Q.forEach(([L],O)=>{const Y=Yt-.255+O*.17;i.interact("pod_gun_"+L,L==="bbq"?"dose BBQ":"dose "+L,Y,1.25,Mt.cz-.25,"pod",{op:"token",token:L,podOnly:!0},1.7)}),ct.forEach(([L],O)=>{const Y=z+.1+O*.19;i.interact("pod_bin_"+L,"add "+L,Y,.98,Mt.cz-.08,"pod",{op:"token",token:L,podOnly:!0},1.7)}),i.interact("pod_uhc","pull from the cabinet",et,1.28,Mt.cz+.345,"pod",{op:"uhc",podOnly:!0},1.6),i.interact("pod_wrap","wrap the order",ks.x,.95,ks.z,"pod",{op:"wrap",podOnly:!0},1.4),i.interact("pod_chute","send it down",xe.x0+.05,1.05,xe.z0,"pod",{op:"send",podOnly:!0},1.4),Mu(i,.42,.94,0,6);for(let L=0;L<3;L++)X(i,"joinery",14272934,1.08+L*.13,.975,-.04+L%2*.08,.11,.15,.065,{cast:L===0,chamfer:0}),X(i,"joinery",14272934,1.08+L*.13,1.06,-.04+L%2*.08,.115,.022,.03,{chamfer:0});for(let L=0;L<3;L++)X(i,"joinery",14272934,1.62+L*.13,.975,-.02+L%2*.07,.11,.15,.065,{cast:!1,chamfer:0}),X(i,"trim",Ge,1.62+L*.13,.955,-.02+L%2*.07,.112,.03,.067,{chamfer:0});i.interact("counter_tray","take a tray for table service",.42,1.02,0,"service",{op:"tray",when:"tray_ready"},1.6),i.interact("counter_bag","bag the next takeaway",1.18,1.02,0,"service",{op:"bag",when:"bag_ready"},1.6),i.interact("dt_bag","bag the drive-thru order",1.68,1.02,0,"service",{op:"dt_bag",when:"dt_bag_ready"},1.6),i.interact("dlv_bag","bag the delivery",1.18,1.02,-.28,"service",{op:"dlv_bag",when:"dlv_bag_ready"},1.6),i.interact("station_counter","work the counter",it,.95,T.z-T.d/2,"station",{station:"counter",zone:{maxZ:T.z-T.d/2}},1.8),i.interact("till_order","take their order",it,1.3,T.z+.95,"counter",{op:"take_order",when:"queue_head"},2.4),i.interact("till_payment","take payment",it,1,T.z+.3,"counter",{op:"take_payment",when:"payment_due"},1.6);const ee=[];for(const L of d){const O=L.noClamp?{x:L.x,z:L.z,moved:0}:ty(i.colliders,L.x,L.z);i.spot(L.name,O.x,0,O.z),O.moved>.005&&ee.push({name:L.name,from:[L.x,L.z],to:[+O.x.toFixed(3),+O.z.toFixed(3)],moved:+O.moved.toFixed(3)})}const jt=ny(i.colliders,d.filter(L=>!L.noClamp).map(L=>({id:L.name,x:L.x,z:L.z,facing:L.facing,standoff:L.standoff}))),oe={rule:`spot = fixture face + normal * standoff; clear floor ${ol} x ${al}; hard floor ${Mi}`,checked:d.length,failures:jt.failures,clamped:ee,tightest:jt.tightest,ok:jt.failures.length===0&&ee.length===0};oe.ok||console.error("Fitout: CLEARANCE FAILURES — a published point is unreachable",oe.failures,ee);const k=[{where:"pod face to the pass",m:+(-_t/2-Mt.z1).toFixed(2)},{where:"pod back to the grill front",m:+(Mt.z0-p).toFixed(2)},{where:"pod east end to the pack-out",m:+(F.cx-F.w/2-Mt.x1).toFixed(2)},{where:"crew aisle, pass to counter",m:+(T.z-T.d/2-_t/2).toFixed(2)},{where:"staff gate",m:+(St-ft).toFixed(2)},{where:"pass flap by the landing",m:+(K-At).toFixed(2)},{where:"counter face to dining tables",m:+(Lt[0].z-.4-(T.z+T.d/2)).toFixed(2)},{where:"restock straight line, pod spot to dry store door",m:+Math.hypot(4.15-Mt.cx,-4.55-(Mt.z1+un)).toFixed(2)},{where:"front door opening",m:1.8}];return{workplace:"burger_barn",clearance:oe,walkways:k,spots:i.spots,materials:K1.map(L=>typeof L[1]=="number"?`${L[0]}@${L[1].toString(16)}`:`${L[0]}:${L[1]}`),labels:sf()!==null}}const Ln={width:20,depth:14,height:4.2},Kt=Ln.width/2,Vt=Ln.depth/2,Kn=Ln.height,aa=Dt.wallThick,Ui=Kt-aa/2,Ls=Vt-aa/2,An=2,ja=4.9,go=.15,Su=6.4,$a=3.2,_o=2.8,sy=.45,ry=2.7,Pe=-1,ts=1.8,wu=2.6,Za=.9,Ka=.85,Ja=2.05,Eu=-4.2,bu=-1,Qa=-5.4,oy=1.8,In=11026479,Bs=13224902,Tu=new Set;function rf(i,t,e={}){if(e.material)return e.material;try{return Bl(i,t,null,e.recipe||{})}catch(n){return Tu.has(i)||(Tu.add(i),console.error(`Shell: surface '${i}' unavailable, flat colour instead`,n)),Se(t,e)}}function zt(i,t,e,n,s,r,o,a,c,l={}){var d;const h=rf(t,e,l),u=new st(new Ut(Math.max(o,.001),Math.max(a,.001),Math.max(c,.001)),h);return u.castShadow=l.cast??((d=h.userData)==null?void 0:d.cast)??!1,u.receiveShadow=!0,u.position.set(n,s,r),l.rotY&&(u.rotation.y=l.rotY),i.add(u),u}const ni=()=>Se(qt.concrete);function Mn(i,t,e,n,s,r=0){const o=(t+n)/2,a=(e+s)/2,c=Math.abs(n-t),l=Math.abs(s-e);zt(i,"(concrete)",0,o,r-.06,a,c,.12,l,{material:ni(),cast:!1}),i.solid(o,r-1.2,a,c,1.2,l,!0)}function Au(i,t,e,n,s,r,o){const a=new ra(n,s,28,2,r,Math.PI/2);a.rotateX(-Math.PI/2);const c=new st(a,ni());return c.receiveShadow=!0,c.position.set(t,o,e),i.add(c),c}function Rn(i,t,e,n,s,r=0,o=.15){const a=(t+n)/2,c=(e+s)/2;zt(i,"(concrete)",0,a,r+o/2,c,Math.max(Math.abs(n-t),.15),o,Math.max(Math.abs(s-e),.15),{material:ni()})}function xo(i,t,e,n,s,r,o=0,a=.15){for(let l=0;l<8;l++){const h=s+(r-s)*(l/8),u=s+(r-s)*((l+1)/8),d=t+Math.cos(h)*n,f=e+Math.sin(h)*n,m=t+Math.cos(u)*n,_=e+Math.sin(u)*n,p=Math.hypot(m-d,_-f)+.04;zt(i,"(concrete)",0,(d+m)/2,o+a/2,(f+_)/2,p,a,.16,{material:ni(),rotY:Math.atan2(-(_-f),m-d)})}}function Ye(i,t,e,n,s,r=0){const o=(t+n)/2,a=(e+s)/2;zt(i,"trim",xt.trim,o,r+.008,a,Math.max(Math.abs(n-t),.1),.012,Math.max(Math.abs(s-e),.1))}function No(i,t,e,n=0,s=1){const r=new st(new Ve(.07,.07,s,8),rf("metal",xt.metalDull));r.castShadow=!0,r.position.set(t,n+s/2,e),i.add(r)}function vo(i,t,e,n,s,r,o=0){const a=n-t,c=s-e,l=Math.hypot(a,c);if(l<.5)return;const h=a/l,u=c/l,d=-u,f=h,m=Math.atan2(-u,h),_=aa/2+.006;for(let p=1.2;p<r-.2;p+=1.2)zt(i,"joinery",xt.shadowDark,t+h*(l/2)+d*_,o+p,e+u*(l/2)+f*_,l,.02,.012,{rotY:m});for(let p=1.2;p<l-.3;p+=1.2)zt(i,"joinery",xt.shadowDark,t+h*p+d*_,o+r/2,e+u*p+f*_,.02,r,.012,{rotY:m})}const Hl={lane:{width:3.5,surface:0,legs:[{name:"entry",from:{x:-15,z:15.9},to:{x:-15,z:-6.5},forward:{x:0,z:-1}},{name:"rear",from:{x:-9,z:-12.5},to:{x:6.15,z:-12.5},forward:{x:1,z:0}},{name:"service",from:{x:12.15,z:-6.5},to:{x:12.15,z:29.5},forward:{x:0,z:1}}]}},pe=Hl.lane.surface,Is=Hl.lane.width/2;function ay(i,t){Mn(i,-Kt,Vt,Kt,10.5),Mn(i,-11,10.5,10.4,27.5),Mn(i,-17.75,15.9,-11,29.5),Mn(i,9.65,27.5,14.65,29.5),Mn(i,-13.25,-6.5,-10,Vt),Mn(i,-12.9,-Vt,-10,-6.5),Mn(i,-7,-10.75,1.5,-8.6),Mn(i,-6.9,-10,-3.9,-Vt),Mn(i,2,-10.2,5,-8.2),Mn(i,-15-Is,-6.5,-15+Is,15.9,pe),Mn(i,-9,-12.5-Is,6.15,-12.5+Is,pe),Mn(i,12.15-Is,-6.5,12.15+Is,29.5,pe),Au(i,-9,-6.5,4.25,7.75,Math.PI/2,pe),Au(i,6.15,-6.5,4.25,7.75,0,pe),Rn(i,-16.75,-6.5,-16.75,15.9,pe),Rn(i,-13.25,-6.5,-13.25,15.9,pe),Rn(i,-9,-14.25,6.15,-14.25,pe),Rn(i,-9,-10.75,.5,-10.75,pe),Rn(i,13.9,-6.5,13.9,29.5,pe),Rn(i,10.4,-6.5,10.4,-5.6,pe),Rn(i,10.4,.6,10.4,29.5,pe),Rn(i,10.4,-5.2,10.4,.2,pe,.1),xo(i,-9,-6.5,4.25,Math.PI,Math.PI*1.5,pe),xo(i,-9,-6.5,7.75,Math.PI,Math.PI*1.5,pe),xo(i,6.15,-6.5,4.25,Math.PI*1.5,Math.PI*2,pe),xo(i,6.15,-6.5,7.75,Math.PI*1.5,Math.PI*2,pe);for(const c of[-16.6,-13.4])Ye(i,c,-6.5,c,15,pe);for(const c of[-14.1,-10.9])Ye(i,-9,c,.4,c,pe);Ye(i,13.75,-6.5,13.75,27.5,pe),Ye(i,.5,-14.25,.5,-10.75,pe);for(let c=1;c<6.4;c+=.8)Ye(i,c,-14.25,c+.4,-14.25,pe);for(const[c,l]of[[-11.2,-8.6],[-10.2,-9.4],[8.6,-8.8],[9.4,-7.8]])No(i,c,l);for(let c=0;c<=2;c++)Ye(i,-11+c*2.6,10.5,-11+c*2.6,15.9);for(let c=0;c<=3;c++)Ye(i,1.4+c*2.6,10.5,1.4+c*2.6,15.9);for(let c=0;c<=8;c++)Ye(i,-11+c*2.6,22.1,-11+c*2.6,27.5);for(let c=0;c<2;c++)zt(i,"(concrete)",0,-11+(c+.5)*2.6,.06,11.4,1.65,.12,.18,{material:ni()});for(let c=0;c<3;c++)zt(i,"(concrete)",0,1.4+(c+.5)*2.6,.06,11.4,1.65,.12,.18,{material:ni()});for(let c=0;c<8;c++)zt(i,"(concrete)",0,-11+(c+.5)*2.6,.06,26.6,1.65,.12,.18,{material:ni()});for(const c of[Pe-2.4,Pe,Pe+2.4])Ye(i,c,10.5,c,15.9);for(let c=11;c<15.9;c+=.7)Ye(i,Pe-2.4,c,Pe,c+.24);No(i,Pe-1.2,13.2,0,1.3),Ye(i,Pe,13.2,Pe+2.4,13.44);for(let c=11;c<15.6;c+=.8)Ye(i,-5.6,c,-3.6,c+.3);Rn(i,-Kt,10.5,Kt,10.5),Rn(i,-11,10.5,-11,27.5),Rn(i,-11,27.5,9.8,27.5);for(let c=16.1;c<22.1;c+=.8)Ye(i,-5.2,c,-3.2,c+.3);Ye(i,-11.25,15.9,-11.25,22.1);for(let c=10.6;c<13.9;c+=.8)Ye(i,c,18,c+.3,20,pe);for(let c=-9.2;c<=9.2;c+=1.5)c>Pe-1.7&&c<Pe+1.7||No(i,c,Vt+.6);zt(i,"metal",xt.metalDull,Pe,3.07,Vt+1.5,6,.14,3,{cast:!0});for(const c of[-2.7,2.7])zt(i,"metal",xt.metalDull,Pe+c,1.5,Vt+2.8,.12,3,.12,{cast:!0});for(const c of[3.4,6.6]){Jd(i,c,9.3,0,.9,.9);for(const[l,h,u]of[[-.78,0,Math.PI/2],[.78,0,-Math.PI/2],[0,-.78,0],[0,.78,Math.PI]])rl(i,c+l,9.3+h,0,u)}Ye(i,-9.8,8.2,-9.8,10.4),Ye(i,-8.6,8.2,-8.6,10.4),Ye(i,-7.4,8.2,-7.4,10.4);for(const c of[-9.2,-8])zt(i,"metal",xt.metalDull,c-.35,.38,10.1,.06,.76,.06,{cast:!0}),zt(i,"metal",xt.metalDull,c+.35,.38,10.1,.06,.76,.06,{cast:!0}),zt(i,"metal",xt.metalDull,c,.74,10.1,.76,.06,.06,{cast:!0});const e=Math.PI/2+.209,n=-12.3,s=7.4,r=(c,l,h,u,d,f,m,_,p={})=>{zt(i,c,l,n+h*Math.cos(e)+d*Math.sin(e),u,s-h*Math.sin(e)+d*Math.cos(e),f,m,_,{rotY:e,...p})};zt(i,"metal",xt.metalDull,-12.1,.55,10.8,.1,1.1,.1,{cast:!0}),zt(i,"trim",In,-12.1,1.6,10.8,.9,1.4,.1,{cast:!0,rotY:e+.4}),r("(concrete)",0,0,.12,.22,2.1,.25,.6,{material:ni()}),r("trim",In,0,1.7,0,1.96,1.66,.16,{cast:!0}),r("trim",xt.trim,0,1.7,-.07,1.8,1.5,.06);const o=(c,l,h,u,d,f="trim",m=0)=>r(f,d,c,l,-.11-m,h,u,.02);o(0,2.28,1.64,.22,In);for(let c=0;c<5;c++)for(const l of[-.42,.44])o(l,2.02-c*.14,.68,.035,xt.shadowDark,"joinery");for(const c of[-.55,0,.55])o(c,1.18,.4,.3,In),o(c,1.12,.28,.12,xt.joineryLight,"joinery",.01);r("metal",xt.metalDull,1.6,.9,-.1,.25,1.8,.25,{cast:!0}),r("joinery",xt.shadowDark,1.6,1.35,-.24,.2,.2,.04),r("joinery",xt.shadowDark,1.6,1.62,-.24,.55,.35,.04),zt(i,"metal",xt.metalDull,-12.55,2.92,7.1,3.2,.14,3,{cast:!0});for(const c of[5.85,8.45])zt(i,"metal",xt.metalDull,-11.45,1.4,c,.12,2.8,.12,{cast:!0});for(const c of[-17.05,-12.95])zt(i,"metal",xt.metalDull,c,pe+1.3,14,.09,2.6,.09,{cast:!0});zt(i,"trim",In,-15,pe+2.5,14,4.3,.2,.12,{cast:!0}),zt(i,"wall",Bs,1.7,1,-9.2,.14,2,2,{cast:!0}),i.solid(1.7,0,-9.2,.14,2,2);for(const c of[-9.6,-8.7])zt(i,"metal",xt.metalDull,3.5,.45,c,1.2,.9,.7,{cast:!0}),i.solid(3.5,0,c,1.2,.9,.7);const a={x0:-12.8,x1:-10.2,z0:-Vt,z1:-5};for(const[c,l,h,u]of[[a.x0,a.z0,a.x1,a.z0+.2],[a.x0,a.z0,a.x0+.2,a.z1],[a.x1-.2,a.z0,a.x1,a.z1]]){const d=(c+h)/2,f=(l+u)/2;zt(i,"wall",Bs,d,.9,f,h-c,1.8,u-l,{cast:!0}),i.solid(d,0,f,h-c,1.8,u-l)}zt(i,"metal",xt.metalDull,(a.x0+a.x1)/2,1.2,a.z1,2.4,2.4,.08,{cast:!0}),zt(i,"metal",xt.metalDull,(a.x0+a.x1)/2,1.94,(a.z0+a.z1)/2,a.x1-a.x0+.2,.1,a.z1-a.z0+.1,{cast:!0});for(const[c,l,h]of[[-12.1,-6.2,1.2],[-10.85,-6.2,1.2],[-12.1,-5.55,1.2],[-10.9,-5.55,.6]])zt(i,"joinery",xt.joineryDark,c,.55,l,h,1.1,.55,{cast:!0}),zt(i,"joinery",xt.shadowDark,c,1.13,l,h+.04,.06,.59),i.solid(c,0,l,h,1.16,.55);Mn(i,-13,-4.8,-11.5,-3.3);for(const[c,l,h,u]of[[-13,-4.8,-11.5,-4.68],[-13,-3.42,-11.5,-3.3],[-13,-4.8,-12.88,-3.3],[-11.62,-4.8,-11.5,-3.3]])Rn(i,c,l,h,u,0,.2);for(const[c,l]of[[-12.55,-4.1],[-11.95,-4.1]])zt(i,"metal",xt.metalDull,c,.42,l,.5,.84,.5,{cast:!0});if(zt(i,"(concrete)",0,-10.6,.1,28.3,1.1,.2,1.1,{material:ni()}),zt(i,"trim",In,-10.6,3,28.3,.55,6,.55,{cast:!0}),i.solid(-10.6,0,28.3,.7,6,.7),t){const c=t.clone();c.scale.set(.62,1.9,1),c.position.set(-10.6,4.3,28.62),i.add(c);const l=t.clone();l.scale.set(.62,1.9,1),l.position.set(-10.6,4.3,27.98),l.rotation.y=Math.PI,i.add(l)}}function cy(i,t={}){const e=new M1;S1(e,0,0,Ln.width,Ln.depth,0,xt.tileFloor,{surface:"vinyl"});const n={height:Kn,colour:Bs,surface:"wall",skirting:!1,cornice:!1,autoServices:!1,inner:-1},s=[],r=(_,p)=>{const g=p-_,v=Math.max(1,Math.round(g/1.565)),x=g/v;for(let M=0;M<v;M++)s.push({at:_+(M+.5)*x+Kt,width:Math.min(1.375,x-.19),kind:"window",sill:sy,head:ry})};r(-Ui,Pe-ts/2-.15),r(Pe+ts/2+.15,9.6),s.push({at:Pe+Kt,width:ts,kind:"door",head:wu,door:{pair:!0,style:"glazed",auto:!0,startsShut:!0,swing:1,label:"entrance"}}),rs(e,-Kt,Vt,Kt,Vt,{...n,openings:s,name:"front"}),rs(e,Kt,Vt,Kt,-Vt+An,{...n,openings:[{at:Vt-4,width:1.2,kind:"window",sill:1.8,head:2.7},{at:Vt-bu,width:Za,kind:"window",sill:Ka,head:Ja},{at:Vt-Eu,width:Za,kind:"window",sill:Ka,head:Ja}],name:"east"}),rs(e,Kt,-Vt+An,Kt-An,-Vt,{...n,name:"splay"}),rs(e,Kt-An,-Vt,-Kt,-Vt,{...n,openings:[{at:Vt-Qa,width:oy,kind:"door",head:wu,door:{style:"panel",pair:!1,startsShut:!1,swing:1,colour:xt.metalDull,label:"goods door"}}],name:"rear"}),rs(e,-Kt,-Vt,-Kt,Vt,{...n,openings:[{at:Vt-.5,width:Za,kind:"window",sill:Ka,head:Ja}],name:"west"});const o=1.4;C1(e,0,(o+Ls)/2,Ui*2,Ls-o,$a),mu(e,0,(o-5)/2,Ui*2,o+5,_o),mu(e,(-Ui+7.9)/2,(-Ls-5)/2,Ui+7.9,Ls-5,_o),zt(e,"wall",Bs,0,(_o+$a+.12)/2,o,Ui*2,$a-_o+.16,.12,{cast:!0}),zt(e,"wall",Bs,0,Kn+.1,0,Ln.width,.2,Ln.depth,{cast:!0});const a=[[-Kt,Vt,Kt,Vt],[Kt,Vt,Kt,-Vt+An],[Kt,-Vt+An,Kt-An,-Vt],[Kt-An,-Vt,-Kt,-Vt],[-Kt,-Vt,-Kt,Vt]];for(const[_,p,g,v]of a){const x=Math.hypot(g-_,v-p)+.36,M=Math.atan2(-(v-p),g-_),A=(_+g)/2,E=(p+v)/2;zt(e,"wall",Bs,A,(Kn+ja-go)/2,E,x,ja-go-Kn,.35,{rotY:M,cast:!0}),zt(e,"trim",xt.trim,A,ja-go/2,E,x+.06,go,.47,{rotY:M,cast:!0})}const c=Vt+aa/2;zt(e,"trim",In,0,3.475,c+.05,Ln.width,.85,.1,{cast:!0});const l=3.2,h=Pe-1.2,u=h+l;for(const[_,p]of[[(-Kt+h)/2,h+Kt],[(u+Kt)/2,Kt-u]])zt(e,"metal",xt.metalDull,_,2.93,c+.6,p,.16,1.2,{cast:!0}),zt(e,"trim",In,_,2.79,c+1.18,p,.14,.06);const d=(h+u)/2;zt(e,"trim",In,d,(2.4+Su)/2,c+.2,l,Su-2.4,.4,{cast:!0});for(const[_,p]of[[(h+Pe-ts/2)/2,Pe-ts/2-h],[(Pe+ts/2+u)/2,u-Pe-ts/2]])zt(e,"trim",In,_,1.2,c+.2,p,2.4,.4,{cast:!0});zt(e,"joinery",xt.shadowDark,d,4.3,c+.41,l,3.4,.02);for(let _=0;_<18;_++)zt(e,"joinery",xt.joineryLight,h+.0875+_*.175,4.3,c+.44,.15,3.4,.04,{cast:!0});let f=null;typeof document<"u"&&document.createElement&&(f=Si(t.name||"BURGER BARN",{width:7.2,height:.62,bg:"rgba(0,0,0,0)",fg:t.signFg??"#f6efe0",font:"bold 84px Georgia, serif"}),f.position.set(4.9,3.46,c+.12),e.add(f));for(const _ of[Eu,bu]){zt(e,"metal",xt.metalDull,Kt+.53,pe+2.66,_,.9,.12,1.6,{cast:!0});for(const p of[-.75,.75])No(e,Kt+.6,_+p,pe)}zt(e,"metal",xt.metalDull,-Kt-.53,pe+2.66,-.5,.9,.12,1.6,{cast:!0}),zt(e,"trim",In,-Kt-.1,2.35,-.5,.1,.45,1.7,{cast:!0}),zt(e,"(concrete)",0,-12.85,.12,-1.9,1.3,.25,.45,{material:ni()}),zt(e,"trim",In,-12.85,1.55,-1.9,1.24,1.3,.14,{cast:!0}),zt(e,"trim",xt.trim,-12.85,1.55,-1.97,1.1,1.16,.05);for(let _=0;_<4;_++)zt(e,"joinery",xt.shadowDark,-12.85,1.86-_*.17,-2,.88,.032,.02);zt(e,"metal",xt.metalDull,-12.85,.85,-.95,.2,1.7,.2,{cast:!0}),zt(e,"joinery",xt.shadowDark,-12.85,1.3,-1.06,.16,.16,.04),zt(e,"metal",xt.metalDull,6.2,2.3,-Vt-.4,.8,4.2,.6,{cast:!0}),zt(e,"metal",xt.metalDull,6.2,4.55,-Vt-.4,1,.35,.8,{cast:!0});for(const _ of[-1,.5]){zt(e,"metal",xt.metalDull,_,2.6,-Vt-.06,.6,.6,.06);for(let p=0;p<5;p++)zt(e,"joinery",xt.shadowDark,_,2.36+p*.12,-Vt-.1,.54,.05,.04)}zt(e,"metal",xt.metalDull,Qa,2.86,-Vt-1,3,.14,2,{cast:!0});for(const _ of[-1.3,1.3])zt(e,"metal",xt.metalDull,Qa+_,1.43,-Vt-1.85,.12,2.86,.12,{cast:!0});vo(e,Kt,Vt,Kt,-Vt+An,Kn),vo(e,Kt,-Vt+An,Kt-An,-Vt,Kn),vo(e,Kt-An,-Vt,-Kt,-Vt,Kn),vo(e,-Kt,-Vt,-Kt,Vt,Kn),ay(e,f);const m=iy(e,{width:Ln.width,depth:Ln.depth});return{group:Hd(e.group),colliders:e.colliders,doorSpecs:e.doors,interactables:e.interactables,spots:e.spots,lights:e.lights,report:m,width:Ln.width,depth:Ln.depth,height:Kn,door:{x:Pe,z:Vt+1.6},doors:[{x:Pe,z:Vt+1.6}],interiorBounds:{minX:-Ui,maxX:Ui,minZ:-Ls,maxZ:Ls,maxY:Kn}}}const re=(i,t,e,n,s=null)=>{const r=new st(new Ut(i,t,e),s||Se(n));return r.castShadow=!0,r.receiveShadow=!0,r};function ly(i){const t=i.root,e=i.rng.child("places"),n=i.colliders,s=(a,c,l,h,u)=>n.push({min:new I(a-l/2,0,c-u/2),max:new I(a+l/2,h,c+u/2),walkable:!1}),r=(a,c,l,h,u=-.045,d=qt.concrete)=>{const f=new st(new Ut(Math.abs(l-a),.1,Math.abs(h-c)),Se(d));f.position.set((a+l)/2,u,(c+h)/2),f.receiveShadow=!0,t.add(f)},o=(a,c,l,h,u=0)=>(a.position.set(c,l,h),a.rotation.y=u,t.add(a),a);hy(t,s,o,r),uy(t,s,o,r,e),dy(t,s,o,r),fy(t,s,o,r),py(t,s,o,r,e)}function hy(i,t,e,n){e(re(7.2,3.1,5.4,15262424),5,1.55,44.5),e(re(7.4,.5,5.6,12597547),5,3.2,44.5),e(re(7.4,.16,5.9,10104864),5,3.5,44.5),t(5,44.5,7.2,3.4,5.4);const o=Si("POST OFFICE",{width:3.4,height:.6,bg:"#c0392b"});e(o,5,3.2,44.5-2.96,Math.PI),e(re(1,2.1,.08,5916210),5+2.1,1.05,44.5-2.74);for(const a of[-2,0])e(re(1.6,1.3,.08,0,ds()),5+a,1.6,44.5-2.74);e(re(.6,1.1,.6,12597547),5-4.6,.55,40),t(5-4.6,40,.7,1.2,.7),n(3,41.8,5+3.6,39.2,-.036)}function uy(i,t,e,n,s){e(re(34,5.4,15,13620184),0,2.7,-53),e(re(34.4,.9,15.4,9063482),0,5.6,-53),t(0,-53,34,6.2,15);const a=Si("BARNSIDE MALL",{width:7.5,height:1.1,bg:"#8a4c3a"});e(a,0,4.4,-53+7.58),e(re(30,2.6,.1,0,ds()),0,1.4,-53+7.52),["GROCER","CHEMIST","BAKERY"].forEach((l,h)=>{const u=-10+h*10;e(Si(l,{width:2.6,height:.5,bg:"#20262e"}),u,3.15,-53+7.56),e(re(1.1,2.2,.1,3817544),u+3,1.1,-53+7.54)}),n(-16,-53+8.5,16,-53+14.5);for(let l=0;l<7;l++){const h=-13+l*4.4;if(n(h-.06,-44,h+.06,-53+13.6,-.03,15262938),l<6&&s.chance(.55)){const u=oa(s);e(u,h+2.2,0,-53+11.4,Math.PI+s.range(-.04,.04)),t(h+2.2,-53+11.4,2,1.6,4.4)}}}function dy(i,t,e,n){e(re(8,3.4,16,14272936),-72,1.7,-5),e(re(8.6,.14,16.8,5266020),-72,3.5,-5),e(re(8.6,.4,16.8,4476991),-72,3.32,-5),t(-72,-5,8,3.8,16),e(Si("BARNSIDE PRIMARY",{width:4.6,height:.7,bg:"#44503f"}),-72+4.08,2.6,-5,Math.PI/2),e(re(1.1,2.1,.1,8007458),-72+4.05,1.05,1);for(const a of[-6,-3,0,3])e(re(.08,1.2,2.2,0,ds()),-72+4.04,1.7,-5+a);n(-68,0,-58,2,-.036),n(-74,-19,-62,-14,-.03,12173510);const o=(a,c,l,h)=>{e(re(Math.max(l,.08),1,Math.max(h,.08),9080982),a,.5,c),t(a,c,Math.max(l,.2),1.1,Math.max(h,.2))};o(-72,-5-16.5,16,.08),o(-80,-5-6.5,.08,20),o(-64,-5-12.5,.08,8)}function fy(i,t,e,n){n(-66,64,-50,77),e(re(13,.35,8,14344164),-58,4.4,70),e(re(13.2,.5,8.2,12597547),-58,4.75,70);for(const o of[-5.4,5.4])for(const a of[-2.8,2.8])e(re(.3,4.3,.3,11186874),-58+o,2.15,70+a),t(-58+o,70+a,.4,4.3,.4);for(const o of[-1.7,1.7]){n(-58-2.4,70+o-.55,-58+2.4,70+o+.55,.06,14209734);for(const a of[-1.4,1.4])e(re(.7,1.5,.5,12597547),-58+a,.85,70+o),t(-58+a,70+o,.8,1.6,.6)}e(re(7,3,4.5,14999766),-58-10.5,1.5,70+.5),t(-58-10.5,70+.5,7,3.2,4.5),e(Si("BARN FUEL",{width:2.4,height:.55,bg:"#c0392b"}),-58-10.5,3.15,70+2.78),e(re(.5,3.6,.5,11186874),-58+6.8,1.8,70+2.5),e(Si("FUEL  189.9",{width:1.9,height:.9,bg:"#20262e"}),-58+6.8,3,70+2.53),e(Si("FUEL  189.9",{width:1.9,height:.9,bg:"#20262e"}),-58+6.8,3,70+2.47,Math.PI),t(-58+6.8,70+2.5,.6,3.8,.6)}function py(i,t,e,n,s){n(48.5,-7.4,70,-8.6,-.036),n(58,-8.6,59.2,13,-.036);const r=new st(new ea(5.2,22),new yi({color:4881812}));r.rotation.x=-Math.PI/2,r.position.set(64,-.02,14),i.add(r);const o=new st(new ra(5.2,5.7,22),Se(12169892));o.rotation.x=-Math.PI/2,o.position.set(64,.012,14),o.receiveShadow=!0,i.add(o);for(let u=0;u<7;u++){const d=s.range(0,Math.PI*2),f=re(.08,s.range(.5,.9),.08,6123586);e(f,64+Math.cos(d)*s.range(4.6,5.4),.35,14+Math.sin(d)*s.range(4.6,5.4))}const a=60,c=-2;n(a-4.5,c-3.5,a+4.5,c+3.5,-.03,13213802);for(const u of[-2.2,2.2])e(re(.14,2.2,1.6,4157322),a+u,1.1,c-1.8);e(re(4.4,.14,.14,4157322),a,2.2,c-1.8);for(const u of[-1,1])e(re(.04,.9,.04,3159098),a+u-.2,1.7,c-1.8),e(re(.04,.9,.04,3159098),a+u+.2,1.7,c-1.8),e(re(.5,.06,.24,12597547),a+u,1.22,c-1.8);t(a,c-1.8,4.6,2.3,.5);const l=re(.7,.1,2.6,12597547);l.rotation.x=.55,e(l,a+1.6,.85,c+1.4),e(re(.8,1.5,.8,4157322),a+1.6,.75,c+2.7),t(a+1.6,c+2,1,1.6,2.6),e(re(.4,.5,.9,13216097),a-2.4,.62,c+1.8),e(re(.1,.5,.1,3159098),a-2.4,.25,c+1.8);for(const[u,d,f]of[[56,-6.6,0],[66,-6.6,0],[60.5,8,Math.PI/2]]){const m=new Xt,_=re(1.7,.09,.45,10129274);_.position.y=.48,m.add(_);const p=re(1.7,.4,.08,10129274);p.position.set(0,.78,-.2),m.add(p);for(const g of[-.7,.7]){const v=re(.08,.48,.4,5593696);v.position.set(g,.24,0),m.add(v)}e(m,u,0,d,f),t(u,d,1.8,.9,.6)}const h=[[52,20],[56,26],[70,24],[78,8],[80,-4],[62,-22],[52,-26],[78,-26]];for(const[u,d]of h)e(qo(s,s.range(.9,1.5)),u,0,d)}const ie=6,le=34.5,Ue=-34,Ne=-46,Oe=44,Je={front:le,back:Ue,west:Ne,east:Oe},si={front:78,back:-78,west:-90,east:88},ls=[],of=[],Hs=ie/2+1.2;function my(i){const t=i.root,e=i.rng.child("town"),n=i.colliders,s=()=>Se(qt.concrete),r=(M,A,E,b)=>{const P=(M+E)/2,D=(A+b)/2,y=new st(new Ut(Math.abs(E-M),.1,Math.abs(b-A)),s());y.position.set(P,-.045,D),y.receiveShadow=!0,t.add(y)},o=(M,A,E,b)=>{const P=Math.abs(E-M)>Math.abs(b-A)?"x":"z",D=Math.abs(P==="x"?E-M:b-A);for(let y=0;y<D;y+=4){const w=y/D,U=new st(new Ut(P==="x"?1.6:.12,.02,P==="x"?.12:1.6),Se(xt.trim));U.position.set(M+(E-M)*w,.012,A+(b-A)*w),t.add(U)}};r(Ne-ie/2,le-ie/2,Oe+ie/2,le+ie/2),r(Ne-ie/2,Ue-ie/2,Oe+ie/2,Ue+ie/2),r(Ne-ie/2,Ue-ie/2,Ne+ie/2,le+ie/2),r(Oe-ie/2,Ue-ie/2,Oe+ie/2,le+ie/2),o(Ne+4,le,Oe-4,le),o(Ne+4,Ue,Oe-4,Ue),o(Ne,Ue+4,Ne,le-4),o(Oe,Ue+4,Oe,le-4),r(-17.75,29.5,-11,le-ie/2),r(9.65,29.5,14.65,le-ie/2);const{front:a,back:c,west:l,east:h}=si;r(l-ie/2,a-ie/2,h+ie/2,a+ie/2),r(l-ie/2,c-ie/2,h+ie/2,c+ie/2),r(l-ie/2,c-ie/2,l+ie/2,a+ie/2),r(h-ie/2,c-ie/2,h+ie/2,a+ie/2),o(l+4,a,h-4,a),o(l+4,c,h-4,c),o(l,c+4,l,a-4),o(h,c+4,h,a-4);for(const M of[Ne,Oe])r(M-3,le+3,M+3,a-3),r(M-3,c+3,M+3,Ue-3),o(M,le+5,M,a-5),o(M,c+5,M,Ue-5);for(const M of[le,Ue])r(l+3,M-3,Ne-3,M+3),r(Oe+3,M-3,h-3,M+3),o(l+5,M,Ne-5,M),o(Oe+5,M,h-5,M);r(-10,-16,-1,-22.5),r(-8,-22.5,-3,Ue+ie/2),r(-23,-22.5,-19,le-ie/2),r(-23,-16,-10,-22.5);const u=(M,A,E,b)=>{const P=new st(new Ut(Math.max(.12,Math.abs(E-M)),.02,Math.max(.12,Math.abs(b-A))),Se(xt.trim));P.position.set((M+E)/2,.012,(A+b)/2),t.add(P)};u(-9.4,-16.4,-9.4,-21.2),u(-6.4,-16.4,-6.4,-21.2),u(-1.6,-16.4,-1.6,-21.2),u(-9.4,-16.4,-1.6,-16.4);const d=Si("DELIVERIES",{width:2.4,height:.55,bg:"#a8402f"});d.position.set(-5.5,2.15,-15.95),d.rotation.y=Math.PI,t.add(d);for(const M of[-6.5,-4.5]){const A=new st(new Ut(.12,2.1,.12),Se(qt.metalDark));A.position.set(M,1.05,-15.95),A.castShadow=!0,t.add(A)}const f=(M,A,E,b)=>{const{group:P,size:D,door:y}=G1(e);P.position.set(A,0,E),P.rotation.y=b,t.add(P);const w=Math.abs(Math.sin(b))>.5,U=(w?D.d:D.w)/2+.1,N=(w?D.w:D.d)/2+.1;n.push({min:new I(A-U,0,E-N),max:new I(A+U,D.h+1.2,E+N),walkable:!1});const W=new sr().setFromAxisAngle(new I(0,1,0),b),q=new I(0,0,D.d/2+1).applyQuaternion(W),H={x:A+q.x,z:E+q.z};of.push({hinge:y,rotY:b,at:H});const Z=new st(new Ut(1.1,.06,2.6),s()),F=new I(0,0,D.d/2+1.6).applyQuaternion(W);Z.position.set(A+F.x,-.02,E+F.z),Z.rotation.y=b,Z.receiveShadow=!0,t.add(Z);const ut=D.w/2+2.3,dt=-(D.d/2+2.4),at=D.d/2-.6,Ot=at-dt,Yt=(Q,z,ct,et)=>{const{group:_t}=V1(ct),ft=new I(Q,0,z).applyQuaternion(W);_t.position.set(A+ft.x,0,E+ft.z),_t.rotation.y=b+(et?0:Math.PI/2),t.add(_t);const St=Math.abs(Math.sin(_t.rotation.y))<.5;n.push({min:new I(A+ft.x-(St?ct/2:.08),0,E+ft.z-(St?.08:ct/2)),max:new I(A+ft.x+(St?ct/2:.08),1.15,E+ft.z+(St?.08:ct/2)),walkable:!1})};Yt(-ut,(at+dt)/2,Ot,!1),Yt(ut,(at+dt)/2,Ot,!1),Yt(0,dt,ut*2,!0),ls.push({name:M,x:A,z:E,rotY:b,door:H})};f("1 Barn Road",-34,le+8.5,Math.PI),f("2 Barn Road",-8,le+8.5,Math.PI),f("3 Barn Road",18,le+8.5,Math.PI),f("4 Barn Road",38,le+8.5,Math.PI),f("1 Millet Street",Ne-8.5,8,Math.PI/2),f("2 Millet Street",Ne-8.5,-18,Math.PI/2),f("1 Sunset Avenue",Oe+8.5,4,-Math.PI/2),f("2 Sunset Avenue",Oe+8.5,-22,-Math.PI/2),f("5 Barn Road",-70,le+8.5,Math.PI),f("6 Barn Road",64,le+8.5,Math.PI),f("3 Millet Street",Ne-8.5,54,Math.PI/2),f("4 Millet Street",Ne-8.5,-52,Math.PI/2),f("3 Sunset Avenue",Oe+8.5,52,-Math.PI/2),f("4 Sunset Avenue",Oe+8.5,-54,-Math.PI/2),f("1 Kookaburra Drive",-24,c-8.5,0),f("2 Kookaburra Drive",20,c-8.5,0),f("3 Kookaburra Drive",-30,a+8.5,Math.PI),f("4 Kookaburra Drive",26,a+8.5,Math.PI);const m=(M,A,E,b)=>{const P=new st(new Ut(Math.max(1.2,Math.abs(E-M)),.07,Math.max(1.2,Math.abs(b-A))),s());P.position.set((M+E)/2,-.036,(A+b)/2),P.receiveShadow=!0,t.add(P)};for(const M of[{w:Ne,e:Oe,n:Ue,f:le},{w:l,e:h,n:c,f:a}])for(const A of[Hs,-Hs])m(M.w-Math.abs(A),M.f+A-.6,M.e+Math.abs(A),M.f+A+.6),m(M.w-Math.abs(A),M.n-A-.6,M.e+Math.abs(A),M.n-A+.6),m(M.w+A-.6,M.n-Math.abs(A),M.w+A+.6,M.f+Math.abs(A)),m(M.e-A-.6,M.n-Math.abs(A),M.e-A+.6,M.f+Math.abs(A));const _=kd(),p=Bd(),g=Se(qt.metalDark),v=(M,A,E)=>{const b=new Xt,P=new st(new Ut(.16,4.6,.16),g);P.position.y=2.3,P.castShadow=!0,b.add(P);const D=new st(new Ut(.12,.12,1.3),g);D.position.set(0,4.5,.62),b.add(D);const y=new st(new Ut(.3,.14,.62),_);y.position.set(0,4.38,1.1),b.add(y);const w=new st(new ea(2.6,14),p);w.rotation.x=-Math.PI/2,w.position.set(0,.02,1.1),b.add(w),b.position.set(M,0,A),b.rotation.y=E,t.add(b)};for(const[M,A,E]of[[-1,le+4.2,Math.PI],[-30,le-4.2,0],[22,le-4.2,0],[-1,Ue-4.2,0],[-30,Ue+4.2,Math.PI],[22,Ue+4.2,Math.PI],[Ne+4.2,12,-Math.PI/2],[Ne-4.2,-14,Math.PI/2],[Oe-4.2,8,Math.PI/2],[Oe+4.2,-18,-Math.PI/2],[-42,le+4.2,Math.PI],[40,le+4.2,Math.PI],[-42,Ue-4.2,0],[40,Ue-4.2,0],[-1,a-4.2,0],[-1,c+4.2,Math.PI],[l+4.2,-1,-Math.PI/2],[h-4.2,-1,Math.PI/2]])v(M,A,E);const x=[[-30,le-8],[8,le-8.5],[30,le-8],[Ne+8,20],[Ne+8,-8],[Oe-8,16],[Oe-8,-14],[-24,Ue+8],[12,Ue+8],[-62,20],[-60,-24],[56,24],[58,-30],[-20,60],[30,58],[-16,-56],[26,-58]];for(const[M,A]of x){const E=qo(e,e.range(.9,1.4));E.position.set(M,0,A),t.add(E)}ly(i);for(const[M,A]of[[-120,40],[-135,-30],[125,60],[140,-20],[-60,120],[40,128],[-30,-125],[90,-120],[130,120],[-125,-115]]){const E=qo(e,e.range(1.1,1.7));E.position.set(M,i.groundHeight(M,A)-.06,A),t.add(E)}}class gy{constructor(t){this.game=t,this.rng=t.rng.child("world"),this.scene=t.renderer.scene,this.root=new Xt,this.scene.add(this.root),this.colliders=[],this.interactables=[],this.buildings=[],this.enterable=[],this.currentBuilding=null,this.spots={},this.doors=new B1(t),this._grid=new Map,this.cellSize=5,this.weather={condition:"clear",wetness:0,temp:24,wind:.3},this._nightState=!1}generate(){this._ground(),this._shop(),this._dressing(),my(this),ls.forEach((t,e)=>{this.addInteractable({id:`house_${e}`,label:"hand over the delivery",pos:new I(t.door.x,1,t.door.z),action:"service",data:{op:"deliver",house:e,when:"at_house"},radius:2.2})}),this._rebuildSpatialHash(),this.game.bus.emit("world:generated",{world:this})}_ground(){const t=new Ie(400,400,100,100),e=t.attributes.position;for(let s=0;s<e.count;s++)e.setZ(s,this.groundHeight(e.getX(s),-e.getY(s)));t.computeVertexNormals();const n=new st(t,Se(qt.grass));n.rotation.x=-Math.PI/2,n.position.y=-.06,n.receiveShadow=!0,this.root.add(n)}_shop(){var n;const t=cy(this.rng.child("shop"));this.report=t.report,t.group.position.set(0,0,0),this.root.add(t.group);for(const s of t.interactables||[])this.interactables.push(s);this.spots=t.spots||{};for(const s of t.colliders)this.colliders.push(s);(n=t.doorSpecs)!=null&&n.length&&(t.group.updateMatrixWorld(!0),this.doors.install(t.doorSpecs,t.group));const e={x:0,z:0,rotY:0,padY:0,shopId:"fastfood",built:t,lights:t.lights,interiorBounds:t.interiorBounds};this.buildings.push(e),this.enterable.push(e)}_dressing(){const t=this.rng.child("dressing"),e=[[-16.5,25],[-16.8,8],[-16.2,-2],[16.5,12],[16.8,-4],[15.8,24],[-6,32.5],[4,32.8],[12,32]];for(const[s,r]of e){const o=qo(t,t.range(.9,1.3));o.position.set(s,0,r),this.root.add(o)}const n=[{x:-9.7,z:24.8,rotY:0},{x:-2,z:24.8,rotY:0},{x:5.8,z:24.8,rotY:0},{x:5.3,z:13.2,rotY:Math.PI}];for(const s of n){const r=oa(t);r.position.set(s.x,0,s.z),r.rotation.y=s.rotY,this.root.add(r),this.colliders.push({min:new I(s.x-1,0,s.z-2.2),max:new I(s.x+1,1.5,s.z+2.2),walkable:!1})}}_rebuildSpatialHash(){this._grid.clear(),this.colliders.forEach((t,e)=>{const n=Math.floor(t.min.x/this.cellSize),s=Math.floor(t.max.x/this.cellSize),r=Math.floor(t.min.z/this.cellSize),o=Math.floor(t.max.z/this.cellSize);for(let a=n;a<=s;a++)for(let c=r;c<=o;c++){const l=a+","+c;this._grid.has(l)||this._grid.set(l,[]),this._grid.get(l).push(e)}})}query(t,e){const n=[],s=Math.floor((t.x-e)/this.cellSize),r=Math.floor((t.x+e)/this.cellSize),o=Math.floor((t.z-e)/this.cellSize),a=Math.floor((t.z+e)/this.cellSize),c=new Set;for(let l=s;l<=r;l++)for(let h=o;h<=a;h++){const u=this._grid.get(l+","+h);if(u)for(const d of u)c.has(d)||(c.add(d),n.push(this.colliders[d]))}return this.doors.collect(t,e,n),n}sightBlocked(t,e,{eye:n=1.15,backOff:s=.45}={}){const r=t.x,o=t.z,a=(t.y??0)+n;let c=e.x-r,l=e.z-o;const h=Math.hypot(c,l);if(h<.05)return!1;const u=Math.max(0,h-s);if(u<.05)return!1;c/=h,l/=h;const d=r+c*u/2,f=o+l*u/2;for(const m of this.query({x:d,z:f},u/2+1)){if(m.walkable||a<m.min.y||a>m.max.y||r>=m.min.x&&r<=m.max.x&&o>=m.min.z&&o<=m.max.z)continue;let _=0,p=u,g=!0;for(const[v,x,M,A]of[[r,c,m.min.x,m.max.x],[o,l,m.min.z,m.max.z]]){if(Math.abs(x)<1e-9){if(v<M||v>A){g=!1;break}continue}let E=(M-v)/x,b=(A-v)/x;if(E>b){const P=E;E=b,b=P}if(E>_&&(_=E),b<p&&(p=b),_>p){g=!1;break}}if(g)return!0}return!1}groundHeight(t,e){let n=0;const s=Math.hypot(t-72,e+14);s<13&&(n+=2.4*(.5+.5*Math.cos(Math.PI*s/13))**1.3);const r=Math.max(0,Math.abs(t)-100),o=Math.max(0,Math.abs(e)-92),a=Math.hypot(r,o);if(a>0){const c=Math.min(1,a/45),l=1.6+Math.sin(t*.041)*Math.cos(e*.053)+.6*Math.sin(t*.013+e*.017);n+=c*c*Math.max(0,l)*3.4}return n}addInteractable(t){return this.interactables.push(t),t}activeInteractables(){return this.interactables}get isIndoors(){return this.currentBuilding!==null}_updateOccupancy(){var n;const t=(n=this.game.player)==null?void 0:n.position;if(!t)return;let e=null;for(const s of this.enterable){const r=s.interiorBounds;if(r&&t.x>r.minX&&t.x<r.maxX&&t.z>r.minZ&&t.z<r.maxZ&&t.y>s.padY-1.5&&t.y<s.padY+r.maxY){e=s;break}}e!==this.currentBuilding&&(this.currentBuilding=e,this.game.bus.emit("world:occupancy",{building:e}))}update(t){var s;this._updateOccupancy(),this.doors.update(t);const e=this.game.clock;this.game.renderer.updateSky(e.dayFraction,(s=this.game.player)==null?void 0:s.position,e.dayOfYear,t);const n=this.game.renderer.nightFactor>.25;n!==this._nightState&&(this._nightState=n,ds().emissiveIntensity=n?.45:0,this.game.bus.emit("world:daynight",{night:n}))}}const _y=.72;class xy{constructor(t){this.game=t,this.target=null,this._label=null,this._fwd=new I(0,0,-1)}update(){var h,u,d,f,m,_;const t=this.game;if(t.mode!==$e.PLAY){this._setTarget(null);return}if(t.player.vehicle){this._setTarget({label:"get out",action:"vehicle_exit",pos:t.player.position}),t.input.wasPressed("interact")&&t.player.vehicle.dismount();return}const e=t.player.position,n=t.camera.active,s=n.position;n.getWorldDirection(this._fwd);const r=((h=t.shift)==null?void 0:h.station)||null;let o=null,a=1/0;const c=(p,g)=>{var U,N;const v=p.pos.x-e.x,x=p.pos.z-e.z,M=Math.hypot(v,x);if(M>=(p.radius||1.8))return;const A=p.pos.x-s.x,E=p.pos.y-s.y,b=p.pos.z-s.z,P=Math.hypot(A,E,b)||1,D=(A*this._fwd.x+E*this._fwd.y+b*this._fwd.z)/P,y=Math.acos(Math.min(1,Math.max(-1,D)));if(y>_y)return;const w=y+M*.1;w>=a||(N=(U=t.world).sightBlocked)!=null&&N.call(U,e,p.pos,g)||(a=w,o=p)};for(const p of t.world.activeInteractables()){const g=(u=p.data)==null?void 0:u.zone;g&&(g.minZ!==void 0&&e.z<g.minZ||g.maxZ!==void 0&&e.z>g.maxZ||g.minX!==void 0&&e.x<g.minX||g.maxX!==void 0&&e.x>g.maxX)||p.action==="station"&&r||(d=p.data)!=null&&d.podOnly&&r!=="pod"||(f=p.data)!=null&&f.when&&!((m=t.shift)!=null&&m.available(p.data.when,p.data))||c(p,void 0)}const l=(_=t.world.doors)==null?void 0:_.nearest(e,2);l&&!r&&c(l,{backOff:.7}),this._setTarget(o),t.input.wasPressed("interact")&&this.activate()}_setTarget(t){const e=t?t.label:null;this.target===t&&this._label===e||(this.target=t,this._label=e,this.game.bus.emit("interaction:target",{label:e,interactable:t}))}activate(){this.target&&this.run(this.target.action,this.target.data||{})}run(t,e){var s;const n=this.game;switch(t){case"door":{e.door.toggle()||n.ui.toast("You are standing in the doorway.");return}case"station":return void n.shift.lockIn(e.station);case"pod":return void n.shift.podPress(e);case"counter":return void n.shift.counterPress(e);case"service":return void n.shift.servicePress(e);case"vehicle":return void((s=n.deliveryCar)==null?void 0:s.mount());case"note":return void n.ui.toast(e.text);default:console.warn("[interaction] no handler for action:",t,e),n.ui.toast("Nothing happens.")}}}const de={ORDER_OFFERED:"order:offered",ORDER_STARTED:"order:started",ORDER_STEP:"order:step",ORDER_BUILT:"order:built",ORDER_WRAPPED:"order:wrapped",ORDER_READY:"order:ready",ORDER_BAGGED:"order:bagged",ORDER_TRAY:"order:tray",ORDER_SERVED:"order:served",ORDER_LOST:"order:lost",COUNTER_TAKEN:"counter:order_taken",COUNTER_PAID:"counter:paid",DT_TAKEN:"dt:order_taken",DT_BAGGED:"dt:bagged",DLV_BAGGED:"dlv:bagged",POD_REFUSED:"pod:refused"},ki={bun:{label:"toasted bun",station:"toaster",colour:13210159,shape:"heel"},ketchup:{label:"ketchup",station:"guns",colour:10236968,shape:"smear"},mustard:{label:"mustard",station:"guns",colour:13210159,shape:"smear"},mayo:{label:"mayo",station:"guns",colour:15261904,shape:"smear"},bbq:{label:"BBQ sauce",station:"guns",colour:5913126,shape:"smear"},pickle:{label:"pickles",station:"bins",colour:8030778,shape:"chips"},onion:{label:"onion",station:"bins",colour:15261904,shape:"chips"},lettuce:{label:"lettuce",station:"bins",colour:5208634,shape:"leaf"},tomato:{label:"tomato",station:"bins",colour:10236968,shape:"slice"},cheese:{label:"cheese",station:"bins",colour:13210159,shape:"flat"},patty:{label:"beef patty",station:"uhc",colour:7031349,shape:"disc"},fillet:{label:"chicken fillet",station:"uhc",colour:13216097,shape:"disc"}},Bi={classic:{label:"Barn Classic",value:7.5,sequence:["bun","ketchup","mustard","pickle","onion","patty"]},cheese:{label:"Cheese Barn",value:8,sequence:["bun","ketchup","pickle","cheese","patty"]},smokehouse:{label:"Smokehouse",value:9,sequence:["bun","bbq","onion","cheese","patty"]},garden_chook:{label:"Garden Chook",value:8.5,sequence:["bun","mayo","lettuce","tomato","fillet"]}},Ru=Object.keys(Bi),hl={double_patty:{label:"double beef",dupe:"patty",value:2.5},double_fillet:{label:"double chook",dupe:"fillet",value:2.5},extra_cheese:{label:"extra cheese",dupe:"cheese",value:1},extra_pickles:{label:"extra pickles",dupe:"pickle",value:.5},extra_onion:{label:"extra onion",dupe:"onion",value:.5},extra_sauce_bbq:{label:"extra BBQ",dupe:"bbq",value:.5}},vy=Object.keys(hl),je={intervalMin:7,intervalJitter:.35,maxLive:4,queueCapacity:3,secondItemChance:.25,sourceMix:{kiosk:.34,counter:.3,drivethru:.21},deliveryHouses:18,laneCapacity:3,modifierChance:.3,queuePatienceMin:12,dtOrderPatienceMin:10,servePatienceMin:26,dtServePatienceMin:22,deliveryDueMin:40,patienceJitter:.25,tipMax:.16,dineInChance:.45},Wi=[{skin:0,hair:0,height:1,build:1,hairStyle:"short",top:4877194,bottom:3884626},{skin:1,hair:2,height:.94,build:.92,hairStyle:"long",top:9067115,bottom:3027256},{skin:2,hair:4,height:1.05,build:1.12,hairStyle:"short",top:5929554,bottom:4866619},{skin:3,hair:1,height:.98,build:1,hairStyle:"bun",top:11569738,bottom:3884626},{skin:4,hair:6,height:1.02,build:.95,hairStyle:"short",top:7035530,bottom:3027256},{skin:5,hair:3,height:.9,build:.9,hairStyle:"long",top:9071434,bottom:5392702},{skin:1,hair:5,height:1.07,build:1.05,hairStyle:"short",top:4885123,bottom:3884626},{skin:3,hair:7,height:.96,build:1.08,hairStyle:"bun",top:10242626,bottom:3027256}];class yy{constructor({emit:t,rng:e,now:n=0}){this.emit=t,this.rng=e,this.now=n,this.orders=new Map,this._nextId=11,this._nextOfferAt=null,this.stats={offered:0,served:0,balked:0,bySource:{},takings:0,tips:0,lost:0,lostValue:0}}_fuse(t,e){return t+e*(1+this.rng.range(-.25,je.patienceJitter))}live(){return[...this.orders.values()].filter(t=>t.state!=="served"&&t.state!=="lost"&&t.state!=="queued"&&t.state!=="ordering"&&t.state!=="driveup").sort((t,e)=>t.id-e.id)}carQueue(){return[...this.orders.values()].filter(t=>t.state==="driveup").sort((t,e)=>t.id-e.id)}all(){return[...this.orders.values()].sort((t,e)=>t.id-e.id)}counterQueue(){return[...this.orders.values()].filter(t=>t.state==="queued").sort((t,e)=>t.id-e.id)}ordering(){return[...this.orders.values()].find(t=>t.state==="ordering")||null}active(){return this.live().find(t=>t.state==="active"||t.state==="building"||t.state==="built"||t.state==="wrapped")||null}ready(){return this.live().filter(t=>t.state==="ready")}readyFor(t){return this.ready().filter(e=>e.service===t&&e.source!=="drivethru")}bagged(){return this.live().filter(t=>t.state==="bagged")}carriedBy(t){return this.live().find(e=>e.state==="carried"&&e.carrier===t)||null}get(t){return this.orders.get(t)||null}offer(t){const e=this.rng.float(),n=je.sourceMix,s=e<n.kiosk?"kiosk":e<n.kiosk+n.counter?"counter":e<n.kiosk+n.counter+n.drivethru?"drivethru":"delivery";if(s==="counter"&&this.counterQueue().length>=je.queueCapacity)return this.stats.balked+=1,null;if(s==="drivethru"&&this.carQueue().length>=je.laneCapacity)return this.stats.balked+=1,null;if((s==="kiosk"||s==="delivery")&&this.live().length>=je.maxLive)return this.stats.balked+=1,null;const r=[this.rng.pick(Ru)];this.rng.chance(je.secondItemChance)&&r.push(this.rng.pick(Ru));const o=r.map(u=>{if(!this.rng.chance(je.modifierChance))return null;const d=vy.filter(f=>Bi[u].sequence.includes(hl[f].dupe));return d.length?this.rng.pick(d):null}),a=[],c=[];let l=0;r.forEach((u,d)=>{const f=[...Bi[u].sequence],m=o[d]?hl[o[d]]:null;if(m){const _=f.indexOf(m.dupe);f.splice(_+1,0,m.dupe)}a.push(...f),c.push(Bi[u].label+(m?` +${m.label}`:"")),l+=Bi[u].value+((m==null?void 0:m.value)??0)});const h={id:this._nextId++,source:s,items:r,mods:o,itemLabels:c,value:l,sequence:a,step:0,state:s==="counter"?"queued":s==="drivethru"?"driveup":"active",house:s==="delivery"?this.rng.int(0,je.deliveryHouses-1):null,look:this.rng.int(0,7),service:s==="drivethru"?"takeaway":this.rng.chance(je.dineInChance)?"dinein":"takeaway",carrier:null,offeredAt:t,takenAt:null,takenBy:null,servedBy:null,builtAt:null,wrappedAt:null,readyAt:null,baggedAt:null,carriedAt:null,servedAt:null,orderBy:null,serveBy:null,dueBy:null,lostAt:null,tip:0};return s==="counter"?h.orderBy=this._fuse(t,je.queuePatienceMin):s==="drivethru"?h.orderBy=this._fuse(t,je.dtOrderPatienceMin):s==="kiosk"?h.serveBy=this._fuse(t,je.servePatienceMin):h.dueBy=this._fuse(t,je.deliveryDueMin),this.orders.set(h.id,h),this.stats.offered+=1,this.stats.bySource[s]=(this.stats.bySource[s]||0)+1,this.emit(de.ORDER_OFFERED,{id:h.id,source:s,items:[...r],sequence:[...a]}),h}takeOrder(t,e="player"){if(this.ordering())return{ok:!1,reason:"already_taking"};const n=this.counterQueue()[0];return n?(n.state="ordering",n.takenBy=e,this.emit(de.COUNTER_TAKEN,{id:n.id,items:[...n.items],total:n.value,by:e}),{ok:!0,id:n.id}):{ok:!1,reason:"nothing_queued"}}takePayment(t,e="player"){const n=this.ordering();return n?(n.state="active",n.takenAt=t,n.orderBy=null,n.serveBy=this._fuse(t,je.servePatienceMin),this.emit(de.COUNTER_PAID,{id:n.id,total:n.value,by:e}),{ok:!0,id:n.id}):{ok:!1,reason:"nothing_to_pay"}}serve(t,e,n="player",s=["ready"]){return!t||!s.includes(t.state)?!1:(t.state="served",t.servedAt=e,t.servedBy=n,t.tip=this._tipFor(t,e),this.stats.served+=1,this.stats.takings=+(this.stats.takings+t.value).toFixed(2),this.stats.tips=+(this.stats.tips+t.tip).toFixed(2),this.emit(de.ORDER_SERVED,{id:t.id,ageMin:+(e-(t.takenAt??t.offeredAt)).toFixed(2),value:t.value,tip:t.tip}),!0)}_tipFor(t,e){let n;if(t.source==="delivery"){const s=t.dueBy-t.offeredAt||1;n=Math.max(0,Math.min(1,(t.dueBy-e)/(s*.5)))}else if(t.serveBy==null)n=1;else{const s=t.takenAt??t.offeredAt;n=Math.max(0,Math.min(1,(t.serveBy-e)/(t.serveBy-s||1)))}return+(t.value*je.tipMax*n).toFixed(2)}patienceFrac(t,e){const n=r=>Math.max(0,Math.min(1,r));if(!t||t.state==="served"||t.state==="lost"||t.state==="ordering")return null;if(t.source==="delivery")return{phase:"due",frac:n((t.dueBy-e)/(t.dueBy-t.offeredAt||1))};if(t.state==="queued"||t.state==="driveup")return{phase:"queue",frac:n((t.orderBy-e)/(t.orderBy-t.offeredAt||1))};if(t.serveBy==null)return null;const s=t.takenAt??t.offeredAt;return{phase:"serve",frac:n((t.serveBy-e)/(t.serveBy-s||1))}}_lose(t,e,n){t.state="lost",t.lostAt=e,t.carrier=null,this.stats.lost+=1,this.stats.lostValue=+(this.stats.lostValue+t.value).toFixed(2),this.emit(de.ORDER_LOST,{id:t.id,source:t.source,reason:n,value:t.value})}bagOrder(t,e="player"){const n=this.readyFor("takeaway")[0];return n?(n.state="bagged",n.baggedAt=t,this.emit(de.ORDER_BAGGED,{id:n.id,by:e}),{ok:!0,id:n.id}):{ok:!1,reason:"nothing_to_bag"}}collect(t,e,n="customer"){const s=this.orders.get(t);return!s||s.state!=="bagged"?{ok:!1,reason:"not_bagged"}:(this.serve(s,e,n,["bagged"]),{ok:!0,id:s.id})}trayUp(t,e="player"){if(this.carriedBy(e))return{ok:!1,reason:"already_carrying"};const n=this.readyFor("dinein")[0];return n?(n.state="carried",n.carrier=e,n.carriedAt=t,this.emit(de.ORDER_TRAY,{id:n.id,by:e}),{ok:!0,id:n.id}):{ok:!1,reason:"nothing_to_tray"}}deliver(t,e="player"){const n=this.carriedBy(e);return n?(this.serve(n,t,e,["carried"]),{ok:!0,id:n.id}):{ok:!1,reason:"not_carrying"}}dtTakeOrder(t,e="player"){const n=this.carQueue()[0];return n?(n.state="active",n.takenAt=t,n.takenBy=e,n.orderBy=null,n.serveBy=this._fuse(t,je.dtServePatienceMin),this.emit(de.DT_TAKEN,{id:n.id,items:[...n.items],total:n.value,by:e}),{ok:!0,id:n.id}):{ok:!1,reason:"no_car_waiting"}}dtBagUp(t,e="player"){if(this.carriedBy(e))return{ok:!1,reason:"already_carrying"};const n=this.ready().find(s=>s.source==="drivethru");return n?(n.state="carried",n.carrier=e,n.carriedAt=t,this.emit(de.DT_BAGGED,{id:n.id,by:e}),{ok:!0,id:n.id}):{ok:!1,reason:"nothing_for_the_window"}}dlvBagUp(t,e="player"){if(this.carriedBy(e))return{ok:!1,reason:"already_carrying"};const n=this.ready().find(s=>s.source==="delivery");return n?(n.state="carried",n.carrier=e,n.carriedAt=t,this.emit(de.DLV_BAGGED,{id:n.id,house:n.house,by:e}),{ok:!0,id:n.id}):{ok:!1,reason:"nothing_to_run"}}_interval(){const t=1+this.rng.range(-.35,je.intervalJitter);return je.intervalMin*t}tick(t){this.now=t,this._nextOfferAt===null&&(this._nextOfferAt=t+this._interval());let e=0;for(;t>=this._nextOfferAt&&e++<16;)this.offer(this._nextOfferAt),this._nextOfferAt+=this._interval();for(const n of this.orders.values())n.state==="served"||n.state==="lost"||n.source==="delivery"||((n.state==="queued"||n.state==="driveup")&&t>n.orderBy?this._lose(n,t,"gave_up_waiting"):n.serveBy!=null&&n.state!=="ordering"&&n.state!=="queued"&&n.state!=="driveup"&&t>n.serveBy&&this._lose(n,t,"too_slow"));for(const n of this.orders.values())n.state==="served"&&t-n.servedAt>10?this.orders.delete(n.id):n.state==="lost"&&t-n.lostAt>10&&this.orders.delete(n.id)}serialize(){return{nextId:this._nextId,nextOfferAt:this._nextOfferAt,stats:{...this.stats,bySource:{...this.stats.bySource}},orders:[...this.orders.values()]}}load(t){var e;t&&(this._nextId=t.nextId,this._nextOfferAt=t.nextOfferAt??null,this.stats={...t.stats,bySource:{...((e=t.stats)==null?void 0:e.bySource)||{}}},this.orders=new Map(t.orders.map(n=>[n.id,{...n}])))}}const Qe={NO_ORDER:"no_order",NOT_NEXT:"not_next",NOT_AT_UHC:"not_at_uhc",ALREADY_BUILT:"already_built",NOT_BUILT:"not_built",NOT_WRAPPED:"not_wrapped"};class My{constructor({queue:t,emit:e}){this.queue=t,this.emit=e}nextToken(){const t=this.queue.active();return!t||t.step>=t.sequence.length?null:t.sequence[t.step]}_refuse(t,e=null){return this.emit(de.POD_REFUSED,{reason:t,token:e,next:this.nextToken()}),{ok:!1,reason:t}}addToken(t,e,n="player"){const s=this.queue.active();if(!s)return this._refuse(Qe.NO_ORDER,t);if(s.state==="built"||s.state==="wrapped")return this._refuse(Qe.ALREADY_BUILT,t);const r=s.sequence[s.step];return t!==r?this._refuse(Qe.NOT_NEXT,t):(s.step+=1,s.state==="active"&&(s.state="building",this.emit(de.ORDER_STARTED,{id:s.id})),this.emit(de.ORDER_STEP,{id:s.id,added:t,next:s.sequence[s.step]??null,step:s.step}),s.step>=s.sequence.length&&(s.state="built",s.builtAt=e,this.emit(de.ORDER_BUILT,{id:s.id})),{ok:!0,added:t})}pullFromUHC(t,e="player"){var s;const n=this.nextToken();if(n===null){const r=this.queue.active();return this._refuse(r?Qe.ALREADY_BUILT:Qe.NO_ORDER)}return((s=ki[n])==null?void 0:s.station)!=="uhc"?this._refuse(Qe.NOT_AT_UHC):this.addToken(n,t,e)}wrap(t,e="player"){const n=this.queue.active();return n?n.state!=="built"?this._refuse(n.state==="wrapped"?Qe.ALREADY_BUILT:Qe.NOT_BUILT):(n.state="wrapped",n.wrappedAt=t,this.emit(de.ORDER_WRAPPED,{id:n.id}),{ok:!0}):this._refuse(Qe.NO_ORDER)}send(t,e="player"){const n=this.queue.active();return n?n.state!=="wrapped"?this._refuse(Qe.NOT_WRAPPED):(n.state="ready",n.readyAt=t,this.emit(de.ORDER_READY,{id:n.id}),{ok:!0}):this._refuse(Qe.NO_ORDER)}}const Gs=class Gs{constructor({rng:t,bus:e=null}){this.bus=e,this.minute=0,this.log=[],this.logSeq=0,this.rev=0,this.netRole="solo";const n=(s,r)=>this._emit(s,r);this.orders=new yy({emit:n,rng:t.child("orders")}),this.pod=new My({queue:this.orders,emit:n})}_emit(t,e={}){this.logSeq+=1,this.rev+=1,this.log.push({type:t,payload:e,minute:+this.minute.toFixed(3),seq:this.logSeq}),this.log.length>600&&this.log.shift(),this.bus&&this.bus.emit(t,e)}tick(t){this.netRole!=="guest"&&(t<=0||(this.minute+=t,this.orders.tick(this.minute)))}addToken(t,e="player"){return this.pod.addToken(t,this.minute,e)}pullFromUHC(t="player"){return this.pod.pullFromUHC(this.minute,t)}wrap(t="player"){return this.pod.wrap(this.minute,t)}send(t="player"){return this.pod.send(this.minute,t)}takeOrder(t="player"){return this.orders.takeOrder(this.minute,t)}takePayment(t="player"){return this.orders.takePayment(this.minute,t)}bagOrder(t="player"){return this.orders.bagOrder(this.minute,t)}trayUp(t="player"){return this.orders.trayUp(this.minute,t)}deliver(t="player"){return this.orders.deliver(this.minute,t)}collect(t,e="customer"){return this.orders.collect(t,this.minute,e)}dtTakeOrder(t="player"){return this.orders.dtTakeOrder(this.minute,t)}dtBagUp(t="player"){return this.orders.dtBagUp(this.minute,t)}dlvBagUp(t="player"){return this.orders.dlvBagUp(this.minute,t)}abandonActor(t){for(const e of this.orders.orders.values())e.state==="carried"&&e.carrier===t&&(e.state="ready",e.carrier=null,e.carriedAt=null,this._emit("order:dropped",{id:e.id,by:t}))}applyNet(t,e=[],n="guest"){if(!Object.hasOwn(Gs.NET_COMMANDS,t))return{ok:!1,reason:"unknown_command"};const s=Gs.NET_COMMANDS[t];return!Array.isArray(e)||e.length<s.n?{ok:!1,reason:"bad_args"}:Gs.prototype[s.m].apply(this,[...e.slice(0,s.n),n])}snapshot(){var t;return{minute:this.minute,board:this.orders.live(),queue:this.orders.counterQueue(),ordering:this.orders.ordering(),activeId:((t=this.orders.active())==null?void 0:t.id)??null,nextToken:this.pod.nextToken(),readyCount:this.orders.ready().length,stats:{...this.orders.stats}}}serialize(){return{minute:this.minute,orders:this.orders.serialize()}}load(t){t&&(this.minute=t.minute||0,this.orders.load(t.orders))}};$l(Gs,"NET_COMMANDS",{token:{m:"addToken",n:1},uhc:{m:"pullFromUHC",n:0},wrap:{m:"wrap",n:0},send:{m:"send",n:0},take_order:{m:"takeOrder",n:0},take_payment:{m:"takePayment",n:0},bag:{m:"bagOrder",n:0},tray:{m:"trayUp",n:0},deliver:{m:"deliver",n:0},collect:{m:"collect",n:1},dt_take:{m:"dtTakeOrder",n:0},dt_bag:{m:"dtBagUp",n:0},dlv_bag:{m:"dlvBagUp",n:0}});let ul=Gs;const Ds=560,Cu=340,tc=68,ec=4,Pu="#f1ece1",yo="#9aa3ad",Mo="#c9a961",So="#0d1116",Sy="#141a21",wy="#1d2733",nc="#7fb069",Ey="#cf5b45";class by{constructor(t,e,n,s){this.scene=t,this.canvas=typeof document<"u"?document.createElement("canvas"):null,this.canvas&&(this.canvas.width=Ds,this.canvas.height=Cu,this.ctx=this.canvas.getContext("2d"),this.tex=new Yn(this.canvas),this.tex.colorSpace=He,this.tex.anisotropy=4,this.mesh=new st(new Ie(s.w,s.h),new en({map:this.tex})),this.mesh.position.set(e.x,e.y,e.z),this.mesh.rotation.x=n,t.add(this.mesh),this._sig=null,this.paint([],null,null,{},{},0))}paint(t,e,n,s,r,o){if(!this.ctx)return;const a=t.slice(0,ec),c=u=>u.takenAt??u.offeredAt,l=`${e}|${n}|`+a.map(u=>`${u.id}:${u.state}:${u.step}:${u.source}:${Math.floor(o-c(u))}`).join(",");if(l===this._sig)return;this._sig=l;const h=this.ctx;if(h.fillStyle=So,h.fillRect(0,0,Ds,Cu),h.fillStyle=Mo,h.font="bold 32px Segoe UI, system-ui, sans-serif",h.fillText("ORDERS",16,36),t.length>ec&&(h.fillStyle=yo,h.font="22px Segoe UI, system-ui, sans-serif",h.textAlign="right",h.fillText(`+${t.length-ec} more`,Ds-16,34),h.textAlign="left"),!a.length){h.fillStyle=yo,h.font="28px Segoe UI, system-ui, sans-serif",h.fillText("Nothing on.",16,100),this.tex.needsUpdate=!0;return}a.forEach((u,d)=>{var M;const f=48+d*tc,m=u.id===e;h.fillStyle=m?wy:Sy,h.fillRect(10,f,Ds-20,tc-8),m&&(h.fillStyle=Mo,h.fillRect(10,f,6,tc-8)),h.fillStyle=m?Pu:yo,h.font="bold 31px Segoe UI, system-ui, sans-serif",h.fillText(`#${u.id}`,22,f+30);let _=92;u.source==="drivethru"?(h.fillStyle=Ey,h.fillRect(_,f+8,50,26),h.fillStyle=So,h.font="bold 20px Segoe UI, system-ui, sans-serif",h.fillText("DT",_+12,f+28),_+=60):u.source==="delivery"?(h.fillStyle="#4a7dc9",h.fillRect(_,f+8,52,26),h.fillStyle=So,h.font="bold 20px Segoe UI, system-ui, sans-serif",h.fillText("DLV",_+8,f+28),_+=62):u.service==="dinein"&&(h.fillStyle=nc,h.fillRect(_,f+8,62,26),h.fillStyle=So,h.font="bold 20px Segoe UI, system-ui, sans-serif",h.fillText("DINE",_+8,f+28),_+=72),h.fillStyle=m?Pu:yo,h.font="25px Segoe UI, system-ui, sans-serif";const p=(u.itemLabels||(u.items||[]).map(A=>{var E;return((E=r[A])==null?void 0:E.label)||A})).join(", ");if(h.fillText(p.slice(0,u.source==="drivethru"?24:28),_,f+30),h.font="23px Segoe UI, system-ui, sans-serif",m){h.fillStyle=nc;const A=u.state==="built"?"wrap it":u.state==="wrapped"?"send it down":n?`next: ${((M=s[n])==null?void 0:M.label)||n}`:"…";h.fillText(A,92,f+57)}else{h.fillStyle=u.state==="ready"||u.state==="bagged"||u.state==="carried"?Mo:"#5d6570";const A=Math.floor(o-c(u));h.fillText(u.state==="ready"?"at the landing":u.state==="bagged"?"on the counter":u.state==="carried"?u.source==="drivethru"?"going to the window":u.source==="delivery"?"out for delivery":"going to the table":A<1?"just in":`waiting ${A}m`,92,f+57)}const g=(u.sequence||[]).length||1,v=u.state==="ready"||u.state==="wrapped"||u.state==="built"||u.state==="bagged"||u.state==="carried",x=v?1:Math.min(1,(u.step||0)/g);h.fillStyle="#2a333d",h.fillRect(Ds-104,f+20,84,10),h.fillStyle=v&&u.state!=="built"?Mo:nc,h.fillRect(Ds-104,f+20,84*x,10)}),this.tex.needsUpdate=!0}dispose(){this.mesh&&(this.scene.remove(this.mesh),this.mesh.geometry.dispose(),this.mesh.material.map.dispose(),this.mesh.material.dispose(),this.mesh=null)}}const dl="#f1ece1",$o="#9aa3ad",Oo="#c9a961",af="#0d1116",ic="#7fb069";function cf(i,t,e,n,s){const r=document.createElement("canvas");r.width=n,r.height=s;const o=new Yn(r);o.colorSpace=He,o.anisotropy=4;const a=new st(new Ie(e.w,e.h),new en({map:o}));return a.position.set(t.x,t.y,t.z),a.rotation.y=t.rotY||0,i.add(a),{canvas:r,tex:o,mesh:a,ctx:r.getContext("2d")}}class Ty{constructor(t,e){typeof document>"u"||(this.face=cf(t,e,{w:e.w,h:e.h},320,235),this._sig=null)}paint(t,e,n,s,r,o=null){if(!this.face)return;const a=n&&s-n.atMin<2,c=t?`t${t.id}:${(t.itemLabels||t.items).join("+")}`:a?`p${n.id}`:`q${e}:${o?`${o.takings}:${o.tips}:${o.lostValue}`:""}`;if(c===this._sig)return;this._sig=c;const l=this.face.ctx,h=320,u=235;if(l.fillStyle=af,l.fillRect(0,0,h,u),l.fillStyle=Oo,l.font="bold 26px Segoe UI, system-ui, sans-serif",l.fillText("TILL",14,32),t){l.fillStyle=dl,l.font="bold 28px Segoe UI, system-ui, sans-serif",l.fillText(`#${t.id}`,240,32),l.font="24px Segoe UI, system-ui, sans-serif";let d=70;t.items.forEach((f,m)=>{var p;const _=r[f];l.fillStyle=dl,l.fillText((((p=t.itemLabels)==null?void 0:p[m])||(_==null?void 0:_.label)||f).slice(0,24),14,d),d+=34}),l.strokeStyle="#2a333d",l.beginPath(),l.moveTo(14,d-12),l.lineTo(h-14,d-12),l.stroke(),l.fillStyle=Oo,l.font="bold 28px Segoe UI, system-ui, sans-serif",l.fillText("TOTAL",14,d+18),l.textAlign="right",l.fillText(`$${t.value.toFixed(2)}`,h-14,d+18),l.textAlign="left",l.fillStyle=ic,l.font="24px Segoe UI, system-ui, sans-serif",l.fillText("take payment",14,u-14)}else a?(l.fillStyle=ic,l.font="bold 42px Segoe UI, system-ui, sans-serif",l.fillText("PAID",14,104),l.fillText(`$${n.total.toFixed(2)}`,14,140),l.fillStyle=$o,l.font="24px Segoe UI, system-ui, sans-serif",l.fillText(`#${n.id} to the kitchen`,14,184)):(l.fillStyle=$o,l.font="28px Segoe UI, system-ui, sans-serif",l.fillText(e===0?"No one waiting.":e===1?"1 in line.":`${e} in line.`,14,100),o&&(l.fillStyle=ic,l.font="bold 26px Segoe UI, system-ui, sans-serif",l.fillText(`Takings $${o.takings.toFixed(2)}`,14,152),l.fillStyle=Oo,l.fillText(`Tips $${o.tips.toFixed(2)}`,14,184),o.lostValue>0&&(l.fillStyle="#c0605a",l.fillText(`Walked $${o.lostValue.toFixed(2)}`,14,216))));this.face.tex.needsUpdate=!0}}class Ay{constructor(t,e){typeof document>"u"||(this.face=cf(t,e,{w:e.w,h:e.h},500,275),this._sig=null)}paint(t){if(!this.face)return;const e=t.filter(h=>h.source!=="drivethru"&&h.source!=="delivery"),n=e.filter(h=>h.state!=="bagged"&&h.state!=="carried").map(h=>h.id),s=e.filter(h=>h.state==="bagged").map(h=>h.id),r=n.join(",")+"|"+s.join(",");if(r===this._sig)return;this._sig=r;const o=this.face.ctx,a=500,c=275;o.fillStyle=af,o.fillRect(0,0,a,c),o.strokeStyle="#2a333d",o.beginPath(),o.moveTo(a/2,12),o.lineTo(a/2,c-12),o.stroke(),o.font="bold 30px Segoe UI, system-ui, sans-serif",o.fillStyle=$o,o.fillText("PREPARING",24,38),o.fillStyle=Oo,o.fillText("READY",a/2+24,38),o.font="bold 58px Segoe UI, system-ui, sans-serif";const l=(h,u,d)=>{o.fillStyle=d,h.slice(0,6).forEach((f,m)=>{o.fillText(`${f}`,u+m%2*118,104+Math.floor(m/2)*72)})};l(n,34,$o),l(s,a/2+34,dl),this.face.tex.needsUpdate=!0}}const Ry=2.6,Cy=4;class Py{constructor(t){var n;this.game=t,this.rules=new ul({rng:t.rng.child("shift"),bus:t.bus}),this.station=null;const e=t.renderer.scene;this.screen=new by(e,fo,fo.tilt,{w:fo.w,h:fo.h}),this.till=new Ty(e,{x:xu.x,...xu.screen}),this.readyBoard=new Ay(e,q1),this._lastPaid=null,t.bus.on(de.COUNTER_PAID,({id:s,total:r})=>{this._lastPaid={id:s,total:r,atMin:this.rules.minute}}),this._buildLandingPool(e),this._buildBagPool(e),this._wireToasts();for(const s of t.world.activeInteractables()){const r=(n=s.data)==null?void 0:n.token;r&&!ki[r]&&console.error("ShiftSystem: interactable",s.id,"dispenses a token the menu does not know:",r)}}available(t,e={}){var s,r,o,a,c;const n=this.rules.orders;switch(t){case"dt_order":{const l=n.carQueue()[0];return!!l&&(((s=this.game.cars)==null?void 0:s.atOrderWindow(l.id))??!1)}case"dt_bag_ready":return!this.game.player.isBusy&&!n.carriedBy("player")&&n.ready().some(l=>l.source==="drivethru");case"window_handout":{const l=n.carriedBy("player");return!!l&&l.source==="drivethru"&&(((r=this.game.cars)==null?void 0:r.atPickup(l.id))??!1)}case"dlv_bag_ready":return!this.game.player.isBusy&&!n.carriedBy("player")&&n.ready().some(l=>l.source==="delivery");case"at_house":{const l=n.carriedBy("player");return!!l&&l.source==="delivery"&&l.house===e.house}case"queue_head":{if(this.station!=="counter"||n.ordering())return!1;const l=n.counterQueue()[0];return!!l&&(((o=this.game.customers)==null?void 0:o.atTill(l.id))??!0)}case"payment_due":return this.station==="counter"&&!!n.ordering();case"bag_ready":return n.readyFor("takeaway").length>0;case"tray_ready":{if(this.game.player.isBusy||n.carriedBy("player"))return!1;const l=n.readyFor("dinein")[0];return!!l&&((a=this.game.customers)==null?void 0:a.seatedTable(l.id))!=null}case"carrying_for":{const l=n.carriedBy("player");return!!l&&((c=this.game.customers)==null?void 0:c.tableOf(l.id))===e.table}default:return!1}}servicePress(t){var n,s,r;const e=this.game.ui;if(t.op==="tray"){const o=this.rules.trayUp();if(o.ok){const a=(n=this.game.customers)==null?void 0:n.tableOf(o.id);e.toast(`#${o.id} on the tray — table ${a??"?"}.`,4200)}else e.toast("Nothing ready for a tray.")}else if(t.op==="bag"){const o=this.rules.bagOrder();o.ok?e.toast(`#${o.id} bagged — their number is up.`):e.toast("Nothing ready to bag.")}else if(t.op==="dt_take"){const o=this.rules.dtTakeOrder();o.ok?e.toast(`#${o.id} — drive-thru order on the board.`):e.toast("No car at the window.")}else if(t.op==="dt_bag"){const o=this.rules.dtBagUp();o.ok?e.toast(`#${o.id} in the bag — pickup window.`,4200):e.toast("Nothing for the window.")}else if(t.op==="dlv_bag"){const o=this.rules.dlvBagUp();if(o.ok){const a=((r=ls[(s=this.rules.orders.get(o.id))==null?void 0:s.house])==null?void 0:r.name)??"the address";e.toast(`#${o.id} for ${a} — the van's at the goods door.`,5200)}else e.toast("No deliveries waiting.")}else t.op==="deliver"&&(this.rules.deliver().ok||e.toast("You are not carrying anything."))}lockIn(t){var n,s;const e=(n=this.game.room)==null?void 0:n.heldByAnother(`station_${t}`);if(e){this.game.ui.toast(`${this.game.room.nameOf(e.by)} is on that station.`,2600);return}if(t==="pod")this._lockPod();else if(t==="counter")this._lockCounter();else{this.game.ui.toast("Nothing to work there yet.");return}this.station===t&&((s=this.game.room)==null||s.take(`station_${t}`))}_lockPod(){const t=this.game.player;t.position.z<Hn.z-.75||(this.station="pod",t.setState("busy"),t.position.x=mn.clamp(t.position.x,Hn.x0,Hn.x1),t.position.z=Hn.z,t.position.y=0,t.velocity.set(0,0,0),t.facing=Hn.facing,this.game.camera.yaw=Hn.facing,this.game.ui.toast("On the pod. A/D to slide along, S to step off.",5200),this.game.bus.emit("shift:station",{station:"pod"}))}_lockCounter(){const t=this.game.player;t.position.z>Qi.z+.75||(this.station="counter",t.setState("busy"),t.position.x=Qi.x,t.position.z=Qi.z,t.position.y=0,t.velocity.set(0,0,0),t.facing=Qi.facing,this.game.camera.yaw=Qi.facing,this.game.ui.toast("On the till. S to step off.",5200),this.game.bus.emit("shift:station",{station:"counter"}))}release(){var t;this.station&&((t=this.game.room)==null||t.release(`station_${this.station}`),this.station=null,this.game.player.setState("normal"),this.game.bus.emit("shift:station",{station:null}))}podPress(t){this.station==="pod"&&(t.op==="uhc"?this.rules.pullFromUHC():t.op==="wrap"?this.rules.wrap():t.op==="send"?this.rules.send():this.rules.addToken(t.token))}counterPress(t){if(this.station!=="counter")return;(t.op==="take_payment"?this.rules.takePayment():this.rules.takeOrder()).ok||this.game.ui.toast("Not right now.")}update(t){var c,l,h,u;const e=this.game;e.mode===$e.PLAY&&(this.rules.tick(t*e.clock.scale),this.station==="pod"?this._slide(t):this.station==="counter"&&this._pin(t),this.station&&this.game.room&&(!this._claimAt||Date.now()-this._claimAt>8e3)&&(this._claimAt=Date.now(),this.game.room.take(`station_${this.station}`)));const n=this.rules.orders,s=n.live();(l=this.screen)==null||l.paint(s,((c=n.active())==null?void 0:c.id)??null,this.rules.pod.nextToken(),ki,Bi,this.rules.minute),(h=this.till)==null||h.paint(n.ordering(),n.counterQueue().length,this._lastPaid,this.rules.minute,Bi,{takings:n.stats.takings||0,tips:n.stats.tips||0,lostValue:n.stats.lostValue||0}),(u=this.readyBoard)==null||u.paint(s),this._syncLanding(),this._syncBags();const r=n.carriedBy("player"),o=r&&r.source!=="kiosk"&&r.source!=="counter"?r.source:null,a=!!this.game.player.vehicle;this.game.player.avatar.setHeld(r&&!a?[{id:(o?"bag":"tray")+r.id,shape:o?"bag":"tray",colour:o?14272934:11026479}]:[]),this._syncReceipt(r&&!a?r:null)}_syncReceipt(t){var r,o,a,c;if(!t){(r=this._receipt)!=null&&r.mesh.parent&&this._receipt.mesh.parent.remove(this._receipt.mesh);return}if(!this._receipt){const l=document.createElement("canvas");l.width=80,l.height=64;const h=new Yn(l);h.colorSpace=He;const u=new st(new Ie(.085,.068),new en({map:h,transparent:!0,side:Vn}));u.position.set(-.1,.05,-.06),u.rotation.y=Math.PI,u.rotation.x=.28,this._receipt={canvas:l,tex:h,mesh:u,sig:null}}const e=(o=this.game.customers)==null?void 0:o.tableOf(t.id),n=`${t.id}:${e}`;if(n!==this._receipt.sig){this._receipt.sig=n;const l=this._receipt.canvas.getContext("2d");l.clearRect(0,0,80,64),l.fillStyle="#f4efe4",l.fillRect(2,2,76,60),l.fillStyle="#20262e",l.textAlign="center",l.font="bold 26px Segoe UI, system-ui, sans-serif",l.fillText("#"+t.id,40,28),l.font="bold 20px Segoe UI, system-ui, sans-serif";const h=t.source==="drivethru"?"WINDOW":t.source==="delivery"?(((a=ls[t.house])==null?void 0:a.name)??"DELIVERY").toUpperCase().slice(0,14):e!=null?"TABLE "+e:"";l.font=t.source==="delivery"?"bold 13px Segoe UI, system-ui, sans-serif":"bold 20px Segoe UI, system-ui, sans-serif",l.fillText(h,40,52),this._receipt.tex.needsUpdate=!0}const s=(c=this.game.player.avatar._held)==null?void 0:c[0];s&&this._receipt.mesh.parent!==s&&s.add(this._receipt.mesh)}_buildBagPool(t){this._bags=[];const e=new yi({color:14272934}),n=new yi({color:11026479});for(let s=0;s<3;s++){const r=new Xt,o=new st(new Ut(.16,.21,.1),e);o.castShadow=!0;const a=new st(new Ut(.165,.035,.05),e);a.position.y=.12;const c=new st(new Ut(.162,.03,.102),n);c.position.y=.02,r.add(o,a,c),r.position.set(-5.85+s*.65,1.075+.105,1.95),r.rotation.y=(s%2?-1:1)*.18,r.visible=!1,t.add(r),this._bags.push(r)}}_syncBags(){const t=this.rules.orders.bagged();for(let e=0;e<this._bags.length;e++)this._bags[e].visible=e<t.length}_pin(){const t=this.game.player;t.position.x=Qi.x,t.position.z=Qi.z,t.position.y=0,this.game.input.axis().y<-.5&&this.release()}_slide(t){const e=this.game.player;e.position.x=mn.clamp(e.position.x,Hn.x0,Hn.x1),e.position.z=Hn.z,e.position.y=0;const s=this.game.input.axis();if(s.y<-.5){this.release();return}if(s.x!==0){const r=this.game.camera.basis().right,o=Math.sign(r.x)||1;e.position.x=mn.clamp(e.position.x+s.x*o*Ry*t,Hn.x0,Hn.x1)}}_buildLandingPool(t){this._landing=[];const e=new yi({color:15262418}),n=new yi({color:11026479}),s=new Ut(.115,.055,.115),r=new Ut(.118,.016,.05);for(let o=0;o<Cy;o++){const a=new Xt,c=new st(s,e);c.castShadow=!0;const l=new st(r,n);l.position.y=.02,a.add(c,l);const h=document.createElement("canvas");h.width=64,h.height=32;const u=new Yn(h);u.colorSpace=He;const d=new st(new Ie(.075,.0375),new en({map:u,transparent:!0}));d.rotation.x=-Math.PI/2+.35,d.position.set(0,.032,.035),a.add(d);const f=Ys.x0+.22+o*.42;a.position.set(f,Ys.y+.03,Ys.z),a.rotation.y=(o%2?-1:1)*.22,a.visible=!1,t.add(a),this._landing.push({g:a,canvas:h,tex:u,shownId:null})}}_stencil(t,e){if(t.shownId===e)return;t.shownId=e;const n=t.canvas.getContext("2d");n.clearRect(0,0,64,32),n.fillStyle="#3a3126",n.font="bold 24px Segoe UI, system-ui, sans-serif",n.textAlign="center",n.textBaseline="middle",n.fillText("#"+e,32,17),t.tex.needsUpdate=!0}_syncLanding(){var n;const t=this.rules.orders.ready(),e=((n=this.game.buildBoard)==null?void 0:n.slidingId)??null;for(let s=0;s<this._landing.length;s++){const r=this._landing[s],o=t[s];r.g.visible=!!o&&o.id!==e,o&&this._stencil(r,o.id)}}_wireToasts(){const t=this.game.bus,e={toast:s=>{var r;return(r=this.game.ui)==null?void 0:r.toast(s)}},n=s=>{const r=ki[s];return r?r.station==="toaster"||r.station==="uhc"?"a "+r.label:r.label:s};t.on(de.POD_REFUSED,({reason:s,next:r})=>{switch(s){case Qe.NO_ORDER:return e.toast("Nothing on the board.");case Qe.NOT_NEXT:case Qe.NOT_AT_UHC:return e.toast(`It wants ${n(r)} next.`);case Qe.ALREADY_BUILT:return e.toast("It has everything it needs.");case Qe.NOT_BUILT:return e.toast("It is not built yet.");case Qe.NOT_WRAPPED:return e.toast("Wrap it before it goes down.");default:return e.toast("Not now.")}}),t.on(de.ORDER_SERVED,({id:s,value:r,tip:o})=>{const a=r!=null?` $${r.toFixed(2)}${o>0?` +$${o.toFixed(2)} tip`:""}`:"";e.toast(`#${s} away.${a}`)}),t.on(de.ORDER_LOST,({id:s,value:r,reason:o})=>{e.toast(o==="gave_up_waiting"?`#${s} gave up waiting — $${r.toFixed(2)} walked out.`:`#${s} walked out — $${r.toFixed(2)} lost.`),this.game.audio.play("wrong_item",{at:{x:0,y:1.4,z:2},rate:.7})})}}const sc={};function ge(i,t){return sc[i]||(sc[i]=t())}const _e=(i,t={})=>new yi({color:i,...t});function Ly(i){const t=new Xt,e=new st(ge("cup",()=>new Ve(.043,.032,.135,10)),_e(i));e.castShadow=!0;const n=new st(ge("cupLid",()=>new Ve(.047,.047,.016,10)),_e(14173231));n.position.y=.075;const s=new st(ge("straw",()=>new Ve(.005,.005,.1,5)),_e(15790836));return s.position.set(.012,.13,0),s.rotation.z=.18,t.add(e,n,s),t}function Iy(i){const t=new st(ge("bun",()=>new Vi(.056,10,6,0,Math.PI*2,0,Math.PI/2)),_e(i));return t.scale.y=.62,t.castShadow=!0,t}function Dy(i){const t=new st(ge("heel",()=>new Ve(.054,.05,.02,12)),_e(i));return t.castShadow=!0,t}function Uy(i){const t=new st(ge("chip",()=>new Ve(.021,.021,.008,8)),_e(i));return t.castShadow=!0,t}function Ny(i){const t=new st(ge("disc",()=>new Ve(.052,.052,.018,12)),_e(i));return t.castShadow=!0,t}function Oy(i){const t=new st(ge("flat",()=>new Ut(.082,.006,.082)),_e(i));return t.castShadow=!0,t}function zy(i){const t=new st(ge("blob",()=>new sa(.036,0)),_e(i));return t.castShadow=!0,t}function Fy(i){const t=new Xt,e=new st(ge("bottle",()=>new Ve(.024,.028,.105,8)),_e(i));e.castShadow=!0;const n=new st(ge("bottleCap",()=>new na(.017,.036,8)),_e(2896184));return n.position.y=.068,t.add(e,n),t}function ky(i){const t=new Xt,e=new st(ge("carton",()=>new Ve(.04,.026,.09,4)),_e(14173231));e.rotation.y=Math.PI/4,e.castShadow=!0;const n=new st(ge("chipTop",()=>new Ve(.03,.03,.05,6)),_e(i));return n.position.y=.055,t.add(e,n),t}function By(i){const t=new Xt,e=new st(ge("bag",()=>new Ut(.1,.135,.062)),_e(i));e.castShadow=!0;const n=new st(ge("bagFold",()=>new Ut(.104,.022,.03)),_e(i));return n.position.y=.076,t.add(e,n),t}function Hy(i){const t=new Xt,e=new st(ge("box",()=>new Ut(.125,.075,.105)),_e(i));e.castShadow=!0;const n=new st(ge("boxTape",()=>new Ut(.128,.004,.022)),_e(15262418));return n.position.y=.039,t.add(e,n),t}function Gy(i){const t=new Xt,e=new st(ge("trayBase",()=>new Ut(.34,.014,.25)),_e(i));e.castShadow=!0;const n=new st(ge("trayRim",()=>new Ut(.36,.022,.27)),_e(i));n.position.y=.004;const s=new st(ge("trayParcel",()=>new Ut(.115,.055,.115)),_e(15262418));s.position.set(.04,.045,.01),s.rotation.y=.3,s.castShadow=!0;const r=new st(ge("trayBand",()=>new Ut(.118,.016,.05)),_e(11026479));return r.position.set(.04,.062,.01),r.rotation.y=.3,t.add(e,n,s,r),t}function Vy(i){const t=new Xt,e=new st(ge("shaft",()=>new Ve(.016,.016,1.15,6)),_e(i));e.castShadow=!0;const n=new st(ge("mopHead",()=>new Ut(.115,.1,.055)),_e(14341056));return n.position.y=-.6,t.add(e,n),t}function Wy(i){const t=new Xt,e=new st(ge("sprayBody",()=>new Ut(.055,.115,.045)),_e(i));e.castShadow=!0;const n=new st(ge("sprayNeck",()=>new Ut(.028,.05,.028)),_e(2896184));n.position.y=.082;const s=new st(ge("sprayTrigger",()=>new Ut(.05,.022,.022)),_e(2896184));s.position.set(.032,.068,0);const r=new st(ge("cloth",()=>new Ut(.075,.018,.06)),_e(7317704));return r.position.y=-.075,t.add(e,n,s,r),t}const Xy={cup:Ly,bun:Iy,heel:Dy,chip:Uy,disc:Ny,flat:Oy,blob:zy,bottle:Fy,carton:ky,bag:By,box:Hy,tray:Gy,mop:Vy,spray:Wy};function qy(i){const t=new st(ge("fallback",()=>new Ut(.075,.055,.075)),_e(i));return t.castShadow=!0,t}function Qn(i,t=13421772){return(Xy[i]||qy)(t)}function Yy(i){return i==="mop"}const Sn=(i,t,e,n)=>{const s=new st(new Ut(i,t,e),Se(n));return s.castShadow=!0,s.receiveShadow=!0,s};class Ur{constructor(t={}){const{skin:e=qt.skinTones[0],hair:n=qt.hairTones[0],height:s=1,build:r=1,hairStyle:o="short"}=t;this.group=new Xt,this.scale=s,this.opts={skin:e,hair:n,height:s,build:r,hairStyle:o};const a=s,c=.44*r,l=.24*r;this.hips=new Xt,this.hips.position.y=.84*a,this.group.add(this.hips),this.torso=Sn(c,.58*a,l,14209734),this.torso.position.y=.29*a,this.hips.add(this.torso),this.neck=Sn(.14*a,.08*a,.14*a,e),this.neck.position.y=.62*a,this.hips.add(this.neck),this.head=new Xt,this.head.position.y=.66*a,this.hips.add(this.head);const h=Sn(.26*a,.3*a,.25*a,e);h.position.y=.15*a,this.head.add(h),this.skull=h,this.hair=new Xt;const u=o==="long"?.2:.1,d=Sn(.28*a,u*a,.27*a,n);if(d.position.y=(.3-u/2+.005)*a,this.hair.add(d),o==="long"){const f=Sn(.26*a,.26*a,.1*a,n);f.position.set(0,.12*a,-.14*a),this.hair.add(f)}if(o==="bun"){const f=new st(new Vi(.08*a,8,6),Se(n));f.position.set(0,.3*a,-.14*a),f.castShadow=!0,this.hair.add(f)}this.head.add(this.hair);for(const f of[-.06,.06]){const m=Sn(.045*a,.045*a,.02*a,1973016);m.position.set(f*a,.17*a,.13*a),this.head.add(m)}this.arms={};for(const f of["left","right"]){const m=new Xt;m.position.set((f==="left"?-1:1)*(c/2+.055*a),.54*a,0);const _=Sn(.11*a,.5*a,.12*a,14209734);_.position.y=-.25*a,m.add(_);const p=Sn(.1*a,.1*a,.11*a,e);p.position.y=-.54*a,m.add(p);const g=new Xt;g.position.y=-.6*a,m.add(g),this.hips.add(m),this.arms[f]={pivot:m,upper:_,hand:p,grip:g}}this.legs={};for(const f of["left","right"]){const m=new Xt;m.position.set((f==="left"?-1:1)*.11*a,0,0);const _=Sn(.15*a,.78*a,.16*a,3884626);_.position.y=-.39*a,m.add(_);const p=Sn(.17*a,.1*a,.24*a,2764083);p.position.set(0,-.82*a,.03*a),m.add(p),this.hips.add(m),this.legs[f]={pivot:m,leg:_,shoe:p}}this.bag=null,this.hat=null,this.phase=0,this.leaning=0,this.firstPerson=!1,this._held=[],this._heldSig=""}applyOutfit(t={}){var o,a,c;const e=(l,h)=>{l.material=Se(h)},n=((o=t.top)==null?void 0:o.colour)??14209734;e(this.torso,n),e(this.arms.left.upper,n),e(this.arms.right.upper,n);const s=((a=t.bottom)==null?void 0:a.colour)??3884626;e(this.legs.left.leg,s),e(this.legs.right.leg,s);const r=((c=t.shoes)==null?void 0:c.colour)??2764083;if(e(this.legs.left.shoe,r),e(this.legs.right.shoe,r),this.hat&&(this.head.remove(this.hat),this.hat=null),t.head){const l=this.scale;if(this.hat=Sn(.3*l,.08*l,.3*l,t.head.colour),this.hat.position.y=.33*l,t.head.id==="cap"){const h=Sn(.28*l,.03*l,.14*l,t.head.colour);h.position.set(0,-.03*l,.2*l),this.hat.add(h)}this.head.add(this.hat)}if(this.bag&&(this.hips.remove(this.bag),this.bag=null),t.bag){const l=this.scale;this.bag=Sn(.32*l,.4*l,.16*l,t.bag.colour),this.bag.position.set(0,.3*l,-.2*l),this.hips.add(this.bag)}}setFirstPerson(t){this.firstPerson=t,this.head.visible=!t,this.neck.visible=!t,this.torso.visible=!t,this.arms.left.pivot.visible=!t,this.arms.right.pivot.visible=!t,this.legs.left.pivot.visible=!t,this.legs.right.pivot.visible=!t,this.bag&&(this.bag.visible=!t),this._applyHeldVisibility()}setHeld(t=[]){var r;const e=Array.isArray(t)?t.slice(0,4):[],n=e.map(o=>`${o.id}:${o.colour}:${o.shape||""}`).join("|");if(n===this._heldSig)return;this._heldSig=n;for(const o of this._held)(r=o.parent)==null||r.remove(o);this._held=[];const s=this.scale;e.forEach((o,a)=>{const c=a===1?"left":"right",l=this.arms[c].grip,h=Yy(o.shape)||!!o.big,u=Qn(o.shape,o.colour??13421772);u.scale.setScalar(s),u.position.set(0,h?-.16*s:-.02*s-(a>>1)*.11*s,h?.05*s:.075*s),h&&(u.rotation.x=.24),l.add(u),this._held.push(u)}),this._applyHeldVisibility()}_applyHeldVisibility(){for(const t of["left","right"]){const e=this.arms[t].grip;e.visible=!0,this.firstPerson?(e.parent!==this.hips&&this.hips.add(e),e.position.set((t==="left"?-1:1)*.22*this.scale,.34*this.scale,.34*this.scale)):e.parent!==this.arms[t].pivot&&(this.arms[t].pivot.add(e),e.position.set(0,-.6*this.scale,0))}}update(t,e=0,n={}){const s=e>.2;if(this.phase+=t*(s?4.2+e*1.1:2.2),n.sitting){this.legs.left.pivot.rotation.x=-1.4,this.legs.right.pivot.rotation.x=-1.4,this.arms.left.pivot.rotation.x=-.5,this.arms.right.pivot.rotation.x=-.5,this.hips.position.y=.5*this.scale;return}if(n.sleeping){this.group.rotation.z=Math.PI/2*.98,this.hips.position.y=.3*this.scale;return}this.group.rotation.z=0,this.hips.position.y=.84*this.scale+(s?Math.abs(Math.sin(this.phase))*.02:0);const r=s?Math.sin(this.phase)*Math.min(.85,.28+e*.14):Math.sin(this.phase)*.03;this.legs.left.pivot.rotation.x=r,this.legs.right.pivot.rotation.x=-r,this.arms.left.pivot.rotation.x=-r*.75,this.arms.right.pivot.rotation.x=r*.75,this.arms.left.pivot.rotation.z=.06,this.arms.right.pivot.rotation.z=-.06;const o=n.tired?.16:0;this.torso.rotation.x=o,this.head.rotation.x=o*.6}fidget(t){this.arms.left.pivot.rotation.x+=(Math.random()-.5)*t*.3,this.arms.right.pivot.rotation.x+=(Math.random()-.5)*t*.3,this.head.rotation.y=(Math.random()-.5)*t*.4}dispose(){this.group.traverse(t=>{t.isMesh&&t.geometry.dispose()})}}const Lu=1.5,wo=[{x:-32,z:30.3},{x:26,z:30.3},{x:-41.8,z:16},{x:39.8,z:12}],jy=.3,Iu=.3,$y=.34,Zy=4.5,Ky={queue_1:Math.PI,queue_2:Math.PI,queue_3:Math.PI,queue_4:Math.PI,collect_wait:Math.PI,collect_pickup:Math.PI,kiosk_1:-Math.PI/2,kiosk_2:-Math.PI/2,seat_1:-Math.PI/2,seat_2:-Math.PI/2,seat_3:-Math.PI/2,seat_4:-Math.PI/2,seat_5:-Math.PI/2,seat_6:-Math.PI/2,seat_7:-Math.PI/2},rc=7,Jy=14;class Qy{constructor(t){this.game=t,this.scene=t.renderer.scene,this._bodies=new Map,this._doorList=[],this._tables=new Map,this._buildLocators(),t.slice=this}tableOf(t){for(const[e,n]of this._tables)if(n===t)return e;return null}seatedTable(t){const e=this.tableOf(t);if(e==null)return null;const n=this._bodies.get(t);return n&&n.sitting?e:null}_freeTable(){for(let t=1;t<=rc;t++)if(!this._tables.has(t))return t;return null}_buildLocators(){this._locators=[];for(let t=1;t<=rc;t++){const e=new Xt,n=new st(new Ut(.035,.115,.022),new yi({color:11026479}));n.position.y=.058,n.castShadow=!0,e.add(n);const s=document.createElement("canvas");s.width=64,s.height=40;const r=new Yn(s);r.colorSpace=He;const o=new en({map:r,transparent:!0});for(const a of[0,Math.PI]){const c=new st(new Ie(.07,.044),o);c.position.set(0,.075,a===0?.013:-.013),c.rotation.y=a,e.add(c)}e.visible=!1,this.scene.add(e),this._locators.push({g:e,canvas:s,tex:r,shownId:null})}}_syncLocators(){const t=this.game.shift.rules.orders;for(let e=1;e<=rc;e++){const n=this._locators[e-1],s=this._tables.get(e),r=s!=null?t.get(s):null,o=!!r&&r.state!=="served";if(n.g.visible=o,!o)continue;const a=this.spot(`table_${e}`);if(n.g.position.set(a.x-.24,.745,a.z-.2),n.shownId!==s){n.shownId=s;const c=n.canvas.getContext("2d");c.clearRect(0,0,64,40),c.fillStyle="#f4efe4",c.font="bold 26px Segoe UI, system-ui, sans-serif",c.textAlign="center",c.textBaseline="middle",c.fillText("#"+s,32,21),n.tex.needsUpdate=!0}}}bodies(){return this._doorList}atTill(t){const e=this._bodies.get(t);return!!e&&e.goalName==="queue_1"&&e.path.length===0}spot(t){return this.game.world.spots[t]}update(t){if(t>0&&this.game.mode===$e.PLAY){this._sync(t);for(const e of this._bodies.values())this._move(e,t);this._separate(),this._syncLocators(),this._doorList.length=0;for(const e of this._bodies.values())this._doorList.push(e),e.avatar.update(t,e.speed,{sitting:!!e.sitting}),this._syncBar(e)}}_syncBar(t){const e=this.game.shift.rules.orders.get(t.id),n=e&&!t.leaving&&t.phase!=="approach"?this.game.shift.rules.orders.patienceFrac(e,this.game.shift.rules.minute):null;if(!n||n.frac>=.98){t.bar&&(t.bar.visible=!1);return}if(!t.bar){const r=new Xt,o=new st(new Ie(.56,.075),new en({color:1316636,transparent:!0,opacity:.85,depthWrite:!1})),a=new st(new Ie(.52,.045),new en({color:3653722,depthWrite:!1}));a.position.z=.002,r.add(o,a),r.position.y=2.1,t.avatar.group.add(r),t.bar=r,t.barFill=a}t.bar.visible=!0;const s=n.frac;t.barFill.scale.x=Math.max(.02,s),t.barFill.position.x=-.26*(1-Math.max(.02,s)),t.barFill.material.color.set(s>.5?3653722:s>.25?16098851:14826286),t.bar.rotation.y=this.game.camera.yaw+Math.PI-t.avatar.group.rotation.y}_sync(t){const e=this.game.shift.rules.orders;for(const n of e.all()){if(n.source==="drivethru"||n.source==="delivery")continue;let s=this._bodies.get(n.id);if(n.state==="lost"){s&&this._leave(s);continue}if(n.state==="served"){if(!s||s.table!=null&&!s.leaving&&(s.sitting=!0,s.eat??(s.eat=Jy+n.id%7*4),s.eat-=t,s.eat>0))continue;this._leave(s);continue}if(s||(s=this._spawn(n)),!s.leaving){if(s.phase==="approach"){if(s.path.length)continue;s.phase="arrive"}n.source==="counter"?this._counterChoreo(s,n,e):this._kioskChoreo(s,n,t)}}for(const n of this._bodies.values())e.get(n.id)||this._leave(n)}_counterChoreo(t,e,n){if(e.state==="queued"){const s=n.counterQueue().indexOf(e),r=Math.min(s+1+(n.ordering()?1:0),4);this._stand(t,`queue_${r}`)}else e.state==="ordering"?this._stand(t,"queue_1"):this._waitChoreo(t,e)}_kioskChoreo(t,e,n){t.phase==="arrive"?(this._stand(t,t.kioskSpot),!t.path.length&&t.goalName===t.kioskSpot&&(t.phase="ordering",t.dwell=Zy)):t.phase==="ordering"?(t.dwell-=n,t.dwell<=0&&(t.phase="waiting")):this._waitChoreo(t,e)}_waitChoreo(t,e){if(e.state==="bagged"){if(t.sitting=!1,this._stand(t,"collect_pickup"),!t.path.length&&t.goalName==="collect_pickup"&&!t.collected){t.collected=!0;const n=this.game.shift.rules;n.netRole!=="guest"&&n.applyNet("collect",[e.id],"customer"),t.avatar.setHeld([{id:"bag",shape:"bag",colour:14272934}])}return}if(e.service==="dinein"){if(t.table==null){const n=this._freeTable();if(n==null){this._stand(t,"collect_wait");return}t.table=n,this._tables.set(n,e.id)}this._stand(t,`seat_${t.table}`),t.sitting=!t.path.length&&t.goalName===`seat_${t.table}`;return}this._stand(t,"collect_wait")}_spawn(t){const e=Wi[t.look%Wi.length],n=new Ur({skin:qt.skinTones[e.skin%qt.skinTones.length],hair:qt.hairTones[e.hair%qt.hairTones.length],hairStyle:e.hairStyle,height:e.height,build:e.build});n.applyOutfit({top:{colour:e.top},bottom:{colour:e.bottom},shoes:{colour:2764083}});const s=this.spot("entry_out"),r=wo[t.id%wo.length];n.group.position.set(r.x,0,r.z),this.scene.add(n.group);const o={id:t.id,avatar:n,pos:n.group.position,facing:Math.PI,speed:0,path:[{x:s.x,z:27},{x:s.x,z:13},{x:s.x,z:s.z}],goalName:null,leaving:!1,phase:"approach",dwell:0,kioskSpot:t.id%2?"kiosk_1":"kiosk_2"};return this._bodies.set(t.id,o),o}_despawn(t){this._freeUp(t),this.scene.remove(t.avatar.group),t.bar&&(t.bar.children.forEach(e=>{var n,s;return(s=(n=e.material)==null?void 0:n.dispose)==null?void 0:s.call(n)}),t.bar=null),t.avatar.dispose(),this._bodies.delete(t.id)}_freeUp(t){t.table!=null&&(this._tables.delete(t.table),t.table=null),t.sitting=!1}_stand(t,e){t.goalName!==e&&(t.goalName=e,t.path=this._route(t,e))}_leave(t){if(t.leaving)return;this._freeUp(t),t.leaving=!0,t.goalName="entry_out",t.path=this._route(t,"entry_out");const e=this.spot("entry_out"),n=wo[(t.id*5+2)%wo.length];t.path.push({x:e.x,z:13},{x:e.x,z:27},{x:n.x,z:n.z})}_route(t,e){const n=this.spot(e),s=[],r=t.pos,o=r.x<-8.3&&r.z>3.5,a=r.z<3.5;return e==="entry_out"?(o&&s.push(this.spot("kiosk_gate")),(o||a)&&s.push(this.spot("aisle")),s.push(this.spot("entry"))):e.startsWith("kiosk")?(!a&&!o&&s.push(this.spot("aisle")),s.push(this.spot("kiosk_gate"))):n.z<3.5&&o?s.push(this.spot("kiosk_gate")):n.z<3.5&&!a&&s.push(this.spot("aisle")),s.push(n),s}_move(t,e){const n=t.path[0];if(!n){const c=t.goalName&&this.spot(t.goalName);if(c){const h=Math.hypot(c.x-t.pos.x,c.z-t.pos.z),u=this.game.player.position,d=Math.hypot(c.x-u.x,c.z-u.z)<.6;if(h>.55&&!d){t.path=[c];return}}t.speed=0;const l=Ky[t.goalName];l!==void 0&&(t.facing=l),t.avatar.group.rotation.y=t.facing;return}const s=n.x-t.pos.x,r=n.z-t.pos.z,o=Math.hypot(s,r);if(o<jy){t.path.shift(),!t.path.length&&t.leaving&&this._despawn(t);return}const a=Math.min(o,Lu*e);t.pos.x+=s/o*a,t.pos.z+=r/o*a,t.facing=Math.atan2(s,r),t.avatar.group.rotation.y=t.facing,t.speed=Lu}_separate(){const t=[...this._bodies.values()];for(let e=0;e<t.length;e++){if(t[e].sitting)continue;for(let l=e+1;l<t.length;l++){const h=t[e],u=t[l];if(u.sitting)continue;let d=u.pos.x-h.pos.x,f=u.pos.z-h.pos.z,m=Math.hypot(d,f);const _=Iu*2;if(m>=_)continue;m<1e-4&&(d=1,f=0,m=1);const p=(_-m)/2;h.pos.x-=d/m*p,h.pos.z-=f/m*p,u.pos.x+=d/m*p,u.pos.z+=f/m*p}const n=this.game.player.position,s=t[e];let r=s.pos.x-n.x,o=s.pos.z-n.z,a=Math.hypot(r,o);const c=Iu+$y;a<c&&(a<1e-4&&(r=1,o=0,a=1),s.pos.x+=r/a*(c-a),s.pos.z+=o/a*(c-a))}}}const t2=5.5,e2=4.5,oc=.35,Du=-.5,n2=-1,i2=20;class s2{constructor(t){this.game=t,this.scene=t.renderer.scene,this._cars=new Map,this._path=this._buildPath(),this._sOrder=this._sNear(-15,Du),this._sPickup=this._sNear(12.15,n2),this._sExit=this._length-.5,this._lightStops=[{s:this._sNear(-46,33)-5.5},{s:this._sNear(44,33)-5.5}].filter(e=>e.s>6)}_buildPath(){const t=[],e=(h,u)=>t.push({x:h,z:u}),n=Hl.lane.legs,s=n[0],r=n[1],o=n[2];e(-40,33),e(-19,33),e(-15.6,30.5),e(-15,26),e(s.from.x,s.from.z),e(s.to.x,s.to.z);const a=(h,u,d,f)=>{for(let _=1;_<=7;_++){const p=d+(f-d)*(_/7);e(h+Math.cos(p)*6,u+Math.sin(p)*6)}};a(-9,-6.5,Math.PI,Math.PI*1.5),e(r.to.x,r.to.z),a(6.15,-6.5,Math.PI*1.5,Math.PI*2),e(o.to.x,i2),e(12.9,26.5),e(14.4,30.5),e(18,33),e(48,33);let c=0;const l=t.map((h,u)=>(u>0&&(c+=Math.hypot(h.x-t[u-1].x,h.z-t[u-1].z)),{...h,s:c}));return this._length=c,l}_sNear(t,e){let n=null;for(let s=1;s<this._path.length;s++){const r=this._path[s-1],o=this._path[s],a=o.x-r.x,c=o.z-r.z,l=a*a+c*c||1,h=Math.max(0,Math.min(1,((t-r.x)*a+(e-r.z)*c)/l)),u=r.x+a*h,d=r.z+c*h,f=Math.hypot(t-u,e-d);(!n||f<n.d)&&(n={d:f,s:r.s+Math.sqrt(l)*h})}return n.s}_at(t){const e=this._path;let n=1;for(;n<e.length-1&&e[n].s<t;)n++;const s=e[n-1],r=e[n],o=r.s-s.s||1,a=Math.min(1,Math.max(0,(t-s.s)/o));return{x:s.x+(r.x-s.x)*a,z:s.z+(r.z-s.z)*a,yaw:Math.atan2(r.x-s.x,r.z-s.z)}}atOrderWindow(t){const e=this._cars.get(t);return!!e&&Math.abs(e.s-this._sOrder)<oc}atPickup(t){const e=this._cars.get(t);return!!e&&Math.abs(e.s-this._sPickup)<oc}update(t){var r;if(!(t>0)||this.game.mode!==$e.PLAY)return;const e=this.game.shift.rules.orders;for(const o of e.all()){if(o.source!=="drivethru")continue;let a=this._cars.get(o.id);!a&&o.state!=="served"&&(a=this._spawn(o)),a&&(a.order=o)}for(const[o,a]of this._cars)e.get(o)||(a.order={state:"served"});const n=[...this._cars.values()].sort((o,a)=>a.s-o.s);let s=1/0;for(const o of n){const a=o.order,c=a.state==="driveup"?this._sOrder:a.state==="served"||a.state==="lost"?this._sExit:this._sPickup;let l=Math.min(c,s-t2);for(const d of this._lightStops){const f=d.s-o.s;f>-.3&&f<12&&((r=this.game.traffic)==null?void 0:r._phase("ew"))!=="green"&&(l=Math.min(l,d.s))}const h=l-o.s;if(h>.001){const d=Math.min(e2,.8+h*1.4);o.s+=Math.min(h,d*t)}s=o.s;const u=this._at(o.s);o.mesh.position.set(u.x,0,u.z),o.mesh.rotation.y=u.yaw,!o.chimed&&a.state==="driveup"&&Math.abs(o.s-this._sOrder)<oc&&(o.chimed=!0,this.game.audio.play("kiosk_order",{at:{x:-10,y:1.3,z:Du},rate:.8})),(a.state==="served"||a.state==="lost")&&o.s>=this._sExit-.1&&this._despawn(o),this._syncBar(o,a)}}_syncBar(t,e){const n=this.game.shift.rules.orders.get(t.id),s=n?this.game.shift.rules.orders.patienceFrac(n,this.game.shift.rules.minute):null;if(!s||s.frac>=.98){t.bar&&(t.bar.visible=!1);return}if(!t.bar){const o=new Xt,a=new st(new Ie(.9,.1),new en({color:1316636,transparent:!0,opacity:.85,depthWrite:!1})),c=new st(new Ie(.84,.06),new en({color:3653722,depthWrite:!1}));c.position.z=.002,o.add(a,c),o.position.y=2.25,t.mesh.add(o),t.bar=o,t.barFill=c}t.bar.visible=!0;const r=s.frac;t.barFill.scale.x=Math.max(.02,r),t.barFill.position.x=-.42*(1-Math.max(.02,r)),t.barFill.material.color.set(r>.5?3653722:r>.25?16098851:14826286),t.bar.rotation.y=this.game.camera.yaw+Math.PI-t.mesh.rotation.y}_spawn(t){const e=this.game.rng.child("car"+t.id),n=oa(e);Qd(n),this.scene.add(n);const s={id:t.id,order:t,mesh:n,s:0,chimed:!1};return this._cars.set(t.id,s),s}_despawn(t){this.scene.remove(t.mesh),t.mesh.traverse(e=>{var n,s,r,o,a;(s=(n=e.geometry)==null?void 0:n.dispose)==null||s.call(n),e.material&&!((r=e.userData)!=null&&r.shared)&&((a=(o=e.material).dispose)==null||a.call(o))}),this._cars.delete(t.id)}}const Cn={topSpeed:12,accel:4.5,brake:7,coastDrag:1.2,turnRateAtSpeed:1,turnRateAtCrawl:2.2,mountRange:2.2},r2=1.2,ac={x:-7.9,z:-18.7,heading:Math.PI};class o2{constructor(t){this.game=t,this.mesh=H1(),t.renderer.scene.add(this.mesh),this.parked=new I(ac.x,0,ac.z),this.heading=ac.heading,this.lean=0,this.speed=0,this.rider=null,this._syncMesh(),this.point=t.world.addInteractable({id:"delivery_van",label:"take the delivery van",pos:this.parked,action:"vehicle",data:{},radius:Cn.mountRange}),this._collider=null,this._addParkedCollider()}get isRidden(){return this.rider!==null}_addParkedCollider(){const t=Math.abs(Math.sin(this.heading))>.5,e=(t?4.2:2)/2,n=(t?2:4.2)/2;this._collider={min:new I(this.parked.x-e,0,this.parked.z-n),max:new I(this.parked.x+e,2.2,this.parked.z+n),walkable:!1},this.game.world.colliders.push(this._collider),this.game.world._rebuildSpatialHash()}_removeParkedCollider(){const t=this.game.world.colliders,e=t.indexOf(this._collider);e>=0&&t.splice(e,1),this._collider=null,this.game.world._rebuildSpatialHash()}_syncMesh(){const t=this.rider?this.rider.position:this.parked;this.mesh.position.set(t.x,0,t.z),this.mesh.rotation.y=this.heading,this.mesh.rotation.z=this.lean*.4}setRemote(t){t?(this._remote||this._removeParkedCollider(),this._remote=t,this.parked.set(t.x,0,t.z),this.heading=t.yaw,this._syncMesh()):this._remote&&(this._remote=null,this._addParkedCollider(),this._syncMesh())}mount(){var n,s,r,o,a;const t=this.game.player;if(this.isRidden||!t||t.isBusy)return!1;if(this._remote||(n=this.game.room)!=null&&n.heldByAnother("van"))return this.game.ui.toast(`${((o=this.game.room)==null?void 0:o.nameOf((r=(s=this.game.room)==null?void 0:s.heldByAnother("van"))==null?void 0:r.by))||"Someone"} has the van.`,2600),!1;(a=this.game.room)==null||a.take("van"),this.rider=t,t.vehicle=this,this._removeParkedCollider(),t.position.set(this.parked.x,0,this.parked.z),t.velocity.set(0,0,0),t.facing=this.heading,this.speed=0;const e=this.game.camera;return e.setMode("ride"),e.yaw=this.heading,e.pitch=-.14,this.game.ui.toast("W/S drive, A/D steer, Space brakes. E to get out.",5200),this.game.bus.emit("van:mounted",{}),!0}dismount(){var s;if(!this.isRidden)return!1;const t=this.rider;this.parked.set(t.position.x,0,t.position.z);const e={x:Math.cos(this.heading),z:-Math.sin(this.heading)},n=t.position.clone();return t.position.x+=e.x*1.35,t.position.z+=e.z*1.35,t.position.y=t._floorUnder(),t._insideSolid()&&t.position.copy(n),t.velocity.set(0,0,0),t.vehicle=null,this.rider=null,this.speed=0,this.game.camera.fovBoost=0,this.game.camera.setMode("first"),this._addParkedCollider(),this._syncMesh(),(s=this.game.room)==null||s.release("van"),this.game.bus.emit("van:dismounted",{}),!0}ride(t){const e=this.rider;if(!e)return;const n=this.game.input,s=n.axis(),r=s.y,o=s.x;if(r>.01)this.speed+=Cn.accel*r*t;else if(r<-.01)this.speed>.15?this.speed-=Cn.brake*t:this.speed-=Cn.accel*.6*t;else{const g=Cn.coastDrag*t;this.speed-=Math.sign(this.speed)*Math.min(Math.abs(this.speed),g)}if(n.isDown("jump")){const g=Cn.brake*1.3*t;this.speed-=Math.sign(this.speed)*Math.min(Math.abs(this.speed),g)}this.speed=mn.clamp(this.speed,-2.5,Cn.topSpeed);const a=Math.min(1,Math.abs(this.speed)/Cn.topSpeed),c=Cn.turnRateAtCrawl+(Cn.turnRateAtSpeed-Cn.turnRateAtCrawl)*a,l=Math.min(1,Math.abs(this.speed)/r2),h=-o*c*l*Math.sign(this.speed||1)*t;this.heading+=h;const u=mn.clamp(-h/Math.max(t,1e-4)*.22*a,-.42,.42);this.lean+=(u-this.lean)*Math.min(1,t*6);const d=Math.sin(this.heading),f=Math.cos(this.heading);e.velocity.x=d*this.speed,e.velocity.z=f*this.speed,e._applyGravity(t),e._collide(t);const m=e._floorUnder();e.position.y<m&&(e.position.y=m,e.velocity.y=0,e.onGround=!0),this.speed=e.velocity.x*d+e.velocity.z*f,e.facing=this.heading,e.horizontalSpeed=0;const _=this.game.camera,p=this.heading-_.yaw;_.yaw+=Math.atan2(Math.sin(p),Math.cos(p))*Math.min(1,t*2.2*a),this.game.camera.fovBoost=7*Math.max(0,this.speed)/Cn.topSpeed,this._syncMesh(),this.game.room&&(!this._claimAt||Date.now()-this._claimAt>8e3)&&(this._claimAt=Date.now(),this.game.room.take("van"))}}const Uu=1.5,Eo=4.5,Nu=6,a2=3,c2=8,l2=6.5,h2=14,js={green:11,amber:2.5,allRed:1.5},cc=js.green+js.amber+js.allRed;class u2{constructor(t){this.game=t;const e=t.renderer.scene;this._t=0,this._lightSig=null,this._lights=[{x:Je.west,z:Je.front},{x:Je.east,z:Je.front},{x:Je.west,z:Je.back},{x:Je.east,z:Je.back}],this._buildPoles(e),this._routes=[];const n={x0:Je.west,z0:Je.back,x1:Je.east,z1:Je.front},s={x0:si.west,z0:si.back,x1:si.east,z1:si.front};this._addRing(n,"out",3),this._addRing(n,"in",2),this._addRing(s,"out",3),this._addRing(s,"in",2);const r=t.world.rng.child("traffic");for(const o of this._routes)for(let a=0;a<o.carCount;a++){const c=oa(r);Qd(c),e.add(c),o.cars.push({mesh:c,s:o.length/o.carCount*a+r.range(0,5),v:Nu*.6})}}_addRing(t,e,n){const s=e==="out"?Uu:-Uu,r=t.x0-s,o=t.z0-s,a=t.x1+s,c=t.z1+s,l=e==="out"?[[a,c],[r,c],[r,o],[a,o]]:[[r,c],[a,c],[a,o],[r,o]],h=[];for(let m=0;m<4;m++){const _=l[(m+3)%4],p=l[m],g=l[(m+1)%4],v=Ou(p[0]-_[0],p[1]-_[1]),x=Ou(g[0]-p[0],g[1]-p[1]),M=[p[0]-v[0]*Eo,p[1]-v[1]*Eo],A=[p[0]+x[0]*Eo,p[1]+x[1]*Eo],E=[(M[0]+A[0])/2*.45+p[0]*.55,(M[1]+A[1])/2*.45+p[1]*.55];h.push(M,E,A)}h.push([...h[0]]);let u=0;const d=h.map((m,_)=>(_>0&&(u+=Math.hypot(m[0]-h[_-1][0],m[1]-h[_-1][1])),{x:m[0],z:m[1],s:u})),f=[];for(const m of this._lights){let _=null;for(let p=1;p<d.length;p++){const g=d2(d[p-1],d[p],m);(!_||g.d<_.d)&&(_=g)}if(_&&_.d<8){const p=this._at(d,u,(_.s-3+u)%u),g=Math.abs(Math.sin(p.yaw))>.5?"ew":"ns";f.push({s:(_.s-l2+u)%u,axis:g})}}this._routes.push({way:d,length:u,stops:f,carCount:n,cars:[]})}_at(t,e,n){n=(n%e+e)%e;let s=1;for(;s<t.length-1&&t[s].s<n;)s++;const r=t[s-1],o=t[s],a=o.s-r.s||1,c=Math.min(1,Math.max(0,(n-r.s)/a));return{x:r.x+(o.x-r.x)*c,z:r.z+(o.z-r.z)*c,yaw:Math.atan2(o.x-r.x,o.z-r.z)}}_phase(t){const e=this._t%(cc*2),n=e<cc?"ns":"ew";if(t!==n)return"red";const s=e%cc;return s<js.green?"green":s<js.green+js.amber?"amber":"red"}_buildPoles(t){const e=o=>new en({color:o}),n=o=>Se(o);this._lampMats={red:[n(3806482),e(14826286)],amber:[n(3812368),e(16098851)],green:[n(1126427),e(3653722)]},this._heads=[];const s=Se(qt.metalDark),r=Se(2237995);for(const o of this._lights)for(const[a,c]of[[1,1],[-1,-1]]){const l=o.x+a*4.4,h=o.z+c*4.4,u=new st(new Ut(.14,3.4,.14),s);u.position.set(l,1.7,h),u.castShadow=!0,t.add(u),this._head(t,r,l,h,c>0?0:Math.PI,"ns",3.05),this._head(t,r,l,h,a>0?Math.PI/2:-Math.PI/2,"ew",2.35)}}_head(t,e,n,s,r,o,a){const c=new Xt,l=new st(new Ut(.26,.72,.18),e);l.position.z=.16,l.castShadow=!0,c.add(l);const h={},u=[["red",.22],["amber",0],["green",-.22]];for(const[d,f]of u){const m=new st(new Ut(.15,.15,.03),this._lampMats[d][0]);m.position.set(0,f,.16+.095),c.add(m),h[d]=m}c.position.set(n,a,s),c.rotation.y=r,t.add(c),this._heads.push({axis:o,lamps:h})}_paintLights(){const t=`${this._phase("ns")}|${this._phase("ew")}`;if(t!==this._lightSig){this._lightSig=t;for(const e of this._heads){const n=this._phase(e.axis);e.lamps.red.material=this._lampMats.red[n==="red"?1:0],e.lamps.amber.material=this._lampMats.amber[n==="amber"?1:0],e.lamps.green.material=this._lampMats.green[n==="green"?1:0]}}}update(t){this._t+=t,this._paintLights();const e=this.game.player.position;for(const n of this._routes){const{cars:s,length:r,way:o}=n;for(const a of s){let c=Nu,l=1/0;for(const m of s){if(m===a)continue;const _=(m.s-a.s+r)%r;_>.01&&_<l&&(l=_)}l<c2&&(c=Math.min(c,Math.max(0,(l-4.6)*1.2)));for(const m of n.stops){const _=(m.s-a.s+r)%r;_<h2&&this._phase(m.axis)!=="green"&&(c=Math.min(c,Math.max(0,(_-.5)*1.3)))}const h=this._at(o,r,a.s+2.6),u=e.x-h.x,d=e.z-h.z;u*u+d*d<3.4*3.4&&(c=0),a.v+=mn.clamp(c-a.v,-6.5*t,a2*t),a.s=(a.s+a.v*t)%r;const f=this._at(o,r,a.s);a.mesh.position.set(f.x,0,f.z),a.mesh.rotation.y=f.yaw}}}}function Ou(i,t){const e=Math.hypot(i,t)||1;return[i/e,t/e]}function d2(i,t,e){const n=t.x-i.x,s=t.z-i.z,r=n*n+s*s||1,o=Math.max(0,Math.min(1,((e.x-i.x)*n+(e.z-i.z)*s)/r)),a=i.x+n*o,c=i.z+s*o;return{d:Math.hypot(e.x-a,e.z-c),s:i.s+Math.sqrt(r)*o}}const zu=2,Fu=[14,40],f2=[2,4.5];class p2{constructor(t){this.game=t;const e=t.renderer.scene,n=t.world.rng.child("pedestrians");this._loops=[];const s={x0:Je.west,z0:Je.back,x1:Je.east,z1:Je.front},r={x0:si.west,z0:si.back,x1:si.east,z1:si.front};this._addLoop(s,+Hs,3),this._addLoop(s,-Hs,3),this._addLoop(r,+Hs,2),this._addLoop(r,-Hs,2),this._walkers=[];for(const o of this._loops)for(let a=0;a<o.count;a++){const c=Wi[n.int(0,Wi.length-1)],l=new Ur({skin:qt.skinTones[c.skin%qt.skinTones.length],hair:qt.hairTones[c.hair%qt.hairTones.length],hairStyle:c.hairStyle,height:c.height,build:c.build});l.applyOutfit({top:{colour:c.top},bottom:{colour:c.bottom},shoes:{colour:2764083}}),e.add(l.group),this._walkers.push({avatar:l,loop:o,s:o.length/o.count*a+n.range(0,8),dir:n.range(0,1)<.5?1:-1,speed:n.range(1.05,1.5),pause:n.range(...Fu),paused:0})}}_addLoop(t,e,n){const s=t.x0-e,r=t.z0-e,o=t.x1+e,a=t.z1+e,c=[[o,a],[s,a],[s,r],[o,r]],l=[];for(let d=0;d<4;d++){const f=c[(d+3)%4],m=c[d],_=c[(d+1)%4],p=ku(m,f,zu),g=ku(m,_,zu);l.push(p,g)}l.push([...l[0]]);let h=0;const u=l.map((d,f)=>(f>0&&(h+=Math.hypot(d[0]-l[f-1][0],d[1]-l[f-1][1])),{x:d[0],z:d[1],s:h}));this._loops.push({way:u,length:h,count:n})}_at(t,e){e=(e%t.length+t.length)%t.length;const n=t.way;let s=1;for(;s<n.length-1&&n[s].s<e;)s++;const r=n[s-1],o=n[s],a=o.s-r.s||1,c=Math.min(1,Math.max(0,(e-r.s)/a));return{x:r.x+(o.x-r.x)*c,z:r.z+(o.z-r.z)*c,dx:(o.x-r.x)/a,dz:(o.z-r.z)/a}}update(t){if(!(t>0)||this.game.mode!==$e.PLAY)return;const e=this.game.player.position;for(const n of this._walkers){let s=n.speed;n.paused>0?(n.paused-=t,s=0):(n.pause-=t,n.pause<=0&&(n.paused=Bu(...f2),n.pause=Bu(...Fu)));const r=this._at(n.loop,n.s),o=e.x-r.x,a=e.z-r.z;o*o+a*a<1.4*1.4&&(s=0),n.s+=s*n.dir*t;const c=this._at(n.loop,n.s);n.avatar.group.position.set(c.x,0,c.z),s>.01&&(n.avatar.group.rotation.y=Math.atan2(c.dx*n.dir,c.dz*n.dir)),n.avatar.update(t,s,{})}}}function ku(i,t,e){const n=t[0]-i[0],s=t[1]-i[1],r=Math.hypot(n,s)||1;return[i[0]+n/r*e,i[1]+s/r*e]}function Bu(i,t){return i+Math.random()*(t-i)}const m2=1.75,xr=.5,fl=.7,g2=1.8,pl=.6,Ns=.5,gr=xr+fl+g2+pl+Ns;class _2{constructor(t){this.game=t,this._moments=new Map,t.bus.on(de.ORDER_SERVED,({id:e})=>{const n=t.shift.rules.orders.get(e);!n||n.source!=="delivery"||n.house==null||this._answer(n.house)})}_answer(t){if(this._moments.has(t))return;const e=ls[t],n=of[t];if(!e||!n)return;const s=Wi[t%Wi.length],r=new Ur({skin:qt.skinTones[s.skin%qt.skinTones.length],hair:qt.hairTones[s.hair%qt.hairTones.length],hairStyle:s.hairStyle,height:s.height,build:s.build});r.applyOutfit({top:{colour:s.top},bottom:{colour:s.bottom},shoes:{colour:3354668}});const o={x:Math.sin(n.rotY),z:Math.cos(n.rotY)},a={x:e.door.x-o.x*1.6,z:e.door.z-o.z*1.6},c={x:e.door.x-o.x*.7,z:e.door.z-o.z*.7};r.group.position.set(a.x,0,a.z),r.group.rotation.y=n.rotY,this.game.renderer.scene.add(r.group),this.game.audio.play("order_taken",{at:{x:e.door.x,y:1.4,z:e.door.z}}),this._moments.set(t,{t:0,hinge:n.hinge,avatar:r,from:a,to:c})}update(t){if(t>0)for(const[e,n]of this._moments){n.t+=t;const s=n.t;let r;s<xr?r=bo(s/xr):s<gr-Ns?r=1:r=1-bo((s-(gr-Ns))/Ns),n.hinge.rotation.y=m2*Math.max(0,Math.min(1,r));const o=xr,a=xr+fl,c=gr-Ns-pl,l=gr-Ns;let h=0,u=0;s<o?h=0:s<a?(h=bo((s-o)/fl),u=1):s<c?h=1:s<l&&(h=1-bo((s-c)/pl),u=1),n.avatar.group.position.set(n.from.x+(n.to.x-n.from.x)*h,0,n.from.z+(n.to.z-n.from.z)*h),n.avatar.update(t,u,{}),s>=gr&&(n.hinge.rotation.y=0,this.game.renderer.scene.remove(n.avatar.group),n.avatar.dispose(),this._moments.delete(e))}}}function bo(i){return i*i*(3-2*i)}class x2{constructor(t){this.game=t,this._bodies=new Map}get room(){return this.game.room}update(t){var o;const e=this.room;if(!e){this._clear();return}const n=Date.now(),s=new Set;let r=null;for(const a of e.roster){if(a.me)continue;s.add(a.id);let c=this._bodies.get(a.id);c||(c=this._spawn(a));const l=e.poseFor(a.id,n);if(!l){c.avatar.group.visible=!1;continue}l.vehicle==="van"?(c.avatar.group.visible=!1,r={x:l.x,z:l.z,yaw:l.yaw}):(c.avatar.group.visible=!0,c.avatar.group.position.set(l.x,l.y,l.z),c.avatar.group.rotation.y=l.yaw),c.avatar.update(t,l.speed,{})}for(const[a,c]of this._bodies)s.has(a)||this._despawn(a,c);(o=this.game.deliveryCar)==null||o.setRemote(r)}_spawn(t){const e=Wi[(t.look??0)%Wi.length],n=new Ur({skin:qt.skinTones[e.skin%qt.skinTones.length],hair:qt.hairTones[e.hair%qt.hairTones.length],hairStyle:e.hairStyle,height:e.height,build:e.build});n.applyOutfit({top:{colour:11026479},bottom:{colour:2303531},shoes:{colour:1842722}}),n.group.visible=!1,this.game.renderer.scene.add(n.group);const s={avatar:n,name:t.name};return this._bodies.set(t.id,s),s}_despawn(t,e){this.game.renderer.scene.remove(e.avatar.group),e.avatar.dispose(),this._bodies.delete(t)}_clear(){var t;for(const[e,n]of this._bodies)this._despawn(e,n);(t=this.game.deliveryCar)==null||t.setRemote(null)}}const dn={x:ks.x,y:Mt.benchH+.045,z:ks.z},Hu={z:Mt.z1-.15,y:Mt.benchH+.002},v2=1.1,y2={heel:.02,smear:.005,chips:.01,leaf:.014,slice:.011,flat:.006,disc:.018,crown:.036},M2=.72;class S2{constructor(t){this.game=t;const e=t.renderer.scene;this.group=new Xt,this.group.name="build-board",e.add(this.group),this._sig=null,this._mats=[],this._piles=[],this._pilePos=[],this._pileOrderId=null,this._parcel=new Xt;const n=new st(new Ut(.115,.055,.115),new yi({color:15262418}));n.castShadow=!0;const s=new st(new Ut(.118,.016,.05),new yi({color:11026479}));s.position.y=.02,this._parcel.add(n,s),this._parcel.visible=!1,e.add(this._parcel),this.slidingId=null,this._slide=null,this._fixturePos={};for(const r of t.world.activeInteractables())r.id==="pod_toaster"?this._fixturePos.bun=r.pos:r.id==="pod_uhc"?(this._fixturePos.patty=r.pos,this._fixturePos.fillet=r.pos):r.id.startsWith("pod_gun_")?this._fixturePos[r.id.slice(8)]=r.pos:r.id.startsWith("pod_bin_")?this._fixturePos[r.id.slice(8)]=r.pos:r.id==="landing_handover"?this._landingPos=r.pos:r.id==="till_order"&&(this._tillPos=r.pos);this._pulses=[];for(let r=0;r<6;r++){const o=new st(new Ie(.16,.16),new en({color:16777215,transparent:!0,opacity:0,blending:ko,depthWrite:!1}));o.visible=!1,o.rotation.x=-.4,e.add(o),this._pulses.push({mesh:o,life:0})}this._bunHalf=Qn("bun",ki.bun.colour),this._bunHalf.visible=!1,e.add(this._bunHalf),this._eject=null,this._wire()}_wire(){const t=this.game.bus,e=this.game.audio,n=s=>s?{at:{x:s.x,y:s.y,z:s.z}}:{};t.on(de.ORDER_STEP,({added:s})=>{const r=this._fixturePos[s],o=ki[s];r&&o&&this._pulse(r,o.colour),s==="bun"&&(this._eject={t:0}),e.play("item_place",{...n(r),rate:.94+Math.random()*.12})}),t.on(de.POD_REFUSED,()=>{e.play("wrong_item",n({x:Mt.cx,y:1.2,z:Mt.cz}))}),t.on(de.ORDER_BUILT,()=>{e.play("item_pickup",n({x:dn.x,y:1,z:dn.z}))}),t.on(de.ORDER_WRAPPED,()=>{e.play("item_place",{...n({x:dn.x,y:1,z:dn.z}),rate:.8})}),t.on(de.ORDER_READY,({id:s})=>{this.slidingId=s,this._slide={t:0},e.play("item_drop",{...n({x:xe.x0,y:1,z:xe.z0}),rate:1.15})}),t.on(de.ORDER_SERVED,({id:s})=>{const r=this.game.shift.rules.orders.get(s),o=(r==null?void 0:r.source)==="drivethru"?{x:9.9,y:1.2,z:-1}:this._landingPos;e.play("order_complete",n(o))}),t.on(de.COUNTER_TAKEN,()=>e.play("order_taken",n(this._tillPos))),t.on(de.COUNTER_PAID,()=>e.play("purchase",n(this._tillPos))),t.on(de.ORDER_OFFERED,({source:s})=>{var r;if(s==="kiosk"){const o=(r=this.game.world.spots)==null?void 0:r.kiosk_1;e.play("kiosk_order",n(o&&{x:o.x,y:1.4,z:o.z}))}})}_pulse(t,e){const n=this._pulses.find(s=>s.life<=0)||this._pulses[0];n.life=.35,n.mesh.material.color.set(e),n.mesh.position.set(t.x,t.y+.06,t.z+.02),n.mesh.visible=!0}update(t){this._syncStack(),this._animate(t)}_syncStack(){var o;const t=this.game.shift.rules.orders.active(),e=t?`${t.id}:${t.step}:${t.state}`:null;if(e===this._sig)return;this._sig=e;for(const a of[...this.group.children])this.group.remove(a);for(const a of this._mats)a.dispose();if(this._mats=[],this._piles=[],this._parcel.visible=this._slide!==null,(!t||this._pileOrderId!==t.id)&&(this._pilePos=[],this._pileOrderId=(t==null?void 0:t.id)??null),!t||t.state==="ready")return;if(t.state==="wrapped"){this._parcel.visible=!0,this._parcel.position.set(dn.x,dn.y+.028,dn.z),this._parcel.rotation.set(0,.12,0);return}const n=t.items.map((a,c)=>{var l;return Bi[a].sequence.length+((l=t.mods)!=null&&l[c]?1:0)});let s=0,r=0;for(let a=0;a<n.length&&s<t.step;a++){const c=s,l=Math.min(t.step-c,n[a]);if(s+=n[a],l<=0)break;const h=l===n[a],u=new Xt,d=(p,g)=>((t.id*7+(c+p)*13)%5-2)*.003*g;let f=0;for(let p=0;p<l;p++){const g=ki[t.sequence[c+p]];if(!g)continue;const v=y2[g.shape]??.012;this._layer(u,g,f+v/2,d(p,1),d(p,-1)),f+=v}if(h){const p=Qn("bun",ki.bun.colour);this._own(p),p.position.y=f,u.add(p)}let m;if(h)m=new I(dn.x+(r%2?.075:-.075)*(n.length>1?1:0),dn.y,dn.z),r++;else{const p=t.sequence[c+l-1],g=((o=this._fixturePos[p])==null?void 0:o.x)??dn.x;m=new I(g,Hu.y,Hu.z)}const _=this._pilePos[a];u.position.copy(_||m),this.group.add(u),this._piles.push({group:u,target:m,item:a})}}_layer(t,e,n,s,r){const o=(a,c=1,l=1,h=1,u=0,d=0)=>{this._own(a),a.scale.multiply(new I(c,l,h)),a.position.set(s+u,n,r+d),t.add(a)};switch(e.shape){case"smear":o(Qn("flat",e.colour),.62,.5,.62);break;case"chips":o(Qn("chip",e.colour),1,1,1,-.018,-.008),o(Qn("chip",e.colour),1,1,1,.016,-.014),o(Qn("chip",e.colour),1,1,1,.004,.019);break;case"leaf":o(Qn("blob",e.colour),1.5,.38,1.5);break;case"slice":o(Qn("disc",e.colour),.92,.6,.92);break;default:o(Qn(e.shape,e.colour))}}_own(t){t.traverse(e=>{e.material&&this._mats.push(e.material)})}_animate(t){var e,n;for(const s of this._piles){const r=s.group,o=s.target,a=o.x-r.position.x,c=o.y-r.position.y,l=o.z-r.position.z,h=Math.hypot(a,c,l);if(h>5e-4){const u=Math.min(h,v2*t);r.position.x+=a/h*u,r.position.y+=c/h*u,r.position.z+=l/h*u}((e=this._pilePos)[n=s.item]||(e[n]=new I)).copy(r.position)}for(const s of this._pulses)s.life<=0||(s.life-=t,s.mesh.material.opacity=Math.max(0,s.life/.35)*.9,s.life<=0&&(s.mesh.visible=!1));if(this._eject){const s=this._fixturePos.bun;this._eject.t+=t/.35;const r=Math.min(1,this._eject.t);s&&(this._bunHalf.visible=!0,this._bunHalf.position.set(s.x,Mt.benchH+.3-.27*r*r,Mt.cz+.24+.16*r),this._bunHalf.rotation.x=.3*(1-r)),r>=1&&(this._eject=null,this._bunHalf.visible=!1)}if(this._slide){this._slide.t+=t/M2;const s=Math.min(1,this._slide.t),r=this.game.shift.rules.orders.ready(),o=Math.max(0,Math.min(r.findIndex(_=>_.id===this.slidingId),3)),a={x:Ys.x0+.22+o*.42,y:Ys.y+.03,z:Ys.z},c=[{x:dn.x,y:dn.y+.03,z:dn.z},{x:xe.x0,y:1,z:xe.z0},{x:xe.x1,y:.93,z:xe.z1},a],l=[.18,.62,1];let h=0;for(;h<2&&s>l[h];)h++;const u=h===0?0:l[h-1],d=(s-u)/(l[h]-u),f=c[h],m=c[h+1];this._parcel.visible=!0,this._parcel.scale.setScalar(1.25-.25*s),this._parcel.position.set(f.x+(m.x-f.x)*d,f.y+(m.y-f.y)*d,f.z+(m.z-f.z)*d),this._parcel.rotation.y+=t*2.2,s>=1&&(this._slide=null,this.slidingId=null,this._parcel.visible=!1,this._parcel.rotation.set(0,0,0),this._parcel.scale.setScalar(1))}}}const wn=.34,Gu=1.75,w2=1.62,E2=22,lc=.42,b2={top:{colour:3817286},bottom:{colour:2303531},shoes:{colour:2764083},head:{id:"cap",colour:11026479}};class T2{constructor(t){var n,s,r;this.game=t,this.position=new I(0,0,0),this.velocity=new I,this.facing=0,this.onGround=!0,this.state="normal",this.eyeHeight=w2,this.horizontalSpeed=0,this.avatar=new Ur({skin:(n=qt.skinTones)==null?void 0:n[1],hair:(s=qt.hairTones)==null?void 0:s[1],hairStyle:"short",height:1,build:1}),this.avatar.applyOutfit(b2),t.renderer.scene.add(this.avatar.group);const e=(r=t.world.spots)==null?void 0:r.spawn;this.teleport(e?e.clone():new I(0,0,14)),this.walkSpeed=4.6,this.runSpeed=9}teleport(t){this.position.copy(t),this.velocity.set(0,0,0),this.avatar.group.position.copy(t)}get isBusy(){return this.state!=="normal"}update(t){if(this.vehicle){this.game.mode===$e.PLAY&&this.vehicle.ride(t),this.avatar.group.position.copy(this.position),this.avatar.group.rotation.y=this.facing,this.avatar.update(t,0,{sitting:!0});return}this.state==="normal"&&this.game.mode===$e.PLAY?this._move(t):(this.velocity.x=0,this.velocity.z=0,this.horizontalSpeed=0,this.state==="normal"&&this._applyGravity(t)),this.avatar.group.position.copy(this.position),this.avatar.group.rotation.y=this.facing,this.avatar.update(t,this.horizontalSpeed,{sitting:!1,sleeping:!1,tired:!1})}_move(t){const e=this.game.input,n=e.axis(),{forward:s,right:r}=this.game.camera.basis(),o=e.isDown("sprint"),a=o?this.runSpeed:this.walkSpeed,c=new I().addScaledVector(s,n.y).addScaledVector(r,n.x);c.lengthSq()>0?(c.normalize(),this.facing=Math.atan2(c.x,c.z),this.game.camera.fovBoost=o?5:0):this.game.camera.fovBoost=0;const l=c.multiplyScalar(a),h=this.onGround?14:3;this.velocity.x+=(l.x-this.velocity.x)*Math.min(1,h*t),this.velocity.z+=(l.z-this.velocity.z)*Math.min(1,h*t),e.wasPressed("jump")&&this.onGround&&(this.velocity.y=6.2,this.onGround=!1),this._applyGravity(t),this._collide(t);const u=this._floorUnder();this.position.y<u&&(this.position.y=u,this.velocity.y=0,this.onGround=!0),this.horizontalSpeed=Math.hypot(this.velocity.x,this.velocity.z)}_floorUnder(){const t=this.game.world,{x:e,z:n,y:s}=this.position;let r=t.groundHeight(e,n);for(const o of t.query(this.position,wn+.5))o.walkable&&(e<o.min.x-wn||e>o.max.x+wn||n<o.min.z-wn||n>o.max.z+wn||o.max.y<=s+lc&&o.max.y>r&&(r=o.max.y));return r}_insideSolid(){const t=this.game.world,e=wn-.06;for(const n of t.query(this.position,wn+.3)){if(this.position.y+Gu<n.min.y||this.position.y>n.max.y||n.max.y<=this.position.y+lc)continue;const s=Math.max(n.min.x,Math.min(this.position.x,n.max.x)),r=Math.max(n.min.z,Math.min(this.position.z,n.max.z)),o=this.position.x-s,a=this.position.z-r;if(o*o+a*a<e*e)return!0}return!1}_applyGravity(t){this.velocity.y-=E2*t,this.position.y+=this.velocity.y*t;const e=this._floorUnder();this.position.y<=e&&(this.position.y=e,this.velocity.y=0,this.onGround=!0)}_collide(t){const e=this.game.world;this.position.x+=this.velocity.x*t,this.position.z+=this.velocity.z*t;for(let s=0;s<4;s++){let r=!1;for(const o of e.query(this.position,wn+.6)){if(this.position.y+Gu<o.min.y||this.position.y>o.max.y||o.max.y<=this.position.y+lc)continue;const a=Math.max(o.min.x,Math.min(this.position.x,o.max.x)),c=Math.max(o.min.z,Math.min(this.position.z,o.max.z));let l=this.position.x-a,h=this.position.z-c;const u=l*l+h*h;if(u>=wn*wn)continue;if(u>1e-8){const f=Math.sqrt(u),m=wn-f;l/=f,h/=f,this.position.x+=l*m,this.position.z+=h*m}else{const f=[[this.position.x-o.min.x,-1,0],[o.max.x-this.position.x,1,0],[this.position.z-o.min.z,0,-1],[o.max.z-this.position.z,0,1]].sort((m,_)=>m[0]-_[0])[0];l=f[1],h=f[2],this.position.x+=l*(f[0]+wn),this.position.z+=h*(f[0]+wn)}const d=this.velocity.x*l+this.velocity.z*h;d<0&&(this.velocity.x-=l*d,this.velocity.z-=h*d),r=!0}if(!r)break}this._insideSolid()?(this._lastSafe&&this.position.copy(this._lastSafe),this.velocity.x=0,this.velocity.z=0):(this._lastSafe||(this._lastSafe=new I)).copy(this.position);const n=180;this.position.x=mn.clamp(this.position.x,-n,n),this.position.z=mn.clamp(this.position.z,-n,n)}setState(t){this.state=t,this.game.bus.emit("player:state",{state:t})}serialize(){return{position:this.position.toArray(),facing:this.facing}}load(t){t&&(this.teleport(new I().fromArray(t.position)),this.position.y=Math.max(this.position.y,this._floorUnder()),this.avatar.group.position.copy(this.position),this.facing=t.facing||0)}}const A2="modulepreload",R2=function(i){return"/burgerbarn/"+i},Vu={},C2=function(t,e,n){let s=Promise.resolve();if(e&&e.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),a=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=Promise.allSettled(e.map(c=>{if(c=R2(c),c in Vu)return;Vu[c]=!0;const l=c.endsWith(".css"),h=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${h}`))return;const u=document.createElement("link");if(u.rel=l?"stylesheet":A2,l||(u.as="script"),u.crossOrigin="",u.href=c,a&&u.setAttribute("nonce",a),document.head.appendChild(u),l)return new Promise((d,f)=>{u.addEventListener("load",d),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(o){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o}return s.then(o=>{for(const a of o||[])a.status==="rejected"&&r(a.reason);return t().catch(r)})},To=210,hc=330,Ao=2,Ee={x:10,y:34,w:190,h:218};class P2{constructor(t){this.game=t,this._repaint=0;const e=document.createElement("canvas");e.id="gps",e.width=To*Ao,e.height=hc*Ao,document.getElementById("ui").appendChild(e),this.el=e,this.ctx=e.getContext("2d"),this._visible=!1,this._buildGraph()}_buildGraph(){const t=Je,e=si,n=this._nodes=[{x:t.west,z:t.front},{x:t.east,z:t.front},{x:t.west,z:t.back},{x:t.east,z:t.back},{x:t.west,z:e.front},{x:t.east,z:e.front},{x:t.west,z:e.back},{x:t.east,z:e.back},{x:e.west,z:t.front},{x:e.east,z:t.front},{x:e.west,z:t.back},{x:e.east,z:t.back},{x:e.west,z:e.front},{x:e.east,z:e.front},{x:e.west,z:e.back},{x:e.east,z:e.back}];this._edges=[[0,1],[2,3],[0,2],[1,3],[0,4],[1,5],[2,6],[3,7],[0,8],[1,9],[2,10],[3,11],[12,4],[4,5],[5,13],[14,6],[6,7],[7,15],[12,8],[8,10],[10,14],[13,9],[9,11],[11,15]].map(([s,r])=>({a:s,b:r,len:Math.hypot(n[s].x-n[r].x,n[s].z-n[r].z)})),this._decor=[[[-14.4,31.5],[-14.4,26]],[[12.15,31.5],[12.15,26]],[[-21,31.5],[-21,-19.2]],[[-21,-19.2],[-5.5,-19.2]],[[-5.5,-19.2],[-5.5,-31]]]}_snap(t,e){let n=null;const s=this._nodes;return this._edges.forEach((r,o)=>{const a=s[r.a],c=s[r.b],l=c.x-a.x,h=c.z-a.z,u=Math.max(0,Math.min(1,((t-a.x)*l+(e-a.z)*h)/(l*l+h*h))),d=a.x+l*u,f=a.z+h*u,m=Math.hypot(t-d,e-f);(!n||m<n.d)&&(n={i:o,t:u,px:d,pz:f,d:m})}),n}_route(t,e){if(t.i===e.i){const _=Math.abs(e.t-t.t)*this._edges[t.i].len;return{pts:[t,e].map(p=>({x:p.px,z:p.pz})),len:_}}const n=this._nodes.length,s=new Array(n).fill(1/0),r=new Array(n).fill(-1),o=this._edges[t.i],a=this._edges[e.i];s[o.a]=t.t*o.len,s[o.b]=(1-t.t)*o.len;const c=new Array(n).fill(!1);for(let _=0;_<n;_++){let p=-1;for(let g=0;g<n;g++)!c[g]&&(p<0||s[g]<s[p])&&(p=g);if(p<0||s[p]===1/0)break;c[p]=!0;for(let g=0;g<this._edges.length;g++){const v=this._edges[g],x=v.a===p?v.b:v.b===p?v.a:-1;if(x<0)continue;const M=s[p]+v.len;M<s[x]&&(s[x]=M,r[x]=p)}}const l=s[a.a]+e.t*a.len,h=s[a.b]+(1-e.t)*a.len;let u=l<=h?a.a:a.b;const d=Math.min(l,h),f=[];for(;u>=0;)f.unshift(u),u=r[u];const m=[{x:t.px,z:t.pz}];for(const _ of f)m.push({x:this._nodes[_].x,z:this._nodes[_].z});return m.push({x:e.px,z:e.pz}),{pts:m,len:d}}update(t){const e=!!this.game.player.vehicle;e!==this._visible&&(this._visible=e,this.el.classList.toggle("on",e)),e&&(this._repaint-=t,!(this._repaint>0)&&(this._repaint=.12,this._paint()))}_paint(){const t=this.game,e=this.ctx;e.setTransform(Ao,0,0,Ao,0,0);const n=t.shift.rules.orders.carriedBy("player"),s=n&&n.source==="delivery"?n:null,o=s?ls[s.house].door:{x:-5.5,z:-19},a=s?ls[s.house].name:"back to the Barn",c=t.player.position,l=this._route(this._snap(c.x,c.z),this._snap(o.x,o.z));e.clearRect(0,0,To,hc),Wu(e,0,0,To,hc,18),e.fillStyle="rgba(16, 19, 24, 0.94)",e.fill(),e.strokeStyle="rgba(241, 236, 225, 0.18)",e.lineWidth=1.5,e.stroke(),e.fillStyle="#c9a961",e.font="bold 13px Segoe UI, system-ui, sans-serif",e.fillText("BARN MAPS",12,22),e.fillStyle="#9aa3ad",e.font="11px Segoe UI, system-ui, sans-serif",e.textAlign="right",e.fillText(t.clock.timeLabel,To-12,22),e.textAlign="left",Wu(e,Ee.x,Ee.y,Ee.w,Ee.h,8),e.save(),e.clip(),e.fillStyle="#151b14",e.fillRect(Ee.x,Ee.y,Ee.w,Ee.h);const h=Math.min(Ee.w/215,Ee.h/195),u=v=>Ee.x+Ee.w/2+v*h,d=v=>Ee.y+Ee.h/2+v*h;e.strokeStyle="#3b4451",e.lineWidth=4,e.lineCap="round";for(const v of this._edges){const x=this._nodes[v.a],M=this._nodes[v.b];e.beginPath(),e.moveTo(u(x.x),d(x.z)),e.lineTo(u(M.x),d(M.z)),e.stroke()}e.lineWidth=2.5;for(const[v,x]of this._decor)e.beginPath(),e.moveTo(u(v[0]),d(v[1])),e.lineTo(u(x[0]),d(x[1])),e.stroke();e.fillStyle="#a8402f",e.fillRect(u(-2)-4,d(-1)-3.5,8,7),e.strokeStyle="#c9a961",e.lineWidth=2.5,e.beginPath(),l.pts.forEach((v,x)=>x?e.lineTo(u(v.x),d(v.z)):e.moveTo(u(v.x),d(v.z))),e.stroke();const f=u(o.x),m=d(o.z);e.strokeStyle="#e2543e",e.lineWidth=2,e.beginPath(),e.moveTo(f,m),e.lineTo(f,m-9),e.stroke(),e.fillStyle="#e2543e",e.beginPath(),e.arc(f,m-11,3.5,0,Math.PI*2),e.fill();const _=t.deliveryCar.heading;e.save(),e.translate(u(c.x),d(c.z)),e.rotate(Math.PI-_),e.fillStyle="#f1ece1",e.beginPath(),e.moveTo(0,-6),e.lineTo(4.5,5),e.lineTo(0,2.4),e.lineTo(-4.5,5),e.closePath(),e.fill(),e.restore(),e.restore(),e.fillStyle="#f1ece1",e.font="bold 15px Segoe UI, system-ui, sans-serif",e.fillText(a,12,Ee.y+Ee.h+26),e.fillStyle="#9aa3ad",e.font="12px Segoe UI, system-ui, sans-serif";let g=`${Math.round((l.len+5)/5)*5} m by road`;if(s){g+=` · #${s.id}`;const v=(s.dueBy??0)-t.shift.rules.minute;e.fillText(g,12,Ee.y+Ee.h+44),e.font="bold 13px Segoe UI, system-ui, sans-serif",v>0?(e.fillStyle=v>8?"#7fb069":"#f5a623",e.fillText(`due in ${Math.ceil(v)} min`,12,Ee.y+Ee.h+62)):(e.fillStyle="#e2543e",e.fillText("OVERDUE — no tip",12,Ee.y+Ee.h+62));return}e.fillText(g,12,Ee.y+Ee.h+44)}}function Wu(i,t,e,n,s,r){i.beginPath(),i.moveTo(t+r,e),i.arcTo(t+n,e,t+n,e+s,r),i.arcTo(t+n,e+s,t,e+s,r),i.arcTo(t,e+s,t,e,r),i.arcTo(t,e,t+n,e,r),i.closePath()}const zo="ABCDEFGHJKLMNPQRSTUVWXYZ23456789",lf=5,Xu="bb_player_id",hf="bb_player_name";function uf(i){const t=[],e=256-256%zo.length,n=typeof globalThis<"u"?globalThis.crypto:null;for(;t.length<i;){let s;if(n!=null&&n.getRandomValues)s=n.getRandomValues(new Uint8Array(i*2));else{s=new Uint8Array(i*2);for(let r=0;r<s.length;r++)s[r]=Math.floor(Math.random()*256)}for(const r of s)if(!(r>=e)&&(t.push(zo[r%zo.length]),t.length===i))break}return t.join("")}function L2(){return uf(lf)}function qu(i){if(!i)return null;const t=String(i).trim().toUpperCase().replace(/[^A-Z0-9]/g,"");if(t.length!==lf)return null;for(const e of t)if(!zo.includes(e))return null;return t}function Gl(){try{return typeof sessionStorage<"u"?sessionStorage:null}catch{return null}}function I2(){const i=Gl();let t=i==null?void 0:i.getItem(Xu);return t||(t="p_"+uf(10).toLowerCase(),i==null||i.setItem(Xu,t)),t}function Yu(i="Crew"){const t=Gl();return(t==null?void 0:t.getItem(hf))||i}function D2(i){var e;const t=String(i).trim().slice(0,16);return t?((e=Gl())==null||e.setItem(hf,t),t):null}function U2(i){if(typeof location>"u")return`?room=${i}`;const t=new URL(location.href);return t.searchParams.set("room",i),t.toString()}class N2{constructor(t){this.game=t;const e=document.getElementById("ui");e.innerHTML=`
      ...
      <div id="nethud"></div>`,this.prompt=document.getElementById("prompt"),this.promptLabel=document.getElementById("prompt-label"),this.toastEl=document.getElementById("toast"),this.pauseEl=document.getElementById("pause"),this._toastTimer=null,this.pauseEl.addEventListener("click",n=>{n.target.closest("#coop")||t.setMode($e.PLAY,"resume")}),this._wireCoop(),t.bus.on("game:mode",({mode:n})=>{this.pauseEl.classList.toggle("hidden",n===$e.PLAY)}),t.bus.on("interaction:target",({label:n})=>this.showPrompt(n)),this.gps=new P2(t)}showPrompt(t){if(!t){this.prompt.style.display="none";return}this.promptLabel.textContent=t,this.prompt.style.display="block"}toast(t,e=2600){this.toastEl.textContent=t,this.toastEl.style.opacity="1",clearTimeout(this._toastTimer),this._toastTimer=setTimeout(()=>{this.toastEl.style.opacity="0"},e)}update(t){this.gps.update(t)}_wireCoop(){const t=n=>document.getElementById(n);t("coop-host").addEventListener("click",()=>this._startCoop(L2())),t("coop-join").addEventListener("click",()=>{const n=qu(window.prompt("Room code?")||"");if(!n){this.toast("That does not look like a room code.");return}this._startCoop(n)}),t("coop-copy").addEventListener("click",()=>{var s,r;const n=(s=this.game.room)==null?void 0:s.code;n&&((r=navigator.clipboard)==null||r.writeText(U2(n)),this.toast("Invite link copied."))}),t("coop-leave").addEventListener("click",async()=>{var n;await((n=this.game.room)==null?void 0:n.leave()),this.game.room=null}),t("roster").addEventListener("click",n=>{var o;const s=n.target.closest("[data-assign]");if(!s)return;const r=s.dataset.assign==="-"?null:s.dataset.assign;(o=this.game.room)==null||o.setAssignment(s.dataset.pid,r)}),this.game.bus.on("net:room",n=>this._renderCoop(n));const e=qu(new URLSearchParams(location.search).get("room")||"");e&&setTimeout(()=>this._startCoop(e,{quiet:!0}),100)}async _startCoop(t,{quiet:e=!1}={}){if(this.game.room)return;if(!e){const o=window.prompt("Your crew name?",Yu("Crew"));if(o===null)return;D2(o||"Crew")}this.toast("Connecting…",8e3);const{createRoom:n}=await C2(async()=>{const{createRoom:o}=await import("./Room-DP93Mw_A.js");return{createRoom:o}},[]),s=[...I2()].reduce((o,a)=>o*31+a.charCodeAt(0)>>>0,0)%8,r=await n(this.game,t,{name:Yu("Crew"),look:s});if(!r){this.toast("Could not reach the room server.");return}if(r.error){this.toast(r.error);return}this.game.room=r,r.attach(this.game.shift.rules),this.toast(`In room ${t} — ${r.isHost?"hosting":"joined"}.`,4e3)}_renderCoop(t){const e=a=>document.getElementById(a),n=!!(t!=null&&t.code);if(e("coop-solo").style.display=n?"none":"",e("coop-room").style.display=n?"":"none",!n){e("nethud").textContent="";return}e("coop-code").textContent=`Room ${t.code}${t.stale?" — host quiet…":""}`;const s=t.role==="host",r=["pod","counter","window","runs"];e("roster").innerHTML=t.players.map(a=>{const c=`${a.host?"★ ":""}${a.me?"You":ju(a.name)}`,l=a.station?`<span class="badge">${ju(a.station)}</span>`:"",h=s&&!a.me?r.map(u=>`<button class="assign${a.station===u?" on":""}" data-assign="${u}" data-pid="${a.id}">${u}</button>`).join("")+`<button class="assign" data-assign="-" data-pid="${a.id}">–</button>`:"";return`<div class="crew-row"><span class="crew-name">${c}</span>${l}${h}</div>`}).join("");const o=t.myStation?` · you: ${t.myStation.toUpperCase()}`:"";e("nethud").textContent=`${t.code} · ${t.players.length} crew${t.connected?"":" · reconnecting…"}${o}`}}function ju(i){return String(i).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const $e={PLAY:"play",MENU:"menu"};class O2{constructor(t,e={}){this.canvas=t,this.seed=e.seed||"burgerbarn",this.bus=new yf,this.rng=new Zo(this.seed),this.clock=new Mf(this.bus),this.input=new Ef(this.bus,t),this.audio=new If(this),this.mode=$e.MENU,this.running=!1,this._accum=0,this._last=0,this.fixedStep=1/60}build(){return this.renderer=new $v(this.canvas,this),this.world=new gy(this),this.world.generate(),this.player=new T2(this),this.camera=new Kv(this),this.interaction=new xy(this),this.shift=new Py(this),this.customers=new Qy(this),this.cars=new s2(this),this.deliveryCar=new o2(this),this.traffic=new u2(this),this.pedestrians=new p2(this),this.houseLife=new _2(this),this.room=null,this.peers=new x2(this),this.buildBoard=new S2(this),this.ui=new N2(this),this.camera.setMode("first"),this.camera.yaw=Math.PI,this._wireGlobalInput(),this.input.enabled=!1,this.bus.emit("game:ready",{game:this}),this}_wireGlobalInput(){this.bus.on("action:camera",()=>{this.mode===$e.PLAY&&this.camera.cycle()}),this.bus.on("input:pointerlock",({locked:t})=>{!t&&this.mode===$e.PLAY&&this.setMode($e.MENU,"pause")})}setMode(t,e=""){if(this.mode===t)return;const n=this.mode;this.mode=t,this.clock.paused=t===$e.MENU,this.input.enabled=t===$e.PLAY,t===$e.PLAY?this.input.requestLock():n===$e.PLAY&&this.input.locked&&this.input.releaseLock(),this.bus.emit("game:mode",{mode:t,prev:n,reason:e})}start(){this.running=!0,this._last=performance.now();const t=e=>{if(!this.running)return;requestAnimationFrame(t);let n=(e-this._last)/1e3;this._last=e,n>.25&&(n=.25),this.update(n),this.render(n)};requestAnimationFrame(t)}update(t){this.mode===$e.PLAY&&this.clock.update(t),this._accum+=t;let e=0;for(;this._accum>=this.fixedStep&&e++<5;)this._accum-=this.fixedStep,this.player.update(this.fixedStep);if(this.camera.update(t),this.world.update(t),this.interaction.update(t),this.shift.update(t),this.buildBoard.update(t),this.customers.update(t),this.cars.update(t),this.traffic.update(t),this.pedestrians.update(t),this.houseLife.update(t),this.peers.update(t),this._netAccum=(this._netAccum||0)+t,this.room&&this._netAccum>=.1){this._netAccum=0;try{this.room._tick()}catch{}}this.ui.update(t),this.audio.update(t),this.input.endFrame()}render(t){this.renderer.render(this.camera.active,t)}}const Fo=document.getElementById("scene"),fn=new O2(Fo,{seed:new URLSearchParams(location.search).get("seed")||"burgerbarn"});fn.build();fn.start();window.game=fn;window.shot=async function(t="shot",e=null){if(e){if(e.pos){const c=fn.player.position.clone();c.set(e.pos[0],e.pos[1]??0,e.pos[2]),fn.player.teleport(c)}e.mode&&fn.camera.setMode(e.mode),e.yaw!==void 0&&(fn.camera.yaw=e.yaw),e.pitch!==void 0&&(fn.camera.pitch=e.pitch)}const n=1280,s=720;(Fo.width!==n||Fo.height!==s)&&(fn.renderer.renderer.setSize(n,s,!1),fn.camera.active.aspect=n/s,fn.camera.active.updateProjectionMatrix());const r=Math.max(1,(e==null?void 0:e.settle)??90);for(let c=0;c<r;c++)fn.update(1/60);if(e!=null&&e.free){const c=fn.camera.active;c.position.set(...e.free.pos),c.lookAt(...e.free.look)}fn.render(0);const o=Fo.toDataURL("image/png");return(await fetch("http://localhost:5199/shot",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({name:t,dataURL:o})})).json()};export{ul as S,C2 as _,Yu as a,I2 as p};
