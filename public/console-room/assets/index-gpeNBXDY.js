...
void main() {
	...
	`}function q1(n){let t=new WeakMap,e=null;function i(a){if(a&&a.isTexture){const c=a.mapping,l=c===Ml||c===yl,h=c===ir||c===sr;if(l||h){let u=t.get(a);const f=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==f)return e===null&&(e=new Fh(n)),u=l?e.fromEquirectangular(a,u):e.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),u.texture;if(u!==void 0)return u.texture;{const d=a.image;return l&&d&&d.height>0||h&&d&&s(d)?(e===null&&(e=new Fh(n)),u=l?e.fromEquirectangular(a):e.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),a.addEventListener("dispose",r),u.texture):null}}}return a}function s(a){let c=0;const l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function r(a){const c=a.target;c.removeEventListener("dispose",r);const l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:i,dispose:o}}function X1(n){const t={};function e(i){if(t[i]!==void 0)return t[i];let s;switch(i){case"WEBGL_depth_texture":s=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=n.getExtension(i)}return t[i]=s,s}return{has:function(i){return e(i)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(i){const s=e(i);return s===null&&ta("THREE.WebGLRenderer: "+i+" extension not supported."),s}}}function Y1(n,t,e,i){const s={},r=new WeakMap;function o(u){const f=u.target;f.index!==null&&t.remove(f.index);for(const _ in f.attributes)t.remove(f.attributes[_]);for(const _ in f.morphAttributes){const x=f.morphAttributes[_];for(let m=0,p=x.length;m<p;m++)t.remove(x[m])}f.removeEventListener("dispose",o),delete s[f.id];const d=r.get(f);d&&(t.remove(d),r.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function a(u,f){return s[f.id]===!0||(f.addEventListener("dispose",o),s[f.id]=!0,e.memory.geometries++),f}function c(u){const f=u.attributes;for(const _ in f)t.update(f[_],n.ARRAY_BUFFER);const d=u.morphAttributes;for(const _ in d){const x=d[_];for(let m=0,p=x.length;m<p;m++)t.update(x[m],n.ARRAY_BUFFER)}}function l(u){const f=[],d=u.index,_=u.attributes.position;let x=0;if(d!==null){const v=d.array;x=d.version;for(let M=0,S=v.length;M<S;M+=3){const R=v[M+0],A=v[M+1],E=v[M+2];f.push(R,A,A,E,E,R)}}else if(_!==void 0){const v=_.array;x=_.version;for(let M=0,S=v.length/3-1;M<S;M+=3){const R=M+0,A=M+1,E=M+2;f.push(R,A,A,E,E,R)}}else return;const m=new(rd(f)?ud:hd)(f,1);m.version=x;const p=r.get(u);p&&t.remove(p),r.set(u,m)}function h(u){const f=r.get(u);if(f){const d=u.index;d!==null&&f.version<d.version&&l(u)}else l(u);return r.get(u)}return{get:a,update:c,getWireframeAttribute:h}}function $1(n,t,e){let i;function s(f){i=f}let r,o;function a(f){r=f.type,o=f.bytesPerElement}function c(f,d){n.drawElements(i,d,r,f*o),e.update(d,i,1)}function l(f,d,_){_!==0&&(n.drawElementsInstanced(i,d,r,f*o,_),e.update(d,i,_))}function h(f,d,_){if(_===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,d,0,r,f,0,_);let m=0;for(let p=0;p<_;p++)m+=d[p];e.update(m,i,1)}function u(f,d,_,x){if(_===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<f.length;p++)l(f[p]/o,d[p],x[p]);else{m.multiDrawElementsInstancedWEBGL(i,d,0,r,f,0,x,0,_);let p=0;for(let v=0;v<_;v++)p+=d[v];for(let v=0;v<x.length;v++)e.update(p,i,x[v])}}this.setMode=s,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function j1(n){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function i(r,o,a){switch(e.calls++,o){case n.TRIANGLES:e.triangles+=a*(r/3);break;case n.LINES:e.lines+=a*(r/2);break;case n.LINE_STRIP:e.lines+=a*(r-1);break;case n.LINE_LOOP:e.lines+=a*r;break;case n.POINTS:e.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:i}}function K1(n,t,e){const i=new WeakMap,s=new ce;function r(o,a,c){const l=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let f=i.get(a);if(f===void 0||f.count!==u){let g=function(){P.dispose(),i.delete(a),a.removeEventListener("dispose",g)};var d=g;f!==void 0&&f.texture.dispose();const _=a.morphAttributes.position!==void 0,x=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,p=a.morphAttributes.position||[],v=a.morphAttributes.normal||[],M=a.morphAttributes.color||[];let S=0;_===!0&&(S=1),x===!0&&(S=2),m===!0&&(S=3);let R=a.attributes.position.count*S,A=1;R>t.maxTextureSize&&(A=Math.ceil(R/t.maxTextureSize),R=t.maxTextureSize);const E=new Float32Array(R*A*4*u),P=new ad(E,R,A,u);P.type=ni,P.needsUpdate=!0;const C=S*4;for(let y=0;y<u;y++){const b=p[y],L=v[y],N=M[y],k=R*A*4*y;for(let I=0;I<b.count;I++){const D=I*C;_===!0&&(s.fromBufferAttribute(b,I),E[k+D+0]=s.x,E[k+D+1]=s.y,E[k+D+2]=s.z,E[k+D+3]=0),x===!0&&(s.fromBufferAttribute(L,I),E[k+D+4]=s.x,E[k+D+5]=s.y,E[k+D+6]=s.z,E[k+D+7]=0),m===!0&&(s.fromBufferAttribute(N,I),E[k+D+8]=s.x,E[k+D+9]=s.y,E[k+D+10]=s.z,E[k+D+11]=N.itemSize===4?s.w:1)}}f={count:u,texture:P,size:new Ot(R,A)},i.set(a,f),a.addEventListener("dispose",g)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",o.morphTexture,e);else{let _=0;for(let m=0;m<l.length;m++)_+=l[m];const x=a.morphTargetsRelative?1:1-_;c.getUniforms().setValue(n,"morphTargetBaseInfluence",x),c.getUniforms().setValue(n,"morphTargetInfluences",l)}c.getUniforms().setValue(n,"morphTargetsTexture",f.texture,e),c.getUniforms().setValue(n,"morphTargetsTextureSize",f.size)}return{update:r}}function Z1(n,t,e,i){let s=new WeakMap;function r(c){const l=i.render.frame,h=c.geometry,u=t.get(c,h);if(s.get(u)!==l&&(t.update(u),s.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),s.get(c)!==l&&(e.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,n.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;s.get(f)!==l&&(f.update(),s.set(f,l))}return u}function o(){s=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:r,dispose:o}}class gd extends tn{constructor(t,e,i,s,r,o,a,c,l,h=Zs){if(h!==Zs&&h!==or)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&h===Zs&&(i=_s),i===void 0&&h===or&&(i=rr),super(null,s,r,o,a,c,h,i,l),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:_n,this.minFilter=c!==void 0?c:_n,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const xd=new tn,Hh=new gd(1,1),vd=new ad,Md=new Um,yd=new pd,Gh=[],Vh=[],Wh=new Float32Array(16),qh=new Float32Array(9),Xh=new Float32Array(4);function _r(n,t,e){const i=n[0];if(i<=0||i>0)return n;const s=t*e;let r=Gh[s];if(r===void 0&&(r=new Float32Array(s),Gh[s]=r),t!==0){i.toArray(r,0);for(let o=1,a=0;o!==t;++o)a+=e,n[o].toArray(r,a)}return r}function Fe(n,t){if(n.length!==t.length)return!1;for(let e=0,i=n.length;e<i;e++)if(n[e]!==t[e])return!1;return!0}function ke(n,t){for(let e=0,i=t.length;e<i;e++)n[e]=t[e]}function Ta(n,t){let e=Vh[t];e===void 0&&(e=new Int32Array(t),Vh[t]=e);for(let i=0;i!==t;++i)e[i]=n.allocateTextureUnit();return e}function J1(n,t){const e=this.cache;e[0]!==t&&(n.uniform1f(this.addr,t),e[0]=t)}function Q1(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Fe(e,t))return;n.uniform2fv(this.addr,t),ke(e,t)}}function tx(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(n.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(Fe(e,t))return;n.uniform3fv(this.addr,t),ke(e,t)}}function ex(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Fe(e,t))return;n.uniform4fv(this.addr,t),ke(e,t)}}function nx(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(Fe(e,t))return;n.uniformMatrix2fv(this.addr,!1,t),ke(e,t)}else{if(Fe(e,i))return;Xh.set(i),n.uniformMatrix2fv(this.addr,!1,Xh),ke(e,i)}}function ix(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(Fe(e,t))return;n.uniformMatrix3fv(this.addr,!1,t),ke(e,t)}else{if(Fe(e,i))return;qh.set(i),n.uniformMatrix3fv(this.addr,!1,qh),ke(e,i)}}function sx(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(Fe(e,t))return;n.uniformMatrix4fv(this.addr,!1,t),ke(e,t)}else{if(Fe(e,i))return;Wh.set(i),n.uniformMatrix4fv(this.addr,!1,Wh),ke(e,i)}}function rx(n,t){const e=this.cache;e[0]!==t&&(n.uniform1i(this.addr,t),e[0]=t)}function ox(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Fe(e,t))return;n.uniform2iv(this.addr,t),ke(e,t)}}function ax(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Fe(e,t))return;n.uniform3iv(this.addr,t),ke(e,t)}}function cx(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Fe(e,t))return;n.uniform4iv(this.addr,t),ke(e,t)}}function lx(n,t){const e=this.cache;e[0]!==t&&(n.uniform1ui(this.addr,t),e[0]=t)}function hx(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Fe(e,t))return;n.uniform2uiv(this.addr,t),ke(e,t)}}function ux(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Fe(e,t))return;n.uniform3uiv(this.addr,t),ke(e,t)}}function fx(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Fe(e,t))return;n.uniform4uiv(this.addr,t),ke(e,t)}}function dx(n,t,e){const i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s);let r;this.type===n.SAMPLER_2D_SHADOW?(Hh.compareFunction=sd,r=Hh):r=xd,e.setTexture2D(t||r,s)}function px(n,t,e){const i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),e.setTexture3D(t||Md,s)}function mx(n,t,e){const i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),e.setTextureCube(t||yd,s)}function _x(n,t,e){const i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),e.setTexture2DArray(t||vd,s)}function gx(n){switch(n){case 5126:return J1;case 35664:return Q1;case 35665:return tx;case 35666:return ex;case 35674:return nx;case 35675:return ix;case 35676:return sx;case 5124:case 35670:return rx;case 35667:case 35671:return ox;case 35668:case 35672:return ax;case 35669:case 35673:return cx;case 5125:return lx;case 36294:return hx;case 36295:return ux;case 36296:return fx;case 35678:case 36198:case 36298:case 36306:case 35682:return dx;case 35679:case 36299:case 36307:return px;case 35680:case 36300:case 36308:case 36293:return mx;case 36289:case 36303:case 36311:case 36292:return _x}}function xx(n,t){n.uniform1fv(this.addr,t)}function vx(n,t){const e=_r(t,this.size,2);n.uniform2fv(this.addr,e)}function Mx(n,t){const e=_r(t,this.size,3);n.uniform3fv(this.addr,e)}function yx(n,t){const e=_r(t,this.size,4);n.uniform4fv(this.addr,e)}function Sx(n,t){const e=_r(t,this.size,4);n.uniformMatrix2fv(this.addr,!1,e)}function Ex(n,t){const e=_r(t,this.size,9);n.uniformMatrix3fv(this.addr,!1,e)}function wx(n,t){const e=_r(t,this.size,16);n.uniformMatrix4fv(this.addr,!1,e)}function Ax(n,t){n.uniform1iv(this.addr,t)}function bx(n,t){n.uniform2iv(this.addr,t)}function Tx(n,t){n.uniform3iv(this.addr,t)}function Rx(n,t){n.uniform4iv(this.addr,t)}function Lx(n,t){n.uniform1uiv(this.addr,t)}function Cx(n,t){n.uniform2uiv(this.addr,t)}function Ix(n,t){n.uniform3uiv(this.addr,t)}function Px(n,t){n.uniform4uiv(this.addr,t)}function Dx(n,t,e){const i=this.cache,s=t.length,r=Ta(e,s);Fe(i,r)||(n.uniform1iv(this.addr,r),ke(i,r));for(let o=0;o!==s;++o)e.setTexture2D(t[o]||xd,r[o])}function Nx(n,t,e){const i=this.cache,s=t.length,r=Ta(e,s);Fe(i,r)||(n.uniform1iv(this.addr,r),ke(i,r));for(let o=0;o!==s;++o)e.setTexture3D(t[o]||Md,r[o])}function Ox(n,t,e){const i=this.cache,s=t.length,r=Ta(e,s);Fe(i,r)||(n.uniform1iv(this.addr,r),ke(i,r));for(let o=0;o!==s;++o)e.setTextureCube(t[o]||yd,r[o])}function Ux(n,t,e){const i=this.cache,s=t.length,r=Ta(e,s);Fe(i,r)||(n.uniform1iv(this.addr,r),ke(i,r));for(let o=0;o!==s;++o)e.setTexture2DArray(t[o]||vd,r[o])}function Fx(n){switch(n){case 5126:return xx;case 35664:return vx;case 35665:return Mx;case 35666:return yx;case 35674:return Sx;case 35675:return Ex;case 35676:return wx;case 5124:case 35670:return Ax;case 35667:case 35671:return bx;case 35668:case 35672:return Tx;case 35669:case 35673:return Rx;case 5125:return Lx;case 36294:return Cx;case 36295:return Ix;case 36296:return Px;case 35678:case 36198:case 36298:case 36306:case 35682:return Dx;case 35679:case 36299:case 36307:return Nx;case 35680:case 36300:case 36308:case 36293:return Ox;case 36289:case 36303:case 36311:case 36292:return Ux}}class kx{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.setValue=gx(e.type)}}class Bx{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=Fx(e.type)}}class zx{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,i){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(t,e[a.id],i)}}}const gc=/(\w+)(\])?(\[|\.)?/g;function Yh(n,t){n.seq.push(t),n.map[t.id]=t}function Hx(n,t,e){const i=n.name,s=i.length;for(gc.lastIndex=0;;){const r=gc.exec(i),o=gc.lastIndex;let a=r[1];const c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===s){Yh(e,l===void 0?new kx(a,n,t):new Bx(a,n,t));break}else{let u=e.map[a];u===void 0&&(u=new zx(a),Yh(e,u)),e=u}}}class ea{constructor(t,e){this.seq=[],this.map={};const i=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<i;++s){const r=t.getActiveUniform(e,s),o=t.getUniformLocation(e,r.name);Hx(r,o,this)}}setValue(t,e,i,s){const r=this.map[e];r!==void 0&&r.setValue(t,i,s)}setOptional(t,e,i){const s=e[i];s!==void 0&&this.setValue(t,i,s)}static upload(t,e,i,s){for(let r=0,o=e.length;r!==o;++r){const a=e[r],c=i[a.id];c.needsUpdate!==!1&&a.setValue(t,c.value,s)}}static seqWithValue(t,e){const i=[];for(let s=0,r=t.length;s!==r;++s){const o=t[s];o.id in e&&i.push(o)}return i}}function $h(n,t,e){const i=n.createShader(t);return n.shaderSource(i,e),n.compileShader(i),i}const Gx=37297;let Vx=0;function Wx(n,t){const e=n.split(`
`),i=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let o=s;o<r;o++){const a=o+1;i.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return i.join(`
`)}function qx(n){const t=ae.getPrimaries(ae.workingColorSpace),e=ae.getPrimaries(n);let i;switch(t===e?i="":t===ua&&e===ha?i="LinearDisplayP3ToLinearSRGB":t===ha&&e===ua&&(i="LinearSRGBToLinearDisplayP3"),n){case Li:case ba:return[i,"LinearTransferOETF"];case Je:case w0:return[i,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",n),[i,"LinearTransferOETF"]}}function jh(n,t,e){const i=n.getShaderParameter(t,n.COMPILE_STATUS),s=n.getShaderInfoLog(t).trim();if(i&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const o=parseInt(r[1]);return e.toUpperCase()+`

`+s+`

`+Wx(n.getShaderSource(t),o)}else return s}function Xx(n,t){const e=qx(t);return`vec4 ${n}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function Yx(n,t){let e;switch(t){case lm:e="Linear";break;case hm:e="Reinhard";break;case um:e="Cineon";break;case Xf:e="ACESFilmic";break;case dm:e="AgX";break;case pm:e="Neutral";break;case fm:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Co=new z;function $x(){ae.getLuminanceCoefficients(Co);const n=Co.x.toFixed(4),t=Co.y.toFixed(4),e=Co.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function jx(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Fr).join(`
`)}function Kx(n){const t=[];for(const e in n){const i=n[e];i!==!1&&t.push("#define "+e+" "+i)}return t.join(`
`)}function Zx(n,t){const e={},i=n.getProgramParameter(t,n.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){const r=n.getActiveAttrib(t,s),o=r.name;let a=1;r.type===n.FLOAT_MAT2&&(a=2),r.type===n.FLOAT_MAT3&&(a=3),r.type===n.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:n.getAttribLocation(t,o),locationSize:a}}return e}function Fr(n){return n!==""}function Kh(n,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Zh(n,t){return n.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Jx=/^[ \t]*#include +<([\w\d./]+)>/gm;function Kl(n){return n.replace(Jx,tv)}const Qx=new Map;function tv(n,t){let e=$t[t];if(e===void 0){const i=Qx.get(t);if(i!==void 0)e=$t[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,i);else throw new Error("Can not resolve #include <"+t+">")}return Kl(e)}const ev=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Jh(n){return n.replace(ev,nv)}function nv(n,t,e,i){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Qh(n){let t=`precision ${n.precision} float;
...
#define LOW_PRECISION`),t}function iv(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Vf?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===Wf?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===vi&&(t="SHADOWMAP_TYPE_VSM"),t}function sv(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case ir:case sr:t="ENVMAP_TYPE_CUBE";break;case Aa:t="ENVMAP_TYPE_CUBE_UV";break}return t}function rv(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case sr:t="ENVMAP_MODE_REFRACTION";break}return t}function ov(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case qf:t="ENVMAP_BLENDING_MULTIPLY";break;case am:t="ENVMAP_BLENDING_MIX";break;case cm:t="ENVMAP_BLENDING_ADD";break}return t}function av(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function cv(n,t,e,i){const s=n.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=iv(e),l=sv(e),h=rv(e),u=ov(e),f=av(e),d=jx(e),_=Kx(r),x=s.createProgram();let m,p,v=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
  ...
  float pull = uNear * ${(1+dE).toFixed(6)};
  float vz = -mv.z;
...
void main() {
  ...
  #include <tonemapping_fragment>
  #include <colorspace_fragment>
}`;function ME({renderer:n,camera:t,aperture:e=bp,pixelRatioCap:i=!0,driveCameraNear:s=!0}={}){if(!n)throw new Error("portal(): no renderer");if(!t)throw new Error("portal(): no camera");n.info&&(n.info.autoReset=!1);const r=new Ji(1,1,{type:dr,format:Qe,depthBuffer:!0,stencilBuffer:!1,samples:sl});r.texture.name="portalTarget",r.texture.colorSpace=Li,r.texture.minFilter=Ue,r.texture.magFilter=Ue,r.texture.generateMipmaps=!1;const o=new cn;o.name="portalCamera",o.matrixAutoUpdate=!1,o.matrixWorldAutoUpdate=!1;const a=[];let c=Ff(t.aspect,{fov:t.fov,apertureH:e.h}),l=1,h=sl,u=null,f=Nf,d=!1;const _={passes:0,skipped:0,rebuilds:0,ratioChanges:0};let x=!1;function m(){n.getDrawingBufferSize(rl);const b=Math.max(1,Math.floor(rl.x)),L=Math.max(1,Math.floor(rl.y)),N=b*L,k=N>il?lE:1,I=N>il?hE:sl;I!==h&&(h=I,r.samples=I,r.dispose(),_.rebuilds++),l=k,r.setSize(Math.max(1,Math.round(b*l)),Math.max(1,Math.round(L*l))),c=Ff(t.aspect,{fov:t.fov,apertureH:e.h});for(const D of a){const U=D.material.uniforms;U.uRes.value.set(b,L),U.uNear.value=c.near}s&&Math.abs(t.near-c.near)>1e-12&&(t.near=c.near,t.updateProjectionMatrix())}function p(){return Math.min((typeof devicePixelRatio=="number"?devicePixelRatio:1)||1,2)}function v(){if(!i)return;const b=p(),L=n.getSize(mE),N=L.x*b*L.y*b,k=d&&b>Df&&N>il?Df:b,I=n.getPixelRatio();if(!(u!==null&&Math.abs(I-u)<1e-9||Math.abs(I-b)<1e-9)){u=null;return}if(Math.abs(I-k)<1e-9){u=k;return}n.setPixelRatio(k),u=k,_.ratioChanges++,m()}function M(b){if(b){d=!0,f=0,v();return}++f>=Nf&&d&&(d=!1,v())}function S(b,L,N={}){const k=new Ci(b,L,Pf,Pf);k.computeBoundingBox();const I=new Ti({name:"portalCap",side:Yn,fog:!1,toneMapped:!0,uniforms:{tPortal:{value:r.texture},uRes:{value:new Ot(1,1)},uNear:{value:c.near}},vertexShader:xE,fragmentShader:vE}),D=new Dt(k,I);D.name=N.name||"portalCap",D.isPortalCap=!0,D.frustumCulled=!1,N.faceMinusZ&&(D.rotation.y=Math.PI);const U=new z,Y=new z,K=new Kn;return Object.defineProperties(D,{normalWorld:{get(){return this.updateWorldMatrix(!0,!1),U.set(0,0,1).transformDirection(this.matrixWorld)}},centreWorld:{get(){return this.updateWorldMatrix(!0,!1),Y.setFromMatrixPosition(this.matrixWorld)}},aabbInflated:{get(){return this.updateWorldMatrix(!0,!1),K.copy(this.geometry.boundingBox).applyMatrix4(this.matrixWorld).expandByScalar(c.skin)}}}),a.push(D),m(),D}function R(b,L,N=t){return!(!b||!b.isPortalCap||b.normalWorld.dot(_E.copy(N.position).sub(b.centreWorld))<=0||L&&!L.intersectsBox(b.aabbInflated))}const A=new Qr;function E(b=t){return b.updateMatrixWorld(),Uf.multiplyMatrices(b.projectionMatrix,b.matrixWorldInverse),A.setFromProjectionMatrix(Uf)}function P(b,L){if(typeof b.M=="function")return b.M(L.id);const N=L.id===Of?b.M_IE:b.M_EI;if(!N)throw new Error(`portal.pass(): link exposes no transform for "${L.id}"`);return N}function C(b,L){if(typeof b.keepFor=="function")return b.keepFor(L.id);const N=L.id===Of?b.keepI:b.keepE;if(!N)throw new Error(`portal.pass(): link exposes no clip plane for "${L.id}"`);return N}function g(b,L,N){if(!b||!L||!N||!N.scene){_.skipped++;return}M(!0);const k=b.portalCam||o;k.projectionMatrix.copy(t.projectionMatrix),k.projectionMatrixInverse.copy(t.projectionMatrixInverse),k.fov=t.fov,k.aspect=t.aspect,k.near=t.near,k.far=t.far,k.layers.mask=t.layers.mask,k.matrixAutoUpdate=!1,k.matrixWorldAutoUpdate=!1,k.matrixWorld.multiplyMatrices(P(b,L),t.matrixWorld),k.matrixWorld.decompose(k.position,k.quaternion,k.scale),k.matrixWorldInverse.copy(k.matrixWorld).invert(),!x&&(Math.abs(k.scale.x-1)>1e-6||Math.abs(k.scale.y-1)>1e-6||Math.abs(k.scale.z-1)>1e-6)&&(x=!0,console.warn("[portal] the link is not rigid: portal camera scale",k.scale.x,k.scale.y,k.scale.z,"- the far world will be the wrong size.")),gE(k,C(b,N));const I=N.cap,D=I?I.visible:!1;I&&(I.visible=!1);const U=n.getRenderTarget();n.setRenderTarget(r),n.clear(),n.render(N.scene,k),n.setRenderTarget(U),I&&(I.visible=D),_.passes++}function y(){r.dispose();for(const b of a)b.geometry.dispose(),b.material.dispose();a.length=0,u!==null&&Math.abs(n.getPixelRatio()-u)<1e-9&&Math.abs(u-p())>1e-9&&n.setPixelRatio(p()),u=null}return m(),{rt:r,portalCam:o,makeCap:S,resize:m,pass:g,setLive:M,capOnScreen:R,frustum:E,dispose:y,stats:_,get near(){return c.near},get skin(){return c.skin},get plan(){return c},get scale(){return l},get samples(){return h},get live(){return d},get caps(){return a.slice()}}}const Tp=document.getElementById("scene"),fr=new URLSearchParams(location.search),yE=fr.get("seed")||"tardis",jn=QS(fr),On=K0[jn.site],de=new Hv({canvas:Tp,antialias:!0,powerPreference:"high-performance"});de.setPixelRatio(Math.min(devicePixelRatio||1,2));de.setSize(innerWidth||1280,innerHeight||720,!1);de.outputColorSpace=Je;de.toneMapping=Xf;const SE=Nn.toneMappingExposure;de.toneMappingExposure=SE;de.shadowMap.type=Wf;de.shadowMap.enabled=!!Nn.shadows;eM(de);const Zn=new Sd;Zn.background=new Nt(Nn.background);Nn.fog&&(Zn.fog=Nn.fog);const EE=new Ed(Nn.hemisphere.sky,Nn.hemisphere.ground,Nn.hemisphere.intensity);Zn.add(EE);const wE=new Ad(Nn.ambient.colour,Nn.ambient.intensity);Zn.add(wE);const ol=Nn.camera,De=new cn(ol.fov,(innerWidth||1280)/(innerHeight||720),ol.near,Math.max(ol.far,On.camera.far)),Fa=new no(yE);Bd();const Ms=zd(Fa.child("tex.roundel")),xn=new O0,at={};at.shell=VM(xn,Ms,{liveDoors:!0});at.console=ny(xn,Ms);at.rotor=py(xn,Ms,{collar:!1});at.fittings=By(xn,Ms);at.lighting=sS(xn,Ms);at.doors=YS(xn,Ms,{shellDoors:at.shell,console:at.console});at.fittings.setScanner(at.fittings.shuttersOpen);const Rp=Na(xn.group);Zn.add(Rp);Zn.add(at.rotor.group);Zn.add(at.fittings.group);Zn.add(at.doors.group);const ys=new Sd;ys.name="site";Ep();const Ss=new O0,AE=Object.values(Ri).filter(n=>n.site===On.id).map(n=>({x:n.x,z:n.z,r:Ai.plinth/2*Math.SQRT2+.06})),Pn=m2(Ss,On,{camera:De,rng:Fa.child("site"),keepOut:AE});ys.fog=Pn.fog;const J0=new O0,Tn=X2(J0,Ap(Fa.child("tex.box")));Pn.contact(jn.x,jn.z,1.9,1.9);const bE=Na(Ss.group);ys.add(bE);ys.add(Pn.live);const wi=Na(J0.group,{colliders:Tn.aoVolumes});wi.position.set(jn.x,0,jn.z);wi.rotation.y=jn.yaw;Tn.leaves.position.copy(wi.position);Tn.leaves.rotation.y=jn.yaw;Tn.lamp.position.set(jn.x,Tn.lamp.position.y,jn.z);ys.add(wi,Tn.leaves,Tn.lamp);at.doors.setBoxDoors(Tn.pivots);at.lighting.setDoorSpillColour(On.sun.colour);const gr=Mp(jn,K0);{const n=Ss.userData.collision;n.boxes=[...n.boxes||[],...gr.boxCollision()]}Np(gr);const ci=ME({renderer:de,camera:De,aperture:gn}),Q0=ci.makeCap(gn.w,gn.h,{name:"capInterior",faceMinusZ:!0});Q0.position.set(0,gn.h/2,ln);Zn.add(Q0);const th=ci.makeCap(gn.w,gn.h,{name:"capExterior"});th.position.set(0,gn.h/2,oo);wi.add(th);const te=Z2({interior:{id:Me,scene:Zn,build:xn,surface:"vinyl",dist:fp,beds:dp,cap:Q0},exterior:{id:On.id,scene:ys,build:Ss,surface:Pn.surface,dist:Pn.distance,beds:Pn.bedIds,cap:th,update:Pn.update},link:gr,startWorld:fr.get("world")==="exterior"?On.id:fr.get("world")||null}),kt=new pS(De,xn,{spawn:et.SPAWN,yaw:et.SPAWN_YAW});kt.setWorld(te.near);if(te.near.id!==Me){const n=gr.toExterior(new z(0,0,ln-2.2));kt.teleport(n.x,0,n.z,jn.yaw+Math.PI)}const Dn=new IS({sounds:ra,buses:PS,distance:fp,defaults:DS,roomBeds:dp,propRate:NS,ctlRate:OS,siteBeds:Pn.beds,surfaceSteps:US,rng:Fa,say:n=>on(n)});Dn.bindRoom({build:xn,rotor:at.rotor,fittings:at.fittings,walker:kt,room:et});at.doors.setAudio(Dn);Dn.setWorld(te.near,gr);const ye=aE({worlds:te,walker:kt,audio:Dn,portal:ci,camera:De,doors:at.doors}),al={1:()=>{on(TE())},2:()=>{on(Lp())},3:()=>{on(Cp())},4:()=>{on("Navigation: the coordinates read as gibberish.")},5:()=>{on(Ip())},6:()=>{on(Pp())}};function Lp(){const n=!at.fittings.shuttersOpen;return at.fittings.setShutters(n),at.fittings.setScanner(n),n?"The scanner shutters grind open. The screen lights, and shows nothing.":"The scanner shutters close over the screen."}function Cp(){return at.fittings.dispense(),"The food machine delivers a bar. It is, allegedly, bacon and eggs."}function Ip(){return!at.rotor.running&&!at.doors.flightReady?at.doors.state!=="shut"?"Flight: the doors are open.":"Flight: the doors must be locked before the ship will move.":(at.rotor.setRunning(!at.rotor.running),at.rotor.running?"The time rotor begins to rise and fall.":"The rotor settles, and the room goes quiet.")}function Pp(){return at.fittings.pulseFault(),at.lighting.pulseAlert(4),"The fault locator runs a query. Forty-eight lamps have opinions."}function kf(n=!1){return at.doors.request(!at.doors.open,{fittings:at.fittings,rotor:at.rotor,walker:kt,atShell:n})}function TE(){return at.doors.setLocked(!at.doors.locked,{rotor:at.rotor})}const Bf={hatStand:"A hat stand. There is a hat on it.",chair:"A high-backed hall chair, out of a house that is nowhere near here.",clock:"An ormolu clock. It keeps perfect time, which proves nothing."};kt.onInteract(n=>{var t;switch(n.action){case"panel":{const e=n.data.panel;at.console.setLamp(e,!0),on(n.label),(t=al[e])==null||t.call(al);break}case"doors":on(kf());break;case"shellDoors":on(kf(!0));break;case"scanner":on(Lp());break;case"faultLocator":on(Pp());break;case"foodMachine":on(Cp());break;case"rotor":on(Ip());break;default:Bf[n.action]&&on(Bf[n.action])}});const xr=document.createElement("div");xr.style.cssText="position:fixed;inset:0;pointer-events:none;font:14px/1.4 system-ui,-apple-system,Segoe UI,sans-serif;color:#e8e6df;text-shadow:0 1px 3px rgba(0,0,0,.9)";xr.innerHTML=`
